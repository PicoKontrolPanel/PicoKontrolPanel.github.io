...
`),await this.transport.write(ua)},d=>d.includes(`${ua}${ua}`)||d.includes(`${ua}>`),o);return await this.friendlyRepl().catch(()=>{}),C_(s)}collectUntil(l,o,s){return new Promise((d,p)=>{let _="",m=null;const g=setTimeout(()=>{m==null||m(),p(new Error("Timeout ved USB REPL kommando."))},s);m=this.transport.addDataListener(b=>{_+=b,o(_)&&(clearTimeout(g),m==null||m(),d(_))}),l().catch(b=>{clearTimeout(g),m==null||m(),p(b instanceof Error?b:new Error("USB REPL kommando fejlede."))})})}async waitForFriendlyPrompt(l=1600){await this.collectUntil(async()=>{await this.transport.write(lh)},o=>/(^|\r?\n)>>> ?$/.test(o),l)}}function C_(i){const l=i.indexOf("OK"),o=i.indexOf(ua,l>=0?l:0),s=o>=0?i.indexOf(ua,o+1):-1;if(l<0||o<0)return{output:i.trim(),error:"",raw:i};const d=i.slice(l+2,o).replace(/^\r?\n/,"").trimEnd(),p=s>=0?i.slice(o+1,s).trim():"";return{output:d,error:p,raw:i}}const D_=[{version:"MicroPython v1.28.0",date:"2026-04-06",stamp:"20260406",tag:"v1.28.0"},{version:"MicroPython v1.27.0",date:"2025-12-09",stamp:"20251209",tag:"v1.27.0"},{version:"MicroPython v1.26.1",date:"2025-09-11",stamp:"20250911",tag:"v1.26.1"},{version:"MicroPython v1.26.0",date:"2025-08-09",stamp:"20250809",tag:"v1.26.0"},{version:"MicroPython v1.25.0",date:"2025-04-15",stamp:"20250415",tag:"v1.25.0"},{version:"MicroPython v1.24.1",date:"2024-11-29",stamp:"20241129",tag:"v1.24.1"},{version:"MicroPython v1.24.0",date:"2024-10-25",stamp:"20241025",tag:"v1.24.0"},{version:"MicroPython v1.23.0",date:"2024-06-02",stamp:"20240602",tag:"v1.23.0"},{version:"MicroPython v1.22.2",date:"2024-02-22",stamp:"20240222",tag:"v1.22.2"},{version:"MicroPython v1.22.1",date:"2024-01-05",stamp:"20240105",tag:"v1.22.1"}],O_=[{board:"Raspberry Pi Pico",firmwareName:"RPI_PICO"},{board:"Raspberry Pi Pico W",firmwareName:"RPI_PICO_W"}],Cl=O_.flatMap(({board:i,firmwareName:l})=>D_.map(({version:o,date:s,stamp:d,tag:p})=>{const _=`${l}-${d}-${p}.uf2`;return{board:i,version:o,date:s,fileName:_,url:`https://micropython.org/resources/firmware/${_}`}})),zd=512,Ud=`import builtins as _pkp_builtins
`;function Xr(i){return JSON.stringify(i)}function L_(i){return`bytes.fromhex(${JSON.stringify([...i].map(l=>l.toString(16).padStart(2,"0")).join(""))})`}function B_(i,l){return`${i==="/"?"":i.replace(/\/$/,"")}/${l}`}class z_{constructor(l){this.repl=l}async list(l="/"){const o=`
import os
base = ${Xr(l)}
...
import sys
${Ud}with _pkp_builtins.open(${Xr(l)}, 'rb') as f:
    while True:
        b = f.read(${zd})
        if not b:
            break
        print(b.hex())
`,s=await this.repl.exec(o,1e4);if(s.error)throw new Error(s.error);const d=s.output.replace(/\s+/g,"");return new TextDecoder().decode(U_(d))}async writeText(l,o,s){const d=new TextEncoder().encode(o);if(s==null||s(5,"Klargør fil..."),await this.repl.exec(`${Ud}_pkp_builtins.open(${Xr(l)}, 'wb').close()`),d.length===0){s==null||s(100,"Gemt på Pico");return}for(let p=0;p<d.length;p+=zd){const _=d.slice(p,p+zd),m=`
${Ud}with _pkp_builtins.open(${Xr(l)}, 'ab') as f:
    f.write(${L_(_)})
...
`);let _=Atomics.load(o,0);for(const m of p)s[oh+_%d]=m,_+=1;Atomics.store(o,0,_),Atomics.notify(o,0)}const sv=new Set(["bluetooth","machine","network","PicoRobotics","rp2","ubluetooth"]);class ov{constructor(){ge(this,"worker",null);ge(this,"pending",null);ge(this,"nextId",0)}send(l,o={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython-terminalen er optaget. Stop den, eller vent på at kommandoen bliver færdig.",timedOut:!1,unavailable:!1});const s=++this.nextId,d=o.timeoutMs??Xh,p=this.ensureWorker();return new Promise(_=>{const m=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython-terminalen stoppede, fordi kommandoen tog for lang tid. Tjek for uendelige løkker.",timedOut:!0,unavailable:!1}),this.restartWorker()},d);this.pending={id:s,timer:m,onOutput:o.onOutput,resolve:_},p.postMessage({type:"run",id:s,code:uv(l),runtimeUrl:Kh})})}reset(){this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),this.restartWorker()}dispose(){var l;this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),(l=this.worker)==null||l.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const l=new Worker(new URL(""+new URL("offlineMicroPython.worker-CyZOxxkY.js",import.meta.url).href,import.meta.url),{type:"module"});return l.onmessage=o=>this.handleMessage(o.data),l.onerror=o=>{this.finish({ok:!1,output:"",error:o.message||"Browser-MicroPython-terminalen fejlede i browser-worker.",timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=l,l}handleMessage(l){var s;const o=this.pending;if(!(!o||l.id!==o.id||l.type==="ready")){if(l.type==="stdout"){(s=o.onOutput)==null||s.call(o,l.text);return}if(l.type==="unavailable"){this.finish({ok:!1,output:"",error:l.error,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:l.ok,output:l.output,error:l.error,timedOut:!1,unavailable:!1})}}finish(l){const o=this.pending;o&&(window.clearTimeout(o.timer),this.pending=null,o.resolve(l))}restartWorker(){var l;(l=this.worker)==null||l.terminate(),this.worker=null}}class cv{constructor(){ge(this,"worker",null);ge(this,"pending",null);ge(this,"nextId",0);ge(this,"stdinSab",null)}run(l,o={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython kører allerede kode. Stop den først.",issues:[],timedOut:!1,unavailable:!1});const s=typeof o=="number"?o:o.timeoutMs===null?null:o.timeoutMs??Xh,d=typeof o=="number"?void 0:o.onOutput,p=typeof o=="number"?void 0:o.signal,_=Xd(l,{allowInput:!0});if(_.some(w=>w.level==="error"))return Promise.resolve({ok:!1,output:"",error:"",issues:_,timedOut:!1,unavailable:!1});const m=++this.nextId,g=this.ensureWorker(),b=av();return this.stdinSab=b,new Promise(w=>{const k=G=>this.finish(G),T=()=>{this.restartWorker(),k({ok:!1,output:"",error:"",issues:_,timedOut:!1,unavailable:!1})},R=s===null?null:window.setTimeout(()=>{k({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:_,timedOut:!0,unavailable:!1}),this.restartWorker()},s);if(this.pending={id:m,timer:R,timeoutMs:s,issues:_,onOutput:d,signal:p,abort:T,resolve:w},p!=null&&p.aborted){T();return}p==null||p.addEventListener("abort",T,{once:!0});const O={type:"run",id:m,code:l,runtimeUrl:Kh,interactive:!0,sab:b??void 0};g.postMessage(O)})}sendInput(l){const o=this.pending;!o||!this.stdinSab||(this.refreshTimeout(o),iv(this.stdinSab,l))}stop(){const l=this.pending;l&&(this.restartWorker(),this.finish({ok:!1,output:"",error:"Browser-MicroPython blev stoppet.",issues:l.issues,timedOut:!1,unavailable:!1}))}dispose(){var l;this.finish({ok:!1,output:"",error:"",issues:[],timedOut:!1,unavailable:!1}),(l=this.worker)==null||l.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const l=new Worker(new URL(""+new URL("offlineMicroPython.worker-CyZOxxkY.js",import.meta.url).href,import.meta.url),{type:"module"});return l.onmessage=o=>this.handleMessage(o.data),l.onerror=o=>{const s=this.pending;this.finish({ok:!1,output:"",error:o.message||"Offline MicroPython fejlede i browser-worker.",issues:(s==null?void 0:s.issues)??[],timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=l,l}handleMessage(l){var s;const o=this.pending;if(!(!o||l.id!==o.id||l.type==="ready")){if(l.type==="stdout"){this.refreshTimeout(o),(s=o.onOutput)==null||s.call(o,l.text);return}if(l.type==="unavailable"){this.finish({ok:!1,output:"",error:l.error,issues:o.issues,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:l.ok,output:l.output,error:l.error,issues:o.issues,timedOut:!1,unavailable:!1}),this.restartWorker()}}finish(l){var s;const o=this.pending;o&&(o.timer!==null&&window.clearTimeout(o.timer),(s=o.signal)==null||s.removeEventListener("abort",o.abort),this.pending=null,o.resolve(l))}refreshTimeout(l){l.timeoutMs!==null&&(l.timer!==null&&window.clearTimeout(l.timer),l.timer=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:l.issues,timedOut:!0,unavailable:!1}),this.restartWorker()},l.timeoutMs))}restartWorker(){var l;(l=this.worker)==null||l.terminate(),this.worker=null,this.stdinSab=null}}function uv(i){const l=JSON.stringify(i);return["try:",`    __pico_repl_value = eval(${l})`,"    if __pico_repl_value is not None:","        print(repr(__pico_repl_value))","except SyntaxError:",`    exec(${l})`,"finally:","    try:","        del __pico_repl_value","    except Exception:","        pass"].join(`
`)}function Xd(i,l={}){const o=[],s=new Blob([i]).size;s>ih&&o.push({level:"error",text:`Koden er ${s} bytes. Offline MicroPython kører kun små programmer op til ${ih} bytes.`});const d=i.split(/\r?\n/);for(let p=0;p<d.length;p+=1){const _=p+1,m=uc(d[p]).trim();if(!m)continue;const g=fv(m);g&&sv.has(g)&&o.push({level:"error",line:_,text:`${g} virker kun på Picoen. Forbind en Pico for at køre denne kode.`}),!l.allowInput&&dv(d[p])&&o.push({level:"error",line:_,text:"input() virker i hele programmer. Skriv programmet i editoren og tryk Kør, eller kør filen på Pico via USB."});const b=m.match(/\brange\(\s*(-?\d+)\s*(?:,\s*(-?\d+)\s*)?(?:,\s*(-?\d+)\s*)?\)/);b&&mv(b)>sh&&o.push({level:"error",line:_,text:`range(...) er for stor til offline kørsel. Brug højst ${sh} gentagelser.`})}for(const p of hv(d))o.push({level:"warning",text:`Funktionen ${p} ser rekursiv ud. Hvis den ikke stopper, afbryder offline MicroPython efter få sekunder.`});return o}function uc(i){let l=null;for(let o=0;o<i.length;o+=1){const s=i[o];if((s==='"'||s==="'")&&i[o-1]!=="\\"&&(l=l===s?null:l??s),s==="#"&&!l)return i.slice(0,o)}return i}function dv(i){const l=uc(i);let o=null;for(let s=0;s<l.length;s+=1){const d=l[s];if((d==='"'||d==="'")&&l[s-1]!=="\\"){o=o===d?null:o??d;continue}if(!o&&!(!ch(l[s-1])||l.slice(s,s+5)!=="input")&&ch(l[s+5])&&l.slice(s+5).trimStart().startsWith("("))return!0}return!1}function ch(i){return!i||!/[A-Za-z0-9_]/.test(i)}function fv(i){const l=i.match(/^import\s+([A-Za-z_]\w*)/);if(l)return l[1];const o=i.match(/^from\s+([A-Za-z_]\w*)\s+import\b/);return(o==null?void 0:o[1])??null}function uh(i){const l=i.match(/^\s*/);return(l==null?void 0:l[0].replace(/\t/g,"    ").length)??0}function mv(i){const l=Number(i[1]),o=i[2]===void 0?void 0:Number(i[2]),s=i[3]===void 0?1:Number(i[3]);if(s===0)return Number.POSITIVE_INFINITY;const _=(o===void 0?l:o)-(o===void 0?0:l);return _>0&&s<0||_<0&&s>0?0:Math.ceil(Math.abs(_/s))}function hv(i){const l=new Set;for(let o=0;o<i.length;o+=1){const s=uc(i[o]).trim().match(/^def\s+([A-Za-z_]\w*)\s*\(/);if(!s)continue;const d=s[1],p=uh(i[o]);for(let _=o+1;_<i.length;_+=1){if(!i[_].trim())continue;if(uh(i[_])<=p)break;if(new RegExp(`\\b${d}\\s*\\(`).test(uc(i[_]))){l.add(d);break}}}return[...l]}const pv=/^(for|if|while|def|class|elif|else|try|except|finally|with)\b/;function gv(i,l){var w;const o=i.trim(),s=l.split(/\r?\n/),d=_v(o),p=d?s[d-1]??"":"",_=vv(s,d),m=o.split(/\r?\n/).filter(Boolean).at(-1)??"";if(/KeyboardInterrupt/.test(m))return{simple:"Programmet blev stoppet.",technical:o,line:d};if(/MemoryError/.test(m))return{simple:`Picoen eller browserens MicroPython løb tør for hukommelse${d?` omkring linje ${d}`:""}.`,technical:o,line:d};if(/RecursionError/.test(m))return{simple:`En funktion kalder sig selv for mange gange${d?` omkring linje ${d}`:""}.`,technical:o,line:d};const g=m.match(/UnboundLocalError:\s+local variable ['"](.+?)['"]/);if(g)return{simple:`Variablen ${g[1]} bruges inde i en funktion, før den har fået en værdi${d?` på linje ${d}`:""}.`,technical:o,line:d};const b=m.match(/NameError:\s+name ['"](.+?)['"] (?:isn't|is not) defined/);if(b)return{simple:wv(p,b[1])?`Teksten ${b[1]} mangler måske citationstegn${d?` på linje ${d}`:""}.`:`Python kender ikke navnet ${b[1]}${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/ZeroDivisionError/.test(m))return{simple:`Kan ikke dividere med 0${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/IndentationError:\s+unexpected indent/.test(m))return{simple:`Der er for meget indrykning${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/IndentationError/.test(m))return{simple:`Mangler indrykning${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/ImportError|ModuleNotFoundError/.test(m)){const k=(w=m.match(/['"](.+?)['"]/))==null?void 0:w[1];return{simple:`Python kan ikke finde modulet${k?` ${k}`:""}.`,technical:o,line:d}}if(/OSError/.test(m))return/ENOENT|No such file|Errno\s+2/.test(m)?{simple:`Python kan ikke finde filen${d?` på linje ${d}`:""}.`,technical:o,line:d}:/EACCES|permission|denied/i.test(m)?{simple:`Python har ikke adgang til filen eller enheden${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Der opstod en fejl med en fil eller en enhed${d?` omkring linje ${d}`:""}.`,technical:o,line:d};if(/SyntaxError/.test(m)){if(/invalid syntax/.test(m)&&_.text.trim().endsWith(","))return{simple:`Linje ${_.line??d} slutter med komma. Tjek om der mangler noget efter kommaet.`,technical:o,line:_.line??d};const k=Kd(p,d)??Kd(_.text,_.line)??bv(s,d);return k?{simple:`Mangler måske : efter linje ${k.line}.`,technical:o,line:k.line}:d&&_.text.trim().endsWith(":")&&p.trim()&&!/^\s+/.test(p)?{simple:`Mangler måske indrykning på linje ${d}.`,technical:o,line:d}:xv(p)?{simple:`Tekst mangler måske citationstegn${d?` på linje ${d}`:""}.`,technical:o,line:d}:yv(p)?{simple:`Tekst mangler måske et afsluttende citationstegn${d?` på linje ${d}`:""}.`,technical:o,line:d}:kv(p)?{simple:`Mangler måske en afsluttende parentes${d?` på linje ${d}`:""}.`,technical:o,line:d}:Sv(p)?{simple:`Der er måske en parentes for meget${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Python fandt en syntaksfejl${d?` omkring linje ${d}`:""}.`,technical:o,line:d}}return/TypeError/.test(m)?/takes .* positional arguments? but .* given/.test(m)||/function takes/.test(m)?{simple:`En funktion får for mange eller for få værdier${d?` på linje ${d}`:""}.`,technical:o,line:d}:/unsupported operand type/.test(m)?{simple:`To værdier kan ikke bruges sammen på den måde${d?` på linje ${d}`:""}.`,technical:o,line:d}:/not callable/.test(m)?{simple:`Der bliver brugt parenteser efter noget, som ikke er en funktion${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`En værdi har den forkerte type${d?` på linje ${d}`:""}.`,technical:o,line:d}:/IndexError/.test(m)?{simple:`Listen har ikke et element på den plads${d?` på linje ${d}`:""}.`,technical:o,line:d}:/KeyError/.test(m)?{simple:`Ordbogen mangler den nøgle${d?` på linje ${d}`:""}.`,technical:o,line:d}:/AttributeError/.test(m)?{simple:`Den ting har ikke den kommando${d?` på linje ${d}`:""}.`,technical:o,line:d}:/ValueError/.test(m)?/invalid literal for int/.test(m)?{simple:`Teksten kan ikke laves om til et heltal${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Værdien passer ikke her${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Python fandt en fejl${d?` omkring linje ${d}`:""}.`,technical:o,line:d}}function _v(i){var d;const o=(d=[...i.matchAll(/line\s+(\d+)/g)].at(-1))==null?void 0:d[1];if(!o)return;const s=parseInt(o,10);return Number.isFinite(s)&&s>0?s:void 0}function vv(i,l){if(!l)return{text:""};for(let o=l-2;o>=0;o-=1){const s=i[o]??"";if(s.trim())return{line:o+1,text:s}}return{text:""}}function Kd(i,l){if(!l)return null;const o=i.trim();return!pv.test(o)||o.endsWith(":")?null:{line:l}}function bv(i,l){const o=l?Math.min(i.length,l):i.length,s=Math.max(0,o-4);for(let d=o-1;d>=s;d-=1){const p=Kd(i[d]??"",d+1);if(p)return p}return null}function yv(i){const l=(i.match(/'/g)??[]).length,o=(i.match(/"/g)??[]).length;return l%2===1||o%2===1}function xv(i){var s,d;const o=(d=(s=i.trim().match(/^print\((.+)\)$/))==null?void 0:s[1])==null?void 0:d.trim();return!o||/['"]/.test(o)?!1:/\s/.test(o)&&/[a-zA-ZæøåÆØÅ]/.test(o)}function wv(i,l){const o=i.trim();return!!l&&/[A-Za-zæøåÆØÅ]/.test(l)&&(o.startsWith("print(")||o.includes(`= ${l}`))}function kv(i){return Wh(i)>0}function Sv(i){return Wh(i)<0}function Wh(i){let l=0,o=null;for(let s=0;s<i.length;s+=1){const d=i[s];if((d==='"'||d==="'")&&i[s-1]!=="\\"){o=o===d?null:o??d;continue}o||((d==="("||d==="["||d==="{")&&(l+=1),(d===")"||d==="]"||d==="}")&&(l-=1))}return l}const Qd="/min_kode.py",Zh=`print('Hej fra Pico Kontrol Panel')
`,Ev=500,Tv=1200,ds="Backup-filnavne er reserveret til versionshistorik. Vælg et andet navn.";function Wt(i,l){return`${i}:${l}`}function Mv(i){return new Promise(l=>window.setTimeout(l,i))}function jv(){const i=ae(f=>f.toggleSideMenu),l=ae(f=>f.askConfirm),o=ae(f=>f.picoIdeOrigin),s=ae(f=>f.active),d=ae(f=>f.isBleConnected),p=ae(f=>f.bleListFiles),_=ae(f=>f.bleReadText),m=ae(f=>f.bleWriteText),g=ae(f=>f.bleDeleteFile),b=ae(f=>f.bleRestartAndReconnect),[w,k]=C.useState(!1),[T,R]=C.useState(!1),[O,G]=C.useState([]),[F,V]=C.useState(!1),[X,P]=C.useState([]),[re,be]=C.useState(null),[de,W]=C.useState(()=>ec(Ko())),[Z,ke]=C.useState(Qd),[Ee,ze]=C.useState("local"),[J,Ne]=C.useState(()=>{var f;return((f=ec(Ko()).find(v=>v.path===Qd))==null?void 0:f.content)??Zh}),[je,ue]=C.useState([]),[z,ne]=C.useState(!1),[he,me]=C.useState(""),[we,E]=C.useState(""),[U,ee]=C.useState(null),[le,se]=C.useState(!1),[H,D]=C.useState(null),[oe,xe]=C.useState(!1),[Ue,fe]=C.useState({}),[Be,Ce]=C.useState(!1),[Ke,it]=C.useState(0),[wt,Ot]=C.useState(()=>{var f,v;return((f=Cl.find(x=>x.board==="Raspberry Pi Pico W"))==null?void 0:f.board)??((v=Cl[0])==null?void 0:v.board)??""}),[Zt,zn]=C.useState(()=>{var f,v;return((f=Cl.find(x=>x.board==="Raspberry Pi Pico W"))==null?void 0:f.version)??((v=Cl[0])==null?void 0:v.version)??""}),[Jt,Tt]=C.useState(!1),[yn,vr]=C.useState({top:0,left:0}),[dt,Jn]=C.useState(!1),[dr,zl]=C.useState(!1),[br,Mt]=C.useState(!0),[un,xn]=C.useState(""),[_e,Qe]=C.useState([]),[Ge,st]=C.useState(null),[pt,wn]=C.useState(!1),[Un,qn]=C.useState({}),[en,tn]=C.useState({}),[We,ft]=C.useState(null),[mt,Ht]=C.useState(null),[pc,Ul]=C.useState(""),[fr,ql]=C.useState(()=>Sm().clearTerminalOnRun),[yr,ws]=C.useState(()=>Sm().simplifiedErrors),[ma,ks]=C.useState(()=>typeof navigator<"u"?hh(navigator):!1),Kr=C.useRef(null),Hn=C.useRef(null),gt=C.useRef(null),si=C.useRef(null),Ft=C.useRef(null),kt=C.useRef(null),Vt=C.useRef(null),er=C.useRef(null),Qr=C.useRef(null),Wr=C.useRef(null),ha=C.useRef(null),kn=C.useRef(!1),Sn=C.useRef(!1),xr=C.useRef(!1),nn=C.useRef(""),En=C.useRef(null),tr=C.useRef(null),mn=C.useRef(null),bt=C.useRef(null),nr=C.useRef(null),Zr=C.useRef(null),dn=C.useRef(0),Tn=C.useRef(null),Jr=C.useRef(null),oi=C.useRef(null),el=C.useRef(null),pa=C.useRef([]),wr=C.useRef([]),rr=C.useRef(null),rn=tv(),ve=o==="control"&&!!s&&d(),ga=ve?(s==null?void 0:s.deviceID)??"ble":null,gc=Math.max(1,J.split(`
`).length),ci=new Blob([J]).size,Ss=Ee==="pico"?"Picoen":"browseren",_a=C.useMemo(()=>[...new Set(Cl.map(f=>f.board))],[]),Hl=C.useMemo(()=>Cl.filter(f=>f.board===wt),[wt]),Lt=Cl.find(f=>f.board===wt&&f.version===Zt)??Hl[0]??Cl[0],Vl=F||!!re||dt||dr,Mn=Ee==="pico",Pl=Mn?dt:dr,Bt=Mn&&dt&&w&&!ve||!Mn&&dr&&!!mn.current,Es=pt||Pl&&!Bt,Ts=Bt?"stdin":">>>",kr=Bt?Mn?"Input til kørende Pico-kode":"Input til kørende Browser-MicroPython":Mn?"Pico MicroPython":"Browser-MicroPython",ui=C.useMemo(()=>{const f=new nv({onData:v=>{Sn.current||!kn.current||(nn.current=(nn.current+v).slice(-240),/(^|\r?\n)>>> ?$/.test(nn.current)&&Fl())},onLine:v=>{if(Sn.current)return;const x=v.trimEnd();if(xr.current&&x.trim()){$("info",x);return}if(kn.current&&di(x)){Fl();return}kn.current&&x.trim()&&!_c(x)&&!x.includes("raw REPL")&&$("info",x)},onLog:$,onDisconnect:()=>{k(!1),Jn(!1),wn(!1),kn.current=!1,xr.current=!1,Il(),nn.current="",ll(),$("warning","USB-forbindelse lukket.")}});return Kr.current=f,f},[]);function $(f,v){G(x=>[...x.slice(-140),{level:f,text:v}])}function Ms(f){G(v=>[...v.slice(-140),{level:"info",text:f,variant:"input"}])}function di(f){return f.trim()===">>>"}function _c(f){return f.trimStart().startsWith(">>> import builtins as _pkp_builtins; exec(")}function Il(){En.current!==null&&(window.clearTimeout(En.current),En.current=null)}function Fl(){!kn.current||En.current!==null||(En.current=window.setTimeout(()=>{En.current=null,kn.current&&(Jn(!1),kn.current=!1,nn.current="",$("success","Pico-koden er færdig."),Vn())},0))}function Vn(){const f=gt.current;f&&hi(f,!1)}function tl(f,v=J,x="error"){const j=gv(f,v);G(N=>[...N.slice(-140),{level:x,text:j.simple,technical:j.technical}])}function _t(f,v,x=Ee){ke(f),ze(x),Ne(v),tn(j=>({...j,[Wt(x,f)]:v})),lr()}function Sr(f,v="pico"){ke(f),ze(v),Ne(""),ft(null),vr({top:0,left:0}),lr()}function lr(){pa.current=[],wr.current=[],rr.current=null}function nl(){const f=Ft.current;return{content:J,selectionStart:(f==null?void 0:f.selectionStart)??J.length,selectionEnd:(f==null?void 0:f.selectionEnd)??(f==null?void 0:f.selectionStart)??J.length}}function fi(f){const v=pa.current,x=v.at(-1);(x==null?void 0:x.content)===f.content&&x.selectionStart===f.selectionStart&&x.selectionEnd===f.selectionEnd||(v.push(f),v.length>Ev&&v.shift(),wr.current=[])}function js(f,v){let x=0;const j=Math.min(f.length,v.length);for(;x<j&&f[x]===v[x];)x+=1;let N=f.length,te=v.length;for(;N>x&&te>x&&f[N-1]===v[te-1];)N-=1,te-=1;const ce=f.slice(x,N),Ve=v.slice(x,te),Me=Ve&&!ce?"insert":ce&&!Ve?"delete":"replace",$e=Ve.at(-1)??"";return{kind:Me,boundaryAfter:Me==="insert"&&/[\s.,:;()[\]{}'"`+\-*/%=<>!?]/.test($e)}}function Gl(f,v){if(v!=="typing")return rr.current=null,!0;const x=Date.now(),j=js(J,f),N=rr.current,te=N!==null&&N.path===Z&&N.source===Ee&&N.kind===j.kind&&N.kind!=="replace"&&!N.boundaryAfter&&x-N.at<=Tv;return rr.current={path:Z,source:Ee,kind:j.kind,at:x,boundaryAfter:j.boundaryAfter},!te}function Pn(f){Ne(f.content),tn(v=>({...v,[Wt(Ee,Z)]:f.content})),Ul(""),ft(null),window.requestAnimationFrame(()=>{const v=Ft.current;v&&(v.focus(),v.selectionStart=Math.min(f.selectionStart,f.content.length),v.selectionEnd=Math.min(f.selectionEnd,f.content.length))})}function mi(){const f=pa.current.pop();return f?(rr.current=null,wr.current.push(nl()),Pn(f),!0):!1}function rl(){const f=wr.current.pop();return f?(rr.current=null,pa.current.push(nl()),Pn(f),!0):!1}function Gt(f,v=(te=>(te=Ft.current)==null?void 0:te.selectionStart)()??f.length,x=nl(),j=v,N="programmatic"){x&&f!==J&&Gl(f,N)&&fi(x),Ne(f),tn(ce=>({...ce,[Wt(Ee,Z)]:f})),Ul(""),Ea(f,v),window.requestAnimationFrame(()=>{const ce=Ft.current;ce&&(ce.selectionStart=Math.min(v,f.length),ce.selectionEnd=Math.min(j,f.length))})}function Er(f,v=Ee){tn(x=>{const j=Wt(v,f);if(!(j in x))return x;const N={...x};return delete N[j],N})}function va(){return Un[Z]===J}function $t(f,v){qn(x=>({...x,[f]:v}))}function $l(f,v){$t(f,v),tn(x=>({...x,[Wt("pico",f)]:v})),Ee==="pico"&&Z===f&&Ne(v)}function ll(){P([]),ue([]),qn({}),tn({}),ft(null),ke(f=>{const v=ec(Ko());if(v.find(N=>N.path===f))return f;const j=v[0];return ze("local"),Ne(j.content),lr(),j.path})}function zt(f){jt(),D({value:100,label:f}),el.current=window.setTimeout(()=>{el.current=null,D(null)},900)}function jt(){el.current!==null&&(window.clearTimeout(el.current),el.current=null)}function Tr(){return H?u.jsxs("div",{className:"ide-task-progress",role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":Math.round(H.value),children:[u.jsxs("div",{children:[u.jsx("span",{children:H.label}),u.jsxs("strong",{children:[Math.round(H.value),"%"]}),H.cancellable&&u.jsx("button",{className:"ide-task-cancel",type:"button",onClick:ba,"aria-label":"Stop handling",title:"Stop",children:u.jsx(Dt,{name:"delete",size:18})})]}),u.jsx("b",{"aria-hidden":"true",children:u.jsx("i",{style:{width:`${Math.max(2,Math.min(100,H.value))}%`}})})]}):null}function ba(){nr.current&&ar("Stopper læsning...",!0,!0)}function ar(f="Stopper læsning...",v=!1,x=!1){var j;jt(),Jr.current=null,dn.current+=1,(j=nr.current)==null||j.abort(),nr.current=null,Tn.current=null,be(null),V(!1),D(v?{value:(H==null?void 0:H.value)??0,label:f,cancellable:!1}:null),x&&$("warning","Stopper BLE-læsning efter den aktuelle datapakke.")}function vc(f){var v;if(!(Tn.current===f||Jr.current===f)){if(Jr.current=f,Zr.current){dn.current+=1,(v=nr.current)==null||v.abort(),nr.current=null,Tn.current=null,Sr(f),be(f),V(!0),jt(),D({value:2,label:`Skifter til ${Ae(f)}...`,cancellable:!0});return}ya()}}function ya(){if(Zr.current)return;const f=Jr.current;if(!f)return;Jr.current=null;const v=dn.current+1;dn.current=v;const x=new AbortController;nr.current=x,Tn.current=f,Sr(f),be(f),V(!0),jt(),D({value:12,label:`Indlæser ${Ae(f)}...`,cancellable:!0});const j=(async()=>{try{const N=await _(f,(te,ce)=>{dn.current===v&&D({value:te,label:ce,cancellable:!0})},x.signal);if(x.signal.aborted||dn.current!==v)return;_t(f,N,"pico"),$t(f,N),zt("Fil indlæst")}catch(N){if(dn.current!==v)return;Av(N)||x.signal.aborted?$("info",`Stoppede læsning af ${Ae(f)}.`):(D(null),$("error",N instanceof Error?N.message:"BLE læsning fejlede."))}})();Zr.current=j,j.finally(()=>{if(Zr.current!==j)return;Zr.current=null,nr.current===x&&(nr.current=null),Tn.current===f&&(Tn.current=null),!!Jr.current||(be(null),V(!1),x.signal.aborted&&D(null)),ya()})}async function al(f){const v=Sn.current;Sn.current=!0;try{return await f()}finally{Sn.current=v}}C.useEffect(()=>{if(!br)return;const f=Qr.current;f&&(f.scrollTop=f.scrollHeight)},[O,br]),C.useEffect(()=>{V2({clearTerminalOnRun:fr,simplifiedErrors:yr})},[fr,yr]),C.useEffect(()=>{var f;Hl.some(v=>v.version===Zt)||zn(((f=Hl[0])==null?void 0:f.version)??"")},[Hl,Zt]),C.useEffect(()=>{ks(hh(navigator))},[]),C.useEffect(()=>{const f=()=>{const v=Kr.current;Hn.current=null,gt.current=null,Kr.current=null,v==null||v.disconnect().catch(()=>{})};return window.addEventListener("pagehide",f),()=>{var v,x;jt(),(v=tr.current)==null||v.dispose(),tr.current=null,(x=mn.current)==null||x.dispose(),mn.current=null,window.removeEventListener("pagehide",f),f()}},[]),C.useEffect(()=>{const f=v=>{!(v.ctrlKey||v.metaKey)||v.key.toLowerCase()!=="s"||(v.preventDefault(),!F&&Z.trim()&&!ma&&!le&&!U&&!z&&As())};return window.addEventListener("keydown",f),()=>window.removeEventListener("keydown",f)},[Ee,ve,F,w,J,Z,ma,le,U,z]);function mr(f,v,x){W(j=>{const N=Hd(j,f,v,x);return ss(N),N})}function Yl(f,v){W(x=>{const j=x.find(Me=>Me.path===f),te=en[Wt("local",f)]??(j==null?void 0:j.content),ce=te!==void 0&&Dl(te)!==Dl(v)?Hd(x,Fv(f,lc(x)),te,!1):x,Ve=Hd(ce,f,v,!1);return ss(Ve),Ve}),tn(x=>({...x,[Wt("local",f)]:v})),Ee==="local"&&Z===f&&(Ne(v),Ul(""),ft(null),lr())}const xa=Yv(X,de,en,w||ve);C.useEffect(()=>{ve&&vt()},[ve]),C.useEffect(()=>{const f=oi.current;f&&f!==ga&&ll(),oi.current=ga},[ga]);async function bc(){if(rn.supported){R(!0);try{await ui.requestAndConnect();const f=new A_(ui);Hn.current=f,gt.current=new z_(f),k(!0),it(0),await f.interrupt(),await yc(f),$("success","Sendte stop-signal til Pico-terminalen."),await hi(gt.current),await Rs(gt.current)}catch(f){$("error",f instanceof Error?f.message:"USB-forbindelse mislykkedes.");try{await ui.disconnect()}catch(v){$("error",v instanceof Error?`USB-porten kunne ikke lukkes: ${v.message}`:"USB-porten kunne ikke lukkes.");return}it(v=>{const x=v+1;return x>=3&&($("info","USB-forbindelsen er mislykkedes flere gange. Hvis Picoen er i BOOTSEL eller mangler MicroPython, kan du bruge MicroPython-download."),Ce(!0)),x}),k(!1)}finally{R(!1)}}}async function yc(f){const v=await f.exec(`import sys
print(sys.implementation.name)
`,4e3);if(v.error||!v.output.toLowerCase().includes("micropython"))throw new Error("MicroPython blev ikke fundet på Picoen.")}async function xc(){var f;try{await((f=Kr.current)==null?void 0:f.disconnect()),Hn.current=null,gt.current=null,k(!1),ll()}catch(v){$("error",v instanceof Error?`USB-porten kunne ikke lukkes: ${v.message}`:"USB-porten kunne ikke lukkes.")}}async function hn(f){const v=gt.current;if(v){V(!0),Sn.current=!0;try{await f(v)}catch(x){D(null),$("error",x instanceof Error?x.message:"USB filhandling fejlede.")}finally{Sn.current=!1,V(!1)}}}async function vt(f=!0){if(ve){V(!0);try{const v=await p();P(v),f&&$("success",`Indlæste ${v.length} filer fra Pico via Bluetooth.`)}catch(v){$("error",v instanceof Error?v.message:"BLE filhandling fejlede.")}finally{V(!1)}return}await hi(gt.current,f)}async function hi(f,v=!0){if(f){V(!0);try{const x=await al(()=>f.list("/"));P(x),v&&$("success",`Indlæste ${x.length} filer fra Pico.`)}catch(x){$("error",x instanceof Error?x.message:"USB filhandling fejlede.")}finally{V(!1)}}}async function Xl(){if(ve){V(!0),D({value:4,label:"Tjekker biblioteker på Pico via Bluetooth..."});try{const f=await Ns((v,x)=>D({value:v,label:x}));ue(f),zt("Fil-tjek færdigt")}catch(f){D(null),$("error",f instanceof Error?f.message:"BLE runtime check fejlede.")}finally{V(!1)}return}await Rs(gt.current)}async function Ns(f){const v=[],x=ei.filter(N=>N.kind==="library"&&!Ol(N));let j=0;for(const N of ei){if(N.kind==="program"){v.push({...N,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}if(Ol(N)){v.push({...N,status:"unknown",detail:"Opdateres via USB"});continue}try{const te=j/Math.max(1,x.length)*100,ce=100/Math.max(1,x.length);$("info",`Tjekker ${N.label} på Pico via Bluetooth...`),f==null||f(Math.min(95,te),`Tjekker ${N.label} på Pico...`);const Ve=await _(N.path,($e,tt)=>{f==null||f(Math.min(95,te+$e/100*ce),`${N.label}: ${tt}`)}),Me=Dl(Ve)===Dl(N.content);v.push({...N,status:Me?"ok":"outdated",detail:Me?"Matcher appens version":"Kan installeres via Bluetooth"})}catch{v.push({...N,status:"missing",detail:"Mangler på Pico"})}finally{j+=1}}return f==null||f(100,"Fil-tjek færdigt"),v}async function Rs(f){if(f){V(!0);try{const v=await al(()=>pi(f)),x=v;ue(x)}catch(v){$("error",v instanceof Error?v.message:"Runtime check fejlede.")}finally{V(!1)}}}async function pi(f){if(!f)return[];const v=[];for(const x of ei){if(x.kind==="program"){v.push({...x,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}try{const j=await f.readText(x.path),N=Dl(j)===Dl(x.content);v.push({...x,status:N?"ok":"outdated",detail:N?"Matcher appens version":"Matcher ikke appens version"})}catch{v.push({...x,status:"missing",detail:"Mangler på Pico"})}}return v}async function wc(f=Z){if(ve){vc(f);return}be(f),await hn(async v=>{D({value:12,label:`Indlæser ${Ae(f)}...`});const x=await kc(v,f);_t(f,x,"pico"),$t(f,x),zt("Fil indlæst")}),be(null)}async function kc(f,v){var x;try{return await f.readText(v)}catch(j){await((x=Hn.current)==null?void 0:x.stop().catch(()=>{})),await Mv(120);try{return await f.readText(v)}catch{throw j}}}function Sc(){se(!0)}async function As(){if(Ee==="pico"){if(!w&&!ve){$("error","Ingen Pico-forbindelse. Brug Gem for at vælge en anden placering.");return}await gi();return}wa()}function wa(){if(Ll(Z)){$("error",ds);return}mr(Z,J,!1),ze("local"),tn(f=>({...f,[Wt("local",Z)]:J})),se(!1),$("success",`Gemte ${Ae(Z)} lokalt.`)}async function gi(){if(se(!1),Ll(Z))return D(null),$("error",ds),!1;if(D({value:0,label:"Starter gemning..."}),ve){V(!0);try{return await m(Z,J,(v,x)=>D({value:v,label:x})),$t(Z,J),ze("pico"),tn(v=>({...v,[Wt("pico",Z)]:J})),zt("Gemt på Pico via Bluetooth"),$("success",`Gemte ${Ae(Z)} på Pico via Bluetooth.`),Jo(Z)&&(Tt(!0),$("warning","main.py er gemt. Genstart Picoen for at køre den nye version.")),await vt(!1),!0}catch(v){return D(null),$("error",v instanceof Error?v.message:"BLE gem fejlede."),!1}finally{V(!1)}}if(!gt.current)return D(null),!1;let f=!1;return await hn(async v=>{il(Z,"pico")?await v.replaceTextSafely(Z,J,(x,j)=>D({value:x,label:j})):await v.writeText(Z,J,(x,j)=>D({value:x,label:j})),$t(Z,J),ze("pico"),tn(x=>({...x,[Wt("pico",Z)]:J})),zt("Gemt på Pico via USB"),$("success",`Gemte ${Z}.`),await vt(),await Xl(),f=!0}),f}function Ec(){Cs(Ae(Z),J),se(!1),$("success",`Downloadede ${Ae(Z)}.`)}function Cs(f,v){const x=new Blob([v],{type:"text/plain;charset=utf-8"}),j=URL.createObjectURL(x),N=document.createElement("a");N.href=j,N.download=f,N.click(),URL.revokeObjectURL(j)}async function _i(f){V(!0),Tt(!1),D({value:10,label:"Genstarter Pico..."});try{await b(f)?(zt("Pico genforbundet"),$("success",f==="control"?"Pico genforbundet. Åbner kontrolpanelet.":"Pico genforbundet til Kodeværkstedet."),f==="ide"&&await vt()):(D(null),$("warning","Automatisk genforbindelse lykkedes ikke. Vælg Picoen fra dashboardet."))}catch(v){D(null),$("error",v instanceof Error?v.message:"Genstart/genforbindelse mislykkedes.")}finally{V(!1)}}function Ds(f){var te,ce;const v=f??{path:Z,source:Ee},x=v.source==="pico"?"Pico":"browser",j=(f==null?void 0:f.versions.length)??(v.source==="pico"?((te=ti(X).get(v.path))==null?void 0:te.length)??0:((ce=ti(lc(de)).get(v.path))==null?void 0:ce.length)??0),N=j>0?` Det sletter også filens versionshistorik (${j} gemte versioner).`:"";ee(null),l({title:"Slet fil",message:`Vil du slette ${Ae(v.path)} fra ${x}?${N}`,confirmLabel:"Slet",onConfirm:()=>{jc(v)}})}function Tc(){l({title:"Nulstil enhed",message:"Vil du nulstille Picoens enhedsindstillinger? Det sletter DeviceSettings.txt, så Picoen kan oprettes som en ny enhed igen. Kodefiler og startprogram bliver ikke slettet.",confirmLabel:"Nulstil",onConfirm:()=>{Mc()}})}async function Mc(){if(!gt.current){$("error","Forbind Picoen med USB først.");return}await hn(async f=>{await f.delete("/DeviceSettings.txt").catch(v=>{const x=v instanceof Error?v.message:"";if(!/ENOENT|No such file|not found/i.test(x))throw v}),qn(v=>{const x={...v};return delete x["/DeviceSettings.txt"],x}),Er("/DeviceSettings.txt","pico"),$("success","DeviceSettings.txt er nulstillet. Afbryd og forbind Picoen igen, hvis kontrolpanelet allerede var åbent."),await vt()})}function Os(f,v,x){const j=xa.filter(ce=>ce.kind==="file"&&ce.type==="file"),N=j.findIndex(ce=>ce.path===f&&ce.source===v);if(N===-1)return null;const te=ce=>!!ce&&!(ce.path===f&&ce.source===v)&&!(ce.source===v&&x.has(ce.path))&&!(ve&&Ol(ce));for(const ce of[!0,!1])for(let Ve=1;Ve<j.length;Ve+=1){const Me=j[N+Ve];if(te(Me)&&(!ce||Me.source===v))return Me;const $e=j[N-Ve];if(te($e)&&(!ce||$e.source===v))return $e}return null}function vi(f){if(f){Mr(f);return}const v=ec(Ko())[0];_t(v.path,en[Wt("local",v.path)]??v.content,"local")}async function jc(f){const v=f.path,x=f.source,j=v===Z&&x===Ee;if(x==="local"){const Me=ti(lc(de)).get(v)??[],$e=new Set([v,...Me.map(ot=>ot.path)]),tt=j?Os(v,x,$e):null,an=de.filter(ot=>!$e.has(ot.path));W(an),ss(an);for(const ot of $e)Er(ot,"local");j&&vi(tt);const Oe=Me.length>0?` og ${Me.length} gemte versioner`:"";$("warning",`Slettede ${Ae(v)}${Oe} fra browseren.`);return}const N=ti(X).get(v)??[],te=[v,...N.map(Me=>Me.path)],ce=j?Os(v,x,new Set(te)):null;if(ve){V(!0);try{for(const $e of te)await g($e);qn($e=>{const tt={...$e};for(const an of te)delete tt[an];return tt});for(const $e of te)Er($e,"pico");const Me=N.length>0?` og ${N.length} gemte versioner`:"";$("warning",`Slettede ${Ae(v)}${Me} på Pico via Bluetooth.`),await vt(),j&&vi(ce)}catch(Me){$("error",Me instanceof Error?Me.message:"BLE sletning fejlede.")}finally{V(!1)}return}if(!gt.current){$("error","Ingen Pico-forbindelse. Kan ikke slette Pico-filen.");return}let Ve=!1;await hn(async Me=>{for(const tt of te)await Me.delete(tt);qn(tt=>{const an={...tt};for(const Oe of te)delete an[Oe];return an});const $e=N.length>0?` og ${N.length} gemte versioner`:"";$("warning",`Slettede ${v}${$e}.`);for(const tt of te)Er(tt,"pico");await vt(),await Xl(),Ve=!0}),Ve&&j&&vi(ce)}async function Nc(f){if(!f)return;const v=Nv(f.name);if(!v){$("error","Kun .py, .txt, .json og .csv kan importeres.");return}if(Ll(v)){$("error",ds);return}if(f.size>128*1024){$("error","Filen er for stor til Pico-værkstedet.");return}const x=await f.text();if(Ee==="local"){mr(v,x,!0),_t(v,x,"local"),$("success",`Importerede ${Ae(v)} i browseren.`);return}if(!w&&!ve){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(ve&&Ol({path:v})){$("error","PicoBluetooth.py kan ikke importeres over Bluetooth, mens den holder forbindelsen i gang. Brug USB i stedet.");return}if(D({value:0,label:"Uploader fil til Pico..."}),ve){V(!0);try{await m(v,x,(N,te)=>D({value:N,label:te})),$t(v,x),_t(v,x,"pico"),zt("Fil uploadet til Pico"),$("success",`Importerede ${Ae(v)} på Pico via Bluetooth.`),await vt()}catch(N){D(null),$("error",N instanceof Error?N.message:"Kunne ikke importere filen til Pico.")}finally{V(!1)}return}if(!gt.current){D(null),$("error","Ingen Pico-forbindelse. Kan ikke importere filen til Pico.");return}await hn(async N=>{il(v,"pico")?await N.replaceTextSafely(v,x,(te,ce)=>D({value:te,label:ce})):await N.writeText(v,x,(te,ce)=>D({value:te,label:ce})),$t(v,x),_t(v,x,"pico"),zt("Fil uploadet til Pico"),$("success",`Importerede ${Ae(v)} på Pico.`),await vt(),await Xl()})}async function Rc(){me(""),ne(!0)}function Ac(){const f=dh(he);if(!f)return;if(Ll(f)){$("error",ds);return}const v=Ee;if(il(f,v)){$("error",`Der findes allerede en fil med navnet ${Ae(f)} i ${v==="pico"?"Pico":"browseren"}.`);return}if(v==="local"){mr(f,"",!1),_t(f,"","local"),ne(!1),$("success",`Oprettede ${Ae(f)} i browseren.`);return}bi(f)}async function bi(f){if(!w&&!ve){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(ne(!1),D({value:0,label:"Opretter fil på Pico..."}),ve){V(!0);try{await m(f,"",(v,x)=>D({value:v,label:x})),$t(f,""),_t(f,"","pico"),zt("Fil oprettet på Pico"),$("success",`Oprettede ${Ae(f)} på Pico via Bluetooth.`),await vt()}catch(v){D(null),$("error",v instanceof Error?v.message:"Kunne ikke oprette fil på Pico.")}finally{V(!1)}return}if(!gt.current){D(null),$("error","Ingen Pico-forbindelse. Kan ikke oprette Pico-filen.");return}await hn(async v=>{await v.writeText(f,"",(x,j)=>D({value:x,label:j})),$t(f,""),_t(f,"","pico"),zt("Fil oprettet på Pico"),$("success",`Oprettede ${Ae(f)} på Pico.`),await vt()})}function Kl(f){f.type==="file"&&(ee(f),E(Rv(f.path)))}async function Cc(f){if(!U)return;const v=U.path;if(ee(null),U.source==="local"){const x=de.find(j=>j.path===f.path);if(!x){$("error","Kunne ikke finde versionen i browseren.");return}Yl(v,x.content),_t(v,x.content,"local"),$("success",`Gendannede ${Ae(f.path)} i browseren.`);return}if(D({value:0,label:"Gendanner version..."}),ve){V(!0);try{const x=await _(f.path);await m(v,x,(j,N)=>D({value:j,label:N})),$t(v,x),_t(v,x,"pico"),zt("Version gendannet"),await vt(!1)}catch(x){D(null),$("error",x instanceof Error?x.message:"Kunne ikke gendanne versionen.")}finally{V(!1)}return}gt.current&&await hn(async x=>{await x.replaceTextSafely(v,await x.readText(f.path),(N,te)=>D({value:N,label:te}));const j=await x.readText(v);$t(v,j),_t(v,j,"pico"),zt("Version gendannet"),await vt()})}function Ls(f){const v=(U==null?void 0:U.source)==="local"?"browseren":"Pico";l({title:"Slet version",message:`Vil du slette ${Ae(f.path)} fra ${v}?`,confirmLabel:"Slet",onConfirm:()=>{Bs(f)}})}async function Bs(f){if((U==null?void 0:U.source)==="local"){const v=de.filter(x=>x.path!==f.path);W(v),ss(v),Er(f.path,"local"),ee(x=>x&&{...x,versions:x.versions.filter(j=>j.path!==f.path)}),$("warning",`Slettede ${Ae(f.path)} fra browserens versionshistorik.`);return}if(ve){V(!0);try{await g(f.path),await vt(!1),ee(v=>v&&{...v,versions:v.versions.filter(x=>x.path!==f.path)})}catch(v){$("error",v instanceof Error?v.message:"Kunne ikke slette versionen.")}finally{V(!1)}return}gt.current&&await hn(async v=>{await v.delete(f.path),await vt(!1),ee(x=>x&&{...x,versions:x.versions.filter(j=>j.path!==f.path)})})}async function zs(){var x;if(!U)return;const f=U,v=Gv(f.path,j=>il(j,f.source));if(!v){$("error",`Kunne ikke finde et ledigt filnavn til en kopi af ${Ae(f.path)}.`);return}if(f.source==="local"){const j=en[Wt("local",f.path)]??((x=de.find(N=>N.path===f.path))==null?void 0:x.content)??"";mr(v,j,!1),_t(v,j,"local"),ee(null),$("success",`Duplikerede ${Ae(f.path)} til ${Ae(v)} i browseren.`);return}if(ee(null),D({value:0,label:"Duplikerer fil..."}),ve){V(!0);try{const j=Un[f.path]??await _(f.path);await m(v,j,(N,te)=>D({value:N,label:te})),$t(v,j),_t(v,j,"pico"),zt("Fil duplikeret"),await vt(!1),$("success",`Duplikerede ${Ae(f.path)} til ${Ae(v)} på Pico via Bluetooth.`)}catch(j){D(null),$("error",j instanceof Error?j.message:"Kunne ikke duplikere filen.")}finally{V(!1)}return}if(!gt.current){D(null),$("error","Ingen Pico-forbindelse. Kan ikke duplikere Pico-filen.");return}await hn(async j=>{const N=await j.readText(f.path);await j.writeText(v,N,(te,ce)=>D({value:te,label:ce})),$t(v,N),_t(v,N,"pico"),zt("Fil duplikeret"),await vt(!1),$("success",`Duplikerede ${Ae(f.path)} til ${Ae(v)} på Pico.`)})}async function Us(){if(!U)return;const f=U,v=qd(we,fs(f.path));if(!v||v===f.path)return;if(Ll(v)){$("error",ds);return}if(il(v,f.source)){$("error",`Der findes allerede en fil med navnet ${Ae(v)}.`);return}const x=f.source==="local",j=f.source==="pico";if(ve&&j&&(Jo(f.path)||Jo(v))){$("error","main.py kan redigeres over Bluetooth, men ikke omdøbes. Gem den som main.py.");return}V(!0);try{if(j)if(ve){const N=Un[f.path]??await _(f.path);await m(v,N,(te,ce)=>D({value:te,label:ce})),await g(f.path),qn(te=>({...yh(te,f.path,v),[v]:N}))}else gt.current&&(await al(()=>gt.current.rename(f.path,v)),qn(N=>yh(N,f.path,v)));x&&W(N=>{const te=N.map(ce=>ce.path===f.path?{...ce,path:v,updatedAt:Date.now()}:ce);return ss(te),te}),Z===f.path&&Ee===f.source&&ke(v),tn(N=>Qv(N,f.source,f.path,v)),ee(null),E(""),$("success",`Omdøbte ${Ae(f.path)} til ${Ae(v)}.`),j&&await vt()}catch(N){$("error",N instanceof Error?N.message:"Kunne ikke omdøbe filen.")}finally{D(null),V(!1)}}function il(f,v){return v==="pico"?X.some(x=>x.path===f):de.some(x=>x.path===f)}function Mr(f){if(f.type!=="file"){ve&&ar(void 0,!1),ke(f.path),ze(f.source);return}if(ve&&Ol(f)){$("warning","PicoBluetooth.py holder Bluetooth-forbindelsen i gang og kan ikke åbnes her.");return}if(f.source==="local"){ve&&ar(void 0,!1);const x=de.find(j=>j.path===f.path);_t(f.path,en[Wt("local",f.path)]??(x==null?void 0:x.content)??"","local");return}const v=Wt("pico",f.path);if(Object.prototype.hasOwnProperty.call(en,v)){ve&&ar(void 0,!1),_t(f.path,en[v],"pico");return}if(Object.prototype.hasOwnProperty.call(Un,f.path)){ve&&ar(void 0,!1),_t(f.path,Un[f.path],"pico");return}wc(f.path)}async function qs(){if(!w&&!ve){const f=fh();ue(f),fe(mh(f)),xe(!0),D(null);return}V(!0),D({value:4,label:ve?"Tjekker biblioteker på Pico via Bluetooth...":"Tjekker biblioteker på Pico..."}),$("info",ve?"Tjekker om Picoens biblioteker er opdaterede via Bluetooth før installation...":"Tjekker om Picoens biblioteker er opdaterede før installation...");try{const f=je.length>0?je:ve?await Ns((v,x)=>D({value:v,label:x})):await al(()=>pi(gt.current));ue(f),fe(mh(f)),xe(!0),D(null)}catch(f){D(null),$("error",f instanceof Error?f.message:"Fil-tjek før installation fejlede.")}finally{V(!1)}}async function Dc(){if(xe(!1),ve){V(!0);try{const v=(je.length>0?je:ei.map(j=>({...j,status:"unknown",detail:"Ikke tjekket"}))).filter(j=>Ue[j.id]&&!Ol(j));if(v.length===0){$("info","Ingen filer valgt til installation.");return}let x=null;D({value:0,label:"Starter installation..."});for(const[j,N]of v.entries()){$("info",`Installerer ${N.label} via Bluetooth...`);const te=j/v.length*100,ce=100/v.length;await m(N.path,N.content,(Ve,Me)=>{D({value:Math.min(99,te+Ve/100*ce),label:`${N.label}: ${Me}`})}),$l(N.path,N.content),$("success",`Installerede ${N.label}.`),N.kind==="library"&&(x=N),Jo(N.path)&&Tt(!0)}zt("Installation færdig"),await vt(!1),await Xl(),x&&sl(x)}catch(f){D(null),$("error",f instanceof Error?f.message:"BLE installation fejlede.")}finally{V(!1)}return}await hn(async f=>{const x=(je.length>0?je:ei.map(N=>({...N,status:"unknown",detail:"Ikke tjekket"}))).filter(N=>Ue[N.id]);if(x.length===0){$("info","Ingen filer valgt til installation.");return}let j=null;D({value:0,label:"Starter installation..."});for(const[N,te]of x.entries()){$("info",`Installerer ${te.label}...`);const ce=N/x.length*100,Ve=100/x.length,Me=await f.readText(te.path).catch(()=>null);Me!==null&&Dl(Me)===Dl(te.content)?(D({value:Math.min(99,ce+Ve),label:`${te.label}: Allerede nyeste version`}),$("info",`${te.label} findes allerede i samme version.`)):(await f.replaceTextSafely(te.path,te.content,($e,tt)=>{D({value:Math.min(99,ce+$e/100*Ve),label:`${te.label}: ${tt}`})},{createBackup:!0}),$("success",`Installerede ${te.label}.`)),$l(te.path,te.content),te.kind==="library"&&(j=te)}zt("Installation færdig"),await vt(!1),await Xl(),j&&sl(j)})}function Hs(){return(je.length>0?je:fh()).filter(v=>Ue[v.id])}function Vs(){const f=Hs();if(f.length===0){$("info","Ingen filer valgt.");return}for(const v of f)Yl(v.path,v.content);xe(!1),$("success",`Gemte ${f.length} filer i browseren.`)}function Ps(){const f=Hs();if(f.length===0){$("info","Ingen filer valgt.");return}f.forEach((v,x)=>{window.setTimeout(()=>{Cs(Ae(v.path),v.content)},x*120)}),xe(!1),$("success",`Starter download af ${f.length} filer.`)}function sl(f){_t(f.path,f.content,"pico"),$t(f.path,f.content),$("info",`Åbnede ${f.label} i editoren.`)}function Ql(f,v){fe(x=>{if(f.kind!=="program")return{...x,[f.id]:v};const j={...x};for(const N of je)N.kind==="program"&&(j[N.id]=!1);return j[f.id]=v,j})}async function Oc(){if(Bc(),ve&&Ee==="pico"){$("warning","Bluetooth holder forbindelsen åben, så koden kan ikke køres direkte her. Gem filen, og genstart Picoen for at køre den.");return}if(Ee==="local"){await ka();return}const f=Hn.current;if(!f){$("error",`${Ae(Z)} er gemt på Picoen, men der er ingen USB-forbindelse til Pico-terminalen.`);return}if(Z.endsWith(".py")){if(!va()&&($("info",`${Ae(Z)} har ikke gemte ændringer. Gemmer på Picoen før kørsel...`),!await gi())){$("error","Pico-forbindelsen blev afbrudt under gemning.");return}if(F)return;Il(),nn.current="",Mt(!0);try{await f.runFile(Z,()=>{Il(),nn.current="",xr.current=!1,Jn(!0),kn.current=!0}),$("success",`Kører ${Ae(Z)}. Brug Stop for at afbryde.`)}catch(v){Jn(!1),kn.current=!1,Il(),nn.current="",$("error",v instanceof Error?v.message:"Kunne ikke starte koden.")}return}V(!0);try{const v=await f.exec(J,2e4);v.output.trim()&&$("info",v.output),v.error.trim()&&tl(v.error,J),!v.output.trim()&&!v.error.trim()&&$("success","Koden kørte uden output.")}catch(v){$("error",v instanceof Error?v.message:"Kunne ikke køre koden.")}finally{V(!1)}}async function ka(){const f=Xd(J,{allowInput:!0});if(f.some(j=>j.level==="error")){for(const j of f){const N=j.line?`Linje ${j.line}: `:"";$(j.level==="error"?"error":"warning",`${N}${j.text}`)}return}/\binput\s*\(/.test(J)&&!Qh()&&$("warning","input() i browseren kræver at siden genindlæses. Opdater siden (F5) og prøv igen.");const v=new AbortController;bt.current=v;const x=new cv;mn.current=x,V(!0),zl(!0),Mt(!0),$("info",w?"Starter Browser-MicroPython for browser-filen.":"Starter Browser-MicroPython. Forbind Pico med USB for at køre på selve Picoen.");try{const j=[],N=await x.run(J,{timeoutMs:null,signal:v.signal,onOutput:Me=>{j.push(Me),$("info",Me)}});for(const Me of N.issues){const $e=Me.line?`Linje ${Me.line}: `:"";$(Me.level==="error"?"error":"warning",`${$e}${Me.text}`)}const te=[...j,N.output].filter(Boolean).join(`
`).trim(),ce=N.output.trim();!N.error.trim()&&Cv(te)?tl(te,J):(ce&&$("info",ce),N.error.trim()&&tl(N.error,J,N.unavailable?"warning":"error")),N.ok&&!te&&!N.error.trim()&&$("success","Browser-MicroPython kørte uden output.")}finally{bt.current=null,mn.current=null,x.dispose(),zl(!1),V(!1)}}async function Is(){var v,x,j;if(dr){(v=bt.current)==null||v.abort(),(x=mn.current)==null||x.stop(),$("warning","Stoppede Browser-MicroPython."),Mt(!0);return}if(!Mn&&pt){(j=tr.current)==null||j.reset(),wn(!1),$("warning","Stoppede Browser-MicroPython-terminalen. Variablerne i browser-terminalen blev nulstillet."),Mt(!0);return}const f=Hn.current;if(f)try{await f.stop(),$("warning","Stoppede koden på Pico.")}catch(N){$("error",N instanceof Error?N.message:"Kunne ikke stoppe koden.")}finally{Jn(!1),kn.current=!1,Il(),nn.current="",Mt(!0),Vn()}}function Fs(){const f=Qr.current;if(!f)return;const v=f.scrollHeight-f.scrollTop-f.clientHeight<12;Mt(v)}function yi(){G([]),Mt(!0)}function xi(){window.requestAnimationFrame(()=>{const f=Qr.current;f&&(f.scrollTop=f.scrollHeight)})}async function Sa(){const f=Bt?un:un.trimEnd();if(Bt){if(!Mn){const j=mn.current;if(!j){$("warning","Browser-MicroPython kører ikke lige nu."),jn();return}xn(""),Mt(!0),Ms(f),j.sendInput(f),jn();return}const x=Hn.current;if(!x){$("warning","Pico-terminalen er ikke forbundet."),jn();return}xn(""),Mt(!0);try{await x.sendProgramInput(f)}catch(j){$("error",j instanceof Error?j.message:"Kunne ikke sende input til Pico-koden.")}finally{jn()}return}if(!f.trim())return;if(Qe(x=>(x.at(-1)===f?x:[...x,f]).slice(-80)),st(null),Ht(null),Pl){$("warning",Mn?"Tryk Stop, før du skriver i Pico-terminalen.":"Stop offline MicroPython, før du skriver i browser-terminalen."),jn();return}if(!Mn){const x=Xd(f);if(x.some(N=>N.level==="error")){for(const N of x){const te=N.line?"Linje "+N.line+": ":"";$(N.level==="error"?"error":"warning",te+N.text)}jn();return}const j=tr.current??new ov;tr.current=j,xn(""),wn(!0),Mt(!0),$("info",">>> "+f);try{let N=!1;const te=await j.send(f,{timeoutMs:15e3,onOutput:Ve=>{N=!0,$("info",Ve)}}),ce=te.output.trim();ce&&!N&&$("info",ce),te.error.trim()&&tl(te.error,f,te.unavailable?"warning":"error")}catch(N){$("error",N instanceof Error?N.message:"Browser-MicroPython-terminalen fejlede.")}finally{wn(!1),jn()}return}if(ve){$("warning","Terminalen bruger USB Serial. Bluetooth-forbindelsen kan vise filer, men kan ikke modtage frie terminalkommandoer."),jn();return}const v=Hn.current;if(!w||!v){$("warning","Forbind en microcontroller med USB for at skrive i MicroPython-terminalen."),jn();return}xn(""),wn(!0),Mt(!0),xr.current=!0,$("info",">>> "+f);try{await v.sendFriendlyLine(f)}catch(x){xr.current=!1,$("error",x instanceof Error?x.message:"Kunne ikke sende kommando til MicroPython REPL.")}finally{wn(!1),jn()}}function jn(){window.requestAnimationFrame(()=>{const f=Wr.current;if(!f||f.disabled)return;f.focus();const v=f.value.length;f.selectionStart=v,f.selectionEnd=v})}function wi(f,v,x){if(x.length===0)return null;const j=w||ve;return u.jsxs("div",{className:"ide-install-group",children:[u.jsxs("div",{className:"ide-install-group-head",children:[u.jsx("h3",{children:f}),u.jsx("p",{children:v})]}),u.jsx("div",{className:"ide-install-scroll",children:x.map(N=>{const te=ve&&Ol(N);return u.jsxs("label",{className:`ide-install-row ${te?"disabled":""}`,children:[u.jsx("input",{type:"checkbox",checked:!!Ue[N.id],disabled:te,onChange:ce=>Ql(N,ce.target.checked)}),u.jsxs("span",{children:[u.jsxs("strong",{children:[Lc(N),j&&N.kind==="library"&&u.jsx("em",{className:`ide-install-status status-${N.status}`,children:te?"USB":$v(N.status)})]}),u.jsx("small",{children:N.description})]})]},N.id)})})]})}function Lc(f){return f.kind==="program"?f.label.replace(/\s*\(main\.py\)$/i,""):f.label}function Bc(){fr&&G([]),Mt(!0)}function ki(f,v){const x=f.indexOf(`
`,v);return x===-1?f.length:x}function Ea(f,v){if(gh(f,v)){ft(null);return}const x=Zd(f,v);if(!x||x.query.length<1){ft(null);return}const j=ph(f,v,!0).slice(0,8),N=_h(Ft.current,x.start,j.length);j.length>0&&N?(ft({items:j,selected:0,start:x.start,end:v,position:N}),In(er.current,0)):ft(null)}function Si(f,v){if(gh(f,v)){Ht(null);return}const x=Zd(f,v);if(!x||x.query.length<1){Ht(null);return}const j=ph(f,v,!1).slice(0,8),N=_h(Wr.current,x.start,j.length);j.length>0&&N?(Ht({items:j,selected:0,start:x.start,end:v,position:N}),In(ha.current,0)):Ht(null)}function ln(f){const v=f.value.slice(f.selectionStart,f.selectionEnd);Ul(qv(v)?v:"")}function In(f,v){window.requestAnimationFrame(()=>{const x=f==null?void 0:f.querySelector(`[data-autocomplete-index="${v}"]`);x==null||x.scrollIntoView({block:"nearest"})})}function Ta(f=We==null?void 0:We.items[We.selected]){if(!f||!We)return;const v=nl(),x=J.slice(0,We.start)+f.insert+J.slice(We.end),j=We.start+f.insert.length-(f.insert.endsWith("()")?1:0);ft(null),Gt(x,j,v),window.requestAnimationFrame(()=>{const N=Ft.current;N&&N.focus()})}function Ei(f=mt==null?void 0:mt.items[mt.selected]){if(!f||!mt)return;const v=un.slice(0,mt.start)+f.insert+un.slice(mt.end),x=mt.start+f.insert.length-(f.insert.endsWith("()")?1:0);xn(v),Ht(null),window.requestAnimationFrame(()=>{const j=Wr.current;j&&(j.focus(),j.selectionStart=x,j.selectionEnd=x)})}function Gs(f){const v=Ft.current;if(!v)return!1;const x=v.selectionStart,j=v.selectionEnd,N={content:J,selectionStart:x,selectionEnd:j},te=J.lastIndexOf(`
`,x-1)+1,ce=j>x&&J[j-1]===`
`?j-1:j,Ve=ki(J,ce),Me=Ve<J.length?Ve+1:Ve,$e=J.slice(te,Me);if(f<0){if(te===0)return!1;const ir=J.lastIndexOf(`
`,te-2)+1,sr=J.slice(ir,te),Nr=J.slice(0,ir)+$e+sr+J.slice(Me),Rr=-sr.length;return Gt(Nr,x+Rr,N,j+Rr),!0}if(Me>=J.length)return!1;const tt=ki(J,Me),an=tt<J.length?tt+1:tt,Oe=J.slice(Me,an),ot=J.slice(0,te)+Oe+$e+J.slice(an),jr=Oe.length;return Gt(ot,x+jr,N,j+jr),!0}function $s(f){var an;if(Vl){(f.key==="Enter"||f.key==="Tab"||(f.ctrlKey||f.metaKey)&&["z","y","s"].includes(f.key.toLowerCase()))&&f.preventDefault();return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="z"){f.preventDefault(),(f.shiftKey?rl():mi())&&ft(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="y"){f.preventDefault(),rl()&&ft(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="s"){f.preventDefault(),!F&&Z.trim()&&As();return}if(f.altKey&&!f.ctrlKey&&!f.metaKey&&(f.key==="ArrowUp"||f.key==="ArrowDown")){f.preventDefault(),Gs(f.key==="ArrowUp"?-1:1)&&ft(null);return}if(We){if(f.key==="ArrowDown"){f.preventDefault(),ft(Oe=>{if(!Oe)return Oe;const ot=(Oe.selected+1)%Oe.items.length;return In(er.current,ot),{...Oe,selected:ot}});return}if(f.key==="ArrowUp"){f.preventDefault(),ft(Oe=>{if(!Oe)return Oe;const ot=(Oe.selected-1+Oe.items.length)%Oe.items.length;return In(er.current,ot),{...Oe,selected:ot}});return}if(f.key==="Tab"){f.preventDefault(),Ta();return}if(f.key==="Enter"){if(!(We.items[We.selected]&&ep(We.items[We.selected],J.slice(We.start,We.end)))){f.preventDefault(),Ta();return}ft(null)}if(f.key==="Escape"){f.preventDefault(),ft(null);return}}if(f.key==="Enter"){f.preventDefault();const Oe=f.currentTarget,ot=Oe.selectionStart,jr=Oe.selectionEnd,ir={content:J,selectionStart:ot,selectionEnd:jr},sr=J.lastIndexOf(`
`,ot-1)+1,Nr=J.slice(sr,ot),Rr=((an=Nr.match(/^[ \t]*/))==null?void 0:an[0])??"",Ma=Nr.trimEnd().endsWith(":")?"    ":"",sn=`
${Rr}${Ma}`,ol=J.slice(0,ot)+sn+J.slice(jr),Pt=ot+sn.length;Gt(ol,Pt,ir),window.requestAnimationFrame(()=>{Oe.selectionStart=Pt,Oe.selectionEnd=Pt});return}if(f.key!=="Tab")return;f.preventDefault();const v=f.currentTarget,x=v.selectionStart,j=v.selectionEnd,N={content:J,selectionStart:x,selectionEnd:j},te="    ";if(f.shiftKey){const Oe=J.lastIndexOf(`
`,x-1)+1,ot=x===j?ki(J,x):j,jr=J.slice(Oe,ot);let ir=0,sr=0;const Nr=jr.replace(/(^|\n)( {1,4}|\t)/g,(Ma,sn,ol,Pt)=>{const Ar=ol.length;return Oe+Pt<x&&(ir+=Ar),sr+=Ar,sn});if(sr===0)return;const Rr=J.slice(0,Oe)+Nr+J.slice(ot);Gt(Rr,Math.max(Oe,x-ir),N,x===j?Math.max(Oe,x-ir):Math.max(Oe,j-sr)),window.requestAnimationFrame(()=>{v.selectionStart=Math.max(Oe,x-ir),v.selectionEnd=x===j?v.selectionStart:Math.max(v.selectionStart,j-sr)});return}if(x===j){const Oe=J.slice(0,x)+te+J.slice(j);Gt(Oe,x+te.length,N),window.requestAnimationFrame(()=>{v.selectionStart=x+te.length,v.selectionEnd=x+te.length});return}const ce=J.lastIndexOf(`
`,x-1)+1,Me=J.slice(ce,j).replace(/^/gm,te),$e=Me.split(`
`).length,tt=J.slice(0,ce)+Me+J.slice(j);Gt(tt,x+te.length,N,j+$e*te.length),window.requestAnimationFrame(()=>{v.selectionStart=x+te.length,v.selectionEnd=j+$e*te.length})}function Ti(f){if(Bt){f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),Sa());return}if(mt){if(f.key==="ArrowDown"){f.preventDefault(),Ht(v=>{if(!v)return v;const x=(v.selected+1)%v.items.length;return In(ha.current,x),{...v,selected:x}});return}if(f.key==="ArrowUp"){f.preventDefault(),Ht(v=>{if(!v)return v;const x=(v.selected-1+v.items.length)%v.items.length;return In(ha.current,x),{...v,selected:x}});return}if(f.key==="Enter"||f.key==="Tab"){f.preventDefault(),Ei();return}if(f.key==="Escape"){f.preventDefault(),Ht(null);return}}if(f.key==="Tab"){f.preventDefault();const v=f.currentTarget,x=v.selectionStart,j=v.selectionEnd,N="    ",te=un.slice(0,x)+N+un.slice(j),ce=x+N.length;xn(te),st(null),Ht(null),window.requestAnimationFrame(()=>{v.selectionStart=ce,v.selectionEnd=ce});return}if(f.key==="ArrowUp"||f.key==="ArrowDown"){if(!(f.key==="ArrowUp"?f.currentTarget.selectionStart===0&&f.currentTarget.selectionEnd===0:f.currentTarget.selectionStart===un.length&&f.currentTarget.selectionEnd===un.length)||_e.length===0)return;f.preventDefault();const x=f.key==="ArrowUp"?Ge===null?_e.length-1:Math.max(0,Ge-1):Ge===null||Ge+1>=_e.length?null:Ge+1;st(x);const j=x===null?"":_e[x]??"";xn(j),Ht(null),Mt(!0),window.requestAnimationFrame(()=>{const N=Wr.current;N&&(N.selectionStart=j.length,N.selectionEnd=j.length,xi())});return}f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),Sa())}return u.jsxs("div",{className:"screen ide-screen",children:[u.jsx(of,{title:"Pico Kodeværksted",onMenu:()=>i()}),ma?u.jsx("div",{className:"ide-size-gate",role:"dialog","aria-modal":"true","aria-labelledby":"ide-size-title",children:u.jsxs("div",{className:"ide-size-gate-panel",children:[u.jsx("h2",{id:"ide-size-title",children:"Brug en bærbar for at bruge Kodeværkstedet"}),u.jsx("p",{children:"Denne skærm er for lille, så du skal åbne Kodeværkstedet på en bærbar eller en større skærm."})]})}):u.jsxs("div",{className:"ide-layout",children:[u.jsxs("section",{className:"ide-panel ide-files-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Filer"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:Rc,"aria-label":"Ny fil",title:"Ny fil",children:u.jsx(Dt,{name:"plus",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>{var f;return(f=si.current)==null?void 0:f.click()},"aria-label":"Importer fil",title:"Importer fil",children:u.jsx(Dt,{name:"upload",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>vt(),disabled:!w&&!ve||F,"aria-label":"Opdater filer",title:"Opdater filer",children:u.jsx(Dt,{name:"refresh",size:20})})]})]}),u.jsx("div",{className:"ide-file-list",children:xa.length===0?u.jsx("button",{type:"button",disabled:!0,children:"Ingen filer læst"}):xa.map(f=>{if(f.kind==="separator"){const N=f.id==="pico-files"&&!w&&!ve;return u.jsxs(C.Fragment,{children:[u.jsx("div",{className:`ide-file-separator ${f.id==="browser-files"?"browser-section":""}`,children:u.jsx("span",{children:f.label})}),N&&u.jsx("div",{className:"ide-file-disconnected",role:"status",children:"Ikke forbundet"})]},f.id)}const v=ve&&Ol(f),x=en[Wt(f.source,f.path)],j=x!==void 0&&x!==Iv(f,de,Un);return u.jsxs("div",{className:`ide-file-row ${Z===f.path&&Ee===f.source?"active":""} ${v?"protected":""}`,children:[u.jsxs("button",{type:"button",onClick:()=>Mr(f),disabled:v,title:v?"Holder Bluetooth-forbindelsen i gang og kan ikke åbnes her":void 0,children:[u.jsx("span",{children:f.name}),u.jsxs("small",{title:j?"Ikke gemte ændringer":"Ingen ikke gemte ændringer",children:[f.versions.length>0&&u.jsx("em",{className:"ide-file-version-count",title:`${f.versions.length} gemte versioner i historikken`,children:f.versions.length}),u.jsx("i",{className:`ide-file-dirty-dot ${j?"dirty":"clean"}`,"aria-hidden":"true"})]})]}),u.jsx("button",{className:"ide-file-actions",type:"button",onClick:()=>Kl(f),disabled:f.type!=="file"||F||v,"aria-label":`Filvalg for ${f.name}`,title:v?"Holder Bluetooth-forbindelsen i gang og kan ikke ændres her":"Filvalg",children:u.jsx(Dt,{name:"settings",size:16})})]},`${f.source}:${f.path}`)})})]}),u.jsxs("section",{className:"ide-panel ide-status-panel",children:[u.jsxs("div",{children:[u.jsxs("div",{className:"ide-status-head",children:[u.jsx("h2",{children:ve?"Forbundet Pico":"USB udvikling"}),!ve&&u.jsx("span",{className:`ide-usb-status ${rn.supported?"available":"unavailable"}`,title:rn.message,"data-tooltip":rn.message,role:"img","aria-label":rn.message,tabIndex:0,children:"!"})]}),ve&&u.jsxs("p",{children:[(s==null?void 0:s.deviceName)??"Pico"," er forbundet via Bluetooth."]})]}),!ve&&u.jsxs("div",{className:"ide-actions",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:w?xc:bc,disabled:!rn.supported||T,children:T?"Forbinder...":w?"Afbryd USB":"Forbind USB"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:qs,disabled:ve||F,children:"Download"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:Tc,disabled:!w||F,children:"Nulstil enhed"})]}),ve&&u.jsxs("div",{className:"ide-actions",children:[u.jsxs("button",{className:"btn btn-primary ide-connection-state",type:"button",disabled:!0,children:[u.jsx(Dt,{name:"power",size:22}),"Bluetooth forbundet"]}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:qs,disabled:F,children:"Startprogrammer og biblioteker"})]}),!ve&&u.jsx("div",{className:"ide-runtime",children:u.jsx("div",{className:"ide-mini-actions single",children:u.jsx("button",{className:"btn btn-outline ide-disconnect-btn",type:"button",onClick:()=>Ce(!0),children:"MicroPython"})})})]}),u.jsxs("section",{className:"ide-panel ide-editor-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("div",{className:"ide-editor-title",children:u.jsxs("h2",{children:[Ae(Z),u.jsxs("small",{children:[ci," bytes"]})]})}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Oc,disabled:F,children:"Kør"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Is,disabled:!dr&&!(!Mn&&pt)&&(!w||!dt),children:"Stop"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:Sc,disabled:F||!Z.trim(),children:"Gem"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Ds(),disabled:F||!Z.trim(),children:"Slet"})]})]}),Tr(),u.jsxs("div",{className:"ide-editor-wrap",children:[u.jsx("div",{ref:Vt,className:"ide-line-numbers","aria-hidden":"true",style:{transform:`translateY(${-yn.top}px)`},children:Array.from({length:gc},(f,v)=>u.jsx("span",{children:v+1},v))}),u.jsx("pre",{ref:kt,className:"ide-highlight","aria-hidden":"true",style:{transform:`translate(${-yn.left}px, ${-yn.top}px)`},children:Pv(J,pc)}),u.jsx("textarea",{ref:Ft,className:"ide-editor",value:J,onChange:f=>Gt(f.target.value,f.target.selectionStart,nl(),f.target.selectionEnd,"typing"),onKeyDown:$s,onKeyUp:f=>{["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(f.key)||Ea(f.currentTarget.value,f.currentTarget.selectionStart)},onClick:f=>{Ea(f.currentTarget.value,f.currentTarget.selectionStart),ln(f.currentTarget)},onSelect:f=>ln(f.currentTarget),onScroll:f=>{const{scrollTop:v,scrollLeft:x}=f.currentTarget;Vt.current&&(Vt.current.style.transform=`translateY(${-v}px)`),kt.current&&(kt.current.style.transform=`translate(${-x}px, ${-v}px)`),vr({top:v,left:x}),We&&Ea(f.currentTarget.value,f.currentTarget.selectionStart)},readOnly:Vl,"aria-busy":Vl,spellCheck:!1}),We&&u.jsx("div",{ref:er,className:`ide-autocomplete placement-${We.position.placement}`,role:"listbox","aria-label":"Kodeforslag",style:{left:We.position.left,top:We.position.top,maxHeight:We.position.maxHeight},children:(We.position.placement==="above"?We.items.map((f,v)=>({item:f,index:v})).reverse():We.items.map((f,v)=>({item:f,index:v}))).map(({item:f,index:v})=>u.jsx("button",{className:v===We.selected?"active":"",type:"button","data-autocomplete-index":v,onMouseDown:x=>{x.preventDefault(),Ta(f)},role:"option","aria-selected":v===We.selected,children:f.label},f.label))}),re&&u.jsxs("div",{className:"ide-editor-loading",role:"status","aria-live":"polite",children:[u.jsx("span",{className:"spinner","aria-hidden":"true"}),u.jsxs("strong",{children:["Indlæser ",Ae(re),"..."]})]})]})]}),u.jsxs("section",{className:"ide-panel ide-terminal-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Terminal"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${yr?"":"active"}`,type:"button",onClick:()=>ws(f=>!f),"aria-label":yr?"Tekniske fejl er slået fra":"Tekniske fejl er slået til","aria-pressed":!yr,title:yr?"Vis originale tekniske fejl":"Viser originale tekniske fejl",children:"Teknisk"}),u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${fr?"active":""}`,type:"button",onClick:()=>ql(f=>!f),"aria-pressed":fr,title:fr?"Terminalen ryddes, hver gang du trykker Kør":"Terminalen beholder tekst, når du trykker Kør",children:"Ryd ved Kør"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:yi,disabled:O.length===0,children:"Ryd"})]})]}),u.jsxs("div",{className:"ide-terminal","aria-live":"polite",ref:Qr,onScroll:Fs,onClick:()=>{var f;return(f=Wr.current)==null?void 0:f.focus()},children:[O.length===0?u.jsx("div",{className:"term-line",children:"Ingen terminaldata endnu."}):O.map((f,v)=>u.jsx("div",{className:`term-line ${f.variant==="input"?"term-input-echo":`term-${f.level}`}`,children:f.technical&&!yr?f.technical:f.text},`${v}-${f.text}`)),u.jsxs("form",{className:`ide-terminal-command ${Pl&&!Bt?"locked":""} ${Bt?"stdin":""}`,onSubmit:f=>{f.preventDefault(),Sa()},children:[u.jsx("span",{"aria-hidden":"true",children:Ts}),u.jsx("textarea",{ref:Wr,value:un,onChange:f=>{xn(f.target.value),st(null),Bt?Ht(null):Si(f.target.value,f.target.selectionStart)},onKeyDown:Ti,onKeyUp:f=>{Bt||["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(f.key)||Si(f.currentTarget.value,f.currentTarget.selectionStart)},onClick:f=>{Bt||Si(f.currentTarget.value,f.currentTarget.selectionStart)},disabled:Es,placeholder:kr,"aria-label":Bt?"Input til kørende Pico-kode":"MicroPython-terminalkommando",title:kr,rows:Math.max(1,un.split(`
`).length)})]}),mt&&u.jsx("div",{ref:ha,className:`ide-autocomplete ide-repl-autocomplete placement-${mt.position.placement}`,role:"listbox","aria-label":"Terminalforslag",style:{left:mt.position.left,top:mt.position.top,maxHeight:mt.position.maxHeight},children:(mt.position.placement==="above"?mt.items.map((f,v)=>({item:f,index:v})).reverse():mt.items.map((f,v)=>({item:f,index:v}))).map(({item:f,index:v})=>u.jsx("button",{className:v===mt.selected?"active":"",type:"button","data-autocomplete-index":v,onMouseDown:x=>{x.preventDefault(),Ei(f)},role:"option","aria-selected":v===mt.selected,children:f.label},f.label))})]})]})]}),u.jsx("input",{ref:si,type:"file",accept:".py,.txt,.json,.csv",className:"sr-only",onChange:f=>{var v;Nc((v=f.target.files)==null?void 0:v[0]),f.currentTarget.value=""}}),le&&u.jsx(qt,{title:"Gem fil",onClose:()=>se(!1),children:u.jsxs("div",{className:"ide-save-options",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:()=>void gi(),disabled:!w&&!ve||F,children:"Gem filen på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Ec,children:"Download filen til computer"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:wa,children:"Gem filen i browseren"})]})}),oe&&u.jsx(qt,{title:"Startprogrammer og biblioteker",onClose:()=>xe(!1),children:u.jsxs("div",{className:"ide-install-list",children:[u.jsx("p",{className:"ide-install-note",children:w||ve?"Vælg et startprogram og de biblioteker dit projekt bruger. Installer lægger filerne på Picoen.":"Du er ikke forbundet til en Pico. Du kan gemme filerne i browseren eller downloade dem til computeren, men de virker først på Picoen, når de er installeret der."}),u.jsxs("div",{className:"ide-install-grid",children:[wi("Startprogrammer (main.py)","Starter automatisk på Picoen.",je.filter(f=>f.kind==="program")),wi("Biblioteker","Ekstra Python-filer som dine programmer kan importere.",je.filter(f=>f.kind==="library"))]}),u.jsxs("div",{className:"ide-install-actions",children:[(w||ve)&&u.jsx("button",{className:"btn btn-primary",type:"button",onClick:Dc,disabled:F,children:"Installer på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Ps,disabled:F,children:"Download til computer"}),u.jsx("button",{className:w||ve?"btn btn-outline":"btn btn-primary",type:"button",onClick:Vs,disabled:F,children:"Gem i browseren"})]})]})}),Jt&&u.jsx(qt,{title:"main.py er gemt",onClose:()=>Tt(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:"Picoen kører stadig den gamle kode. Genstart Picoen for at anvende den nye main.py. Appen forsøger automatisk at genforbinde bagefter."}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>void _i("control"),disabled:F,children:"Genstart og åbn kontrolpanel"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void _i("ide"),disabled:F,children:"Genstart og bliv i Kodeværksted"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>Tt(!1),disabled:F,children:"Senere"})]})}),Be&&u.jsx(qt,{title:"Installer MicroPython",onClose:()=>Ce(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:"Hvis Picoen er helt frisk, skal MicroPython først lægges på den."}),u.jsxs("ol",{className:"micropython-steps",children:[u.jsx("li",{children:"Hold BOOTSEL-knappen nede."}),u.jsx("li",{children:"Sæt Picoen i USB, og slip derefter BOOTSEL."}),u.jsx("li",{children:"Vælg Pico-model og MicroPython-version herunder, og download UF2-filen."}),u.jsxs("li",{children:["Kopier UF2-filen til drevet ",u.jsx("strong",{children:"RPI-RP2"})]})]}),u.jsxs("div",{className:"micropython-selects",children:[u.jsx("label",{htmlFor:"micropython-board",children:"Pico-model"}),u.jsx("select",{id:"micropython-board",value:wt,onChange:f=>Ot(f.target.value),children:_a.map(f=>u.jsx("option",{value:f,children:f},f))}),u.jsx("label",{htmlFor:"micropython-version",children:"MicroPython-version"}),u.jsx("select",{id:"micropython-version",value:(Lt==null?void 0:Lt.version)??Zt,onChange:f=>zn(f.target.value),children:Hl.map(f=>u.jsxs("option",{value:f.version,children:[f.version," (",f.date,")"]},`${f.board}:${f.version}:${f.date}`))})]}),Lt&&u.jsx("a",{className:"btn btn-primary btn-block",href:Lt.url,download:Lt.fileName,children:"Download UF2"}),u.jsx("a",{className:"btn btn-outline btn-block",href:"https://www.raspberrypi.com/documentation/microcontrollers/micropython.html",target:"_blank",rel:"noreferrer",children:"Se vejledning"})]})}),z&&u.jsx(qt,{title:"Ny Python-fil",onClose:()=>ne(!1),children:u.jsxs("form",{className:"ide-new-file-form",onSubmit:f=>{f.preventDefault(),Ac()},children:[u.jsx("label",{htmlFor:"new-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"new-pico-file",value:he,onChange:f=>me(f.target.value),autoFocus:!0,placeholder:"test"}),u.jsx("span",{children:".py"})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen tilføjer .py automatisk og opretter filen i ",Ss,"."]}),u.jsx("button",{className:"btn btn-primary",type:"submit",disabled:!dh(he),children:"Opret"})]})}),U&&u.jsx(qt,{title:Ae(U.path),onClose:()=>ee(null),children:u.jsxs("div",{className:"ide-file-action-modal",children:[u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:"Placering"}),u.jsx("strong",{children:U.source==="pico"?"Pico":"Browser"})]}),u.jsxs("form",{className:"ide-file-rename-form",onSubmit:f=>{f.preventDefault(),Us()},children:[u.jsx("label",{htmlFor:"rename-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"rename-pico-file",value:we,onChange:f=>E(f.target.value),placeholder:"min_kode"}),u.jsxs("span",{children:[".",fs(U.path)]})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen beholder filendelsen .",fs(U.path)," automatisk."]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"submit",disabled:!qd(we,fs(U.path))||qd(we,fs(U.path))===U.path||F,children:"Gem navn"})]}),u.jsxs("div",{className:"ide-file-action-buttons",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void zs(),disabled:F,children:"Dupliker"}),u.jsx("button",{className:"btn btn-outline btn-danger btn-block",type:"button",onClick:()=>Ds(U),disabled:F,children:"Slet"})]}),u.jsxs("section",{className:"ide-version-history",children:[u.jsx("h4",{children:"Versionshistorik"}),U.versions.length===0?u.jsx("p",{children:"Versionshistorik: 0 gemte versioner."}):u.jsx("div",{className:"ide-version-list",children:U.versions.map(f=>u.jsxs("div",{className:"ide-version-row",children:[u.jsx("span",{children:Ae(f.path)}),u.jsx("small",{children:f.size!==void 0?`${f.size} bytes`:"Gemt på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:()=>void Cc(f),disabled:F,children:"Gendan"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Ls(f),disabled:F,children:"Slet"})]},f.path))})]})]})})]})}function dh(i){var o;const l=(o=i.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:o.replace(/\.py$/i,"").replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"");return l?`/${l}.py`:""}function Nv(i){const l=i.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop(),o=l==null?void 0:l.match(/^(.+)\.(py|txt|json|csv)$/i);if(!o)return"";const s=Jh(o[1]);return s?`/${s}.${o[2].toLowerCase()}`:""}function qd(i,l="py"){const o=i.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop();if(!o)return"";const s=o.match(/^(.+?)(?:\.(py|txt|json|csv))?$/i);if(!s)return"";const d=Jh(s[1]),p=l.replace(/^\./,"").toLowerCase(),_=(s[2]??(p||"py")).toLowerCase();return d?`/${d}.${_}`:""}function Rv(i){return Ae(i).replace(/\.(py|txt|json|csv)$/i,"")}function Jh(i){return i.replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"")}function fs(i){var s;const l=Ae(i).match(/\.([a-z0-9]+)$/i),o=(s=l==null?void 0:l[1])==null?void 0:s.toLowerCase();return o&&["py","txt","json","csv"].includes(o)?o:"py"}function Dl(i){return i.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`,_),w=b===-1?i.length:b;if(l<=w&&_>=o)return!0;_=w;continue}if(g==='"""'||g==="'''"){d=m,_+=2;continue}(m==='"'||m==="'")&&(s=m)}return s!==null||d!==null}function ep(i,l){const o=i.insert.trim();return!/[().]/.test(o)&&o.toLowerCase()===l.toLowerCase()}function qv(i){return/^[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_]*$/.test(i)}function _h(i,l,o){if(!i)return null;const s=i.closest(".ide-terminal")??i.parentElement;if(!s)return null;const d=window.getComputedStyle(i),p=document.createElement("div"),_=document.createElement("span"),m=s.getBoundingClientRect(),g=i.getBoundingClientRect();p.style.position="absolute",p.style.visibility="hidden",p.style.pointerEvents="none",p.style.whiteSpace="pre-wrap",p.style.overflowWrap="break-word",p.style.wordBreak=d.wordBreak,p.style.boxSizing=d.boxSizing,p.style.width=`${i.getBoundingClientRect().width}px`,p.style.padding=d.padding,p.style.border=d.border,p.style.font=d.font,p.style.lineHeight=d.lineHeight,p.style.letterSpacing=d.letterSpacing,p.style.tabSize=d.tabSize,p.style.fontVariantLigatures=d.fontVariantLigatures,p.style.scrollbarGutter=d.scrollbarGutter,p.style.left=`${g.left-m.left-i.scrollLeft}px`,p.style.top=`${g.top-m.top-i.scrollTop}px`,p.textContent=i.value.slice(0,l),_.textContent=i.value.slice(l,l+1)||" ",p.appendChild(_),s.appendChild(p);const b=_.getBoundingClientRect();p.remove();const w=34,k=14,T=Math.min(210,Math.max(w+k,o*w+k)),R=Hv(b.left-m.left,8,Math.max(8,s.clientWidth-296)),O=b.top-m.top+s.scrollTop,G=b.bottom-m.top+s.scrollTop+10,F=s.scrollTop+s.clientHeight-G-8,V=O-s.scrollTop-8,X=s.scrollTop+s.clientHeight,P=F>=Math.min(T,w*2)||F>=V?"below":"above",re=Math.max(w+k,Math.min(T,P==="below"?F:V)),be=P==="below"?Math.min(G,X-re-8):Math.max(s.scrollTop+8,O-re-8);return{left:R,top:be,maxHeight:re,placement:P}}function Hv(i,l,o){return Math.max(l,Math.min(o,i))}function Vv(i){const l=[];let o=null,s=null,d=!1,p=0,_=0;const m=(g,b)=>{g>p&&l.push({text:i.slice(p,g),isTriple:b}),p=g};for(;_<i.length;){const g=i[_],b=i.slice(_,_+3);if(s){if(b===s.repeat(3)){_+=3,s=null,m(_,!0);continue}_+=1;continue}if(o){d?d=!1:g==="\\"?d=!0:(g===o||g===`
...
`||b===`\r
`){d.push(u.jsx("br",{},`br-${p++}`));return}b!==""&&g(b,`part-${p++}`)})}return Vv(i).forEach(m=>{if(m.isTriple){_(m.text,(g,b)=>{d.push(...ps(g,l,b,"tok-string"))});return}_(m.text,(g,b)=>{let w=0;[...g.matchAll(s)].forEach((T,R)=>{const O=T.index??0;O>w&&d.push(...vh(g.slice(w,O),o,`${b}-${R}-plain`,l));const G=T[0],F=G.startsWith("#")?"tok-comment":G.startsWith('"')||G.startsWith("'")?"tok-string":/^\d/.test(G)?"tok-number":"tok-builtin";d.push(...ps(G,l,`${b}-${R}-token`,F)),w=O+G.length}),w<g.length&&d.push(...vh(g.slice(w),o,`${b}-tail`,l))})}),d.length?d:" "}function vh(i,l,o,s=""){const d=[];let p=0;const _=new RegExp(l.source,"g");return[...i.matchAll(_)].forEach((m,g)=>{const b=m.index??0;b>p&&d.push(...ps(i.slice(p,b),s,`${o}-${g}-plain`)),d.push(...ps(m[0],s,`${o}-${g}-keyword`,"tok-keyword")),p=b+m[0].length}),p<i.length&&d.push(...ps(i.slice(p),s,`${o}-plain-end`)),d}function ps(i,l,o,s=""){if(!l)return[u.jsx("span",{className:s||void 0,children:i},o)];const d=[],p=l.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),_=new RegExp(`(?<![A-Za-zÆØÅæøå0-9_])(${p})(?![A-Za-zÆØÅæøå0-9_])`,"g");let m=0;return[...i.matchAll(_)].forEach((g,b)=>{const w=g.index??0;w>m&&d.push(u.jsx("span",{className:s||void 0,children:i.slice(m,w)},`${o}-${b}-before`)),d.push(u.jsx("span",{className:`${s} tok-match`.trim(),children:g[0]},`${o}-${b}-match`)),m=w+g[0].length}),m<i.length&&d.push(u.jsx("span",{className:s||void 0,children:i.slice(m)},`${o}-after`)),d.length?d:[u.jsx("span",{className:s||void 0,children:i},o)]}function ec(i){return i.length>0?i:[{path:Qd,content:Zh,uploaded:!1,updatedAt:Date.now()}]}function Hd(i,l,o,s){const d=i.filter(p=>p.path!==l);return[{path:l,content:o,uploaded:s,updatedAt:Date.now()},...d].sort((p,_)=>_.updatedAt-p.updatedAt)}function lc(i){return i.map(l=>({name:Ae(l.path),path:l.path,type:"file",size:new Blob([l.content]).size}))}function Iv(i,l,o){var s;return i.source==="pico"?o[i.path]:(s=l.find(d=>d.path===i.path))==null?void 0:s.content}function ac(i){const l=i.replace(/\\/g,"/"),o=l.lastIndexOf("/"),s=o>=0?l.slice(0,o+1):"",p=(o>=0?l.slice(o+1):l).match(/^(.+)_backup(\d+)(\.[^.]+)$/i);return p?{originalPath:`${s}${p[1]}${p[3]}`,index:parseInt(p[2],10)}:null}function Ll(i){return ac(i)!==null}function ti(i){const l=new Map;for(const o of i){const s=ac(o.path);if(!s)continue;const d=l.get(s.originalPath)??[];d.push(o),l.set(s.originalPath,d)}for(const o of l.values())o.sort((s,d)=>{var p,_;return(((p=ac(d.path))==null?void 0:p.index)??0)-(((_=ac(s.path))==null?void 0:_.index)??0)});return l}function Fv(i,l){const o=i.replace(/\\/g,"/"),s=o.lastIndexOf("/"),d=s>=0?o.slice(0,s+1):"/",p=s>=0?o.slice(s+1):o.replace(/^\/+/,""),_=p.lastIndexOf("."),m=_>0?p.slice(0,_):p,g=_>0?p.slice(_):"",b=new Set(l.map(w=>w.path.toLowerCase()));for(let w=1;w<1e3;w+=1){const k=`${d}${m}_backup${w}${g}`;if(!b.has(k.toLowerCase()))return k}return`${d}${m}_backup${Date.now()}${g}`}function Gv(i,l){const o=i.replace(/\\/g,"/"),s=o.lastIndexOf("/"),d=s>=0?o.slice(0,s+1):"/",p=s>=0?o.slice(s+1):o.replace(/^\/+/,""),_=p.lastIndexOf("."),m=_>0?p.slice(0,_):p,g=_>0?p.slice(_):"";for(let b=1;b<1e3;b+=1){const w=b===1?"_kopi":`_kopi${b}`,k=`${d}${m}${w}${g}`;if(!l(k)&&!Ll(k))return k}return`${d}${m}_kopi${Date.now()}${g}`}function $v(i){return i==="ok"?"Nyeste":i==="outdated"?"Opdater":i==="missing"?"Mangler":"Ikke tjekket"}function Yv(i,l,o,s){const d=new Map,p=ti(i),_=ti(lc(l));for(const k of i)Ll(k.path)||d.set(Wt("pico",k.path),{kind:"file",name:k.name,path:k.path,type:k.type,size:k.size,source:"pico",uploaded:!0,versions:p.get(k.path)??[]});for(const k of l)Ll(k.path)||d.set(Wt("local",k.path),{kind:"file",name:Ae(k.path),path:k.path,type:"file",source:"local",uploaded:!1,versions:_.get(k.path)??[]});for(const k of Object.keys(o)){const[T,...R]=k.split(":"),O=R.join(":");if(T!=="local"&&T!=="pico"||!O)continue;const G=d.get(k);if(G){d.set(k,G);continue}d.set(k,{kind:"file",name:Ae(O),path:O,type:"file",source:T,uploaded:!1,versions:T==="pico"?p.get(O)??[]:_.get(O)??[]})}const m=[...d.values()].sort(Kv),g=m.filter(k=>k.source==="pico"),b=m.filter(k=>k.source==="local"),w=[];return g.length>0||s?w.push({kind:"separator",id:"pico-files",label:s?"Pico":"Microcontroller"},...g):w.push({kind:"separator",id:"pico-files",label:"Microcontroller"}),b.length>0&&w.push({kind:"separator",id:"browser-files",label:"Browser"},...b),w}const Xv=new Map([["main.py",0],["devicesettings.txt",1],["layout.txt",2],["picobluetooth.py",3],["picofly.py",4],["picorobotics.py",5],["neopixel.py",6],["hcsr04.py",7]]);function Kv(i,l){const o=bh(i.path),s=bh(l.path);return o===null&&s===null?i.name.localeCompare(l.name,"da"):o===null?-1:s===null?1:o-s}function bh(i){var o;const l=(o=i.replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:o.toLowerCase();return l?Xv.get(l)??null:null}function yh(i,l,o){if(!(l in i))return i;const s={...i,[o]:i[l]};return delete s[l],s}function Qv(i,l,o,s){const d=`${l}:${o}`;if(!(d in i))return i;const p={...i,[`${l}:${s}`]:i[d]};return delete p[d],p}function Wv({open:i}){const l=ae(X=>X.screen),o=ae(X=>X.active),s=ae(X=>X.toggleSideMenu),d=ae(X=>X.toggleDebugger),p=ae(X=>X.setEditMode),_=ae(X=>X.openMenuPage),m=ae(X=>X.disconnect),g=ae(X=>X.openPicoIde),b=ae(X=>X.closePicoIde),w=ae(X=>X.picoIdeOrigin),k=l==="dashboard",T=l==="control",R=l==="ide",O=T&&!!(o!=null&&o.canEdit),G=!T||!!(o!=null&&o.isOwnedByMe)||!!(o!=null&&o.canEditCode),F=w==="control",V=w==="control"?"Pico Kontrol Panel":"Hovedmenu";return u.jsxs(u.Fragment,{children:[u.jsx("div",{className:`scrim ${i?"open":"closing"}`,onClick:()=>s(!1)}),u.jsxs("nav",{className:`sidemenu sidemenu-${l} ${i?"open":"closing"}`,"aria-label":"Sidemenu",children:[k&&u.jsxs(u.Fragment,{children:[u.jsx(Ln,{label:"Bruger",icon:"user",onClick:()=>_("user-settings")}),u.jsx(Ln,{label:"Indstillinger",icon:"settings",onClick:()=>_("application-settings")}),u.jsx(Ln,{label:"Kodeværksted",icon:"picoIde",onClick:g,disabled:!G}),u.jsx(Vd,{}),u.jsx(Ln,{label:"Om appen",icon:"info",onClick:()=>_("application-about")}),u.jsx(Ln,{label:"Hjælp",icon:"help",onClick:()=>_("application-help")}),u.jsx(Ln,{label:"Fejlfinding",icon:"debugger",onClick:()=>d(!0)})]}),T&&u.jsxs(u.Fragment,{children:[u.jsx(Ln,{label:"Indstillinger",icon:"settings",onClick:()=>_("device-settings")}),u.jsx(Ln,{label:"Rediger",icon:"edit",onClick:()=>p(!0),disabled:!O}),u.jsx(Ln,{label:"Kodeværksted",icon:"picoIde",onClick:g,disabled:!G}),u.jsx(Vd,{}),u.jsx(Ln,{label:"Hjælp",icon:"help",onClick:()=>_("device-help")}),u.jsx(Ln,{label:"Fejlfinding",icon:"debugger",onClick:()=>d(!0)})]}),R&&u.jsxs(u.Fragment,{children:[u.jsx(Ln,{label:V,icon:"back",onClick:b}),u.jsx(Vd,{})]}),u.jsx("div",{className:"spacer"}),(T||R&&F)&&u.jsx(Ln,{label:"Forlad",icon:"exit",onClick:()=>m()})]})]})}function Ln({label:i,icon:l,disabled:o,onClick:s}){return u.jsxs("button",{className:"iconbtn",type:"button",onClick:s,disabled:o,"aria-label":i,children:[u.jsx(Dt,{name:l}),u.jsx("span",{children:i})]})}function Vd(){return u.jsxs("a",{className:"iconbtn sidemenu-link",href:"https://www.teknologiskolen.dk/",target:"_blank",rel:"noreferrer","aria-label":"Teknologiskolen",children:[u.jsx("img",{src:hg,alt:""}),u.jsx("span",{children:"Teknologiskolen"})]})}const Zv={error:"term-error",success:"term-success",warning:"term-warning",info:""},xh={error:"[FEJL] ",success:"[SUCCES] ",warning:"[ADVARSEL] ",info:""};function Jv(){const i=new Date,l=o=>String(o).padStart(2,"0");return`${l(i.getDate())}-${l(i.getMonth()+1)}-${i.getFullYear()}-${l(i.getHours())}-${l(i.getMinutes())}`}function eb(){const i=ae(d=>d.logs),l=ae(d=>d.clearLogs),o=ae(d=>d.toggleDebugger);function s(){const d=[...i].reverse().map(g=>`${g.time} ${xh[g.level]}${g.message}`).join(`
`),p=new Blob([d],{type:"text/plain"}),_=URL.createObjectURL(p),m=document.createElement("a");m.href=_,m.download=`${Jv()}.txt`,m.click(),URL.revokeObjectURL(_)}return u.jsxs(qt,{title:"Fejlfinding",onClose:()=>o(!1),closeVariant:"circle",children:[u.jsx("div",{className:"terminal",children:i.length===0?u.jsx("div",{className:"term-line",children:"Ingen log endnu."}):i.map((d,p)=>u.jsxs("div",{className:`term-line ${Zv[d.level]}`,children:[d.time," ",xh[d.level],d.message]},`${d.time}-${p}`))}),u.jsxs("div",{className:"row",style:{marginTop:14},children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:l,children:"Ryd"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:s,children:"Gem logfil"})]})]})}const tp=4,Zn=tp*4+17,wh=80,tb=20,nb=30660;function rb(i){const l=new TextEncoder().encode(i);if(l.length>76)throw new Error("QR-koden er for lang.");const o=kh(!1),s=kh(!1);lb(o,s);const d=ib(l),p=cb(d,tb);return sb(o,s,[...d,...p]),ob(o,s),o}function kh(i){return Array.from({length:Zn},()=>Array.from({length:Zn},()=>i))}function Wn(i,l,o,s,d,p=!0){i[s][o]=d,p&&(l[s][o]=!0)}function lb(i,l){Pd(i,l,0,0),Pd(i,l,Zn-7,0),Pd(i,l,0,Zn-7);for(let o=0;o<Zn;o+=1)l[6][o]||Wn(i,l,o,6,o%2===0),l[o][6]||Wn(i,l,6,o,o%2===0);ab(i,l,26,26),Wn(i,l,8,tp*4+9,!0)}function Pd(i,l,o,s){for(let d=-1;d<=7;d+=1)for(let p=-1;p<=7;p+=1){const _=o+p,m=s+d;if(_<0||m<0||_>=Zn||m>=Zn)continue;const g=p>=0&&p<=6&&d>=0&&d<=6&&(p===0||p===6||d===0||d===6||p>=2&&p<=4&&d>=2&&d<=4);Wn(i,l,_,m,g)}}function ab(i,l,o,s){for(let d=-2;d<=2;d+=1)for(let p=-2;p<=2;p+=1)l[s+d][o+p]||Wn(i,l,o+p,s+d,Math.max(Math.abs(p),Math.abs(d))!==1)}function ib(i){const l=[];tc(l,4,4),tc(l,i.length,8);for(const s of i)tc(l,s,8);for(tc(l,0,Math.min(4,wh*8-l.length));l.length%8!==0;)l.push(0);const o=[];for(let s=0;s<l.length;s+=8)o.push(l.slice(s,s+8).reduce((d,p)=>d<<1|p,0));for(let s=236;o.length<wh;s=s===236?17:236)o.push(s);return o}function tc(i,l,o){for(let s=o-1;s>=0;s-=1)i.push(l>>>s&1)}function sb(i,l,o){const s=o.flatMap(_=>Array.from({length:8},(m,g)=>_>>>7-g&1));let d=0,p=!0;for(let _=Zn-1;_>=1;_-=2){_===6&&(_-=1);for(let m=0;m<Zn;m+=1){const g=p?Zn-1-m:m;for(let b=0;b<2;b+=1){const w=_-b;if(l[g][w])continue;const k=d<s.length?s[d]===1:!1;i[g][w]=k!==((w+g)%2===0),d+=1}}p=!p}}function ob(i,l){const o=s=>(nb>>>s&1)!==0;for(let s=0;s<=5;s+=1)Wn(i,l,8,s,o(s));Wn(i,l,8,7,o(6)),Wn(i,l,8,8,o(7)),Wn(i,l,7,8,o(8));for(let s=9;s<15;s+=1)Wn(i,l,14-s,8,o(s));for(let s=0;s<8;s+=1)Wn(i,l,Zn-1-s,8,o(s));for(let s=8;s<15;s+=1)Wn(i,l,8,Zn-15+s,o(s))}const gs=new Array(512),Jd=new Array(256);let Sh=!1;function np(){if(Sh)return;let i=1;for(let l=0;l<255;l+=1)gs[l]=i,Jd[i]=l,i<<=1,i&256&&(i^=285);for(let l=255;l<512;l+=1)gs[l]=gs[l-255];Sh=!0}function rp(i,l){return i===0||l===0?0:gs[Jd[i]+Jd[l]]}function cb(i,l){np();const o=ub(l),s=Array.from({length:l},()=>0);for(const d of i){const p=d^s.shift();s.push(0);for(let _=0;_<l;_+=1)s[_]^=rp(o[_],p)}return s}function ub(i){np();let l=[1];for(let o=0;o<i;o+=1){const s=Array.from({length:l.length+1},()=>0);for(let d=0;d<l.length;d+=1)s[d]^=rp(l[d],gs[o]),s[d+1]^=l[d];l=s}return l.slice(1)}function db(){const i=ae(fe=>fe.menuPage),l=ae(fe=>fe.closeMenuPage),o=ae(fe=>fe.user),s=ae(fe=>fe.active),d=ae(fe=>fe.layout),p=ae(fe=>fe.savedDevices),_=ae(fe=>fe.updateUsername),m=ae(fe=>fe.createOwnerPairingCode),g=ae(fe=>fe.applyOwnerPairingCode),b=ae(fe=>fe.clearSavedDevices),w=ae(fe=>fe.resetApplicationData),k=ae(fe=>fe.saveDeviceSettings),T=ae(fe=>fe.setEditMode),R=ae(fe=>fe.askConfirm),[O,G]=C.useState((o==null?void 0:o.username)??""),[F,V]=C.useState(!1),[X,P]=C.useState(""),[re,be]=C.useState(""),[de,W]=C.useState(!1),[Z,ke]=C.useState(""),Ee=C.useRef(null),[ze,J]=C.useState((s==null?void 0:s.icon)??Bl),[Ne,je]=C.useState(!1),[ue,z]=C.useState((s==null?void 0:s.canOthersConnect)??!1),[ne,he]=C.useState((s==null?void 0:s.canOthersEdit)??!1),[me,we]=C.useState((s==null?void 0:s.canOthersEditCode)??!1),[E,U]=C.useState((s==null?void 0:s.gridCols)??11),[ee,le]=C.useState((s==null?void 0:s.gridRows)??31),[se,H]=C.useState(!1);C.useEffect(()=>{i==="user-settings"&&(G((o==null?void 0:o.username)??""),be(""),ke(""),W(!1))},[i,o==null?void 0:o.username]),C.useEffect(()=>{i==="device-settings"&&s&&(J(s.icon),z(s.canOthersConnect),he(s.canOthersEdit),we(s.canOthersEditCode),U(s.gridCols),le(s.gridRows))},[s,i]),C.useEffect(()=>{if(!de)return;let fe=!1,Be=null,Ce=0;async function Ke(){var wt;const it=window.BarcodeDetector;if(!it||!((wt=navigator.mediaDevices)!=null&&wt.getUserMedia)){ke("Denne browser kan ikke scanne QR-koder. Skriv ejerkoden i stedet."),W(!1);return}try{Be=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const Ot=Ee.current;if(!Ot)return;Ot.srcObject=Be,await Ot.play();const Zt=new it({formats:["qr_code"]}),zn=async()=>{var Jt;if(!fe){try{const yn=(Jt=(await Zt.detect(Ot)).find(vr=>vr.rawValue))==null?void 0:Jt.rawValue;if(yn){be(yn),g(yn)&&V(!1),W(!1);return}}catch{}Ce=window.requestAnimationFrame(zn)}};Ce=window.requestAnimationFrame(zn)}catch{ke("Kameraet kunne ikke åbnes. Skriv ejerkoden i stedet."),W(!1)}}return Ke(),()=>{fe=!0,Ce&&window.cancelAnimationFrame(Ce),Be==null||Be.getTracks().forEach(it=>it.stop())}},[g,de]);const D=(fe,Be)=>Number.isFinite(fe)?Math.max(ri,Math.min(li,Math.round(fe))):Be,oe=(o==null?void 0:o.username)??"",xe=O.trim(),Ue=xe.length>0&&xe!==oe;if(!i)return null;if(i==="user-settings"){let fe=function(){const Ke=m();Ke&&(P(Ke),be(""),V(!0))},Be=function(){g(re)&&(be(""),V(!1))};async function Ce(){var Ke;try{await((Ke=navigator.clipboard)==null?void 0:Ke.writeText(X))}catch{}}return u.jsxs(u.Fragment,{children:[u.jsx(qt,{title:"Brugerindstillinger",onClose:l,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(ur,{label:"GUID",value:(o==null?void 0:o.userID)??"Ukendt"}),u.jsxs("div",{className:`field ${O.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-username",value:O,onChange:Ke=>G(Ke.target.value),maxLength:24,autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-username",children:"Brugernavn"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>_(O),disabled:!Ue,children:"Gem nyt brugernavn"}),u.jsx("div",{className:"notice",children:"Ejerkode bruges, hvis den samme person skal forbinde fra flere browsere eller telefoner."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:fe,children:"Ejerkode"}),u.jsx("button",{className:"btn btn-outline btn-block btn-danger",type:"button",onClick:()=>R({title:"Start forfra",message:"Vil du slette brugeroplysninger og gemte enheder fra denne browser? Siden genindlæses bagefter.",confirmLabel:"Slet alt",onConfirm:()=>{w()}}),children:"Slet brugerdata"})]})}),F&&u.jsx(qt,{title:"Del ejerkode",onClose:()=>V(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(mb,{code:X}),u.jsx("code",{className:"owner-code-text",children:X}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void Ce(),children:"Kopiér ejerkode"}),u.jsxs("div",{className:`field ${re.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-owner-code",value:re,onChange:Ke=>be(Ke.target.value),autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-owner-code",children:"Skriv ejerkode"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:Be,disabled:!re.trim(),children:"Brug ejerkode i denne browser"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>W(Ke=>!Ke),children:de?"Stop scanning":"Scan QR-kode"}),Z&&u.jsx("div",{className:"notice",children:Z}),de&&u.jsx("video",{className:"owner-code-video",ref:Ee,muted:!0,playsInline:!0})]})})]})}if(i==="application-settings")return u.jsx(qt,{title:"Applikationsindstillinger",onClose:l,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(ur,{label:"Version",value:_s}),u.jsx(ur,{label:"Bluetooth",value:mc()?"Tilgængelig":"Ikke tilgængelig"}),u.jsx(ur,{label:"Gemte enheder",value:String(p.length)}),u.jsx("div",{className:"notice",children:"Bluetooth-tilladelser styres af browseren. Hvis du vil glemme en parret Pico helt, skal du fjerne tilladelsen i browserens site- eller Bluetooth-indstillinger."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>R({title:"Ryd gemte enheder",message:"Vil du fjerne alle gemte enheder fra denne browser?",confirmLabel:"Ryd",onConfirm:b}),disabled:p.length===0,children:"Ryd gemte enheder"})]})});if(i==="application-about")return u.jsx(qt,{title:"Om appen",onClose:l,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Pico Kontrol Panel er lavet til at bygge og fjernstyre sjove eller seje Raspberry Pi Pico W-projekter."}),u.jsx(ur,{label:"Udvikler",value:"Christian Bröchner Rasmussen"}),u.jsx(ur,{label:"Version",value:_s})]})});if(i==="application-help")return u.jsx(qt,{title:"Hjælp til applikationen",onClose:l,children:u.jsxs("div",{className:"settings-stack prose help-lesson",children:[u.jsxs("div",{className:"help-lesson-card",children:[u.jsx("strong",{children:"Komplet undervisningsforløb"}),u.jsx("p",{children:"Linket åbner Teknologiskolens guide til Pico Kontrol Panel. Her kan du lære hele arbejdsgangen: browseropsætning, Kodeværkstedet, MicroPython, USB-installation, Bluetooth-forbindelse, kontrolpaneler og trådløs kodeudvikling."})]}),u.jsxs("div",{className:"help-lesson-list","aria-label":"Undervisningsforløbet indeholder",children:[u.jsx("span",{children:"Trin-for-trin opsætning"}),u.jsx("span",{children:"Øvelser til kode og kontrolpanel"}),u.jsx("span",{children:"Projektforslag med Pico W"})]}),u.jsx("p",{className:"help-lesson-destination",children:"Du sendes til materialer.teknologiskolen.dk i en ny fane."}),u.jsx("a",{className:"btn btn-primary btn-block",href:"https://materialer.teknologiskolen.dk/lessons/fjernstyring-af-raspberry-pi-pico-w",target:"_blank",rel:"noreferrer",children:"Åbn komplet undervisningsforløb"})]})});if(i==="device-settings"){const fe=!!(s!=null&&s.isOwnedByMe);async function Be(Ce=!1){if(!s||!fe)return;const Ke=D(E,s.gridCols),it=D(ee,s.gridRows),wt=fb(d,Ke,it);if(wt&&!Ce){R({title:"Gitter kan påvirke layout",message:`Det nuværende layout bruger op til ${wt.requiredCols} kolonner og ${wt.requiredRows} rækker. Det nye gitter er ${Ke} × ${it}, så nogle kontroller kan ende udenfor eller skulle flyttes i redigering.`,confirmLabel:"Gem alligevel",onConfirm:()=>{Be(!0)}});return}H(!0),await k(ze,ue,ue&&ne,ue&&me,Ke,it),U(Ke),le(it),H(!1),l()}return u.jsx(qt,{title:"Enhedsindstillinger",onClose:l,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(ur,{label:"Navn",value:(s==null?void 0:s.deviceName)??"Ukendt"}),u.jsx(ur,{label:"Ejer",value:hb(s)}),fe?u.jsxs(u.Fragment,{children:[u.jsxs("button",{className:"device-icon-pick settings-icon-pick",type:"button",onClick:()=>je(!0),"aria-label":"Vælg ikon",children:[u.jsx(xs,{slug:ze}),u.jsx("span",{className:"badge",children:u.jsx(Dt,{name:"plus",size:22})})]}),u.jsx("p",{className:"prompt",children:"Må andre forbinde til- og bruge denne enhed?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:ue?"":"active",onClick:()=>z(!1),children:"Privat"}),u.jsx("button",{type:"button",className:ue?"active":"",onClick:()=>z(!0),children:"Offentlig"})]}),ue&&u.jsxs(u.Fragment,{children:[u.jsx("p",{className:"prompt",children:"Må andre redigere layoutet?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:ne?"":"active",onClick:()=>he(!1),children:"Nej"}),u.jsx("button",{type:"button",className:ne?"active":"",onClick:()=>he(!0),children:"Ja"})]}),u.jsx("p",{className:"prompt",children:"Må andre redigere koden?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:me?"":"active",onClick:()=>we(!1),children:"Nej"}),u.jsx("button",{type:"button",className:me?"active":"",onClick:()=>we(!0),children:"Ja"})]})]}),u.jsx("p",{className:"prompt",children:"Kontrolpanelets gitter"}),u.jsxs("div",{className:"row",children:[u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-cols",children:"Kolonner"}),u.jsx("input",{id:"device-cols",type:"number",min:ri,max:li,value:Number.isNaN(E)?"":E,onChange:Ce=>U(parseInt(Ce.target.value,10)),onBlur:()=>U(D(E,(s==null?void 0:s.gridCols)??11))})]}),u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-rows",children:"Rækker"}),u.jsx("input",{id:"device-rows",type:"number",min:ri,max:li,value:Number.isNaN(ee)?"":ee,onChange:Ce=>le(parseInt(Ce.target.value,10)),onBlur:()=>le(D(ee,(s==null?void 0:s.gridRows)??31))})]})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>Be(),disabled:se,children:se?"Gemmer...":"Gem enhedsindstillinger"})]}):u.jsxs(u.Fragment,{children:[u.jsx(ur,{label:"Ikon",value:(s==null?void 0:s.icon)??Bl}),u.jsx(ur,{label:"Redigering",value:s!=null&&s.canEdit?"Tilladt":"Ikke tilladt"}),u.jsx(ur,{label:"Gitter",value:`${(s==null?void 0:s.gridCols)??0} × ${(s==null?void 0:s.gridRows)??0}`})]}),Ne&&u.jsx(Uh,{selected:ze,onSelect:J,onClose:()=>je(!1)})]})})}return u.jsx(qt,{title:"Hjælp til enheden",onClose:l,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Knapper sender en kommando med deres navn, når de trykkes."}),u.jsx("p",{children:"Slidere sender værdien fra den firmware-definerede skala. Appen ændrer kun placering og størrelse."}),u.jsx("p",{children:"Hvis redigering er tilladt, kan du åbne redigering fra menuen og gemme layoutet tilbage på Picoen."}),(s==null?void 0:s.canEdit)&&u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>T(!0),children:"Rediger layout"})]})})}function fb(i,l,o){let s=0,d=0;for(const p of i)ys(p)&&(s=Math.max(s,Math.ceil((p.centerX2+p.spanX)/2)+1),d=Math.max(d,Math.ceil((p.centerY2+p.spanY)/2)+1));return l<s||o<d?{requiredCols:s,requiredRows:d}:null}function mb({code:i}){const l=C.useMemo(()=>rb(i),[i]),o=l.length;return u.jsxs("svg",{className:"owner-code-qr",viewBox:`0 0 ${o+8} ${o+8}`,role:"img","aria-label":"QR-kode til ejerkode",children:[u.jsx("rect",{width:o+8,height:o+8,fill:"white"}),l.map((s,d)=>s.map((p,_)=>p?u.jsx("rect",{x:_+4,y:d+4,width:"1",height:"1",fill:"currentColor"},`${_}-${d}`):null))]})}function hb(i){var l;return i?i.isOwnedByMe?"Dig":((l=i.ownerName)==null?void 0:l.trim())||"Anden bruger":"Ukendt"}function ur({label:i,value:l}){return u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:i}),u.jsx("strong",{children:l})]})}function pb(){const i=ae(s=>s.confirmDialog),l=ae(s=>s.closeConfirm);if(!i)return null;function o(){i==null||i.onConfirm(),l()}return u.jsx(qt,{title:i.title,onClose:l,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:i.message}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:l,children:i.cancelLabel??"Annuller"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:o,children:i.confirmLabel??"Fortsæt"})]})]})})}function gb(){const i=ae(s=>s.connectionLost),l=ae(s=>s.reconnectLostDevice),o=ae(s=>s.dismissConnectionLost);return i?u.jsx(qt,{title:"Forbindelse afbrudt",onClose:o,children:u.jsxs("div",{className:"settings-stack",children:[u.jsxs("p",{className:"confirm-message",children:["Forbindelsen til ",i.deviceName," blev afbrudt. Tjek at Picoen har strøm og er tæt nok på."]}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:o,children:"Luk"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>l(),children:"Genforbind"})]})]})}):null}function _b(){const i=ae(o=>o.toast),l=ae(o=>o.dismissToast);return i?u.jsx("div",{className:"toast",role:"alert",onClick:l,children:i.message},i.id):null}function vb(){const i=ae(m=>m.screen),l=ae(m=>m.splashTarget),o=ae(m=>m.init),s=ae(m=>m.sideMenuOpen),d=ae(m=>m.debuggerOpen),[p,_]=C.useState(!1);return C.useEffect(()=>{o()},[o]),C.useEffect(()=>{if(s){_(!0);return}const m=setTimeout(()=>_(!1),140);return()=>clearTimeout(m)},[s]),u.jsxs("div",{className:"app",children:[i==="splash"&&l==="intro"&&u.jsx(Lm,{}),i==="splash"&&l==="dashboard"&&u.jsx(Um,{}),i==="splash"&&u.jsx(wg,{}),i==="intro"&&u.jsx(Lm,{}),i==="dashboard"&&u.jsx(Um,{}),i==="connection"&&u.jsx(Lg,{}),i==="create"&&u.jsx(Ug,{}),i==="control"&&u.jsx(N_,{}),i==="ide"&&u.jsx(jv,{}),p&&u.jsx(Wv,{open:s}),u.jsx(db,{}),u.jsx(gb,{}),u.jsx(pb,{}),d&&u.jsx(eb,{}),u.jsx(_b,{})]})}function bb(){if(!("serviceWorker"in navigator))return;window.addEventListener("load",()=>{const l=new URL("sw.js",window.location.href);navigator.serviceWorker.register(l,{scope:"./"}).catch(o=>{console.warn("Service worker registration failed:",o)})});let i=!1;navigator.serviceWorker.addEventListener("controllerchange",()=>{i||window.crossOriginIsolated||(i=!0,window.location.reload())})}bb();C2.createRoot(document.getElementById("root")).render(u.jsx(ms.StrictMode,{children:u.jsx(vb,{})}));
