...
`,dp=0,Cr="Backup filenames are reserved for version history. Choose another name.";function Qt(o,r){return`${o}:${r}`}function E0(){const o=W(m=>m.toggleSideMenu),r=W(m=>m.askConfirm),c=W(m=>m.picoIdeOrigin),s=W(m=>m.active),u=W(m=>m.isBleConnected),h=W(m=>m.bleListFiles),_=W(m=>m.bleReadText),g=W(m=>m.bleWriteText),v=W(m=>m.bleDeleteFile),y=W(m=>m.bleRestartAndReconnect),[S,R]=q.useState(!1),[O,Q]=q.useState(!1),[F,le]=q.useState([]),[U,H]=q.useState(!1),[pe,oe]=q.useState([]),[Ee,fe]=q.useState(null),[Ne,ee]=q.useState(()=>Vu(Ou())),[J,ge]=q.useState(Iu),[_e,ye]=q.useState("local"),[se,Ge]=q.useState(()=>{var m;return((m=Vu(Ou()).find(b=>b.path===Iu))==null?void 0:m.content)??Dp}),[Ae,Fe]=q.useState([]),[D,V]=q.useState(!1),[ae,xe]=q.useState(""),[de,E]=q.useState(""),[z,P]=q.useState(null),[A,I]=q.useState(!1),[Z,K]=q.useState(null),[Ke,Le]=q.useState(!1),[pn,ql]=q.useState({}),[ki,va]=q.useState(!1),[ll,xa]=q.useState(0),[al,vo]=q.useState(()=>{var m,b;return((m=Yl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:m.board)??((b=Yl[0])==null?void 0:b.board)??""}),[Xl,Sa]=q.useState(()=>{var m,b;return((m=Yl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:m.version)??((b=Yl[0])==null?void 0:b.version)??""}),[ji,An]=q.useState(!1),[Ai,Gr]=q.useState({top:0,left:0}),[wt,Ea]=q.useState(!1),[wa,Di]=q.useState(!1),[Kl,Zt]=q.useState(!0),[Oi,Ci]=q.useState(""),[zi,Pt]=q.useState(!1),[st,Mt]=q.useState({}),[mt,Jt]=q.useState({}),[_t,Sn]=q.useState(null),[_n,Na]=q.useState(()=>Hh().clearTerminalOnRun),[Wt,Dn]=q.useState(()=>Hh().simplifiedErrors),[il,$l]=q.useState(()=>typeof window<"u"&&window.innerWidth<dp),Ta=q.useRef(null),On=q.useRef(null),lt=q.useRef(null),rl=q.useRef(null),Ra=q.useRef(null),Ma=q.useRef(null),Bi=q.useRef(null),sl=q.useRef(!1),En=q.useRef(!1),ol=q.useRef(!1),cl=q.useRef(null),ka=q.useRef(null),yt=q.useRef(null),Je=q.useRef(null),We=q.useRef(0),Ht=q.useRef(null),wn=q.useRef(null),Vr=q.useRef(null),Il=q.useRef(null),Cn=n0(),me=c==="control"&&!!s&&u(),Ql=me?(s==null?void 0:s.deviceID)??"ble":null,ul=Math.max(1,se.split(`
`).length),fl=new Blob([se]).size,Fl=_e==="pico"?"Picoen":"browseren",dl=q.useMemo(()=>[...new Set(Yl.map(m=>m.board))],[]),Ze=q.useMemo(()=>Yl.filter(m=>m.board===al),[al]),zn=Yl.find(m=>m.board===al&&m.version===Xl)??Ze[0]??Yl[0],Bn=_e==="pico",gn=Bn?wt:wa,ml=zi||gn,Yr=Bn?"Pico MicroPython":"Browser MicroPython",ja=q.useMemo(()=>{const m=new l0({onLine:b=>{if(En.current)return;const w=b.trimEnd();if(ol.current&&w.trim()){$("info",w);return}sl.current&&w.trim()&&!w.includes(">>>")&&!w.includes("raw REPL")&&$("info",w)},onLog:$,onDisconnect:()=>{R(!1),Ea(!1),Pt(!1),sl.current=!1,ol.current=!1,Oa(),$("warning","USB-forbindelse lukket.")}});return Ta.current=m,m},[]);function $(m,b){le(w=>[...w.slice(-140),{level:m,text:b}])}function Aa(m,b=se,w="error"){const G=p0(m,b);le(L=>[...L.slice(-140),{level:w,text:G.simple,technical:G.technical}])}function et(m,b,w=_e){ge(m),ye(w),Ge(b),Jt(G=>({...G,[Qt(w,m)]:b}))}function Zl(m,b="pico"){ge(m),ye(b),Ge(""),Sn(null),Gr({top:0,left:0})}function At(m,b=(w=>(w=Ra.current)==null?void 0:w.selectionStart)()??m.length){Ge(m),Jt(G=>({...G,[Qt(_e,J)]:m})),bl(m,b)}function Nt(m,b=_e){Jt(w=>{const G=Qt(b,m);if(!(G in w))return w;const L={...w};return delete L[G],L})}function qr(){return st[J]===se}function Dt(m,b){Mt(w=>({...w,[m]:b}))}function Da(m,b){Dt(m,b),Jt(w=>({...w,[Qt("pico",m)]:b})),_e==="pico"&&J===m&&Ge(b)}function Oa(){oe([]),Fe([]),Mt({}),Jt({}),Sn(null),ge(m=>{const b=Vu(Ou());if(b.find(L=>L.path===m))return m;const G=b[0];return ye("local"),Ge(G.content),G.path})}function ht(m){Pl(),K({value:100,label:m}),Il.current=window.setTimeout(()=>{Il.current=null,K(null)},900)}function Pl(){Il.current!==null&&(window.clearTimeout(Il.current),Il.current=null)}function Ot(){return Z?f.jsxs("div",{className:"ide-task-progress",role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":Math.round(Z.value),children:[f.jsxs("div",{children:[f.jsx("span",{children:Z.label}),f.jsxs("strong",{children:[Math.round(Z.value),"%"]}),Z.cancellable&&f.jsx("button",{className:"ide-task-cancel",type:"button",onClick:Li,"aria-label":"Stop handling",title:"Stop",children:f.jsx(jt,{name:"delete",size:18})})]}),f.jsx("i",{style:{width:`${Math.max(2,Math.min(100,Z.value))}%`}})]}):null}function Li(){yt.current&&hl("Stopper læsning...",!0,!0)}function hl(m="Stopper læsning...",b=!1,w=!1){var G;Pl(),wn.current=null,We.current+=1,(G=yt.current)==null||G.abort(),yt.current=null,Ht.current=null,fe(null),H(!1),K(b?{value:(Z==null?void 0:Z.value)??0,label:m,cancellable:!1}:null),w&&$("warning","Stopper BLE-læsning efter den aktuelle datapakke.")}function Ui(m){var b;if(!(Ht.current===m||wn.current===m)){if(wn.current=m,Je.current){We.current+=1,(b=yt.current)==null||b.abort(),yt.current=null,Ht.current=null,Zl(m),fe(m),H(!0),Pl(),K({value:2,label:`Skifter til ${De(m)}...`,cancellable:!0});return}Ln()}}function Ln(){if(Je.current)return;const m=wn.current;if(!m)return;wn.current=null;const b=We.current+1;We.current=b;const w=new AbortController;yt.current=w,Ht.current=m,Zl(m),fe(m),H(!0),Pl(),K({value:12,label:`Indlæser ${De(m)}...`,cancellable:!0});const G=(async()=>{try{const L=await _(m,(ie,we)=>{We.current===b&&K({value:ie,label:we,cancellable:!0})},w.signal);if(w.signal.aborted||We.current!==b)return;et(m,L,"pico"),Dt(m,L),ht("Fil indlæst")}catch(L){if(We.current!==b)return;T0(L)||w.signal.aborted?$("info",`Stoppede læsning af ${De(m)}.`):(K(null),$("error",L instanceof Error?L.message:"BLE læsning fejlede."))}})();Je.current=G,G.finally(()=>{if(Je.current!==G)return;Je.current=null,yt.current===w&&(yt.current=null),Ht.current===m&&(Ht.current=null),!!wn.current||(fe(null),H(!1),w.signal.aborted&&K(null)),Ln()})}async function Jl(m){const b=En.current;En.current=!0;try{return await m()}finally{En.current=b}}q.useEffect(()=>{if(!Kl)return;const m=Ma.current;m&&(m.scrollTop=m.scrollHeight)},[F,Kl]),q.useEffect(()=>{jg({clearTerminalOnRun:_n,simplifiedErrors:Wt})},[_n,Wt]),q.useEffect(()=>{var m;Ze.some(b=>b.version===Xl)||Sa(((m=Ze[0])==null?void 0:m.version)??"")},[Ze,Xl]),q.useEffect(()=>{const m=()=>$l(window.innerWidth<dp);return m(),window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[]),q.useEffect(()=>{const m=()=>{const b=Ta.current;On.current=null,lt.current=null,Ta.current=null,b==null||b.disconnect().catch(()=>{})};return window.addEventListener("pagehide",m),()=>{var b;Pl(),(b=cl.current)==null||b.dispose(),cl.current=null,window.removeEventListener("pagehide",m),m()}},[]),q.useEffect(()=>{const m=b=>{!(b.ctrlKey||b.metaKey)||b.key.toLowerCase()!=="s"||(b.preventDefault(),!U&&J.trim()&&!il&&!A&&!z&&!D&&Hi())};return window.addEventListener("keydown",m),()=>window.removeEventListener("keydown",m)},[_e,me,U,S,se,J,il,A,z,D]);function Ca(m,b,w){ee(G=>{const L=C0(G,m,b,w);return Cu(L),L})}const Un=U0(pe,Ne,mt,S||me);q.useEffect(()=>{me&&ot()},[me]),q.useEffect(()=>{const m=Vr.current;m&&m!==Ql&&Oa(),Vr.current=Ql},[Ql]);async function xo(){if(Cn.supported){Q(!0);try{await ja.requestAndConnect();const m=new Lb(ja);On.current=m,lt.current=new qb(m),R(!0),xa(0),await m.interrupt(),await Xr(m),$("success","Sendte stop-signal til Pico REPL."),await $r(lt.current),await za(lt.current)}catch(m){$("error",m instanceof Error?m.message:"USB-forbindelse mislykkedes.");try{await ja.disconnect()}catch(b){$("error",b instanceof Error?`USB-porten kunne ikke lukkes: ${b.message}`:"USB-porten kunne ikke lukkes.");return}xa(b=>{const w=b+1;return w>=3&&($("info","USB-forbindelsen er mislykkedes flere gange. Hvis Picoen er i BOOTSEL eller mangler MicroPython, kan du bruge MicroPython-download."),va(!0)),w}),R(!1)}finally{Q(!1)}}}async function Xr(m){const b=await m.exec(`import sys
print(sys.implementation.name)
`,4e3);if(b.error||!b.output.toLowerCase().includes("micropython"))throw new Error("MicroPython blev ikke fundet på Picoen.")}async function Kr(){var m;try{await((m=Ta.current)==null?void 0:m.disconnect()),On.current=null,lt.current=null,R(!1),Oa()}catch(b){$("error",b instanceof Error?`USB-porten kunne ikke lukkes: ${b.message}`:"USB-porten kunne ikke lukkes.")}}async function en(m){const b=lt.current;if(b){H(!0),En.current=!0;try{await m(b)}catch(w){K(null),$("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{En.current=!1,H(!1)}}}async function ot(m=!0){if(me){H(!0);try{const b=await h();oe(b),m&&$("success",`Indlæste ${b.length} filer fra Pico via Bluetooth.`)}catch(b){$("error",b instanceof Error?b.message:"BLE filhandling fejlede.")}finally{H(!1)}return}await $r(lt.current,m)}async function $r(m,b=!0){if(m){H(!0);try{const w=await Jl(()=>m.list("/"));oe(w),b&&$("success",`Indlæste ${w.length} filer fra Pico.`)}catch(w){$("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{H(!1)}}}async function bn(){if(me){H(!0),K({value:4,label:"Tjekker biblioteker på Pico via Bluetooth..."});try{const m=await tn((b,w)=>K({value:b,label:w}));Fe(m),ht("Fil-tjek færdigt")}catch(m){K(null),$("error",m instanceof Error?m.message:"BLE runtime check fejlede.")}finally{H(!1)}return}await za(lt.current)}async function tn(m){const b=[],w=Or.filter(L=>L.kind==="library"&&!ga(L));let G=0;for(const L of Or){if(L.kind==="program"){b.push({...L,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}if(ga(L)){b.push({...L,status:"unknown",detail:"Opdateres via USB"});continue}try{const ie=G/Math.max(1,w.length)*100,we=100/Math.max(1,w.length);$("info",`Tjekker ${L.label} på Pico via Bluetooth...`),m==null||m(Math.min(95,ie),`Tjekker ${L.label} på Pico...`);const Be=await _(L.path,(ln,$e)=>{m==null||m(Math.min(95,ie+ln/100*we),`${L.label}: ${$e}`)}),at=io(Be)===io(L.content);b.push({...L,status:at?"ok":"outdated",detail:at?"Matcher appens version":"Kan installeres via Bluetooth"})}catch{b.push({...L,status:"missing",detail:"Mangler på Pico"})}finally{G+=1}}return m==null||m(100,"Fil-tjek færdigt"),b}async function za(m){if(m){H(!0);try{const b=await Jl(()=>Ba(m)),w=b;Fe(w)}catch(b){$("error",b instanceof Error?b.message:"Runtime check fejlede.")}finally{H(!1)}}}async function Ba(m){if(!m)return[];const b=[];for(const w of Or){if(w.kind==="program"){b.push({...w,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}try{const G=await m.readText(w.path),L=io(G)===io(w.content);b.push({...w,status:L?"ok":"outdated",detail:L?"Matcher appens version":"Matcher ikke appens version"})}catch{b.push({...w,status:"missing",detail:"Mangler på Pico"})}}return b}async function pl(m=J){if(me){Ui(m);return}fe(m),await en(async b=>{K({value:12,label:`Indlæser ${De(m)}...`});const w=await b.readText(m);et(m,w,"pico"),Dt(m,w),ht("Fil indlæst")}),fe(null)}function _l(){I(!0)}async function Hi(){if(_e==="pico"){if(!S&&!me){$("error","Ingen Pico-forbindelse. Brug Gem for at vælge en anden placering.");return}await Ua();return}La()}function La(){if(Si(J)){$("error",Cr);return}Ca(J,se,!1),ye("local"),Jt(m=>({...m,[Qt("local",J)]:se})),I(!1),$("success",`Gemte ${De(J)} lokalt.`)}async function Ua(){if(I(!1),Si(J))return K(null),$("error",Cr),!1;if(K({value:0,label:"Starter gemning..."}),me){H(!0);try{return await g(J,se,(b,w)=>K({value:b,label:w})),Dt(J,se),ye("pico"),Jt(b=>({...b,[Qt("pico",J)]:se})),ht("Gemt på Pico via Bluetooth"),$("success",`Gemte ${De(J)} på Pico via Bluetooth.`),ro(J)&&(An(!0),$("warning","main.py er gemt. Genstart Picoen for at køre den nye version.")),await ot(!1),!0}catch(b){return K(null),$("error",b instanceof Error?b.message:"BLE gem fejlede."),!1}finally{H(!1)}}if(!lt.current)return K(null),!1;let m=!1;return await en(async b=>{Tn(J,"pico")?await b.replaceTextSafely(J,se,(w,G)=>K({value:w,label:G})):await b.writeText(J,se,(w,G)=>K({value:w,label:G})),Dt(J,se),ye("pico"),Jt(w=>({...w,[Qt("pico",J)]:se})),ht("Gemt på Pico via USB"),$("success",`Gemte ${J}.`),await ot(),await bn(),m=!0}),m}function Wl(){const m=new Blob([se],{type:"text/plain;charset=utf-8"}),b=URL.createObjectURL(m),w=document.createElement("a");w.href=b,w.download=De(J),w.click(),URL.revokeObjectURL(b),I(!1),$("success",`Downloadede ${De(J)}.`)}async function nn(m){H(!0),An(!1),K({value:10,label:"Genstarter Pico..."});try{await y(m)?(ht("Pico genforbundet"),$("success",m==="control"?"Pico genforbundet. Åbner kontrolpanelet.":"Pico genforbundet til Kodeværkstedet."),m==="ide"&&await ot()):(K(null),$("warning","Automatisk genforbindelse lykkedes ikke. Vælg Picoen fra dashboardet."))}catch(b){K(null),$("error",b instanceof Error?b.message:"Genstart/genforbindelse mislykkedes.")}finally{H(!1)}}function Ha(m){var ie;const b=m??{path:J,source:_e},w=b.source==="pico"?"Pico":"browser",G=b.source==="pico"?(m==null?void 0:m.versions.length)??((ie=Qu(pe).get(b.path))==null?void 0:ie.length)??0:0,L=G>0?` This will delete the file and its saved version history (${G} saved versions).`:"";P(null),r({title:"Slet fil",message:`Vil du slette ${De(b.path)} fra ${w}?${L}`,confirmLabel:"Slet",onConfirm:()=>{ea(b)}})}async function ea(m){const b=m.path,w=m.source,G=b===J&&w===_e;if(w==="local"){const we=Ne.filter(Be=>Be.path!==b);ee(we),Cu(we),G&&et(b,"","local"),Nt(b,"local"),$("warning",`Slettede ${De(b)} fra browseren.`);return}const L=Qu(pe).get(b)??[],ie=[b,...L.map(we=>we.path)];if(me){H(!0);try{for(const Be of ie)await v(Be);Mt(Be=>{const at={...Be};for(const ln of ie)delete at[ln];return at}),G&&et(b,"","pico");for(const Be of ie)Nt(Be,"pico");const we=L.length>0?` og ${L.length} gemte versioner`:"";$("warning",`Slettede ${De(b)}${we} på Pico via Bluetooth.`),await ot()}catch(we){$("error",we instanceof Error?we.message:"BLE sletning fejlede.")}finally{H(!1)}return}if(!lt.current){$("error","Ingen Pico-forbindelse. Kan ikke slette Pico-filen.");return}await en(async we=>{for(const at of ie)await we.delete(at);Mt(at=>{const ln={...at};for(const $e of ie)delete ln[$e];return ln});const Be=L.length>0?` og ${L.length} gemte versioner`:"";$("warning",`Slettede ${b}${Be}.`),G&&et(b,"","pico");for(const at of ie)Nt(at,"pico");await ot(),await bn()})}async function Nn(m){if(!m)return;const b=w0(m.name);if(!b){$("error","Kun .py, .txt, .json og .csv kan importeres.");return}if(Si(b)){$("error",Cr);return}if(m.size>128*1024){$("error","Filen er for stor til Pico-værkstedet.");return}const w=await m.text();if(_e==="local"){Ca(b,w,!0),et(b,w,"local"),$("success",`Importerede ${De(b)} i browseren.`);return}if(!S&&!me){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(me&&ga({path:b})){$("error","BLEPeripheral.py kan ikke importeres over Bluetooth, mens den holder forbindelsen i gang. Brug USB i stedet.");return}if(K({value:0,label:"Uploader fil til Pico..."}),me){H(!0);try{await g(b,w,(L,ie)=>K({value:L,label:ie})),Dt(b,w),et(b,w,"pico"),ht("Fil uploadet til Pico"),$("success",`Importerede ${De(b)} på Pico via Bluetooth.`),await ot()}catch(L){K(null),$("error",L instanceof Error?L.message:"Kunne ikke importere filen til Pico.")}finally{H(!1)}return}if(!lt.current){K(null),$("error","Ingen Pico-forbindelse. Kan ikke importere filen til Pico.");return}await en(async L=>{Tn(b,"pico")?await L.replaceTextSafely(b,w,(ie,we)=>K({value:ie,label:we})):await L.writeText(b,w,(ie,we)=>K({value:ie,label:we})),Dt(b,w),et(b,w,"pico"),ht("Fil uploadet til Pico"),$("success",`Importerede ${De(b)} på Pico.`),await ot(),await bn()})}async function Gi(){xe(""),V(!0)}function Ga(){const m=mp(ae);if(!m)return;if(Si(m)){$("error",Cr);return}const b=_e;if(Tn(m,b)){$("error",`Der findes allerede en fil med navnet ${De(m)} i ${b==="pico"?"Pico":"browseren"}.`);return}if(b==="local"){Ca(m,"",!1),et(m,"","local"),V(!1),$("success",`Oprettede ${De(m)} i browseren.`);return}Ir(m)}async function Ir(m){if(!S&&!me){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(V(!1),K({value:0,label:"Opretter fil på Pico..."}),me){H(!0);try{await g(m,"",(b,w)=>K({value:b,label:w})),Dt(m,""),et(m,"","pico"),ht("Fil oprettet på Pico"),$("success",`Oprettede ${De(m)} på Pico via Bluetooth.`),await ot()}catch(b){K(null),$("error",b instanceof Error?b.message:"Kunne ikke oprette fil på Pico.")}finally{H(!1)}return}if(!lt.current){K(null),$("error","Ingen Pico-forbindelse. Kan ikke oprette Pico-filen.");return}await en(async b=>{await b.writeText(m,"",(w,G)=>K({value:w,label:G})),Dt(m,""),et(m,"","pico"),ht("Fil oprettet på Pico"),$("success",`Oprettede ${De(m)} på Pico.`),await ot()})}function Va(m){m.type==="file"&&(P(m),E(N0(m.path)))}async function Ya(m){if(!z||z.source!=="pico")return;const b=z.path;if(P(null),K({value:0,label:"Gendanner version..."}),me){H(!0);try{const w=await _(m.path);await g(b,w,(G,L)=>K({value:G,label:L})),Dt(b,w),et(b,w,"pico"),ht("Version gendannet"),await ot(!1)}catch(w){K(null),$("error",w instanceof Error?w.message:"Kunne ikke gendanne versionen.")}finally{H(!1)}return}lt.current&&await en(async w=>{await w.replaceTextSafely(b,await w.readText(m.path),(L,ie)=>K({value:L,label:ie}));const G=await w.readText(b);Dt(b,G),et(b,G,"pico"),ht("Version gendannet"),await ot()})}function Qr(m){r({title:"Slet version",message:`Vil du slette ${De(m.path)} fra Pico?`,confirmLabel:"Slet",onConfirm:()=>{Tt(m)}})}async function Tt(m){if(me){H(!0);try{await v(m.path),await ot(!1),P(b=>b&&{...b,versions:b.versions.filter(w=>w.path!==m.path)})}catch(b){$("error",b instanceof Error?b.message:"Kunne ikke slette versionen.")}finally{H(!1)}return}lt.current&&await en(async b=>{await b.delete(m.path),await ot(!1),P(w=>w&&{...w,versions:w.versions.filter(G=>G.path!==m.path)})})}async function Hn(){if(!z)return;const m=z,b=Gu(de,zr(m.path));if(!b||b===m.path)return;if(Si(b)){$("error",Cr);return}if(Tn(b,m.source)){$("error",`Der findes allerede en fil med navnet ${De(b)}.`);return}const w=m.source==="local",G=m.source==="pico";if(me&&G&&(ro(m.path)||ro(b))){$("error","main.py kan redigeres over Bluetooth, men ikke omdøbes. Gem den som main.py.");return}H(!0);try{if(G)if(me){const L=st[m.path]??await _(m.path);await g(b,L,(ie,we)=>K({value:ie,label:we})),await v(m.path),Mt(ie=>({..._p(ie,m.path,b),[b]:L}))}else lt.current&&(await Jl(()=>lt.current.rename(m.path,b)),Mt(L=>_p(L,m.path,b)));w&&ee(L=>{const ie=L.map(we=>we.path===m.path?{...we,path:b,updatedAt:Date.now()}:we);return Cu(ie),ie}),J===m.path&&_e===m.source&&ge(b),Jt(L=>V0(L,m.source,m.path,b)),P(null),E(""),$("success",`Omdøbte ${De(m.path)} til ${De(b)}.`),G&&await ot()}catch(L){$("error",L instanceof Error?L.message:"Kunne ikke omdøbe filen.")}finally{K(null),H(!1)}}function Tn(m,b){return b==="pico"?pe.some(w=>w.path===m):Ne.some(w=>w.path===m)}async function ta(m){if(!Tn(m,"pico"))return;const b=B0(m,pe),w=st[m]??await _(m);await g(b,w)}function So(m){if(m.type!=="file"){me&&hl(void 0,!1),ge(m.path),ye(m.source);return}if(me&&ga(m)){$("warning","BLEPeripheral.py holder Bluetooth-forbindelsen i gang og kan ikke åbnes her.");return}if(m.source==="local"){me&&hl(void 0,!1);const w=Ne.find(G=>G.path===m.path);et(m.path,mt[Qt("local",m.path)]??(w==null?void 0:w.content)??"","local");return}const b=Qt("pico",m.path);if(Object.prototype.hasOwnProperty.call(mt,b)){me&&hl(void 0,!1),et(m.path,mt[b],"pico");return}if(Object.prototype.hasOwnProperty.call(st,m.path)){me&&hl(void 0,!1),et(m.path,st[m.path],"pico");return}pl(m.path)}async function qa(){if(!(!S&&!me)){H(!0),K({value:4,label:me?"Tjekker biblioteker på Pico via Bluetooth...":"Tjekker biblioteker på Pico..."}),$("info",me?"Tjekker om Picoens biblioteker er opdaterede via Bluetooth før installation...":"Tjekker om Picoens biblioteker er opdaterede før installation...");try{const m=Ae.length>0?Ae:me?await tn((w,G)=>K({value:w,label:G})):await Jl(()=>Ba(lt.current));Fe(m);const b={};m.forEach(w=>{b[w.id]=!1}),ql(b),Le(!0),K(null)}catch(m){K(null),$("error",m instanceof Error?m.message:"Fil-tjek før installation fejlede.")}finally{H(!1)}}}async function Vi(){if(Le(!1),me){H(!0);try{const b=(Ae.length>0?Ae:Or.map(G=>({...G,status:"unknown",detail:"Ikke tjekket"}))).filter(G=>pn[G.id]&&!ga(G));if(b.length===0){$("info","Ingen filer valgt til installation.");return}let w=null;K({value:0,label:"Starter installation..."});for(const[G,L]of b.entries()){$("info",`Installerer ${L.label} via Bluetooth...`);const ie=G/b.length*100,we=100/b.length;await ta(L.path),await g(L.path,L.content,(Be,at)=>{K({value:Math.min(99,ie+Be/100*we),label:`${L.label}: ${at}`})}),Da(L.path,L.content),$("success",`Installerede ${L.label}.`),L.kind==="library"&&(w=L),ro(L.path)&&An(!0)}ht("Installation færdig"),await ot(!1),await bn(),w&&gl(w)}catch(m){K(null),$("error",m instanceof Error?m.message:"BLE installation fejlede.")}finally{H(!1)}return}await en(async m=>{const w=(Ae.length>0?Ae:Or.map(L=>({...L,status:"unknown",detail:"Ikke tjekket"}))).filter(L=>pn[L.id]);if(w.length===0){$("info","Ingen filer valgt til installation.");return}let G=null;K({value:0,label:"Starter installation..."});for(const[L,ie]of w.entries()){$("info",`Installerer ${ie.label}...`);const we=L/w.length*100,Be=100/w.length;await m.replaceTextSafely(ie.path,ie.content,(at,ln)=>{K({value:Math.min(99,we+at/100*Be),label:`${ie.label}: ${ln}`})},{createBackup:!0}),Da(ie.path,ie.content),$("success",`Installerede ${ie.label}.`),ie.kind==="library"&&(G=ie)}ht("Installation færdig"),await ot(!1),await bn(),G&&gl(G)})}function gl(m){et(m.path,m.content,"pico"),Dt(m.path,m.content),$("info",`Åbnede ${m.label} i editoren.`)}function Xa(m,b){ql(w=>{if(m.kind!=="program")return{...w,[m.id]:b};const G={...w};for(const L of Ae)L.kind==="program"&&(G[L.id]=!1);return G[m.id]=b,G})}async function Fr(){if(Mo(),me&&_e==="pico"){$("warning","Bluetooth holder forbindelsen åben, så koden kan ikke køres direkte her. Gem filen, og genstart Picoen for at køre den.");return}if(_e==="local"){await Eo();return}const m=On.current;if(!m){$("error",`${De(J)} er gemt på Picoen, men der er ingen USB-forbindelse til Pico REPL.`);return}if(J.endsWith(".py")){if(!qr()&&($("info",`${De(J)} har ikke gemte ændringer. Gemmer på Picoen før kørsel...`),!await Ua())){$("error","Pico-forbindelsen blev afbrudt under gemning.");return}if(U)return;Ea(!0),sl.current=!0,Zt(!0);try{await m.runFile(J),$("success",`Kører ${De(J)}. Brug Stop for at afbryde.`)}catch(b){Ea(!1),sl.current=!1,$("error",b instanceof Error?b.message:"Kunne ikke starte koden.")}return}H(!0);try{const b=await m.exec(se,2e4);b.output.trim()&&$("info",b.output),b.error.trim()&&Aa(b.error,se),!b.output.trim()&&!b.error.trim()&&$("success","Koden kørte uden output.")}catch(b){$("error",b instanceof Error?b.message:"Kunne ikke køre koden.")}finally{H(!1)}}async function Eo(){const m=Ku(se);if(m.some(w=>w.level==="error")){for(const w of m){const G=w.line?`Linje ${w.line}: `:"";$(w.level==="error"?"error":"warning",`${G}${w.text}`)}return}const b=new AbortController;ka.current=b,H(!0),Di(!0),Zt(!0),$("info",S?"Starter offline MicroPython for browser-filen.":"Starter offline MicroPython. Forbind Pico med USB for at køre på selve Picoen.");try{const w=[],G=await o0(se,{signal:b.signal,onOutput:Be=>{w.push(Be),$("info",Be)}});for(const Be of G.issues){const at=Be.line?`Linje ${Be.line}: `:"";$(Be.level==="error"?"error":"warning",`${at}${Be.text}`)}const L=[...w,G.output].filter(Boolean).join(`
`).trim(),ie=G.output.trim();!G.error.trim()&&R0(L)?Aa(L,se):(ie&&$("info",ie),G.error.trim()&&Aa(G.error,se,G.unavailable?"warning":"error")),G.ok&&!L&&!G.error.trim()&&$("success","Offline MicroPython kørte uden output.")}finally{ka.current=null,Di(!1),H(!1)}}async function wo(){var b,w;if(wa){(b=ka.current)==null||b.abort(),$("warning","Stoppede offline MicroPython."),Zt(!0);return}if(!Bn&&zi){(w=cl.current)==null||w.reset(),Pt(!1),$("warning","Stoppede Browser MicroPython REPL. Variablerne i browser-REPL blev nulstillet."),Zt(!0);return}const m=On.current;if(m)try{await m.stop(),$("warning","Stoppede koden på Pico.")}catch(G){$("error",G instanceof Error?G.message:"Kunne ikke stoppe koden.")}finally{Ea(!1),sl.current=!1,Zt(!0)}}function No(){const m=Ma.current;if(!m)return;const b=m.scrollHeight-m.scrollTop-m.clientHeight<12;Zt(b)}function Yi(){le([]),Zt(!0)}async function To(){const m=Oi.trimEnd();if(!m.trim())return;if(gn){$("warning",Bn?"Tryk Stop, før du skriver i Pico REPL.":"Stop offline MicroPython, før du skriver i Browser REPL.");return}if(!Bn){const w=Ku(m);if(w.some(L=>L.level==="error")){for(const L of w){const ie=L.line?"Linje "+L.line+": ":"";$(L.level==="error"?"error":"warning",ie+L.text)}return}const G=cl.current??new s0;cl.current=G,Ci(""),Pt(!0),Zt(!0),$("info",">>> "+m);try{let L=!1;const ie=await G.send(m,{timeoutMs:15e3,onOutput:Be=>{L=!0,$("info",Be)}}),we=ie.output.trim();we&&!L&&$("info",we),ie.error.trim()&&Aa(ie.error,m,ie.unavailable?"warning":"error")}catch(L){$("error",L instanceof Error?L.message:"Browser MicroPython REPL fejlede.")}finally{Pt(!1)}return}if(me){$("warning","REPL-terminalen bruger USB Serial. Bluetooth-forbindelsen kan vise filer, men kan ikke modtage frie REPL-kommandoer.");return}const b=On.current;if(!S||!b){$("warning","Forbind en Micro Controller med USB for at skrive i MicroPython REPL.");return}Ci(""),Pt(!0),Zt(!0),ol.current=!0,$("info",">>> "+m);try{await b.sendFriendlyLine(m)}catch(w){ol.current=!1,$("error",w instanceof Error?w.message:"Kunne ikke sende kommando til MicroPython REPL.")}finally{Pt(!1)}}function Zr(m,b,w){return w.length===0?null:f.jsxs("div",{className:"ide-install-group",children:[f.jsxs("div",{className:"ide-install-group-head",children:[f.jsx("h3",{children:m}),f.jsx("p",{children:b})]}),w.map(G=>{const L=me&&ga(G);return f.jsxs("label",{className:`ide-install-row ${L?"disabled":""}`,children:[f.jsx("input",{type:"checkbox",checked:!!pn[G.id],disabled:L,onChange:ie=>Xa(G,ie.target.checked)}),f.jsxs("span",{children:[f.jsxs("strong",{children:[Ro(G),G.kind==="library"&&f.jsx("em",{className:`ide-install-status status-${G.status}`,children:L?"USB":L0(G.status)})]}),f.jsx("small",{children:G.description})]})]},G.id)})]})}function Ro(m){return m.kind==="program"?m.label.replace(/\s*\(main\.py\)$/i,""):m.label}function Mo(){_n&&le([]),Zt(!0)}function ko(m,b){const w=m.indexOf(`
`,b);return w===-1?m.length:w}function bl(m,b){const w=j0(m,b);if(!w||w.query.length<1){Sn(null);return}const G=w.query.toLowerCase(),L=k0.filter(we=>we.label.toLowerCase().startsWith(G)).slice(0,8),ie=A0(Ra.current,b);Sn(L.length>0&&ie?{items:L,selected:0,start:w.start,end:b,position:ie}:null)}function Pr(m=_t==null?void 0:_t.items[_t.selected]){if(!m||!_t)return;const b=se.slice(0,_t.start)+m.insert+se.slice(_t.end),w=_t.start+m.insert.length-(m.insert.endsWith("()")?1:0);Ge(b),Jt(G=>({...G,[Qt(_e,J)]:b})),Sn(null),window.requestAnimationFrame(()=>{const G=Ra.current;G&&(G.focus(),G.selectionStart=w,G.selectionEnd=w,bl(b,w))})}function jo(m){if((m.ctrlKey||m.metaKey)&&m.key.toLowerCase()==="s"){m.preventDefault(),!U&&J.trim()&&Hi();return}if(_t){if(m.key==="ArrowDown"){m.preventDefault(),Sn($e=>$e&&{...$e,selected:($e.selected+1)%$e.items.length});return}if(m.key==="ArrowUp"){m.preventDefault(),Sn($e=>$e&&{...$e,selected:($e.selected-1+$e.items.length)%$e.items.length});return}if(m.key==="Enter"||m.key==="Tab"){m.preventDefault(),Pr();return}if(m.key==="Escape"){m.preventDefault(),Sn(null);return}}if(m.key!=="Tab")return;m.preventDefault();const b=m.currentTarget,w=b.selectionStart,G=b.selectionEnd,L="    ";if(m.shiftKey){const $e=se.lastIndexOf(`
`,w-1)+1,Jr=w===G?ko(se,w):G,Ao=se.slice($e,Jr);let qi=0,Xi=0;const Do=Ao.replace(/(^|\n)( {1,4}|\t)/g,(Ka,Oo,Wr,es)=>{const $i=Wr.length;return $e+es<w&&(qi+=$i),Xi+=$i,Oo});if(Xi===0)return;const Ki=se.slice(0,$e)+Do+se.slice(Jr);At(Ki,Math.max($e,w-qi)),window.requestAnimationFrame(()=>{b.selectionStart=Math.max($e,w-qi),b.selectionEnd=w===G?b.selectionStart:Math.max(b.selectionStart,G-Xi)});return}if(w===G){const $e=se.slice(0,w)+L+se.slice(G);At($e,w+L.length),window.requestAnimationFrame(()=>{b.selectionStart=w+L.length,b.selectionEnd=w+L.length});return}const ie=se.lastIndexOf(`
`,w-1)+1,Be=se.slice(ie,G).replace(/^/gm,L),at=Be.split(`
`).length,ln=se.slice(0,ie)+Be+se.slice(G);At(ln,w+L.length),window.requestAnimationFrame(()=>{b.selectionStart=w+L.length,b.selectionEnd=G+at*L.length})}return f.jsxs("div",{className:"screen ide-screen",children:[f.jsx(tf,{title:"Pico Kodeværksted",onMenu:()=>o()}),il?f.jsx("div",{className:"ide-size-gate",role:"dialog","aria-modal":"true","aria-labelledby":"ide-size-title",children:f.jsxs("div",{className:"ide-size-gate-panel",children:[f.jsx("h2",{id:"ide-size-title",children:"Brug en bærbar for at bruge Kodeværkstedet"}),f.jsx("p",{children:"Denne skærm er for lille, så du skal åbne Kodeværkstedet på en bærbar eller en større skærm."})]})}):f.jsxs("div",{className:"ide-layout",children:[f.jsxs("section",{className:"ide-panel ide-files-panel",children:[f.jsxs("div",{className:"ide-panel-head",children:[f.jsx("h2",{children:"Filer"}),f.jsxs("div",{className:"ide-mini-actions",children:[f.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:Gi,"aria-label":"Ny fil",title:"Ny fil",children:f.jsx(jt,{name:"plus",size:20})}),f.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>{var m;return(m=rl.current)==null?void 0:m.click()},"aria-label":"Importer fil",title:"Importer fil",children:f.jsx(jt,{name:"upload",size:20})}),f.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>ot(),disabled:!S&&!me||U,"aria-label":"Opdater filer",title:"Opdater filer",children:f.jsx(jt,{name:"refresh",size:20})})]})]}),f.jsx("div",{className:"ide-file-list",children:Un.length===0?f.jsx("button",{type:"button",disabled:!0,children:"Ingen filer læst"}):Un.map(m=>{if(m.kind==="separator"){const L=m.id==="pico-files"&&!S&&!me;return f.jsxs(q.Fragment,{children:[f.jsx("div",{className:"ide-file-separator",children:f.jsx("span",{children:m.label})}),L&&f.jsx("div",{className:"ide-file-disconnected",role:"status",children:"Ikke forbundet"})]},m.id)}const b=me&&ga(m),w=mt[Qt(m.source,m.path)],G=w!==void 0&&w!==z0(m,Ne,st);return f.jsxs("div",{className:`ide-file-row ${J===m.path&&_e===m.source?"active":""} ${b?"protected":""}`,children:[f.jsxs("button",{type:"button",onClick:()=>So(m),disabled:b,title:b?"Holder Bluetooth-forbindelsen i gang og kan ikke åbnes her":void 0,children:[f.jsx("span",{children:m.name}),f.jsx("small",{title:G?"Ikke gemte ændringer":"Ingen ikke gemte ændringer",children:f.jsx("i",{className:`ide-file-dirty-dot ${G?"dirty":"clean"}`,"aria-hidden":"true"})})]}),f.jsx("button",{className:"ide-file-actions",type:"button",onClick:()=>Va(m),disabled:m.type!=="file"||U||b,"aria-label":`Filvalg for ${m.name}`,title:b?"Holder Bluetooth-forbindelsen i gang og kan ikke ændres her":"Filvalg",children:f.jsx(jt,{name:"settings",size:16})})]},`${m.source}:${m.path}`)})})]}),f.jsxs("section",{className:"ide-panel ide-status-panel",children:[f.jsxs("div",{children:[f.jsxs("div",{className:"ide-status-head",children:[f.jsx("h2",{children:me?"Forbundet Pico":"USB udvikling"}),!me&&f.jsx("span",{className:`ide-usb-status ${Cn.supported?"available":"unavailable"}`,title:Cn.message,"data-tooltip":Cn.message,role:"img","aria-label":Cn.message,tabIndex:0,children:"!"})]}),me&&f.jsxs("p",{children:[(s==null?void 0:s.deviceName)??"Pico"," er forbundet via Bluetooth."]})]}),!me&&f.jsxs("div",{className:"ide-actions",children:[f.jsx("button",{className:"btn btn-primary",type:"button",onClick:S?Kr:xo,disabled:!Cn.supported||O,children:O?"Forbinder...":S?"Afbryd USB":"Forbind USB"}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:qa,disabled:!S||me||U,children:"Installer"})]}),me&&f.jsxs("div",{className:"ide-actions",children:[f.jsxs("button",{className:"btn btn-primary ide-connection-state",type:"button",disabled:!0,children:[f.jsx(jt,{name:"power",size:22}),"Bluetooth forbundet"]}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:qa,disabled:U,children:"Installer"})]}),f.jsx("div",{className:"ide-runtime",children:f.jsxs("div",{className:`ide-mini-actions ${me?"single":""}`,children:[f.jsx("button",{className:"btn btn-outline",type:"button",onClick:bn,disabled:!S&&!me||U,children:"Tjek filer"}),!me&&f.jsx("button",{className:"btn btn-outline ide-disconnect-btn",type:"button",onClick:()=>va(!0),children:"MicroPython"})]})})]}),f.jsxs("section",{className:"ide-panel ide-editor-panel",children:[f.jsxs("div",{className:"ide-panel-head",children:[f.jsx("div",{className:"ide-editor-title",children:f.jsxs("h2",{children:[De(J),f.jsxs("small",{children:[fl," bytes"]})]})}),f.jsxs("div",{className:"ide-mini-actions",children:[f.jsx("button",{className:"btn btn-outline",type:"button",onClick:Fr,disabled:U,children:"Kør"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:wo,disabled:!wa&&!(!Bn&&zi)&&(!S||!wt),children:"Stop"}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:_l,disabled:U||!J.trim(),children:"Gem"}),f.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Ha(),disabled:U||!J.trim(),children:"Slet"})]})]}),Ot(),f.jsxs("div",{className:"ide-editor-wrap",children:[f.jsx("div",{className:"ide-line-numbers","aria-hidden":"true",style:{transform:`translateY(${-Ai.top}px)`},children:Array.from({length:ul},(m,b)=>f.jsx("span",{children:b+1},b))}),f.jsx("pre",{className:"ide-highlight","aria-hidden":"true",style:{transform:`translate(${-Ai.left}px, ${-Ai.top}px)`},children:O0(se)}),f.jsx("textarea",{ref:Ra,className:"ide-editor",value:se,onChange:m=>At(m.target.value,m.target.selectionStart),onKeyDown:jo,onKeyUp:m=>{["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(m.key)||bl(m.currentTarget.value,m.currentTarget.selectionStart)},onClick:m=>bl(m.currentTarget.value,m.currentTarget.selectionStart),onScroll:m=>{Gr({top:m.currentTarget.scrollTop,left:m.currentTarget.scrollLeft}),_t&&bl(m.currentTarget.value,m.currentTarget.selectionStart)},spellCheck:!1}),_t&&f.jsx("div",{className:"ide-autocomplete",role:"listbox","aria-label":"Kodeforslag",style:{left:_t.position.left,top:_t.position.top},children:_t.items.map((m,b)=>f.jsx("button",{className:b===_t.selected?"active":"",type:"button",onMouseDown:w=>{w.preventDefault(),Pr(m)},role:"option","aria-selected":b===_t.selected,children:m.label},m.label))}),Ee&&f.jsxs("div",{className:"ide-editor-loading",role:"status","aria-live":"polite",children:[f.jsx("span",{className:"spinner","aria-hidden":"true"}),f.jsxs("strong",{children:["Indlæser ",De(Ee),"..."]})]})]})]}),f.jsxs("section",{className:"ide-panel ide-terminal-panel",children:[f.jsxs("div",{className:"ide-panel-head",children:[f.jsx("h2",{children:"Terminal"}),f.jsxs("div",{className:"ide-mini-actions",children:[f.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${Wt?"":"active"}`,type:"button",onClick:()=>Dn(m=>!m),"aria-label":Wt?"Tekniske fejl er slået fra":"Tekniske fejl er slået til","aria-pressed":!Wt,title:Wt?"Vis originale tekniske fejl":"Viser originale tekniske fejl",children:"Teknisk"}),f.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${_n?"active":""}`,type:"button",onClick:()=>Na(m=>!m),"aria-pressed":_n,title:_n?"Terminalen ryddes, hver gang du trykker Kør":"Terminalen beholder tekst, når du trykker Kør",children:"Ryd ved Kør"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:Yi,disabled:F.length===0,children:"Ryd"})]})]}),f.jsxs("div",{className:"ide-terminal","aria-live":"polite",ref:Ma,onScroll:No,onClick:()=>{var m;return(m=Bi.current)==null?void 0:m.focus()},children:[F.length===0?f.jsx("div",{className:"term-line",children:"Ingen terminaldata endnu."}):F.map((m,b)=>f.jsx("div",{className:`term-line term-${m.level}`,children:m.technical&&!Wt?m.technical:m.text},`${b}-${m.text}`)),f.jsxs("form",{className:`ide-terminal-command ${gn?"locked":""}`,onSubmit:m=>{m.preventDefault(),To()},children:[f.jsx("span",{"aria-hidden":"true",children:">>>"}),f.jsx("input",{ref:Bi,value:Oi,onChange:m=>Ci(m.target.value),disabled:ml,placeholder:Yr,"aria-label":"MicroPython REPL command",title:Yr})]})]})]})]}),f.jsx("input",{ref:rl,type:"file",accept:".py,.txt,.json,.csv",className:"sr-only",onChange:m=>{var b;Nn((b=m.target.files)==null?void 0:b[0]),m.currentTarget.value=""}}),A&&f.jsx(bt,{title:"Gem fil",onClose:()=>I(!1),children:f.jsxs("div",{className:"ide-save-options",children:[f.jsx("button",{className:"btn btn-primary",type:"button",onClick:La,children:"Gem i browser"}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:()=>void Ua(),disabled:!S&&!me||U,children:"Gem på Pico"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:Wl,children:"Download til computer"})]})}),Ke&&f.jsx(bt,{title:"Installer filer",onClose:()=>Le(!1),children:f.jsxs("div",{className:"ide-install-list",children:[f.jsx("p",{className:"ide-install-note",children:"Vælg et startprogram og de biblioteker dit projekt bruger. Ingen filer er valgt på forhånd."}),f.jsxs("div",{className:"ide-install-grid",children:[Zr("Startprogrammer (main.py)","Starter automatisk på Picoen.",Ae.filter(m=>m.kind==="program")),Zr("Biblioteker","Ekstra Python-filer som dine programmer kan importere.",Ae.filter(m=>m.kind==="library"))]}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:Vi,disabled:U,children:"Installer valgte"})]})}),ji&&f.jsx(bt,{title:"main.py er gemt",onClose:()=>An(!1),children:f.jsxs("div",{className:"settings-stack",children:[f.jsx("p",{className:"confirm-message",children:"Picoen kører stadig den gamle kode. Genstart Picoen for at anvende den nye main.py. Appen forsøger automatisk at genforbinde bagefter."}),f.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>void nn("control"),disabled:U,children:"Genstart og åbn kontrolpanel"}),f.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void nn("ide"),disabled:U,children:"Genstart og bliv i Kodeværksted"}),f.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>An(!1),disabled:U,children:"Senere"})]})}),ki&&f.jsx(bt,{title:"Installer MicroPython",onClose:()=>va(!1),children:f.jsxs("div",{className:"settings-stack",children:[f.jsx("p",{className:"confirm-message",children:"Hvis Picoen er helt frisk, skal MicroPython først lægges på den."}),f.jsxs("ol",{className:"micropython-steps",children:[f.jsx("li",{children:"Hold BOOTSEL-knappen nede."}),f.jsx("li",{children:"Sæt Picoen i USB, og slip derefter BOOTSEL."}),f.jsx("li",{children:"Vælg Pico-model og MicroPython-version herunder, og download UF2-filen."}),f.jsxs("li",{children:["Kopier UF2-filen til drevet ",f.jsx("strong",{children:"RPI-RP2"})]})]}),f.jsxs("div",{className:"micropython-selects",children:[f.jsx("label",{htmlFor:"micropython-board",children:"Pico-model"}),f.jsx("select",{id:"micropython-board",value:al,onChange:m=>vo(m.target.value),children:dl.map(m=>f.jsx("option",{value:m,children:m},m))}),f.jsx("label",{htmlFor:"micropython-version",children:"MicroPython-version"}),f.jsx("select",{id:"micropython-version",value:(zn==null?void 0:zn.version)??Xl,onChange:m=>Sa(m.target.value),children:Ze.map(m=>f.jsxs("option",{value:m.version,children:[m.version," (",m.date,")"]},`${m.board}:${m.version}:${m.date}`))})]}),zn&&f.jsx("a",{className:"btn btn-primary btn-block",href:zn.url,download:zn.fileName,children:"Download UF2"}),f.jsx("a",{className:"btn btn-outline btn-block",href:"https://www.raspberrypi.com/documentation/microcontrollers/micropython.html",target:"_blank",rel:"noreferrer",children:"Se vejledning"})]})}),D&&f.jsx(bt,{title:"Ny Python-fil",onClose:()=>V(!1),children:f.jsxs("form",{className:"ide-new-file-form",onSubmit:m=>{m.preventDefault(),Ga()},children:[f.jsx("label",{htmlFor:"new-pico-file",children:"Filnavn"}),f.jsxs("div",{className:"ide-new-file-row",children:[f.jsx("input",{id:"new-pico-file",value:ae,onChange:m=>xe(m.target.value),autoFocus:!0,placeholder:"test"}),f.jsx("span",{children:".py"})]}),f.jsxs("p",{children:["Skriv kun navnet. Appen tilføjer .py automatisk og opretter filen i ",Fl,"."]}),f.jsx("button",{className:"btn btn-primary",type:"submit",disabled:!mp(ae),children:"Opret"})]})}),z&&f.jsx(bt,{title:De(z.path),onClose:()=>P(null),children:f.jsxs("div",{className:"ide-file-action-modal",children:[f.jsxs("form",{className:"ide-file-rename-form",onSubmit:m=>{m.preventDefault(),Hn()},children:[f.jsx("label",{htmlFor:"rename-pico-file",children:"Filnavn"}),f.jsxs("div",{className:"ide-new-file-row",children:[f.jsx("input",{id:"rename-pico-file",value:de,onChange:m=>E(m.target.value),placeholder:"min_kode"}),f.jsxs("span",{children:[".",zr(z.path)]})]}),f.jsxs("p",{children:["Skriv kun navnet. Appen beholder filendelsen .",zr(z.path)," automatisk."]}),f.jsx("button",{className:"btn btn-primary btn-block",type:"submit",disabled:!Gu(de,zr(z.path))||Gu(de,zr(z.path))===z.path||U,children:"Gem navn"})]}),f.jsx("div",{className:"ide-file-action-buttons",children:f.jsx("button",{className:"btn btn-outline btn-danger btn-block",type:"button",onClick:()=>Ha(z),disabled:U,children:"Slet"})}),f.jsxs("section",{className:"ide-version-history",children:[f.jsx("h4",{children:"Version history"}),z.source!=="pico"?f.jsx("p",{children:"Versioner gemmes kun for filer på Picoen."}):z.versions.length===0?f.jsx("p",{children:"Version history: 0 saved versions."}):f.jsx("div",{className:"ide-version-list",children:z.versions.map(m=>f.jsxs("div",{className:"ide-version-row",children:[f.jsx("span",{children:De(m.path)}),f.jsx("small",{children:m.size!==void 0?`${m.size} bytes`:"Gemt på Pico"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:()=>void Ya(m),disabled:U,children:"Gendan"}),f.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Qr(m),disabled:U,children:"Slet"})]},m.path))})]})]})})]})}function mp(o){var c;const r=(c=o.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:c.replace(/\.py$/i,"").replace(/[^a-zA-Z0-9_-]/g,"_").replace(/^_+|_+$/g,"");return r?`/${r}.py`:""}function w0(o){const r=o.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop(),c=r==null?void 0:r.match(/^(.+)\.(py|txt|json|csv)$/i);if(!c)return"";const s=c[1].replace(/[^a-zA-Z0-9_-]/g,"_").replace(/^_+|_+$/g,"");return s?`/${s}.${c[2].toLowerCase()}`:""}function Gu(o,r="py"){const c=o.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop();if(!c)return"";const s=c.match(/^(.+?)(?:\.(py|txt|json|csv))?$/i);if(!s)return"";const u=s[1].replace(/[^a-zA-Z0-9_-]/g,"_").replace(/^_+|_+$/g,""),h=r.replace(/^\./,"").toLowerCase(),_=(s[2]??(h||"py")).toLowerCase();return u?`/${u}.${_}`:""}function N0(o){return De(o).replace(/\.(py|txt|json|csv)$/i,"")}function zr(o){var s;const r=De(o).match(/\.([a-z0-9]+)$/i),c=(s=r==null?void 0:r[1])==null?void 0:s.toLowerCase();return c&&["py","txt","json","csv"].includes(c)?c:"py"}function io(o){return o.replace(/\r\n/g,`
`).replace(/\r/g,`
