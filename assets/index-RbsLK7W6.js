var qg=Object.defineProperty;var Pg=(o,a,c)=>a in o?qg(o,a,{enumerable:!0,configurable:!0,writable:!0,value:c}):o[a]=c;var ue=(o,a,c)=>Pg(o,typeof a!="symbol"?a+"":a,c);(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const u of document.querySelectorAll('link[rel="modulepreload"]'))i(u);new MutationObserver(u=>{for(const d of u)if(d.type==="childList")for(const h of d.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&i(h)}).observe(document,{childList:!0,subtree:!0});function c(u){const d={};return u.integrity&&(d.integrity=u.integrity),u.referrerPolicy&&(d.referrerPolicy=u.referrerPolicy),u.crossOrigin==="use-credentials"?d.credentials="include":u.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(u){if(u.ep)return;u.ep=!0;const d=c(u);fetch(u.href,d)}})();function Wh(o){return o&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o}var rf={exports:{}},qi={};/**
 * @license React
 ...
 */var Qp;function $g(){if(Qp)return qi;Qp=1;var o=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function c(i,u,d){var h=null;if(d!==void 0&&(h=""+d),u.key!==void 0&&(h=""+u.key),"key"in u){d={};for(var _ in u)_!=="key"&&(d[_]=u[_])}else d=u;return u=d.ref,{$$typeof:o,type:i,key:h,ref:u!==void 0?u:null,props:d}}return qi.Fragment=a,qi.jsx=c,qi.jsxs=c,qi}var Zp;function Xg(){return Zp||(Zp=1,rf.exports=$g()),rf.exports}var f=Xg(),lf={exports:{}},ve={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wp;function Fg(){if(Wp)return ve;Wp=1;var o=Symbol.for("react.transitional.element"),a=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),i=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),h=Symbol.for("react.context"),_=Symbol.for("react.forward_ref"),v=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),x=Symbol.for("react.lazy"),N=Symbol.for("react.activity"),R=Symbol.iterator;function $(S){return S===null||typeof S!="object"?null:(S=R&&S[R]||S["@@iterator"],typeof S=="function"?S:null)}var I={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},J=Object.assign,K={};function G(S,B,W){this.props=S,this.context=B,this.refs=K,this.updater=W||I}G.prototype.isReactComponent={},G.prototype.setState=function(S,B){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,B,"setState")},G.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function H(){}H.prototype=G.prototype;function ae(S,B,W){this.props=S,this.context=B,this.refs=K,this.updater=W||I}var le=ae.prototype=new H;le.constructor=ae,J(le,G.prototype),le.isPureReactComponent=!0;var se=Array.isArray;function he(){}var ne={H:null,A:null,T:null,S:null},ee=Object.prototype.hasOwnProperty;function xe(S,B,W){var T=W.ref;return{$$typeof:o,type:S,key:B,ref:T!==void 0?T:null,props:W}}function ge(S,B){return xe(S.type,B,S.props)}function ye(S){return typeof S=="object"&&S!==null&&S.$$typeof===o}function ie(S){var B={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(W){return B[W]})}var Ve=/\/+/g;function Re(S,B){return typeof S=="object"&&S!==null&&S.key!=null?ie(""+S.key):B.toString(36)}function Pe(S){switch(S.status){case"fulfilled":return S.value;case"rejected":throw S.reason;default:switch(typeof S.status=="string"?S.then(he,he):(S.status="pending",S.then(function(B){S.status==="pending"&&(S.status="fulfilled",S.value=B)},function(B){S.status==="pending"&&(S.status="rejected",S.reason=B)})),S.status){case"fulfilled":return S.value;case"rejected":throw S.reason}}throw S}function z(S,B,W,T,F){var Q=typeof S;(Q==="undefined"||Q==="boolean")&&(S=null);var X=!1;if(S===null)X=!0;else switch(Q){case"bigint":case"string":case"number":X=!0;break;case"object":switch(S.$$typeof){case o:case a:X=!0;break;case x:return X=S._init,z(X(S._payload),B,W,T,F)}}if(X)return F=F(S),X=T===""?"."+Re(S,0):T,se(F)?(W="",X!=null&&(W=X.replace(Ve,"$&/")+"/"),z(F,B,W,"",function(Yn){return Yn})):F!=null&&(ye(F)&&(F=ge(F,W+(F.key==null||S&&S.key===F.key?"":(""+F.key).replace(Ve,"$&/")+"/")+X)),B.push(F)),1;X=0;var Le=T===""?".":T+":";if(se(S))for(var je=0;je<S.length;je++)T=S[je],Q=Le+Re(T,je),X+=z(T,B,W,Q,F);else if(je=$(S),typeof je=="function")for(S=je.call(S),je=0;!(T=S.next()).done;)T=T.value,Q=Le+Re(T,je++),X+=z(T,B,W,Q,F);else if(Q==="object"){if(typeof S.then=="function")return z(Pe(S),B,W,T,F);throw B=String(S),Error("Objects are not valid as a React child (found: "+(B==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":B)+"). If you meant to render a collection of children, use an array instead.")}return X}function Z(S,B,W){if(S==null)return S;var T=[],F=0;return z(S,T,"","",function(Q){return B.call(W,Q,F++)}),T}function oe(S){if(S._status===-1){var B=S._result;B=B(),B.then(function(W){(S._status===0||S._status===-1)&&(S._status=1,S._result=W)},function(W){(S._status===0||S._status===-1)&&(S._status=2,S._result=W)}),S._status===-1&&(S._status=0,S._result=B)}if(S._status===1)return S._result.default;throw S._result}var we=typeof reportError=="function"?reportError:function(S){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var B=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof S=="object"&&S!==null&&typeof S.message=="string"?String(S.message):String(S),error:S});if(!window.dispatchEvent(B))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",S);return}console.error(S)},ke={map:Z,forEach:function(S,B,W){Z(S,function(){B.apply(this,arguments)},W)},count:function(S){var B=0;return Z(S,function(){B++}),B},toArray:function(S){return Z(S,function(B){return B})||[]},only:function(S){if(!ye(S))throw Error("React.Children.only expected to receive a single React element child.");return S}};return ve.Activity=N,ve.Children=ke,ve.Component=G,ve.Fragment=c,ve.Profiler=u,ve.PureComponent=ae,ve.StrictMode=i,ve.Suspense=v,ve.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ne,ve.__COMPILER_RUNTIME={__proto__:null,c:function(S){return ne.H.useMemoCache(S)}},ve.cache=function(S){return function(){return S.apply(null,arguments)}},ve.cacheSignal=function(){return null},ve.cloneElement=function(S,B,W){if(S==null)throw Error("The argument must be a React element, but you passed "+S+".");var T=J({},S.props),F=S.key;if(B!=null)for(Q in B.key!==void 0&&(F=""+B.key),B)!ee.call(B,Q)||Q==="key"||Q==="__self"||Q==="__source"||Q==="ref"&&B.ref===void 0||(T[Q]=B[Q]);var Q=arguments.length-2;if(Q===1)T.children=W;else if(1<Q){for(var X=Array(Q),Le=0;Le<Q;Le++)X[Le]=arguments[Le+2];T.children=X}return xe(S.type,F,T)},ve.createContext=function(S){return S={$$typeof:h,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null},S.Provider=S,S.Consumer={$$typeof:d,_context:S},S},ve.createElement=function(S,B,W){var T,F={},Q=null;if(B!=null)for(T in B.key!==void 0&&(Q=""+B.key),B)ee.call(B,T)&&T!=="key"&&T!=="__self"&&T!=="__source"&&(F[T]=B[T]);var X=arguments.length-2;if(X===1)F.children=W;else if(1<X){for(var Le=Array(X),je=0;je<X;je++)Le[je]=arguments[je+2];F.children=Le}if(S&&S.defaultProps)for(T in X=S.defaultProps,X)F[T]===void 0&&(F[T]=X[T]);return xe(S,Q,F)},ve.createRef=function(){return{current:null}},ve.forwardRef=function(S){return{$$typeof:_,render:S}},ve.isValidElement=ye,ve.lazy=function(S){return{$$typeof:x,_payload:{_status:-1,_result:S},_init:oe}},ve.memo=function(S,B){return{$$typeof:y,type:S,compare:B===void 0?null:B}},ve.startTransition=function(S){var B=ne.T,W={};ne.T=W;try{var T=S(),F=ne.S;F!==null&&F(W,T),typeof T=="object"&&T!==null&&typeof T.then=="function"&&T.then(he,we)}catch(Q){we(Q)}finally{B!==null&&W.types!==null&&(B.types=W.types),ne.T=B}},ve.unstable_useCacheRefresh=function(){return ne.H.useCacheRefresh()},ve.use=function(S){return ne.H.use(S)},ve.useActionState=function(S,B,W){return ne.H.useActionState(S,B,W)},ve.useCallback=function(S,B){return ne.H.useCallback(S,B)},ve.useContext=function(S){return ne.H.useContext(S)},ve.useDebugValue=function(){},ve.useDeferredValue=function(S,B){return ne.H.useDeferredValue(S,B)},ve.useEffect=function(S,B){return ne.H.useEffect(S,B)},ve.useEffectEvent=function(S){return ne.H.useEffectEvent(S)},ve.useId=function(){return ne.H.useId()},ve.useImperativeHandle=function(S,B,W){return ne.H.useImperativeHandle(S,B,W)},ve.useInsertionEffect=function(S,B){return ne.H.useInsertionEffect(S,B)},ve.useLayoutEffect=function(S,B){return ne.H.useLayoutEffect(S,B)},ve.useMemo=function(S,B){return ne.H.useMemo(S,B)},ve.useOptimistic=function(S,B){return ne.H.useOptimistic(S,B)},ve.useReducer=function(S,B,W){return ne.H.useReducer(S,B,W)},ve.useRef=function(S){return ne.H.useRef(S)},ve.useState=function(S){return ne.H.useState(S)},ve.useSyncExternalStore=function(S,B,W){return ne.H.useSyncExternalStore(S,B,W)},ve.useTransition=function(){return ne.H.useTransition()},ve.version="19.2.7",ve}var Jp;function Cf(){return Jp||(Jp=1,lf.exports=Fg()),lf.exports}var L=Cf();const Wi=Wh(L);var af={exports:{}},Pi={},sf={exports:{}},of={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var eh;function Kg(){return eh||(eh=1,(function(o){function a(z,Z){var oe=z.length;z.push(Z);e:for(;0<oe;){var we=oe-1>>>1,ke=z[we];if(0<u(ke,Z))z[we]=Z,z[oe]=ke,oe=we;else break e}}function c(z){return z.length===0?null:z[0]}function i(z){if(z.length===0)return null;var Z=z[0],oe=z.pop();if(oe!==Z){z[0]=oe;e:for(var we=0,ke=z.length,S=ke>>>1;we<S;){var B=2*(we+1)-1,W=z[B],T=B+1,F=z[T];if(0>u(W,oe))T<ke&&0>u(F,W)?(z[we]=F,z[T]=oe,we=T):(z[we]=W,z[B]=oe,we=B);else if(T<ke&&0>u(F,oe))z[we]=F,z[T]=oe,we=T;else break e}}return Z}function u(z,Z){var oe=z.sortIndex-Z.sortIndex;return oe!==0?oe:z.id-Z.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;o.unstable_now=function(){return d.now()}}else{var h=Date,_=h.now();o.unstable_now=function(){return h.now()-_}}var v=[],y=[],x=1,N=null,R=3,$=!1,I=!1,J=!1,K=!1,G=typeof setTimeout=="function"?setTimeout:null,H=typeof clearTimeout=="function"?clearTimeout:null,ae=typeof setImmediate<"u"?setImmediate:null;function le(z){for(var Z=c(y);Z!==null;){if(Z.callback===null)i(y);else if(Z.startTime<=z)i(y),Z.sortIndex=Z.expirationTime,a(v,Z);else break;Z=c(y)}}function se(z){if(J=!1,le(z),!I)if(c(v)!==null)I=!0,he||(he=!0,ie());else{var Z=c(y);Z!==null&&Pe(se,Z.startTime-z)}}var he=!1,ne=-1,ee=5,xe=-1;function ge(){return K?!0:!(o.unstable_now()-xe<ee)}function ye(){if(K=!1,he){var z=o.unstable_now();xe=z;var Z=!0;try{e:{I=!1,J&&(J=!1,H(ne),ne=-1),$=!0;var oe=R;try{n:{for(le(z),N=c(v);N!==null&&!(N.expirationTime>z&&ge());){var we=N.callback;if(typeof we=="function"){N.callback=null,R=N.priorityLevel;var ke=we(N.expirationTime<=z);if(z=o.unstable_now(),typeof ke=="function"){N.callback=ke,le(z),Z=!0;break n}N===c(v)&&i(v),le(z)}else i(v);N=c(v)}if(N!==null)Z=!0;else{var S=c(y);S!==null&&Pe(se,S.startTime-z),Z=!1}}break e}finally{N=null,R=oe,$=!1}Z=void 0}}finally{Z?ie():he=!1}}}var ie;if(typeof ae=="function")ie=function(){ae(ye)};else if(typeof MessageChannel<"u"){var Ve=new MessageChannel,Re=Ve.port2;Ve.port1.onmessage=ye,ie=function(){Re.postMessage(null)}}else ie=function(){G(ye,0)};function Pe(z,Z){ne=G(function(){z(o.unstable_now())},Z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(z){z.callback=null},o.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ee=0<z?Math.floor(1e3/z):5},o.unstable_getCurrentPriorityLevel=function(){return R},o.unstable_next=function(z){switch(R){case 1:case 2:case 3:var Z=3;break;default:Z=R}var oe=R;R=Z;try{return z()}finally{R=oe}},o.unstable_requestPaint=function(){K=!0},o.unstable_runWithPriority=function(z,Z){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var oe=R;R=z;try{return Z()}finally{R=oe}},o.unstable_scheduleCallback=function(z,Z,oe){var we=o.unstable_now();switch(typeof oe=="object"&&oe!==null?(oe=oe.delay,oe=typeof oe=="number"&&0<oe?we+oe:we):oe=we,z){case 1:var ke=-1;break;case 2:ke=250;break;case 5:ke=1073741823;break;case 4:ke=1e4;break;default:ke=5e3}return ke=oe+ke,z={id:x++,callback:Z,priorityLevel:z,startTime:oe,expirationTime:ke,sortIndex:-1},oe>we?(z.sortIndex=oe,a(y,z),c(v)===null&&z===c(y)&&(J?(H(ne),ne=-1):J=!0,Pe(se,oe-we))):(z.sortIndex=ke,a(v,z),I||$||(I=!0,he||(he=!0,ie()))),z},o.unstable_shouldYield=ge,o.unstable_wrapCallback=function(z){var Z=R;return function(){var oe=R;R=Z;try{return z.apply(this,arguments)}finally{R=oe}}}})(of)),of}var nh;function Qg(){return nh||(nh=1,sf.exports=Kg()),sf.exports}var cf={exports:{}},Gn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var th;function Zg(){if(th)return Gn;th=1;var o=Cf();function a(v){var y="https://react.dev/errors/"+v;if(1<arguments.length){y+="?args[]="+encodeURIComponent(arguments[1]);for(var x=2;x<arguments.length;x++)y+="&args[]="+encodeURIComponent(arguments[x])}return"Minified React error #"+v+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function c(){}var i={d:{f:c,r:function(){throw Error(a(522))},D:c,C:c,L:c,m:c,X:c,S:c,M:c},p:0,findDOMNode:null},u=Symbol.for("react.portal");function d(v,y,x){var N=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:u,key:N==null?null:""+N,children:v,containerInfo:y,implementation:x}}var h=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function _(v,y){if(v==="font")return"";if(typeof y=="string")return y==="use-credentials"?y:""}return Gn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=i,Gn.createPortal=function(v,y){var x=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!y||y.nodeType!==1&&y.nodeType!==9&&y.nodeType!==11)throw Error(a(299));return d(v,y,null,x)},Gn.flushSync=function(v){var y=h.T,x=i.p;try{if(h.T=null,i.p=2,v)return v()}finally{h.T=y,i.p=x,i.d.f()}},Gn.preconnect=function(v,y){typeof v=="string"&&(y?(y=y.crossOrigin,y=typeof y=="string"?y==="use-credentials"?y:"":void 0):y=null,i.d.C(v,y))},Gn.prefetchDNS=function(v){typeof v=="string"&&i.d.D(v)},Gn.preinit=function(v,y){if(typeof v=="string"&&y&&typeof y.as=="string"){var x=y.as,N=_(x,y.crossOrigin),R=typeof y.integrity=="string"?y.integrity:void 0,$=typeof y.fetchPriority=="string"?y.fetchPriority:void 0;x==="style"?i.d.S(v,typeof y.precedence=="string"?y.precedence:void 0,{crossOrigin:N,integrity:R,fetchPriority:$}):x==="script"&&i.d.X(v,{crossOrigin:N,integrity:R,fetchPriority:$,nonce:typeof y.nonce=="string"?y.nonce:void 0})}},Gn.preinitModule=function(v,y){if(typeof v=="string")if(typeof y=="object"&&y!==null){if(y.as==null||y.as==="script"){var x=_(y.as,y.crossOrigin);i.d.M(v,{crossOrigin:x,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0})}}else y==null&&i.d.M(v)},Gn.preload=function(v,y){if(typeof v=="string"&&typeof y=="object"&&y!==null&&typeof y.as=="string"){var x=y.as,N=_(x,y.crossOrigin);i.d.L(v,x,{crossOrigin:N,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0,type:typeof y.type=="string"?y.type:void 0,fetchPriority:typeof y.fetchPriority=="string"?y.fetchPriority:void 0,referrerPolicy:typeof y.referrerPolicy=="string"?y.referrerPolicy:void 0,imageSrcSet:typeof y.imageSrcSet=="string"?y.imageSrcSet:void 0,imageSizes:typeof y.imageSizes=="string"?y.imageSizes:void 0,media:typeof y.media=="string"?y.media:void 0})}},Gn.preloadModule=function(v,y){if(typeof v=="string")if(y){var x=_(y.as,y.crossOrigin);i.d.m(v,{as:typeof y.as=="string"&&y.as!=="script"?y.as:void 0,crossOrigin:x,integrity:typeof y.integrity=="string"?y.integrity:void 0})}else i.d.m(v)},Gn.requestFormReset=function(v){i.d.r(v)},Gn.unstable_batchedUpdates=function(v,y){return v(y)},Gn.useFormState=function(v,y,x){return h.H.useFormState(v,y,x)},Gn.useFormStatus=function(){return h.H.useHostTransitionStatus()},Gn.version="19.2.7",Gn}var rh;function Wg(){if(rh)return cf.exports;rh=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(a){console.error(a)}}return o(),cf.exports=Zg(),cf.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lh;function Jg(){if(lh)return Pi;lh=1;var o=Qg(),a=Cf(),c=Wg();function i(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var t=2;t<arguments.length;t++)n+="&args[]="+encodeURIComponent(arguments[t])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function d(e){var n=e,t=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(t=n.return),e=n.return;while(e)}return n.tag===3?t:null}function h(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function _(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function v(e){if(d(e)!==e)throw Error(i(188))}function y(e){var n=e.alternate;if(!n){if(n=d(e),n===null)throw Error(i(188));return n!==e?null:e}for(var t=e,r=n;;){var l=t.return;if(l===null)break;var s=l.alternate;if(s===null){if(r=l.return,r!==null){t=r;continue}break}if(l.child===s.child){for(s=l.child;s;){if(s===t)return v(l),e;if(s===r)return v(l),n;s=s.sibling}throw Error(i(188))}if(t.return!==r.return)t=l,r=s;else{for(var p=!1,g=l.child;g;){if(g===t){p=!0,t=l,r=s;break}if(g===r){p=!0,r=l,t=s;break}g=g.sibling}if(!p){for(g=s.child;g;){if(g===t){p=!0,t=s,r=l;break}if(g===r){p=!0,r=s,t=l;break}g=g.sibling}if(!p)throw Error(i(189))}}if(t.alternate!==r)throw Error(i(190))}if(t.tag!==3)throw Error(i(188));return t.stateNode.current===t?e:n}function x(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=x(e),n!==null)return n;e=e.sibling}return null}var N=Object.assign,R=Symbol.for("react.element"),$=Symbol.for("react.transitional.element"),I=Symbol.for("react.portal"),J=Symbol.for("react.fragment"),K=Symbol.for("react.strict_mode"),G=Symbol.for("react.profiler"),H=Symbol.for("react.consumer"),ae=Symbol.for("react.context"),le=Symbol.for("react.forward_ref"),se=Symbol.for("react.suspense"),he=Symbol.for("react.suspense_list"),ne=Symbol.for("react.memo"),ee=Symbol.for("react.lazy"),xe=Symbol.for("react.activity"),ge=Symbol.for("react.memo_cache_sentinel"),ye=Symbol.iterator;function ie(e){return e===null||typeof e!="object"?null:(e=ye&&e[ye]||e["@@iterator"],typeof e=="function"?e:null)}var Ve=Symbol.for("react.client.reference");function Re(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Ve?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case J:return"Fragment";case G:return"Profiler";case K:return"StrictMode";case se:return"Suspense";case he:return"SuspenseList";case xe:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case I:return"Portal";case ae:return e.displayName||"Context";case H:return(e._context.displayName||"Context")+".Consumer";case le:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case ne:return n=e.displayName||null,n!==null?n:Re(e.type)||"Memo";case ee:n=e._payload,e=e._init;try{return Re(e(n))}catch{}}return null}var Pe=Array.isArray,z=a.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Z=c.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,oe={pending:!1,data:null,method:null,action:null},we=[],ke=-1;function S(e){return{current:e}}function B(e){0>ke||(e.current=we[ke],we[ke]=null,ke--)}function W(e,n){ke++,we[ke]=e.current,e.current=n}var T=S(null),F=S(null),Q=S(null),X=S(null);function Le(e,n){switch(W(Q,n),W(F,e),W(T,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?yp(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=yp(n),e=vp(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}B(T),W(T,e)}function je(){B(T),B(F),B(Q)}function Yn(e){e.memoizedState!==null&&W(X,e);var n=T.current,t=vp(n,e.type);n!==t&&(W(F,e),W(T,t))}function Pt(e){F.current===e&&(B(T),B(F)),X.current===e&&(B(X),Vi._currentValue=oe)}var be,bn;function En(e){if(be===void 0)try{throw Error()}catch(t){var n=t.stack.trim().match(/\n( *(at )?)/);be=n&&n[1]||"",bn=-1<t.stack.indexOf(`
...
`+r.stack}}var jr=Object.prototype.hasOwnProperty,Ar=o.unstable_scheduleCallback,vt=o.unstable_cancelCallback,Ql=o.unstable_shouldYield,Dr=o.unstable_requestPaint,yn=o.unstable_now,dl=o.unstable_getCurrentPriorityLevel,ml=o.unstable_ImmediatePriority,Pa=o.unstable_UserBlockingPriority,pl=o.unstable_NormalPriority,Qn=o.unstable_LowPriority,lt=o.unstable_IdlePriority,$t=o.log,Zl=o.unstable_setDisableYieldValue,hl=null,vn=null;function at(e){if(typeof $t=="function"&&Zl(e),vn&&typeof vn.setStrictMode=="function")try{vn.setStrictMode(hl,e)}catch{}}var Rn=Math.clz32?Math.clz32:rr,Or=Math.log,Cr=Math.LN2;function rr(e){return e>>>=0,e===0?32:31-(Or(e)/Cr|0)|0}var Xt=256,In=262144,Ke=4194304;function Mn(e){var n=e&42;if(n!==0)return n;switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:return 64;case 128:return 128;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:return e&261888;case 262144:case 524288:case 1048576:case 2097152:return e&3932160;case 4194304:case 8388608:case 16777216:case 33554432:return e&62914560;case 67108864:return 67108864;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 0;default:return e}}function mn(e,n,t){var r=e.pendingLanes;if(r===0)return 0;var l=0,s=e.suspendedLanes,p=e.pingedLanes;e=e.warmLanes;var g=r&134217727;return g!==0?(r=g&~s,r!==0?l=Mn(r):(p&=g,p!==0?l=Mn(p):t||(t=g&~e,t!==0&&(l=Mn(t))))):(g=r&~s,g!==0?l=Mn(g):p!==0?l=Mn(p):t||(t=r&~e,t!==0&&(l=Mn(t)))),l===0?0:n!==0&&n!==l&&(n&s)===0&&(s=l&-l,t=n&-n,s>=t||s===32&&(t&4194048)!==0)?n:l}function zn(e,n){return(e.pendingLanes&~(e.suspendedLanes&~e.pingedLanes)&n)===0}function Io(e,n){switch(e){case 1:case 2:case 4:case 8:case 64:return n+250;case 16:case 32:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return n+5e3;case 4194304:case 8388608:case 16777216:case 33554432:return-1;case 67108864:case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function $a(){var e=Ke;return Ke<<=1,(Ke&62914560)===0&&(Ke=4194304),e}function Ft(e){for(var n=[],t=0;31>t;t++)n.push(e);return n}function _l(e,n){e.pendingLanes|=n,n!==268435456&&(e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0)}function lr(e,n,t,r,l,s){var p=e.pendingLanes;e.pendingLanes=t,e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0,e.expiredLanes&=t,e.entangledLanes&=t,e.errorRecoveryDisabledLanes&=t,e.shellSuspendCounter=0;var g=e.entanglements,E=e.expirationTimes,A=e.hiddenUpdates;for(t=p&~t;0<t;){var V=31-Rn(t),P=1<<V;g[V]=0,E[V]=-1;var O=A[V];if(O!==null)for(A[V]=null,V=0;V<O.length;V++){var U=O[V];U!==null&&(U.lane&=-536870913)}t&=~P}r!==0&&ls(e,r,0),s!==0&&l===0&&e.tag!==0&&(e.suspendedLanes|=s&~(p&~n))}function ls(e,n,t){e.pendingLanes|=n,e.suspendedLanes&=~n;var r=31-Rn(n);e.entangledLanes|=n,e.entanglements[r]=e.entanglements[r]|1073741824|t&261930}function Wl(e,n){var t=e.entangledLanes|=n;for(e=e.entanglements;t;){var r=31-Rn(t),l=1<<r;l&n|e[r]&n&&(e[r]|=n),t&=~l}}function as(e,n){var t=n&-n;return t=(t&42)!==0?1:Lr(t),(t&(e.suspendedLanes|n))!==0?0:t}function Lr(e){switch(e){case 2:e=1;break;case 8:e=4;break;case 32:e=16;break;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:e=128;break;case 268435456:e=134217728;break;default:e=0}return e}function xt(e){return e&=-e,2<e?8<e?(e&134217727)!==0?32:268435456:8:2}function on(){var e=Z.p;return e!==0?e:(e=window.event,e===void 0?32:Ip(e.type))}function Xa(e,n){var t=Z.p;try{return Z.p=e,n()}finally{Z.p=t}}var it=Math.random().toString(36).slice(2),cn="__reactFiber$"+it,un="__reactProps$"+it,Tn="__reactContainer$"+it,zt="__reactEvents$"+it,gl="__reactListeners$"+it,Ut="__reactHandles$"+it,ar="__reactResources$"+it,Ht="__reactMarker$"+it;function Vt(e){delete e[cn],delete e[un],delete e[zt],delete e[gl],delete e[Ut]}function Kt(e){var n=e[cn];if(n)return n;for(var t=e.parentNode;t;){if(n=t[Tn]||t[cn]){if(t=n.alternate,n.child!==null||t!==null&&t.child!==null)for(e=Rp(e);e!==null;){if(t=e[cn])return t;e=Rp(e)}return n}e=t,t=e.parentNode}return null}function qn(e){if(e=e[cn]||e[Tn]){var n=e.tag;if(n===5||n===6||n===13||n===31||n===26||n===27||n===3)return e}return null}function Gt(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e.stateNode;throw Error(i(33))}function Zn(e){var n=e[ar];return n||(n=e[ar]={hoistableStyles:new Map,hoistableScripts:new Map}),n}function Ze(e){e[Ht]=!0}var ir=new Set,Fa={};function st(e,n){ot(e,n),ot(e+"Capture",n)}function ot(e,n){for(Fa[e]=n,e=0;e<n.length;e++)ir.add(n[e])}var pe=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),Jl={},is={};function qo(e){return jr.call(is,e)?!0:jr.call(Jl,e)?!1:pe.test(e)?is[e]=!0:(Jl[e]=!0,!1)}function ea(e,n,t){if(qo(n))if(t===null)e.removeAttribute(n);else{switch(typeof t){case"undefined":case"function":case"symbol":e.removeAttribute(n);return;case"boolean":var r=n.toLowerCase().slice(0,5);if(r!=="data-"&&r!=="aria-"){e.removeAttribute(n);return}}e.setAttribute(n,""+t)}}function na(e,n,t){if(t===null)e.removeAttribute(n);else{switch(typeof t){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(n);return}e.setAttribute(n,""+t)}}function Pn(e,n,t,r){if(r===null)e.removeAttribute(t);else{switch(typeof r){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(t);return}e.setAttributeNS(n,t,""+r)}}function xn(e){switch(typeof e){case"bigint":case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function ct(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function Ka(e,n,t){var r=Object.getOwnPropertyDescriptor(e.constructor.prototype,n);if(!e.hasOwnProperty(n)&&typeof r<"u"&&typeof r.get=="function"&&typeof r.set=="function"){var l=r.get,s=r.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return l.call(this)},set:function(p){t=""+p,s.call(this,p)}}),Object.defineProperty(e,n,{enumerable:r.enumerable}),{getValue:function(){return t},setValue:function(p){t=""+p},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function Un(e){if(!e._valueTracker){var n=ct(e)?"checked":"value";e._valueTracker=Ka(e,n,""+e[n])}}function ss(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var t=n.getValue(),r="";return e&&(r=ct(e)?e.checked?"true":"false":e.value),e=r,e!==t?(n.setValue(e),!0):!1}function ta(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}var os=/[\n"\\]/g;function Hn(e){return e.replace(os,function(n){return"\\"+n.charCodeAt(0).toString(16)+" "})}function q(e,n,t,r,l,s,p,g){e.name="",p!=null&&typeof p!="function"&&typeof p!="symbol"&&typeof p!="boolean"?e.type=p:e.removeAttribute("type"),n!=null?p==="number"?(n===0&&e.value===""||e.value!=n)&&(e.value=""+xn(n)):e.value!==""+xn(n)&&(e.value=""+xn(n)):p!=="submit"&&p!=="reset"||e.removeAttribute("value"),n!=null?Qa(e,p,xn(n)):t!=null?Qa(e,p,xn(t)):r!=null&&e.removeAttribute("value"),l==null&&s!=null&&(e.defaultChecked=!!s),l!=null&&(e.checked=l&&typeof l!="function"&&typeof l!="symbol"),g!=null&&typeof g!="function"&&typeof g!="symbol"&&typeof g!="boolean"?e.name=""+xn(g):e.removeAttribute("name")}function cs(e,n,t,r,l,s,p,g){if(s!=null&&typeof s!="function"&&typeof s!="symbol"&&typeof s!="boolean"&&(e.type=s),n!=null||t!=null){if(!(s!=="submit"&&s!=="reset"||n!=null)){Un(e);return}t=t!=null?""+xn(t):"",n=n!=null?""+xn(n):t,g||n===e.value||(e.value=n),e.defaultValue=n}r=r??l,r=typeof r!="function"&&typeof r!="symbol"&&!!r,e.checked=g?e.checked:!!r,e.defaultChecked=!!r,p!=null&&typeof p!="function"&&typeof p!="symbol"&&typeof p!="boolean"&&(e.name=p),Un(e)}function Qa(e,n,t){n==="number"&&ta(e.ownerDocument)===e||e.defaultValue===""+t||(e.defaultValue=""+t)}function wt(e,n,t,r){if(e=e.options,n){n={};for(var l=0;l<t.length;l++)n["$"+t[l]]=!0;for(t=0;t<e.length;t++)l=n.hasOwnProperty("$"+e[t].value),e[t].selected!==l&&(e[t].selected=l),l&&r&&(e[t].defaultSelected=!0)}else{for(t=""+xn(t),n=null,l=0;l<e.length;l++){if(e[l].value===t){e[l].selected=!0,r&&(e[l].defaultSelected=!0);return}n!==null||e[l].disabled||(n=e[l])}n!==null&&(n.selected=!0)}}function Za(e,n,t){if(n!=null&&(n=""+xn(n),n!==e.value&&(e.value=n),t==null)){e.defaultValue!==n&&(e.defaultValue=n);return}e.defaultValue=t!=null?""+xn(t):""}function bl(e,n,t,r){if(n==null){if(r!=null){if(t!=null)throw Error(i(92));if(Pe(r)){if(1<r.length)throw Error(i(93));r=r[0]}t=r}t==null&&(t=""),n=t}t=xn(n),e.defaultValue=t,r=e.textContent,r===t&&r!==""&&r!==null&&(e.value=r),Un(e)}function nn(e,n){if(n){var t=e.firstChild;if(t&&t===e.lastChild&&t.nodeType===3){t.nodeValue=n;return}}e.textContent=n}var us=new Set("animationIterationCount aspectRatio borderImageOutset borderImageSlice borderImageWidth boxFlex boxFlexGroup boxOrdinalGroup columnCount columns flex flexGrow flexPositive flexShrink flexNegative flexOrder gridArea gridRow gridRowEnd gridRowSpan gridRowStart gridColumn gridColumnEnd gridColumnSpan gridColumnStart fontWeight lineClamp lineHeight opacity order orphans scale tabSize widows zIndex zoom fillOpacity floodOpacity stopOpacity strokeDasharray strokeDashoffset strokeMiterlimit strokeOpacity strokeWidth MozAnimationIterationCount MozBoxFlex MozBoxFlexGroup MozLineClamp msAnimationIterationCount msFlex msZoom msFlexGrow msFlexNegative msFlexOrder msFlexPositive msFlexShrink msGridColumn msGridColumnSpan msGridRow msGridRowSpan WebkitAnimationIterationCount WebkitBoxFlex WebKitBoxFlexGroup WebkitBoxOrdinalGroup WebkitColumnCount WebkitColumns WebkitFlex WebkitFlexGrow WebkitFlexPositive WebkitFlexShrink WebkitLineClamp".split(" "));function Br(e,n,t){var r=n.indexOf("--")===0;t==null||typeof t=="boolean"||t===""?r?e.setProperty(n,""):n==="float"?e.cssFloat="":e[n]="":r?e.setProperty(n,t):typeof t!="number"||t===0||us.has(n)?n==="float"?e.cssFloat=t:e[n]=(""+t).trim():e[n]=t+"px"}function yl(e,n,t){if(n!=null&&typeof n!="object")throw Error(i(62));if(e=e.style,t!=null){for(var r in t)!t.hasOwnProperty(r)||n!=null&&n.hasOwnProperty(r)||(r.indexOf("--")===0?e.setProperty(r,""):r==="float"?e.cssFloat="":e[r]="");for(var l in n)r=n[l],n.hasOwnProperty(l)&&t[l]!==r&&Br(e,l,r)}else for(var s in n)n.hasOwnProperty(s)&&Br(e,s,n[s])}function Wa(e){if(e.indexOf("-")===-1)return!1;switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var Wn=new Map([["acceptCharset","accept-charset"],["htmlFor","for"],["httpEquiv","http-equiv"],["crossOrigin","crossorigin"],["accentHeight","accent-height"],["alignmentBaseline","alignment-baseline"],["arabicForm","arabic-form"],["baselineShift","baseline-shift"],["capHeight","cap-height"],["clipPath","clip-path"],["clipRule","clip-rule"],["colorInterpolation","color-interpolation"],["colorInterpolationFilters","color-interpolation-filters"],["colorProfile","color-profile"],["colorRendering","color-rendering"],["dominantBaseline","dominant-baseline"],["enableBackground","enable-background"],["fillOpacity","fill-opacity"],["fillRule","fill-rule"],["floodColor","flood-color"],["floodOpacity","flood-opacity"],["fontFamily","font-family"],["fontSize","font-size"],["fontSizeAdjust","font-size-adjust"],["fontStretch","font-stretch"],["fontStyle","font-style"],["fontVariant","font-variant"],["fontWeight","font-weight"],["glyphName","glyph-name"],["glyphOrientationHorizontal","glyph-orientation-horizontal"],["glyphOrientationVertical","glyph-orientation-vertical"],["horizAdvX","horiz-adv-x"],["horizOriginX","horiz-origin-x"],["imageRendering","image-rendering"],["letterSpacing","letter-spacing"],["lightingColor","lighting-color"],["markerEnd","marker-end"],["markerMid","marker-mid"],["markerStart","marker-start"],["overlinePosition","overline-position"],["overlineThickness","overline-thickness"],["paintOrder","paint-order"],["panose-1","panose-1"],["pointerEvents","pointer-events"],["renderingIntent","rendering-intent"],["shapeRendering","shape-rendering"],["stopColor","stop-color"],["stopOpacity","stop-opacity"],["strikethroughPosition","strikethrough-position"],["strikethroughThickness","strikethrough-thickness"],["strokeDasharray","stroke-dasharray"],["strokeDashoffset","stroke-dashoffset"],["strokeLinecap","stroke-linecap"],["strokeLinejoin","stroke-linejoin"],["strokeMiterlimit","stroke-miterlimit"],["strokeOpacity","stroke-opacity"],["strokeWidth","stroke-width"],["textAnchor","text-anchor"],["textDecoration","text-decoration"],["textRendering","text-rendering"],["transformOrigin","transform-origin"],["underlinePosition","underline-position"],["underlineThickness","underline-thickness"],["unicodeBidi","unicode-bidi"],["unicodeRange","unicode-range"],["unitsPerEm","units-per-em"],["vAlphabetic","v-alphabetic"],["vHanging","v-hanging"],["vIdeographic","v-ideographic"],["vMathematical","v-mathematical"],["vectorEffect","vector-effect"],["vertAdvY","vert-adv-y"],["vertOriginX","vert-origin-x"],["vertOriginY","vert-origin-y"],["wordSpacing","word-spacing"],["writingMode","writing-mode"],["xmlnsXlink","xmlns:xlink"],["xHeight","x-height"]]),fs=/^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*:/i;function zr(e){return fs.test(""+e)?"javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')":e}function tn(){}var sr=null;function Ja(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var Ur=null,St=null;function ds(e){var n=qn(e);if(n&&(e=n.stateNode)){var t=e[un]||null;e:switch(e=n.stateNode,n.type){case"input":if(q(e,t.value,t.defaultValue,t.defaultValue,t.checked,t.defaultChecked,t.type,t.name),n=t.name,t.type==="radio"&&n!=null){for(t=e;t.parentNode;)t=t.parentNode;for(t=t.querySelectorAll('input[name="'+Hn(""+n)+'"][type="radio"]'),n=0;n<t.length;n++){var r=t[n];if(r!==e&&r.form===e.form){var l=r[un]||null;if(!l)throw Error(i(90));q(r,l.value,l.defaultValue,l.defaultValue,l.checked,l.defaultChecked,l.type,l.name)}}for(n=0;n<t.length;n++)r=t[n],r.form===e.form&&ss(r)}break e;case"textarea":Za(e,t.value,t.defaultValue);break e;case"select":n=t.value,n!=null&&wt(e,!!t.multiple,n,!1)}}}var ra=!1;function vl(e,n,t){if(ra)return e(n,t);ra=!0;try{var r=e(n);return r}finally{if(ra=!1,(Ur!==null||St!==null)&&(ao(),Ur&&(n=Ur,e=St,St=Ur=null,ds(n),e)))for(n=0;n<e.length;n++)ds(e[n])}}function Qt(e,n){var t=e.stateNode;if(t===null)return null;var r=t[un]||null;if(r===null)return null;t=r[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(r=!r.disabled)||(e=e.type,r=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!r;break e;default:e=!1}if(e)return null;if(t&&typeof t!="function")throw Error(i(231,n,typeof t));return t}var Et=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),ei=!1;if(Et)try{var xl={};Object.defineProperty(xl,"passive",{get:function(){ei=!0}}),window.addEventListener("test",xl,xl),window.removeEventListener("test",xl,xl)}catch{ei=!1}var Zt=null,ut=null,rn=null;function ni(){if(rn)return rn;var e,n=ut,t=n.length,r,l="value"in Zt?Zt.value:Zt.textContent,s=l.length;for(e=0;e<t&&n[e]===l[e];e++);var p=t-e;for(r=1;r<=p&&n[t-r]===l[s-r];r++);return rn=l.slice(e,1<r?1-r:void 0)}function Wt(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function wl(){return!0}function ti(){return!1}function jn(e){function n(t,r,l,s,p){this._reactName=t,this._targetInst=l,this.type=r,this.nativeEvent=s,this.target=p,this.currentTarget=null;for(var g in e)e.hasOwnProperty(g)&&(t=e[g],this[g]=t?t(s):s[g]);return this.isDefaultPrevented=(s.defaultPrevented!=null?s.defaultPrevented:s.returnValue===!1)?wl:ti,this.isPropagationStopped=ti,this}return N(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var t=this.nativeEvent;t&&(t.preventDefault?t.preventDefault():typeof t.returnValue!="unknown"&&(t.returnValue=!1),this.isDefaultPrevented=wl)},stopPropagation:function(){var t=this.nativeEvent;t&&(t.stopPropagation?t.stopPropagation():typeof t.cancelBubble!="unknown"&&(t.cancelBubble=!0),this.isPropagationStopped=wl)},persist:function(){},isPersistent:wl}),n}var or={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},la=jn(or),Sl=N({},or,{view:0,detail:0}),ms=jn(Sl),aa,El,kl,Nl=N({},Sl,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:ai,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==kl&&(kl&&e.type==="mousemove"?(aa=e.screenX-kl.screenX,El=e.screenY-kl.screenY):El=aa=0,kl=e),aa)},movementY:function(e){return"movementY"in e?e.movementY:El}}),ri=jn(Nl),ps=N({},Nl,{dataTransfer:0}),Po=jn(ps),$o=N({},Sl,{relatedTarget:0}),li=jn($o),Xo=N({},or,{animationName:0,elapsedTime:0,pseudoElement:0}),Fo=jn(Xo),Ko=N({},or,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),Qo=jn(Ko),Zo=N({},or,{data:0}),hs=jn(Zo),Wo={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Jo={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},ec={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Rl(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=ec[e])?!!n[e]:!1}function ai(){return Rl}var nc=N({},Sl,{key:function(e){if(e.key){var n=Wo[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=Wt(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?Jo[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:ai,charCode:function(e){return e.type==="keypress"?Wt(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Wt(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),_s=jn(nc),tc=N({},Nl,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),ii=jn(tc),rc=N({},Sl,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:ai}),lc=jn(rc),gs=N({},or,{propertyName:0,elapsedTime:0,pseudoElement:0}),ac=jn(gs),ic=N({},Nl,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),sc=jn(ic),oc=N({},or,{newState:0,oldState:0}),cc=jn(oc),uc=[9,13,27,32],Ml=Et&&"CompositionEvent"in window,Vn=null;Et&&"documentMode"in document&&(Vn=document.documentMode);var bs=Et&&"TextEvent"in window&&!Vn,ys=Et&&(!Ml||Vn&&8<Vn&&11>=Vn),vs=" ",xs=!1;function Hr(e,n){switch(e){case"keyup":return uc.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Tl(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var cr=!1;function si(e,n){switch(e){case"compositionend":return Tl(n);case"keypress":return n.which!==32?null:(xs=!0,vs);case"textInput":return e=n.data,e===vs&&xs?null:e;default:return null}}function ws(e,n){if(cr)return e==="compositionend"||!Ml&&Hr(e,n)?(e=ni(),rn=ut=Zt=null,cr=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return ys&&n.locale!=="ko"?null:n.data;default:return null}}var fc={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Ss(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!fc[e.type]:n==="textarea"}function m(e,n,t,r){Ur?St?St.push(r):St=[r]:Ur=r,n=mo(n,"onChange"),0<n.length&&(t=new la("onChange","change",null,t,r),e.push({event:t,listeners:n}))}var b=null,w=null;function C(e){mp(e,0)}function D(e){var n=Gt(e);if(ss(n))return e}function fe(e,n){if(e==="change")return n}var Se=!1;if(Et){var We;if(Et){var Ge="oninput"in document;if(!Ge){var $n=document.createElement("div");$n.setAttribute("oninput","return;"),Ge=typeof $n.oninput=="function"}We=Ge}else We=!1;Se=We&&(!document.documentMode||9<document.documentMode)}function ur(){b&&(b.detachEvent("onpropertychange",Ye),w=b=null)}function Ye(e){if(e.propertyName==="value"&&D(w)){var n=[];m(n,w,e,Ja(e)),vl(C,n)}}function fr(e,n,t){e==="focusin"?(ur(),b=n,w=t,b.attachEvent("onpropertychange",Ye)):e==="focusout"&&ur()}function oi(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return D(w)}function jl(e,n){if(e==="click")return D(n)}function Vr(e,n){if(e==="input"||e==="change")return D(n)}function ci(e,n){return e===n&&(e!==0||1/e===1/n)||e!==e&&n!==n}var An=typeof Object.is=="function"?Object.is:ci;function dr(e,n){if(An(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var t=Object.keys(e),r=Object.keys(n);if(t.length!==r.length)return!1;for(r=0;r<t.length;r++){var l=t[r];if(!jr.call(n,l)||!An(e[l],n[l]))return!1}return!0}function ia(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Gr(e,n){var t=ia(e);e=0;for(var r;t;){if(t.nodeType===3){if(r=e+t.textContent.length,e<=n&&r>=n)return{node:t,offset:n-e};e=r}e:{for(;t;){if(t.nextSibling){t=t.nextSibling;break e}t=t.parentNode}t=void 0}t=ia(t)}}function Es(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?Es(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function ui(e){e=e!=null&&e.ownerDocument!=null&&e.ownerDocument.defaultView!=null?e.ownerDocument.defaultView:window;for(var n=ta(e.document);n instanceof e.HTMLIFrameElement;){try{var t=typeof n.contentWindow.location.href=="string"}catch{t=!1}if(t)e=n.contentWindow;else break;n=ta(e.document)}return n}function dc(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var S_=Et&&"documentMode"in document&&11>=document.documentMode,sa=null,mc=null,fi=null,pc=!1;function Gf(e,n,t){var r=t.window===t?t.document:t.nodeType===9?t:t.ownerDocument;pc||sa==null||sa!==ta(r)||(r=sa,"selectionStart"in r&&dc(r)?r={start:r.selectionStart,end:r.selectionEnd}:(r=(r.ownerDocument&&r.ownerDocument.defaultView||window).getSelection(),r={anchorNode:r.anchorNode,anchorOffset:r.anchorOffset,focusNode:r.focusNode,focusOffset:r.focusOffset}),fi&&dr(fi,r)||(fi=r,r=mo(mc,"onSelect"),0<r.length&&(n=new la("onSelect","select",null,n,t),e.push({event:n,listeners:r}),n.target=sa)))}function Al(e,n){var t={};return t[e.toLowerCase()]=n.toLowerCase(),t["Webkit"+e]="webkit"+n,t["Moz"+e]="moz"+n,t}var oa={animationend:Al("Animation","AnimationEnd"),animationiteration:Al("Animation","AnimationIteration"),animationstart:Al("Animation","AnimationStart"),transitionrun:Al("Transition","TransitionRun"),transitionstart:Al("Transition","TransitionStart"),transitioncancel:Al("Transition","TransitionCancel"),transitionend:Al("Transition","TransitionEnd")},hc={},Yf={};Et&&(Yf=document.createElement("div").style,"AnimationEvent"in window||(delete oa.animationend.animation,delete oa.animationiteration.animation,delete oa.animationstart.animation),"TransitionEvent"in window||delete oa.transitionend.transition);function Dl(e){if(hc[e])return hc[e];if(!oa[e])return e;var n=oa[e],t;for(t in n)if(n.hasOwnProperty(t)&&t in Yf)return hc[e]=n[t];return e}var If=Dl("animationend"),qf=Dl("animationiteration"),Pf=Dl("animationstart"),E_=Dl("transitionrun"),k_=Dl("transitionstart"),N_=Dl("transitioncancel"),$f=Dl("transitionend"),Xf=new Map,_c="abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");_c.push("scrollEnd");function Yt(e,n){Xf.set(e,n),st(n,[e])}var ks=typeof reportError=="function"?reportError:function(e){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var n=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof e=="object"&&e!==null&&typeof e.message=="string"?String(e.message):String(e),error:e});if(!window.dispatchEvent(n))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",e);return}console.error(e)},kt=[],ca=0,gc=0;function Ns(){for(var e=ca,n=gc=ca=0;n<e;){var t=kt[n];kt[n++]=null;var r=kt[n];kt[n++]=null;var l=kt[n];kt[n++]=null;var s=kt[n];if(kt[n++]=null,r!==null&&l!==null){var p=r.pending;p===null?l.next=l:(l.next=p.next,p.next=l),r.pending=l}s!==0&&Ff(t,l,s)}}function Rs(e,n,t,r){kt[ca++]=e,kt[ca++]=n,kt[ca++]=t,kt[ca++]=r,gc|=r,e.lanes|=r,e=e.alternate,e!==null&&(e.lanes|=r)}function bc(e,n,t,r){return Rs(e,n,t,r),Ms(e)}function Ol(e,n){return Rs(e,null,null,n),Ms(e)}function Ff(e,n,t){e.lanes|=t;var r=e.alternate;r!==null&&(r.lanes|=t);for(var l=!1,s=e.return;s!==null;)s.childLanes|=t,r=s.alternate,r!==null&&(r.childLanes|=t),s.tag===22&&(e=s.stateNode,e===null||e._visibility&1||(l=!0)),e=s,s=s.return;return e.tag===3?(s=e.stateNode,l&&n!==null&&(l=31-Rn(t),e=s.hiddenUpdates,r=e[l],r===null?e[l]=[n]:r.push(n),n.lane=t|536870912),s):null}function Ms(e){if(50<Oi)throw Oi=0,Ru=null,Error(i(185));for(var n=e.return;n!==null;)e=n,n=e.return;return e.tag===3?e.stateNode:null}var ua={};function R_(e,n,t,r){this.tag=e,this.key=t,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.refCleanup=this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=r,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function ft(e,n,t,r){return new R_(e,n,t,r)}function yc(e){return e=e.prototype,!(!e||!e.isReactComponent)}function mr(e,n){var t=e.alternate;return t===null?(t=ft(e.tag,n,e.key,e.mode),t.elementType=e.elementType,t.type=e.type,t.stateNode=e.stateNode,t.alternate=e,e.alternate=t):(t.pendingProps=n,t.type=e.type,t.flags=0,t.subtreeFlags=0,t.deletions=null),t.flags=e.flags&65011712,t.childLanes=e.childLanes,t.lanes=e.lanes,t.child=e.child,t.memoizedProps=e.memoizedProps,t.memoizedState=e.memoizedState,t.updateQueue=e.updateQueue,n=e.dependencies,t.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},t.sibling=e.sibling,t.index=e.index,t.ref=e.ref,t.refCleanup=e.refCleanup,t}function Kf(e,n){e.flags&=65011714;var t=e.alternate;return t===null?(e.childLanes=0,e.lanes=n,e.child=null,e.subtreeFlags=0,e.memoizedProps=null,e.memoizedState=null,e.updateQueue=null,e.dependencies=null,e.stateNode=null):(e.childLanes=t.childLanes,e.lanes=t.lanes,e.child=t.child,e.subtreeFlags=0,e.deletions=null,e.memoizedProps=t.memoizedProps,e.memoizedState=t.memoizedState,e.updateQueue=t.updateQueue,e.type=t.type,n=t.dependencies,e.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext}),e}function Ts(e,n,t,r,l,s){var p=0;if(r=e,typeof e=="function")yc(e)&&(p=1);else if(typeof e=="string")p=Dg(e,t,T.current)?26:e==="html"||e==="head"||e==="body"?27:5;else e:switch(e){case xe:return e=ft(31,t,n,l),e.elementType=xe,e.lanes=s,e;case J:return Cl(t.children,l,s,n);case K:p=8,l|=24;break;case G:return e=ft(12,t,n,l|2),e.elementType=G,e.lanes=s,e;case se:return e=ft(13,t,n,l),e.elementType=se,e.lanes=s,e;case he:return e=ft(19,t,n,l),e.elementType=he,e.lanes=s,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case ae:p=10;break e;case H:p=9;break e;case le:p=11;break e;case ne:p=14;break e;case ee:p=16,r=null;break e}p=29,t=Error(i(130,e===null?"null":typeof e,"")),r=null}return n=ft(p,t,n,l),n.elementType=e,n.type=r,n.lanes=s,n}function Cl(e,n,t,r){return e=ft(7,e,r,n),e.lanes=t,e}function vc(e,n,t){return e=ft(6,e,null,n),e.lanes=t,e}function Qf(e){var n=ft(18,null,null,0);return n.stateNode=e,n}function xc(e,n,t){return n=ft(4,e.children!==null?e.children:[],e.key,n),n.lanes=t,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}var Zf=new WeakMap;function Nt(e,n){if(typeof e=="object"&&e!==null){var t=Zf.get(e);return t!==void 0?t:(n={value:e,source:n,stack:Bn(n)},Zf.set(e,n),n)}return{value:e,source:n,stack:Bn(n)}}var fa=[],da=0,js=null,di=0,Rt=[],Mt=0,Yr=null,Jt=1,er="";function pr(e,n){fa[da++]=di,fa[da++]=js,js=e,di=n}function Wf(e,n,t){Rt[Mt++]=Jt,Rt[Mt++]=er,Rt[Mt++]=Yr,Yr=e;var r=Jt;e=er;var l=32-Rn(r)-1;r&=~(1<<l),t+=1;var s=32-Rn(n)+l;if(30<s){var p=l-l%5;s=(r&(1<<p)-1).toString(32),r>>=p,l-=p,Jt=1<<32-Rn(n)+l|t<<l|r,er=s+e}else Jt=1<<s|t<<l|r,er=e}function wc(e){e.return!==null&&(pr(e,1),Wf(e,1,0))}function Sc(e){for(;e===js;)js=fa[--da],fa[da]=null,di=fa[--da],fa[da]=null;for(;e===Yr;)Yr=Rt[--Mt],Rt[Mt]=null,er=Rt[--Mt],Rt[Mt]=null,Jt=Rt[--Mt],Rt[Mt]=null}function Jf(e,n){Rt[Mt++]=Jt,Rt[Mt++]=er,Rt[Mt++]=Yr,Jt=n.id,er=n.overflow,Yr=e}var Dn=null,Je=null,Ce=!1,Ir=null,Tt=!1,Ec=Error(i(519));function qr(e){var n=Error(i(418,1<arguments.length&&arguments[1]!==void 0&&arguments[1]?"text":"HTML",""));throw mi(Nt(n,e)),Ec}function ed(e){var n=e.stateNode,t=e.type,r=e.memoizedProps;switch(n[cn]=e,n[un]=r,t){case"dialog":Te("cancel",n),Te("close",n);break;case"iframe":case"object":case"embed":Te("load",n);break;case"video":case"audio":for(t=0;t<Li.length;t++)Te(Li[t],n);break;case"source":Te("error",n);break;case"img":case"image":case"link":Te("error",n),Te("load",n);break;case"details":Te("toggle",n);break;case"input":Te("invalid",n),cs(n,r.value,r.defaultValue,r.checked,r.defaultChecked,r.type,r.name,!0);break;case"select":Te("invalid",n);break;case"textarea":Te("invalid",n),bl(n,r.value,r.defaultValue,r.children)}t=r.children,typeof t!="string"&&typeof t!="number"&&typeof t!="bigint"||n.textContent===""+t||r.suppressHydrationWarning===!0||gp(n.textContent,t)?(r.popover!=null&&(Te("beforetoggle",n),Te("toggle",n)),r.onScroll!=null&&Te("scroll",n),r.onScrollEnd!=null&&Te("scrollend",n),r.onClick!=null&&(n.onclick=tn),n=!0):n=!1,n||qr(e,!0)}function nd(e){for(Dn=e.return;Dn;)switch(Dn.tag){case 5:case 31:case 13:Tt=!1;return;case 27:case 3:Tt=!0;return;default:Dn=Dn.return}}function ma(e){if(e!==Dn)return!1;if(!Ce)return nd(e),Ce=!0,!1;var n=e.tag,t;if((t=n!==3&&n!==27)&&((t=n===5)&&(t=e.type,t=!(t!=="form"&&t!=="button")||Yu(e.type,e.memoizedProps)),t=!t),t&&Je&&qr(e),nd(e),n===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(i(317));Je=Np(e)}else if(n===31){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(i(317));Je=Np(e)}else n===27?(n=Je,ll(e.type)?(e=Xu,Xu=null,Je=e):Je=n):Je=Dn?At(e.stateNode.nextSibling):null;return!0}function Ll(){Je=Dn=null,Ce=!1}function kc(){var e=Ir;return e!==null&&(tt===null?tt=e:tt.push.apply(tt,e),Ir=null),e}function mi(e){Ir===null?Ir=[e]:Ir.push(e)}var Nc=S(null),Bl=null,hr=null;function Pr(e,n,t){W(Nc,n._currentValue),n._currentValue=t}function _r(e){e._currentValue=Nc.current,B(Nc)}function Rc(e,n,t){for(;e!==null;){var r=e.alternate;if((e.childLanes&n)!==n?(e.childLanes|=n,r!==null&&(r.childLanes|=n)):r!==null&&(r.childLanes&n)!==n&&(r.childLanes|=n),e===t)break;e=e.return}}function Mc(e,n,t,r){var l=e.child;for(l!==null&&(l.return=e);l!==null;){var s=l.dependencies;if(s!==null){var p=l.child;s=s.firstContext;e:for(;s!==null;){var g=s;s=l;for(var E=0;E<n.length;E++)if(g.context===n[E]){s.lanes|=t,g=s.alternate,g!==null&&(g.lanes|=t),Rc(s.return,t,e),r||(p=null);break e}s=g.next}}else if(l.tag===18){if(p=l.return,p===null)throw Error(i(341));p.lanes|=t,s=p.alternate,s!==null&&(s.lanes|=t),Rc(p,t,e),p=null}else p=l.child;if(p!==null)p.return=l;else for(p=l;p!==null;){if(p===e){p=null;break}if(l=p.sibling,l!==null){l.return=p.return,p=l;break}p=p.return}l=p}}function pa(e,n,t,r){e=null;for(var l=n,s=!1;l!==null;){if(!s){if((l.flags&524288)!==0)s=!0;else if((l.flags&262144)!==0)break}if(l.tag===10){var p=l.alternate;if(p===null)throw Error(i(387));if(p=p.memoizedProps,p!==null){var g=l.type;An(l.pendingProps.value,p.value)||(e!==null?e.push(g):e=[g])}}else if(l===X.current){if(p=l.alternate,p===null)throw Error(i(387));p.memoizedState.memoizedState!==l.memoizedState.memoizedState&&(e!==null?e.push(Vi):e=[Vi])}l=l.return}e!==null&&Mc(n,e,t,r),n.flags|=262144}function As(e){for(e=e.firstContext;e!==null;){if(!An(e.context._currentValue,e.memoizedValue))return!0;e=e.next}return!1}function zl(e){Bl=e,hr=null,e=e.dependencies,e!==null&&(e.firstContext=null)}function On(e){return td(Bl,e)}function Ds(e,n){return Bl===null&&zl(e),td(e,n)}function td(e,n){var t=n._currentValue;if(n={context:n,memoizedValue:t,next:null},hr===null){if(e===null)throw Error(i(308));hr=n,e.dependencies={lanes:0,firstContext:n},e.flags|=524288}else hr=hr.next=n;return t}var M_=typeof AbortController<"u"?AbortController:function(){var e=[],n=this.signal={aborted:!1,addEventListener:function(t,r){e.push(r)}};this.abort=function(){n.aborted=!0,e.forEach(function(t){return t()})}},T_=o.unstable_scheduleCallback,j_=o.unstable_NormalPriority,pn={$$typeof:ae,Consumer:null,Provider:null,_currentValue:null,_currentValue2:null,_threadCount:0};function Tc(){return{controller:new M_,data:new Map,refCount:0}}function pi(e){e.refCount--,e.refCount===0&&T_(j_,function(){e.controller.abort()})}var hi=null,jc=0,ha=0,_a=null;function A_(e,n){if(hi===null){var t=hi=[];jc=0,ha=Ou(),_a={status:"pending",value:void 0,then:function(r){t.push(r)}}}return jc++,n.then(rd,rd),n}function rd(){if(--jc===0&&hi!==null){_a!==null&&(_a.status="fulfilled");var e=hi;hi=null,ha=0,_a=null;for(var n=0;n<e.length;n++)(0,e[n])()}}function D_(e,n){var t=[],r={status:"pending",value:null,reason:null,then:function(l){t.push(l)}};return e.then(function(){r.status="fulfilled",r.value=n;for(var l=0;l<t.length;l++)(0,t[l])(n)},function(l){for(r.status="rejected",r.reason=l,l=0;l<t.length;l++)(0,t[l])(void 0)}),r}var ld=z.S;z.S=function(e,n){Gm=yn(),typeof n=="object"&&n!==null&&typeof n.then=="function"&&A_(e,n),ld!==null&&ld(e,n)};var Ul=S(null);function Ac(){var e=Ul.current;return e!==null?e:Qe.pooledCache}function Os(e,n){n===null?W(Ul,Ul.current):W(Ul,n.pool)}function ad(){var e=Ac();return e===null?null:{parent:pn._currentValue,pool:e}}var ga=Error(i(460)),Dc=Error(i(474)),Cs=Error(i(542)),Ls={then:function(){}};function id(e){return e=e.status,e==="fulfilled"||e==="rejected"}function sd(e,n,t){switch(t=e[t],t===void 0?e.push(n):t!==n&&(n.then(tn,tn),n=t),n.status){case"fulfilled":return n.value;case"rejected":throw e=n.reason,cd(e),e;default:if(typeof n.status=="string")n.then(tn,tn);else{if(e=Qe,e!==null&&100<e.shellSuspendCounter)throw Error(i(482));e=n,e.status="pending",e.then(function(r){if(n.status==="pending"){var l=n;l.status="fulfilled",l.value=r}},function(r){if(n.status==="pending"){var l=n;l.status="rejected",l.reason=r}})}switch(n.status){case"fulfilled":return n.value;case"rejected":throw e=n.reason,cd(e),e}throw Vl=n,ga}}function Hl(e){try{var n=e._init;return n(e._payload)}catch(t){throw t!==null&&typeof t=="object"&&typeof t.then=="function"?(Vl=t,ga):t}}var Vl=null;function od(){if(Vl===null)throw Error(i(459));var e=Vl;return Vl=null,e}function cd(e){if(e===ga||e===Cs)throw Error(i(483))}var ba=null,_i=0;function Bs(e){var n=_i;return _i+=1,ba===null&&(ba=[]),sd(ba,e,n)}function gi(e,n){n=n.props.ref,e.ref=n!==void 0?n:null}function zs(e,n){throw n.$$typeof===R?Error(i(525)):(e=Object.prototype.toString.call(n),Error(i(31,e==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":e)))}function ud(e){function n(M,k){if(e){var j=M.deletions;j===null?(M.deletions=[k],M.flags|=16):j.push(k)}}function t(M,k){if(!e)return null;for(;k!==null;)n(M,k),k=k.sibling;return null}function r(M){for(var k=new Map;M!==null;)M.key!==null?k.set(M.key,M):k.set(M.index,M),M=M.sibling;return k}function l(M,k){return M=mr(M,k),M.index=0,M.sibling=null,M}function s(M,k,j){return M.index=j,e?(j=M.alternate,j!==null?(j=j.index,j<k?(M.flags|=67108866,k):j):(M.flags|=67108866,k)):(M.flags|=1048576,k)}function p(M){return e&&M.alternate===null&&(M.flags|=67108866),M}function g(M,k,j,Y){return k===null||k.tag!==6?(k=vc(j,M.mode,Y),k.return=M,k):(k=l(k,j),k.return=M,k)}function E(M,k,j,Y){var me=j.type;return me===J?V(M,k,j.props.children,Y,j.key):k!==null&&(k.elementType===me||typeof me=="object"&&me!==null&&me.$$typeof===ee&&Hl(me)===k.type)?(k=l(k,j.props),gi(k,j),k.return=M,k):(k=Ts(j.type,j.key,j.props,null,M.mode,Y),gi(k,j),k.return=M,k)}function A(M,k,j,Y){return k===null||k.tag!==4||k.stateNode.containerInfo!==j.containerInfo||k.stateNode.implementation!==j.implementation?(k=xc(j,M.mode,Y),k.return=M,k):(k=l(k,j.children||[]),k.return=M,k)}function V(M,k,j,Y,me){return k===null||k.tag!==7?(k=Cl(j,M.mode,Y,me),k.return=M,k):(k=l(k,j),k.return=M,k)}function P(M,k,j){if(typeof k=="string"&&k!==""||typeof k=="number"||typeof k=="bigint")return k=vc(""+k,M.mode,j),k.return=M,k;if(typeof k=="object"&&k!==null){switch(k.$$typeof){case $:return j=Ts(k.type,k.key,k.props,null,M.mode,j),gi(j,k),j.return=M,j;case I:return k=xc(k,M.mode,j),k.return=M,k;case ee:return k=Hl(k),P(M,k,j)}if(Pe(k)||ie(k))return k=Cl(k,M.mode,j,null),k.return=M,k;if(typeof k.then=="function")return P(M,Bs(k),j);if(k.$$typeof===ae)return P(M,Ds(M,k),j);zs(M,k)}return null}function O(M,k,j,Y){var me=k!==null?k.key:null;if(typeof j=="string"&&j!==""||typeof j=="number"||typeof j=="bigint")return me!==null?null:g(M,k,""+j,Y);if(typeof j=="object"&&j!==null){switch(j.$$typeof){case $:return j.key===me?E(M,k,j,Y):null;case I:return j.key===me?A(M,k,j,Y):null;case ee:return j=Hl(j),O(M,k,j,Y)}if(Pe(j)||ie(j))return me!==null?null:V(M,k,j,Y,null);if(typeof j.then=="function")return O(M,k,Bs(j),Y);if(j.$$typeof===ae)return O(M,k,Ds(M,j),Y);zs(M,j)}return null}function U(M,k,j,Y,me){if(typeof Y=="string"&&Y!==""||typeof Y=="number"||typeof Y=="bigint")return M=M.get(j)||null,g(k,M,""+Y,me);if(typeof Y=="object"&&Y!==null){switch(Y.$$typeof){case $:return M=M.get(Y.key===null?j:Y.key)||null,E(k,M,Y,me);case I:return M=M.get(Y.key===null?j:Y.key)||null,A(k,M,Y,me);case ee:return Y=Hl(Y),U(M,k,j,Y,me)}if(Pe(Y)||ie(Y))return M=M.get(j)||null,V(k,M,Y,me,null);if(typeof Y.then=="function")return U(M,k,j,Bs(Y),me);if(Y.$$typeof===ae)return U(M,k,j,Ds(k,Y),me);zs(k,Y)}return null}function ce(M,k,j,Y){for(var me=null,ze=null,de=k,Ne=k=0,De=null;de!==null&&Ne<j.length;Ne++){de.index>Ne?(De=de,de=null):De=de.sibling;var Ue=O(M,de,j[Ne],Y);if(Ue===null){de===null&&(de=De);break}e&&de&&Ue.alternate===null&&n(M,de),k=s(Ue,k,Ne),ze===null?me=Ue:ze.sibling=Ue,ze=Ue,de=De}if(Ne===j.length)return t(M,de),Ce&&pr(M,Ne),me;if(de===null){for(;Ne<j.length;Ne++)de=P(M,j[Ne],Y),de!==null&&(k=s(de,k,Ne),ze===null?me=de:ze.sibling=de,ze=de);return Ce&&pr(M,Ne),me}for(de=r(de);Ne<j.length;Ne++)De=U(de,M,Ne,j[Ne],Y),De!==null&&(e&&De.alternate!==null&&de.delete(De.key===null?Ne:De.key),k=s(De,k,Ne),ze===null?me=De:ze.sibling=De,ze=De);return e&&de.forEach(function(cl){return n(M,cl)}),Ce&&pr(M,Ne),me}function _e(M,k,j,Y){if(j==null)throw Error(i(151));for(var me=null,ze=null,de=k,Ne=k=0,De=null,Ue=j.next();de!==null&&!Ue.done;Ne++,Ue=j.next()){de.index>Ne?(De=de,de=null):De=de.sibling;var cl=O(M,de,Ue.value,Y);if(cl===null){de===null&&(de=De);break}e&&de&&cl.alternate===null&&n(M,de),k=s(cl,k,Ne),ze===null?me=cl:ze.sibling=cl,ze=cl,de=De}if(Ue.done)return t(M,de),Ce&&pr(M,Ne),me;if(de===null){for(;!Ue.done;Ne++,Ue=j.next())Ue=P(M,Ue.value,Y),Ue!==null&&(k=s(Ue,k,Ne),ze===null?me=Ue:ze.sibling=Ue,ze=Ue);return Ce&&pr(M,Ne),me}for(de=r(de);!Ue.done;Ne++,Ue=j.next())Ue=U(de,M,Ne,Ue.value,Y),Ue!==null&&(e&&Ue.alternate!==null&&de.delete(Ue.key===null?Ne:Ue.key),k=s(Ue,k,Ne),ze===null?me=Ue:ze.sibling=Ue,ze=Ue);return e&&de.forEach(function(Ig){return n(M,Ig)}),Ce&&pr(M,Ne),me}function Fe(M,k,j,Y){if(typeof j=="object"&&j!==null&&j.type===J&&j.key===null&&(j=j.props.children),typeof j=="object"&&j!==null){switch(j.$$typeof){case $:e:{for(var me=j.key;k!==null;){if(k.key===me){if(me=j.type,me===J){if(k.tag===7){t(M,k.sibling),Y=l(k,j.props.children),Y.return=M,M=Y;break e}}else if(k.elementType===me||typeof me=="object"&&me!==null&&me.$$typeof===ee&&Hl(me)===k.type){t(M,k.sibling),Y=l(k,j.props),gi(Y,j),Y.return=M,M=Y;break e}t(M,k);break}else n(M,k);k=k.sibling}j.type===J?(Y=Cl(j.props.children,M.mode,Y,j.key),Y.return=M,M=Y):(Y=Ts(j.type,j.key,j.props,null,M.mode,Y),gi(Y,j),Y.return=M,M=Y)}return p(M);case I:e:{for(me=j.key;k!==null;){if(k.key===me)if(k.tag===4&&k.stateNode.containerInfo===j.containerInfo&&k.stateNode.implementation===j.implementation){t(M,k.sibling),Y=l(k,j.children||[]),Y.return=M,M=Y;break e}else{t(M,k);break}else n(M,k);k=k.sibling}Y=xc(j,M.mode,Y),Y.return=M,M=Y}return p(M);case ee:return j=Hl(j),Fe(M,k,j,Y)}if(Pe(j))return ce(M,k,j,Y);if(ie(j)){if(me=ie(j),typeof me!="function")throw Error(i(150));return j=me.call(j),_e(M,k,j,Y)}if(typeof j.then=="function")return Fe(M,k,Bs(j),Y);if(j.$$typeof===ae)return Fe(M,k,Ds(M,j),Y);zs(M,j)}return typeof j=="string"&&j!==""||typeof j=="number"||typeof j=="bigint"?(j=""+j,k!==null&&k.tag===6?(t(M,k.sibling),Y=l(k,j),Y.return=M,M=Y):(t(M,k),Y=vc(j,M.mode,Y),Y.return=M,M=Y),p(M)):t(M,k)}return function(M,k,j,Y){try{_i=0;var me=Fe(M,k,j,Y);return ba=null,me}catch(de){if(de===ga||de===Cs)throw de;var ze=ft(29,de,null,M.mode);return ze.lanes=Y,ze.return=M,ze}finally{}}}var Gl=ud(!0),fd=ud(!1),$r=!1;function Oc(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,lanes:0,hiddenCallbacks:null},callbacks:null}}function Cc(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,callbacks:null})}function Xr(e){return{lane:e,tag:0,payload:null,callback:null,next:null}}function Fr(e,n,t){var r=e.updateQueue;if(r===null)return null;if(r=r.shared,(He&2)!==0){var l=r.pending;return l===null?n.next=n:(n.next=l.next,l.next=n),r.pending=n,n=Ms(e),Ff(e,null,t),n}return Rs(e,r,n,t),Ms(e)}function bi(e,n,t){if(n=n.updateQueue,n!==null&&(n=n.shared,(t&4194048)!==0)){var r=n.lanes;r&=e.pendingLanes,t|=r,n.lanes=t,Wl(e,t)}}function Lc(e,n){var t=e.updateQueue,r=e.alternate;if(r!==null&&(r=r.updateQueue,t===r)){var l=null,s=null;if(t=t.firstBaseUpdate,t!==null){do{var p={lane:t.lane,tag:t.tag,payload:t.payload,callback:null,next:null};s===null?l=s=p:s=s.next=p,t=t.next}while(t!==null);s===null?l=s=n:s=s.next=n}else l=s=n;t={baseState:r.baseState,firstBaseUpdate:l,lastBaseUpdate:s,shared:r.shared,callbacks:r.callbacks},e.updateQueue=t;return}e=t.lastBaseUpdate,e===null?t.firstBaseUpdate=n:e.next=n,t.lastBaseUpdate=n}var Bc=!1;function yi(){if(Bc){var e=_a;if(e!==null)throw e}}function vi(e,n,t,r){Bc=!1;var l=e.updateQueue;$r=!1;var s=l.firstBaseUpdate,p=l.lastBaseUpdate,g=l.shared.pending;if(g!==null){l.shared.pending=null;var E=g,A=E.next;E.next=null,p===null?s=A:p.next=A,p=E;var V=e.alternate;V!==null&&(V=V.updateQueue,g=V.lastBaseUpdate,g!==p&&(g===null?V.firstBaseUpdate=A:g.next=A,V.lastBaseUpdate=E))}if(s!==null){var P=l.baseState;p=0,V=A=E=null,g=s;do{var O=g.lane&-536870913,U=O!==g.lane;if(U?(Ae&O)===O:(r&O)===O){O!==0&&O===ha&&(Bc=!0),V!==null&&(V=V.next={lane:0,tag:g.tag,payload:g.payload,callback:null,next:null});e:{var ce=e,_e=g;O=n;var Fe=t;switch(_e.tag){case 1:if(ce=_e.payload,typeof ce=="function"){P=ce.call(Fe,P,O);break e}P=ce;break e;case 3:ce.flags=ce.flags&-65537|128;case 0:if(ce=_e.payload,O=typeof ce=="function"?ce.call(Fe,P,O):ce,O==null)break e;P=N({},P,O);break e;case 2:$r=!0}}O=g.callback,O!==null&&(e.flags|=64,U&&(e.flags|=8192),U=l.callbacks,U===null?l.callbacks=[O]:U.push(O))}else U={lane:O,tag:g.tag,payload:g.payload,callback:g.callback,next:null},V===null?(A=V=U,E=P):V=V.next=U,p|=O;if(g=g.next,g===null){if(g=l.shared.pending,g===null)break;U=g,g=U.next,U.next=null,l.lastBaseUpdate=U,l.shared.pending=null}}while(!0);V===null&&(E=P),l.baseState=E,l.firstBaseUpdate=A,l.lastBaseUpdate=V,s===null&&(l.shared.lanes=0),Jr|=p,e.lanes=p,e.memoizedState=P}}function dd(e,n){if(typeof e!="function")throw Error(i(191,e));e.call(n)}function md(e,n){var t=e.callbacks;if(t!==null)for(e.callbacks=null,e=0;e<t.length;e++)dd(t[e],n)}var ya=S(null),Us=S(0);function pd(e,n){e=kr,W(Us,e),W(ya,n),kr=e|n.baseLanes}function zc(){W(Us,kr),W(ya,ya.current)}function Uc(){kr=Us.current,B(ya),B(Us)}var dt=S(null),jt=null;function Kr(e){var n=e.alternate;W(fn,fn.current&1),W(dt,e),jt===null&&(n===null||ya.current!==null||n.memoizedState!==null)&&(jt=e)}function Hc(e){W(fn,fn.current),W(dt,e),jt===null&&(jt=e)}function hd(e){e.tag===22?(W(fn,fn.current),W(dt,e),jt===null&&(jt=e)):Qr()}function Qr(){W(fn,fn.current),W(dt,dt.current)}function mt(e){B(dt),jt===e&&(jt=null),B(fn)}var fn=S(0);function Hs(e){for(var n=e;n!==null;){if(n.tag===13){var t=n.memoizedState;if(t!==null&&(t=t.dehydrated,t===null||Pu(t)||$u(t)))return n}else if(n.tag===19&&(n.memoizedProps.revealOrder==="forwards"||n.memoizedProps.revealOrder==="backwards"||n.memoizedProps.revealOrder==="unstable_legacy-backwards"||n.memoizedProps.revealOrder==="together")){if((n.flags&128)!==0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var gr=0,Ee=null,$e=null,hn=null,Vs=!1,va=!1,Yl=!1,Gs=0,xi=0,xa=null,O_=0;function an(){throw Error(i(321))}function Vc(e,n){if(n===null)return!1;for(var t=0;t<n.length&&t<e.length;t++)if(!An(e[t],n[t]))return!1;return!0}function Gc(e,n,t,r,l,s){return gr=s,Ee=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,z.H=e===null||e.memoizedState===null?Wd:tu,Yl=!1,s=t(r,l),Yl=!1,va&&(s=gd(n,t,r,l)),_d(e),s}function _d(e){z.H=Ei;var n=$e!==null&&$e.next!==null;if(gr=0,hn=$e=Ee=null,Vs=!1,xi=0,xa=null,n)throw Error(i(300));e===null||_n||(e=e.dependencies,e!==null&&As(e)&&(_n=!0))}function gd(e,n,t,r){Ee=e;var l=0;do{if(va&&(xa=null),xi=0,va=!1,25<=l)throw Error(i(301));if(l+=1,hn=$e=null,e.updateQueue!=null){var s=e.updateQueue;s.lastEffect=null,s.events=null,s.stores=null,s.memoCache!=null&&(s.memoCache.index=0)}z.H=Jd,s=n(t,r)}while(va);return s}function C_(){var e=z.H,n=e.useState()[0];return n=typeof n.then=="function"?wi(n):n,e=e.useState()[0],($e!==null?$e.memoizedState:null)!==e&&(Ee.flags|=1024),n}function Yc(){var e=Gs!==0;return Gs=0,e}function Ic(e,n,t){n.updateQueue=e.updateQueue,n.flags&=-2053,e.lanes&=~t}function qc(e){if(Vs){for(e=e.memoizedState;e!==null;){var n=e.queue;n!==null&&(n.pending=null),e=e.next}Vs=!1}gr=0,hn=$e=Ee=null,va=!1,xi=Gs=0,xa=null}function Xn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return hn===null?Ee.memoizedState=hn=e:hn=hn.next=e,hn}function dn(){if($e===null){var e=Ee.alternate;e=e!==null?e.memoizedState:null}else e=$e.next;var n=hn===null?Ee.memoizedState:hn.next;if(n!==null)hn=n,$e=e;else{if(e===null)throw Ee.alternate===null?Error(i(467)):Error(i(310));$e=e,e={memoizedState:$e.memoizedState,baseState:$e.baseState,baseQueue:$e.baseQueue,queue:$e.queue,next:null},hn===null?Ee.memoizedState=hn=e:hn=hn.next=e}return hn}function Ys(){return{lastEffect:null,events:null,stores:null,memoCache:null}}function wi(e){var n=xi;return xi+=1,xa===null&&(xa=[]),e=sd(xa,e,n),n=Ee,(hn===null?n.memoizedState:hn.next)===null&&(n=n.alternate,z.H=n===null||n.memoizedState===null?Wd:tu),e}function Is(e){if(e!==null&&typeof e=="object"){if(typeof e.then=="function")return wi(e);if(e.$$typeof===ae)return On(e)}throw Error(i(438,String(e)))}function Pc(e){var n=null,t=Ee.updateQueue;if(t!==null&&(n=t.memoCache),n==null){var r=Ee.alternate;r!==null&&(r=r.updateQueue,r!==null&&(r=r.memoCache,r!=null&&(n={data:r.data.map(function(l){return l.slice()}),index:0})))}if(n==null&&(n={data:[],index:0}),t===null&&(t=Ys(),Ee.updateQueue=t),t.memoCache=n,t=n.data[n.index],t===void 0)for(t=n.data[n.index]=Array(e),r=0;r<e;r++)t[r]=ge;return n.index++,t}function br(e,n){return typeof n=="function"?n(e):n}function qs(e){var n=dn();return $c(n,$e,e)}function $c(e,n,t){var r=e.queue;if(r===null)throw Error(i(311));r.lastRenderedReducer=t;var l=e.baseQueue,s=r.pending;if(s!==null){if(l!==null){var p=l.next;l.next=s.next,s.next=p}n.baseQueue=l=s,r.pending=null}if(s=e.baseState,l===null)e.memoizedState=s;else{n=l.next;var g=p=null,E=null,A=n,V=!1;do{var P=A.lane&-536870913;if(P!==A.lane?(Ae&P)===P:(gr&P)===P){var O=A.revertLane;if(O===0)E!==null&&(E=E.next={lane:0,revertLane:0,gesture:null,action:A.action,hasEagerState:A.hasEagerState,eagerState:A.eagerState,next:null}),P===ha&&(V=!0);else if((gr&O)===O){A=A.next,O===ha&&(V=!0);continue}else P={lane:0,revertLane:A.revertLane,gesture:null,action:A.action,hasEagerState:A.hasEagerState,eagerState:A.eagerState,next:null},E===null?(g=E=P,p=s):E=E.next=P,Ee.lanes|=O,Jr|=O;P=A.action,Yl&&t(s,P),s=A.hasEagerState?A.eagerState:t(s,P)}else O={lane:P,revertLane:A.revertLane,gesture:A.gesture,action:A.action,hasEagerState:A.hasEagerState,eagerState:A.eagerState,next:null},E===null?(g=E=O,p=s):E=E.next=O,Ee.lanes|=P,Jr|=P;A=A.next}while(A!==null&&A!==n);if(E===null?p=s:E.next=g,!An(s,e.memoizedState)&&(_n=!0,V&&(t=_a,t!==null)))throw t;e.memoizedState=s,e.baseState=p,e.baseQueue=E,r.lastRenderedState=s}return l===null&&(r.lanes=0),[e.memoizedState,r.dispatch]}function Xc(e){var n=dn(),t=n.queue;if(t===null)throw Error(i(311));t.lastRenderedReducer=e;var r=t.dispatch,l=t.pending,s=n.memoizedState;if(l!==null){t.pending=null;var p=l=l.next;do s=e(s,p.action),p=p.next;while(p!==l);An(s,n.memoizedState)||(_n=!0),n.memoizedState=s,n.baseQueue===null&&(n.baseState=s),t.lastRenderedState=s}return[s,r]}function bd(e,n,t){var r=Ee,l=dn(),s=Ce;if(s){if(t===void 0)throw Error(i(407));t=t()}else t=n();var p=!An(($e||l).memoizedState,t);if(p&&(l.memoizedState=t,_n=!0),l=l.queue,Qc(xd.bind(null,r,l,e),[e]),l.getSnapshot!==n||p||hn!==null&&hn.memoizedState.tag&1){if(r.flags|=2048,wa(9,{destroy:void 0},vd.bind(null,r,l,t,n),null),Qe===null)throw Error(i(349));s||(gr&127)!==0||yd(r,n,t)}return t}function yd(e,n,t){e.flags|=16384,e={getSnapshot:n,value:t},n=Ee.updateQueue,n===null?(n=Ys(),Ee.updateQueue=n,n.stores=[e]):(t=n.stores,t===null?n.stores=[e]:t.push(e))}function vd(e,n,t,r){n.value=t,n.getSnapshot=r,wd(n)&&Sd(e)}function xd(e,n,t){return t(function(){wd(n)&&Sd(e)})}function wd(e){var n=e.getSnapshot;e=e.value;try{var t=n();return!An(e,t)}catch{return!0}}function Sd(e){var n=Ol(e,2);n!==null&&rt(n,e,2)}function Fc(e){var n=Xn();if(typeof e=="function"){var t=e;if(e=t(),Yl){at(!0);try{t()}finally{at(!1)}}}return n.memoizedState=n.baseState=e,n.queue={pending:null,lanes:0,dispatch:null,lastRenderedReducer:br,lastRenderedState:e},n}function Ed(e,n,t,r){return e.baseState=t,$c(e,$e,typeof r=="function"?r:br)}function L_(e,n,t,r,l){if(Xs(e))throw Error(i(485));if(e=n.action,e!==null){var s={payload:l,action:e,next:null,isTransition:!0,status:"pending",value:null,reason:null,listeners:[],then:function(p){s.listeners.push(p)}};z.T!==null?t(!0):s.isTransition=!1,r(s),t=n.pending,t===null?(s.next=n.pending=s,kd(n,s)):(s.next=t.next,n.pending=t.next=s)}}function kd(e,n){var t=n.action,r=n.payload,l=e.state;if(n.isTransition){var s=z.T,p={};z.T=p;try{var g=t(l,r),E=z.S;E!==null&&E(p,g),Nd(e,n,g)}catch(A){Kc(e,n,A)}finally{s!==null&&p.types!==null&&(s.types=p.types),z.T=s}}else try{s=t(l,r),Nd(e,n,s)}catch(A){Kc(e,n,A)}}function Nd(e,n,t){t!==null&&typeof t=="object"&&typeof t.then=="function"?t.then(function(r){Rd(e,n,r)},function(r){return Kc(e,n,r)}):Rd(e,n,t)}function Rd(e,n,t){n.status="fulfilled",n.value=t,Md(n),e.state=t,n=e.pending,n!==null&&(t=n.next,t===n?e.pending=null:(t=t.next,n.next=t,kd(e,t)))}function Kc(e,n,t){var r=e.pending;if(e.pending=null,r!==null){r=r.next;do n.status="rejected",n.reason=t,Md(n),n=n.next;while(n!==r)}e.action=null}function Md(e){e=e.listeners;for(var n=0;n<e.length;n++)(0,e[n])()}function Td(e,n){return n}function jd(e,n){if(Ce){var t=Qe.formState;if(t!==null){e:{var r=Ee;if(Ce){if(Je){n:{for(var l=Je,s=Tt;l.nodeType!==8;){if(!s){l=null;break n}if(l=At(l.nextSibling),l===null){l=null;break n}}s=l.data,l=s==="F!"||s==="F"?l:null}if(l){Je=At(l.nextSibling),r=l.data==="F!";break e}}qr(r)}r=!1}r&&(n=t[0])}}return t=Xn(),t.memoizedState=t.baseState=n,r={pending:null,lanes:0,dispatch:null,lastRenderedReducer:Td,lastRenderedState:n},t.queue=r,t=Kd.bind(null,Ee,r),r.dispatch=t,r=Fc(!1),s=nu.bind(null,Ee,!1,r.queue),r=Xn(),l={state:n,dispatch:null,action:e,pending:null},r.queue=l,t=L_.bind(null,Ee,l,s,t),l.dispatch=t,r.memoizedState=e,[n,t,!1]}function Ad(e){var n=dn();return Dd(n,$e,e)}function Dd(e,n,t){if(n=$c(e,n,Td)[0],e=qs(br)[0],typeof n=="object"&&n!==null&&typeof n.then=="function")try{var r=wi(n)}catch(p){throw p===ga?Cs:p}else r=n;n=dn();var l=n.queue,s=l.dispatch;return t!==n.memoizedState&&(Ee.flags|=2048,wa(9,{destroy:void 0},B_.bind(null,l,t),null)),[r,s,e]}function B_(e,n){e.action=n}function Od(e){var n=dn(),t=$e;if(t!==null)return Dd(n,t,e);dn(),n=n.memoizedState,t=dn();var r=t.queue.dispatch;return t.memoizedState=e,[n,r,!1]}function wa(e,n,t,r){return e={tag:e,create:t,deps:r,inst:n,next:null},n=Ee.updateQueue,n===null&&(n=Ys(),Ee.updateQueue=n),t=n.lastEffect,t===null?n.lastEffect=e.next=e:(r=t.next,t.next=e,e.next=r,n.lastEffect=e),e}function Cd(){return dn().memoizedState}function Ps(e,n,t,r){var l=Xn();Ee.flags|=e,l.memoizedState=wa(1|n,{destroy:void 0},t,r===void 0?null:r)}function $s(e,n,t,r){var l=dn();r=r===void 0?null:r;var s=l.memoizedState.inst;$e!==null&&r!==null&&Vc(r,$e.memoizedState.deps)?l.memoizedState=wa(n,s,t,r):(Ee.flags|=e,l.memoizedState=wa(1|n,s,t,r))}function Ld(e,n){Ps(8390656,8,e,n)}function Qc(e,n){$s(2048,8,e,n)}function z_(e){Ee.flags|=4;var n=Ee.updateQueue;if(n===null)n=Ys(),Ee.updateQueue=n,n.events=[e];else{var t=n.events;t===null?n.events=[e]:t.push(e)}}function Bd(e){var n=dn().memoizedState;return z_({ref:n,nextImpl:e}),function(){if((He&2)!==0)throw Error(i(440));return n.impl.apply(void 0,arguments)}}function zd(e,n){return $s(4,2,e,n)}function Ud(e,n){return $s(4,4,e,n)}function Hd(e,n){if(typeof n=="function"){e=e();var t=n(e);return function(){typeof t=="function"?t():n(null)}}if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function Vd(e,n,t){t=t!=null?t.concat([e]):null,$s(4,4,Hd.bind(null,n,e),t)}function Zc(){}function Gd(e,n){var t=dn();n=n===void 0?null:n;var r=t.memoizedState;return n!==null&&Vc(n,r[1])?r[0]:(t.memoizedState=[e,n],e)}function Yd(e,n){var t=dn();n=n===void 0?null:n;var r=t.memoizedState;if(n!==null&&Vc(n,r[1]))return r[0];if(r=e(),Yl){at(!0);try{e()}finally{at(!1)}}return t.memoizedState=[r,n],r}function Wc(e,n,t){return t===void 0||(gr&1073741824)!==0&&(Ae&261930)===0?e.memoizedState=n:(e.memoizedState=t,e=Im(),Ee.lanes|=e,Jr|=e,t)}function Id(e,n,t,r){return An(t,n)?t:ya.current!==null?(e=Wc(e,t,r),An(e,n)||(_n=!0),e):(gr&42)===0||(gr&1073741824)!==0&&(Ae&261930)===0?(_n=!0,e.memoizedState=t):(e=Im(),Ee.lanes|=e,Jr|=e,n)}function qd(e,n,t,r,l){var s=Z.p;Z.p=s!==0&&8>s?s:8;var p=z.T,g={};z.T=g,nu(e,!1,n,t);try{var E=l(),A=z.S;if(A!==null&&A(g,E),E!==null&&typeof E=="object"&&typeof E.then=="function"){var V=D_(E,r);Si(e,n,V,_t(e))}else Si(e,n,r,_t(e))}catch(P){Si(e,n,{then:function(){},status:"rejected",reason:P},_t())}finally{Z.p=s,p!==null&&g.types!==null&&(p.types=g.types),z.T=p}}function U_(){}function Jc(e,n,t,r){if(e.tag!==5)throw Error(i(476));var l=Pd(e).queue;qd(e,l,n,oe,t===null?U_:function(){return $d(e),t(r)})}function Pd(e){var n=e.memoizedState;if(n!==null)return n;n={memoizedState:oe,baseState:oe,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:br,lastRenderedState:oe},next:null};var t={};return n.next={memoizedState:t,baseState:t,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:br,lastRenderedState:t},next:null},e.memoizedState=n,e=e.alternate,e!==null&&(e.memoizedState=n),n}function $d(e){var n=Pd(e);n.next===null&&(n=e.alternate.memoizedState),Si(e,n.next.queue,{},_t())}function eu(){return On(Vi)}function Xd(){return dn().memoizedState}function Fd(){return dn().memoizedState}function H_(e){for(var n=e.return;n!==null;){switch(n.tag){case 24:case 3:var t=_t();e=Xr(t);var r=Fr(n,e,t);r!==null&&(rt(r,n,t),bi(r,n,t)),n={cache:Tc()},e.payload=n;return}n=n.return}}function V_(e,n,t){var r=_t();t={lane:r,revertLane:0,gesture:null,action:t,hasEagerState:!1,eagerState:null,next:null},Xs(e)?Qd(n,t):(t=bc(e,n,t,r),t!==null&&(rt(t,e,r),Zd(t,n,r)))}function Kd(e,n,t){var r=_t();Si(e,n,t,r)}function Si(e,n,t,r){var l={lane:r,revertLane:0,gesture:null,action:t,hasEagerState:!1,eagerState:null,next:null};if(Xs(e))Qd(n,l);else{var s=e.alternate;if(e.lanes===0&&(s===null||s.lanes===0)&&(s=n.lastRenderedReducer,s!==null))try{var p=n.lastRenderedState,g=s(p,t);if(l.hasEagerState=!0,l.eagerState=g,An(g,p))return Rs(e,n,l,0),Qe===null&&Ns(),!1}catch{}finally{}if(t=bc(e,n,l,r),t!==null)return rt(t,e,r),Zd(t,n,r),!0}return!1}function nu(e,n,t,r){if(r={lane:2,revertLane:Ou(),gesture:null,action:r,hasEagerState:!1,eagerState:null,next:null},Xs(e)){if(n)throw Error(i(479))}else n=bc(e,t,r,2),n!==null&&rt(n,e,2)}function Xs(e){var n=e.alternate;return e===Ee||n!==null&&n===Ee}function Qd(e,n){va=Vs=!0;var t=e.pending;t===null?n.next=n:(n.next=t.next,t.next=n),e.pending=n}function Zd(e,n,t){if((t&4194048)!==0){var r=n.lanes;r&=e.pendingLanes,t|=r,n.lanes=t,Wl(e,t)}}var Ei={readContext:On,use:Is,useCallback:an,useContext:an,useEffect:an,useImperativeHandle:an,useLayoutEffect:an,useInsertionEffect:an,useMemo:an,useReducer:an,useRef:an,useState:an,useDebugValue:an,useDeferredValue:an,useTransition:an,useSyncExternalStore:an,useId:an,useHostTransitionStatus:an,useFormState:an,useActionState:an,useOptimistic:an,useMemoCache:an,useCacheRefresh:an};Ei.useEffectEvent=an;var Wd={readContext:On,use:Is,useCallback:function(e,n){return Xn().memoizedState=[e,n===void 0?null:n],e},useContext:On,useEffect:Ld,useImperativeHandle:function(e,n,t){t=t!=null?t.concat([e]):null,Ps(4194308,4,Hd.bind(null,n,e),t)},useLayoutEffect:function(e,n){return Ps(4194308,4,e,n)},useInsertionEffect:function(e,n){Ps(4,2,e,n)},useMemo:function(e,n){var t=Xn();n=n===void 0?null:n;var r=e();if(Yl){at(!0);try{e()}finally{at(!1)}}return t.memoizedState=[r,n],r},useReducer:function(e,n,t){var r=Xn();if(t!==void 0){var l=t(n);if(Yl){at(!0);try{t(n)}finally{at(!1)}}}else l=n;return r.memoizedState=r.baseState=l,e={pending:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:l},r.queue=e,e=e.dispatch=V_.bind(null,Ee,e),[r.memoizedState,e]},useRef:function(e){var n=Xn();return e={current:e},n.memoizedState=e},useState:function(e){e=Fc(e);var n=e.queue,t=Kd.bind(null,Ee,n);return n.dispatch=t,[e.memoizedState,t]},useDebugValue:Zc,useDeferredValue:function(e,n){var t=Xn();return Wc(t,e,n)},useTransition:function(){var e=Fc(!1);return e=qd.bind(null,Ee,e.queue,!0,!1),Xn().memoizedState=e,[!1,e]},useSyncExternalStore:function(e,n,t){var r=Ee,l=Xn();if(Ce){if(t===void 0)throw Error(i(407));t=t()}else{if(t=n(),Qe===null)throw Error(i(349));(Ae&127)!==0||yd(r,n,t)}l.memoizedState=t;var s={value:t,getSnapshot:n};return l.queue=s,Ld(xd.bind(null,r,s,e),[e]),r.flags|=2048,wa(9,{destroy:void 0},vd.bind(null,r,s,t,n),null),t},useId:function(){var e=Xn(),n=Qe.identifierPrefix;if(Ce){var t=er,r=Jt;t=(r&~(1<<32-Rn(r)-1)).toString(32)+t,n="_"+n+"R_"+t,t=Gs++,0<t&&(n+="H"+t.toString(32)),n+="_"}else t=O_++,n="_"+n+"r_"+t.toString(32)+"_";return e.memoizedState=n},useHostTransitionStatus:eu,useFormState:jd,useActionState:jd,useOptimistic:function(e){var n=Xn();n.memoizedState=n.baseState=e;var t={pending:null,lanes:0,dispatch:null,lastRenderedReducer:null,lastRenderedState:null};return n.queue=t,n=nu.bind(null,Ee,!0,t),t.dispatch=n,[e,n]},useMemoCache:Pc,useCacheRefresh:function(){return Xn().memoizedState=H_.bind(null,Ee)},useEffectEvent:function(e){var n=Xn(),t={impl:e};return n.memoizedState=t,function(){if((He&2)!==0)throw Error(i(440));return t.impl.apply(void 0,arguments)}}},tu={readContext:On,use:Is,useCallback:Gd,useContext:On,useEffect:Qc,useImperativeHandle:Vd,useInsertionEffect:zd,useLayoutEffect:Ud,useMemo:Yd,useReducer:qs,useRef:Cd,useState:function(){return qs(br)},useDebugValue:Zc,useDeferredValue:function(e,n){var t=dn();return Id(t,$e.memoizedState,e,n)},useTransition:function(){var e=qs(br)[0],n=dn().memoizedState;return[typeof e=="boolean"?e:wi(e),n]},useSyncExternalStore:bd,useId:Xd,useHostTransitionStatus:eu,useFormState:Ad,useActionState:Ad,useOptimistic:function(e,n){var t=dn();return Ed(t,$e,e,n)},useMemoCache:Pc,useCacheRefresh:Fd};tu.useEffectEvent=Bd;var Jd={readContext:On,use:Is,useCallback:Gd,useContext:On,useEffect:Qc,useImperativeHandle:Vd,useInsertionEffect:zd,useLayoutEffect:Ud,useMemo:Yd,useReducer:Xc,useRef:Cd,useState:function(){return Xc(br)},useDebugValue:Zc,useDeferredValue:function(e,n){var t=dn();return $e===null?Wc(t,e,n):Id(t,$e.memoizedState,e,n)},useTransition:function(){var e=Xc(br)[0],n=dn().memoizedState;return[typeof e=="boolean"?e:wi(e),n]},useSyncExternalStore:bd,useId:Xd,useHostTransitionStatus:eu,useFormState:Od,useActionState:Od,useOptimistic:function(e,n){var t=dn();return $e!==null?Ed(t,$e,e,n):(t.baseState=e,[e,t.queue.dispatch])},useMemoCache:Pc,useCacheRefresh:Fd};Jd.useEffectEvent=Bd;function ru(e,n,t,r){n=e.memoizedState,t=t(r,n),t=t==null?n:N({},n,t),e.memoizedState=t,e.lanes===0&&(e.updateQueue.baseState=t)}var lu={enqueueSetState:function(e,n,t){e=e._reactInternals;var r=_t(),l=Xr(r);l.payload=n,t!=null&&(l.callback=t),n=Fr(e,l,r),n!==null&&(rt(n,e,r),bi(n,e,r))},enqueueReplaceState:function(e,n,t){e=e._reactInternals;var r=_t(),l=Xr(r);l.tag=1,l.payload=n,t!=null&&(l.callback=t),n=Fr(e,l,r),n!==null&&(rt(n,e,r),bi(n,e,r))},enqueueForceUpdate:function(e,n){e=e._reactInternals;var t=_t(),r=Xr(t);r.tag=2,n!=null&&(r.callback=n),n=Fr(e,r,t),n!==null&&(rt(n,e,t),bi(n,e,t))}};function em(e,n,t,r,l,s,p){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(r,s,p):n.prototype&&n.prototype.isPureReactComponent?!dr(t,r)||!dr(l,s):!0}function nm(e,n,t,r){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(t,r),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(t,r),n.state!==e&&lu.enqueueReplaceState(n,n.state,null)}function Il(e,n){var t=n;if("ref"in n){t={};for(var r in n)r!=="ref"&&(t[r]=n[r])}if(e=e.defaultProps){t===n&&(t=N({},t));for(var l in e)t[l]===void 0&&(t[l]=e[l])}return t}function tm(e){ks(e)}function rm(e){console.error(e)}function lm(e){ks(e)}function Fs(e,n){try{var t=e.onUncaughtError;t(n.value,{componentStack:n.stack})}catch(r){setTimeout(function(){throw r})}}function am(e,n,t){try{var r=e.onCaughtError;r(t.value,{componentStack:t.stack,errorBoundary:n.tag===1?n.stateNode:null})}catch(l){setTimeout(function(){throw l})}}function au(e,n,t){return t=Xr(t),t.tag=3,t.payload={element:null},t.callback=function(){Fs(e,n)},t}function im(e){return e=Xr(e),e.tag=3,e}function sm(e,n,t,r){var l=t.type.getDerivedStateFromError;if(typeof l=="function"){var s=r.value;e.payload=function(){return l(s)},e.callback=function(){am(n,t,r)}}var p=t.stateNode;p!==null&&typeof p.componentDidCatch=="function"&&(e.callback=function(){am(n,t,r),typeof l!="function"&&(el===null?el=new Set([this]):el.add(this));var g=r.stack;this.componentDidCatch(r.value,{componentStack:g!==null?g:""})})}function G_(e,n,t,r,l){if(t.flags|=32768,r!==null&&typeof r=="object"&&typeof r.then=="function"){if(n=t.alternate,n!==null&&pa(n,t,l,!0),t=dt.current,t!==null){switch(t.tag){case 31:case 13:return jt===null?io():t.alternate===null&&sn===0&&(sn=3),t.flags&=-257,t.flags|=65536,t.lanes=l,r===Ls?t.flags|=16384:(n=t.updateQueue,n===null?t.updateQueue=new Set([r]):n.add(r),ju(e,r,l)),!1;case 22:return t.flags|=65536,r===Ls?t.flags|=16384:(n=t.updateQueue,n===null?(n={transitions:null,markerInstances:null,retryQueue:new Set([r])},t.updateQueue=n):(t=n.retryQueue,t===null?n.retryQueue=new Set([r]):t.add(r)),ju(e,r,l)),!1}throw Error(i(435,t.tag))}return ju(e,r,l),io(),!1}if(Ce)return n=dt.current,n!==null?((n.flags&65536)===0&&(n.flags|=256),n.flags|=65536,n.lanes=l,r!==Ec&&(e=Error(i(422),{cause:r}),mi(Nt(e,t)))):(r!==Ec&&(n=Error(i(423),{cause:r}),mi(Nt(n,t))),e=e.current.alternate,e.flags|=65536,l&=-l,e.lanes|=l,r=Nt(r,t),l=au(e.stateNode,r,l),Lc(e,l),sn!==4&&(sn=2)),!1;var s=Error(i(520),{cause:r});if(s=Nt(s,t),Di===null?Di=[s]:Di.push(s),sn!==4&&(sn=2),n===null)return!0;r=Nt(r,t),t=n;do{switch(t.tag){case 3:return t.flags|=65536,e=l&-l,t.lanes|=e,e=au(t.stateNode,r,e),Lc(t,e),!1;case 1:if(n=t.type,s=t.stateNode,(t.flags&128)===0&&(typeof n.getDerivedStateFromError=="function"||s!==null&&typeof s.componentDidCatch=="function"&&(el===null||!el.has(s))))return t.flags|=65536,l&=-l,t.lanes|=l,l=im(l),sm(l,e,t,r),Lc(t,l),!1}t=t.return}while(t!==null);return!1}var iu=Error(i(461)),_n=!1;function Cn(e,n,t,r){n.child=e===null?fd(n,null,t,r):Gl(n,e.child,t,r)}function om(e,n,t,r,l){t=t.render;var s=n.ref;if("ref"in r){var p={};for(var g in r)g!=="ref"&&(p[g]=r[g])}else p=r;return zl(n),r=Gc(e,n,t,p,s,l),g=Yc(),e!==null&&!_n?(Ic(e,n,l),yr(e,n,l)):(Ce&&g&&wc(n),n.flags|=1,Cn(e,n,r,l),n.child)}function cm(e,n,t,r,l){if(e===null){var s=t.type;return typeof s=="function"&&!yc(s)&&s.defaultProps===void 0&&t.compare===null?(n.tag=15,n.type=s,um(e,n,s,r,l)):(e=Ts(t.type,null,r,n,n.mode,l),e.ref=n.ref,e.return=n,n.child=e)}if(s=e.child,!pu(e,l)){var p=s.memoizedProps;if(t=t.compare,t=t!==null?t:dr,t(p,r)&&e.ref===n.ref)return yr(e,n,l)}return n.flags|=1,e=mr(s,r),e.ref=n.ref,e.return=n,n.child=e}function um(e,n,t,r,l){if(e!==null){var s=e.memoizedProps;if(dr(s,r)&&e.ref===n.ref)if(_n=!1,n.pendingProps=r=s,pu(e,l))(e.flags&131072)!==0&&(_n=!0);else return n.lanes=e.lanes,yr(e,n,l)}return su(e,n,t,r,l)}function fm(e,n,t,r){var l=r.children,s=e!==null?e.memoizedState:null;if(e===null&&n.stateNode===null&&(n.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null}),r.mode==="hidden"){if((n.flags&128)!==0){if(s=s!==null?s.baseLanes|t:t,e!==null){for(r=n.child=e.child,l=0;r!==null;)l=l|r.lanes|r.childLanes,r=r.sibling;r=l&~s}else r=0,n.child=null;return dm(e,n,s,t,r)}if((t&536870912)!==0)n.memoizedState={baseLanes:0,cachePool:null},e!==null&&Os(n,s!==null?s.cachePool:null),s!==null?pd(n,s):zc(),hd(n);else return r=n.lanes=536870912,dm(e,n,s!==null?s.baseLanes|t:t,t,r)}else s!==null?(Os(n,s.cachePool),pd(n,s),Qr(),n.memoizedState=null):(e!==null&&Os(n,null),zc(),Qr());return Cn(e,n,l,t),n.child}function ki(e,n){return e!==null&&e.tag===22||n.stateNode!==null||(n.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null}),n.sibling}function dm(e,n,t,r,l){var s=Ac();return s=s===null?null:{parent:pn._currentValue,pool:s},n.memoizedState={baseLanes:t,cachePool:s},e!==null&&Os(n,null),zc(),hd(n),e!==null&&pa(e,n,r,!0),n.childLanes=l,null}function Ks(e,n){return n=Zs({mode:n.mode,children:n.children},e.mode),n.ref=e.ref,e.child=n,n.return=e,n}function mm(e,n,t){return Gl(n,e.child,null,t),e=Ks(n,n.pendingProps),e.flags|=2,mt(n),n.memoizedState=null,e}function Y_(e,n,t){var r=n.pendingProps,l=(n.flags&128)!==0;if(n.flags&=-129,e===null){if(Ce){if(r.mode==="hidden")return e=Ks(n,r),n.lanes=536870912,ki(null,e);if(Hc(n),(e=Je)?(e=kp(e,Tt),e=e!==null&&e.data==="&"?e:null,e!==null&&(n.memoizedState={dehydrated:e,treeContext:Yr!==null?{id:Jt,overflow:er}:null,retryLane:536870912,hydrationErrors:null},t=Qf(e),t.return=n,n.child=t,Dn=n,Je=null)):e=null,e===null)throw qr(n);return n.lanes=536870912,null}return Ks(n,r)}var s=e.memoizedState;if(s!==null){var p=s.dehydrated;if(Hc(n),l)if(n.flags&256)n.flags&=-257,n=mm(e,n,t);else if(n.memoizedState!==null)n.child=e.child,n.flags|=128,n=null;else throw Error(i(558));else if(_n||pa(e,n,t,!1),l=(t&e.childLanes)!==0,_n||l){if(r=Qe,r!==null&&(p=as(r,t),p!==0&&p!==s.retryLane))throw s.retryLane=p,Ol(e,p),rt(r,e,p),iu;io(),n=mm(e,n,t)}else e=s.treeContext,Je=At(p.nextSibling),Dn=n,Ce=!0,Ir=null,Tt=!1,e!==null&&Jf(n,e),n=Ks(n,r),n.flags|=4096;return n}return e=mr(e.child,{mode:r.mode,children:r.children}),e.ref=n.ref,n.child=e,e.return=n,e}function Qs(e,n){var t=n.ref;if(t===null)e!==null&&e.ref!==null&&(n.flags|=4194816);else{if(typeof t!="function"&&typeof t!="object")throw Error(i(284));(e===null||e.ref!==t)&&(n.flags|=4194816)}}function su(e,n,t,r,l){return zl(n),t=Gc(e,n,t,r,void 0,l),r=Yc(),e!==null&&!_n?(Ic(e,n,l),yr(e,n,l)):(Ce&&r&&wc(n),n.flags|=1,Cn(e,n,t,l),n.child)}function pm(e,n,t,r,l,s){return zl(n),n.updateQueue=null,t=gd(n,r,t,l),_d(e),r=Yc(),e!==null&&!_n?(Ic(e,n,s),yr(e,n,s)):(Ce&&r&&wc(n),n.flags|=1,Cn(e,n,t,s),n.child)}function hm(e,n,t,r,l){if(zl(n),n.stateNode===null){var s=ua,p=t.contextType;typeof p=="object"&&p!==null&&(s=On(p)),s=new t(r,s),n.memoizedState=s.state!==null&&s.state!==void 0?s.state:null,s.updater=lu,n.stateNode=s,s._reactInternals=n,s=n.stateNode,s.props=r,s.state=n.memoizedState,s.refs={},Oc(n),p=t.contextType,s.context=typeof p=="object"&&p!==null?On(p):ua,s.state=n.memoizedState,p=t.getDerivedStateFromProps,typeof p=="function"&&(ru(n,t,p,r),s.state=n.memoizedState),typeof t.getDerivedStateFromProps=="function"||typeof s.getSnapshotBeforeUpdate=="function"||typeof s.UNSAFE_componentWillMount!="function"&&typeof s.componentWillMount!="function"||(p=s.state,typeof s.componentWillMount=="function"&&s.componentWillMount(),typeof s.UNSAFE_componentWillMount=="function"&&s.UNSAFE_componentWillMount(),p!==s.state&&lu.enqueueReplaceState(s,s.state,null),vi(n,r,s,l),yi(),s.state=n.memoizedState),typeof s.componentDidMount=="function"&&(n.flags|=4194308),r=!0}else if(e===null){s=n.stateNode;var g=n.memoizedProps,E=Il(t,g);s.props=E;var A=s.context,V=t.contextType;p=ua,typeof V=="object"&&V!==null&&(p=On(V));var P=t.getDerivedStateFromProps;V=typeof P=="function"||typeof s.getSnapshotBeforeUpdate=="function",g=n.pendingProps!==g,V||typeof s.UNSAFE_componentWillReceiveProps!="function"&&typeof s.componentWillReceiveProps!="function"||(g||A!==p)&&nm(n,s,r,p),$r=!1;var O=n.memoizedState;s.state=O,vi(n,r,s,l),yi(),A=n.memoizedState,g||O!==A||$r?(typeof P=="function"&&(ru(n,t,P,r),A=n.memoizedState),(E=$r||em(n,t,E,r,O,A,p))?(V||typeof s.UNSAFE_componentWillMount!="function"&&typeof s.componentWillMount!="function"||(typeof s.componentWillMount=="function"&&s.componentWillMount(),typeof s.UNSAFE_componentWillMount=="function"&&s.UNSAFE_componentWillMount()),typeof s.componentDidMount=="function"&&(n.flags|=4194308)):(typeof s.componentDidMount=="function"&&(n.flags|=4194308),n.memoizedProps=r,n.memoizedState=A),s.props=r,s.state=A,s.context=p,r=E):(typeof s.componentDidMount=="function"&&(n.flags|=4194308),r=!1)}else{s=n.stateNode,Cc(e,n),p=n.memoizedProps,V=Il(t,p),s.props=V,P=n.pendingProps,O=s.context,A=t.contextType,E=ua,typeof A=="object"&&A!==null&&(E=On(A)),g=t.getDerivedStateFromProps,(A=typeof g=="function"||typeof s.getSnapshotBeforeUpdate=="function")||typeof s.UNSAFE_componentWillReceiveProps!="function"&&typeof s.componentWillReceiveProps!="function"||(p!==P||O!==E)&&nm(n,s,r,E),$r=!1,O=n.memoizedState,s.state=O,vi(n,r,s,l),yi();var U=n.memoizedState;p!==P||O!==U||$r||e!==null&&e.dependencies!==null&&As(e.dependencies)?(typeof g=="function"&&(ru(n,t,g,r),U=n.memoizedState),(V=$r||em(n,t,V,r,O,U,E)||e!==null&&e.dependencies!==null&&As(e.dependencies))?(A||typeof s.UNSAFE_componentWillUpdate!="function"&&typeof s.componentWillUpdate!="function"||(typeof s.componentWillUpdate=="function"&&s.componentWillUpdate(r,U,E),typeof s.UNSAFE_componentWillUpdate=="function"&&s.UNSAFE_componentWillUpdate(r,U,E)),typeof s.componentDidUpdate=="function"&&(n.flags|=4),typeof s.getSnapshotBeforeUpdate=="function"&&(n.flags|=1024)):(typeof s.componentDidUpdate!="function"||p===e.memoizedProps&&O===e.memoizedState||(n.flags|=4),typeof s.getSnapshotBeforeUpdate!="function"||p===e.memoizedProps&&O===e.memoizedState||(n.flags|=1024),n.memoizedProps=r,n.memoizedState=U),s.props=r,s.state=U,s.context=E,r=V):(typeof s.componentDidUpdate!="function"||p===e.memoizedProps&&O===e.memoizedState||(n.flags|=4),typeof s.getSnapshotBeforeUpdate!="function"||p===e.memoizedProps&&O===e.memoizedState||(n.flags|=1024),r=!1)}return s=r,Qs(e,n),r=(n.flags&128)!==0,s||r?(s=n.stateNode,t=r&&typeof t.getDerivedStateFromError!="function"?null:s.render(),n.flags|=1,e!==null&&r?(n.child=Gl(n,e.child,null,l),n.child=Gl(n,null,t,l)):Cn(e,n,t,l),n.memoizedState=s.state,e=n.child):e=yr(e,n,l),e}function _m(e,n,t,r){return Ll(),n.flags|=256,Cn(e,n,t,r),n.child}var ou={dehydrated:null,treeContext:null,retryLane:0,hydrationErrors:null};function cu(e){return{baseLanes:e,cachePool:ad()}}function uu(e,n,t){return e=e!==null?e.childLanes&~t:0,n&&(e|=ht),e}function gm(e,n,t){var r=n.pendingProps,l=!1,s=(n.flags&128)!==0,p;if((p=s)||(p=e!==null&&e.memoizedState===null?!1:(fn.current&2)!==0),p&&(l=!0,n.flags&=-129),p=(n.flags&32)!==0,n.flags&=-33,e===null){if(Ce){if(l?Kr(n):Qr(),(e=Je)?(e=kp(e,Tt),e=e!==null&&e.data!=="&"?e:null,e!==null&&(n.memoizedState={dehydrated:e,treeContext:Yr!==null?{id:Jt,overflow:er}:null,retryLane:536870912,hydrationErrors:null},t=Qf(e),t.return=n,n.child=t,Dn=n,Je=null)):e=null,e===null)throw qr(n);return $u(e)?n.lanes=32:n.lanes=536870912,null}var g=r.children;return r=r.fallback,l?(Qr(),l=n.mode,g=Zs({mode:"hidden",children:g},l),r=Cl(r,l,t,null),g.return=n,r.return=n,g.sibling=r,n.child=g,r=n.child,r.memoizedState=cu(t),r.childLanes=uu(e,p,t),n.memoizedState=ou,ki(null,r)):(Kr(n),fu(n,g))}var E=e.memoizedState;if(E!==null&&(g=E.dehydrated,g!==null)){if(s)n.flags&256?(Kr(n),n.flags&=-257,n=du(e,n,t)):n.memoizedState!==null?(Qr(),n.child=e.child,n.flags|=128,n=null):(Qr(),g=r.fallback,l=n.mode,r=Zs({mode:"visible",children:r.children},l),g=Cl(g,l,t,null),g.flags|=2,r.return=n,g.return=n,r.sibling=g,n.child=r,Gl(n,e.child,null,t),r=n.child,r.memoizedState=cu(t),r.childLanes=uu(e,p,t),n.memoizedState=ou,n=ki(null,r));else if(Kr(n),$u(g)){if(p=g.nextSibling&&g.nextSibling.dataset,p)var A=p.dgst;p=A,r=Error(i(419)),r.stack="",r.digest=p,mi({value:r,source:null,stack:null}),n=du(e,n,t)}else if(_n||pa(e,n,t,!1),p=(t&e.childLanes)!==0,_n||p){if(p=Qe,p!==null&&(r=as(p,t),r!==0&&r!==E.retryLane))throw E.retryLane=r,Ol(e,r),rt(p,e,r),iu;Pu(g)||io(),n=du(e,n,t)}else Pu(g)?(n.flags|=192,n.child=e.child,n=null):(e=E.treeContext,Je=At(g.nextSibling),Dn=n,Ce=!0,Ir=null,Tt=!1,e!==null&&Jf(n,e),n=fu(n,r.children),n.flags|=4096);return n}return l?(Qr(),g=r.fallback,l=n.mode,E=e.child,A=E.sibling,r=mr(E,{mode:"hidden",children:r.children}),r.subtreeFlags=E.subtreeFlags&65011712,A!==null?g=mr(A,g):(g=Cl(g,l,t,null),g.flags|=2),g.return=n,r.return=n,r.sibling=g,n.child=r,ki(null,r),r=n.child,g=e.child.memoizedState,g===null?g=cu(t):(l=g.cachePool,l!==null?(E=pn._currentValue,l=l.parent!==E?{parent:E,pool:E}:l):l=ad(),g={baseLanes:g.baseLanes|t,cachePool:l}),r.memoizedState=g,r.childLanes=uu(e,p,t),n.memoizedState=ou,ki(e.child,r)):(Kr(n),t=e.child,e=t.sibling,t=mr(t,{mode:"visible",children:r.children}),t.return=n,t.sibling=null,e!==null&&(p=n.deletions,p===null?(n.deletions=[e],n.flags|=16):p.push(e)),n.child=t,n.memoizedState=null,t)}function fu(e,n){return n=Zs({mode:"visible",children:n},e.mode),n.return=e,e.child=n}function Zs(e,n){return e=ft(22,e,null,n),e.lanes=0,e}function du(e,n,t){return Gl(n,e.child,null,t),e=fu(n,n.pendingProps.children),e.flags|=2,n.memoizedState=null,e}function bm(e,n,t){e.lanes|=n;var r=e.alternate;r!==null&&(r.lanes|=n),Rc(e.return,n,t)}function mu(e,n,t,r,l,s){var p=e.memoizedState;p===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:r,tail:t,tailMode:l,treeForkCount:s}:(p.isBackwards=n,p.rendering=null,p.renderingStartTime=0,p.last=r,p.tail=t,p.tailMode=l,p.treeForkCount=s)}function ym(e,n,t){var r=n.pendingProps,l=r.revealOrder,s=r.tail;r=r.children;var p=fn.current,g=(p&2)!==0;if(g?(p=p&1|2,n.flags|=128):p&=1,W(fn,p),Cn(e,n,r,t),r=Ce?di:0,!g&&e!==null&&(e.flags&128)!==0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&bm(e,t,n);else if(e.tag===19)bm(e,t,n);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}switch(l){case"forwards":for(t=n.child,l=null;t!==null;)e=t.alternate,e!==null&&Hs(e)===null&&(l=t),t=t.sibling;t=l,t===null?(l=n.child,n.child=null):(l=t.sibling,t.sibling=null),mu(n,!1,l,t,s,r);break;case"backwards":case"unstable_legacy-backwards":for(t=null,l=n.child,n.child=null;l!==null;){if(e=l.alternate,e!==null&&Hs(e)===null){n.child=l;break}e=l.sibling,l.sibling=t,t=l,l=e}mu(n,!0,t,null,s,r);break;case"together":mu(n,!1,null,null,void 0,r);break;default:n.memoizedState=null}return n.child}function yr(e,n,t){if(e!==null&&(n.dependencies=e.dependencies),Jr|=n.lanes,(t&n.childLanes)===0)if(e!==null){if(pa(e,n,t,!1),(t&n.childLanes)===0)return null}else return null;if(e!==null&&n.child!==e.child)throw Error(i(153));if(n.child!==null){for(e=n.child,t=mr(e,e.pendingProps),n.child=t,t.return=n;e.sibling!==null;)e=e.sibling,t=t.sibling=mr(e,e.pendingProps),t.return=n;t.sibling=null}return n.child}function pu(e,n){return(e.lanes&n)!==0?!0:(e=e.dependencies,!!(e!==null&&As(e)))}function I_(e,n,t){switch(n.tag){case 3:Le(n,n.stateNode.containerInfo),Pr(n,pn,e.memoizedState.cache),Ll();break;case 27:case 5:Yn(n);break;case 4:Le(n,n.stateNode.containerInfo);break;case 10:Pr(n,n.type,n.memoizedProps.value);break;case 31:if(n.memoizedState!==null)return n.flags|=128,Hc(n),null;break;case 13:var r=n.memoizedState;if(r!==null)return r.dehydrated!==null?(Kr(n),n.flags|=128,null):(t&n.child.childLanes)!==0?gm(e,n,t):(Kr(n),e=yr(e,n,t),e!==null?e.sibling:null);Kr(n);break;case 19:var l=(e.flags&128)!==0;if(r=(t&n.childLanes)!==0,r||(pa(e,n,t,!1),r=(t&n.childLanes)!==0),l){if(r)return ym(e,n,t);n.flags|=128}if(l=n.memoizedState,l!==null&&(l.rendering=null,l.tail=null,l.lastEffect=null),W(fn,fn.current),r)break;return null;case 22:return n.lanes=0,fm(e,n,t,n.pendingProps);case 24:Pr(n,pn,e.memoizedState.cache)}return yr(e,n,t)}function vm(e,n,t){if(e!==null)if(e.memoizedProps!==n.pendingProps)_n=!0;else{if(!pu(e,t)&&(n.flags&128)===0)return _n=!1,I_(e,n,t);_n=(e.flags&131072)!==0}else _n=!1,Ce&&(n.flags&1048576)!==0&&Wf(n,di,n.index);switch(n.lanes=0,n.tag){case 16:e:{var r=n.pendingProps;if(e=Hl(n.elementType),n.type=e,typeof e=="function")yc(e)?(r=Il(e,r),n.tag=1,n=hm(null,n,e,r,t)):(n.tag=0,n=su(null,n,e,r,t));else{if(e!=null){var l=e.$$typeof;if(l===le){n.tag=11,n=om(null,n,e,r,t);break e}else if(l===ne){n.tag=14,n=cm(null,n,e,r,t);break e}}throw n=Re(e)||e,Error(i(306,n,""))}}return n;case 0:return su(e,n,n.type,n.pendingProps,t);case 1:return r=n.type,l=Il(r,n.pendingProps),hm(e,n,r,l,t);case 3:e:{if(Le(n,n.stateNode.containerInfo),e===null)throw Error(i(387));r=n.pendingProps;var s=n.memoizedState;l=s.element,Cc(e,n),vi(n,r,null,t);var p=n.memoizedState;if(r=p.cache,Pr(n,pn,r),r!==s.cache&&Mc(n,[pn],t,!0),yi(),r=p.element,s.isDehydrated)if(s={element:r,isDehydrated:!1,cache:p.cache},n.updateQueue.baseState=s,n.memoizedState=s,n.flags&256){n=_m(e,n,r,t);break e}else if(r!==l){l=Nt(Error(i(424)),n),mi(l),n=_m(e,n,r,t);break e}else{switch(e=n.stateNode.containerInfo,e.nodeType){case 9:e=e.body;break;default:e=e.nodeName==="HTML"?e.ownerDocument.body:e}for(Je=At(e.firstChild),Dn=n,Ce=!0,Ir=null,Tt=!0,t=fd(n,null,r,t),n.child=t;t;)t.flags=t.flags&-3|4096,t=t.sibling}else{if(Ll(),r===l){n=yr(e,n,t);break e}Cn(e,n,r,t)}n=n.child}return n;case 26:return Qs(e,n),e===null?(t=Ap(n.type,null,n.pendingProps,null))?n.memoizedState=t:Ce||(t=n.type,e=n.pendingProps,r=po(Q.current).createElement(t),r[cn]=n,r[un]=e,Ln(r,t,e),Ze(r),n.stateNode=r):n.memoizedState=Ap(n.type,e.memoizedProps,n.pendingProps,e.memoizedState),null;case 27:return Yn(n),e===null&&Ce&&(r=n.stateNode=Mp(n.type,n.pendingProps,Q.current),Dn=n,Tt=!0,l=Je,ll(n.type)?(Xu=l,Je=At(r.firstChild)):Je=l),Cn(e,n,n.pendingProps.children,t),Qs(e,n),e===null&&(n.flags|=4194304),n.child;case 5:return e===null&&Ce&&((l=r=Je)&&(r=yg(r,n.type,n.pendingProps,Tt),r!==null?(n.stateNode=r,Dn=n,Je=At(r.firstChild),Tt=!1,l=!0):l=!1),l||qr(n)),Yn(n),l=n.type,s=n.pendingProps,p=e!==null?e.memoizedProps:null,r=s.children,Yu(l,s)?r=null:p!==null&&Yu(l,p)&&(n.flags|=32),n.memoizedState!==null&&(l=Gc(e,n,C_,null,null,t),Vi._currentValue=l),Qs(e,n),Cn(e,n,r,t),n.child;case 6:return e===null&&Ce&&((e=t=Je)&&(t=vg(t,n.pendingProps,Tt),t!==null?(n.stateNode=t,Dn=n,Je=null,e=!0):e=!1),e||qr(n)),null;case 13:return gm(e,n,t);case 4:return Le(n,n.stateNode.containerInfo),r=n.pendingProps,e===null?n.child=Gl(n,null,r,t):Cn(e,n,r,t),n.child;case 11:return om(e,n,n.type,n.pendingProps,t);case 7:return Cn(e,n,n.pendingProps,t),n.child;case 8:return Cn(e,n,n.pendingProps.children,t),n.child;case 12:return Cn(e,n,n.pendingProps.children,t),n.child;case 10:return r=n.pendingProps,Pr(n,n.type,r.value),Cn(e,n,r.children,t),n.child;case 9:return l=n.type._context,r=n.pendingProps.children,zl(n),l=On(l),r=r(l),n.flags|=1,Cn(e,n,r,t),n.child;case 14:return cm(e,n,n.type,n.pendingProps,t);case 15:return um(e,n,n.type,n.pendingProps,t);case 19:return ym(e,n,t);case 31:return Y_(e,n,t);case 22:return fm(e,n,t,n.pendingProps);case 24:return zl(n),r=On(pn),e===null?(l=Ac(),l===null&&(l=Qe,s=Tc(),l.pooledCache=s,s.refCount++,s!==null&&(l.pooledCacheLanes|=t),l=s),n.memoizedState={parent:r,cache:l},Oc(n),Pr(n,pn,l)):((e.lanes&t)!==0&&(Cc(e,n),vi(n,null,null,t),yi()),l=e.memoizedState,s=n.memoizedState,l.parent!==r?(l={parent:r,cache:r},n.memoizedState=l,n.lanes===0&&(n.memoizedState=n.updateQueue.baseState=l),Pr(n,pn,r)):(r=s.cache,Pr(n,pn,r),r!==l.cache&&Mc(n,[pn],t,!0))),Cn(e,n,n.pendingProps.children,t),n.child;case 29:throw n.pendingProps}throw Error(i(156,n.tag))}function vr(e){e.flags|=4}function hu(e,n,t,r,l){if((n=(e.mode&32)!==0)&&(n=!1),n){if(e.flags|=16777216,(l&335544128)===l)if(e.stateNode.complete)e.flags|=8192;else if(Xm())e.flags|=8192;else throw Vl=Ls,Dc}else e.flags&=-16777217}function xm(e,n){if(n.type!=="stylesheet"||(n.state.loading&4)!==0)e.flags&=-16777217;else if(e.flags|=16777216,!Bp(n))if(Xm())e.flags|=8192;else throw Vl=Ls,Dc}function Ws(e,n){n!==null&&(e.flags|=4),e.flags&16384&&(n=e.tag!==22?$a():536870912,e.lanes|=n,Na|=n)}function Ni(e,n){if(!Ce)switch(e.tailMode){case"hidden":n=e.tail;for(var t=null;n!==null;)n.alternate!==null&&(t=n),n=n.sibling;t===null?e.tail=null:t.sibling=null;break;case"collapsed":t=e.tail;for(var r=null;t!==null;)t.alternate!==null&&(r=t),t=t.sibling;r===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:r.sibling=null}}function en(e){var n=e.alternate!==null&&e.alternate.child===e.child,t=0,r=0;if(n)for(var l=e.child;l!==null;)t|=l.lanes|l.childLanes,r|=l.subtreeFlags&65011712,r|=l.flags&65011712,l.return=e,l=l.sibling;else for(l=e.child;l!==null;)t|=l.lanes|l.childLanes,r|=l.subtreeFlags,r|=l.flags,l.return=e,l=l.sibling;return e.subtreeFlags|=r,e.childLanes=t,n}function q_(e,n,t){var r=n.pendingProps;switch(Sc(n),n.tag){case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return en(n),null;case 1:return en(n),null;case 3:return t=n.stateNode,r=null,e!==null&&(r=e.memoizedState.cache),n.memoizedState.cache!==r&&(n.flags|=2048),_r(pn),je(),t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(ma(n)?vr(n):e===null||e.memoizedState.isDehydrated&&(n.flags&256)===0||(n.flags|=1024,kc())),en(n),null;case 26:var l=n.type,s=n.memoizedState;return e===null?(vr(n),s!==null?(en(n),xm(n,s)):(en(n),hu(n,l,null,r,t))):s?s!==e.memoizedState?(vr(n),en(n),xm(n,s)):(en(n),n.flags&=-16777217):(e=e.memoizedProps,e!==r&&vr(n),en(n),hu(n,l,e,r,t)),null;case 27:if(Pt(n),t=Q.current,l=n.type,e!==null&&n.stateNode!=null)e.memoizedProps!==r&&vr(n);else{if(!r){if(n.stateNode===null)throw Error(i(166));return en(n),null}e=T.current,ma(n)?ed(n):(e=Mp(l,r,t),n.stateNode=e,vr(n))}return en(n),null;case 5:if(Pt(n),l=n.type,e!==null&&n.stateNode!=null)e.memoizedProps!==r&&vr(n);else{if(!r){if(n.stateNode===null)throw Error(i(166));return en(n),null}if(s=T.current,ma(n))ed(n);else{var p=po(Q.current);switch(s){case 1:s=p.createElementNS("http://www.w3.org/2000/svg",l);break;case 2:s=p.createElementNS("http://www.w3.org/1998/Math/MathML",l);break;default:switch(l){case"svg":s=p.createElementNS("http://www.w3.org/2000/svg",l);break;case"math":s=p.createElementNS("http://www.w3.org/1998/Math/MathML",l);break;case"script":s=p.createElement("div"),s.innerHTML="<script><\/script>",s=s.removeChild(s.firstChild);break;case"select":s=typeof r.is=="string"?p.createElement("select",{is:r.is}):p.createElement("select"),r.multiple?s.multiple=!0:r.size&&(s.size=r.size);break;default:s=typeof r.is=="string"?p.createElement(l,{is:r.is}):p.createElement(l)}}s[cn]=n,s[un]=r;e:for(p=n.child;p!==null;){if(p.tag===5||p.tag===6)s.appendChild(p.stateNode);else if(p.tag!==4&&p.tag!==27&&p.child!==null){p.child.return=p,p=p.child;continue}if(p===n)break e;for(;p.sibling===null;){if(p.return===null||p.return===n)break e;p=p.return}p.sibling.return=p.return,p=p.sibling}n.stateNode=s;e:switch(Ln(s,l,r),l){case"button":case"input":case"select":case"textarea":r=!!r.autoFocus;break e;case"img":r=!0;break e;default:r=!1}r&&vr(n)}}return en(n),hu(n,n.type,e===null?null:e.memoizedProps,n.pendingProps,t),null;case 6:if(e&&n.stateNode!=null)e.memoizedProps!==r&&vr(n);else{if(typeof r!="string"&&n.stateNode===null)throw Error(i(166));if(e=Q.current,ma(n)){if(e=n.stateNode,t=n.memoizedProps,r=null,l=Dn,l!==null)switch(l.tag){case 27:case 5:r=l.memoizedProps}e[cn]=n,e=!!(e.nodeValue===t||r!==null&&r.suppressHydrationWarning===!0||gp(e.nodeValue,t)),e||qr(n,!0)}else e=po(e).createTextNode(r),e[cn]=n,n.stateNode=e}return en(n),null;case 31:if(t=n.memoizedState,e===null||e.memoizedState!==null){if(r=ma(n),t!==null){if(e===null){if(!r)throw Error(i(318));if(e=n.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(i(557));e[cn]=n}else Ll(),(n.flags&128)===0&&(n.memoizedState=null),n.flags|=4;en(n),e=!1}else t=kc(),e!==null&&e.memoizedState!==null&&(e.memoizedState.hydrationErrors=t),e=!0;if(!e)return n.flags&256?(mt(n),n):(mt(n),null);if((n.flags&128)!==0)throw Error(i(558))}return en(n),null;case 13:if(r=n.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(l=ma(n),r!==null&&r.dehydrated!==null){if(e===null){if(!l)throw Error(i(318));if(l=n.memoizedState,l=l!==null?l.dehydrated:null,!l)throw Error(i(317));l[cn]=n}else Ll(),(n.flags&128)===0&&(n.memoizedState=null),n.flags|=4;en(n),l=!1}else l=kc(),e!==null&&e.memoizedState!==null&&(e.memoizedState.hydrationErrors=l),l=!0;if(!l)return n.flags&256?(mt(n),n):(mt(n),null)}return mt(n),(n.flags&128)!==0?(n.lanes=t,n):(t=r!==null,e=e!==null&&e.memoizedState!==null,t&&(r=n.child,l=null,r.alternate!==null&&r.alternate.memoizedState!==null&&r.alternate.memoizedState.cachePool!==null&&(l=r.alternate.memoizedState.cachePool.pool),s=null,r.memoizedState!==null&&r.memoizedState.cachePool!==null&&(s=r.memoizedState.cachePool.pool),s!==l&&(r.flags|=2048)),t!==e&&t&&(n.child.flags|=8192),Ws(n,n.updateQueue),en(n),null);case 4:return je(),e===null&&zu(n.stateNode.containerInfo),en(n),null;case 10:return _r(n.type),en(n),null;case 19:if(B(fn),r=n.memoizedState,r===null)return en(n),null;if(l=(n.flags&128)!==0,s=r.rendering,s===null)if(l)Ni(r,!1);else{if(sn!==0||e!==null&&(e.flags&128)!==0)for(e=n.child;e!==null;){if(s=Hs(e),s!==null){for(n.flags|=128,Ni(r,!1),e=s.updateQueue,n.updateQueue=e,Ws(n,e),n.subtreeFlags=0,e=t,t=n.child;t!==null;)Kf(t,e),t=t.sibling;return W(fn,fn.current&1|2),Ce&&pr(n,r.treeForkCount),n.child}e=e.sibling}r.tail!==null&&yn()>ro&&(n.flags|=128,l=!0,Ni(r,!1),n.lanes=4194304)}else{if(!l)if(e=Hs(s),e!==null){if(n.flags|=128,l=!0,e=e.updateQueue,n.updateQueue=e,Ws(n,e),Ni(r,!0),r.tail===null&&r.tailMode==="hidden"&&!s.alternate&&!Ce)return en(n),null}else 2*yn()-r.renderingStartTime>ro&&t!==536870912&&(n.flags|=128,l=!0,Ni(r,!1),n.lanes=4194304);r.isBackwards?(s.sibling=n.child,n.child=s):(e=r.last,e!==null?e.sibling=s:n.child=s,r.last=s)}return r.tail!==null?(e=r.tail,r.rendering=e,r.tail=e.sibling,r.renderingStartTime=yn(),e.sibling=null,t=fn.current,W(fn,l?t&1|2:t&1),Ce&&pr(n,r.treeForkCount),e):(en(n),null);case 22:case 23:return mt(n),Uc(),r=n.memoizedState!==null,e!==null?e.memoizedState!==null!==r&&(n.flags|=8192):r&&(n.flags|=8192),r?(t&536870912)!==0&&(n.flags&128)===0&&(en(n),n.subtreeFlags&6&&(n.flags|=8192)):en(n),t=n.updateQueue,t!==null&&Ws(n,t.retryQueue),t=null,e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(t=e.memoizedState.cachePool.pool),r=null,n.memoizedState!==null&&n.memoizedState.cachePool!==null&&(r=n.memoizedState.cachePool.pool),r!==t&&(n.flags|=2048),e!==null&&B(Ul),null;case 24:return t=null,e!==null&&(t=e.memoizedState.cache),n.memoizedState.cache!==t&&(n.flags|=2048),_r(pn),en(n),null;case 25:return null;case 30:return null}throw Error(i(156,n.tag))}function P_(e,n){switch(Sc(n),n.tag){case 1:return e=n.flags,e&65536?(n.flags=e&-65537|128,n):null;case 3:return _r(pn),je(),e=n.flags,(e&65536)!==0&&(e&128)===0?(n.flags=e&-65537|128,n):null;case 26:case 27:case 5:return Pt(n),null;case 31:if(n.memoizedState!==null){if(mt(n),n.alternate===null)throw Error(i(340));Ll()}return e=n.flags,e&65536?(n.flags=e&-65537|128,n):null;case 13:if(mt(n),e=n.memoizedState,e!==null&&e.dehydrated!==null){if(n.alternate===null)throw Error(i(340));Ll()}return e=n.flags,e&65536?(n.flags=e&-65537|128,n):null;case 19:return B(fn),null;case 4:return je(),null;case 10:return _r(n.type),null;case 22:case 23:return mt(n),Uc(),e!==null&&B(Ul),e=n.flags,e&65536?(n.flags=e&-65537|128,n):null;case 24:return _r(pn),null;case 25:return null;default:return null}}function wm(e,n){switch(Sc(n),n.tag){case 3:_r(pn),je();break;case 26:case 27:case 5:Pt(n);break;case 4:je();break;case 31:n.memoizedState!==null&&mt(n);break;case 13:mt(n);break;case 19:B(fn);break;case 10:_r(n.type);break;case 22:case 23:mt(n),Uc(),e!==null&&B(Ul);break;case 24:_r(pn)}}function Ri(e,n){try{var t=n.updateQueue,r=t!==null?t.lastEffect:null;if(r!==null){var l=r.next;t=l;do{if((t.tag&e)===e){r=void 0;var s=t.create,p=t.inst;r=s(),p.destroy=r}t=t.next}while(t!==l)}}catch(g){qe(n,n.return,g)}}function Zr(e,n,t){try{var r=n.updateQueue,l=r!==null?r.lastEffect:null;if(l!==null){var s=l.next;r=s;do{if((r.tag&e)===e){var p=r.inst,g=p.destroy;if(g!==void 0){p.destroy=void 0,l=n;var E=t,A=g;try{A()}catch(V){qe(l,E,V)}}}r=r.next}while(r!==s)}}catch(V){qe(n,n.return,V)}}function Sm(e){var n=e.updateQueue;if(n!==null){var t=e.stateNode;try{md(n,t)}catch(r){qe(e,e.return,r)}}}function Em(e,n,t){t.props=Il(e.type,e.memoizedProps),t.state=e.memoizedState;try{t.componentWillUnmount()}catch(r){qe(e,n,r)}}function Mi(e,n){try{var t=e.ref;if(t!==null){switch(e.tag){case 26:case 27:case 5:var r=e.stateNode;break;case 30:r=e.stateNode;break;default:r=e.stateNode}typeof t=="function"?e.refCleanup=t(r):t.current=r}}catch(l){qe(e,n,l)}}function nr(e,n){var t=e.ref,r=e.refCleanup;if(t!==null)if(typeof r=="function")try{r()}catch(l){qe(e,n,l)}finally{e.refCleanup=null,e=e.alternate,e!=null&&(e.refCleanup=null)}else if(typeof t=="function")try{t(null)}catch(l){qe(e,n,l)}else t.current=null}function km(e){var n=e.type,t=e.memoizedProps,r=e.stateNode;try{e:switch(n){case"button":case"input":case"select":case"textarea":t.autoFocus&&r.focus();break e;case"img":t.src?r.src=t.src:t.srcSet&&(r.srcset=t.srcSet)}}catch(l){qe(e,e.return,l)}}function _u(e,n,t){try{var r=e.stateNode;mg(r,e.type,t,n),r[un]=n}catch(l){qe(e,e.return,l)}}function Nm(e){return e.tag===5||e.tag===3||e.tag===26||e.tag===27&&ll(e.type)||e.tag===4}function gu(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||Nm(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.tag===27&&ll(e.type)||e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function bu(e,n,t){var r=e.tag;if(r===5||r===6)e=e.stateNode,n?(t.nodeType===9?t.body:t.nodeName==="HTML"?t.ownerDocument.body:t).insertBefore(e,n):(n=t.nodeType===9?t.body:t.nodeName==="HTML"?t.ownerDocument.body:t,n.appendChild(e),t=t._reactRootContainer,t!=null||n.onclick!==null||(n.onclick=tn));else if(r!==4&&(r===27&&ll(e.type)&&(t=e.stateNode,n=null),e=e.child,e!==null))for(bu(e,n,t),e=e.sibling;e!==null;)bu(e,n,t),e=e.sibling}function Js(e,n,t){var r=e.tag;if(r===5||r===6)e=e.stateNode,n?t.insertBefore(e,n):t.appendChild(e);else if(r!==4&&(r===27&&ll(e.type)&&(t=e.stateNode),e=e.child,e!==null))for(Js(e,n,t),e=e.sibling;e!==null;)Js(e,n,t),e=e.sibling}function Rm(e){var n=e.stateNode,t=e.memoizedProps;try{for(var r=e.type,l=n.attributes;l.length;)n.removeAttributeNode(l[0]);Ln(n,r,t),n[cn]=e,n[un]=t}catch(s){qe(e,e.return,s)}}var xr=!1,gn=!1,yu=!1,Mm=typeof WeakSet=="function"?WeakSet:Set,Nn=null;function $_(e,n){if(e=e.containerInfo,Vu=xo,e=ui(e),dc(e)){if("selectionStart"in e)var t={start:e.selectionStart,end:e.selectionEnd};else e:{t=(t=e.ownerDocument)&&t.defaultView||window;var r=t.getSelection&&t.getSelection();if(r&&r.rangeCount!==0){t=r.anchorNode;var l=r.anchorOffset,s=r.focusNode;r=r.focusOffset;try{t.nodeType,s.nodeType}catch{t=null;break e}var p=0,g=-1,E=-1,A=0,V=0,P=e,O=null;n:for(;;){for(var U;P!==t||l!==0&&P.nodeType!==3||(g=p+l),P!==s||r!==0&&P.nodeType!==3||(E=p+r),P.nodeType===3&&(p+=P.nodeValue.length),(U=P.firstChild)!==null;)O=P,P=U;for(;;){if(P===e)break n;if(O===t&&++A===l&&(g=p),O===s&&++V===r&&(E=p),(U=P.nextSibling)!==null)break;P=O,O=P.parentNode}P=U}t=g===-1||E===-1?null:{start:g,end:E}}else t=null}t=t||{start:0,end:0}}else t=null;for(Gu={focusedElem:e,selectionRange:t},xo=!1,Nn=n;Nn!==null;)if(n=Nn,e=n.child,(n.subtreeFlags&1028)!==0&&e!==null)e.return=n,Nn=e;else for(;Nn!==null;){switch(n=Nn,s=n.alternate,e=n.flags,n.tag){case 0:if((e&4)!==0&&(e=n.updateQueue,e=e!==null?e.events:null,e!==null))for(t=0;t<e.length;t++)l=e[t],l.ref.impl=l.nextImpl;break;case 11:case 15:break;case 1:if((e&1024)!==0&&s!==null){e=void 0,t=n,l=s.memoizedProps,s=s.memoizedState,r=t.stateNode;try{var ce=Il(t.type,l);e=r.getSnapshotBeforeUpdate(ce,s),r.__reactInternalSnapshotBeforeUpdate=e}catch(_e){qe(t,t.return,_e)}}break;case 3:if((e&1024)!==0){if(e=n.stateNode.containerInfo,t=e.nodeType,t===9)qu(e);else if(t===1)switch(e.nodeName){case"HEAD":case"HTML":case"BODY":qu(e);break;default:e.textContent=""}}break;case 5:case 26:case 27:case 6:case 4:case 17:break;default:if((e&1024)!==0)throw Error(i(163))}if(e=n.sibling,e!==null){e.return=n.return,Nn=e;break}Nn=n.return}}function Tm(e,n,t){var r=t.flags;switch(t.tag){case 0:case 11:case 15:Sr(e,t),r&4&&Ri(5,t);break;case 1:if(Sr(e,t),r&4)if(e=t.stateNode,n===null)try{e.componentDidMount()}catch(p){qe(t,t.return,p)}else{var l=Il(t.type,n.memoizedProps);n=n.memoizedState;try{e.componentDidUpdate(l,n,e.__reactInternalSnapshotBeforeUpdate)}catch(p){qe(t,t.return,p)}}r&64&&Sm(t),r&512&&Mi(t,t.return);break;case 3:if(Sr(e,t),r&64&&(e=t.updateQueue,e!==null)){if(n=null,t.child!==null)switch(t.child.tag){case 27:case 5:n=t.child.stateNode;break;case 1:n=t.child.stateNode}try{md(e,n)}catch(p){qe(t,t.return,p)}}break;case 27:n===null&&r&4&&Rm(t);case 26:case 5:Sr(e,t),n===null&&r&4&&km(t),r&512&&Mi(t,t.return);break;case 12:Sr(e,t);break;case 31:Sr(e,t),r&4&&Dm(e,t);break;case 13:Sr(e,t),r&4&&Om(e,t),r&64&&(e=t.memoizedState,e!==null&&(e=e.dehydrated,e!==null&&(t=ng.bind(null,t),xg(e,t))));break;case 22:if(r=t.memoizedState!==null||xr,!r){n=n!==null&&n.memoizedState!==null||gn,l=xr;var s=gn;xr=r,(gn=n)&&!s?Er(e,t,(t.subtreeFlags&8772)!==0):Sr(e,t),xr=l,gn=s}break;case 30:break;default:Sr(e,t)}}function jm(e){var n=e.alternate;n!==null&&(e.alternate=null,jm(n)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(n=e.stateNode,n!==null&&Vt(n)),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}var ln=null,Jn=!1;function wr(e,n,t){for(t=t.child;t!==null;)Am(e,n,t),t=t.sibling}function Am(e,n,t){if(vn&&typeof vn.onCommitFiberUnmount=="function")try{vn.onCommitFiberUnmount(hl,t)}catch{}switch(t.tag){case 26:gn||nr(t,n),wr(e,n,t),t.memoizedState?t.memoizedState.count--:t.stateNode&&(t=t.stateNode,t.parentNode.removeChild(t));break;case 27:gn||nr(t,n);var r=ln,l=Jn;ll(t.type)&&(ln=t.stateNode,Jn=!1),wr(e,n,t),zi(t.stateNode),ln=r,Jn=l;break;case 5:gn||nr(t,n);case 6:if(r=ln,l=Jn,ln=null,wr(e,n,t),ln=r,Jn=l,ln!==null)if(Jn)try{(ln.nodeType===9?ln.body:ln.nodeName==="HTML"?ln.ownerDocument.body:ln).removeChild(t.stateNode)}catch(s){qe(t,n,s)}else try{ln.removeChild(t.stateNode)}catch(s){qe(t,n,s)}break;case 18:ln!==null&&(Jn?(e=ln,Sp(e.nodeType===9?e.body:e.nodeName==="HTML"?e.ownerDocument.body:e,t.stateNode),Ca(e)):Sp(ln,t.stateNode));break;case 4:r=ln,l=Jn,ln=t.stateNode.containerInfo,Jn=!0,wr(e,n,t),ln=r,Jn=l;break;case 0:case 11:case 14:case 15:Zr(2,t,n),gn||Zr(4,t,n),wr(e,n,t);break;case 1:gn||(nr(t,n),r=t.stateNode,typeof r.componentWillUnmount=="function"&&Em(t,n,r)),wr(e,n,t);break;case 21:wr(e,n,t);break;case 22:gn=(r=gn)||t.memoizedState!==null,wr(e,n,t),gn=r;break;default:wr(e,n,t)}}function Dm(e,n){if(n.memoizedState===null&&(e=n.alternate,e!==null&&(e=e.memoizedState,e!==null))){e=e.dehydrated;try{Ca(e)}catch(t){qe(n,n.return,t)}}}function Om(e,n){if(n.memoizedState===null&&(e=n.alternate,e!==null&&(e=e.memoizedState,e!==null&&(e=e.dehydrated,e!==null))))try{Ca(e)}catch(t){qe(n,n.return,t)}}function X_(e){switch(e.tag){case 31:case 13:case 19:var n=e.stateNode;return n===null&&(n=e.stateNode=new Mm),n;case 22:return e=e.stateNode,n=e._retryCache,n===null&&(n=e._retryCache=new Mm),n;default:throw Error(i(435,e.tag))}}function eo(e,n){var t=X_(e);n.forEach(function(r){if(!t.has(r)){t.add(r);var l=tg.bind(null,e,r);r.then(l,l)}})}function et(e,n){var t=n.deletions;if(t!==null)for(var r=0;r<t.length;r++){var l=t[r],s=e,p=n,g=p;e:for(;g!==null;){switch(g.tag){case 27:if(ll(g.type)){ln=g.stateNode,Jn=!1;break e}break;case 5:ln=g.stateNode,Jn=!1;break e;case 3:case 4:ln=g.stateNode.containerInfo,Jn=!0;break e}g=g.return}if(ln===null)throw Error(i(160));Am(s,p,l),ln=null,Jn=!1,s=l.alternate,s!==null&&(s.return=null),l.return=null}if(n.subtreeFlags&13886)for(n=n.child;n!==null;)Cm(n,e),n=n.sibling}var It=null;function Cm(e,n){var t=e.alternate,r=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:et(n,e),nt(e),r&4&&(Zr(3,e,e.return),Ri(3,e),Zr(5,e,e.return));break;case 1:et(n,e),nt(e),r&512&&(gn||t===null||nr(t,t.return)),r&64&&xr&&(e=e.updateQueue,e!==null&&(r=e.callbacks,r!==null&&(t=e.shared.hiddenCallbacks,e.shared.hiddenCallbacks=t===null?r:t.concat(r))));break;case 26:var l=It;if(et(n,e),nt(e),r&512&&(gn||t===null||nr(t,t.return)),r&4){var s=t!==null?t.memoizedState:null;if(r=e.memoizedState,t===null)if(r===null)if(e.stateNode===null){e:{r=e.type,t=e.memoizedProps,l=l.ownerDocument||l;n:switch(r){case"title":s=l.getElementsByTagName("title")[0],(!s||s[Ht]||s[cn]||s.namespaceURI==="http://www.w3.org/2000/svg"||s.hasAttribute("itemprop"))&&(s=l.createElement(r),l.head.insertBefore(s,l.querySelector("head > title"))),Ln(s,r,t),s[cn]=e,Ze(s),r=s;break e;case"link":var p=Cp("link","href",l).get(r+(t.href||""));if(p){for(var g=0;g<p.length;g++)if(s=p[g],s.getAttribute("href")===(t.href==null||t.href===""?null:t.href)&&s.getAttribute("rel")===(t.rel==null?null:t.rel)&&s.getAttribute("title")===(t.title==null?null:t.title)&&s.getAttribute("crossorigin")===(t.crossOrigin==null?null:t.crossOrigin)){p.splice(g,1);break n}}s=l.createElement(r),Ln(s,r,t),l.head.appendChild(s);break;case"meta":if(p=Cp("meta","content",l).get(r+(t.content||""))){for(g=0;g<p.length;g++)if(s=p[g],s.getAttribute("content")===(t.content==null?null:""+t.content)&&s.getAttribute("name")===(t.name==null?null:t.name)&&s.getAttribute("property")===(t.property==null?null:t.property)&&s.getAttribute("http-equiv")===(t.httpEquiv==null?null:t.httpEquiv)&&s.getAttribute("charset")===(t.charSet==null?null:t.charSet)){p.splice(g,1);break n}}s=l.createElement(r),Ln(s,r,t),l.head.appendChild(s);break;default:throw Error(i(468,r))}s[cn]=e,Ze(s),r=s}e.stateNode=r}else Lp(l,e.type,e.stateNode);else e.stateNode=Op(l,r,e.memoizedProps);else s!==r?(s===null?t.stateNode!==null&&(t=t.stateNode,t.parentNode.removeChild(t)):s.count--,r===null?Lp(l,e.type,e.stateNode):Op(l,r,e.memoizedProps)):r===null&&e.stateNode!==null&&_u(e,e.memoizedProps,t.memoizedProps)}break;case 27:et(n,e),nt(e),r&512&&(gn||t===null||nr(t,t.return)),t!==null&&r&4&&_u(e,e.memoizedProps,t.memoizedProps);break;case 5:if(et(n,e),nt(e),r&512&&(gn||t===null||nr(t,t.return)),e.flags&32){l=e.stateNode;try{nn(l,"")}catch(ce){qe(e,e.return,ce)}}r&4&&e.stateNode!=null&&(l=e.memoizedProps,_u(e,l,t!==null?t.memoizedProps:l)),r&1024&&(yu=!0);break;case 6:if(et(n,e),nt(e),r&4){if(e.stateNode===null)throw Error(i(162));r=e.memoizedProps,t=e.stateNode;try{t.nodeValue=r}catch(ce){qe(e,e.return,ce)}}break;case 3:if(go=null,l=It,It=ho(n.containerInfo),et(n,e),It=l,nt(e),r&4&&t!==null&&t.memoizedState.isDehydrated)try{Ca(n.containerInfo)}catch(ce){qe(e,e.return,ce)}yu&&(yu=!1,Lm(e));break;case 4:r=It,It=ho(e.stateNode.containerInfo),et(n,e),nt(e),It=r;break;case 12:et(n,e),nt(e);break;case 31:et(n,e),nt(e),r&4&&(r=e.updateQueue,r!==null&&(e.updateQueue=null,eo(e,r)));break;case 13:et(n,e),nt(e),e.child.flags&8192&&e.memoizedState!==null!=(t!==null&&t.memoizedState!==null)&&(to=yn()),r&4&&(r=e.updateQueue,r!==null&&(e.updateQueue=null,eo(e,r)));break;case 22:l=e.memoizedState!==null;var E=t!==null&&t.memoizedState!==null,A=xr,V=gn;if(xr=A||l,gn=V||E,et(n,e),gn=V,xr=A,nt(e),r&8192)e:for(n=e.stateNode,n._visibility=l?n._visibility&-2:n._visibility|1,l&&(t===null||E||xr||gn||ql(e)),t=null,n=e;;){if(n.tag===5||n.tag===26){if(t===null){E=t=n;try{if(s=E.stateNode,l)p=s.style,typeof p.setProperty=="function"?p.setProperty("display","none","important"):p.display="none";else{g=E.stateNode;var P=E.memoizedProps.style,O=P!=null&&P.hasOwnProperty("display")?P.display:null;g.style.display=O==null||typeof O=="boolean"?"":(""+O).trim()}}catch(ce){qe(E,E.return,ce)}}}else if(n.tag===6){if(t===null){E=n;try{E.stateNode.nodeValue=l?"":E.memoizedProps}catch(ce){qe(E,E.return,ce)}}}else if(n.tag===18){if(t===null){E=n;try{var U=E.stateNode;l?Ep(U,!0):Ep(E.stateNode,!1)}catch(ce){qe(E,E.return,ce)}}}else if((n.tag!==22&&n.tag!==23||n.memoizedState===null||n===e)&&n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break e;for(;n.sibling===null;){if(n.return===null||n.return===e)break e;t===n&&(t=null),n=n.return}t===n&&(t=null),n.sibling.return=n.return,n=n.sibling}r&4&&(r=e.updateQueue,r!==null&&(t=r.retryQueue,t!==null&&(r.retryQueue=null,eo(e,t))));break;case 19:et(n,e),nt(e),r&4&&(r=e.updateQueue,r!==null&&(e.updateQueue=null,eo(e,r)));break;case 30:break;case 21:break;default:et(n,e),nt(e)}}function nt(e){var n=e.flags;if(n&2){try{for(var t,r=e.return;r!==null;){if(Nm(r)){t=r;break}r=r.return}if(t==null)throw Error(i(160));switch(t.tag){case 27:var l=t.stateNode,s=gu(e);Js(e,s,l);break;case 5:var p=t.stateNode;t.flags&32&&(nn(p,""),t.flags&=-33);var g=gu(e);Js(e,g,p);break;case 3:case 4:var E=t.stateNode.containerInfo,A=gu(e);bu(e,A,E);break;default:throw Error(i(161))}}catch(V){qe(e,e.return,V)}e.flags&=-3}n&4096&&(e.flags&=-4097)}function Lm(e){if(e.subtreeFlags&1024)for(e=e.child;e!==null;){var n=e;Lm(n),n.tag===5&&n.flags&1024&&n.stateNode.reset(),e=e.sibling}}function Sr(e,n){if(n.subtreeFlags&8772)for(n=n.child;n!==null;)Tm(e,n.alternate,n),n=n.sibling}function ql(e){for(e=e.child;e!==null;){var n=e;switch(n.tag){case 0:case 11:case 14:case 15:Zr(4,n,n.return),ql(n);break;case 1:nr(n,n.return);var t=n.stateNode;typeof t.componentWillUnmount=="function"&&Em(n,n.return,t),ql(n);break;case 27:zi(n.stateNode);case 26:case 5:nr(n,n.return),ql(n);break;case 22:n.memoizedState===null&&ql(n);break;case 30:ql(n);break;default:ql(n)}e=e.sibling}}function Er(e,n,t){for(t=t&&(n.subtreeFlags&8772)!==0,n=n.child;n!==null;){var r=n.alternate,l=e,s=n,p=s.flags;switch(s.tag){case 0:case 11:case 15:Er(l,s,t),Ri(4,s);break;case 1:if(Er(l,s,t),r=s,l=r.stateNode,typeof l.componentDidMount=="function")try{l.componentDidMount()}catch(A){qe(r,r.return,A)}if(r=s,l=r.updateQueue,l!==null){var g=r.stateNode;try{var E=l.shared.hiddenCallbacks;if(E!==null)for(l.shared.hiddenCallbacks=null,l=0;l<E.length;l++)dd(E[l],g)}catch(A){qe(r,r.return,A)}}t&&p&64&&Sm(s),Mi(s,s.return);break;case 27:Rm(s);case 26:case 5:Er(l,s,t),t&&r===null&&p&4&&km(s),Mi(s,s.return);break;case 12:Er(l,s,t);break;case 31:Er(l,s,t),t&&p&4&&Dm(l,s);break;case 13:Er(l,s,t),t&&p&4&&Om(l,s);break;case 22:s.memoizedState===null&&Er(l,s,t),Mi(s,s.return);break;case 30:break;default:Er(l,s,t)}n=n.sibling}}function vu(e,n){var t=null;e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(t=e.memoizedState.cachePool.pool),e=null,n.memoizedState!==null&&n.memoizedState.cachePool!==null&&(e=n.memoizedState.cachePool.pool),e!==t&&(e!=null&&e.refCount++,t!=null&&pi(t))}function xu(e,n){e=null,n.alternate!==null&&(e=n.alternate.memoizedState.cache),n=n.memoizedState.cache,n!==e&&(n.refCount++,e!=null&&pi(e))}function qt(e,n,t,r){if(n.subtreeFlags&10256)for(n=n.child;n!==null;)Bm(e,n,t,r),n=n.sibling}function Bm(e,n,t,r){var l=n.flags;switch(n.tag){case 0:case 11:case 15:qt(e,n,t,r),l&2048&&Ri(9,n);break;case 1:qt(e,n,t,r);break;case 3:qt(e,n,t,r),l&2048&&(e=null,n.alternate!==null&&(e=n.alternate.memoizedState.cache),n=n.memoizedState.cache,n!==e&&(n.refCount++,e!=null&&pi(e)));break;case 12:if(l&2048){qt(e,n,t,r),e=n.stateNode;try{var s=n.memoizedProps,p=s.id,g=s.onPostCommit;typeof g=="function"&&g(p,n.alternate===null?"mount":"update",e.passiveEffectDuration,-0)}catch(E){qe(n,n.return,E)}}else qt(e,n,t,r);break;case 31:qt(e,n,t,r);break;case 13:qt(e,n,t,r);break;case 23:break;case 22:s=n.stateNode,p=n.alternate,n.memoizedState!==null?s._visibility&2?qt(e,n,t,r):Ti(e,n):s._visibility&2?qt(e,n,t,r):(s._visibility|=2,Sa(e,n,t,r,(n.subtreeFlags&10256)!==0||!1)),l&2048&&vu(p,n);break;case 24:qt(e,n,t,r),l&2048&&xu(n.alternate,n);break;default:qt(e,n,t,r)}}function Sa(e,n,t,r,l){for(l=l&&((n.subtreeFlags&10256)!==0||!1),n=n.child;n!==null;){var s=e,p=n,g=t,E=r,A=p.flags;switch(p.tag){case 0:case 11:case 15:Sa(s,p,g,E,l),Ri(8,p);break;case 23:break;case 22:var V=p.stateNode;p.memoizedState!==null?V._visibility&2?Sa(s,p,g,E,l):Ti(s,p):(V._visibility|=2,Sa(s,p,g,E,l)),l&&A&2048&&vu(p.alternate,p);break;case 24:Sa(s,p,g,E,l),l&&A&2048&&xu(p.alternate,p);break;default:Sa(s,p,g,E,l)}n=n.sibling}}function Ti(e,n){if(n.subtreeFlags&10256)for(n=n.child;n!==null;){var t=e,r=n,l=r.flags;switch(r.tag){case 22:Ti(t,r),l&2048&&vu(r.alternate,r);break;case 24:Ti(t,r),l&2048&&xu(r.alternate,r);break;default:Ti(t,r)}n=n.sibling}}var ji=8192;function Ea(e,n,t){if(e.subtreeFlags&ji)for(e=e.child;e!==null;)zm(e,n,t),e=e.sibling}function zm(e,n,t){switch(e.tag){case 26:Ea(e,n,t),e.flags&ji&&e.memoizedState!==null&&Og(t,It,e.memoizedState,e.memoizedProps);break;case 5:Ea(e,n,t);break;case 3:case 4:var r=It;It=ho(e.stateNode.containerInfo),Ea(e,n,t),It=r;break;case 22:e.memoizedState===null&&(r=e.alternate,r!==null&&r.memoizedState!==null?(r=ji,ji=16777216,Ea(e,n,t),ji=r):Ea(e,n,t));break;default:Ea(e,n,t)}}function Um(e){var n=e.alternate;if(n!==null&&(e=n.child,e!==null)){n.child=null;do n=e.sibling,e.sibling=null,e=n;while(e!==null)}}function Ai(e){var n=e.deletions;if((e.flags&16)!==0){if(n!==null)for(var t=0;t<n.length;t++){var r=n[t];Nn=r,Vm(r,e)}Um(e)}if(e.subtreeFlags&10256)for(e=e.child;e!==null;)Hm(e),e=e.sibling}function Hm(e){switch(e.tag){case 0:case 11:case 15:Ai(e),e.flags&2048&&Zr(9,e,e.return);break;case 3:Ai(e);break;case 12:Ai(e);break;case 22:var n=e.stateNode;e.memoizedState!==null&&n._visibility&2&&(e.return===null||e.return.tag!==13)?(n._visibility&=-3,no(e)):Ai(e);break;default:Ai(e)}}function no(e){var n=e.deletions;if((e.flags&16)!==0){if(n!==null)for(var t=0;t<n.length;t++){var r=n[t];Nn=r,Vm(r,e)}Um(e)}for(e=e.child;e!==null;){switch(n=e,n.tag){case 0:case 11:case 15:Zr(8,n,n.return),no(n);break;case 22:t=n.stateNode,t._visibility&2&&(t._visibility&=-3,no(n));break;default:no(n)}e=e.sibling}}function Vm(e,n){for(;Nn!==null;){var t=Nn;switch(t.tag){case 0:case 11:case 15:Zr(8,t,n);break;case 23:case 22:if(t.memoizedState!==null&&t.memoizedState.cachePool!==null){var r=t.memoizedState.cachePool.pool;r!=null&&r.refCount++}break;case 24:pi(t.memoizedState.cache)}if(r=t.child,r!==null)r.return=t,Nn=r;else e:for(t=e;Nn!==null;){r=Nn;var l=r.sibling,s=r.return;if(jm(r),r===t){Nn=null;break e}if(l!==null){l.return=s,Nn=l;break e}Nn=s}}}var F_={getCacheForType:function(e){var n=On(pn),t=n.data.get(e);return t===void 0&&(t=e(),n.data.set(e,t)),t},cacheSignal:function(){return On(pn).controller.signal}},K_=typeof WeakMap=="function"?WeakMap:Map,He=0,Qe=null,Me=null,Ae=0,Ie=0,pt=null,Wr=!1,ka=!1,wu=!1,kr=0,sn=0,Jr=0,Pl=0,Su=0,ht=0,Na=0,Di=null,tt=null,Eu=!1,to=0,Gm=0,ro=1/0,lo=null,el=null,wn=0,nl=null,Ra=null,Nr=0,ku=0,Nu=null,Ym=null,Oi=0,Ru=null;function _t(){return(He&2)!==0&&Ae!==0?Ae&-Ae:z.T!==null?Ou():on()}function Im(){if(ht===0)if((Ae&536870912)===0||Ce){var e=In;In<<=1,(In&3932160)===0&&(In=262144),ht=e}else ht=536870912;return e=dt.current,e!==null&&(e.flags|=32),ht}function rt(e,n,t){(e===Qe&&(Ie===2||Ie===9)||e.cancelPendingCommit!==null)&&(Ma(e,0),tl(e,Ae,ht,!1)),_l(e,t),((He&2)===0||e!==Qe)&&(e===Qe&&((He&2)===0&&(Pl|=t),sn===4&&tl(e,Ae,ht,!1)),tr(e))}function qm(e,n,t){if((He&6)!==0)throw Error(i(327));var r=!t&&(n&127)===0&&(n&e.expiredLanes)===0||zn(e,n),l=r?W_(e,n):Tu(e,n,!0),s=r;do{if(l===0){ka&&!r&&tl(e,n,0,!1);break}else{if(t=e.current.alternate,s&&!Q_(t)){l=Tu(e,n,!1),s=!1;continue}if(l===2){if(s=n,e.errorRecoveryDisabledLanes&s)var p=0;else p=e.pendingLanes&-536870913,p=p!==0?p:p&536870912?536870912:0;if(p!==0){n=p;e:{var g=e;l=Di;var E=g.current.memoizedState.isDehydrated;if(E&&(Ma(g,p).flags|=256),p=Tu(g,p,!1),p!==2){if(wu&&!E){g.errorRecoveryDisabledLanes|=s,Pl|=s,l=4;break e}s=tt,tt=l,s!==null&&(tt===null?tt=s:tt.push.apply(tt,s))}l=p}if(s=!1,l!==2)continue}}if(l===1){Ma(e,0),tl(e,n,0,!0);break}e:{switch(r=e,s=l,s){case 0:case 1:throw Error(i(345));case 4:if((n&4194048)!==n)break;case 6:tl(r,n,ht,!Wr);break e;case 2:tt=null;break;case 3:case 5:break;default:throw Error(i(329))}if((n&62914560)===n&&(l=to+300-yn(),10<l)){if(tl(r,n,ht,!Wr),mn(r,0,!0)!==0)break e;Nr=n,r.timeoutHandle=xp(Pm.bind(null,r,t,tt,lo,Eu,n,ht,Pl,Na,Wr,s,"Throttled",-0,0),l);break e}Pm(r,t,tt,lo,Eu,n,ht,Pl,Na,Wr,s,null,-0,0)}}break}while(!0);tr(e)}function Pm(e,n,t,r,l,s,p,g,E,A,V,P,O,U){if(e.timeoutHandle=-1,P=n.subtreeFlags,P&8192||(P&16785408)===16785408){P={stylesheets:null,count:0,imgCount:0,imgBytes:0,suspenseyImages:[],waitingForImages:!0,waitingForViewTransition:!1,unsuspend:tn},zm(n,s,P);var ce=(s&62914560)===s?to-yn():(s&4194048)===s?Gm-yn():0;if(ce=Cg(P,ce),ce!==null){Nr=s,e.cancelPendingCommit=ce(Jm.bind(null,e,n,s,t,r,l,p,g,E,V,P,null,O,U)),tl(e,s,p,!A);return}}Jm(e,n,s,t,r,l,p,g,E)}function Q_(e){for(var n=e;;){var t=n.tag;if((t===0||t===11||t===15)&&n.flags&16384&&(t=n.updateQueue,t!==null&&(t=t.stores,t!==null)))for(var r=0;r<t.length;r++){var l=t[r],s=l.getSnapshot;l=l.value;try{if(!An(s(),l))return!1}catch{return!1}}if(t=n.child,n.subtreeFlags&16384&&t!==null)t.return=n,n=t;else{if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return!0;n=n.return}n.sibling.return=n.return,n=n.sibling}}return!0}function tl(e,n,t,r){n&=~Su,n&=~Pl,e.suspendedLanes|=n,e.pingedLanes&=~n,r&&(e.warmLanes|=n),r=e.expirationTimes;for(var l=n;0<l;){var s=31-Rn(l),p=1<<s;r[s]=-1,l&=~p}t!==0&&ls(e,t,n)}function ao(){return(He&6)===0?(Ci(0),!1):!0}function Mu(){if(Me!==null){if(Ie===0)var e=Me.return;else e=Me,hr=Bl=null,qc(e),ba=null,_i=0,e=Me;for(;e!==null;)wm(e.alternate,e),e=e.return;Me=null}}function Ma(e,n){var t=e.timeoutHandle;t!==-1&&(e.timeoutHandle=-1,_g(t)),t=e.cancelPendingCommit,t!==null&&(e.cancelPendingCommit=null,t()),Nr=0,Mu(),Qe=e,Me=t=mr(e.current,null),Ae=n,Ie=0,pt=null,Wr=!1,ka=zn(e,n),wu=!1,Na=ht=Su=Pl=Jr=sn=0,tt=Di=null,Eu=!1,(n&8)!==0&&(n|=n&32);var r=e.entangledLanes;if(r!==0)for(e=e.entanglements,r&=n;0<r;){var l=31-Rn(r),s=1<<l;n|=e[l],r&=~s}return kr=n,Ns(),t}function $m(e,n){Ee=null,z.H=Ei,n===ga||n===Cs?(n=od(),Ie=3):n===Dc?(n=od(),Ie=4):Ie=n===iu?8:n!==null&&typeof n=="object"&&typeof n.then=="function"?6:1,pt=n,Me===null&&(sn=1,Fs(e,Nt(n,e.current)))}function Xm(){var e=dt.current;return e===null?!0:(Ae&4194048)===Ae?jt===null:(Ae&62914560)===Ae||(Ae&536870912)!==0?e===jt:!1}function Fm(){var e=z.H;return z.H=Ei,e===null?Ei:e}function Km(){var e=z.A;return z.A=F_,e}function io(){sn=4,Wr||(Ae&4194048)!==Ae&&dt.current!==null||(ka=!0),(Jr&134217727)===0&&(Pl&134217727)===0||Qe===null||tl(Qe,Ae,ht,!1)}function Tu(e,n,t){var r=He;He|=2;var l=Fm(),s=Km();(Qe!==e||Ae!==n)&&(lo=null,Ma(e,n)),n=!1;var p=sn;e:do try{if(Ie!==0&&Me!==null){var g=Me,E=pt;switch(Ie){case 8:Mu(),p=6;break e;case 3:case 2:case 9:case 6:dt.current===null&&(n=!0);var A=Ie;if(Ie=0,pt=null,Ta(e,g,E,A),t&&ka){p=0;break e}break;default:A=Ie,Ie=0,pt=null,Ta(e,g,E,A)}}Z_(),p=sn;break}catch(V){$m(e,V)}while(!0);return n&&e.shellSuspendCounter++,hr=Bl=null,He=r,z.H=l,z.A=s,Me===null&&(Qe=null,Ae=0,Ns()),p}function Z_(){for(;Me!==null;)Qm(Me)}function W_(e,n){var t=He;He|=2;var r=Fm(),l=Km();Qe!==e||Ae!==n?(lo=null,ro=yn()+500,Ma(e,n)):ka=zn(e,n);e:do try{if(Ie!==0&&Me!==null){n=Me;var s=pt;n:switch(Ie){case 1:Ie=0,pt=null,Ta(e,n,s,1);break;case 2:case 9:if(id(s)){Ie=0,pt=null,Zm(n);break}n=function(){Ie!==2&&Ie!==9||Qe!==e||(Ie=7),tr(e)},s.then(n,n);break e;case 3:Ie=7;break e;case 4:Ie=5;break e;case 7:id(s)?(Ie=0,pt=null,Zm(n)):(Ie=0,pt=null,Ta(e,n,s,7));break;case 5:var p=null;switch(Me.tag){case 26:p=Me.memoizedState;case 5:case 27:var g=Me;if(p?Bp(p):g.stateNode.complete){Ie=0,pt=null;var E=g.sibling;if(E!==null)Me=E;else{var A=g.return;A!==null?(Me=A,so(A)):Me=null}break n}}Ie=0,pt=null,Ta(e,n,s,5);break;case 6:Ie=0,pt=null,Ta(e,n,s,6);break;case 8:Mu(),sn=6;break e;default:throw Error(i(462))}}J_();break}catch(V){$m(e,V)}while(!0);return hr=Bl=null,z.H=r,z.A=l,He=t,Me!==null?0:(Qe=null,Ae=0,Ns(),sn)}function J_(){for(;Me!==null&&!Ql();)Qm(Me)}function Qm(e){var n=vm(e.alternate,e,kr);e.memoizedProps=e.pendingProps,n===null?so(e):Me=n}function Zm(e){var n=e,t=n.alternate;switch(n.tag){case 15:case 0:n=pm(t,n,n.pendingProps,n.type,void 0,Ae);break;case 11:n=pm(t,n,n.pendingProps,n.type.render,n.ref,Ae);break;case 5:qc(n);default:wm(t,n),n=Me=Kf(n,kr),n=vm(t,n,kr)}e.memoizedProps=e.pendingProps,n===null?so(e):Me=n}function Ta(e,n,t,r){hr=Bl=null,qc(n),ba=null,_i=0;var l=n.return;try{if(G_(e,l,n,t,Ae)){sn=1,Fs(e,Nt(t,e.current)),Me=null;return}}catch(s){if(l!==null)throw Me=l,s;sn=1,Fs(e,Nt(t,e.current)),Me=null;return}n.flags&32768?(Ce||r===1?e=!0:ka||(Ae&536870912)!==0?e=!1:(Wr=e=!0,(r===2||r===9||r===3||r===6)&&(r=dt.current,r!==null&&r.tag===13&&(r.flags|=16384))),Wm(n,e)):so(n)}function so(e){var n=e;do{if((n.flags&32768)!==0){Wm(n,Wr);return}e=n.return;var t=q_(n.alternate,n,kr);if(t!==null){Me=t;return}if(n=n.sibling,n!==null){Me=n;return}Me=n=e}while(n!==null);sn===0&&(sn=5)}function Wm(e,n){do{var t=P_(e.alternate,e);if(t!==null){t.flags&=32767,Me=t;return}if(t=e.return,t!==null&&(t.flags|=32768,t.subtreeFlags=0,t.deletions=null),!n&&(e=e.sibling,e!==null)){Me=e;return}Me=e=t}while(e!==null);sn=6,Me=null}function Jm(e,n,t,r,l,s,p,g,E){e.cancelPendingCommit=null;do oo();while(wn!==0);if((He&6)!==0)throw Error(i(327));if(n!==null){if(n===e.current)throw Error(i(177));if(s=n.lanes|n.childLanes,s|=gc,lr(e,t,s,p,g,E),e===Qe&&(Me=Qe=null,Ae=0),Ra=n,nl=e,Nr=t,ku=s,Nu=l,Ym=r,(n.subtreeFlags&10256)!==0||(n.flags&10256)!==0?(e.callbackNode=null,e.callbackPriority=0,rg(pl,function(){return lp(),null})):(e.callbackNode=null,e.callbackPriority=0),r=(n.flags&13878)!==0,(n.subtreeFlags&13878)!==0||r){r=z.T,z.T=null,l=Z.p,Z.p=2,p=He,He|=4;try{$_(e,n,t)}finally{He=p,Z.p=l,z.T=r}}wn=1,ep(),np(),tp()}}function ep(){if(wn===1){wn=0;var e=nl,n=Ra,t=(n.flags&13878)!==0;if((n.subtreeFlags&13878)!==0||t){t=z.T,z.T=null;var r=Z.p;Z.p=2;var l=He;He|=4;try{Cm(n,e);var s=Gu,p=ui(e.containerInfo),g=s.focusedElem,E=s.selectionRange;if(p!==g&&g&&g.ownerDocument&&Es(g.ownerDocument.documentElement,g)){if(E!==null&&dc(g)){var A=E.start,V=E.end;if(V===void 0&&(V=A),"selectionStart"in g)g.selectionStart=A,g.selectionEnd=Math.min(V,g.value.length);else{var P=g.ownerDocument||document,O=P&&P.defaultView||window;if(O.getSelection){var U=O.getSelection(),ce=g.textContent.length,_e=Math.min(E.start,ce),Fe=E.end===void 0?_e:Math.min(E.end,ce);!U.extend&&_e>Fe&&(p=Fe,Fe=_e,_e=p);var M=Gr(g,_e),k=Gr(g,Fe);if(M&&k&&(U.rangeCount!==1||U.anchorNode!==M.node||U.anchorOffset!==M.offset||U.focusNode!==k.node||U.focusOffset!==k.offset)){var j=P.createRange();j.setStart(M.node,M.offset),U.removeAllRanges(),_e>Fe?(U.addRange(j),U.extend(k.node,k.offset)):(j.setEnd(k.node,k.offset),U.addRange(j))}}}}for(P=[],U=g;U=U.parentNode;)U.nodeType===1&&P.push({element:U,left:U.scrollLeft,top:U.scrollTop});for(typeof g.focus=="function"&&g.focus(),g=0;g<P.length;g++){var Y=P[g];Y.element.scrollLeft=Y.left,Y.element.scrollTop=Y.top}}xo=!!Vu,Gu=Vu=null}finally{He=l,Z.p=r,z.T=t}}e.current=n,wn=2}}function np(){if(wn===2){wn=0;var e=nl,n=Ra,t=(n.flags&8772)!==0;if((n.subtreeFlags&8772)!==0||t){t=z.T,z.T=null;var r=Z.p;Z.p=2;var l=He;He|=4;try{Tm(e,n.alternate,n)}finally{He=l,Z.p=r,z.T=t}}wn=3}}function tp(){if(wn===4||wn===3){wn=0,Dr();var e=nl,n=Ra,t=Nr,r=Ym;(n.subtreeFlags&10256)!==0||(n.flags&10256)!==0?wn=5:(wn=0,Ra=nl=null,rp(e,e.pendingLanes));var l=e.pendingLanes;if(l===0&&(el=null),xt(t),n=n.stateNode,vn&&typeof vn.onCommitFiberRoot=="function")try{vn.onCommitFiberRoot(hl,n,void 0,(n.current.flags&128)===128)}catch{}if(r!==null){n=z.T,l=Z.p,Z.p=2,z.T=null;try{for(var s=e.onRecoverableError,p=0;p<r.length;p++){var g=r[p];s(g.value,{componentStack:g.stack})}}finally{z.T=n,Z.p=l}}(Nr&3)!==0&&oo(),tr(e),l=e.pendingLanes,(t&261930)!==0&&(l&42)!==0?e===Ru?Oi++:(Oi=0,Ru=e):Oi=0,Ci(0)}}function rp(e,n){(e.pooledCacheLanes&=n)===0&&(n=e.pooledCache,n!=null&&(e.pooledCache=null,pi(n)))}function oo(){return ep(),np(),tp(),lp()}function lp(){if(wn!==5)return!1;var e=nl,n=ku;ku=0;var t=xt(Nr),r=z.T,l=Z.p;try{Z.p=32>t?32:t,z.T=null,t=Nu,Nu=null;var s=nl,p=Nr;if(wn=0,Ra=nl=null,Nr=0,(He&6)!==0)throw Error(i(331));var g=He;if(He|=4,Hm(s.current),Bm(s,s.current,p,t),He=g,Ci(0,!1),vn&&typeof vn.onPostCommitFiberRoot=="function")try{vn.onPostCommitFiberRoot(hl,s)}catch{}return!0}finally{Z.p=l,z.T=r,rp(e,n)}}function ap(e,n,t){n=Nt(t,n),n=au(e.stateNode,n,2),e=Fr(e,n,2),e!==null&&(_l(e,2),tr(e))}function qe(e,n,t){if(e.tag===3)ap(e,e,t);else for(;n!==null;){if(n.tag===3){ap(n,e,t);break}else if(n.tag===1){var r=n.stateNode;if(typeof n.type.getDerivedStateFromError=="function"||typeof r.componentDidCatch=="function"&&(el===null||!el.has(r))){e=Nt(t,e),t=im(2),r=Fr(n,t,2),r!==null&&(sm(t,r,n,e),_l(r,2),tr(r));break}}n=n.return}}function ju(e,n,t){var r=e.pingCache;if(r===null){r=e.pingCache=new K_;var l=new Set;r.set(n,l)}else l=r.get(n),l===void 0&&(l=new Set,r.set(n,l));l.has(t)||(wu=!0,l.add(t),e=eg.bind(null,e,n,t),n.then(e,e))}function eg(e,n,t){var r=e.pingCache;r!==null&&r.delete(n),e.pingedLanes|=e.suspendedLanes&t,e.warmLanes&=~t,Qe===e&&(Ae&t)===t&&(sn===4||sn===3&&(Ae&62914560)===Ae&&300>yn()-to?(He&2)===0&&Ma(e,0):Su|=t,Na===Ae&&(Na=0)),tr(e)}function ip(e,n){n===0&&(n=$a()),e=Ol(e,n),e!==null&&(_l(e,n),tr(e))}function ng(e){var n=e.memoizedState,t=0;n!==null&&(t=n.retryLane),ip(e,t)}function tg(e,n){var t=0;switch(e.tag){case 31:case 13:var r=e.stateNode,l=e.memoizedState;l!==null&&(t=l.retryLane);break;case 19:r=e.stateNode;break;case 22:r=e.stateNode._retryCache;break;default:throw Error(i(314))}r!==null&&r.delete(n),ip(e,t)}function rg(e,n){return Ar(e,n)}var co=null,ja=null,Au=!1,uo=!1,Du=!1,rl=0;function tr(e){e!==ja&&e.next===null&&(ja===null?co=ja=e:ja=ja.next=e),uo=!0,Au||(Au=!0,ag())}function Ci(e,n){if(!Du&&uo){Du=!0;do for(var t=!1,r=co;r!==null;){if(e!==0){var l=r.pendingLanes;if(l===0)var s=0;else{var p=r.suspendedLanes,g=r.pingedLanes;s=(1<<31-Rn(42|e)+1)-1,s&=l&~(p&~g),s=s&201326741?s&201326741|1:s?s|2:0}s!==0&&(t=!0,up(r,s))}else s=Ae,s=mn(r,r===Qe?s:0,r.cancelPendingCommit!==null||r.timeoutHandle!==-1),(s&3)===0||zn(r,s)||(t=!0,up(r,s));r=r.next}while(t);Du=!1}}function lg(){sp()}function sp(){uo=Au=!1;var e=0;rl!==0&&hg()&&(e=rl);for(var n=yn(),t=null,r=co;r!==null;){var l=r.next,s=op(r,n);s===0?(r.next=null,t===null?co=l:t.next=l,l===null&&(ja=t)):(t=r,(e!==0||(s&3)!==0)&&(uo=!0)),r=l}wn!==0&&wn!==5||Ci(e),rl!==0&&(rl=0)}function op(e,n){for(var t=e.suspendedLanes,r=e.pingedLanes,l=e.expirationTimes,s=e.pendingLanes&-62914561;0<s;){var p=31-Rn(s),g=1<<p,E=l[p];E===-1?((g&t)===0||(g&r)!==0)&&(l[p]=Io(g,n)):E<=n&&(e.expiredLanes|=g),s&=~g}if(n=Qe,t=Ae,t=mn(e,e===n?t:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),r=e.callbackNode,t===0||e===n&&(Ie===2||Ie===9)||e.cancelPendingCommit!==null)return r!==null&&r!==null&&vt(r),e.callbackNode=null,e.callbackPriority=0;if((t&3)===0||zn(e,t)){if(n=t&-t,n===e.callbackPriority)return n;switch(r!==null&&vt(r),xt(t)){case 2:case 8:t=Pa;break;case 32:t=pl;break;case 268435456:t=lt;break;default:t=pl}return r=cp.bind(null,e),t=Ar(t,r),e.callbackPriority=n,e.callbackNode=t,n}return r!==null&&r!==null&&vt(r),e.callbackPriority=2,e.callbackNode=null,2}function cp(e,n){if(wn!==0&&wn!==5)return e.callbackNode=null,e.callbackPriority=0,null;var t=e.callbackNode;if(oo()&&e.callbackNode!==t)return null;var r=Ae;return r=mn(e,e===Qe?r:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),r===0?null:(qm(e,r,n),op(e,yn()),e.callbackNode!=null&&e.callbackNode===t?cp.bind(null,e):null)}function up(e,n){if(oo())return null;qm(e,n,!0)}function ag(){gg(function(){(He&6)!==0?Ar(ml,lg):sp()})}function Ou(){if(rl===0){var e=ha;e===0&&(e=Xt,Xt<<=1,(Xt&261888)===0&&(Xt=256)),rl=e}return rl}function fp(e){return e==null||typeof e=="symbol"||typeof e=="boolean"?null:typeof e=="function"?e:zr(""+e)}function dp(e,n){var t=n.ownerDocument.createElement("input");return t.name=n.name,t.value=n.value,e.id&&t.setAttribute("form",e.id),n.parentNode.insertBefore(t,n),e=new FormData(e),t.parentNode.removeChild(t),e}function ig(e,n,t,r,l){if(n==="submit"&&t&&t.stateNode===l){var s=fp((l[un]||null).action),p=r.submitter;p&&(n=(n=p[un]||null)?fp(n.formAction):p.getAttribute("formAction"),n!==null&&(s=n,p=null));var g=new la("action","action",null,r,l);e.push({event:g,listeners:[{instance:null,listener:function(){if(r.defaultPrevented){if(rl!==0){var E=p?dp(l,p):new FormData(l);Jc(t,{pending:!0,data:E,method:l.method,action:s},null,E)}}else typeof s=="function"&&(g.preventDefault(),E=p?dp(l,p):new FormData(l),Jc(t,{pending:!0,data:E,method:l.method,action:s},s,E))},currentTarget:l}]})}}for(var Cu=0;Cu<_c.length;Cu++){var Lu=_c[Cu],sg=Lu.toLowerCase(),og=Lu[0].toUpperCase()+Lu.slice(1);Yt(sg,"on"+og)}Yt(If,"onAnimationEnd"),Yt(qf,"onAnimationIteration"),Yt(Pf,"onAnimationStart"),Yt("dblclick","onDoubleClick"),Yt("focusin","onFocus"),Yt("focusout","onBlur"),Yt(E_,"onTransitionRun"),Yt(k_,"onTransitionStart"),Yt(N_,"onTransitionCancel"),Yt($f,"onTransitionEnd"),ot("onMouseEnter",["mouseout","mouseover"]),ot("onMouseLeave",["mouseout","mouseover"]),ot("onPointerEnter",["pointerout","pointerover"]),ot("onPointerLeave",["pointerout","pointerover"]),st("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),st("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),st("onBeforeInput",["compositionend","keypress","textInput","paste"]),st("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),st("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),st("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var Li="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),cg=new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(Li));function mp(e,n){n=(n&4)!==0;for(var t=0;t<e.length;t++){var r=e[t],l=r.event;r=r.listeners;e:{var s=void 0;if(n)for(var p=r.length-1;0<=p;p--){var g=r[p],E=g.instance,A=g.currentTarget;if(g=g.listener,E!==s&&l.isPropagationStopped())break e;s=g,l.currentTarget=A;try{s(l)}catch(V){ks(V)}l.currentTarget=null,s=E}else for(p=0;p<r.length;p++){if(g=r[p],E=g.instance,A=g.currentTarget,g=g.listener,E!==s&&l.isPropagationStopped())break e;s=g,l.currentTarget=A;try{s(l)}catch(V){ks(V)}l.currentTarget=null,s=E}}}}function Te(e,n){var t=n[zt];t===void 0&&(t=n[zt]=new Set);var r=e+"__bubble";t.has(r)||(pp(n,e,2,!1),t.add(r))}function Bu(e,n,t){var r=0;n&&(r|=4),pp(t,e,r,n)}var fo="_reactListening"+Math.random().toString(36).slice(2);function zu(e){if(!e[fo]){e[fo]=!0,ir.forEach(function(t){t!=="selectionchange"&&(cg.has(t)||Bu(t,!1,e),Bu(t,!0,e))});var n=e.nodeType===9?e:e.ownerDocument;n===null||n[fo]||(n[fo]=!0,Bu("selectionchange",!1,n))}}function pp(e,n,t,r){switch(Ip(n)){case 2:var l=zg;break;case 8:l=Ug;break;default:l=Wu}t=l.bind(null,n,t,e),l=void 0,!ei||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(l=!0),r?l!==void 0?e.addEventListener(n,t,{capture:!0,passive:l}):e.addEventListener(n,t,!0):l!==void 0?e.addEventListener(n,t,{passive:l}):e.addEventListener(n,t,!1)}function Uu(e,n,t,r,l){var s=r;if((n&1)===0&&(n&2)===0&&r!==null)e:for(;;){if(r===null)return;var p=r.tag;if(p===3||p===4){var g=r.stateNode.containerInfo;if(g===l)break;if(p===4)for(p=r.return;p!==null;){var E=p.tag;if((E===3||E===4)&&p.stateNode.containerInfo===l)return;p=p.return}for(;g!==null;){if(p=Kt(g),p===null)return;if(E=p.tag,E===5||E===6||E===26||E===27){r=s=p;continue e}g=g.parentNode}}r=r.return}vl(function(){var A=s,V=Ja(t),P=[];e:{var O=Xf.get(e);if(O!==void 0){var U=la,ce=e;switch(e){case"keypress":if(Wt(t)===0)break e;case"keydown":case"keyup":U=_s;break;case"focusin":ce="focus",U=li;break;case"focusout":ce="blur",U=li;break;case"beforeblur":case"afterblur":U=li;break;case"click":if(t.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":U=ri;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":U=Po;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":U=lc;break;case If:case qf:case Pf:U=Fo;break;case $f:U=ac;break;case"scroll":case"scrollend":U=ms;break;case"wheel":U=sc;break;case"copy":case"cut":case"paste":U=Qo;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":U=ii;break;case"toggle":case"beforetoggle":U=cc}var _e=(n&4)!==0,Fe=!_e&&(e==="scroll"||e==="scrollend"),M=_e?O!==null?O+"Capture":null:O;_e=[];for(var k=A,j;k!==null;){var Y=k;if(j=Y.stateNode,Y=Y.tag,Y!==5&&Y!==26&&Y!==27||j===null||M===null||(Y=Qt(k,M),Y!=null&&_e.push(Bi(k,Y,j))),Fe)break;k=k.return}0<_e.length&&(O=new U(O,ce,null,t,V),P.push({event:O,listeners:_e}))}}if((n&7)===0){e:{if(O=e==="mouseover"||e==="pointerover",U=e==="mouseout"||e==="pointerout",O&&t!==sr&&(ce=t.relatedTarget||t.fromElement)&&(Kt(ce)||ce[Tn]))break e;if((U||O)&&(O=V.window===V?V:(O=V.ownerDocument)?O.defaultView||O.parentWindow:window,U?(ce=t.relatedTarget||t.toElement,U=A,ce=ce?Kt(ce):null,ce!==null&&(Fe=d(ce),_e=ce.tag,ce!==Fe||_e!==5&&_e!==27&&_e!==6)&&(ce=null)):(U=null,ce=A),U!==ce)){if(_e=ri,Y="onMouseLeave",M="onMouseEnter",k="mouse",(e==="pointerout"||e==="pointerover")&&(_e=ii,Y="onPointerLeave",M="onPointerEnter",k="pointer"),Fe=U==null?O:Gt(U),j=ce==null?O:Gt(ce),O=new _e(Y,k+"leave",U,t,V),O.target=Fe,O.relatedTarget=j,Y=null,Kt(V)===A&&(_e=new _e(M,k+"enter",ce,t,V),_e.target=j,_e.relatedTarget=Fe,Y=_e),Fe=Y,U&&ce)n:{for(_e=ug,M=U,k=ce,j=0,Y=M;Y;Y=_e(Y))j++;Y=0;for(var me=k;me;me=_e(me))Y++;for(;0<j-Y;)M=_e(M),j--;for(;0<Y-j;)k=_e(k),Y--;for(;j--;){if(M===k||k!==null&&M===k.alternate){_e=M;break n}M=_e(M),k=_e(k)}_e=null}else _e=null;U!==null&&hp(P,O,U,_e,!1),ce!==null&&Fe!==null&&hp(P,Fe,ce,_e,!0)}}e:{if(O=A?Gt(A):window,U=O.nodeName&&O.nodeName.toLowerCase(),U==="select"||U==="input"&&O.type==="file")var ze=fe;else if(Ss(O))if(Se)ze=Vr;else{ze=oi;var de=fr}else U=O.nodeName,!U||U.toLowerCase()!=="input"||O.type!=="checkbox"&&O.type!=="radio"?A&&Wa(A.elementType)&&(ze=fe):ze=jl;if(ze&&(ze=ze(e,A))){m(P,ze,t,V);break e}de&&de(e,O,A),e==="focusout"&&A&&O.type==="number"&&A.memoizedProps.value!=null&&Qa(O,"number",O.value)}switch(de=A?Gt(A):window,e){case"focusin":(Ss(de)||de.contentEditable==="true")&&(sa=de,mc=A,fi=null);break;case"focusout":fi=mc=sa=null;break;case"mousedown":pc=!0;break;case"contextmenu":case"mouseup":case"dragend":pc=!1,Gf(P,t,V);break;case"selectionchange":if(S_)break;case"keydown":case"keyup":Gf(P,t,V)}var Ne;if(Ml)e:{switch(e){case"compositionstart":var De="onCompositionStart";break e;case"compositionend":De="onCompositionEnd";break e;case"compositionupdate":De="onCompositionUpdate";break e}De=void 0}else cr?Hr(e,t)&&(De="onCompositionEnd"):e==="keydown"&&t.keyCode===229&&(De="onCompositionStart");De&&(ys&&t.locale!=="ko"&&(cr||De!=="onCompositionStart"?De==="onCompositionEnd"&&cr&&(Ne=ni()):(Zt=V,ut="value"in Zt?Zt.value:Zt.textContent,cr=!0)),de=mo(A,De),0<de.length&&(De=new hs(De,e,null,t,V),P.push({event:De,listeners:de}),Ne?De.data=Ne:(Ne=Tl(t),Ne!==null&&(De.data=Ne)))),(Ne=bs?si(e,t):ws(e,t))&&(De=mo(A,"onBeforeInput"),0<De.length&&(de=new hs("onBeforeInput","beforeinput",null,t,V),P.push({event:de,listeners:De}),de.data=Ne)),ig(P,e,A,t,V)}mp(P,n)})}function Bi(e,n,t){return{instance:e,listener:n,currentTarget:t}}function mo(e,n){for(var t=n+"Capture",r=[];e!==null;){var l=e,s=l.stateNode;if(l=l.tag,l!==5&&l!==26&&l!==27||s===null||(l=Qt(e,t),l!=null&&r.unshift(Bi(e,l,s)),l=Qt(e,n),l!=null&&r.push(Bi(e,l,s))),e.tag===3)return r;e=e.return}return[]}function ug(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5&&e.tag!==27);return e||null}function hp(e,n,t,r,l){for(var s=n._reactName,p=[];t!==null&&t!==r;){var g=t,E=g.alternate,A=g.stateNode;if(g=g.tag,E!==null&&E===r)break;g!==5&&g!==26&&g!==27||A===null||(E=A,l?(A=Qt(t,s),A!=null&&p.unshift(Bi(t,A,E))):l||(A=Qt(t,s),A!=null&&p.push(Bi(t,A,E)))),t=t.return}p.length!==0&&e.push({event:n,listeners:p})}var fg=/\r\n?/g,dg=/\u0000|\uFFFD/g;function _p(e){return(typeof e=="string"?e:""+e).replace(fg,`
`).replace(dg,"")}function gp(e,n){return n=_p(n),_p(e)===n}function Xe(e,n,t,r,l,s){switch(t){case"children":typeof r=="string"?n==="body"||n==="textarea"&&r===""||nn(e,r):(typeof r=="number"||typeof r=="bigint")&&n!=="body"&&nn(e,""+r);break;case"className":na(e,"class",r);break;case"tabIndex":na(e,"tabindex",r);break;case"dir":case"role":case"viewBox":case"width":case"height":na(e,t,r);break;case"style":yl(e,r,s);break;case"data":if(n!=="object"){na(e,"data",r);break}case"src":case"href":if(r===""&&(n!=="a"||t!=="href")){e.removeAttribute(t);break}if(r==null||typeof r=="function"||typeof r=="symbol"||typeof r=="boolean"){e.removeAttribute(t);break}r=zr(""+r),e.setAttribute(t,r);break;case"action":case"formAction":if(typeof r=="function"){e.setAttribute(t,"javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')");break}else typeof s=="function"&&(t==="formAction"?(n!=="input"&&Xe(e,n,"name",l.name,l,null),Xe(e,n,"formEncType",l.formEncType,l,null),Xe(e,n,"formMethod",l.formMethod,l,null),Xe(e,n,"formTarget",l.formTarget,l,null)):(Xe(e,n,"encType",l.encType,l,null),Xe(e,n,"method",l.method,l,null),Xe(e,n,"target",l.target,l,null)));if(r==null||typeof r=="symbol"||typeof r=="boolean"){e.removeAttribute(t);break}r=zr(""+r),e.setAttribute(t,r);break;case"onClick":r!=null&&(e.onclick=tn);break;case"onScroll":r!=null&&Te("scroll",e);break;case"onScrollEnd":r!=null&&Te("scrollend",e);break;case"dangerouslySetInnerHTML":if(r!=null){if(typeof r!="object"||!("__html"in r))throw Error(i(61));if(t=r.__html,t!=null){if(l.children!=null)throw Error(i(60));e.innerHTML=t}}break;case"multiple":e.multiple=r&&typeof r!="function"&&typeof r!="symbol";break;case"muted":e.muted=r&&typeof r!="function"&&typeof r!="symbol";break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"defaultValue":case"defaultChecked":case"innerHTML":case"ref":break;case"autoFocus":break;case"xlinkHref":if(r==null||typeof r=="function"||typeof r=="boolean"||typeof r=="symbol"){e.removeAttribute("xlink:href");break}t=zr(""+r),e.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",t);break;case"contentEditable":case"spellCheck":case"draggable":case"value":case"autoReverse":case"externalResourcesRequired":case"focusable":case"preserveAlpha":r!=null&&typeof r!="function"&&typeof r!="symbol"?e.setAttribute(t,""+r):e.removeAttribute(t);break;case"inert":case"allowFullScreen":case"async":case"autoPlay":case"controls":case"default":case"defer":case"disabled":case"disablePictureInPicture":case"disableRemotePlayback":case"formNoValidate":case"hidden":case"loop":case"noModule":case"noValidate":case"open":case"playsInline":case"readOnly":case"required":case"reversed":case"scoped":case"seamless":case"itemScope":r&&typeof r!="function"&&typeof r!="symbol"?e.setAttribute(t,""):e.removeAttribute(t);break;case"capture":case"download":r===!0?e.setAttribute(t,""):r!==!1&&r!=null&&typeof r!="function"&&typeof r!="symbol"?e.setAttribute(t,r):e.removeAttribute(t);break;case"cols":case"rows":case"size":case"span":r!=null&&typeof r!="function"&&typeof r!="symbol"&&!isNaN(r)&&1<=r?e.setAttribute(t,r):e.removeAttribute(t);break;case"rowSpan":case"start":r==null||typeof r=="function"||typeof r=="symbol"||isNaN(r)?e.removeAttribute(t):e.setAttribute(t,r);break;case"popover":Te("beforetoggle",e),Te("toggle",e),ea(e,"popover",r);break;case"xlinkActuate":Pn(e,"http://www.w3.org/1999/xlink","xlink:actuate",r);break;case"xlinkArcrole":Pn(e,"http://www.w3.org/1999/xlink","xlink:arcrole",r);break;case"xlinkRole":Pn(e,"http://www.w3.org/1999/xlink","xlink:role",r);break;case"xlinkShow":Pn(e,"http://www.w3.org/1999/xlink","xlink:show",r);break;case"xlinkTitle":Pn(e,"http://www.w3.org/1999/xlink","xlink:title",r);break;case"xlinkType":Pn(e,"http://www.w3.org/1999/xlink","xlink:type",r);break;case"xmlBase":Pn(e,"http://www.w3.org/XML/1998/namespace","xml:base",r);break;case"xmlLang":Pn(e,"http://www.w3.org/XML/1998/namespace","xml:lang",r);break;case"xmlSpace":Pn(e,"http://www.w3.org/XML/1998/namespace","xml:space",r);break;case"is":ea(e,"is",r);break;case"innerText":case"textContent":break;default:(!(2<t.length)||t[0]!=="o"&&t[0]!=="O"||t[1]!=="n"&&t[1]!=="N")&&(t=Wn.get(t)||t,ea(e,t,r))}}function Hu(e,n,t,r,l,s){switch(t){case"style":yl(e,r,s);break;case"dangerouslySetInnerHTML":if(r!=null){if(typeof r!="object"||!("__html"in r))throw Error(i(61));if(t=r.__html,t!=null){if(l.children!=null)throw Error(i(60));e.innerHTML=t}}break;case"children":typeof r=="string"?nn(e,r):(typeof r=="number"||typeof r=="bigint")&&nn(e,""+r);break;case"onScroll":r!=null&&Te("scroll",e);break;case"onScrollEnd":r!=null&&Te("scrollend",e);break;case"onClick":r!=null&&(e.onclick=tn);break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"innerHTML":case"ref":break;case"innerText":case"textContent":break;default:if(!Fa.hasOwnProperty(t))e:{if(t[0]==="o"&&t[1]==="n"&&(l=t.endsWith("Capture"),n=t.slice(2,l?t.length-7:void 0),s=e[un]||null,s=s!=null?s[t]:null,typeof s=="function"&&e.removeEventListener(n,s,l),typeof r=="function")){typeof s!="function"&&s!==null&&(t in e?e[t]=null:e.hasAttribute(t)&&e.removeAttribute(t)),e.addEventListener(n,r,l);break e}t in e?e[t]=r:r===!0?e.setAttribute(t,""):ea(e,t,r)}}}function Ln(e,n,t){switch(n){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"img":Te("error",e),Te("load",e);var r=!1,l=!1,s;for(s in t)if(t.hasOwnProperty(s)){var p=t[s];if(p!=null)switch(s){case"src":r=!0;break;case"srcSet":l=!0;break;case"children":case"dangerouslySetInnerHTML":throw Error(i(137,n));default:Xe(e,n,s,p,t,null)}}l&&Xe(e,n,"srcSet",t.srcSet,t,null),r&&Xe(e,n,"src",t.src,t,null);return;case"input":Te("invalid",e);var g=s=p=l=null,E=null,A=null;for(r in t)if(t.hasOwnProperty(r)){var V=t[r];if(V!=null)switch(r){case"name":l=V;break;case"type":p=V;break;case"checked":E=V;break;case"defaultChecked":A=V;break;case"value":s=V;break;case"defaultValue":g=V;break;case"children":case"dangerouslySetInnerHTML":if(V!=null)throw Error(i(137,n));break;default:Xe(e,n,r,V,t,null)}}cs(e,s,g,E,A,p,l,!1);return;case"select":Te("invalid",e),r=p=s=null;for(l in t)if(t.hasOwnProperty(l)&&(g=t[l],g!=null))switch(l){case"value":s=g;break;case"defaultValue":p=g;break;case"multiple":r=g;default:Xe(e,n,l,g,t,null)}n=s,t=p,e.multiple=!!r,n!=null?wt(e,!!r,n,!1):t!=null&&wt(e,!!r,t,!0);return;case"textarea":Te("invalid",e),s=l=r=null;for(p in t)if(t.hasOwnProperty(p)&&(g=t[p],g!=null))switch(p){case"value":r=g;break;case"defaultValue":l=g;break;case"children":s=g;break;case"dangerouslySetInnerHTML":if(g!=null)throw Error(i(91));break;default:Xe(e,n,p,g,t,null)}bl(e,r,l,s);return;case"option":for(E in t)if(t.hasOwnProperty(E)&&(r=t[E],r!=null))switch(E){case"selected":e.selected=r&&typeof r!="function"&&typeof r!="symbol";break;default:Xe(e,n,E,r,t,null)}return;case"dialog":Te("beforetoggle",e),Te("toggle",e),Te("cancel",e),Te("close",e);break;case"iframe":case"object":Te("load",e);break;case"video":case"audio":for(r=0;r<Li.length;r++)Te(Li[r],e);break;case"image":Te("error",e),Te("load",e);break;case"details":Te("toggle",e);break;case"embed":case"source":case"link":Te("error",e),Te("load",e);case"area":case"base":case"br":case"col":case"hr":case"keygen":case"meta":case"param":case"track":case"wbr":case"menuitem":for(A in t)if(t.hasOwnProperty(A)&&(r=t[A],r!=null))switch(A){case"children":case"dangerouslySetInnerHTML":throw Error(i(137,n));default:Xe(e,n,A,r,t,null)}return;default:if(Wa(n)){for(V in t)t.hasOwnProperty(V)&&(r=t[V],r!==void 0&&Hu(e,n,V,r,t,void 0));return}}for(g in t)t.hasOwnProperty(g)&&(r=t[g],r!=null&&Xe(e,n,g,r,t,null))}function mg(e,n,t,r){switch(n){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"input":var l=null,s=null,p=null,g=null,E=null,A=null,V=null;for(U in t){var P=t[U];if(t.hasOwnProperty(U)&&P!=null)switch(U){case"checked":break;case"value":break;case"defaultValue":E=P;default:r.hasOwnProperty(U)||Xe(e,n,U,null,r,P)}}for(var O in r){var U=r[O];if(P=t[O],r.hasOwnProperty(O)&&(U!=null||P!=null))switch(O){case"type":s=U;break;case"name":l=U;break;case"checked":A=U;break;case"defaultChecked":V=U;break;case"value":p=U;break;case"defaultValue":g=U;break;case"children":case"dangerouslySetInnerHTML":if(U!=null)throw Error(i(137,n));break;default:U!==P&&Xe(e,n,O,U,r,P)}}q(e,p,g,E,A,V,s,l);return;case"select":U=p=g=O=null;for(s in t)if(E=t[s],t.hasOwnProperty(s)&&E!=null)switch(s){case"value":break;case"multiple":U=E;default:r.hasOwnProperty(s)||Xe(e,n,s,null,r,E)}for(l in r)if(s=r[l],E=t[l],r.hasOwnProperty(l)&&(s!=null||E!=null))switch(l){case"value":O=s;break;case"defaultValue":g=s;break;case"multiple":p=s;default:s!==E&&Xe(e,n,l,s,r,E)}n=g,t=p,r=U,O!=null?wt(e,!!t,O,!1):!!r!=!!t&&(n!=null?wt(e,!!t,n,!0):wt(e,!!t,t?[]:"",!1));return;case"textarea":U=O=null;for(g in t)if(l=t[g],t.hasOwnProperty(g)&&l!=null&&!r.hasOwnProperty(g))switch(g){case"value":break;case"children":break;default:Xe(e,n,g,null,r,l)}for(p in r)if(l=r[p],s=t[p],r.hasOwnProperty(p)&&(l!=null||s!=null))switch(p){case"value":O=l;break;case"defaultValue":U=l;break;case"children":break;case"dangerouslySetInnerHTML":if(l!=null)throw Error(i(91));break;default:l!==s&&Xe(e,n,p,l,r,s)}Za(e,O,U);return;case"option":for(var ce in t)if(O=t[ce],t.hasOwnProperty(ce)&&O!=null&&!r.hasOwnProperty(ce))switch(ce){case"selected":e.selected=!1;break;default:Xe(e,n,ce,null,r,O)}for(E in r)if(O=r[E],U=t[E],r.hasOwnProperty(E)&&O!==U&&(O!=null||U!=null))switch(E){case"selected":e.selected=O&&typeof O!="function"&&typeof O!="symbol";break;default:Xe(e,n,E,O,r,U)}return;case"img":case"link":case"area":case"base":case"br":case"col":case"embed":case"hr":case"keygen":case"meta":case"param":case"source":case"track":case"wbr":case"menuitem":for(var _e in t)O=t[_e],t.hasOwnProperty(_e)&&O!=null&&!r.hasOwnProperty(_e)&&Xe(e,n,_e,null,r,O);for(A in r)if(O=r[A],U=t[A],r.hasOwnProperty(A)&&O!==U&&(O!=null||U!=null))switch(A){case"children":case"dangerouslySetInnerHTML":if(O!=null)throw Error(i(137,n));break;default:Xe(e,n,A,O,r,U)}return;default:if(Wa(n)){for(var Fe in t)O=t[Fe],t.hasOwnProperty(Fe)&&O!==void 0&&!r.hasOwnProperty(Fe)&&Hu(e,n,Fe,void 0,r,O);for(V in r)O=r[V],U=t[V],!r.hasOwnProperty(V)||O===U||O===void 0&&U===void 0||Hu(e,n,V,O,r,U);return}}for(var M in t)O=t[M],t.hasOwnProperty(M)&&O!=null&&!r.hasOwnProperty(M)&&Xe(e,n,M,null,r,O);for(P in r)O=r[P],U=t[P],!r.hasOwnProperty(P)||O===U||O==null&&U==null||Xe(e,n,P,O,r,U)}function bp(e){switch(e){case"css":case"script":case"font":case"img":case"image":case"input":case"link":return!0;default:return!1}}function pg(){if(typeof performance.getEntriesByType=="function"){for(var e=0,n=0,t=performance.getEntriesByType("resource"),r=0;r<t.length;r++){var l=t[r],s=l.transferSize,p=l.initiatorType,g=l.duration;if(s&&g&&bp(p)){for(p=0,g=l.responseEnd,r+=1;r<t.length;r++){var E=t[r],A=E.startTime;if(A>g)break;var V=E.transferSize,P=E.initiatorType;V&&bp(P)&&(E=E.responseEnd,p+=V*(E<g?1:(g-A)/(E-A)))}if(--r,n+=8*(s+p)/(l.duration/1e3),e++,10<e)break}}if(0<e)return n/e/1e6}return navigator.connection&&(e=navigator.connection.downlink,typeof e=="number")?e:5}var Vu=null,Gu=null;function po(e){return e.nodeType===9?e:e.ownerDocument}function yp(e){switch(e){case"http://www.w3.org/2000/svg":return 1;case"http://www.w3.org/1998/Math/MathML":return 2;default:return 0}}function vp(e,n){if(e===0)switch(n){case"svg":return 1;case"math":return 2;default:return 0}return e===1&&n==="foreignObject"?0:e}function Yu(e,n){return e==="textarea"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.children=="bigint"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var Iu=null;function hg(){var e=window.event;return e&&e.type==="popstate"?e===Iu?!1:(Iu=e,!0):(Iu=null,!1)}var xp=typeof setTimeout=="function"?setTimeout:void 0,_g=typeof clearTimeout=="function"?clearTimeout:void 0,wp=typeof Promise=="function"?Promise:void 0,gg=typeof queueMicrotask=="function"?queueMicrotask:typeof wp<"u"?function(e){return wp.resolve(null).then(e).catch(bg)}:xp;function bg(e){setTimeout(function(){throw e})}function ll(e){return e==="head"}function Sp(e,n){var t=n,r=0;do{var l=t.nextSibling;if(e.removeChild(t),l&&l.nodeType===8)if(t=l.data,t==="/$"||t==="/&"){if(r===0){e.removeChild(l),Ca(n);return}r--}else if(t==="$"||t==="$?"||t==="$~"||t==="$!"||t==="&")r++;else if(t==="html")zi(e.ownerDocument.documentElement);else if(t==="head"){t=e.ownerDocument.head,zi(t);for(var s=t.firstChild;s;){var p=s.nextSibling,g=s.nodeName;s[Ht]||g==="SCRIPT"||g==="STYLE"||g==="LINK"&&s.rel.toLowerCase()==="stylesheet"||t.removeChild(s),s=p}}else t==="body"&&zi(e.ownerDocument.body);t=l}while(t);Ca(n)}function Ep(e,n){var t=e;e=0;do{var r=t.nextSibling;if(t.nodeType===1?n?(t._stashedDisplay=t.style.display,t.style.display="none"):(t.style.display=t._stashedDisplay||"",t.getAttribute("style")===""&&t.removeAttribute("style")):t.nodeType===3&&(n?(t._stashedText=t.nodeValue,t.nodeValue=""):t.nodeValue=t._stashedText||""),r&&r.nodeType===8)if(t=r.data,t==="/$"){if(e===0)break;e--}else t!=="$"&&t!=="$?"&&t!=="$~"&&t!=="$!"||e++;t=r}while(t)}function qu(e){var n=e.firstChild;for(n&&n.nodeType===10&&(n=n.nextSibling);n;){var t=n;switch(n=n.nextSibling,t.nodeName){case"HTML":case"HEAD":case"BODY":qu(t),Vt(t);continue;case"SCRIPT":case"STYLE":continue;case"LINK":if(t.rel.toLowerCase()==="stylesheet")continue}e.removeChild(t)}}function yg(e,n,t,r){for(;e.nodeType===1;){var l=t;if(e.nodeName.toLowerCase()!==n.toLowerCase()){if(!r&&(e.nodeName!=="INPUT"||e.type!=="hidden"))break}else if(r){if(!e[Ht])switch(n){case"meta":if(!e.hasAttribute("itemprop"))break;return e;case"link":if(s=e.getAttribute("rel"),s==="stylesheet"&&e.hasAttribute("data-precedence"))break;if(s!==l.rel||e.getAttribute("href")!==(l.href==null||l.href===""?null:l.href)||e.getAttribute("crossorigin")!==(l.crossOrigin==null?null:l.crossOrigin)||e.getAttribute("title")!==(l.title==null?null:l.title))break;return e;case"style":if(e.hasAttribute("data-precedence"))break;return e;case"script":if(s=e.getAttribute("src"),(s!==(l.src==null?null:l.src)||e.getAttribute("type")!==(l.type==null?null:l.type)||e.getAttribute("crossorigin")!==(l.crossOrigin==null?null:l.crossOrigin))&&s&&e.hasAttribute("async")&&!e.hasAttribute("itemprop"))break;return e;default:return e}}else if(n==="input"&&e.type==="hidden"){var s=l.name==null?null:""+l.name;if(l.type==="hidden"&&e.getAttribute("name")===s)return e}else return e;if(e=At(e.nextSibling),e===null)break}return null}function vg(e,n,t){if(n==="")return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!=="INPUT"||e.type!=="hidden")&&!t||(e=At(e.nextSibling),e===null))return null;return e}function kp(e,n){for(;e.nodeType!==8;)if((e.nodeType!==1||e.nodeName!=="INPUT"||e.type!=="hidden")&&!n||(e=At(e.nextSibling),e===null))return null;return e}function Pu(e){return e.data==="$?"||e.data==="$~"}function $u(e){return e.data==="$!"||e.data==="$?"&&e.ownerDocument.readyState!=="loading"}function xg(e,n){var t=e.ownerDocument;if(e.data==="$~")e._reactRetry=n;else if(e.data!=="$?"||t.readyState!=="loading")n();else{var r=function(){n(),t.removeEventListener("DOMContentLoaded",r)};t.addEventListener("DOMContentLoaded",r),e._reactRetry=r}}function At(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break;if(n===8){if(n=e.data,n==="$"||n==="$!"||n==="$?"||n==="$~"||n==="&"||n==="F!"||n==="F")break;if(n==="/$"||n==="/&")return null}}return e}var Xu=null;function Np(e){e=e.nextSibling;for(var n=0;e;){if(e.nodeType===8){var t=e.data;if(t==="/$"||t==="/&"){if(n===0)return At(e.nextSibling);n--}else t!=="$"&&t!=="$!"&&t!=="$?"&&t!=="$~"&&t!=="&"||n++}e=e.nextSibling}return null}function Rp(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var t=e.data;if(t==="$"||t==="$!"||t==="$?"||t==="$~"||t==="&"){if(n===0)return e;n--}else t!=="/$"&&t!=="/&"||n++}e=e.previousSibling}return null}function Mp(e,n,t){switch(n=po(t),e){case"html":if(e=n.documentElement,!e)throw Error(i(452));return e;case"head":if(e=n.head,!e)throw Error(i(453));return e;case"body":if(e=n.body,!e)throw Error(i(454));return e;default:throw Error(i(451))}}function zi(e){for(var n=e.attributes;n.length;)e.removeAttributeNode(n[0]);Vt(e)}var Dt=new Map,Tp=new Set;function ho(e){return typeof e.getRootNode=="function"?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var Rr=Z.d;Z.d={f:wg,r:Sg,D:Eg,C:kg,L:Ng,m:Rg,X:Tg,S:Mg,M:jg};function wg(){var e=Rr.f(),n=ao();return e||n}function Sg(e){var n=qn(e);n!==null&&n.tag===5&&n.type==="form"?$d(n):Rr.r(e)}var Aa=typeof document>"u"?null:document;function jp(e,n,t){var r=Aa;if(r&&typeof n=="string"&&n){var l=Hn(n);l='link[rel="'+e+'"][href="'+l+'"]',typeof t=="string"&&(l+='[crossorigin="'+t+'"]'),Tp.has(l)||(Tp.add(l),e={rel:e,crossOrigin:t,href:n},r.querySelector(l)===null&&(n=r.createElement("link"),Ln(n,"link",e),Ze(n),r.head.appendChild(n)))}}function Eg(e){Rr.D(e),jp("dns-prefetch",e,null)}function kg(e,n){Rr.C(e,n),jp("preconnect",e,n)}function Ng(e,n,t){Rr.L(e,n,t);var r=Aa;if(r&&e&&n){var l='link[rel="preload"][as="'+Hn(n)+'"]';n==="image"&&t&&t.imageSrcSet?(l+='[imagesrcset="'+Hn(t.imageSrcSet)+'"]',typeof t.imageSizes=="string"&&(l+='[imagesizes="'+Hn(t.imageSizes)+'"]')):l+='[href="'+Hn(e)+'"]';var s=l;switch(n){case"style":s=Da(e);break;case"script":s=Oa(e)}Dt.has(s)||(e=N({rel:"preload",href:n==="image"&&t&&t.imageSrcSet?void 0:e,as:n},t),Dt.set(s,e),r.querySelector(l)!==null||n==="style"&&r.querySelector(Ui(s))||n==="script"&&r.querySelector(Hi(s))||(n=r.createElement("link"),Ln(n,"link",e),Ze(n),r.head.appendChild(n)))}}function Rg(e,n){Rr.m(e,n);var t=Aa;if(t&&e){var r=n&&typeof n.as=="string"?n.as:"script",l='link[rel="modulepreload"][as="'+Hn(r)+'"][href="'+Hn(e)+'"]',s=l;switch(r){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":s=Oa(e)}if(!Dt.has(s)&&(e=N({rel:"modulepreload",href:e},n),Dt.set(s,e),t.querySelector(l)===null)){switch(r){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":if(t.querySelector(Hi(s)))return}r=t.createElement("link"),Ln(r,"link",e),Ze(r),t.head.appendChild(r)}}}function Mg(e,n,t){Rr.S(e,n,t);var r=Aa;if(r&&e){var l=Zn(r).hoistableStyles,s=Da(e);n=n||"default";var p=l.get(s);if(!p){var g={loading:0,preload:null};if(p=r.querySelector(Ui(s)))g.loading=5;else{e=N({rel:"stylesheet",href:e,"data-precedence":n},t),(t=Dt.get(s))&&Fu(e,t);var E=p=r.createElement("link");Ze(E),Ln(E,"link",e),E._p=new Promise(function(A,V){E.onload=A,E.onerror=V}),E.addEventListener("load",function(){g.loading|=1}),E.addEventListener("error",function(){g.loading|=2}),g.loading|=4,_o(p,n,r)}p={type:"stylesheet",instance:p,count:1,state:g},l.set(s,p)}}}function Tg(e,n){Rr.X(e,n);var t=Aa;if(t&&e){var r=Zn(t).hoistableScripts,l=Oa(e),s=r.get(l);s||(s=t.querySelector(Hi(l)),s||(e=N({src:e,async:!0},n),(n=Dt.get(l))&&Ku(e,n),s=t.createElement("script"),Ze(s),Ln(s,"link",e),t.head.appendChild(s)),s={type:"script",instance:s,count:1,state:null},r.set(l,s))}}function jg(e,n){Rr.M(e,n);var t=Aa;if(t&&e){var r=Zn(t).hoistableScripts,l=Oa(e),s=r.get(l);s||(s=t.querySelector(Hi(l)),s||(e=N({src:e,async:!0,type:"module"},n),(n=Dt.get(l))&&Ku(e,n),s=t.createElement("script"),Ze(s),Ln(s,"link",e),t.head.appendChild(s)),s={type:"script",instance:s,count:1,state:null},r.set(l,s))}}function Ap(e,n,t,r){var l=(l=Q.current)?ho(l):null;if(!l)throw Error(i(446));switch(e){case"meta":case"title":return null;case"style":return typeof t.precedence=="string"&&typeof t.href=="string"?(n=Da(t.href),t=Zn(l).hoistableStyles,r=t.get(n),r||(r={type:"style",instance:null,count:0,state:null},t.set(n,r)),r):{type:"void",instance:null,count:0,state:null};case"link":if(t.rel==="stylesheet"&&typeof t.href=="string"&&typeof t.precedence=="string"){e=Da(t.href);var s=Zn(l).hoistableStyles,p=s.get(e);if(p||(l=l.ownerDocument||l,p={type:"stylesheet",instance:null,count:0,state:{loading:0,preload:null}},s.set(e,p),(s=l.querySelector(Ui(e)))&&!s._p&&(p.instance=s,p.state.loading=5),Dt.has(e)||(t={rel:"preload",as:"style",href:t.href,crossOrigin:t.crossOrigin,integrity:t.integrity,media:t.media,hrefLang:t.hrefLang,referrerPolicy:t.referrerPolicy},Dt.set(e,t),s||Ag(l,e,t,p.state))),n&&r===null)throw Error(i(528,""));return p}if(n&&r!==null)throw Error(i(529,""));return null;case"script":return n=t.async,t=t.src,typeof t=="string"&&n&&typeof n!="function"&&typeof n!="symbol"?(n=Oa(t),t=Zn(l).hoistableScripts,r=t.get(n),r||(r={type:"script",instance:null,count:0,state:null},t.set(n,r)),r):{type:"void",instance:null,count:0,state:null};default:throw Error(i(444,e))}}function Da(e){return'href="'+Hn(e)+'"'}function Ui(e){return'link[rel="stylesheet"]['+e+"]"}function Dp(e){return N({},e,{"data-precedence":e.precedence,precedence:null})}function Ag(e,n,t,r){e.querySelector('link[rel="preload"][as="style"]['+n+"]")?r.loading=1:(n=e.createElement("link"),r.preload=n,n.addEventListener("load",function(){return r.loading|=1}),n.addEventListener("error",function(){return r.loading|=2}),Ln(n,"link",t),Ze(n),e.head.appendChild(n))}function Oa(e){return'[src="'+Hn(e)+'"]'}function Hi(e){return"script[async]"+e}function Op(e,n,t){if(n.count++,n.instance===null)switch(n.type){case"style":var r=e.querySelector('style[data-href~="'+Hn(t.href)+'"]');if(r)return n.instance=r,Ze(r),r;var l=N({},t,{"data-href":t.href,"data-precedence":t.precedence,href:null,precedence:null});return r=(e.ownerDocument||e).createElement("style"),Ze(r),Ln(r,"style",l),_o(r,t.precedence,e),n.instance=r;case"stylesheet":l=Da(t.href);var s=e.querySelector(Ui(l));if(s)return n.state.loading|=4,n.instance=s,Ze(s),s;r=Dp(t),(l=Dt.get(l))&&Fu(r,l),s=(e.ownerDocument||e).createElement("link"),Ze(s);var p=s;return p._p=new Promise(function(g,E){p.onload=g,p.onerror=E}),Ln(s,"link",r),n.state.loading|=4,_o(s,t.precedence,e),n.instance=s;case"script":return s=Oa(t.src),(l=e.querySelector(Hi(s)))?(n.instance=l,Ze(l),l):(r=t,(l=Dt.get(s))&&(r=N({},t),Ku(r,l)),e=e.ownerDocument||e,l=e.createElement("script"),Ze(l),Ln(l,"link",r),e.head.appendChild(l),n.instance=l);case"void":return null;default:throw Error(i(443,n.type))}else n.type==="stylesheet"&&(n.state.loading&4)===0&&(r=n.instance,n.state.loading|=4,_o(r,t.precedence,e));return n.instance}function _o(e,n,t){for(var r=t.querySelectorAll('link[rel="stylesheet"][data-precedence],style[data-precedence]'),l=r.length?r[r.length-1]:null,s=l,p=0;p<r.length;p++){var g=r[p];if(g.dataset.precedence===n)s=g;else if(s!==l)break}s?s.parentNode.insertBefore(e,s.nextSibling):(n=t.nodeType===9?t.head:t,n.insertBefore(e,n.firstChild))}function Fu(e,n){e.crossOrigin==null&&(e.crossOrigin=n.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=n.referrerPolicy),e.title==null&&(e.title=n.title)}function Ku(e,n){e.crossOrigin==null&&(e.crossOrigin=n.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=n.referrerPolicy),e.integrity==null&&(e.integrity=n.integrity)}var go=null;function Cp(e,n,t){if(go===null){var r=new Map,l=go=new Map;l.set(t,r)}else l=go,r=l.get(t),r||(r=new Map,l.set(t,r));if(r.has(e))return r;for(r.set(e,null),t=t.getElementsByTagName(e),l=0;l<t.length;l++){var s=t[l];if(!(s[Ht]||s[cn]||e==="link"&&s.getAttribute("rel")==="stylesheet")&&s.namespaceURI!=="http://www.w3.org/2000/svg"){var p=s.getAttribute(n)||"";p=e+p;var g=r.get(p);g?g.push(s):r.set(p,[s])}}return r}function Lp(e,n,t){e=e.ownerDocument||e,e.head.insertBefore(t,n==="title"?e.querySelector("head > title"):null)}function Dg(e,n,t){if(t===1||n.itemProp!=null)return!1;switch(e){case"meta":case"title":return!0;case"style":if(typeof n.precedence!="string"||typeof n.href!="string"||n.href==="")break;return!0;case"link":if(typeof n.rel!="string"||typeof n.href!="string"||n.href===""||n.onLoad||n.onError)break;switch(n.rel){case"stylesheet":return e=n.disabled,typeof n.precedence=="string"&&e==null;default:return!0}case"script":if(n.async&&typeof n.async!="function"&&typeof n.async!="symbol"&&!n.onLoad&&!n.onError&&n.src&&typeof n.src=="string")return!0}return!1}function Bp(e){return!(e.type==="stylesheet"&&(e.state.loading&3)===0)}function Og(e,n,t,r){if(t.type==="stylesheet"&&(typeof r.media!="string"||matchMedia(r.media).matches!==!1)&&(t.state.loading&4)===0){if(t.instance===null){var l=Da(r.href),s=n.querySelector(Ui(l));if(s){n=s._p,n!==null&&typeof n=="object"&&typeof n.then=="function"&&(e.count++,e=bo.bind(e),n.then(e,e)),t.state.loading|=4,t.instance=s,Ze(s);return}s=n.ownerDocument||n,r=Dp(r),(l=Dt.get(l))&&Fu(r,l),s=s.createElement("link"),Ze(s);var p=s;p._p=new Promise(function(g,E){p.onload=g,p.onerror=E}),Ln(s,"link",r),t.instance=s}e.stylesheets===null&&(e.stylesheets=new Map),e.stylesheets.set(t,n),(n=t.state.preload)&&(t.state.loading&3)===0&&(e.count++,t=bo.bind(e),n.addEventListener("load",t),n.addEventListener("error",t))}}var Qu=0;function Cg(e,n){return e.stylesheets&&e.count===0&&vo(e,e.stylesheets),0<e.count||0<e.imgCount?function(t){var r=setTimeout(function(){if(e.stylesheets&&vo(e,e.stylesheets),e.unsuspend){var s=e.unsuspend;e.unsuspend=null,s()}},6e4+n);0<e.imgBytes&&Qu===0&&(Qu=62500*pg());var l=setTimeout(function(){if(e.waitingForImages=!1,e.count===0&&(e.stylesheets&&vo(e,e.stylesheets),e.unsuspend)){var s=e.unsuspend;e.unsuspend=null,s()}},(e.imgBytes>Qu?50:800)+n);return e.unsuspend=t,function(){e.unsuspend=null,clearTimeout(r),clearTimeout(l)}}:null}function bo(){if(this.count--,this.count===0&&(this.imgCount===0||!this.waitingForImages)){if(this.stylesheets)vo(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var yo=null;function vo(e,n){e.stylesheets=null,e.unsuspend!==null&&(e.count++,yo=new Map,n.forEach(Lg,e),yo=null,bo.call(e))}function Lg(e,n){if(!(n.state.loading&4)){var t=yo.get(e);if(t)var r=t.get(null);else{t=new Map,yo.set(e,t);for(var l=e.querySelectorAll("link[data-precedence],style[data-precedence]"),s=0;s<l.length;s++){var p=l[s];(p.nodeName==="LINK"||p.getAttribute("media")!=="not all")&&(t.set(p.dataset.precedence,p),r=p)}r&&t.set(null,r)}l=n.instance,p=l.getAttribute("data-precedence"),s=t.get(p)||r,s===r&&t.set(null,l),t.set(p,l),this.count++,r=bo.bind(this),l.addEventListener("load",r),l.addEventListener("error",r),s?s.parentNode.insertBefore(l,s.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(l,e.firstChild)),n.state.loading|=4}}var Vi={$$typeof:ae,Provider:null,Consumer:null,_currentValue:oe,_currentValue2:oe,_threadCount:0};function Bg(e,n,t,r,l,s,p,g,E){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=Ft(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Ft(0),this.hiddenUpdates=Ft(null),this.identifierPrefix=r,this.onUncaughtError=l,this.onCaughtError=s,this.onRecoverableError=p,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=E,this.incompleteTransitions=new Map}function zp(e,n,t,r,l,s,p,g,E,A,V,P){return e=new Bg(e,n,t,p,E,A,V,P,g),n=1,s===!0&&(n|=24),s=ft(3,null,null,n),e.current=s,s.stateNode=e,n=Tc(),n.refCount++,e.pooledCache=n,n.refCount++,s.memoizedState={element:r,isDehydrated:t,cache:n},Oc(s),e}function Up(e){return e?(e=ua,e):ua}function Hp(e,n,t,r,l,s){l=Up(l),r.context===null?r.context=l:r.pendingContext=l,r=Xr(n),r.payload={element:t},s=s===void 0?null:s,s!==null&&(r.callback=s),t=Fr(e,r,n),t!==null&&(rt(t,e,n),bi(t,e,n))}function Vp(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var t=e.retryLane;e.retryLane=t!==0&&t<n?t:n}}function Zu(e,n){Vp(e,n),(e=e.alternate)&&Vp(e,n)}function Gp(e){if(e.tag===13||e.tag===31){var n=Ol(e,67108864);n!==null&&rt(n,e,67108864),Zu(e,67108864)}}function Yp(e){if(e.tag===13||e.tag===31){var n=_t();n=Lr(n);var t=Ol(e,n);t!==null&&rt(t,e,n),Zu(e,n)}}var xo=!0;function zg(e,n,t,r){var l=z.T;z.T=null;var s=Z.p;try{Z.p=2,Wu(e,n,t,r)}finally{Z.p=s,z.T=l}}function Ug(e,n,t,r){var l=z.T;z.T=null;var s=Z.p;try{Z.p=8,Wu(e,n,t,r)}finally{Z.p=s,z.T=l}}function Wu(e,n,t,r){if(xo){var l=Ju(r);if(l===null)Uu(e,n,r,wo,t),qp(e,r);else if(Vg(l,e,n,t,r))r.stopPropagation();else if(qp(e,r),n&4&&-1<Hg.indexOf(e)){for(;l!==null;){var s=qn(l);if(s!==null)switch(s.tag){case 3:if(s=s.stateNode,s.current.memoizedState.isDehydrated){var p=Mn(s.pendingLanes);if(p!==0){var g=s;for(g.pendingLanes|=2,g.entangledLanes|=2;p;){var E=1<<31-Rn(p);g.entanglements[1]|=E,p&=~E}tr(s),(He&6)===0&&(ro=yn()+500,Ci(0))}}break;case 31:case 13:g=Ol(s,2),g!==null&&rt(g,s,2),ao(),Zu(s,2)}if(s=Ju(r),s===null&&Uu(e,n,r,wo,t),s===l)break;l=s}l!==null&&r.stopPropagation()}else Uu(e,n,r,null,t)}}function Ju(e){return e=Ja(e),ef(e)}var wo=null;function ef(e){if(wo=null,e=Kt(e),e!==null){var n=d(e);if(n===null)e=null;else{var t=n.tag;if(t===13){if(e=h(n),e!==null)return e;e=null}else if(t===31){if(e=_(n),e!==null)return e;e=null}else if(t===3){if(n.stateNode.current.memoizedState.isDehydrated)return n.tag===3?n.stateNode.containerInfo:null;e=null}else n!==e&&(e=null)}}return wo=e,null}function Ip(e){switch(e){case"beforetoggle":case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"toggle":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 2;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 8;case"message":switch(dl()){case ml:return 2;case Pa:return 8;case pl:case Qn:return 32;case lt:return 268435456;default:return 32}default:return 32}}var nf=!1,al=null,il=null,sl=null,Gi=new Map,Yi=new Map,ol=[],Hg="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");function qp(e,n){switch(e){case"focusin":case"focusout":al=null;break;case"dragenter":case"dragleave":il=null;break;case"mouseover":case"mouseout":sl=null;break;case"pointerover":case"pointerout":Gi.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Yi.delete(n.pointerId)}}function Ii(e,n,t,r,l,s){return e===null||e.nativeEvent!==s?(e={blockedOn:n,domEventName:t,eventSystemFlags:r,nativeEvent:s,targetContainers:[l]},n!==null&&(n=qn(n),n!==null&&Gp(n)),e):(e.eventSystemFlags|=r,n=e.targetContainers,l!==null&&n.indexOf(l)===-1&&n.push(l),e)}function Vg(e,n,t,r,l){switch(n){case"focusin":return al=Ii(al,e,n,t,r,l),!0;case"dragenter":return il=Ii(il,e,n,t,r,l),!0;case"mouseover":return sl=Ii(sl,e,n,t,r,l),!0;case"pointerover":var s=l.pointerId;return Gi.set(s,Ii(Gi.get(s)||null,e,n,t,r,l)),!0;case"gotpointercapture":return s=l.pointerId,Yi.set(s,Ii(Yi.get(s)||null,e,n,t,r,l)),!0}return!1}function Pp(e){var n=Kt(e.target);if(n!==null){var t=d(n);if(t!==null){if(n=t.tag,n===13){if(n=h(t),n!==null){e.blockedOn=n,Xa(e.priority,function(){Yp(t)});return}}else if(n===31){if(n=_(t),n!==null){e.blockedOn=n,Xa(e.priority,function(){Yp(t)});return}}else if(n===3&&t.stateNode.current.memoizedState.isDehydrated){e.blockedOn=t.tag===3?t.stateNode.containerInfo:null;return}}}e.blockedOn=null}function So(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var t=Ju(e.nativeEvent);if(t===null){t=e.nativeEvent;var r=new t.constructor(t.type,t);sr=r,t.target.dispatchEvent(r),sr=null}else return n=qn(t),n!==null&&Gp(n),e.blockedOn=t,!1;n.shift()}return!0}function $p(e,n,t){So(e)&&t.delete(n)}function Gg(){nf=!1,al!==null&&So(al)&&(al=null),il!==null&&So(il)&&(il=null),sl!==null&&So(sl)&&(sl=null),Gi.forEach($p),Yi.forEach($p)}function Eo(e,n){e.blockedOn===n&&(e.blockedOn=null,nf||(nf=!0,o.unstable_scheduleCallback(o.unstable_NormalPriority,Gg)))}var ko=null;function Xp(e){ko!==e&&(ko=e,o.unstable_scheduleCallback(o.unstable_NormalPriority,function(){ko===e&&(ko=null);for(var n=0;n<e.length;n+=3){var t=e[n],r=e[n+1],l=e[n+2];if(typeof r!="function"){if(ef(r||t)===null)continue;break}var s=qn(t);s!==null&&(e.splice(n,3),n-=3,Jc(s,{pending:!0,data:l,method:t.method,action:r},r,l))}}))}function Ca(e){function n(E){return Eo(E,e)}al!==null&&Eo(al,e),il!==null&&Eo(il,e),sl!==null&&Eo(sl,e),Gi.forEach(n),Yi.forEach(n);for(var t=0;t<ol.length;t++){var r=ol[t];r.blockedOn===e&&(r.blockedOn=null)}for(;0<ol.length&&(t=ol[0],t.blockedOn===null);)Pp(t),t.blockedOn===null&&ol.shift();if(t=(e.ownerDocument||e).$$reactFormReplay,t!=null)for(r=0;r<t.length;r+=3){var l=t[r],s=t[r+1],p=l[un]||null;if(typeof s=="function")p||Xp(t);else if(p){var g=null;if(s&&s.hasAttribute("formAction")){if(l=s,p=s[un]||null)g=p.formAction;else if(ef(l)!==null)continue}else g=p.action;typeof g=="function"?t[r+1]=g:(t.splice(r,3),r-=3),Xp(t)}}}function Fp(){function e(s){s.canIntercept&&s.info==="react-transition"&&s.intercept({handler:function(){return new Promise(function(p){return l=p})},focusReset:"manual",scroll:"manual"})}function n(){l!==null&&(l(),l=null),r||setTimeout(t,20)}function t(){if(!r&&!navigation.transition){var s=navigation.currentEntry;s&&s.url!=null&&navigation.navigate(s.url,{state:s.getState(),info:"react-transition",history:"replace"})}}if(typeof navigation=="object"){var r=!1,l=null;return navigation.addEventListener("navigate",e),navigation.addEventListener("navigatesuccess",n),navigation.addEventListener("navigateerror",n),setTimeout(t,100),function(){r=!0,navigation.removeEventListener("navigate",e),navigation.removeEventListener("navigatesuccess",n),navigation.removeEventListener("navigateerror",n),l!==null&&(l(),l=null)}}}function tf(e){this._internalRoot=e}No.prototype.render=tf.prototype.render=function(e){var n=this._internalRoot;if(n===null)throw Error(i(409));var t=n.current,r=_t();Hp(t,r,e,n,null,null)},No.prototype.unmount=tf.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var n=e.containerInfo;Hp(e.current,2,null,e,null,null),ao(),n[Tn]=null}};function No(e){this._internalRoot=e}No.prototype.unstable_scheduleHydration=function(e){if(e){var n=on();e={blockedOn:null,target:e,priority:n};for(var t=0;t<ol.length&&n!==0&&n<ol[t].priority;t++);ol.splice(t,0,e),t===0&&Pp(e)}};var Kp=a.version;if(Kp!=="19.2.7")throw Error(i(527,Kp,"19.2.7"));Z.findDOMNode=function(e){var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(i(188)):(e=Object.keys(e).join(","),Error(i(268,e)));return e=y(n),e=e!==null?x(e):null,e=e===null?null:e.stateNode,e};var Yg={bundleType:0,version:"19.2.7",rendererPackageName:"react-dom",currentDispatcherRef:z,reconcilerVersion:"19.2.7"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var Ro=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!Ro.isDisabled&&Ro.supportsFiber)try{hl=Ro.inject(Yg),vn=Ro}catch{}}return Pi.createRoot=function(e,n){if(!u(e))throw Error(i(299));var t=!1,r="",l=tm,s=rm,p=lm;return n!=null&&(n.unstable_strictMode===!0&&(t=!0),n.identifierPrefix!==void 0&&(r=n.identifierPrefix),n.onUncaughtError!==void 0&&(l=n.onUncaughtError),n.onCaughtError!==void 0&&(s=n.onCaughtError),n.onRecoverableError!==void 0&&(p=n.onRecoverableError)),n=zp(e,1,!1,null,null,t,r,null,l,s,p,Fp),e[Tn]=n.current,zu(e),new tf(n)},Pi.hydrateRoot=function(e,n,t){if(!u(e))throw Error(i(299));var r=!1,l="",s=tm,p=rm,g=lm,E=null;return t!=null&&(t.unstable_strictMode===!0&&(r=!0),t.identifierPrefix!==void 0&&(l=t.identifierPrefix),t.onUncaughtError!==void 0&&(s=t.onUncaughtError),t.onCaughtError!==void 0&&(p=t.onCaughtError),t.onRecoverableError!==void 0&&(g=t.onRecoverableError),t.formState!==void 0&&(E=t.formState)),n=zp(e,1,!0,n,t??null,r,l,E,s,p,g,Fp),n.context=Up(null),t=n.current,r=_t(),r=Lr(r),l=Xr(r),l.callback=null,Fr(t,l,r),t=r,n.current.lanes=t,_l(n,t),tr(n),e[Tn]=n.current,zu(e),new No(n)},Pi.version="19.2.7",Pi}var ah;function e0(){if(ah)return af.exports;ah=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(a){console.error(a)}}return o(),af.exports=Jg(),af.exports}var n0=e0();const t0=Wh(n0),ih=o=>{let a;const c=new Set,i=(y,x)=>{const N=typeof y=="function"?y(a):y;if(!Object.is(N,a)){const R=a;a=x??(typeof N!="object"||N===null)?N:Object.assign({},a,N),c.forEach($=>$(a,R))}},u=()=>a,_={setState:i,getState:u,getInitialState:()=>v,subscribe:y=>(c.add(y),()=>c.delete(y))},v=a=o(i,u,_);return _},r0=(o=>o?ih(o):ih),l0=o=>o;function a0(o,a=l0){const c=Wi.useSyncExternalStore(o.subscribe,Wi.useCallback(()=>a(o.getState()),[o,a]),Wi.useCallback(()=>a(o.getInitialState()),[o,a]));return Wi.useDebugValue(c),c}const sh=o=>{const a=r0(o),c=i=>a0(a,i);return Object.assign(c,a),c},i0=(o=>o?sh(o):sh);function s0(){const o=new Uint8Array(16);if(typeof crypto<"u"&&crypto.getRandomValues)crypto.getRandomValues(o);else for(let c=0;c<o.length;c+=1)o[c]=Math.floor(Math.random()*256);let a="";for(const c of o)a+=c.toString(16).padStart(2,"0");return a}const Lf="pkp.user",Bf="pkp.savedDevices",zf="pkp.ideDrafts",Uf="pkp.ideSettings",ns="Prototype Version 0.6.7";function Uo(o){try{const a=localStorage.getItem(o);return a?JSON.parse(a):null}catch{return null}}function Ho(o,a){try{localStorage.setItem(o,JSON.stringify(a))}catch{}}function o0(){const o=Uo(Lf);return o&&typeof o.username=="string"&&typeof o.userID=="string"?o:null}function uf(o){Ho(Lf,o)}function Hf(){return Uo(Bf)??[]}function ts(o){Ho(Bf,o)}function c0(){ts([])}function u0(){try{localStorage.removeItem(Lf),localStorage.removeItem(Bf),localStorage.removeItem(zf),localStorage.removeItem(Uf)}catch{}}function ff(){var o;return((o=Uo(zf))==null?void 0:o.filter(a=>a.path&&typeof a.content=="string"))??[]}function df(o){Ho(zf,o)}function oh(){const o=Uo(Uf)??{};return{clearTerminalOnRun:!!o.clearTerminalOnRun,simplifiedErrors:o.simplifiedErrors!==!1}}function f0(o){Ho(Uf,o)}function mf(o){const a=Hf(),c=a.findIndex(i=>i.deviceID===o.deviceID);return c>=0?a[c]=o:a.push(o),ts(a),a}function d0(o){const a=Hf().filter(c=>c.deviceID!==o);return ts(a),a}const Sf="b8e06067-62ad-41ba-9231-206ae80ab551",m0="f897177b-aee8-4767-8ecc-cc694fd5fce0",p0="f897177b-aee8-4767-8ecc-cc694fd5fce1",pf=20,h0=12,_0=new TextEncoder,g0=new TextDecoder;function b0(o){return new Promise(a=>setTimeout(a,o))}function Vo(){return typeof navigator<"u"&&"bluetooth"in navigator}function Ef(o){return o?o.startsWith("PicoW-")?o.slice(6):o:"Pico"}async function y0(){if(!Vo())throw new Error("Web Bluetooth er ikke tilgængelig i denne browser.");return navigator.bluetooth.requestDevice({filters:[{services:[Sf]},{namePrefix:"PicoW-"}],optionalServices:[Sf]})}async function Jh(){if(!Vo()||!navigator.bluetooth.getDevices)return[];try{return await navigator.bluetooth.getDevices()}catch{return[]}}class v0{constructor(){ue(this,"device",null);ue(this,"writeChar",null);ue(this,"notifyChar",null);ue(this,"buffer","");ue(this,"writeQueue",Promise.resolve());ue(this,"disconnectNotified",!1);ue(this,"onLine",()=>{});ue(this,"onDisconnect",()=>{});ue(this,"handleNotification",a=>{const c=a.target;if(!(c!=null&&c.value))return;this.buffer+=g0.decode(c.value.buffer);let i=this.buffer.indexOf(`
`);for(;i>=0;){const u=this.buffer.slice(0,i).trim();this.buffer=this.buffer.slice(i+1),u&&this.onLine(u),i=this.buffer.indexOf(`
`)}});ue(this,"handleDisconnected",()=>{var a;this.disconnectNotified||(this.disconnectNotified=!0,(a=this.device)==null||a.removeEventListener("gattserverdisconnected",this.handleDisconnected),this.writeChar=null,this.notifyChar=null,this.onDisconnect())})}get connected(){var a,c;return!!((c=(a=this.device)==null?void 0:a.gatt)!=null&&c.connected)}async connect(a){var u;this.device&&this.device!==a&&this.device.removeEventListener("gattserverdisconnected",this.handleDisconnected),this.device=a,this.buffer="",this.disconnectNotified=!1,a.removeEventListener("gattserverdisconnected",this.handleDisconnected),a.addEventListener("gattserverdisconnected",this.handleDisconnected);const c=await((u=a.gatt)==null?void 0:u.connect());if(!c)throw new Error("Kunne ikke åbne Bluetooth-forbindelsen.");const i=await c.getPrimaryService(Sf);this.writeChar=await i.getCharacteristic(m0),this.notifyChar=await i.getCharacteristic(p0),await this.notifyChar.startNotifications(),this.notifyChar.addEventListener("characteristicvaluechanged",this.handleNotification)}writeLine(a){const c=this.writeQueue.then(()=>this.doWrite(a));return this.writeQueue=c.catch(()=>{}),c}async doWrite(a){if(!this.writeChar)throw new Error("Ingen forbindelse.");const c=_0.encode(`${a}
`),u=this.writeChar.properties.writeWithoutResponse&&typeof this.writeChar.writeValueWithoutResponse=="function"?this.writeChar.writeValueWithoutResponse.bind(this.writeChar):this.writeChar.writeValue.bind(this.writeChar);for(let d=0;d<c.length;d+=pf){const h=c.slice(d,d+pf);await u(h),d+pf<c.length&&await b0(h0)}}disconnect(){var c;const a=this.device;(c=a==null?void 0:a.gatt)!=null&&c.connected?a.gatt.disconnect():this.handleDisconnected()}}class x0{constructor(a,c){ue(this,"send");ue(this,"onMessage");ue(this,"inActive",!1);ue(this,"inExpectedTotal",0);ue(this,"inStreamId",0);ue(this,"inParts",new Map);ue(this,"inProgress",null);ue(this,"outPendingLines",null);ue(this,"outWaitingAck",!1);ue(this,"outStreamId",0);ue(this,"outNextStreamId",1);ue(this,"outCache",new Map);ue(this,"outProgress",null);ue(this,"outResolve",null);ue(this,"outReject",null);this.send=a,this.onMessage=c}reset(){this.inActive=!1,this.inExpectedTotal=0,this.inStreamId=0,this.inParts.clear(),this.inProgress=null,this.outPendingLines=null,this.outWaitingAck=!1,this.outStreamId=0,this.outCache.clear(),this.outProgress=null,this.outResolve=null,this.outReject=null}handleLine(a){var i;if(a.startsWith("prep,")){const u=a.split(","),d=u.length>=2&&/^\d+$/.test(u[1])?parseInt(u[1],10):null,h=u.length>=3&&/^\d+$/.test(u[2])?parseInt(u[2],10):0;d!==null&&d>0&&(this.inActive=!0,this.inExpectedTotal=d,this.inStreamId=h,this.inParts.clear(),this.send(h>0?`ack:prep,${h}`:"ack:prep"));return}if(a==="ack:prep"||a===`ack:prep,${this.outStreamId}`){this.flushOutbound();return}if(a.startsWith("miss,")){const u=a.split(",");if(u.length>=3&&/^\d+$/.test(u[1])&&/^\d+$/.test(u[2])){const d=parseInt(u[1],10),h=parseInt(u[2],10),_=this.outCache.get(h);d===this.outStreamId&&_&&this.send(_)}return}const c=this.parseNumbered(a);if(c){const{idx:u,payload:d}=c;if(!this.inActive){this.onMessage(d);return}this.inParts.has(u)||(this.inParts.set(u,d),(i=this.inProgress)==null||i.call(this,this.inParts.size,this.inExpectedTotal));let h=0;for(let _=1;_<=this.inExpectedTotal;_+=1)if(!this.inParts.has(_)){h=_;break}if(h>0&&this.inStreamId>0&&u>h&&this.send(`miss,${this.inStreamId},${h}`),this.inParts.size>=this.inExpectedTotal){for(let _=1;_<=this.inExpectedTotal;_+=1){const v=this.inParts.get(_);v!==void 0&&this.onMessage(v)}this.inActive=!1,this.inExpectedTotal=0,this.inStreamId=0,this.inParts.clear()}return}this.onMessage(a)}setInboundProgress(a){this.inProgress=a}async sendReliable(a,c){if(this.outPendingLines!==null||this.outWaitingAck)throw new Error("Reliable stream is already sending.");const i=a.length===0?[""]:a;this.outPendingLines=[...i],this.outWaitingAck=!0,this.outProgress=c??null,this.outStreamId=this.outNextStreamId,this.outNextStreamId+=1,this.outCache.clear();const u=new Promise((d,h)=>{this.outResolve=d,this.outReject=h});try{await this.send(`prep,${i.length},${this.outStreamId}`)}catch(d){throw this.outResolve=null,this.outReject=null,this.outPendingLines=null,this.outWaitingAck=!1,this.outProgress=null,d}await u}async flushOutbound(){var a,c,i,u;if(!this.outWaitingAck||this.outPendingLines===null){this.outWaitingAck=!1,this.outProgress=null,(a=this.outResolve)==null||a.call(this),this.outResolve=null,this.outReject=null;return}try{const d=this.outPendingLines.length;for(let h=0;h<d;h+=1){const _=this.outPendingLines[h],v=`${h+1}-${_}`;this.outCache.set(h+1,v),await this.send(v),(c=this.outProgress)==null||c.call(this,h+1,d,_)}(i=this.outResolve)==null||i.call(this)}catch(d){(u=this.outReject)==null||u.call(this,d)}finally{this.outResolve=null,this.outReject=null,this.outPendingLines=null,this.outWaitingAck=!1,this.outProgress=null}}parseNumbered(a){const c=a.indexOf("-");if(c<=0)return null;const i=a.slice(0,c);if(!/^\d+$/.test(i))return null;const u=parseInt(i,10);return u<1?null:{idx:u,payload:a.slice(c+1)}}}const Ya=11,rs=31,w0=2,S0=60,Ha=4,Va=40;function E0(o,a){return Math.max(14,Math.min(56,Math.min(o,a)*.05))}function e_(o,a,c=Ya,i=rs){const u=E0(o,a),d=Math.max(1,o-2*u),h=Math.max(1,a-2*u);return{areaW:o,areaH:a,cols:c,rows:i,margin:u,stepX:d/Math.max(1,c-1),stepY:h/Math.max(1,i-1)}}function n_(o,a){return a.margin+o/2*a.stepX}function t_(o,a){const c=a.margin+o/2*a.stepY;return a.areaH-c}function Ji(o,a){return o.centerX2===null||o.centerY2===null||o.spanX===null||o.spanY===null?null:{cx:n_(o.centerX2,a),cy:t_(o.centerY2,a),width:o.spanX*a.stepX,height:o.spanY*a.stepY}}function k0(o){const a=[];for(let c=0;c<o.cols;c+=1)for(let i=0;i<o.rows;i+=1)a.push({x:o.margin+c*o.stepX,y:o.areaH-(o.margin+i*o.stepY)});return a}function jo(o,a,c,i,u){const d=(v,y,x,N)=>{const R=y%2,$=N*2;let I=R,J=1/0;for(let K=R;K<=$;K+=2){const G=Math.abs(x(K)-v);G<J&&(J=G,I=K)}return Math.max(y,Math.min($-y,I))},h=d(o,c,v=>n_(v,u),u.cols-1),_=d(a,i,v=>t_(v,u),u.rows-1);return{centerX2:h,centerY2:_}}const Fl=6e3,N0=15,Co=[32,64,128,192],R0=Fl*10,M0=3500,T0=8e3,j0=2,A0=Fl,D0=Fl*8;function hf(o){return new Promise(a=>setTimeout(a,o))}function La(o){if(o!=null&&o.aborted)throw new DOMException("BLE file read cancelled","AbortError")}function ch(o){return o instanceof DOMException&&o.name==="AbortError"}function ul(o){return o.replace(/[\r\n,]/g," ").trim()}class O0{constructor(a={}){ue(this,"transport",new v0);ue(this,"stream");ue(this,"events");ue(this,"waiters",[]);ue(this,"collectingLayout",!1);ue(this,"layoutBuffer",[]);ue(this,"layoutResolve",null);ue(this,"collectingLines",!1);ue(this,"lineBuffer",[]);ue(this,"lineResolve",null);ue(this,"lineReject",null);ue(this,"lineCollectId",0);ue(this,"controlPumpActive",!1);ue(this,"pendingButtons",[]);ue(this,"pendingSliders",new Map);ue(this,"pendingToggles",new Map);ue(this,"pendingJoysticks",new Map);ue(this,"pendingDpads",[]);ue(this,"expectingDisconnect",!1);ue(this,"disconnectMessage",null);ue(this,"busy",!1);ue(this,"fsCapabilities",null);this.events=a,this.stream=new x0(c=>this.transport.writeLine(c),c=>this.onDeviceMessage(c)),this.transport.onLine=c=>this.stream.handleLine(c),this.transport.onDisconnect=()=>this.handleDisconnect()}get device(){return this.transport.device}get deviceName(){var a;return Ef((a=this.transport.device)==null?void 0:a.name)}get connected(){return this.transport.connected}setBusy(a){if(this.busy=a,a){this.pendingButtons=[],this.pendingSliders.clear(),this.pendingToggles.clear(),this.pendingJoysticks.clear(),this.pendingDpads=[];return}this.pumpControls()}log(a,c){var i,u;(u=(i=this.events).onLog)==null||u.call(i,a,c)}progress(a,c){var i,u;(u=(i=this.events).onProgress)==null||u.call(i,a,c)}onDeviceMessage(a){var i,u;if(a==="disconnect"||a==="disconnect_private"){const d=a==="disconnect_private"?"Du blev afbrudt, fordi enheden er privat, og andre brugere ikke må forbinde.":"Enheden afbrød forbindelsen.";this.disconnectMessage=d,this.log("warning",d),this.expectingDisconnect=!0,this.transport.disconnect();return}if(this.collectingLines){if(a==="__END__"){const d=this.lineBuffer;this.lineBuffer=[],this.collectingLines=!1,(i=this.lineResolve)==null||i.call(this,d),this.lineResolve=null;return}this.lineBuffer.push(a);return}if(this.collectingLayout){if(a==="__END__"){const d=this.layoutBuffer;this.layoutBuffer=[],this.collectingLayout=!1,(u=this.layoutResolve)==null||u.call(this,d),this.layoutResolve=null;return}!a.startsWith("ACK")&&!a.startsWith("ERR")&&!a.startsWith("#VERSION")?this.layoutBuffer.push(a):a.startsWith("#VERSION")&&this.layoutBuffer.push(a);return}a.startsWith("ERR")?this.log("error",a):a.startsWith("radar,")?this.handleRadarLine(a):a.startsWith("text,")?this.handleTextLine(a):a.startsWith("toggle_state,")?this.handleToggleStateLine(a):a.startsWith("ACK")||a==="LAYOUT_SAVED"||a.startsWith("READY")?this.log("success",a):this.log("info",`rx: ${a}`);const c=this.waiters.findIndex(d=>d.match(a));if(c>=0){const d=this.waiters[c];this.waiters.splice(c,1),clearTimeout(d.timer),d.resolve(a)}}waitFor(a,c,i){return new Promise((u,d)=>{const h=setTimeout(()=>{const _=this.waiters.findIndex(v=>v.timer===h);_>=0&&this.waiters.splice(_,1),d(new Error(`Timeout: ${i}`))},c);this.waiters.push({match:a,resolve:u,reject:d,timer:h})})}async collectLines(a,c,i,u,d){La(u);const h=this.lineCollectId+1;this.lineCollectId=h,this.collectingLines=!0,this.lineBuffer=[],this.stream.setInboundProgress(d??null);const _=new Promise((v,y)=>{let x=!1;const N=()=>this.lineCollectId===h,R=()=>{x=!0,N()&&(this.lineReject=null,this.stream.setInboundProgress(null)),u==null||u.removeEventListener("abort",I)},$=G=>{x||(clearTimeout(J),N()&&(this.collectingLines=!1,this.lineBuffer=[],this.lineResolve=null),R(),y(G))},I=()=>{$(new DOMException("BLE file read cancelled","AbortError"))},J=setTimeout(()=>{N()&&$(new Error(`Timeout: ${i}`))},c);this.lineResolve=v,this.lineReject=$;const K=this.lineResolve;this.lineResolve=G=>{N()&&(clearTimeout(J),R(),K==null||K(G))},u==null||u.addEventListener("abort",I,{once:!0})});return await this.transport.writeLine(a),_}async exchange(a,c,i,u=3){let d;for(let h=1;h<=u;h+=1)try{return await this.transport.writeLine(a),await this.waitFor(c,Fl,i)}catch(_){d=_,this.log("warning",`${i}: forsøg ${h}/${u} mislykkedes`)}throw d instanceof Error?d:new Error(`Failed: ${i}`)}async connect(a){this.expectingDisconnect=!1,this.stream.reset(),this.progress(5,"Forbinder til Bluetooth..."),await this.transport.connect(a)}async runHandshake(a){var ae;await hf(350),this.progress(18,"Klargør forbindelse..."),this.progress(26,"Sender HELLO..."),await this.exchange("HELLO",le=>le==="ACK:HELLO","HELLO"),this.progress(34,"Forbindelse bekræftet"),this.progress(44,"Spørger om ejerskab...");const c=await this.exchange("who_are_you",le=>le==="unowned"||le.startsWith("owned,"),"who_are_you");if(this.progress(56,"Ejerskab modtaget"),c==="unowned")return{kind:"unowned"};const i=c.split(","),u=i[1]??"",d=i[2]!==void 0&&parseInt(i[2],10)||0,h=i[3]!==void 0?parseInt(i[3],10)===1:!0,_=i[4]!==void 0?parseInt(i[4],10)===1:!1,v=i.length>=7,y=v?parseInt(i[5]??"0",10)===1:_,x=((ae=i[v?6:5])==null?void 0:ae.trim())||void 0;await this.exchange("ACK:ownership",le=>le==="READY:permission","ACK:ownership",1),this.progress(66,"Anmoder om adgang...");const N=await this.exchange(`request_permission,${a.userID},${ul(a.username)}`,le=>le.startsWith("perm,"),"request_permission");this.progress(76,"Adgang vurderet");const R=N.split(",").filter(le=>/^\d+$/.test(le)),$=R.length>=1?parseInt(R[0]??"0",10):0,I=R.length>=2?parseInt(R[1]??"0",10):0,J=R.length>=3?parseInt(R[2]??"0",10):I;if($===0)return this.expectingDisconnect=!0,this.disconnectMessage="Du kan ikke forbinde, fordi enheden er privat, og andre brugere ikke må forbinde.",{kind:"denied",ownerName:x,canOthersConnect:h};const K=a.userID===u,G=I===1||K,H=J===1||K;return await this.transport.writeLine("ACK:permission"),{kind:"owned",ownerID:u,ownerName:x,iconID:d,canEdit:G,canEditCode:H,isOwnedByMe:K,canOthersConnect:h,canOthersEdit:_,canOthersEditCode:y}}async create(a,c,i,u,d,h,_){const v=i?1:0,y=i&&u?1:0,x=i&&d?1:0;await this.exchange(`create,${a.userID},${ul(a.username)},${c},${v},${y},${x},${h},${_}`,N=>N==="ACK:create","create")}async updateDeviceSettings(a,c,i,u,d,h,_){const v=c?1:0,y=c&&i?1:0,x=c&&u?1:0;await this.exchange(`settings_update,${a},${v},${y},${x},${d},${h},${ul(_??"")}`,N=>N==="ACK:settings_update","settings_update",3)}async requestLayout(){this.progress(84,"Henter kontrolpanel..."),this.collectingLayout=!0,this.layoutBuffer=[];const a=new Promise((i,u)=>{this.layoutResolve=i;const d=setTimeout(()=>{this.collectingLayout&&(this.collectingLayout=!1,this.layoutResolve=null,u(new Error("Timeout: layout")))},Fl*2),h=this.layoutResolve;this.layoutResolve=_=>{clearTimeout(d),h==null||h(_)}});await this.transport.writeLine("request"),this.progress(92,"Modtager kontrolpanel...");const c=await a;return this.progress(100,"Klar"),c}async saveLayout(a){await this.exchange("update",u=>u==="ACK:update","update",3).catch(()=>{this.log("warning","ACK:update udeblev (fortsætter).")});const c=a.map(u=>{const d=_=>_===null?"n":String(_),h=`update,${u.type},${u.name},${d(u.centerX2)},${d(u.centerY2)},${d(u.spanX)},${d(u.spanY)},${u.rotation}`;return u.type==="slider"?`${h},${u.sliderMin??0},${u.sliderMax??100},${u.sliderRecenter??"none"}`:u.type==="toggle"?`${h},${u.toggleInitial?1:0}`:u.type==="radar"?[h,u.radarMinAngle??0,u.radarMaxAngle??180,u.radarMaxDistance??200,u.radarFadeMs??1200].join(","):u.type==="joystick"?[h,u.joystickXMin??-100,u.joystickXMax??100,u.joystickYMin??-100,u.joystickYMax??100,u.joystickXRecenter??"middle",u.joystickYRecenter??"middle"].join(","):h});c.push("__END__");const i=this.waitFor(u=>u==="LAYOUT_SAVED",Fl*2,"LAYOUT_SAVED");await this.stream.sendReliable(c),await i}async listFiles(a="/"){return(await this.collectLines(`fs_list,${ul(a)}`,Fl*3,"fs_list")).filter(i=>i.startsWith("fs_entry,")).map(i=>{const[,u,d,h]=i.split(","),_=u==="file"||u==="dir"?u:"unknown",v=parseInt(h??"",10),y=d||"/";return{name:y.split("/").filter(Boolean).pop()??y,path:y,type:_,...Number.isFinite(v)&&v>=0?{size:v}:{}}})}handleRadarLine(a){var h,_,v;const c=a.split(",");if(c.length<4)return;const i=(h=c[1])==null?void 0:h.trim(),u=parseFloat(c[2]??""),d=parseFloat(c[3]??"");!i||!Number.isFinite(u)||!Number.isFinite(d)||((v=(_=this.events).onRadar)==null||v.call(_,i,u,d),this.log("info",`rx: ${a}`))}handleTextLine(a){var _,v;const c=a.indexOf(","),i=c>=0?a.indexOf(",",c+1):-1;if(c<0||i<0)return;const u=a.slice(c+1,i),d=a.slice(i+1),h=u==null?void 0:u.trim();h&&((v=(_=this.events).onText)==null||v.call(_,h,d),this.log("info",`rx: ${a}`))}handleToggleStateLine(a){var d,h,_;const c=a.split(",");if(c.length<3)return;const i=(d=c[1])==null?void 0:d.trim(),u=parseInt(c[2]??"",10);!i||!Number.isFinite(u)||((_=(h=this.events).onToggleState)==null||_.call(h,i,u===1),this.log("info",`rx: ${a}`))}async readText(a,c,i){c==null||c(4,"Validerer Picoens Bluetooth-filsystem...");const u=await this.getFilesystemCapabilities(i);if(u.streamRead)try{return await this.readTextStream(a,u,c,i)}catch(d){if(i!=null&&i.aborted||ch(d)||!u.pageRead)throw d;this.log("warning",d instanceof Error?`fs_read_stream fejlede; bruger paged read: ${d.message}`:"fs_read_stream fejlede; bruger paged read")}return this.readTextPaged(a,c,i)}async getFilesystemCapabilities(a){if(this.fsCapabilities)return this.fsCapabilities;const c=await this.collectLines("fs_capabilities",A0,"fs_capabilities",a),i=c.find(x=>x.startsWith("ERR"));if(i)throw new Error(i);const u=c.find(x=>x.startsWith("fs_capabilities,"));if(!u)throw new Error("Kunne ikke validere Picoens Bluetooth-filsystem. Runtime sendte ikke fs_capabilities.");const d=u.split(","),h=new Map;for(let x=1;x<d.length-1;x+=2)h.set(d[x],d[x+1]);const _=parseInt(h.get("max_page")??"",10),v=parseInt(h.get("stream_chunk")??"",10),y={version:h.get("version")||void 0,pageRead:h.get("page_read")==="1",maxPageSize:Number.isFinite(_)&&_>0?_:32,streamRead:h.get("stream_read")==="1",streamChunkSize:Number.isFinite(v)&&v>0?v:128};if(!y.pageRead&&!y.streamRead)throw new Error("Picoens Bluetooth-runtime meldte, at file-read ikke er understøttet.");return this.fsCapabilities=y,y}async readTextPaged(a,c,i){const u=await this.getFilesystemCapabilities(i);let d=0,h=C0(u.maxPageSize),_=0,v=null,y="";const x=`Indlæser ${_f(a)}...`;La(i),c==null||c(5,x);for(let N=0;N<512;N+=1){La(i),_===0&&(c==null||c(7,x));const $=await this.readPageWithRetry(a,_,d,h,i),I=$.lines;d=$.nextPageSizeIndex,h=$.maxPageSizeIndex,La(i);const J=I.find(ee=>ee.startsWith("ERR"));if(J)throw new Error(J);const K=I.find(ee=>ee.startsWith("fs_page,"));if(!K)throw new Error("ERR: fs_read_page missing data");const[,G,H,ae,le=""]=K.split(",",5);if(G!==a)throw new Error("ERR: fs_read_page stale data");const se=parseInt(H??"",10),he=parseInt(ae??"",10);if(!Number.isFinite(se)||se!==_||!Number.isFinite(he))throw new Error("ERR: fs_read_page invalid data");v=he,y+=le,_+=Math.floor(le.length/2);const ne=v>0?8+Math.min(87,Math.round(_/v*87)):95;if(c==null||c(ne,x),_>=v||le.length===0)return c==null||c(100,"Fil indlæst fra Pico"),new TextDecoder().decode(fh(y))}throw new Error("ERR: fs_read_page too many pages")}async readPageWithRetry(a,c,i,u,d){let h,_=Math.min(i,u);for(;_>=0;){const v=Co[_],y=_===0?j0:1,x=_===0?T0:M0;for(let N=1;N<=y;N+=1){La(d);try{return{lines:await this.collectLines(`fs_read_page,${ul(a)},${c},${v}`,x,`fs_read_page ${c}`,d),nextPageSizeIndex:Math.min(_+1,u),maxPageSizeIndex:u}}catch(R){if(d!=null&&d.aborted||ch(R))throw R;if(h=R,N<y||_>0){const I=_>0&&N>=y?Co[_-1]:v;this.log("warning",`fs_read_page ${c} (${v} bytes) fejlede; prøver ${I} bytes`),await hf(80+N*80)}}}if(_===0)break;u=Math.max(0,_-1),_=u}throw h instanceof Error?h:new Error(`Timeout: fs_read_page ${c}`)}async readTextStream(a,c,i,u){const d=`Indlæser ${_f(a)}...`,h=Math.max(16,Math.min(192,c.streamChunkSize||128));i==null||i(5,d);const _=await this.collectLines(`fs_read_stream,${ul(a)},${h}`,D0,`fs_read_stream ${a}`,u,(ne,ee)=>{const xe=8+Math.round(Math.min(ne,ee)/Math.max(1,ee)*87);i==null||i(Math.min(95,xe),d)});La(u);const v=_.find(ne=>ne.startsWith("ERR"));if(v)throw new Error(v);const y=_.find(ne=>ne.startsWith("fs_stream_begin,")),x=_.find(ne=>ne.startsWith("fs_stream_end,"));if(!y||!x)throw new Error("ERR: fs_read_stream missing metadata");const[,N,R]=y.split(",",4),[,$,I,J]=x.split(",",4),K=parseInt(R??"",10),G=parseInt(I??"",10),H=parseInt(J??"",10);if(N!==a||$!==a||!Number.isFinite(K)||K!==G||!Number.isFinite(H))throw new Error("ERR: fs_read_stream invalid metadata");let ae=0,le="";for(const ne of _){if(!ne.startsWith("fs_stream_chunk,"))continue;const[,ee,xe=""]=ne.split(",",3),ge=parseInt(ee??"",10);if(!Number.isFinite(ge)||ge!==ae||xe.length%2!==0)throw new Error("ERR: fs_read_stream invalid chunk");le+=xe,ae+=Math.floor(xe.length/2)}if(ae!==K)throw new Error("ERR: fs_read_stream size mismatch");const se=fh(le);if(uh(se)!==H)throw new Error("ERR: fs_read_stream checksum mismatch");return i==null||i(100,"Fil indlæst fra Pico"),new TextDecoder().decode(se)}async writeText(a,c,i){i==null||i(5,"Klargør BLE-overførsel..."),await this.exchange(`fs_write_begin,${ul(a)}`,x=>x==="ACK:fs_write_begin","fs_write_begin",2),i==null||i(18,"Pico er klar til filen...");const u=new TextEncoder().encode(c),d=[...u].map(x=>x.toString(16).padStart(2,"0")).join(""),h=[];for(let x=0;x<d.length;x+=160)h.push(`fs_write_chunk,${d.slice(x,x+160)}`);h.push("fs_write_end");const _=uh(u),v=this.waitFor(x=>x==="ACK:fs_write_done"||x.startsWith("ACK:fs_write_done,")||x.startsWith("ERR"),R0,"fs_write_done");i==null||i(u.length===0?85:18,u.length===0?"Sender tom fil via Bluetooth...":`Sender 0/${u.length} bytes via Bluetooth...`),await this.stream.sendReliable(h,(x,N,R)=>{if(!R.startsWith("fs_write_chunk,"))return;const $=Math.min(u.length,x*80),I=18+Math.round(x/Math.max(1,N-1)*67);i==null||i(Math.min(85,I),`Sender ${$}/${u.length} bytes via Bluetooth...`)}),i==null||i(90,"Verificerer BLE-fil...");const y=await v;if(y.startsWith("ERR"))throw new Error(y);if(y.startsWith("ACK:fs_write_done,")){const[,x,N]=y.split(",",3),R=parseInt(x??"",10),$=parseInt(N??"",10);if(R!==u.length||$!==_)throw new Error(`ERR: BLE-verificering fejlede for ${_f(a)}.`)}i==null||i(100,"Gemt på Pico")}async deleteFile(a){const c=await this.exchange(`fs_delete,${ul(a)}`,i=>i==="ACK:fs_delete"||i.startsWith("ERR"),"fs_delete",2);if(c.startsWith("ERR"))throw new Error(c)}async restart(){await this.exchange("restart",a=>a==="ACK:restart"||a.startsWith("ERR"),"restart",1).catch(()=>{}),this.expectingDisconnect=!0}enqueueButton(a,c){this.busy||(this.pendingButtons.push(`button,${a}:${c?"down":"up"}`),this.pumpControls())}enqueueSlider(a,c){this.busy||(this.pendingSliders.set(a,`slider,${a}:${c}`),this.pumpControls())}enqueueToggle(a,c){this.busy||(this.pendingToggles.set(a,`toggle,${a}:${c?1:0}`),this.pumpControls())}enqueueJoystick(a,c,i){this.busy||(this.pendingJoysticks.set(a,`joystick,${a}:${Math.round(c)},${Math.round(i)}`),this.pumpControls())}enqueueDpad(a,c,i){this.busy||(this.pendingDpads.push(`dpad,${a}:${c},${i?"down":"up"}`),this.pumpControls())}pumpControls(){this.controlPumpActive||this.busy||!this.transport.connected||(this.controlPumpActive=!0,this.drainControls())}async drainControls(){try{for(;!this.busy&&this.transport.connected;){const a=this.nextControlLine();if(!a)break;await this.transport.writeLine(a),this.log("info",`tx: ${a}`),await hf(N0)}}catch(a){this.log("error",a instanceof Error?a.message:"Kunne ikke sende kommando."),this.handleDisconnect()}finally{this.controlPumpActive=!1,!this.busy&&this.transport.connected&&this.hasPendingControls()&&this.pumpControls()}}nextControlLine(){const a=this.pendingButtons.shift();if(a)return a;const c=this.pendingDpads.shift();if(c)return c;const i=this.pendingSliders.entries().next();if(!i.done){const[h,_]=i.value;return this.pendingSliders.delete(h),_}const u=this.pendingToggles.entries().next();if(!u.done){const[h,_]=u.value;return this.pendingToggles.delete(h),_}const d=this.pendingJoysticks.entries().next();if(!d.done){const[h,_]=d.value;return this.pendingJoysticks.delete(h),_}return null}hasPendingControls(){return this.pendingButtons.length>0||this.pendingDpads.length>0||this.pendingSliders.size>0||this.pendingToggles.size>0||this.pendingJoysticks.size>0}async disconnect(){if(!this.transport.connected){this.handleDisconnect();return}this.expectingDisconnect=!0;try{await this.exchange("disconnect",a=>a==="ACK:disconnect","disconnect",1)}catch{}this.transport.disconnect()}handleDisconnect(){var c,i,u;for(const d of this.waiters)clearTimeout(d.timer),d.reject(new Error("Forbindelsen blev afbrudt."));this.waiters=[],this.collectingLayout=!1,this.layoutResolve=null,(c=this.lineReject)==null||c.call(this,new Error("Forbindelsen blev afbrudt.")),this.collectingLines=!1,this.lineResolve=null,this.lineReject=null,this.fsCapabilities=null,this.stream.reset();const a=this.disconnectMessage??void 0;this.disconnectMessage=null,(u=(i=this.events).onDisconnect)==null||u.call(i,a)}}function C0(o){let a=0;for(let c=0;c<Co.length;c+=1)Co[c]<=o&&(a=c);return a}function _f(o){return o.replace(/\\/g,"/").replace(/^\/+/,"")||o}function uh(o){let a=0;for(const c of o)a=a+c>>>0;return a}function fh(o){const a=new Uint8Array(Math.floor(o.length/2));for(let c=0;c<a.length;c+=1)a[c]=parseInt(o.slice(c*2,c*2+2),16);return a}function dh(o){const a=(c,i)=>Number.isFinite(c)?Math.max(w0,Math.min(S0,c)):i;for(const c of o){const i=c.trim();if(i.startsWith("#GRID,")){const u=i.split(","),d=a(parseInt(u[1],10),Ya),h=a(parseInt(u[2],10),rs);return{cols:d,rows:h}}}return{cols:Ya,rows:rs}}function mh(o){const a=new Map;for(const c of o){const i=c.trim();if(!i||i.startsWith("#VERSION")||i==="__END__")continue;const u=i.split(",");if(u.length<7)continue;const[d,h,_,v,y,x,N,R,$,I,J,K,G]=u;if(d!=="button"&&d!=="slider"&&d!=="toggle"&&d!=="radar"&&d!=="text"&&d!=="joystick"&&d!=="dpad"||a.has(h))continue;const H=Z=>{if(Z==="n")return null;const oe=parseInt(Z,10);return Number.isNaN(oe)?null:oe},ae=parseInt(N,10)||0,le=R!==void 0?parseInt(R,10):0,se=$!==void 0?parseInt($,10):100,he=["none","bottom","middle","top"].includes(I??"")?I:"none",ne=R!==void 0?parseInt(R,10)===1:!1,ee=R!==void 0?parseFloat(R):0,xe=$!==void 0?parseFloat($):180,ge=I!==void 0?parseFloat(I):200,ye=J!==void 0?parseInt(J,10):1200,ie=(Z,oe)=>["none","bottom","middle","top"].includes(Z??"")?Z:oe,Ve=R!==void 0?parseInt(R,10):-100,Re=$!==void 0?parseInt($,10):100,Pe=I!==void 0?parseInt(I,10):-100,z=J!==void 0?parseInt(J,10):100;a.set(h,{type:d,name:h,centerX2:H(_),centerY2:H(v),spanX:H(y),spanY:H(x),rotation:[0,90,180,270].includes(ae)?ae:0,...d==="slider"?{sliderMin:Number.isFinite(le)?le:0,sliderMax:Number.isFinite(se)?se:100,sliderRecenter:he}:{},...d==="toggle"?{toggleInitial:ne}:{},...d==="radar"?{radarMinAngle:Number.isFinite(ee)?ee:0,radarMaxAngle:Number.isFinite(xe)?xe:180,radarMaxDistance:Number.isFinite(ge)&&ge>0?ge:200,radarFadeMs:Number.isFinite(ye)&&ye>0?ye:1200}:{},...d==="joystick"?{joystickXMin:Number.isFinite(Ve)?Ve:-100,joystickXMax:Number.isFinite(Re)&&Re!==Ve?Re:100,joystickYMin:Number.isFinite(Pe)?Pe:-100,joystickYMax:Number.isFinite(z)&&z!==Pe?z:100,joystickXRecenter:ie(K,"middle"),joystickYRecenter:ie(G,"middle")}:{}})}return[...a.values()]}let re=null,$i=null,ph=0,Mr=!1;function L0(){return new Date().toLocaleTimeString("da-DK",{hour12:!1})}function hh(o){return new Promise(a=>setTimeout(a,o))}function B0(o){return Object.fromEntries(o.filter(a=>a.type==="toggle").map(a=>[a.name,!!a.toggleInitial]))}function _h(o,a){const c=B0(o);for(const i of o)i.type==="toggle"&&a[i.name]!==void 0&&(c[i.name]=a[i.name]);return c}const te=i0((o,a)=>{function c(u,d){o(h=>({logs:[{level:u,message:d,time:L0()},...h.logs].slice(0,200)}))}function i(u){$i&&clearTimeout($i),ph+=1,o({toast:{message:u,id:ph}}),$i=setTimeout(()=>o({toast:null}),4500)}return re=new O0({onProgress:(u,d)=>o({progress:{value:u,label:d}}),onLog:(u,d)=>c(u,d),onRadar:(u,d,h)=>{const _=Date.now(),v={id:`${_}-${Math.random().toString(36).slice(2)}`,angle:d,distance:h,createdAt:_};o(y=>{const x=y.layout.find($=>$.type==="radar"&&$.name===u),N=(x==null?void 0:x.radarFadeMs)??1200,R=y.radarPings[u]??[];return{radarPings:{...y.radarPings,[u]:[...R.filter($=>_-$.createdAt<=N),v].slice(-80)}}})},onText:(u,d)=>{o(h=>({textValues:{...h.textValues,[u]:d}}))},onToggleState:(u,d)=>{o(h=>({toggleValues:{...h.toggleValues,[u]:d}}))},onDisconnect:u=>{const{screen:d,active:h,picoIdeOrigin:_}=a();if(Mr){Mr=!1;return}if(u&&(c("warning",u),i(u)),d==="control"||d==="connection"||d==="create"||d==="ide"&&_==="control"){const v=h?{deviceID:h.deviceID,deviceName:h.deviceName,deviceIconID:h.iconID,canOthersConnect:h.canOthersConnect,canOthersEdit:h.canOthersEdit,canOthersEditCode:h.canOthersEditCode,isOwnedByMe:h.isOwnedByMe,ownerName:h.ownerName}:null;o({screen:"dashboard",active:null,layout:[],sliderValues:{},toggleValues:{},radarPings:{},textValues:{},editMode:!1,sideMenuOpen:!1,menuPage:null,connectionLost:v})}}}),{screen:"splash",splashTarget:null,user:null,savedDevices:[],connecting:null,progress:{value:0,label:""},toast:null,confirmDialog:null,connectionLost:null,active:null,layout:[],sliderValues:{},toggleValues:{},radarPings:{},textValues:{},logs:[],sideMenuOpen:!1,debuggerOpen:!1,menuPage:null,editMode:!1,dashboardPage:"mine",picoIdeOrigin:"dashboard",init:()=>{const u=o0(),d=Hf();o({user:u,savedDevices:d,splashTarget:u?"dashboard":"intro"})},finishSplash:()=>{const u=a().splashTarget;o({screen:u??"intro"})},createUser:u=>{const d=u.trim();if(!d)return;const h={username:d,userID:s0()};uf(h),o({user:h,screen:"dashboard"})},findDevice:async()=>{try{const u=await y0();await a().connectToDevice(u)}catch(u){u instanceof Error&&u.name!=="NotFoundError"&&c("error",u.message)}},connectToDevice:async(u,d)=>{var _,v;const h=a().user;if(!(!h||!re)){Mr=!1,o({screen:"connection",connecting:{name:Ef(u.name)||(d==null?void 0:d.deviceName)||"Pico",iconID:(d==null?void 0:d.deviceIconID)??0},progress:{value:0,label:"Forbinder..."}});try{await re.connect(u);const y=await re.runHandshake(h),x=u.id,N=Ef(u.name)||(d==null?void 0:d.deviceName)||"Pico";if(y.kind==="denied"){const G=`Du kan ikke forbinde, fordi ${((_=y.ownerName)==null?void 0:_.trim())||((v=d==null?void 0:d.ownerName)==null?void 0:v.trim())||"ejeren"} ejer enheden og ikke tillader besøgende at forbinde.`;c("warning",G),i(G),o({screen:"dashboard",connecting:null}),await re.disconnect();return}if(y.kind==="unowned"){o({active:{deviceID:x,deviceName:N,iconID:0,canEdit:!0,canEditCode:!0,canOthersConnect:!1,canOthersEdit:!1,canOthersEditCode:!1,isOwnedByMe:!0,ownerName:h.username,gridCols:Ya,gridRows:rs},screen:"create"});return}const R={deviceID:x,deviceName:N,deviceIconID:y.iconID,canOthersConnect:y.canOthersConnect,canOthersEdit:y.canOthersEdit,canOthersEditCode:y.canOthersEditCode,isOwnedByMe:y.isOwnedByMe,ownerName:y.isOwnedByMe?h.username:y.ownerName??(d==null?void 0:d.ownerName)};o({savedDevices:mf(R)});const $=await re.requestLayout(),I=dh($),J=mh($);o({layout:J,sliderValues:{},toggleValues:_h(J,a().toggleValues),radarPings:{},textValues:{},active:{deviceID:x,deviceName:N,iconID:y.iconID,canEdit:y.canEdit,canEditCode:y.canEditCode,canOthersConnect:y.canOthersConnect,canOthersEdit:y.canOthersEdit,canOthersEditCode:y.canOthersEditCode,isOwnedByMe:y.isOwnedByMe,ownerName:y.isOwnedByMe?h.username:y.ownerName??(d==null?void 0:d.ownerName),gridCols:I.cols,gridRows:I.rows},screen:"control",connecting:null,connectionLost:null})}catch(y){const x=y instanceof Error?y.message:"Forbindelsen mislykkedes.";c("error",x),i("Forbindelsen mislykkedes."),o({screen:"dashboard",connecting:null}),await re.disconnect().catch(()=>{})}}},finishCreate:async(u,d,h,_,v,y)=>{const{user:x,active:N}=a();if(!(!x||!N||!re))try{re.setBusy(!0),await re.create(x,u,d,h,_,v,y),re.setBusy(!1);const R={deviceID:N.deviceID,deviceName:N.deviceName,deviceIconID:u,canOthersConnect:d,canOthersEdit:d&&h,canOthersEditCode:d&&_,isOwnedByMe:!0,ownerName:x.username};o({savedDevices:mf(R)});const $=await re.requestLayout(),I=dh($),J=mh($);o({layout:J,sliderValues:{},toggleValues:_h(J,a().toggleValues),radarPings:{},textValues:{},active:{...N,iconID:u,canEdit:!0,canEditCode:!0,canOthersConnect:d,canOthersEdit:d&&h,canOthersEditCode:d&&_,ownerName:x.username,gridCols:I.cols,gridRows:I.rows},screen:"control"})}catch(R){re.setBusy(!1);const $=R instanceof Error?R.message:"Oprettelse mislykkedes.";c("error",$),i("Oprettelse mislykkedes."),o({screen:"dashboard"}),await re.disconnect().catch(()=>{})}},saveDeviceSettings:async(u,d,h,_,v,y)=>{const{active:x,user:N}=a();if(!(!x||!re||!x.isOwnedByMe))try{re.setBusy(!0),await re.updateDeviceSettings(u,d,h,_,v,y,N==null?void 0:N.username);const R={...x,iconID:u,canEdit:!0,canEditCode:!0,canOthersConnect:d,canOthersEdit:d&&h,canOthersEditCode:d&&_,ownerName:(N==null?void 0:N.username)??x.ownerName,gridCols:v,gridRows:y},$={deviceID:x.deviceID,deviceName:x.deviceName,deviceIconID:u,canOthersConnect:d,canOthersEdit:d&&h,canOthersEditCode:d&&_,isOwnedByMe:!0,ownerName:(N==null?void 0:N.username)??x.ownerName};o({active:R,savedDevices:mf($)}),i("Enhedsindstillinger gemt.")}catch(R){c("error",R instanceof Error?R.message:"Kunne ikke gemme enhedsindstillinger."),i("Kunne ikke gemme enhedsindstillinger.")}finally{re.setBusy(!1)}},cancelCreate:async()=>{re&&await re.disconnect().catch(()=>{}),o({screen:"dashboard",active:null,connecting:null})},disconnect:async()=>{Mr=!0,re&&await re.disconnect().catch(()=>{}),Mr=!1,o({screen:"dashboard",active:null,layout:[],sliderValues:{},toggleValues:{},radarPings:{},textValues:{},editMode:!1,sideMenuOpen:!1,menuPage:null,connectionLost:null})},removeSavedDevice:u=>{o({savedDevices:d0(u)})},clearSavedDevices:()=>{c0(),o({savedDevices:[]}),i("Gemte enheder ryddet.")},resetApplicationData:async()=>{Mr=!0,re!=null&&re.connected&&await re.disconnect().catch(()=>{}),u0(),window.location.reload()},updateUsername:u=>{const d=a().user,h=u.trim();if(!d||!h)return;const _={...d,username:h};uf(_),o(v=>{var x;const y=v.savedDevices.map(N=>N.isOwnedByMe?{...N,ownerName:h}:N);return ts(y),{user:_,active:(x=v.active)!=null&&x.isOwnedByMe?{...v.active,ownerName:h}:v.active,savedDevices:y}}),i("Brugernavn gemt.")},createOwnerPairingCode:()=>{const u=a().user;return u?z0(u):null},applyOwnerPairingCode:u=>{var h;const d=U0(u,(h=a().user)==null?void 0:h.username);return d?(uf(d),o(_=>{var y;const v=_.savedDevices.map(x=>x.isOwnedByMe?{...x,ownerName:d.username}:x);return ts(v),{user:d,active:(y=_.active)!=null&&y.isOwnedByMe?{..._.active,ownerName:d.username}:_.active,savedDevices:v}}),i("Ejerkoden er gemt. Denne browser bruger nu samme ejer-GUID."),!0):(i("Ejerkoden kunne ikke læses."),!1)},openPicoIde:()=>{const u=a().screen==="control"&&!!(re!=null&&re.connected),d=a().active;if(u&&d&&!d.isOwnedByMe&&!d.canEditCode){i("Ejeren tillader ikke, at gæster åbner Kodeværkstedet på denne enhed."),c("warning","Kodeværkstedet er blokeret, fordi ejeren ikke tillader gæster at redigere kode."),o({sideMenuOpen:!1});return}o(h=>({screen:"ide",picoIdeOrigin:u?"control":"dashboard",active:u?h.active:null,layout:u?h.layout:[],sliderValues:u?h.sliderValues:{},toggleValues:u?h.toggleValues:{},radarPings:u?h.radarPings:{},textValues:u?h.textValues:{},editMode:!1,sideMenuOpen:!1,menuPage:null}))},closePicoIde:()=>{const{picoIdeOrigin:u,active:d}=a();o({screen:u==="control"&&d&&(re!=null&&re.connected)?"control":"dashboard",sideMenuOpen:!1,menuPage:null,picoIdeOrigin:"dashboard"})},isBleConnected:()=>!!(re!=null&&re.connected),bleListFiles:async()=>re!=null&&re.connected?re.listFiles("/"):[],bleReadText:async(u,d,h)=>{if(!(re!=null&&re.connected))throw new Error("Ingen BLE-forbindelse.");return re.readText(u,d,h)},bleWriteText:async(u,d,h)=>{if(!(re!=null&&re.connected))throw new Error("Ingen BLE-forbindelse.");await re.writeText(u,d,h)},bleDeleteFile:async u=>{if(!(re!=null&&re.connected))throw new Error("Ingen BLE-forbindelse.");await re.deleteFile(u)},bleRestart:async()=>{re!=null&&re.connected&&await re.restart()},bleRestartAndReconnect:async(u="control")=>{const{active:d}=a();if(!(re!=null&&re.connected)||!d)return!1;const h={deviceID:d.deviceID,deviceName:d.deviceName,deviceIconID:d.iconID,canOthersConnect:d.canOthersConnect,canOthersEdit:d.canOthersEdit,canOthersEditCode:d.canOthersEditCode,isOwnedByMe:d.isOwnedByMe,ownerName:d.ownerName};Mr=!0,c("info","Genstarter Pico og forsøger automatisk genforbindelse...");try{await re.restart()}catch{}o({progress:{value:15,label:"Venter på Pico genstart..."},connecting:{name:h.deviceName,iconID:h.deviceIconID}});for(let _=0;_<12&&(re!=null&&re.connected);_+=1)await hh(250);re!=null&&re.connected||(Mr=!1);for(let _=1;_<=8;_+=1){await hh(_===1?1200:850);try{const y=(await Jh()).find(x=>x.id===h.deviceID);if(!y){o({progress:{value:Math.min(88,20+_*8),label:"Venter på browser-tilladelse..."}});continue}return o({progress:{value:Math.min(92,24+_*8),label:`Genforbinder (${_}/8)...`}}),await a().connectToDevice(y,h),u==="ide"&&o(x=>({screen:"ide",picoIdeOrigin:"control",active:x.active,layout:x.layout,sliderValues:x.sliderValues,toggleValues:x.toggleValues,radarPings:x.radarPings,textValues:x.textValues,editMode:!1,sideMenuOpen:!1,menuPage:null})),i("Pico genforbundet."),!0}catch(v){c("warning",v instanceof Error?v.message:"Genforbindelse mislykkedes.")}}return i("Kunne ikke genforbinde automatisk. Vælg Picoen igen."),Mr=!1,o({screen:"dashboard",active:null,layout:[],sliderValues:{},toggleValues:{},radarPings:{},textValues:{},editMode:!1,sideMenuOpen:!1,menuPage:null,connecting:null,connectionLost:h}),!1},reconnectLostDevice:async()=>{var d;const u=a().connectionLost;if(u){o({connectionLost:null});try{if((d=navigator.bluetooth)!=null&&d.getDevices){const _=(await navigator.bluetooth.getDevices()).find(v=>v.id===u.deviceID);if(_){await a().connectToDevice(_,u);return}}}catch{}c("info","Genforbind: vælg enheden i browserens liste."),await a().findDevice()}},dismissConnectionLost:()=>o({connectionLost:null}),sendButton:(u,d)=>re==null?void 0:re.enqueueButton(u,d),sendSlider:(u,d)=>{o(h=>({sliderValues:{...h.sliderValues,[u]:d}})),re==null||re.enqueueSlider(u,d)},sendToggle:(u,d)=>{o(h=>({toggleValues:{...h.toggleValues,[u]:d}})),re==null||re.enqueueToggle(u,d)},sendJoystick:(u,d,h)=>re==null?void 0:re.enqueueJoystick(u,d,h),sendDpad:(u,d,h)=>re==null?void 0:re.enqueueDpad(u,d,h),saveLayout:async u=>{if(re)try{re.setBusy(!0),await re.saveLayout(u),o({layout:u,editMode:!1})}catch(d){c("error",d instanceof Error?d.message:"Kunne ikke gemme layout.")}finally{re.setBusy(!1)}},setEditMode:u=>o({editMode:u,sideMenuOpen:!1,menuPage:null}),setDashboardPage:u=>o({dashboardPage:u}),toggleSideMenu:u=>o(d=>({sideMenuOpen:u??!d.sideMenuOpen})),toggleDebugger:u=>o(d=>({debuggerOpen:u??!d.debuggerOpen,sideMenuOpen:!1,menuPage:null})),openMenuPage:u=>o({menuPage:u,sideMenuOpen:!1}),closeMenuPage:()=>o({menuPage:null}),clearLogs:()=>o({logs:[]}),log:(u,d)=>c(u,d),askConfirm:u=>o({confirmDialog:u}),closeConfirm:()=>o({confirmDialog:null}),showToast:u=>i(u),dismissToast:()=>{$i&&clearTimeout($i),o({toast:null})}}}),kf="PKP-EJER";function z0(o){var i;const a=o.userID.toLowerCase(),c=((i=a.match(/.{1,4}/g))==null?void 0:i.join("-"))??a;return`${kf}-${c}-${r_(a)}`}function U0(o,a="Ejer"){const c=o.trim().toUpperCase().replace(/\s+/g,"-");if(!c.startsWith(`${kf}-`))return null;const i=c.slice(kf.length+1).split("-").filter(Boolean),u=i.pop()??"",d=i.join("").toLowerCase();return!/^[a-f0-9]{32}$/.test(d)||u!==r_(d)?null:{userID:d,username:a.trim()||"Ejer"}}function r_(o){let a=2166136261;for(const c of o.toLowerCase())a^=c.charCodeAt(0),a=Math.imul(a,16777619)>>>0;return(a%65536).toString(16).toUpperCase().padStart(4,"0")}const Go="./",l_=[{id:0,label:"Raspberry Pi"},{id:1,label:"Sumo robot"},{id:2,label:"LED / lys"},{id:3,label:"Lineal + blyant"},{id:4,label:"Bil"},{id:5,label:"Tank"},{id:6,label:"Robotarm"},{id:7,label:"Bi"},{id:8,label:"Palet"},{id:9,label:"Afstandssensor"},{id:10,label:"Søg"},{id:11,label:"Alarm"}];function qa(o){const a=o>=0&&o<l_.length?o:0;return`${Go}device-icons/${a}.png`}const H0=`${Go}art/logo.png`,V0=`${Go}art/Teknologiskolen_logo.png`,G0=`${Go}art/logo_teknologiskolen_white.png`,Y0={menu:f.jsxs(f.Fragment,{children:[f.jsx("line",{x1:"3",y1:"6",x2:"21",y2:"6"}),f.jsx("line",{x1:"3",y1:"12",x2:"21",y2:"12"}),f.jsx("line",{x1:"3",y1:"18",x2:"21",y2:"18"})]}),close:f.jsxs(f.Fragment,{children:[f.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"}),f.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"})]}),user:f.jsxs(f.Fragment,{children:[f.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),f.jsx("circle",{cx:"12",cy:"7",r:"4"})]}),settings:f.jsxs(f.Fragment,{children:[f.jsx("circle",{cx:"12",cy:"12",r:"3"}),f.jsx("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]}),info:f.jsxs(f.Fragment,{children:[f.jsx("circle",{cx:"12",cy:"12",r:"10"}),f.jsx("line",{x1:"12",y1:"16",x2:"12",y2:"12"}),f.jsx("line",{x1:"12",y1:"8",x2:"12.01",y2:"8"})]}),help:f.jsxs(f.Fragment,{children:[f.jsx("circle",{cx:"12",cy:"12",r:"10"}),f.jsx("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),f.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]}),debugger:f.jsx(f.Fragment,{children:f.jsx("path",{d:"M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"})}),edit:f.jsxs(f.Fragment,{children:[f.jsx("path",{d:"M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"}),f.jsx("path",{d:"M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4z"})]}),picoIde:f.jsxs(f.Fragment,{children:[f.jsx("rect",{x:"3",y:"4",width:"18",height:"16",rx:"2"}),f.jsx("path",{d:"M8 9l-3 3 3 3"}),f.jsx("path",{d:"M16 9l3 3-3 3"}),f.jsx("line",{x1:"13",y1:"8",x2:"11",y2:"16"})]}),exit:f.jsxs(f.Fragment,{children:[f.jsx("path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"}),f.jsx("polyline",{points:"16 17 21 12 16 7"}),f.jsx("line",{x1:"21",y1:"12",x2:"9",y2:"12"})]}),plus:f.jsxs(f.Fragment,{children:[f.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),f.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),delete:f.jsxs(f.Fragment,{children:[f.jsx("circle",{cx:"12",cy:"12",r:"10"}),f.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"}),f.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"})]}),power:f.jsxs(f.Fragment,{children:[f.jsx("path",{d:"M18.36 6.64a9 9 0 1 1-12.73 0"}),f.jsx("line",{x1:"12",y1:"2",x2:"12",y2:"12"})]}),save:f.jsxs(f.Fragment,{children:[f.jsx("path",{d:"M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"}),f.jsx("polyline",{points:"17 21 17 13 7 13 7 21"}),f.jsx("polyline",{points:"7 3 7 8 15 8"})]}),upload:f.jsxs(f.Fragment,{children:[f.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),f.jsx("polyline",{points:"17 8 12 3 7 8"}),f.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),refresh:f.jsxs(f.Fragment,{children:[f.jsx("polyline",{points:"23 4 23 10 17 10"}),f.jsx("polyline",{points:"1 20 1 14 7 14"}),f.jsx("path",{d:"M3.5 9a9 9 0 0 1 14.9-3.4L23 10"}),f.jsx("path",{d:"M20.5 15a9 9 0 0 1-14.9 3.4L1 14"})]}),package:f.jsxs(f.Fragment,{children:[f.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),f.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),f.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]}),back:f.jsxs(f.Fragment,{children:[f.jsx("line",{x1:"19",y1:"12",x2:"5",y2:"12"}),f.jsx("polyline",{points:"12 19 5 12 12 5"})]})};function Fn({name:o,size:a=24,className:c}){return f.jsx("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",className:c,"aria-hidden":"true",children:Y0[o]})}const I0=1850,q0=450;function P0(){const o=te(i=>i.splashTarget),a=te(i=>i.finishSplash),c=o?"splash-screen-animation splash-ready":"splash-pending";return L.useEffect(()=>{if(!o)return;const u=window.matchMedia("(prefers-reduced-motion: reduce)").matches?q0:I0,d=window.setTimeout(a,u);return()=>window.clearTimeout(d)},[a,o]),f.jsxs("div",{className:`screen splash-screen ${c}`,"aria-label":"Teknologiskolen starter",children:[f.jsx("div",{className:"splash-white-cover"}),f.jsx("div",{className:"splash-red-field"}),f.jsx("div",{className:"splash-brand","aria-hidden":"true",children:f.jsx("div",{className:"splash-mark splash-logo-shell",children:f.jsx("img",{className:"splash-logo",src:H0,alt:""})})}),f.jsx("span",{className:"sr-only",children:"Teknologiskolen"})]})}function gh(){const o=te(u=>u.createUser),[a,c]=L.useState(""),i=a.length>0;return f.jsxs("div",{className:"screen intro",children:[f.jsxs("div",{className:"intro-header",children:[f.jsx("span",{className:"intro-header-fill","aria-hidden":"true"}),f.jsx("img",{className:"intro-header-image",src:V0,alt:"Teknologiskolen"}),f.jsx("span",{className:"intro-header-fill","aria-hidden":"true"})]}),f.jsxs("div",{className:"intro-body",children:[f.jsx("p",{children:"Velkommen til Teknologiskolens Bluetooth-styringsapplikation til Raspberry Pi. Find selv på et navn, du vil vises som i appen. Det er ikke et login, og navnet gemmes kun i denne browser."}),f.jsxs("div",{className:`field ${i?"filled":""}`,children:[f.jsx("input",{id:"username",value:a,onChange:u=>c(u.target.value),maxLength:32,autoComplete:"off","aria-label":"Brugernavn"}),f.jsx("label",{htmlFor:"username",children:"Brugernavn"})]}),f.jsx("button",{className:"btn btn-primary btn-block",type:"button",disabled:!i,onClick:()=>o(a),children:"Fortsæt"})]}),f.jsx("span",{className:"version",children:ns})]})}function Vf({title:o,onMenu:a}){return f.jsx("header",{className:"topbar",children:f.jsxs("div",{className:"topbar-inner",children:[f.jsx("h1",{children:o}),f.jsx("button",{className:"iconbtn",type:"button",onClick:a,"aria-label":"Menu",children:f.jsx(Fn,{name:"menu"})})]})})}function Sn({title:o,onClose:a,children:c,closeVariant:i="plain"}){const u=i==="circle",d=L.useRef(!1);return f.jsx("div",{className:"modal-root",onPointerDown:h=>{d.current=h.target===h.currentTarget},onClick:h=>{h.target===h.currentTarget&&d.current&&a(),d.current=!1},children:f.jsxs("div",{className:"modal",onClick:h=>h.stopPropagation(),children:[f.jsxs("div",{className:"modal-head",children:[f.jsx("h3",{children:o}),f.jsx("button",{className:`iconbtn ${u?"modal-close-circle":""}`,type:"button",onClick:a,"aria-label":"Luk",children:f.jsx(Fn,{name:u?"delete":"close",size:u?30:24})})]}),f.jsx("div",{className:"modal-body",children:c})]})})}function bh(){const o=te(R=>R.savedDevices),a=te(R=>R.toggleSideMenu),c=te(R=>R.findDevice),i=te(R=>R.removeSavedDevice),u=te(R=>R.askConfirm),d=te(R=>R.dashboardPage),h=te(R=>R.setDashboardPage),_=K0(),[v,y]=L.useState(null),x=Vo(),N=o.filter(R=>d==="mine"?R.isOwnedByMe:!R.isOwnedByMe).sort(F0);return f.jsxs("div",{className:"screen dashboard-screen",children:[f.jsx(Vf,{title:"Hovedmenu",onMenu:()=>a()}),f.jsxs("div",{className:"content dash-content",children:[!x&&f.jsx("div",{className:"notice",children:"Web Bluetooth er ikke tilgængelig her. På iPhone/iPad: åbn siden i Bluefy-browseren. På Android: brug Chrome."}),f.jsxs("div",{className:"segmented",children:[f.jsx("button",{type:"button",className:d==="mine"?"active":"",onClick:()=>h("mine"),children:"Mine Enheder"}),f.jsx("button",{type:"button",className:d==="andre"?"active":"",onClick:()=>h("andre"),children:"Andre Enheder"})]}),f.jsx("div",{className:"panel panel-white device-list",children:N.length===0?f.jsx("div",{className:"device-list-empty",children:d==="mine"?"Ingen enheder endnu. Tryk på + for at finde en enhed.":"Ingen andre enheder gemt."}):N.map(R=>f.jsx($0,{device:R,disabled:!x,onConnect:()=>_(R),onSettings:()=>y(R)},R.deviceID))})]}),f.jsx("button",{className:"fab",type:"button",onClick:()=>c(),disabled:!x,"aria-label":"Find enhed",children:f.jsx(Fn,{name:"plus",size:30})}),f.jsx("span",{className:"version",children:ns}),v&&f.jsx(Sn,{title:"Enhedsindstillinger",onClose:()=>y(null),children:f.jsxs("div",{className:"settings-stack",children:[f.jsxs("div",{className:"saved-device-head",children:[f.jsx("img",{src:qa(v.deviceIconID),alt:""}),f.jsx("strong",{children:v.deviceName})]}),f.jsx(Xi,{label:"Gemte indstillinger",value:"Denne browser"}),f.jsx(Xi,{label:"Ejer",value:X0(v)}),f.jsx(Xi,{label:"Offentlig",value:v.canOthersConnect?"Ja":"Nej"}),f.jsx(Xi,{label:"Andre må redigere layout",value:v.canOthersEdit?"Ja":"Nej"}),f.jsx(Xi,{label:"Andre må redigere kode",value:v.canOthersEditCode?"Ja":"Nej"}),f.jsx("div",{className:"notice",children:"Forbind til enheden for at ændre de indstillinger, der er gemt på Picoen."}),f.jsx("button",{className:"btn btn-primary btn-block",type:"button",disabled:!x,onClick:()=>{const R=v;y(null),_(R)},children:"Forbind"}),f.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>u({title:"Glem enhed",message:`Vil du fjerne ${v.deviceName} fra gemte enheder?`,confirmLabel:"Glem",onConfirm:()=>{i(v.deviceID),y(null)}}),children:"Glem enhed"})]})})]})}function $0({device:o,disabled:a,onConnect:c,onSettings:i}){return f.jsxs("div",{className:"device-tile-wrap",children:[f.jsxs("button",{className:"device-tile",type:"button",onClick:c,disabled:a,children:[f.jsx("img",{className:"device-tile-icon",src:qa(o.deviceIconID),alt:""}),f.jsx("span",{className:"device-tile-name",children:o.deviceName})]}),f.jsx("button",{className:"device-tile-del",type:"button",onClick:i,"aria-label":"Enhedsindstillinger",children:f.jsx(Fn,{name:"settings"})})]})}function Xi({label:o,value:a}){return f.jsxs("div",{className:"settings-row",children:[f.jsx("span",{children:o}),f.jsx("strong",{children:a})]})}function X0(o){var a;return o.isOwnedByMe?"Dig":((a=o.ownerName)==null?void 0:a.trim())||"Anden bruger"}function F0(o,a){return o.deviceName.localeCompare(a.deviceName,"da",{sensitivity:"base"})}function K0(){const o=te(i=>i.connectToDevice),a=te(i=>i.findDevice),c=te(i=>i.log);return async i=>{const d=(await Jh()).find(h=>h.id===i.deviceID);d?await o(d,i):(c("info","Genforbind: vælg enheden i browserens liste."),await a())}}function Q0(){const o=te(c=>c.connecting),a=te(c=>c.progress);return f.jsxs("div",{className:"screen connection",children:[f.jsx("div",{className:"device-icon-pick",children:f.jsx("img",{src:qa((o==null?void 0:o.iconID)??0),alt:""})}),f.jsxs("h2",{style:{margin:0,color:"var(--red)"},children:["Forbinder til ",(o==null?void 0:o.name)??"enhed"]}),f.jsx("div",{className:"spinner"}),f.jsxs("div",{style:{width:"100%"},children:[f.jsx("div",{className:"progress-track",children:f.jsx("div",{className:"progress-fill",style:{width:`${a.value}%`}})}),f.jsx("p",{style:{color:"var(--muted)",fontWeight:600,marginTop:12},children:a.label})]})]})}function a_({selected:o,onSelect:a,onClose:c}){return f.jsx(Sn,{title:"Vælg Enhedens Ikon",onClose:c,children:f.jsx("div",{className:"icon-grid",children:l_.map(i=>f.jsx("button",{type:"button",className:`icon-tile ${i.id===o?"selected":""}`,onClick:()=>{a(i.id),c()},"aria-label":i.label,children:f.jsx("img",{src:qa(i.id),alt:""})},i.id))})})}function Z0(){const o=te(le=>le.finishCreate),a=te(le=>le.cancelCreate),[c,i]=L.useState(0),[u,d]=L.useState(!1),[h,_]=L.useState(!1),[v,y]=L.useState(!1),[x,N]=L.useState(!1),[R,$]=L.useState(Ya),[I,J]=L.useState(rs),[K,G]=L.useState(!1),H=le=>Number.isFinite(le)?Math.max(Ha,Math.min(Va,Math.round(le))):Ya;async function ae(){G(!0),await o(c,h,h&&v,h&&x,H(R),H(I))}return f.jsxs("div",{className:"screen",children:[f.jsx("header",{className:"topbar",children:f.jsx("h1",{children:"Opret Enhed"})}),f.jsxs("div",{className:"content create-body",children:[f.jsxs("button",{type:"button",className:"device-icon-pick",onClick:()=>d(!0),"aria-label":"Vælg ikon",children:[f.jsx("img",{src:qa(c),alt:""}),f.jsx("span",{className:"badge",children:f.jsx(Fn,{name:"plus",size:22})})]}),f.jsx("p",{className:"prompt",children:"Må andre forbinde til- og bruge denne enhed?"}),f.jsxs("div",{className:"segmented",children:[f.jsx("button",{type:"button",className:h?"":"active",onClick:()=>_(!1),children:"Privat"}),f.jsx("button",{type:"button",className:h?"active":"",onClick:()=>_(!0),children:"Offentlig"})]}),h&&f.jsxs(f.Fragment,{children:[f.jsx("p",{className:"prompt",children:"Må andre redigere layoutet?"}),f.jsxs("div",{className:"segmented",children:[f.jsx("button",{type:"button",className:v?"":"active",onClick:()=>y(!1),children:"Nej"}),f.jsx("button",{type:"button",className:v?"active":"",onClick:()=>y(!0),children:"Ja"})]}),f.jsx("p",{className:"prompt",children:"Må andre redigere koden?"}),f.jsxs("div",{className:"segmented",children:[f.jsx("button",{type:"button",className:x?"":"active",onClick:()=>N(!1),children:"Nej"}),f.jsx("button",{type:"button",className:x?"active":"",onClick:()=>N(!0),children:"Ja"})]})]}),f.jsx("p",{className:"prompt",children:"Kontrolpanelets gitter (kolonner × rækker)"}),f.jsxs("div",{className:"row",style:{width:"100%"},children:[f.jsxs("div",{className:"grid-field",children:[f.jsx("label",{htmlFor:"cols",children:"Kolonner"}),f.jsx("input",{id:"cols",type:"number",min:Ha,max:Va,value:Number.isNaN(R)?"":R,onChange:le=>$(parseInt(le.target.value,10)),onBlur:()=>$(H(R))})]}),f.jsxs("div",{className:"grid-field",children:[f.jsx("label",{htmlFor:"rows",children:"Rækker"}),f.jsx("input",{id:"rows",type:"number",min:Ha,max:Va,value:Number.isNaN(I)?"":I,onChange:le=>J(parseInt(le.target.value,10)),onBlur:()=>J(H(I))})]})]}),f.jsxs("div",{className:"row",style:{marginTop:"auto",width:"100%"},children:[f.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>a(),disabled:K,children:"Annuller"}),f.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:ae,disabled:K,children:K?"Opretter...":"Opret"})]})]}),u&&f.jsx(a_,{selected:c,onSelect:i,onClose:()=>d(!1)}),f.jsx("span",{className:"version",children:ns})]})}const Ia=8;function Ao(o){return Math.max(5,Math.min(22,o))}function W0(o,a,c){const i=Math.max(1,o.length),u=(a-Ia*2)/(i*.58),d=(c-Ia*2)*.48;return Ao(Math.min(u,d))}function Kl(o,a,c){switch(c){case 90:return{x:-a,y:o};case 180:return{x:-o,y:-a};case 270:return{x:a,y:-o};default:return{x:o,y:a}}}function Lo(o){return(360-o)%360}function J0(o,a,c,i){const u=i===90||i===270;return W0(o,u?c:a,u?a:c)}function Bo({name:o,width:a,height:c,rotation:i}){return f.jsx("span",{style:{display:"inline-block",fontWeight:800,fontSize:J0(o,a,c,i),transform:i?`rotate(${i}deg)`:void 0,whiteSpace:i===90||i===270?"nowrap":void 0},children:o})}function eb(o,a,c,i,u){const d=o.trim().split(/\s+/).filter(Boolean),h=Math.max(1,o.replace(/\s+/g,"").length+Math.max(0,d.length-1)*1.6),_=u?Ao(Math.min(a/4.6,c/4.6,12)):0,v=u?_+Ia:Ia;if(i){const N=Math.max(1,c-v*2);return{fontSize:Ao(Math.min(a*.48,N/(h*1.04))),endFontSize:_,centerInset:u?{top:v,bottom:v}:{}}}const y=Math.max(1,a-v*4.2);return{fontSize:Ao(Math.min(c*.42,y/(h*.58))),endFontSize:_,centerInset:u?{left:v*2.1,right:v*2.1}:{}}}function nb({control:o,rect:a,disabled:c,latestValue:i,toggleValue:u,radarPings:d=[],textValue:h,onButton:_,onSlider:v,onToggle:y,onJoystick:x,onDpad:N}){const R=L.useRef(!1),$={left:a.cx,top:a.cy,width:a.width,height:a.height};if(o.type==="button"){const I=()=>{c||!R.current||(R.current=!1,_(o.name,!1))};return f.jsx("div",{className:"control",style:$,children:f.jsx("button",{className:"control-button",type:"button",disabled:c,style:{width:"100%",height:"100%",display:"grid",placeItems:"center"},onPointerDown:J=>{var K,G;c||(J.preventDefault(),(G=(K=J.currentTarget).setPointerCapture)==null||G.call(K,J.pointerId),R.current=!0,_(o.name,!0))},onPointerUp:J=>{var K,G;J.preventDefault(),(G=(K=J.currentTarget).releasePointerCapture)==null||G.call(K,J.pointerId),I()},onPointerCancel:I,onLostPointerCapture:I,children:f.jsx(Bo,{name:o.name,width:a.width,height:a.height,rotation:o.rotation})})})}if(o.type==="toggle"){const I=!!u;return f.jsx("div",{className:"control",style:$,children:f.jsx("button",{className:`control-toggle ${I?"on":""}`,type:"button",disabled:c,"aria-pressed":I,style:{width:"100%",height:"100%"},onPointerDown:J=>{c||(J.preventDefault(),y(o.name,!I))},children:f.jsx(Bo,{name:o.name,width:a.width,height:a.height,rotation:o.rotation})})})}return o.type==="radar"?f.jsx("div",{className:"control",style:$,children:f.jsx(s_,{control:o,pings:d,width:a.width,height:a.height})}):o.type==="text"?f.jsx("div",{className:"control",style:$,children:f.jsx(i_,{message:h??o.name,width:a.width,height:a.height,rotation:o.rotation})}):o.type==="joystick"?f.jsx("div",{className:"control",style:$,children:f.jsx(mb,{control:o,disabled:c,onJoystick:x,width:a.width,height:a.height})}):o.type==="dpad"?f.jsx("div",{className:"control",style:$,children:f.jsx(xb,{control:o,disabled:c,onDpad:N})}):f.jsx("div",{className:"control",style:$,children:f.jsx(db,{control:o,disabled:c,latestValue:i,onSlider:v,width:a.width,height:a.height})})}function tb(o,a,c){const i=o.trim()||" ",d=i.split(/\s+/).filter(Boolean).reduce((N,R)=>Math.max(N,R.length),1),h=Math.max(1,Math.ceil(i.length/Math.max(1,Math.floor(d*1.9)))),_=Math.max(1,a-Ia*3),v=Math.max(1,c-Ia*3),y=_/(d*.58),x=v/(h*1.16);return Math.max(7,Math.min(24,y,x))}function i_({message:o,width:a,height:c,rotation:i=0}){const u=o.trim()||"...",d=i===90||i===270,h=tb(u,d?c:a,d?a:c);return f.jsx("div",{className:"control-text",style:{width:"100%",height:"100%",fontSize:h},children:f.jsx("span",{style:{transform:i?`rotate(${i}deg)`:void 0},children:u})})}function s_({control:o,pings:a,width:c,height:i,preview:u=!1}){const[,d]=L.useState(0),h=Math.max(120,o.radarFadeMs??1200),_=o.radarMinAngle??0,v=o.radarMaxAngle??180,y=Kn(_),x=Kn(v),N=Math.abs(v-_)>=360||y===x&&_!==v,R=Math.max(1,o.radarMaxDistance??200),$=Date.now(),I=a[a.length-1],J=o.rotation,K=Kn(y+J),G=Kn(x+J),H=ob(y,x),ae=((I==null?void 0:I.angle)??H)+J,le=u?[{id:"preview",angle:H,distance:R*.62,createdAt:$}]:a.filter(S=>$-S.createdAt<=h),se=!N,he=Math.max(8,Math.min(12,Math.min(c,i)*.16)),ne=0,ee=0,xe=1,ge=N?{x:-1.12,y:-1.12,width:2.24,height:2.24}:ab(K,G),ye=N?"":rb(ne,ee,xe,K,G),ie=wh(_),Ve=wh(v),Re=se?sb(K,G,ge,c,i,ie,Ve,he):null,Pe=Math.max(7,he*.85),z=Kn(H+J),Z=N?180:Yo(K,G)/2,oe=Kn(z-Math.min(16,Z*.55)),we=[.25,.5,.75,1].map(S=>{const B=yt(ne,ee,xe*S,oe),W=o_(B,ge,c,i);return{fraction:S,value:Math.round(R*S),x:W.x,y:W.y}});L.useEffect(()=>{if(u||a.length===0)return;const S=window.setInterval(()=>d(B=>B+1),120);return()=>window.clearInterval(S)},[h,a.length,u]);const ke=yt(ne,ee,xe,ae);return f.jsxs("div",{className:"control-radar",style:{width:"100%",height:"100%"},children:[f.jsxs("svg",{width:c,height:i,viewBox:`${ge.x} ${ge.y} ${ge.width} ${ge.height}`,preserveAspectRatio:"none","aria-hidden":"true",children:[N?f.jsx("circle",{className:"radar-sector-fill",cx:ne,cy:ee,r:xe}):f.jsx("path",{className:"radar-sector-fill",d:ye}),[.25,.5,.75,1].map(S=>N?f.jsx("circle",{className:"radar-ring",cx:ne,cy:ee,r:xe*S},S):f.jsx("path",{className:"radar-ring",d:lb(ne,ee,xe*S,K,G)},S)),!N&&f.jsx(yh,{cx:ne,cy:ee,radius:xe,angle:K}),!N&&f.jsx(yh,{cx:ne,cy:ee,radius:xe,angle:G}),f.jsx("line",{className:"radar-sweep",x1:ne,y1:ee,x2:ke.x,y2:ke.y}),le.map(S=>{const B=u?0:$-S.createdAt,W=Math.max(0,1-B/h),T=Math.max(0,Math.min(R,S.distance)),F=yt(ne,ee,xe*(T/R),S.angle+J);return f.jsx("circle",{className:"radar-ping",cx:F.x,cy:F.y,r:Math.max(.025,Math.min(ge.width,ge.height)*.025),opacity:W},S.id)})]}),se&&Re&&f.jsxs(f.Fragment,{children:[f.jsx("span",{className:"radar-angle-label",style:{left:Re.min.x,top:Re.min.y,fontSize:he},children:ie}),f.jsx("span",{className:"radar-angle-label",style:{left:Re.max.x,top:Re.max.y,fontSize:he},children:Ve})]}),we.map(S=>f.jsx("span",{className:"radar-range-label",style:{left:S.x,top:S.y,fontSize:Pe},children:S.value},S.fraction))]})}function yh({cx:o,cy:a,radius:c,angle:i}){const u=yt(o,a,c,i);return f.jsx("line",{className:"radar-boundary",x1:o,y1:a,x2:u.x,y2:u.y})}function yt(o,a,c,i){const u=(Kn(i)-90)*Math.PI/180;return{x:o+Math.cos(u)*c,y:a+Math.sin(u)*c}}function rb(o,a,c,i,u){const d=yt(o,a,c,i),h=yt(o,a,c,u),_=Yo(i,u)>180?1:0;return`M ${o} ${a} L ${d.x} ${d.y} A ${c} ${c} 0 ${_} 1 ${h.x} ${h.y} Z`}function lb(o,a,c,i,u){const d=yt(o,a,c,i),h=yt(o,a,c,u),_=Yo(i,u)>180?1:0;return`M ${d.x} ${d.y} A ${c} ${c} 0 ${_} 1 ${h.x} ${h.y}`}function Yo(o,a){const c=Kn(o),i=Kn(a),u=i>=c?i-c:360-c+i;return u===0?360:u}function ab(o,a){const c=[{x:0,y:0},yt(0,0,1,o),yt(0,0,1,a)];for(const x of[0,90,180,270])ib(x,o,a)&&c.push(yt(0,0,1,x));const i=Math.min(...c.map(x=>x.x)),u=Math.max(...c.map(x=>x.x)),d=Math.min(...c.map(x=>x.y)),h=Math.max(...c.map(x=>x.y)),_=Math.max(.1,u-i),v=Math.max(.1,h-d),y=Math.max(_,v)*.24;return{x:i-y,y:d-y,width:_+y*2,height:v+y*2}}function ib(o,a,c){const i=Kn(a),u=Kn(o),d=Yo(a,c),h=Kn(u-i);return h>=0&&h<=d}function sb(o,a,c,i,u,d,h,_){const y=yt(0,0,1.1,o),x=yt(0,0,1.1,a);return{min:vh(y,c,i,u,d,_),max:vh(x,c,i,u,h,_)}}function o_(o,a,c,i){return{x:(o.x-a.x)/a.width*c,y:(o.y-a.y)/a.height*i}}function vh(o,a,c,i,u,d){const h=o_(o,a,c,i),_=Math.max(10,u.length*d*.62),v=d,y=7;return{x:xh(h.x,_/2+y,Math.max(_/2+y,c-_/2-y)),y:xh(h.y,v/2+y,Math.max(v/2+y,i-v/2-y))}}function xh(o,a,c){return Math.max(a,Math.min(c,o))}function wh(o){return`${Math.round(o)}`}function Kn(o){return Number.isFinite(o)?(o%360+360)%360:0}function ob(o,a){const c=Kn(o),i=Kn(a),u=i>=c?i-c:360-c+i;return Kn(c+u/2)}function cb(o,a){if(!a)return o;const c=o.trim().split(/\s+/).filter(Boolean);return f.jsx("span",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",width:"100%",lineHeight:1.02,textAlign:"center",gap:"0.42em"},children:c.map((i,u)=>f.jsx("span",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[...i].map((d,h)=>f.jsx("span",{children:d},`${d}-${h}`))},`${i}-${u}`))})}function ub(o){const a={position:"absolute",display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"none"},c=4;return o===0?{low:{...a,left:c,top:0,bottom:0},high:{...a,right:c,top:0,bottom:0}}:o===180?{low:{...a,right:c,top:0,bottom:0},high:{...a,left:c,top:0,bottom:0}}:o===90?{low:{...a,bottom:c,left:0,right:0},high:{...a,top:c,left:0,right:0}}:{low:{...a,top:c,left:0,right:0},high:{...a,bottom:c,left:0,right:0}}}function fb({name:o,vertical:a,rotation:c,color:i,fontSize:u,endFontSize:d,centerInset:h,lowLabel:_,highLabel:v,showEnds:y}){const x=y?ub(c):null;return f.jsxs("div",{style:{position:"absolute",inset:0,color:i},children:[f.jsx("div",{style:{position:"absolute",inset:0,...h,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,fontSize:u,textAlign:"center",pointerEvents:"none"},children:cb(o,a)}),x&&f.jsxs(f.Fragment,{children:[f.jsx("div",{style:{...x.low,fontWeight:800,fontSize:d},children:_}),f.jsx("div",{style:{...x.high,fontWeight:800,fontSize:d},children:v})]})]})}function c_({name:o,rotation:a,width:c,height:i,value:u,showEnds:d=!1,fillColor:h="var(--red)",lowLabel:_="0",highLabel:v="100"}){const y=a===90||a===270,{fontSize:x,endFontSize:N,centerInset:R}=eb(o,c,i,y,d);let $,I;a===0?($={left:0,top:0,bottom:0,width:`${u}%`},I={left:0,top:0}):a===180?($={right:0,top:0,bottom:0,width:`${u}%`},I={right:0,top:0}):a===90?($={left:0,right:0,bottom:0,height:`${u}%`},I={left:0,bottom:0}):($={left:0,right:0,top:0,height:`${u}%`},I={left:0,top:0});const J=K=>f.jsx(fb,{name:o,vertical:y,rotation:a,color:K,fontSize:x,endFontSize:N,centerInset:R,lowLabel:_,highLabel:v,showEnds:d});return f.jsxs(f.Fragment,{children:[f.jsx("div",{style:{position:"absolute",left:0,top:0,width:`${c}px`,height:`${i}px`},children:J("var(--red)")}),f.jsx("div",{style:{position:"absolute",background:h,overflow:"hidden",...$},children:f.jsx("div",{style:{position:"absolute",width:`${c}px`,height:`${i}px`,...I},children:J("var(--white)")})})]})}function db({control:o,disabled:a,latestValue:c,onSlider:i,width:u,height:d}){const h=L.useRef(null),_=o.sliderMin??0,v=o.sliderMax??100,[y,x]=L.useState(()=>c===void 0?Sh(o.sliderRecenter??"none"):Eh(c,_,v)),N=L.useRef(null),R=o.rotation;L.useEffect(()=>{c!==void 0&&(x(Eh(c,_,v)),N.current=c)},[c,_,v]);function $(G){const H=h.current;if(!H)return 0;const ae=H.getBoundingClientRect();let le;return R===0?le=(G.clientX-ae.left)/ae.width:R===180?le=1-(G.clientX-ae.left)/ae.width:R===90?le=1-(G.clientY-ae.top)/ae.height:le=(G.clientY-ae.top)/ae.height,Math.max(0,Math.min(1,le))}function I(G){a||J($(G))}function J(G){const H=Math.round(G*100),ae=Math.round(_+(v-_)*G);x(H),ae!==N.current&&(N.current=ae,i(o.name,ae))}function K(){const G=o.sliderRecenter??"none";a||G==="none"||J(Sh(G)/100)}return f.jsx("div",{ref:h,className:"control-slider",style:{width:"100%",height:"100%",position:"relative",overflow:"hidden",touchAction:"none"},onPointerDown:G=>{a||(G.preventDefault(),G.currentTarget.setPointerCapture(G.pointerId),I(G))},onPointerMove:G=>{G.buttons!==0&&I(G)},onPointerUp:K,onPointerCancel:K,onLostPointerCapture:K,children:f.jsx(c_,{name:o.name,rotation:R,width:u,height:d,value:y,showEnds:!0,lowLabel:String(_),highLabel:String(v)})})}function Sh(o){return o==="bottom"?0:o==="top"?100:o==="middle"?50:0}function Eh(o,a,c){return c===a?0:Math.max(0,Math.min(100,Math.round((o-a)/(c-a)*100)))}function kh(o,a,c){return Math.round(a+(c-a)*(o+1)/2)}function Nh(o,a){return o==="bottom"?a?1:-1:o==="top"?a?-1:1:0}function Rh(o){return{nx:Nh(o.joystickXRecenter,!1),ny:Nh(o.joystickYRecenter,!0)}}function u_(o,a){const c=Math.min(o,a),i=Math.max(6,c*.16),u=Math.max(1,c/2-i-2);return{knobRadius:i,reach:u}}function f_({control:o,width:a,height:c,pos:i,dragging:u=!1}){const d=o.rotation,{knobRadius:h,reach:_}=u_(a,c),v=Math.max(7,Math.min(14,h*.62)),y=Math.max(7,Math.min(12,Math.min(a,c)*.1)),x=[{key:"xmax",value:o.joystickXMax??100,lx:1,ly:0},{key:"xmin",value:o.joystickXMin??-100,lx:-1,ly:0},{key:"ymax",value:o.joystickYMax??100,lx:0,ly:-1},{key:"ymin",value:o.joystickYMin??-100,lx:0,ly:1}];return f.jsxs("div",{className:"control-joystick",style:{width:"100%",height:"100%",position:"relative"},children:[f.jsx("div",{className:"joystick-oval",style:{position:"absolute",left:"50%",top:"50%",width:_*2,height:_*2,transform:"translate(-50%, -50%)"}}),x.map(N=>{const R=Kl(N.lx,N.ly,d);return f.jsx("span",{className:"joystick-edge-label",style:{position:"absolute",left:"50%",top:"50%",fontSize:y,transform:`translate(-50%, -50%) translate(${R.x*_}px, ${R.y*_}px) rotate(${d}deg)`},children:N.value},N.key)}),f.jsx("div",{className:"joystick-knob",style:{position:"absolute",left:"50%",top:"50%",width:h*2,height:h*2,fontSize:v,transform:`translate(calc(-50% + ${i.nx*_}px), calc(-50% + ${i.ny*_}px))`,transition:u?"none":"transform 0.12s ease-out"},children:f.jsx("span",{style:{display:"inline-block",transform:o.rotation?`rotate(${o.rotation}deg)`:void 0,whiteSpace:o.rotation===90||o.rotation===270?"nowrap":void 0},children:o.name})})]})}function mb({control:o,disabled:a,onJoystick:c,width:i,height:u}){const d=o.rotation,h=L.useRef(null),[_,v]=L.useState(()=>{const H=Rh(o),ae=Kl(H.nx,H.ny,d);return{nx:ae.x,ny:ae.y}}),y=L.useRef(!1),x=L.useRef(null),N=o.joystickXMin??-100,R=o.joystickXMax??100,$=o.joystickYMin??-100,I=o.joystickYMax??100;function J(H,ae){const le=Kl(H,ae,Lo(d)),se=kh(le.x,N,R),he=kh(-le.y,$,I);(!x.current||x.current.x!==se||x.current.y!==he)&&(x.current={x:se,y:he},c(o.name,se,he))}function K(H){const ae=h.current;if(!ae)return;const le=ae.getBoundingClientRect(),{reach:se}=u_(le.width,le.height);let he=(H.clientX-(le.left+le.width/2))/se,ne=(H.clientY-(le.top+le.height/2))/se;const ee=Math.hypot(he,ne);ee>1&&(he/=ee,ne/=ee),v({nx:he,ny:ne}),J(he,ne)}function G(){const H=o.joystickXRecenter??"middle",ae=o.joystickYRecenter??"middle";if(H==="none"&&ae==="none")return;const le=Kl(_.nx,_.ny,Lo(d)),se=Rh(o),he={x:H==="none"?le.x:se.nx,y:ae==="none"?le.y:se.ny},ne=Kl(he.x,he.y,d),ee={nx:ne.x,ny:ne.y};y.current=!1,v(ee),J(ee.nx,ee.ny)}return f.jsx("div",{ref:h,style:{width:"100%",height:"100%",touchAction:"none"},onPointerDown:H=>{a||(H.preventDefault(),H.currentTarget.setPointerCapture(H.pointerId),y.current=!0,K(H))},onPointerMove:H=>{a||!y.current||H.buttons===0||K(H)},onPointerUp:G,onPointerCancel:G,onLostPointerCapture:G,children:f.jsx(f_,{control:o,width:i,height:u,pos:_,dragging:y.current})})}const pb=[{direction:"up",rotate:0},{direction:"right",rotate:90},{direction:"down",rotate:180},{direction:"left",rotate:270}],hb="M 34 30 L 34 15 Q 34 8 41 8 L 59 8 Q 66 8 66 15 L 66 30 L 50 46 L 34 30 Z",_b=.1,gb={up:"OP",down:"NED",left:"VENSTRE",right:"HØJRE"},bb={up:[0,-1],right:[1,0],down:[0,1],left:[-1,0]},yb=[{pos:"up",x:50,y:23},{pos:"right",x:78,y:50},{pos:"down",x:50,y:77},{pos:"left",x:22,y:50}];function Nf(o,a){return Math.hypot(o,a)<_b?null:Math.abs(o)>=Math.abs(a)?o>0?"right":"left":a>0?"down":"up"}function vb(o,a){const[c,i]=bb[o],u=Kl(c,i,Lo(a));return Nf(u.x,u.y)??o}function d_({control:o,active:a=null}){const c=o.rotation;return f.jsx("div",{className:"control-dpad",style:{width:"100%",height:"100%"},children:f.jsxs("svg",{viewBox:"0 0 100 100",preserveAspectRatio:"xMidYMid meet",children:[pb.map(i=>f.jsx("path",{className:`dpad-arm ${a===i.direction?"active":""}`,transform:`rotate(${i.rotate} 50 50)`,d:hb},i.direction)),yb.map(i=>f.jsx("text",{className:`dpad-label ${a===i.pos?"active":""}`,x:i.x,y:i.y,textAnchor:"middle",dominantBaseline:"central",transform:c?`rotate(${c} ${i.x} ${i.y})`:void 0,children:gb[vb(i.pos,c)]},i.pos))]})})}function xb({control:o,disabled:a,onDpad:c}){const i=L.useRef(null),u=L.useRef(null),d=L.useRef(!1),[h,_]=L.useState(null);function v(R){const $=i.current;if(!$)return{screen:null,logical:null};const I=$.getBoundingClientRect(),J=Math.min(I.width,I.height)/2,K=(R.clientX-(I.left+I.width/2))/J,G=(R.clientY-(I.top+I.height/2))/J,H=Nf(K,G),ae=Kl(K,G,Lo(o.rotation)),le=Nf(ae.x,ae.y);return{screen:H,logical:le}}function y(R){const $=i.current;if(!$)return!1;const I=$.getBoundingClientRect(),J=(R.clientX-I.left)/I.width,K=(R.clientY-I.top)/I.height;return J>=0&&J<=1&&K>=0&&K<=1}function x(R){R.logical!==u.current&&(u.current&&c(o.name,u.current,!1),u.current=R.logical,R.logical&&c(o.name,R.logical,!0)),_(R.screen)}function N(){d.current=!1,x({screen:null,logical:null})}return f.jsx("div",{ref:i,style:{width:"100%",height:"100%",touchAction:"none"},onPointerDown:R=>{a||!y(R)||(R.preventDefault(),R.currentTarget.setPointerCapture(R.pointerId),d.current=!0,x(v(R)))},onPointerMove:R=>{a||!d.current||R.buttons===0||x(v(R))},onPointerUp:N,onPointerCancel:N,onLostPointerCapture:N,children:f.jsx(d_,{control:o,active:h})})}const wb={button:"Knapper",slider:"Slidere",toggle:"Toggleknapper",radar:"Radar",text:"Tekstfelter",joystick:"Joysticks",dpad:"Dpads"},Sb=["button","slider","toggle","radar","text","joystick","dpad"];function Eb({unplaced:o,onAdd:a,onClose:c}){const i=L.useMemo(()=>Sb.filter(_=>o.some(v=>v.type===_)),[o]),[u,d]=L.useState(i[0]??"button"),h=o.filter(_=>_.type===u);return L.useEffect(()=>{i.length>0&&!i.includes(u)&&d(i[0])},[i,u]),f.jsxs(Sn,{title:"Tilføj kontrol",onClose:c,children:[i.length>1&&f.jsx("div",{className:"segmented add-modal-tabs",children:i.map(_=>f.jsx("button",{type:"button",className:u===_?"active":"",onClick:()=>d(_),children:wb[_]},_))}),f.jsx("div",{className:"add-lists",children:i.length===0?f.jsx("div",{className:"device-list-empty",children:"Alle kontroller er allerede placeret."}):h.map(_=>f.jsxs("button",{type:"button",className:"add-entry",onClick:()=>a(_.name),children:[f.jsx("span",{children:_.name}),f.jsx("span",{className:"iconbtn",children:f.jsx(Fn,{name:"plus",size:22})})]},_.name))})]})}function m_(o){const[a,c]=L.useState({w:0,h:0}),i=L.useRef(null),u=L.useRef(null);return L.useLayoutEffect(()=>{var v;const d=o.current;if(i.current===d)return;if((v=u.current)==null||v.disconnect(),u.current=null,i.current=d,!d){c(y=>y.w===0&&y.h===0?y:{w:0,h:0});return}const h=()=>{const y={w:d.clientWidth,h:d.clientHeight};c(x=>x.w===y.w&&x.h===y.h?x:y)};h();const _=new ResizeObserver(h);_.observe(d),u.current=_}),L.useEffect(()=>()=>{var d;(d=u.current)==null||d.disconnect(),u.current=null,i.current=null},[]),a}function Ga(o){return o.centerX2!==null&&o.centerY2!==null&&o.spanX!==null&&o.spanY!==null}const kb=4,Nb=5;function Rb(o){return o==="joystick"||o==="dpad"?{spanX:6,spanY:6}:{spanX:kb,spanY:Nb}}function Mh(o){if(!Ga(o))return null;const a=o.centerX2/2,c=o.centerY2/2;return{x0:a-o.spanX/2,x1:a+o.spanX/2,y0:c-o.spanY/2,y1:c+o.spanY/2}}function Mb(o,a,c=.02){return o.x0<a.x1-c&&a.x0<o.x1-c&&o.y0<a.y1-c&&a.y0<o.y1-c}function Th(o,a){const c=Ji(o,a);if(!c||o.spanX===null||o.spanY===null)return o;const i=jo(c.cx,c.cy,o.spanX,o.spanY,a);return{...o,centerX2:i.centerX2,centerY2:i.centerY2}}function jh(o,a){return Math.max(1,Math.min(a.cols-1,o))}function Ah(o,a){return Math.max(1,Math.min(a.rows-1,o))}function Tb(){const o=te(T=>T.layout),a=te(T=>T.active),c=te(T=>T.saveLayout),i=te(T=>T.setEditMode),u=te(T=>T.askConfirm),d=!!(a!=null&&a.canEdit),[h,_]=L.useState(()=>o.map(T=>({...T}))),[v,y]=L.useState(null),[x,N]=L.useState(!1),[R,$]=L.useState(null),[I,J]=L.useState(null),[K,G]=L.useState(!1),H=L.useRef(null),ae=m_(H),le=ae.w>0&&ae.h>0,se=e_(ae.w,ae.h,a==null?void 0:a.gridCols,a==null?void 0:a.gridRows),he=L.useMemo(()=>le?k0(se):[],[se,le]),ne=h.filter(Ga),ee=h.filter(T=>!Ga(T)),xe=L.useMemo(()=>{const T=new Set;for(let F=0;F<ne.length;F+=1)for(let Q=F+1;Q<ne.length;Q+=1){const X=Mh(ne[F]),Le=Mh(ne[Q]);X&&Le&&Mb(X,Le)&&(T.add(ne[F].name),T.add(ne[Q].name))}return T},[ne]),ge=xe.size>0,ye=h.find(T=>T.name===v)??null,ie=L.useMemo(()=>Dh(h)!==Dh(o),[h,o]),Ve=L.useMemo(()=>{if(!R||!I)return null;const T=h.find(X=>X.name===R);if(!T||T.spanX===null||T.spanY===null)return null;const F=jo(I.cx,I.cy,T.spanX,T.spanY,se),Q=Ji({...T,centerX2:F.centerX2,centerY2:F.centerY2},se);return Q?{name:T.name,rect:Q}:null},[h,R,I,se]);function Re(T,F){_(Q=>Q.map(X=>X.name===T?F(X):X))}function Pe(T,F){T.stopPropagation(),y(F.name);const Q=Ji(F,se);Q&&($(F.name),J({cx:Q.cx,cy:Q.cy}),T.currentTarget.setPointerCapture(T.pointerId))}function z(T){if(!R)return;const F=H.current;if(!F)return;const Q=F.getBoundingClientRect(),X=F.clientWidth/Q.width,Le=F.clientHeight/Q.height;J({cx:Math.max(0,Math.min(F.clientWidth,(T.clientX-Q.left)*X)),cy:Math.max(0,Math.min(F.clientHeight,(T.clientY-Q.top)*Le))})}function Z(){if(R&&I){const T=h.find(F=>F.name===R);if(T&&T.spanX!==null&&T.spanY!==null){const F=jo(I.cx,I.cy,T.spanX,T.spanY,se);Re(R,Q=>({...Q,centerX2:F.centerX2,centerY2:F.centerY2}))}}$(null),J(null)}function oe(T){Re(T,F=>F.spanX===null||F.spanY===null?{...F,rotation:(F.rotation+270)%360}:Th({...F,rotation:(F.rotation+270)%360,spanX:jh(F.spanY,se),spanY:Ah(F.spanX,se)},se))}function we(T,F,Q){Re(T,X=>{if(X.spanX===null||X.spanY===null)return X;const Le=F==="x"?jh(X.spanX+Q,se):X.spanX,je=F==="y"?Ah(X.spanY+Q,se):X.spanY;return Th({...X,spanX:Le,spanY:je},se)})}function ke(T){Re(T,F=>({...F,centerX2:null,centerY2:null,spanX:null,spanY:null,rotation:0})),y(null)}function S(T){N(!1);const F=h.find(je=>je.name===T);if(!F)return;const{spanX:Q,spanY:X}=Rb(F.type),Le=jo(se.areaW/2,se.areaH/2,Q,X,se);Re(T,()=>({...F,spanX:Q,spanY:X,rotation:0,centerX2:Le.centerX2,centerY2:Le.centerY2})),y(T)}async function B(){ge||(G(!0),await c(h),G(!1))}function W(){if(!ie){i(!1);return}u({title:"Kassér ændringer",message:"Vil du forlade redigering og kassere dine layout-ændringer?",confirmLabel:"Kassér",onConfirm:()=>i(!1)})}return f.jsxs("div",{className:"edit-view",children:[f.jsx("div",{className:"edit-band edit-toolbar-band",children:ye&&Ga(ye)?f.jsxs("div",{className:"edit-toolbar",onPointerDown:T=>T.stopPropagation(),children:[f.jsx(Fi,{label:"⟲",title:"Roter",onClick:()=>oe(ye.name)}),f.jsx(Fi,{label:"W−",title:"Gør smallere",onClick:()=>we(ye.name,"x",-1),disabled:ye.spanX===null||ye.spanX<=1}),f.jsx(Fi,{label:"W+",title:"Gør bredere",onClick:()=>we(ye.name,"x",1),disabled:ye.spanX===null||ye.spanX>=se.cols-1}),f.jsx(Fi,{label:"H−",title:"Gør lavere",onClick:()=>we(ye.name,"y",-1),disabled:ye.spanY===null||ye.spanY<=1}),f.jsx(Fi,{label:"H+",title:"Gør højere",onClick:()=>we(ye.name,"y",1),disabled:ye.spanY===null||ye.spanY>=se.rows-1}),f.jsx("button",{className:"iconbtn",style:{color:"var(--red)"},onClick:()=>ke(ye.name),"aria-label":"Slet",children:f.jsx(Fn,{name:"delete",size:24})})]}):f.jsx("span",{className:"edit-hint",children:"Vælg en kontrol for at redigere"})}),f.jsx("div",{className:"controls-area-wrap",children:f.jsx("div",{className:"controls-area",ref:H,style:{touchAction:"none"},onPointerMove:z,onPointerUp:Z,onPointerDown:()=>y(null),children:le&&f.jsxs(f.Fragment,{children:[f.jsx("svg",{width:se.areaW,height:se.areaH,style:{position:"absolute",inset:0,pointerEvents:"none"},children:he.map((T,F)=>f.jsx("circle",{cx:T.x,cy:T.y,r:2.5,fill:"rgba(198,80,78,0.45)"},F))}),Ve&&f.jsx("div",{className:"snap-preview",style:{left:Ve.rect.cx,top:Ve.rect.cy,width:Ve.rect.width,height:Ve.rect.height}}),ne.map(T=>{const F=R===T.name&&I,Q=Ji(T,se);if(!Q)return null;const X=F?I.cx:Q.cx,Le=F?I.cy:Q.cy,je={left:X,top:Le,width:Q.width,height:Q.height,outline:v===T.name?"3px solid var(--text)":"none",outlineOffset:2};return f.jsx("div",{className:`control ${xe.has(T.name)?"colliding":""}`,style:je,onPointerDown:Yn=>Pe(Yn,T),children:T.type==="button"?f.jsx("div",{className:"control-button",style:{width:"100%",height:"100%",display:"grid",placeItems:"center"},children:f.jsx(Bo,{name:T.name,width:Q.width,height:Q.height,rotation:T.rotation})}):T.type==="toggle"?f.jsx("div",{className:"control-toggle on",style:{width:"100%",height:"100%"},children:f.jsx(Bo,{name:T.name,width:Q.width,height:Q.height,rotation:T.rotation})}):T.type==="radar"?f.jsx(s_,{control:T,pings:[],width:Q.width,height:Q.height,preview:!0}):T.type==="text"?f.jsx(i_,{message:T.name,width:Q.width,height:Q.height,rotation:T.rotation}):T.type==="joystick"?f.jsx(f_,{control:T,width:Q.width,height:Q.height,pos:{nx:0,ny:0}}):T.type==="dpad"?f.jsx(d_,{control:T}):f.jsx("div",{className:"control-slider",style:{width:"100%",height:"100%",position:"relative",overflow:"hidden"},children:f.jsx(c_,{name:T.name,rotation:T.rotation,width:Q.width,height:Q.height,value:50,showEnds:!0,lowLabel:String(T.sliderMin??0),highLabel:String(T.sliderMax??100),fillColor:xe.has(T.name)?"var(--disabled)":"var(--red)"})})},T.name)}),d&&f.jsx("button",{type:"button",className:"fab",style:{width:52,height:52,right:12,bottom:12},onPointerDown:T=>T.stopPropagation(),onClick:()=>N(!0),"aria-label":"Tilføj kontrol",children:f.jsx(Fn,{name:"plus",size:24})}),K&&f.jsx("div",{className:"overlay",children:f.jsx("div",{className:"spinner"})})]})})}),f.jsxs("div",{className:"edit-band edit-actions-band",children:[f.jsx("button",{className:"btn btn-outline",style:{flex:1},type:"button",onClick:W,disabled:K,children:"Annuller"}),f.jsx("button",{className:"btn btn-primary",style:{flex:1},type:"button",onClick:B,disabled:ge||K,children:K?"Gemmer...":"Gem"})]}),x&&f.jsx(Eb,{unplaced:ee,onAdd:S,onClose:()=>N(!1)})]})}function Dh(o){return JSON.stringify(o.map(a=>({type:a.type,name:a.name,centerX2:a.centerX2,centerY2:a.centerY2,spanX:a.spanX,spanY:a.spanY,rotation:a.rotation})))}function Fi({label:o,title:a,disabled:c,onClick:i}){return f.jsx("button",{type:"button","aria-label":a,title:a,disabled:c,onClick:i,style:{minWidth:38,height:38,borderRadius:12,background:c?"var(--grey)":"var(--red)",color:"var(--white)",fontWeight:800,fontSize:14,padding:"0 8px"},children:o})}function jb(){const o=te(H=>H.layout),a=te(H=>H.editMode),c=te(H=>H.active),i=te(H=>H.sliderValues),u=te(H=>H.toggleValues),d=te(H=>H.radarPings),h=te(H=>H.textValues),_=te(H=>H.toggleSideMenu),v=te(H=>H.sendButton),y=te(H=>H.sendSlider),x=te(H=>H.sendToggle),N=te(H=>H.sendJoystick),R=te(H=>H.sendDpad),$=L.useRef(null),I=m_($),J=e_(I.w,I.h,c==null?void 0:c.gridCols,c==null?void 0:c.gridRows),K=I.w>0&&I.h>0,G=o.filter(Ga);return f.jsxs("div",{className:"screen control-screen",children:[f.jsx(Vf,{title:"Kontrol Panel",onMenu:()=>_()}),a?f.jsx(Tb,{}):f.jsx("div",{className:"controls-area-wrap",children:f.jsx("div",{className:"controls-area",ref:$,children:K?G.map(H=>{const ae=Ji(H,J);return ae?f.jsx(nb,{control:H,rect:ae,disabled:!1,latestValue:H.type==="slider"?i[H.name]:void 0,toggleValue:H.type==="toggle"?u[H.name]:void 0,radarPings:H.type==="radar"?d[H.name]:void 0,textValue:H.type==="text"?h[H.name]:void 0,onButton:v,onSlider:y,onToggle:x,onJoystick:N,onDpad:R},H.name):null}):f.jsx("div",{className:"overlay",children:f.jsx("div",{className:"spinner"})})})})]})}const Ab="",Oh="",Ch="",Xl="";function Ki(o){return new Promise(a=>setTimeout(a,o))}class Db{constructor(a){this.transport=a}async interrupt(){await this.transport.write(Ch),await Ki(80),await this.transport.write(Ch)}async friendlyRepl(){await this.transport.write(Oh)}async softReset(){await this.transport.write(Xl)}async stop(){await this.interrupt(),await this.friendlyRepl().catch(()=>{})}async runFile(a,c){await this.interrupt(),await this.waitForFriendlyPrompt().catch(async()=>{await this.friendlyRepl().catch(()=>{}),await Ki(180)}),await Ki(120),c==null||c(),await this.transport.writeLine(`import builtins as _pkp_builtins; exec(_pkp_builtins.open(${JSON.stringify(a)}).read())`)}async sendFriendlyLine(a){await this.friendlyRepl().catch(()=>{}),await this.transport.writeLine(a)}async sendProgramInput(a){await this.transport.writeLine(a)}async enterRawRepl(a=2500){if(await this.interrupt(),await Ki(80),await this.transport.write(`\r
`),await Ki(40),!(await this.collectUntil(async()=>{await this.transport.write(Ab)},i=>i.includes("raw REPL")||i.includes("raw REPL; CTRL-B to exit"),a)).includes("raw REPL"))throw new Error("Kunne ikke skifte til MicroPython raw REPL.")}async exec(a,c=6e3){await this.enterRawRepl();const i=await this.collectUntil(async()=>{await this.transport.write(a),a.endsWith(`
`)||await this.transport.write(`
`),await this.transport.write(Xl)},u=>u.includes(`${Xl}${Xl}`)||u.includes(`${Xl}>`),c);return await this.friendlyRepl().catch(()=>{}),Ob(i)}collectUntil(a,c,i){return new Promise((u,d)=>{let h="",_=null;const v=setTimeout(()=>{_==null||_(),d(new Error("Timeout ved USB REPL kommando."))},i);_=this.transport.addDataListener(y=>{h+=y,c(h)&&(clearTimeout(v),_==null||_(),u(h))}),a().catch(y=>{clearTimeout(v),_==null||_(),d(y instanceof Error?y:new Error("USB REPL kommando fejlede."))})})}async waitForFriendlyPrompt(a=1600){await this.collectUntil(async()=>{await this.transport.write(Oh)},c=>/(^|\r?\n)>>> ?$/.test(c),a)}}function Ob(o){const a=o.indexOf("OK"),c=o.indexOf(Xl,a>=0?a:0),i=c>=0?o.indexOf(Xl,c+1):-1;if(a<0||c<0)return{output:o.trim(),error:"",raw:o};const u=o.slice(a+2,c).replace(/^\r?\n/,"").trimEnd(),d=i>=0?o.slice(c+1,i).trim():"";return{output:u,error:d,raw:o}}const Cb=[{version:"MicroPython v1.28.0",date:"2026-04-06",stamp:"20260406",tag:"v1.28.0"},{version:"MicroPython v1.27.0",date:"2025-12-09",stamp:"20251209",tag:"v1.27.0"},{version:"MicroPython v1.26.1",date:"2025-09-11",stamp:"20250911",tag:"v1.26.1"},{version:"MicroPython v1.26.0",date:"2025-08-09",stamp:"20250809",tag:"v1.26.0"},{version:"MicroPython v1.25.0",date:"2025-04-15",stamp:"20250415",tag:"v1.25.0"},{version:"MicroPython v1.24.1",date:"2024-11-29",stamp:"20241129",tag:"v1.24.1"},{version:"MicroPython v1.24.0",date:"2024-10-25",stamp:"20241025",tag:"v1.24.0"},{version:"MicroPython v1.23.0",date:"2024-06-02",stamp:"20240602",tag:"v1.23.0"},{version:"MicroPython v1.22.2",date:"2024-02-22",stamp:"20240222",tag:"v1.22.2"},{version:"MicroPython v1.22.1",date:"2024-01-05",stamp:"20240105",tag:"v1.22.1"}],Lb=[{board:"Raspberry Pi Pico",firmwareName:"RPI_PICO"},{board:"Raspberry Pi Pico W",firmwareName:"RPI_PICO_W"}],fl=Lb.flatMap(({board:o,firmwareName:a})=>Cb.map(({version:c,date:i,stamp:u,tag:d})=>{const h=`${a}-${u}-${d}.uf2`;return{board:o,version:c,date:i,fileName:h,url:`https://micropython.org/resources/firmware/${h}`}})),gf=512,bf=`import builtins as _pkp_builtins
`;function Tr(o){return JSON.stringify(o)}function Bb(o){return`bytes.fromhex(${JSON.stringify([...o].map(a=>a.toString(16).padStart(2,"0")).join(""))})`}function zb(o,a){return`${o==="/"?"":o.replace(/\/$/,"")}/${a}`}class Ub{constructor(a){this.repl=a}async list(a="/"){const c=`
import os
base = ${Tr(a)}
...
`,i=await this.repl.exec(c);if(i.error)throw new Error(i.error);return i.output.split(/\r?\n/).map(u=>u.trim()).filter(Boolean).map(u=>{const[d,h,_]=u.split("	"),v=h==="dir"||h==="file"?h:"unknown",y=parseInt(_??"",10);return{name:d,path:zb(a,d),type:v,...Number.isFinite(y)&&y>=0?{size:y}:{}}})}async readText(a){const c=`
import sys
${bf}with _pkp_builtins.open(${Tr(a)}, 'rb') as f:
    while True:
        b = f.read(${gf})
        if not b:
            break
        print(b.hex())
`,i=await this.repl.exec(c,1e4);if(i.error)throw new Error(i.error);const u=i.output.replace(/\s+/g,"");return new TextDecoder().decode(Hb(u))}async writeText(a,c,i){const u=new TextEncoder().encode(c);if(i==null||i(5,"Klargør fil..."),await this.repl.exec(`${bf}_pkp_builtins.open(${Tr(a)}, 'wb').close()`),u.length===0){i==null||i(100,"Gemt på Pico");return}for(let d=0;d<u.length;d+=gf){const h=u.slice(d,d+gf),_=`
${bf}with _pkp_builtins.open(${Tr(a)}, 'ab') as f:
    f.write(${Bb(h)})
...
import os
os.remove(${Tr(a)})
`);if(c.error)throw new Error(c.error)}async nextBackupPath(a){const c=await this.list("/"),i=new Set(c.map(N=>N.path.toLowerCase())),u=a.replace(/\\/g,"/"),d=u.lastIndexOf("/"),h=d>=0?u.slice(0,d+1):"/",_=d>=0?u.slice(d+1):u.replace(/^\/+/,""),v=_.lastIndexOf("."),y=v>0?_.slice(0,v):_,x=v>0?_.slice(v):"";for(let N=1;N<1e3;N+=1){const R=`${h}${y}_backup${N}${x}`;if(!i.has(R.toLowerCase()))return R}return`${h}${y}_backup${Date.now()}${x}`}async rename(a,c){const i=await this.repl.exec(`
import os
os.rename(${Tr(a)}, ${Tr(c)})
`);if(i.error)throw new Error(i.error)}}function Hb(o){const a=new Uint8Array(Math.floor(o.length/2));for(let c=0;c<a.length;c+=1)a[c]=parseInt(o.slice(c*2,c*2+2),16);return a}const Vb=`import ubluetooth\r
