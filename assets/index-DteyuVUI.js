 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sh;function nb(){return sh||(sh=1,(function(s){function i(H,ne){var ce=H.length;H.push(ne);e:for(;0<ce;){var pe=ce-1>>>1,Ee=H[pe];if(0<f(Ee,ne))H[pe]=ne,H[ce]=Ee,ce=pe;else break e}}function c(H){return H.length===0?null:H[0]}function a(H){if(H.length===0)return null;var ne=H[0],ce=H.pop();if(ce!==ne){H[0]=ce;e:for(var pe=0,Ee=H.length,k=Ee>>>1;pe<k;){var z=2*(pe+1)-1,ee=H[z],oe=z+1,ye=H[oe];if(0>f(ee,ce))oe<Ee&&0>f(ye,ee)?(H[pe]=ye,H[oe]=ce,pe=oe):(H[pe]=ee,H[z]=ce,pe=z);else if(oe<Ee&&0>f(ye,ce))H[pe]=ye,H[oe]=ce,pe=oe;else break e}}return ne}function f(H,ne){var ce=H.sortIndex-ne.sortIndex;return ce!==0?ce:H.id-ne.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;s.unstable_now=function(){return h.now()}}else{var b=Date,p=b.now();s.unstable_now=function(){return b.now()-p}}var g=[],y=[],w=1,S=null,N=3,D=!1,U=!1,K=!1,q=!1,P=typeof setTimeout=="function"?setTimeout:null,G=typeof clearTimeout=="function"?clearTimeout:null,re=typeof setImmediate<"u"?setImmediate:null;function ie(H){for(var ne=c(y);ne!==null;){if(ne.callback===null)a(y);else if(ne.startTime<=H)a(y),ne.sortIndex=ne.expirationTime,i(g,ne);else break;ne=c(y)}}function ge(H){if(K=!1,ie(H),!U)if(c(g)!==null)U=!0,he||(he=!0,W());else{var ne=c(y);ne!==null&&Ve(ge,ne.startTime-H)}}var he=!1,Q=-1,J=5,ke=-1;function we(){return q?!0:!(s.unstable_now()-ke<J)}function Ye(){if(q=!1,he){var H=s.unstable_now();ke=H;var ne=!0;try{e:{U=!1,K&&(K=!1,G(Q),Q=-1),D=!0;var ce=N;try{n:{for(ie(H),S=c(g);S!==null&&!(S.expirationTime>H&&we());){var pe=S.callback;if(typeof pe=="function"){S.callback=null,N=S.priorityLevel;var Ee=pe(S.expirationTime<=H);if(H=s.unstable_now(),typeof Ee=="function"){S.callback=Ee,ie(H),ne=!0;break n}S===c(g)&&a(g),ie(H)}else a(g);S=c(g)}if(S!==null)ne=!0;else{var k=c(y);k!==null&&Ve(ge,k.startTime-H),ne=!1}}break e}finally{S=null,N=ce,D=!1}ne=void 0}}finally{ne?W():he=!1}}}var W;if(typeof re=="function")W=function(){re(Ye)};else if(typeof MessageChannel<"u"){var nn=new MessageChannel,ze=nn.port2;nn.port1.onmessage=Ye,W=function(){ze.postMessage(null)}}else W=function(){P(Ye,0)};function Ve(H,ne){Q=P(function(){H(s.unstable_now())},ne)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(H){H.callback=null},s.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<H?Math.floor(1e3/H):5},s.unstable_getCurrentPriorityLevel=function(){return N},s.unstable_next=function(H){switch(N){case 1:case 2:case 3:var ne=3;break;default:ne=N}var ce=N;N=ne;try{return H()}finally{N=ce}},s.unstable_requestPaint=function(){q=!0},s.unstable_runWithPriority=function(H,ne){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var ce=N;N=H;try{return ne()}finally{N=ce}},s.unstable_scheduleCallback=function(H,ne,ce){var pe=s.unstable_now();switch(typeof ce=="object"&&ce!==null?(ce=ce.delay,ce=typeof ce=="number"&&0<ce?pe+ce:pe):ce=pe,H){case 1:var Ee=-1;break;case 2:Ee=250;break;case 5:Ee=1073741823;break;case 4:Ee=1e4;break;default:Ee=5e3}return Ee=ce+Ee,H={id:w++,callback:ne,priorityLevel:H,startTime:ce,expirationTime:Ee,sortIndex:-1},ce>pe?(H.sortIndex=ce,i(y,H),c(g)===null&&H===c(y)&&(K?(G(Q),Q=-1):K=!0,Ve(ge,ce-pe))):(H.sortIndex=Ee,i(g,H),U||D||(U=!0,he||(he=!0,W()))),H},s.unstable_shouldYield=we,s.unstable_wrapCallback=function(H){var ne=N;return function(){var ce=N;N=ne;try{return H.apply(this,arguments)}finally{N=ce}}}})(Ef)),Ef}var oh;function tb(){return oh||(oh=1,Sf.exports=nb()),Sf.exports}var kf={exports:{}},Jn={};/**
 * @license React
...
`,b),w=y===-1?s.length:y;if(i<=w&&b>=c)return!0;b=w;continue}if(g==='"""'||g==="'''"){f=p,b+=2;continue}(p==='"'||p==="'")&&(a=p)}return a!==null||f!==null}function M_(s,i){const c=s.insert.trim();return!/[().]/.test(c)&&c.toLowerCase()===i.toLowerCase()}function Jy(s){return/^[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_]*$/.test(s)}function Zh(s,i,c){if(!s)return null;const a=s.closest(".ide-terminal")??s.parentElement;if(!a)return null;const f=window.getComputedStyle(s),h=document.createElement("div"),b=document.createElement("span"),p=a.getBoundingClientRect(),g=s.getBoundingClientRect();h.style.position="absolute",h.style.visibility="hidden",h.style.pointerEvents="none",h.style.whiteSpace="pre-wrap",h.style.overflowWrap="break-word",h.style.wordBreak=f.wordBreak,h.style.boxSizing=f.boxSizing,h.style.width=`${s.getBoundingClientRect().width}px`,h.style.padding=f.padding,h.style.border=f.border,h.style.font=f.font,h.style.lineHeight=f.lineHeight,h.style.letterSpacing=f.letterSpacing,h.style.tabSize=f.tabSize,h.style.fontVariantLigatures=f.fontVariantLigatures,h.style.scrollbarGutter=f.scrollbarGutter,h.style.left=`${g.left-p.left-s.scrollLeft}px`,h.style.top=`${g.top-p.top-s.scrollTop}px`,h.textContent=s.value.slice(0,i),b.textContent=s.value.slice(i,i+1)||" ",h.appendChild(b),a.appendChild(h);const y=b.getBoundingClientRect();h.remove();const w=34,S=14,N=Math.min(210,Math.max(w+S,c*w+S)),D=ev(y.left-p.left,8,Math.max(8,a.clientWidth-296)),U=y.top-p.top+a.scrollTop,K=y.bottom-p.top+a.scrollTop+10,q=a.scrollTop+a.clientHeight-K-8,P=U-a.scrollTop-8,G=a.scrollTop+a.clientHeight,re=q>=Math.min(N,w*2)||q>=P?"below":"above",ie=Math.max(w+S,Math.min(N,re==="below"?q:P)),ge=re==="below"?Math.min(K,G-ie-8):Math.max(a.scrollTop+8,U-ie-8);return{left:D,top:ge,maxHeight:ie,placement:re}}function ev(s,i,c){return Math.max(i,Math.min(c,s))}function nv(s,i=""){const c=/\b(False|None|True|and|as|assert|async|await|break|class|continue|def|del|elif|else|except|finally|for|from|global|if|import|in|is|lambda|nonlocal|not|or|pass|raise|return|try|while|with|yield)\b/g,a=/(#.*$|"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|\b\d+(?:\.\d+)?\b|\b(?:print|range|len|str|int|float|bool|list|dict|set|tuple|sum|min|max|abs|round)\b)/gm,f=[];return s.split(/(\r?\n)/).forEach((h,b)=>{if(h===`
`||h===`\r
`){f.push(u.jsx("br",{},`br-${b}`));return}let p=0;[...h.matchAll(a)].forEach((y,w)=>{const S=y.index??0;S>p&&f.push(...Wh(h.slice(p,S),c,`${b}-${w}-plain`,i));const N=y[0],D=N.startsWith("#")?"tok-comment":N.startsWith('"')||N.startsWith("'")?"tok-string":/^\d/.test(N)?"tok-number":"tok-builtin";f.push(...Wo(N,i,`${b}-${w}-token`,D)),p=S+N.length}),p<h.length&&f.push(...Wh(h.slice(p),c,`${b}-tail`,i))}),f.length?f:" "}function Wh(s,i,c,a=""){const f=[];let h=0;const b=new RegExp(i.source,"g");return[...s.matchAll(b)].forEach((p,g)=>{const y=p.index??0;y>h&&f.push(...Wo(s.slice(h,y),a,`${c}-${g}-plain`)),f.push(...Wo(p[0],a,`${c}-${g}-keyword`,"tok-keyword")),h=y+p[0].length}),h<s.length&&f.push(...Wo(s.slice(h),a,`${c}-plain-end`)),f}function Wo(s,i,c,a=""){if(!i)return[u.jsx("span",{className:a||void 0,children:s},c)];const f=[],h=i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),b=new RegExp(`(?<![A-Za-zÆØÅæøå0-9_])(${h})(?![A-Za-zÆØÅæøå0-9_])`,"g");let p=0;return[...s.matchAll(b)].forEach((g,y)=>{const w=g.index??0;w>p&&f.push(u.jsx("span",{className:a||void 0,children:s.slice(p,w)},`${c}-${y}-before`)),f.push(u.jsx("span",{className:`${a} tok-match`.trim(),children:g[0]},`${c}-${y}-match`)),p=w+g[0].length}),p<s.length&&f.push(u.jsx("span",{className:a||void 0,children:s.slice(p)},`${c}-after`)),f.length?f:[u.jsx("span",{className:a||void 0,children:s},c)]}function Xo(s){return s.length>0?s:[{path:Ff,content:R_,uploaded:!1,updatedAt:Date.now()}]}function zf(s,i,c,a){const f=s.filter(h=>h.path!==i);return[{path:i,content:c,uploaded:a,updatedAt:Date.now()},...f].sort((h,b)=>b.updatedAt-h.updatedAt)}function Jo(s){return s.map(i=>({name:Re(i.path),path:i.path,type:"file",size:new Blob([i.content]).size}))}function tv(s,i,c){var a;return s.source==="pico"?c[s.path]:(a=i.find(f=>f.path===s.path))==null?void 0:a.content}function ec(s){const i=s.replace(/\\/g,"/"),c=i.lastIndexOf("/"),a=c>=0?i.slice(0,c+1):"",h=(c>=0?i.slice(c+1):i).match(/^(.+)_backup(\d+)(\.[^.]+)$/i);return h?{originalPath:`${a}${h[1]}${h[3]}`,index:parseInt(h[2],10)}:null}function Dr(s){return ec(s)!==null}function ea(s){const i=new Map;for(const c of s){const a=ec(c.path);if(!a)continue;const f=i.get(a.originalPath)??[];f.push(c),i.set(a.originalPath,f)}for(const c of i.values())c.sort((a,f)=>{var h,b;return(((h=ec(f.path))==null?void 0:h.index)??0)-(((b=ec(a.path))==null?void 0:b.index)??0)});return i}function Jh(s,i){const c=s.replace(/\\/g,"/"),a=c.lastIndexOf("/"),f=a>=0?c.slice(0,a+1):"/",h=a>=0?c.slice(a+1):c.replace(/^\/+/,""),b=h.lastIndexOf("."),p=b>0?h.slice(0,b):h,g=b>0?h.slice(b):"",y=new Set(i.map(w=>w.path.toLowerCase()));for(let w=1;w<1e3;w+=1){const S=`${f}${p}_backup${w}${g}`;if(!y.has(S.toLowerCase()))return S}return`${f}${p}_backup${Date.now()}${g}`}function lv(s,i){const c=s.replace(/\\/g,"/"),a=c.lastIndexOf("/"),f=a>=0?c.slice(0,a+1):"/",h=a>=0?c.slice(a+1):c.replace(/^\/+/,""),b=h.lastIndexOf("."),p=b>0?h.slice(0,b):h,g=b>0?h.slice(b):"";for(let y=1;y<1e3;y+=1){const w=y===1?"_kopi":`_kopi${y}`,S=`${f}${p}${w}${g}`;if(!i(S)&&!Dr(S))return S}return`${f}${p}_kopi${Date.now()}${g}`}function rv(s){return s==="ok"?"Nyeste":s==="outdated"?"Opdater":s==="missing"?"Mangler":"Ikke tjekket"}function iv(s,i,c,a){const f=new Map,h=ea(s),b=ea(Jo(i));for(const S of s)Dr(S.path)||f.set($n("pico",S.path),{kind:"file",name:S.name,path:S.path,type:S.type,size:S.size,source:"pico",uploaded:!0,versions:h.get(S.path)??[]});for(const S of i)Dr(S.path)||f.set($n("local",S.path),{kind:"file",name:Re(S.path),path:S.path,type:"file",source:"local",uploaded:!1,versions:b.get(S.path)??[]});for(const S of Object.keys(c)){const[N,...D]=S.split(":"),U=D.join(":");if(N!=="local"&&N!=="pico"||!U)continue;const K=f.get(S);if(K){f.set(S,K);continue}f.set(S,{kind:"file",name:Re(U),path:U,type:"file",source:N,uploaded:!1,versions:N==="pico"?h.get(U)??[]:b.get(U)??[]})}const p=[...f.values()].sort(sv),g=p.filter(S=>S.source==="pico"),y=p.filter(S=>S.source==="local"),w=[];return g.length>0||a?w.push({kind:"separator",id:"pico-files",label:a?"Pico":"Microcontroller"},...g):w.push({kind:"separator",id:"pico-files",label:"Microcontroller"}),y.length>0&&w.push({kind:"separator",id:"browser-files",label:"Browser"},...y),w}const av=new Map([["main.py",0],["devicesettings.txt",1],["layout.txt",2],["picobluetooth.py",3],["picofly.py",4],["picorobotics.py",5],["neopixel.py",6],["hcsr04.py",7]]);function sv(s,i){const c=e_(s.path),a=e_(i.path);return c===null&&a===null?s.name.localeCompare(i.name,"da"):c===null?-1:a===null?1:c-a}function e_(s){var c;const i=(c=s.replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:c.toLowerCase();return i?av.get(i)??null:null}function n_(s,i,c){if(!(i in s))return s;const a={...s,[c]:s[i]};return delete a[i],a}function ov(s,i,c,a){const f=`${i}:${c}`;if(!(f in s))return s;const h={...s,[`${i}:${a}`]:s[f]};return delete h[f],h}function cv({open:s}){const i=te(G=>G.screen),c=te(G=>G.active),a=te(G=>G.toggleSideMenu),f=te(G=>G.toggleDebugger),h=te(G=>G.setEditMode),b=te(G=>G.openMenuPage),p=te(G=>G.disconnect),g=te(G=>G.openPicoIde),y=te(G=>G.closePicoIde),w=te(G=>G.picoIdeOrigin),S=i==="dashboard",N=i==="control",D=i==="ide",U=N&&!!(c!=null&&c.canEdit),K=!N||!!(c!=null&&c.isOwnedByMe)||!!(c!=null&&c.canEditCode),q=w==="control",P=w==="control"?"Kontrol Panel":"Hovedmenu";return u.jsxs(u.Fragment,{children:[u.jsx("div",{className:`scrim ${s?"open":"closing"}`,onClick:()=>a(!1)}),u.jsxs("nav",{className:`sidemenu sidemenu-${i} ${s?"open":"closing"}`,"aria-label":"Sidemenu",children:[S&&u.jsxs(u.Fragment,{children:[u.jsx(Tt,{label:"Bruger",icon:"user",onClick:()=>b("user-settings")}),u.jsx(Tt,{label:"Indstillinger",icon:"settings",onClick:()=>b("application-settings")}),u.jsx(Tt,{label:"Kodeværksted",icon:"picoIde",onClick:g,disabled:!K}),u.jsx(Uf,{}),u.jsx(Tt,{label:"Om appen",icon:"info",onClick:()=>b("application-about")}),u.jsx(Tt,{label:"Hjælp",icon:"help",onClick:()=>b("application-help")}),u.jsx(Tt,{label:"Fejlfinding",icon:"debugger",onClick:()=>f(!0)})]}),N&&u.jsxs(u.Fragment,{children:[u.jsx(Tt,{label:"Indstillinger",icon:"settings",onClick:()=>b("device-settings")}),u.jsx(Tt,{label:"Rediger",icon:"edit",onClick:()=>h(!0),disabled:!U}),u.jsx(Tt,{label:"Kodeværksted",icon:"picoIde",onClick:g,disabled:!K}),u.jsx(Uf,{}),u.jsx(Tt,{label:"Hjælp",icon:"help",onClick:()=>b("device-help")}),u.jsx(Tt,{label:"Fejlfinding",icon:"debugger",onClick:()=>f(!0)})]}),D&&u.jsxs(u.Fragment,{children:[u.jsx(Tt,{label:P,icon:"back",onClick:y}),u.jsx(Uf,{})]}),u.jsx("div",{className:"spacer"}),(N||D&&q)&&u.jsx(Tt,{label:"Forlad",icon:"exit",onClick:()=>p()})]})]})}function Tt({label:s,icon:i,disabled:c,onClick:a}){return u.jsxs("button",{className:"iconbtn",type:"button",onClick:a,disabled:c,"aria-label":s,children:[u.jsx(rt,{name:i}),u.jsx("span",{children:s})]})}function Uf(){return u.jsxs("a",{className:"iconbtn sidemenu-link",href:"https://www.teknologiskolen.dk/",target:"_blank",rel:"noreferrer","aria-label":"Teknologiskolen",children:[u.jsx("img",{src:qb,alt:""}),u.jsx("span",{children:"Teknologiskolen"})]})}const uv={error:"term-error",success:"term-success",warning:"term-warning",info:""},t_={error:"[FEJL] ",success:"[SUCCES] ",warning:"[ADVARSEL] ",info:""};function fv(){const s=new Date,i=c=>String(c).padStart(2,"0");return`${i(s.getDate())}-${i(s.getMonth()+1)}-${s.getFullYear()}-${i(s.getHours())}-${i(s.getMinutes())}`}function dv(){const s=te(f=>f.logs),i=te(f=>f.clearLogs),c=te(f=>f.toggleDebugger);function a(){const f=[...s].reverse().map(g=>`${g.time} ${t_[g.level]}${g.message}`).join(`
`),h=new Blob([f],{type:"text/plain"}),b=URL.createObjectURL(h),p=document.createElement("a");p.href=b,p.download=`${fv()}.txt`,p.click(),URL.revokeObjectURL(b)}return u.jsxs(On,{title:"Fejlfinding",onClose:()=>c(!1),closeVariant:"circle",children:[u.jsx("div",{className:"terminal",children:s.length===0?u.jsx("div",{className:"term-line",children:"Ingen log endnu."}):s.map((f,h)=>u.jsxs("div",{className:`term-line ${uv[f.level]}`,children:[f.time," ",t_[f.level],f.message]},`${f.time}-${h}`))}),u.jsxs("div",{className:"row",style:{marginTop:14},children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:i,children:"Ryd"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:a,children:"Gem logfil"})]})]})}const j_=4,Ft=j_*4+17,l_=80,mv=20,pv=30660;function hv(s){const i=new TextEncoder().encode(s);if(i.length>76)throw new Error("QR-koden er for lang.");const c=r_(!1),a=r_(!1);_v(c,a);const f=bv(i),h=xv(f,mv);return yv(c,a,[...f,...h]),vv(c,a),c}function r_(s){return Array.from({length:Ft},()=>Array.from({length:Ft},()=>s))}function Yt(s,i,c,a,f,h=!0){s[a][c]=f,h&&(i[a][c]=!0)}function _v(s,i){Hf(s,i,0,0),Hf(s,i,Ft-7,0),Hf(s,i,0,Ft-7);for(let c=0;c<Ft;c+=1)i[6][c]||Yt(s,i,c,6,c%2===0),i[c][6]||Yt(s,i,6,c,c%2===0);gv(s,i,26,26),Yt(s,i,8,j_*4+9,!0)}function Hf(s,i,c,a){for(let f=-1;f<=7;f+=1)for(let h=-1;h<=7;h+=1){const b=c+h,p=a+f;if(b<0||p<0||b>=Ft||p>=Ft)continue;const g=h>=0&&h<=6&&f>=0&&f<=6&&(h===0||h===6||f===0||f===6||h>=2&&h<=4&&f>=2&&f<=4);Yt(s,i,b,p,g)}}function gv(s,i,c,a){for(let f=-2;f<=2;f+=1)for(let h=-2;h<=2;h+=1)i[a+f][c+h]||Yt(s,i,c+h,a+f,Math.max(Math.abs(h),Math.abs(f))!==1)}function bv(s){const i=[];Qo(i,4,4),Qo(i,s.length,8);for(const a of s)Qo(i,a,8);for(Qo(i,0,Math.min(4,l_*8-i.length));i.length%8!==0;)i.push(0);const c=[];for(let a=0;a<i.length;a+=8)c.push(i.slice(a,a+8).reduce((f,h)=>f<<1|h,0));for(let a=236;c.length<l_;a=a===236?17:236)c.push(a);return c}function Qo(s,i,c){for(let a=c-1;a>=0;a-=1)s.push(i>>>a&1)}function yv(s,i,c){const a=c.flatMap(b=>Array.from({length:8},(p,g)=>b>>>7-g&1));let f=0,h=!0;for(let b=Ft-1;b>=1;b-=2){b===6&&(b-=1);for(let p=0;p<Ft;p+=1){const g=h?Ft-1-p:p;for(let y=0;y<2;y+=1){const w=b-y;if(i[g][w])continue;const S=f<a.length?a[f]===1:!1;s[g][w]=S!==((w+g)%2===0),f+=1}}h=!h}}function vv(s,i){const c=a=>(pv>>>a&1)!==0;for(let a=0;a<=5;a+=1)Yt(s,i,8,a,c(a));Yt(s,i,8,7,c(6)),Yt(s,i,8,8,c(7)),Yt(s,i,7,8,c(8));for(let a=9;a<15;a+=1)Yt(s,i,14-a,8,c(a));for(let a=0;a<8;a+=1)Yt(s,i,Ft-1-a,8,c(a));for(let a=8;a<15;a+=1)Yt(s,i,8,Ft-15+a,c(a))}const hs=new Array(512),Kf=new Array(256);let i_=!1;function D_(){if(i_)return;let s=1;for(let i=0;i<255;i+=1)hs[i]=s,Kf[s]=i,s<<=1,s&256&&(s^=285);for(let i=255;i<512;i+=1)hs[i]=hs[i-255];i_=!0}function A_(s,i){return s===0||i===0?0:hs[Kf[s]+Kf[i]]}function xv(s,i){D_();const c=wv(i),a=Array.from({length:i},()=>0);for(const f of s){const h=f^a.shift();a.push(0);for(let b=0;b<i;b+=1)a[b]^=A_(c[b],h)}return a}function wv(s){D_();let i=[1];for(let c=0;c<s;c+=1){const a=Array.from({length:i.length+1},()=>0);for(let f=0;f<i.length;f+=1)a[f]^=A_(i[f],hs[c]),a[f+1]^=i[f];i=a}return i.slice(1)}function Sv(){const s=te(me=>me.menuPage),i=te(me=>me.closeMenuPage),c=te(me=>me.user),a=te(me=>me.active),f=te(me=>me.layout),h=te(me=>me.sliderValues),b=te(me=>me.savedDevices),p=te(me=>me.updateUsername),g=te(me=>me.createOwnerPairingCode),y=te(me=>me.applyOwnerPairingCode),w=te(me=>me.clearSavedDevices),S=te(me=>me.resetApplicationData),N=te(me=>me.saveDeviceSettings),D=te(me=>me.setEditMode),U=te(me=>me.askConfirm),[K,q]=L.useState((c==null?void 0:c.username)??""),[P,G]=L.useState(!1),[re,ie]=L.useState(""),[ge,he]=L.useState(""),[Q,J]=L.useState(!1),[ke,we]=L.useState(""),Ye=L.useRef(null),[W,nn]=L.useState((a==null?void 0:a.iconID)??0),[ze,Ve]=L.useState(!1),[H,ne]=L.useState((a==null?void 0:a.canOthersConnect)??!1),[ce,pe]=L.useState((a==null?void 0:a.canOthersEdit)??!1),[Ee,k]=L.useState((a==null?void 0:a.canOthersEditCode)??!1),[z,ee]=L.useState((a==null?void 0:a.gridCols)??11),[oe,ye]=L.useState((a==null?void 0:a.gridRows)??31),[I,A]=L.useState(!1);L.useEffect(()=>{s==="user-settings"&&(q((c==null?void 0:c.username)??""),he(""),we(""),J(!1))},[s,c==null?void 0:c.username]),L.useEffect(()=>{s==="device-settings"&&a&&(nn(a.iconID),ne(a.canOthersConnect),pe(a.canOthersEdit),k(a.canOthersEditCode),ee(a.gridCols),ye(a.gridRows))},[a,s]),L.useEffect(()=>{if(!Q)return;let me=!1,De=null,vn=0;async function Ae(){var qn;const mn=window.BarcodeDetector;if(!mn||!((qn=navigator.mediaDevices)!=null&&qn.getUserMedia)){we("Denne browser kan ikke scanne QR-koder. Skriv ejerkoden i stedet."),J(!1);return}try{De=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const Rn=Ye.current;if(!Rn)return;Rn.srcObject=De,await Rn.play();const fl=new mn({formats:["qr_code"]}),$t=async()=>{var jt;if(!me){try{const Pl=(jt=(await fl.detect(Rn)).find(xn=>xn.rawValue))==null?void 0:jt.rawValue;if(Pl){he(Pl),y(Pl)&&G(!1),J(!1);return}}catch{}vn=window.requestAnimationFrame($t)}};vn=window.requestAnimationFrame($t)}catch{we("Kameraet kunne ikke åbnes. Skriv ejerkoden i stedet."),J(!1)}}return Ae(),()=>{me=!0,vn&&window.cancelAnimationFrame(vn),De==null||De.getTracks().forEach(mn=>mn.stop())}},[y,Q]);const ae=(me,De)=>Number.isFinite(me)?Math.max(ta,Math.min(la,Math.round(me))):De,be=(c==null?void 0:c.username)??"",Oe=K.trim(),Ge=Oe.length>0&&Oe!==be;if(!s)return null;if(s==="user-settings"){let me=function(){const Ae=g();Ae&&(ie(Ae),he(""),G(!0))},De=function(){y(ge)&&(he(""),G(!1))};async function vn(){var Ae;try{await((Ae=navigator.clipboard)==null?void 0:Ae.writeText(re))}catch{}}return u.jsxs(u.Fragment,{children:[u.jsx(On,{title:"Brugerindstillinger",onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Pt,{label:"GUID",value:(c==null?void 0:c.userID)??"Ukendt"}),u.jsxs("div",{className:`field ${K.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-username",value:K,onChange:Ae=>q(Ae.target.value),maxLength:24,autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-username",children:"Brugernavn"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>p(K),disabled:!Ge,children:"Gem nyt brugernavn"}),u.jsx("div",{className:"notice",children:"Ejerkode bruges, hvis den samme person skal forbinde fra flere browsere eller telefoner."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:me,children:"Ejerkode"}),u.jsx("button",{className:"btn btn-outline btn-block btn-danger",type:"button",onClick:()=>U({title:"Start forfra",message:"Vil du slette brugeroplysninger og gemte enheder fra denne browser? Siden genindlæses bagefter.",confirmLabel:"Slet alt",onConfirm:()=>{S()}}),children:"Slet brugerdata"})]})}),P&&u.jsx(On,{title:"Del ejerkode",onClose:()=>G(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Nv,{code:re}),u.jsx("code",{className:"owner-code-text",children:re}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void vn(),children:"Kopiér ejerkode"}),u.jsxs("div",{className:`field ${ge.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-owner-code",value:ge,onChange:Ae=>he(Ae.target.value),autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-owner-code",children:"Skriv ejerkode"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:De,disabled:!ge.trim(),children:"Brug ejerkode i denne browser"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>J(Ae=>!Ae),children:Q?"Stop scanning":"Scan QR-kode"}),ke&&u.jsx("div",{className:"notice",children:ke}),Q&&u.jsx("video",{className:"owner-code-video",ref:Ye,muted:!0,playsInline:!0})]})})]})}if(s==="application-settings")return u.jsx(On,{title:"Applikationsindstillinger",onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Pt,{label:"Version",value:_s}),u.jsx(Pt,{label:"Bluetooth",value:oc()?"Tilgængelig":"Ikke tilgængelig"}),u.jsx(Pt,{label:"Gemte enheder",value:String(b.length)}),u.jsx("div",{className:"notice",children:"Bluetooth-tilladelser styres af browseren. Hvis du vil glemme en parret Pico helt, skal du fjerne tilladelsen i browserens site- eller Bluetooth-indstillinger."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>U({title:"Ryd gemte enheder",message:"Vil du fjerne alle gemte enheder fra denne browser?",confirmLabel:"Ryd",onConfirm:w}),disabled:b.length===0,children:"Ryd gemte enheder"})]})});if(s==="application-about")return u.jsx(On,{title:"Om appen",onClose:i,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Pico Kontrol Panel er lavet til at bygge og fjernstyre sjove eller seje Raspberry Pi Pico W-projekter."}),u.jsx(Pt,{label:"Udvikler",value:"Christian Bröchner Rasmussen"}),u.jsx(Pt,{label:"Version",value:_s})]})});if(s==="application-help")return u.jsx(On,{title:"Hjælp til applikationen",onClose:i,children:u.jsxs("div",{className:"settings-stack prose help-lesson",children:[u.jsxs("div",{className:"help-lesson-card",children:[u.jsx("strong",{children:"Komplet undervisningsforløb"}),u.jsx("p",{children:"Linket åbner Teknologiskolens guide til Pico Kontrol Panel. Her kan du lære hele arbejdsgangen: browseropsætning, Kodeværkstedet, MicroPython, USB-installation, Bluetooth-forbindelse, kontrolpaneler og trådløs kodeudvikling."})]}),u.jsxs("div",{className:"help-lesson-list","aria-label":"Undervisningsforløbet indeholder",children:[u.jsx("span",{children:"Trin-for-trin opsætning"}),u.jsx("span",{children:"Øvelser til kode og kontrolpanel"}),u.jsx("span",{children:"Projektforslag med Pico W"})]}),u.jsx("p",{className:"help-lesson-destination",children:"Du sendes til materialer.teknologiskolen.dk i en ny fane."}),u.jsx("a",{className:"btn btn-primary btn-block",href:"https://materialer.teknologiskolen.dk/lessons/fjernstyring-af-raspberry-pi-pico-w",target:"_blank",rel:"noreferrer",children:"Åbn komplet undervisningsforløb"})]})});if(s==="device-settings"){const me=f.filter(Ae=>Ae.type==="slider"),De=!!(a!=null&&a.isOwnedByMe);async function vn(Ae=!1){if(!a||!De)return;const mn=ae(z,a.gridCols),qn=ae(oe,a.gridRows),Rn=Ev(f,mn,qn);if(Rn&&!Ae){U({title:"Gitter kan påvirke layout",message:`Det nuværende layout bruger op til ${Rn.requiredCols} kolonner og ${Rn.requiredRows} rækker. Det nye gitter er ${mn} × ${qn}, så nogle kontroller kan ende udenfor eller skulle flyttes i redigering.`,confirmLabel:"Gem alligevel",onConfirm:()=>{vn(!0)}});return}A(!0),await N(W,H,H&&ce,H&&Ee,mn,qn),ee(mn),ye(qn),A(!1)}return u.jsx(On,{title:"Enhedsindstillinger",onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Pt,{label:"Navn",value:(a==null?void 0:a.deviceName)??"Ukendt"}),u.jsx(Pt,{label:"Ejer",value:Rv(a)}),De?u.jsxs(u.Fragment,{children:[u.jsx("button",{className:"device-icon-pick settings-icon-pick",type:"button",onClick:()=>Ve(!0),children:u.jsx("img",{src:aa(W),alt:""})}),u.jsx("p",{className:"prompt",children:"Må andre forbinde til- og bruge denne enhed?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:H?"":"active",onClick:()=>ne(!1),children:"Privat"}),u.jsx("button",{type:"button",className:H?"active":"",onClick:()=>ne(!0),children:"Offentlig"})]}),H&&u.jsxs(u.Fragment,{children:[u.jsx("p",{className:"prompt",children:"Må andre redigere layoutet?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:ce?"":"active",onClick:()=>pe(!1),children:"Nej"}),u.jsx("button",{type:"button",className:ce?"active":"",onClick:()=>pe(!0),children:"Ja"})]}),u.jsx("p",{className:"prompt",children:"Må andre redigere koden?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:Ee?"":"active",onClick:()=>k(!1),children:"Nej"}),u.jsx("button",{type:"button",className:Ee?"active":"",onClick:()=>k(!0),children:"Ja"})]})]}),u.jsx("p",{className:"prompt",children:"Kontrolpanelets gitter"}),u.jsxs("div",{className:"row",children:[u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-cols",children:"Kolonner"}),u.jsx("input",{id:"device-cols",type:"number",min:ta,max:la,value:Number.isNaN(z)?"":z,onChange:Ae=>ee(parseInt(Ae.target.value,10)),onBlur:()=>ee(ae(z,(a==null?void 0:a.gridCols)??11))})]}),u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-rows",children:"Rækker"}),u.jsx("input",{id:"device-rows",type:"number",min:ta,max:la,value:Number.isNaN(oe)?"":oe,onChange:Ae=>ye(parseInt(Ae.target.value,10)),onBlur:()=>ye(ae(oe,(a==null?void 0:a.gridRows)??31))})]})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>vn(),disabled:I,children:I?"Gemmer...":"Gem enhedsindstillinger"})]}):u.jsxs(u.Fragment,{children:[u.jsx(Pt,{label:"Ikon ID",value:String((a==null?void 0:a.iconID)??0)}),u.jsx(Pt,{label:"Redigering",value:a!=null&&a.canEdit?"Tilladt":"Ikke tilladt"}),u.jsx(Pt,{label:"Gitter",value:`${(a==null?void 0:a.gridCols)??0} × ${(a==null?void 0:a.gridRows)??0}`})]}),u.jsx(Pt,{label:"Kontroller",value:String(f.length)}),me.length>0&&u.jsxs("div",{className:"settings-section",children:[u.jsx("h4",{children:"Slidere"}),me.map(Ae=>u.jsxs("div",{className:"slider-meta",children:[u.jsx("strong",{children:Ae.name}),u.jsxs("span",{children:[Ae.sliderMin??0," til ",Ae.sliderMax??100]}),u.jsxs("span",{children:["Retur: ",kv(Ae.sliderRecenter??"none")]}),u.jsxs("span",{children:["Seneste værdi: ",h[Ae.name]??"Ikke brugt"]})]},Ae.name))]}),ze&&u.jsx(p_,{selected:W,onSelect:nn,onClose:()=>Ve(!1)})]})})}return u.jsx(On,{title:"Hjælp til enheden",onClose:i,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Knapper sender en kommando med deres navn, når de trykkes."}),u.jsx("p",{children:"Slidere sender værdien fra den firmware-definerede skala. Appen ændrer kun placering og størrelse."}),u.jsx("p",{children:"Hvis redigering er tilladt, kan du åbne redigering fra menuen og gemme layoutet tilbage på Picoen."}),(a==null?void 0:a.canEdit)&&u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>D(!0),children:"Rediger layout"})]})})}function Ev(s,i,c){let a=0,f=0;for(const h of s)bs(h)&&(a=Math.max(a,Math.ceil((h.centerX2+h.spanX)/2)+1),f=Math.max(f,Math.ceil((h.centerY2+h.spanY)/2)+1));return i<a||c<f?{requiredCols:a,requiredRows:f}:null}function kv(s){return s==="bottom"?"bund":s==="middle"?"midte":s==="top"?"top":"ingen"}function Nv({code:s}){const i=L.useMemo(()=>hv(s),[s]),c=i.length;return u.jsxs("svg",{className:"owner-code-qr",viewBox:`0 0 ${c+8} ${c+8}`,role:"img","aria-label":"QR-kode til ejerkode",children:[u.jsx("rect",{width:c+8,height:c+8,fill:"white"}),i.map((a,f)=>a.map((h,b)=>h?u.jsx("rect",{x:b+4,y:f+4,width:"1",height:"1",fill:"currentColor"},`${b}-${f}`):null))]})}function Rv(s){var i;return s?s.isOwnedByMe?"Dig":((i=s.ownerName)==null?void 0:i.trim())||"Anden bruger":"Ukendt"}function Pt({label:s,value:i}){return u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:s}),u.jsx("strong",{children:i})]})}function Tv(){const s=te(a=>a.confirmDialog),i=te(a=>a.closeConfirm);if(!s)return null;function c(){s==null||s.onConfirm(),i()}return u.jsx(On,{title:s.title,onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:s.message}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:i,children:s.cancelLabel??"Annuller"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:c,children:s.confirmLabel??"Fortsæt"})]})]})})}function Mv(){const s=te(a=>a.connectionLost),i=te(a=>a.reconnectLostDevice),c=te(a=>a.dismissConnectionLost);return s?u.jsx(On,{title:"Forbindelse afbrudt",onClose:c,children:u.jsxs("div",{className:"settings-stack",children:[u.jsxs("p",{className:"confirm-message",children:["Forbindelsen til ",s.deviceName," blev afbrudt. Tjek at Picoen har strøm og er tæt nok på."]}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:c,children:"Luk"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>i(),children:"Genforbind"})]})]})}):null}function jv(){const s=te(c=>c.toast),i=te(c=>c.dismissToast);return s?u.jsx("div",{className:"toast",role:"alert",onClick:i,children:s.message},s.id):null}function Dv(){const s=te(p=>p.screen),i=te(p=>p.splashTarget),c=te(p=>p.init),a=te(p=>p.sideMenuOpen),f=te(p=>p.debuggerOpen),[h,b]=L.useState(!1);return L.useEffect(()=>{c()},[c]),L.useEffect(()=>{if(a){b(!0);return}const p=setTimeout(()=>b(!1),140);return()=>clearTimeout(p)},[a]),u.jsxs("div",{className:"app",children:[s==="splash"&&i==="intro"&&u.jsx(Eh,{}),s==="splash"&&i==="dashboard"&&u.jsx(kh,{}),s==="splash"&&u.jsx(Zb,{}),s==="intro"&&u.jsx(Eh,{}),s==="dashboard"&&u.jsx(kh,{}),s==="connection"&&u.jsx(t0,{}),s==="create"&&u.jsx(l0,{}),s==="control"&&u.jsx(Y0,{}),s==="ide"&&u.jsx(Gy,{}),h&&u.jsx(cv,{open:a}),u.jsx(Sv,{}),u.jsx(Mv,{}),u.jsx(Tv,{}),f&&u.jsx(dv,{}),u.jsx(jv,{})]})}function Av(){if(!("serviceWorker"in navigator))return;window.addEventListener("load",()=>{const i=new URL("sw.js",window.location.href);navigator.serviceWorker.register(i,{scope:"./"}).catch(c=>{console.warn("Service worker registration failed:",c)})});let s=!1;navigator.serviceWorker.addEventListener("controllerchange",()=>{s||window.crossOriginIsolated||(s=!0,window.location.reload())})}Av();ob.createRoot(document.getElementById("root")).render(u.jsx(ms.StrictMode,{children:u.jsx(Dv,{})}));
