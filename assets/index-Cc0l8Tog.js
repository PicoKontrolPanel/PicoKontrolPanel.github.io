var N2=Object.defineProperty;var R2=(a,l,o)=>l in a?N2(a,l,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[l]=o;var we=(a,l,o)=>R2(a,typeof l!="symbol"?l+"":l,o);(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))s(d);new MutationObserver(d=>{for(const h of d)if(h.type==="childList")for(const g of h.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&s(g)}).observe(document,{childList:!0,subtree:!0});function o(d){const h={};return d.integrity&&(h.integrity=d.integrity),d.referrerPolicy&&(h.referrerPolicy=d.referrerPolicy),d.crossOrigin==="use-credentials"?h.credentials="include":d.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function s(d){if(d.ep)return;d.ep=!0;const h=o(d);fetch(d.href,h)}})();function Rh(a){return a&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a}var Sd={exports:{}},_s={};/**
 * @license React
 ...
 */var pm;function A2(){if(pm)return _s;pm=1;var a=Symbol.for("react.transitional.element"),l=Symbol.for("react.fragment");function o(s,d,h){var g=null;if(h!==void 0&&(g=""+h),d.key!==void 0&&(g=""+d.key),"key"in d){h={};for(var m in d)m!=="key"&&(h[m]=d[m])}else h=d;return d=h.ref,{$$typeof:a,type:s,key:g,ref:d!==void 0?d:null,props:h}}return _s.Fragment=l,_s.jsx=o,_s.jsxs=o,_s}var gm;function C2(){return gm||(gm=1,Sd.exports=A2()),Sd.exports}var u=C2(),Ed={exports:{}},Oe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _m;function D2(){if(_m)return Oe;_m=1;var a=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),g=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),k=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),E=Symbol.iterator;function C(T){return T===null||typeof T!="object"?null:(T=E&&T[E]||T["@@iterator"],typeof T=="function"?T:null)}var O={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},F=Object.assign,H={};function P(T,G,le){this.props=T,this.context=G,this.refs=H,this.updater=le||O}P.prototype.isReactComponent={},P.prototype.setState=function(T,G){if(typeof T!="object"&&typeof T!="function"&&T!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,T,G,"setState")},P.prototype.forceUpdate=function(T){this.updater.enqueueForceUpdate(this,T,"forceUpdate")};function B(){}B.prototype=P.prototype;function re(T,G,le){this.props=T,this.context=G,this.refs=H,this.updater=le||O}var q=re.prototype=new B;q.constructor=re,F(q,P.prototype),q.isPureReactComponent=!0;var oe=Array.isArray;function ge(){}var te={H:null,A:null,T:null,S:null},pe=Object.prototype.hasOwnProperty;function ve(T,G,le){var ae=le.ref;return{$$typeof:a,type:T,key:G,ref:ae!==void 0?ae:null,props:le}}function Be(T,G){return ve(T.type,G,T.props)}function ne(T){return typeof T=="object"&&T!==null&&T.$$typeof===a}function Ie(T){var G={"=":"=0",":":"=2"};return"$"+T.replace(/[=:]/g,function(le){return G[le]})}var xe=/\/+/g;function $e(T,G){return typeof T=="object"&&T!==null&&T.key!=null?Ie(""+T.key):G.toString(36)}function Z(T){switch(T.status){case"fulfilled":return T.value;case"rejected":throw T.reason;default:switch(typeof T.status=="string"?T.then(ge,ge):(T.status="pending",T.then(function(G){T.status==="pending"&&(T.status="fulfilled",T.value=G)},function(G){T.status==="pending"&&(T.status="rejected",T.reason=G)})),T.status){case"fulfilled":return T.value;case"rejected":throw T.reason}}throw T}function R(T,G,le,ae,ce){var me=typeof T;(me==="undefined"||me==="boolean")&&(T=null);var Te=!1;if(T===null)Te=!0;else switch(me){case"bigint":case"string":case"number":Te=!0;break;case"object":switch(T.$$typeof){case a:case l:Te=!0;break;case k:return Te=T._init,R(Te(T._payload),G,le,ae,ce)}}if(Te)return ce=ce(T),Te=ae===""?"."+$e(T,0):ae,oe(ce)?(le="",Te!=null&&(le=Te.replace(xe,"$&/")+"/"),R(ce,G,le,"",function(he){return he})):ce!=null&&(ne(ce)&&(ce=Be(ce,le+(ce.key==null||T&&T.key===ce.key?"":(""+ce.key).replace(xe,"$&/")+"/")+Te)),G.push(ce)),1;Te=0;var We=ae===""?".":ae+":";if(oe(T))for(var ze=0;ze<T.length;ze++)ae=T[ze],me=We+$e(ae,ze),Te+=R(ae,G,le,me,ce);else if(ze=C(T),typeof ze=="function")for(T=ze.call(T),ze=0;!(ae=T.next()).done;)ae=ae.value,me=We+$e(ae,ze++),Te+=R(ae,G,le,me,ce);else if(me==="object"){if(typeof T.then=="function")return R(Z(T),G,le,ae,ce);throw G=String(T),Error("Objects are not valid as a React child (found: "+(G==="[object Object]"?"object with keys {"+Object.keys(T).join(", ")+"}":G)+"). If you meant to render a collection of children, use an array instead.")}return Te}function W(T,G,le){if(T==null)return T;var ae=[],ce=0;return R(T,ae,"","",function(me){return G.call(le,me,ce++)}),ae}function fe(T){if(T._status===-1){var G=T._result;G=G(),G.then(function(le){(T._status===0||T._status===-1)&&(T._status=1,T._result=le)},function(le){(T._status===0||T._status===-1)&&(T._status=2,T._result=le)}),T._status===-1&&(T._status=0,T._result=G)}if(T._status===1)return T._result.default;throw T._result}var Re=typeof reportError=="function"?reportError:function(T){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var G=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof T=="object"&&T!==null&&typeof T.message=="string"?String(T.message):String(T),error:T});if(!window.dispatchEvent(G))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",T);return}console.error(T)},_e={map:W,forEach:function(T,G,le){W(T,function(){G.apply(this,arguments)},le)},count:function(T){var G=0;return W(T,function(){G++}),G},toArray:function(T){return W(T,function(G){return G})||[]},only:function(T){if(!ne(T))throw Error("React.Children.only expected to receive a single React element child.");return T}};return Oe.Activity=x,Oe.Children=_e,Oe.Component=P,Oe.Fragment=o,Oe.Profiler=d,Oe.PureComponent=re,Oe.StrictMode=s,Oe.Suspense=_,Oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=te,Oe.__COMPILER_RUNTIME={__proto__:null,c:function(T){return te.H.useMemoCache(T)}},Oe.cache=function(T){return function(){return T.apply(null,arguments)}},Oe.cacheSignal=function(){return null},Oe.cloneElement=function(T,G,le){if(T==null)throw Error("The argument must be a React element, but you passed "+T+".");var ae=F({},T.props),ce=T.key;if(G!=null)for(me in G.key!==void 0&&(ce=""+G.key),G)!pe.call(G,me)||me==="key"||me==="__self"||me==="__source"||me==="ref"&&G.ref===void 0||(ae[me]=G[me]);var me=arguments.length-2;if(me===1)ae.children=le;else if(1<me){for(var Te=Array(me),We=0;We<me;We++)Te[We]=arguments[We+2];ae.children=Te}return ve(T.type,ce,ae)},Oe.createContext=function(T){return T={$$typeof:g,_currentValue:T,_currentValue2:T,_threadCount:0,Provider:null,Consumer:null},T.Provider=T,T.Consumer={$$typeof:h,_context:T},T},Oe.createElement=function(T,G,le){var ae,ce={},me=null;if(G!=null)for(ae in G.key!==void 0&&(me=""+G.key),G)pe.call(G,ae)&&ae!=="key"&&ae!=="__self"&&ae!=="__source"&&(ce[ae]=G[ae]);var Te=arguments.length-2;if(Te===1)ce.children=le;else if(1<Te){for(var We=Array(Te),ze=0;ze<Te;ze++)We[ze]=arguments[ze+2];ce.children=We}if(T&&T.defaultProps)for(ae in Te=T.defaultProps,Te)ce[ae]===void 0&&(ce[ae]=Te[ae]);return ve(T,me,ce)},Oe.createRef=function(){return{current:null}},Oe.forwardRef=function(T){return{$$typeof:m,render:T}},Oe.isValidElement=ne,Oe.lazy=function(T){return{$$typeof:k,_payload:{_status:-1,_result:T},_init:fe}},Oe.memo=function(T,G){return{$$typeof:b,type:T,compare:G===void 0?null:G}},Oe.startTransition=function(T){var G=te.T,le={};te.T=le;try{var ae=T(),ce=te.S;ce!==null&&ce(le,ae),typeof ae=="object"&&ae!==null&&typeof ae.then=="function"&&ae.then(ge,Re)}catch(me){Re(me)}finally{G!==null&&le.types!==null&&(G.types=le.types),te.T=G}},Oe.unstable_useCacheRefresh=function(){return te.H.useCacheRefresh()},Oe.use=function(T){return te.H.use(T)},Oe.useActionState=function(T,G,le){return te.H.useActionState(T,G,le)},Oe.useCallback=function(T,G){return te.H.useCallback(T,G)},Oe.useContext=function(T){return te.H.useContext(T)},Oe.useDebugValue=function(){},Oe.useDeferredValue=function(T,G){return te.H.useDeferredValue(T,G)},Oe.useEffect=function(T,G){return te.H.useEffect(T,G)},Oe.useEffectEvent=function(T){return te.H.useEffectEvent(T)},Oe.useId=function(){return te.H.useId()},Oe.useImperativeHandle=function(T,G,le){return te.H.useImperativeHandle(T,G,le)},Oe.useInsertionEffect=function(T,G){return te.H.useInsertionEffect(T,G)},Oe.useLayoutEffect=function(T,G){return te.H.useLayoutEffect(T,G)},Oe.useMemo=function(T,G){return te.H.useMemo(T,G)},Oe.useOptimistic=function(T,G){return te.H.useOptimistic(T,G)},Oe.useReducer=function(T,G,le){return te.H.useReducer(T,G,le)},Oe.useRef=function(T){return te.H.useRef(T)},Oe.useState=function(T){return te.H.useState(T)},Oe.useSyncExternalStore=function(T,G,le){return te.H.useSyncExternalStore(T,G,le)},Oe.useTransition=function(){return te.H.useTransition()},Oe.version="19.2.7",Oe}var vm;function rf(){return vm||(vm=1,Ed.exports=D2()),Ed.exports}var j=rf();const Ts=Rh(j);var Td={exports:{}},vs={},Md={exports:{}},jd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var bm;function O2(){return bm||(bm=1,(function(a){function l(R,W){var fe=R.length;R.push(W);e:for(;0<fe;){var Re=fe-1>>>1,_e=R[Re];if(0<d(_e,W))R[Re]=W,R[fe]=_e,fe=Re;else break e}}function o(R){return R.length===0?null:R[0]}function s(R){if(R.length===0)return null;var W=R[0],fe=R.pop();if(fe!==W){R[0]=fe;e:for(var Re=0,_e=R.length,T=_e>>>1;Re<T;){var G=2*(Re+1)-1,le=R[G],ae=G+1,ce=R[ae];if(0>d(le,fe))ae<_e&&0>d(ce,le)?(R[Re]=ce,R[ae]=fe,Re=ae):(R[Re]=le,R[G]=fe,Re=G);else if(ae<_e&&0>d(ce,fe))R[Re]=ce,R[ae]=fe,Re=ae;else break e}}return W}function d(R,W){var fe=R.sortIndex-W.sortIndex;return fe!==0?fe:R.id-W.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;a.unstable_now=function(){return h.now()}}else{var g=Date,m=g.now();a.unstable_now=function(){return g.now()-m}}var _=[],b=[],k=1,x=null,E=3,C=!1,O=!1,F=!1,H=!1,P=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,re=typeof setImmediate<"u"?setImmediate:null;function q(R){for(var W=o(b);W!==null;){if(W.callback===null)s(b);else if(W.startTime<=R)s(b),W.sortIndex=W.expirationTime,l(_,W);else break;W=o(b)}}function oe(R){if(F=!1,q(R),!O)if(o(_)!==null)O=!0,ge||(ge=!0,Ie());else{var W=o(b);W!==null&&Z(oe,W.startTime-R)}}var ge=!1,te=-1,pe=5,ve=-1;function Be(){return H?!0:!(a.unstable_now()-ve<pe)}function ne(){if(H=!1,ge){var R=a.unstable_now();ve=R;var W=!0;try{e:{O=!1,F&&(F=!1,B(te),te=-1),C=!0;var fe=E;try{t:{for(q(R),x=o(_);x!==null&&!(x.expirationTime>R&&Be());){var Re=x.callback;if(typeof Re=="function"){x.callback=null,E=x.priorityLevel;var _e=Re(x.expirationTime<=R);if(R=a.unstable_now(),typeof _e=="function"){x.callback=_e,q(R),W=!0;break t}x===o(_)&&s(_),q(R)}else s(_);x=o(_)}if(x!==null)W=!0;else{var T=o(b);T!==null&&Z(oe,T.startTime-R),W=!1}}break e}finally{x=null,E=fe,C=!1}W=void 0}}finally{W?Ie():ge=!1}}}var Ie;if(typeof re=="function")Ie=function(){re(ne)};else if(typeof MessageChannel<"u"){var xe=new MessageChannel,$e=xe.port2;xe.port1.onmessage=ne,Ie=function(){$e.postMessage(null)}}else Ie=function(){P(ne,0)};function Z(R,W){te=P(function(){R(a.unstable_now())},W)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(R){R.callback=null},a.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):pe=0<R?Math.floor(1e3/R):5},a.unstable_getCurrentPriorityLevel=function(){return E},a.unstable_next=function(R){switch(E){case 1:case 2:case 3:var W=3;break;default:W=E}var fe=E;E=W;try{return R()}finally{E=fe}},a.unstable_requestPaint=function(){H=!0},a.unstable_runWithPriority=function(R,W){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var fe=E;E=R;try{return W()}finally{E=fe}},a.unstable_scheduleCallback=function(R,W,fe){var Re=a.unstable_now();switch(typeof fe=="object"&&fe!==null?(fe=fe.delay,fe=typeof fe=="number"&&0<fe?Re+fe:Re):fe=Re,R){case 1:var _e=-1;break;case 2:_e=250;break;case 5:_e=1073741823;break;case 4:_e=1e4;break;default:_e=5e3}return _e=fe+_e,R={id:k++,callback:W,priorityLevel:R,startTime:fe,expirationTime:_e,sortIndex:-1},fe>Re?(R.sortIndex=fe,l(b,R),o(_)===null&&R===o(b)&&(F?(B(te),te=-1):F=!0,Z(oe,fe-Re))):(R.sortIndex=_e,l(_,R),O||C||(O=!0,ge||(ge=!0,Ie()))),R},a.unstable_shouldYield=Be,a.unstable_wrapCallback=function(R){var W=E;return function(){var fe=E;E=W;try{return R.apply(this,arguments)}finally{E=fe}}}})(jd)),jd}var ym;function L2(){return ym||(ym=1,Md.exports=O2()),Md.exports}var Nd={exports:{}},an={};/**
 * @license React
...
`),await ks(40),!(await this.collectUntil(async()=>{await this.transport.write($_)},s=>s.includes("raw REPL")||s.includes("raw REPL; CTRL-B to exit"),l)).includes("raw REPL"))throw new Error("Kunne ikke skifte til MicroPython raw REPL.")}async exec(l,o=6e3){await this.enterRawRepl();const s=await this.collectUntil(async()=>{await this.transport.write(l),l.endsWith(`
`)||await this.transport.write(`
`),await this.transport.write(ga)},d=>d.includes(`${ga}${ga}`)||d.includes(`${ga}>`),o);return await this.friendlyRepl().catch(()=>{}),X_(s)}collectUntil(l,o,s){return new Promise((d,h)=>{let g="",m=null;const _=setTimeout(()=>{m==null||m(),h(new Error("Timeout ved USB REPL kommando."))},s);m=this.transport.addDataListener(b=>{g+=b,o(g)&&(clearTimeout(_),m==null||m(),d(g))}),l().catch(b=>{clearTimeout(_),m==null||m(),h(b instanceof Error?b:new Error("USB REPL kommando fejlede."))})})}async waitForFriendlyPrompt(l=1600){await this.collectUntil(async()=>{await this.transport.write(ih)},o=>/(^|\r?\n)>>> ?$/.test(o),l)}}function X_(a){const l=a.indexOf("OK"),o=a.indexOf(ga,l>=0?l:0),s=o>=0?a.indexOf(ga,o+1):-1;if(l<0||o<0)return{output:a.trim(),error:"",raw:a};const d=a.slice(l+2,o).replace(/^\r?\n/,"").trimEnd(),h=s>=0?a.slice(o+1,s).trim():"";return{output:d,error:h,raw:a}}const K_=[{version:"MicroPython v1.28.0",date:"2026-04-06",stamp:"20260406",tag:"v1.28.0"},{version:"MicroPython v1.27.0",date:"2025-12-09",stamp:"20251209",tag:"v1.27.0"},{version:"MicroPython v1.26.1",date:"2025-09-11",stamp:"20250911",tag:"v1.26.1"},{version:"MicroPython v1.26.0",date:"2025-08-09",stamp:"20250809",tag:"v1.26.0"},{version:"MicroPython v1.25.0",date:"2025-04-15",stamp:"20250415",tag:"v1.25.0"},{version:"MicroPython v1.24.1",date:"2024-11-29",stamp:"20241129",tag:"v1.24.1"},{version:"MicroPython v1.24.0",date:"2024-10-25",stamp:"20241025",tag:"v1.24.0"},{version:"MicroPython v1.23.0",date:"2024-06-02",stamp:"20240602",tag:"v1.23.0"},{version:"MicroPython v1.22.2",date:"2024-02-22",stamp:"20240222",tag:"v1.22.2"},{version:"MicroPython v1.22.1",date:"2024-01-05",stamp:"20240105",tag:"v1.22.1"}],Q_=[{board:"Raspberry Pi Pico",firmwareName:"RPI_PICO"},{board:"Raspberry Pi Pico W",firmwareName:"RPI_PICO_W"}],Vl=Q_.flatMap(({board:a,firmwareName:l})=>K_.map(({version:o,date:s,stamp:d,tag:h})=>{const g=`${l}-${d}-${h}.uf2`;return{board:a,version:o,date:s,fileName:g,url:`https://micropython.org/resources/firmware/${g}`}})),Vd=512,Id=`import builtins as _pkp_builtins
`;function il(a){return JSON.stringify(a)}function W_(a){return`bytes.fromhex(${JSON.stringify([...a].map(l=>l.toString(16).padStart(2,"0")).join(""))})`}function Z_(a,l){return`${a==="/"?"":a.replace(/\/$/,"")}/${l}`}class J_{constructor(l){this.repl=l}async list(l="/"){const o=`
import os
base = ${il(l)}
...
`,s=await this.repl.exec(o);if(s.error)throw new Error(s.error);return s.output.split(/\r?\n/).map(d=>d.trim()).filter(Boolean).map(d=>{const[h,g,m]=d.split("	"),_=g==="dir"||g==="file"?g:"unknown",b=parseInt(m??"",10);return{name:h,path:Z_(l,h),type:_,...Number.isFinite(b)&&b>=0?{size:b}:{}}})}async readText(l){const o=`
import sys
...
import os
os.rename(${il(l)}, ${il(o)})
`);if(s.error)throw new Error(s.error)}}function ev(a){const l=new Uint8Array(Math.floor(a.length/2));for(let o=0;o<l.length;o+=1)l[o]=parseInt(a.slice(o*2,o*2+2),16);return l}const tv=`from machine import Pin                    # Giver adgang til pins på Pico W, fx LED'en\r
...
while True:\r
    ...
    # til Bluetooth.\r
    time.sleep_ms(100)\r
`,iv=`from machine import Pin                    # Giver adgang til pins på Pico W, fx LED'en\r
import utime as time                       # Bruges til tid, pauser og timere\r
import network                             # Bruges til at forbinde Pico W til Wi-Fi\r
import gc                                  # Bruges til at rydde op i hukommelsen\r
...
while True:\r
    ...
    # til Bluetooth.\r
    time.sleep_ms(100)\r
`,li=[{id:"program:send-text",path:"/main.py",label:"Send tekst (main.py)",description:"Startprogram med kun et tekstfelt, hvor Picoen sender beskeder til kontrolpanelet.",kind:"program",difficulty:"Nem",content:fv},{id:"program:neopixel-led",path:"/main.py",label:"NeoPixel lys (main.py)",description:"Startprogram til NeoPixel med hold-knap og lysstyrke-slider.",kind:"program",difficulty:"Nem",content:ov},{id:"program:tank-control",path:"/main.py",label:"Robotbil med tankstyring (main.py)",description:"Startprogram til robotbil med to motor-slidere.",kind:"program",difficulty:"Mellem",content:hv},{id:"program:dpad-control",path:"/main.py",label:"Robotbil med D-pad (main.py)",description:"Startprogram til robotbil styret med fire retningsknapper og fart-slider.",kind:"program",difficulty:"Mellem",content:av},{id:"program:joystick-control",path:"/main.py",label:"Robotbil med joystick (main.py)",description:"Startprogram til robotbil styret med joystick og fart-slider.",kind:"program",difficulty:"Mellem",content:sv},{id:"program:radar-control",path:"/main.py",label:"Radar med afstandssensor (main.py)",description:"Startprogram til radar med servo, afstandssensor og scan-toggle.",kind:"program",difficulty:"Svær",content:dv},{id:"program:api-weather",path:"/main.py",label:"Vejr fra internettet (main.py)",description:"Startprogram der henter vejr fra et API over Wi-Fi og viser det i tekstfelter. Husk at skrive dit Wi-Fi navn og kodeord ind i main.py.",kind:"program",difficulty:"Svær",content:tv},{id:"program:graphs",path:"/main.py",label:"Vejrgrafer fra internettet (main.py)",description:"Startprogram der henter vejr fra et API og tegner temperatur og nedbør som grafer over tid. Husk at skrive dit Wi-Fi navn og kodeord ind i main.py.",kind:"program",difficulty:"Svær",content:iv},{id:"program:smart-home",path:"/main.py",label:"SmartHome alarmstation (main.py)",description:"Startprogram til alarmstation med dør-servo, keypad, PIR, vandsensor, buzzer og NeoPixel.",kind:"program",difficulty:"Svær",content:mv},{id:"library:pico-bluetooth",path:"/PicoBluetooth.py",label:"PicoBluetooth.py",description:"Bluetooth-biblioteket der får Picoen til at tale med appen.",kind:"library",content:nv},{id:"library:pico-robotics",path:"/PicoRobotics.py",label:"PicoRobotics.py",description:"Bibliotek til Kitronik Pico Robotics Board.",kind:"library",content:uv},{id:"library:pico-fly",path:"/PicoFly.py",label:"PicoFly.py",description:"Bibliotek til PicoFly-board med motorer og servoer.",kind:"library",content:cv},{id:"library:hcsr04",path:"/hcsr04.py",label:"hcsr04.py",description:"Bibliotek til HC-SR04 ultralyds-afstandssensor.",kind:"library",content:rv},{id:"library:neopixel",path:"/neopixel.py",label:"neopixel.py",description:"Bibliotek til NeoPixel LED-strips og LED-ringe.",kind:"library",content:lv}],pv=11914;function gv(){return typeof navigator<"u"&&"serial"in navigator&&!!navigator.serial}function _v(){return gv()?{supported:!0,message:"USB-udvikling er tilgængelig i denne browser."}:{supported:!1,message:"USB-udvikling kræver en computer med Chrome, Edge eller Chromebook."}}class vv{constructor(l={}){we(this,"port",null);we(this,"reader",null);we(this,"writer",null);we(this,"readLoopDone",null);we(this,"readLoopActive",!1);we(this,"disconnecting",!1);we(this,"buffer","");we(this,"events");we(this,"dataListeners",new Set);this.events=l}get connected(){return!!this.port&&!!this.writer}get info(){var l;return((l=this.port)==null?void 0:l.getInfo())??null}async requestAndConnect(){if(!navigator.serial)throw new Error("Web Serial er ikke tilgængelig i denne browser.");const l=await navigator.serial.requestPort({filters:[{usbVendorId:pv}]});await this.openPort(l)}async connectKnownPort(l){await this.openPort(l)}async disconnect(){var _,b;const l=this.connected||!!this.port||!!this.reader,o=this.port,s=this.reader,d=this.writer,h=this.readLoopDone,g=s==null?void 0:s.closed.catch(()=>{}),m=d==null?void 0:d.closed.catch(()=>{});this.disconnecting=!0,this.readLoopActive=!1;try{await(s==null?void 0:s.cancel())}catch{}h&&await h.catch(()=>{}),await g;try{s==null||s.releaseLock()}catch{}this.reader===s&&(this.reader=null);try{await(d==null?void 0:d.close()),await m}catch{try{await(d==null?void 0:d.abort("disconnect"))}catch{}}try{d==null||d.releaseLock()}catch{}this.writer===d&&(this.writer=null),o&&await o.close(),this.port===o&&(this.port=null),this.buffer="",this.readLoopDone===h&&(this.readLoopDone=null),this.disconnecting=!1,l&&((b=(_=this.events).onDisconnect)==null||b.call(_))}async write(l){if(!this.writer)throw new Error("Ingen USB-forbindelse.");await this.writer.write(new TextEncoder().encode(l))}async writeLine(l){await this.write(`${l}\r
`)}addDataListener(l){return this.dataListeners.add(l),()=>this.dataListeners.delete(l)}async openPort(l){var s,d,h;if(await this.disconnect().catch(()=>{}),await l.open({baudRate:115200,bufferSize:4096}),this.port=l,this.writer=((s=l.writable)==null?void 0:s.getWriter())??null,!this.writer||!l.readable)throw new Error("USB-porten kunne ikke åbnes til læsning og skrivning.");const o=l.getInfo();(h=(d=this.events).onLog)==null||h.call(d,"success",`USB-forbindelse oprettet (${bv(o)}).`),this.readLoopDone=this.startReadLoop(l)}async startReadLoop(l){var d,h,g;this.readLoopActive=!0;const o=new TextDecoder;this.reader=((d=l.readable)==null?void 0:d.getReader())??null;const s=this.reader;if(s)try{for(;this.readLoopActive;){const{value:m,done:_}=await s.read();if(_)break;m&&this.consumeText(o.decode(m,{stream:!0}))}}catch(m){this.readLoopActive&&((g=(h=this.events).onLog)==null||g.call(h,"error",m instanceof Error?m.message:"USB-læsning stoppede."))}finally{try{s.releaseLock()}catch{}this.reader===s&&(this.reader=null),this.readLoopActive&&!this.disconnecting&&this.port===l&&this.closeAfterUnexpectedReadEnd(l)}}async closeAfterUnexpectedReadEnd(l){var h,g;const o=this.connected||this.port===l;this.disconnecting=!0,this.readLoopActive=!1;const s=this.writer,d=s==null?void 0:s.closed.catch(()=>{});try{await(s==null?void 0:s.close()),await d}catch{try{await(s==null?void 0:s.abort("disconnect"))}catch{}}try{s==null||s.releaseLock()}catch{}this.writer===s&&(this.writer=null);try{await l.close()}catch{}this.port===l&&(this.port=null),this.buffer="",this.readLoopDone=null,this.disconnecting=!1,o&&((g=(h=this.events).onDisconnect)==null||g.call(h))}consumeText(l){var o,s,d,h;(s=(o=this.events).onData)==null||s.call(o,l);for(const g of this.dataListeners)g(l);for(this.buffer+=l;this.buffer.includes(`
`);){const g=this.buffer.indexOf(`
`),m=this.buffer.slice(0,g).replace(/\r$/,"");this.buffer=this.buffer.slice(g+1),(h=(d=this.events).onLine)==null||h.call(d,m)}}}function bv(a){const l=a.usbVendorId!==void 0?`VID ${a.usbVendorId.toString(16).padStart(4,"0")}`:"ukendt VID",o=a.usbProductId!==void 0?`PID ${a.usbProductId.toString(16).padStart(4,"0")}`:"ukendt PID";return`${l}, ${o}`}const tp=15e3,oh=64*1024,ch=1e5,np=new URL("/micropython/micropython.mjs",window.location.origin).toString(),yv=64*1024,uh=8;function rp(){return typeof SharedArrayBuffer<"u"&&globalThis.crossOriginIsolated===!0}function wv(){return rp()?new SharedArrayBuffer(yv):null}function xv(a,l){const o=new Int32Array(a,0,2),s=new Uint8Array(a),d=a.byteLength-uh,h=new TextEncoder().encode(l+`
`);let g=Atomics.load(o,0);for(const m of h)s[uh+g%d]=m,g+=1;Atomics.store(o,0,g),Atomics.notify(o,0)}const kv=new Set(["bluetooth","machine","network","PicoRobotics","rp2","ubluetooth"]);class Sv{constructor(){we(this,"worker",null);we(this,"pending",null);we(this,"nextId",0)}send(l,o={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython-terminalen er optaget. Stop den, eller vent på at kommandoen bliver færdig.",timedOut:!1,unavailable:!1});const s=++this.nextId,d=o.timeoutMs??tp,h=this.ensureWorker();return new Promise(g=>{const m=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython-terminalen stoppede, fordi kommandoen tog for lang tid. Tjek for uendelige løkker.",timedOut:!0,unavailable:!1}),this.restartWorker()},d);this.pending={id:s,timer:m,onOutput:o.onOutput,resolve:g},h.postMessage({type:"run",id:s,code:Tv(l),runtimeUrl:np})})}reset(){this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),this.restartWorker()}dispose(){var l;this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),(l=this.worker)==null||l.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const l=new Worker(new URL(""+new URL("offlineMicroPython.worker-B_-Tbi7X.js",import.meta.url).href,import.meta.url),{type:"module"});return l.onmessage=o=>this.handleMessage(o.data),l.onerror=o=>{this.finish({ok:!1,output:"",error:o.message||"Browser-MicroPython-terminalen fejlede i browser-worker.",timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=l,l}handleMessage(l){var s;const o=this.pending;if(!(!o||l.id!==o.id||l.type==="ready")){if(l.type==="stdout"){(s=o.onOutput)==null||s.call(o,l.text);return}if(l.type!=="stdin-wait"){if(l.type==="unavailable"){this.finish({ok:!1,output:"",error:l.error,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:l.ok,output:l.output,error:l.error,timedOut:!1,unavailable:!1})}}}finish(l){const o=this.pending;o&&(window.clearTimeout(o.timer),this.pending=null,o.resolve(l))}restartWorker(){var l;(l=this.worker)==null||l.terminate(),this.worker=null}}class Ev{constructor(){we(this,"worker",null);we(this,"pending",null);we(this,"nextId",0);we(this,"stdinSab",null)}run(l,o={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython kører allerede kode. Stop den først.",issues:[],timedOut:!1,unavailable:!1});const s=typeof o=="number"?o:o.timeoutMs===null?null:o.timeoutMs??tp,d=typeof o=="number"?void 0:o.onOutput,h=typeof o=="number"?void 0:o.onWaitingForInput,g=typeof o=="number"?void 0:o.signal,m=Wd(l,{allowInput:!0});if(m.some(x=>x.level==="error"))return Promise.resolve({ok:!1,output:"",error:"",issues:m,timedOut:!1,unavailable:!1});const _=++this.nextId,b=this.ensureWorker(),k=wv();return this.stdinSab=k,new Promise(x=>{const E=H=>this.finish(H),C=()=>{this.restartWorker(),E({ok:!1,output:"",error:"",issues:m,timedOut:!1,unavailable:!1})},O=s===null?null:window.setTimeout(()=>{E({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:m,timedOut:!0,unavailable:!1}),this.restartWorker()},s);if(this.pending={id:_,timer:O,timeoutMs:s,issues:m,onOutput:d,onWaitingForInput:h,signal:g,abort:C,resolve:x},g!=null&&g.aborted){C();return}g==null||g.addEventListener("abort",C,{once:!0});const F={type:"run",id:_,code:l,runtimeUrl:np,interactive:!0,sab:k??void 0};b.postMessage(F)})}sendInput(l){const o=this.pending;!o||!this.stdinSab||(this.refreshTimeout(o),xv(this.stdinSab,l))}stop(){const l=this.pending;l&&(this.restartWorker(),this.finish({ok:!1,output:"",error:"Browser-MicroPython blev stoppet.",issues:l.issues,timedOut:!1,unavailable:!1}))}dispose(){var l;this.finish({ok:!1,output:"",error:"",issues:[],timedOut:!1,unavailable:!1}),(l=this.worker)==null||l.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const l=new Worker(new URL(""+new URL("offlineMicroPython.worker-B_-Tbi7X.js",import.meta.url).href,import.meta.url),{type:"module"});return l.onmessage=o=>this.handleMessage(o.data),l.onerror=o=>{const s=this.pending;this.finish({ok:!1,output:"",error:o.message||"Offline MicroPython fejlede i browser-worker.",issues:(s==null?void 0:s.issues)??[],timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=l,l}handleMessage(l){var s,d;const o=this.pending;if(!(!o||l.id!==o.id||l.type==="ready")){if(l.type==="stdout"){this.refreshTimeout(o),(s=o.onOutput)==null||s.call(o,l.text);return}if(l.type==="stdin-wait"){l.waiting&&this.refreshTimeout(o),(d=o.onWaitingForInput)==null||d.call(o,l.waiting);return}if(l.type==="unavailable"){this.finish({ok:!1,output:"",error:l.error,issues:o.issues,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:l.ok,output:l.output,error:l.error,issues:o.issues,timedOut:!1,unavailable:!1}),this.restartWorker()}}finish(l){var s,d;const o=this.pending;o&&(o.timer!==null&&window.clearTimeout(o.timer),(s=o.signal)==null||s.removeEventListener("abort",o.abort),this.pending=null,(d=o.onWaitingForInput)==null||d.call(o,!1),o.resolve(l))}refreshTimeout(l){l.timeoutMs!==null&&(l.timer!==null&&window.clearTimeout(l.timer),l.timer=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:l.issues,timedOut:!0,unavailable:!1}),this.restartWorker()},l.timeoutMs))}restartWorker(){var l;(l=this.worker)==null||l.terminate(),this.worker=null,this.stdinSab=null}}function Tv(a){const l=JSON.stringify(a);return["try:",`    __pico_repl_value = eval(${l})`,"    if __pico_repl_value is not None:","        print(repr(__pico_repl_value))","except SyntaxError:",`    exec(${l})`,"finally:","    try:","        del __pico_repl_value","    except Exception:","        pass"].join(`
`)}function Wd(a,l={}){const o=[],s=new Blob([a]).size;s>oh&&o.push({level:"error",text:`Koden er ${s} bytes. Offline MicroPython kører kun små programmer op til ${oh} bytes.`});const d=a.split(/\r?\n/);for(let h=0;h<d.length;h+=1){const g=h+1,m=yc(d[h]).trim();if(!m)continue;const _=jv(m);_&&kv.has(_)&&o.push({level:"error",line:g,text:`${_} virker kun på Picoen. Forbind en Pico for at køre denne kode.`}),!l.allowInput&&Mv(d[h])&&o.push({level:"error",line:g,text:"input() virker i hele programmer. Skriv programmet i editoren og tryk Kør, eller kør filen på Pico via USB."});const b=m.match(/\brange\(\s*(-?\d+)\s*(?:,\s*(-?\d+)\s*)?(?:,\s*(-?\d+)\s*)?\)/);b&&Nv(b)>ch&&o.push({level:"error",line:g,text:`range(...) er for stor til offline kørsel. Brug højst ${ch} gentagelser.`})}for(const h of Rv(d))o.push({level:"warning",text:`Funktionen ${h} ser rekursiv ud. Hvis den ikke stopper, afbryder offline MicroPython efter få sekunder.`});return o}function yc(a){let l=null;for(let o=0;o<a.length;o+=1){const s=a[o];if((s==='"'||s==="'")&&a[o-1]!=="\\"&&(l=l===s?null:l??s),s==="#"&&!l)return a.slice(0,o)}return a}function Mv(a){const l=yc(a);let o=null;for(let s=0;s<l.length;s+=1){const d=l[s];if((d==='"'||d==="'")&&l[s-1]!=="\\"){o=o===d?null:o??d;continue}if(!o&&!(!dh(l[s-1])||l.slice(s,s+5)!=="input")&&dh(l[s+5])&&l.slice(s+5).trimStart().startsWith("("))return!0}return!1}function dh(a){return!a||!/[A-Za-z0-9_]/.test(a)}function jv(a){const l=a.match(/^import\s+([A-Za-z_]\w*)/);if(l)return l[1];const o=a.match(/^from\s+([A-Za-z_]\w*)\s+import\b/);return(o==null?void 0:o[1])??null}function fh(a){const l=a.match(/^\s*/);return(l==null?void 0:l[0].replace(/\t/g,"    ").length)??0}function Nv(a){const l=Number(a[1]),o=a[2]===void 0?void 0:Number(a[2]),s=a[3]===void 0?1:Number(a[3]);if(s===0)return Number.POSITIVE_INFINITY;const g=(o===void 0?l:o)-(o===void 0?0:l);return g>0&&s<0||g<0&&s>0?0:Math.ceil(Math.abs(g/s))}function Rv(a){const l=new Set;for(let o=0;o<a.length;o+=1){const s=yc(a[o]).trim().match(/^def\s+([A-Za-z_]\w*)\s*\(/);if(!s)continue;const d=s[1],h=fh(a[o]);for(let g=o+1;g<a.length;g+=1){if(!a[g].trim())continue;if(fh(a[g])<=h)break;if(new RegExp(`\\b${d}\\s*\\(`).test(yc(a[g]))){l.add(d);break}}}return[...l]}const Av=/^(for|if|while|def|class|elif|else|try|except|finally|with)\b/;function Cv(a,l){var k;const o=a.trim(),s=l.split(/\r?\n/),d=Dv(o),h=d?s[d-1]??"":"",g=Ov(s,d),m=o.split(/\r?\n/).filter(Boolean).at(-1)??"";if(/KeyboardInterrupt/.test(m))return{simple:"Programmet blev stoppet.",technical:o,line:d};if(/MemoryError/.test(m))return{simple:`Picoen eller browserens MicroPython løb tør for hukommelse${d?` omkring linje ${d}`:""}.`,technical:o,line:d};if(/RecursionError/.test(m))return{simple:`En funktion kalder sig selv for mange gange${d?` omkring linje ${d}`:""}.`,technical:o,line:d};const _=m.match(/UnboundLocalError:\s+local variable ['"](.+?)['"]/);if(_)return{simple:`Variablen ${_[1]} bruges inde i en funktion, før den har fået en værdi${d?` på linje ${d}`:""}.`,technical:o,line:d};const b=m.match(/NameError:\s+name ['"](.+?)['"] (?:isn't|is not) defined/);if(b)return{simple:Uv(h,b[1])?`Teksten ${b[1]} mangler måske citationstegn${d?` på linje ${d}`:""}.`:`Python kender ikke navnet ${b[1]}${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/ZeroDivisionError/.test(m))return{simple:`Kan ikke dividere med 0${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/IndentationError:\s+unexpected indent/.test(m))return{simple:`Der er for meget indrykning${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/IndentationError/.test(m))return{simple:`Mangler indrykning${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/ImportError|ModuleNotFoundError/.test(m)){const x=(k=m.match(/['"](.+?)['"]/))==null?void 0:k[1];return{simple:`Python kan ikke finde modulet${x?` ${x}`:""}.`,technical:o,line:d}}if(/OSError/.test(m))return/ENOENT|No such file|Errno\s+2/.test(m)?{simple:`Python kan ikke finde filen${d?` på linje ${d}`:""}.`,technical:o,line:d}:/EACCES|permission|denied/i.test(m)?{simple:`Python har ikke adgang til filen eller enheden${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Der opstod en fejl med en fil eller en enhed${d?` omkring linje ${d}`:""}.`,technical:o,line:d};if(/SyntaxError/.test(m)){if(/invalid syntax/.test(m)&&g.text.trim().endsWith(","))return{simple:`Linje ${g.line??d} slutter med komma. Tjek om der mangler noget efter kommaet.`,technical:o,line:g.line??d};const x=Zd(h,d)??Zd(g.text,g.line)??Lv(s,d);return x?{simple:`Mangler måske : efter linje ${x.line}.`,technical:o,line:x.line}:d&&g.text.trim().endsWith(":")&&h.trim()&&!/^\s+/.test(h)?{simple:`Mangler måske indrykning på linje ${d}.`,technical:o,line:d}:zv(h)?{simple:`Tekst mangler måske citationstegn${d?` på linje ${d}`:""}.`,technical:o,line:d}:Bv(h)?{simple:`Tekst mangler måske et afsluttende citationstegn${d?` på linje ${d}`:""}.`,technical:o,line:d}:qv(h)?{simple:`Mangler måske en afsluttende parentes${d?` på linje ${d}`:""}.`,technical:o,line:d}:Hv(h)?{simple:`Der er måske en parentes for meget${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Python fandt en syntaksfejl${d?` omkring linje ${d}`:""}.`,technical:o,line:d}}return/TypeError/.test(m)?/takes .* positional arguments? but .* given/.test(m)||/function takes/.test(m)?{simple:`En funktion får for mange eller for få værdier${d?` på linje ${d}`:""}.`,technical:o,line:d}:/unsupported operand type/.test(m)?{simple:`To værdier kan ikke bruges sammen på den måde${d?` på linje ${d}`:""}.`,technical:o,line:d}:/not callable/.test(m)?{simple:`Der bliver brugt parenteser efter noget, som ikke er en funktion${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`En værdi har den forkerte type${d?` på linje ${d}`:""}.`,technical:o,line:d}:/IndexError/.test(m)?{simple:`Listen har ikke et element på den plads${d?` på linje ${d}`:""}.`,technical:o,line:d}:/KeyError/.test(m)?{simple:`Ordbogen mangler den nøgle${d?` på linje ${d}`:""}.`,technical:o,line:d}:/AttributeError/.test(m)?{simple:`Den ting har ikke den kommando${d?` på linje ${d}`:""}.`,technical:o,line:d}:/ValueError/.test(m)?/invalid literal for int/.test(m)?{simple:`Teksten kan ikke laves om til et heltal${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Værdien passer ikke her${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Python fandt en fejl${d?` omkring linje ${d}`:""}.`,technical:o,line:d}}function Dv(a){var d;const o=(d=[...a.matchAll(/line\s+(\d+)/g)].at(-1))==null?void 0:d[1];if(!o)return;const s=parseInt(o,10);return Number.isFinite(s)&&s>0?s:void 0}function Ov(a,l){if(!l)return{text:""};for(let o=l-2;o>=0;o-=1){const s=a[o]??"";if(s.trim())return{line:o+1,text:s}}return{text:""}}function Zd(a,l){if(!l)return null;const o=a.trim();return!Av.test(o)||o.endsWith(":")?null:{line:l}}function Lv(a,l){const o=l?Math.min(a.length,l):a.length,s=Math.max(0,o-4);for(let d=o-1;d>=s;d-=1){const h=Zd(a[d]??"",d+1);if(h)return h}return null}function Bv(a){const l=(a.match(/'/g)??[]).length,o=(a.match(/"/g)??[]).length;return l%2===1||o%2===1}function zv(a){var s,d;const o=(d=(s=a.trim().match(/^print\((.+)\)$/))==null?void 0:s[1])==null?void 0:d.trim();return!o||/['"]/.test(o)?!1:/\s/.test(o)&&/[a-zA-ZæøåÆØÅ]/.test(o)}function Uv(a,l){const o=a.trim();return!!l&&/[A-Za-zæøåÆØÅ]/.test(l)&&(o.startsWith("print(")||o.includes(`= ${l}`))}function qv(a){return lp(a)>0}function Hv(a){return lp(a)<0}function lp(a){let l=0,o=null;for(let s=0;s<a.length;s+=1){const d=a[s];if((d==='"'||d==="'")&&a[s-1]!=="\\"){o=o===d?null:o??d;continue}o||((d==="("||d==="["||d==="{")&&(l+=1),(d===")"||d==="]"||d==="}")&&(l-=1))}return l}const Jd="/min_kode.py",ap=`print('Hej fra Pico Kontrol Panel')
`,Vv=500,Iv=1200,Ss="Backup-filnavne er reserveret til versionshistorik. Vælg et andet navn.";function Zt(a,l){return`${a}:${l}`}function mh(a){return new Promise(l=>window.setTimeout(l,a))}function Pv(){const a=se(f=>f.toggleSideMenu),l=se(f=>f.askConfirm),o=se(f=>f.picoIdeOrigin),s=se(f=>f.active),d=se(f=>f.isBleConnected),h=se(f=>f.bleListFiles),g=se(f=>f.bleReadText),m=se(f=>f.bleWriteText),_=se(f=>f.bleDeleteFile),b=se(f=>f.bleRestartAndReconnect),k=se(f=>f.progress),[x,E]=j.useState(!1),[C,O]=j.useState(!1),[F,H]=j.useState([]),[P,B]=j.useState(!1),[re,q]=j.useState(!1),[oe,ge]=j.useState([]),[te,pe]=j.useState(null),[ve,Be]=j.useState(()=>cc(ic())),[ne,Ie]=j.useState(Jd),[xe,$e]=j.useState("local"),[Z,R]=j.useState(()=>{var f;return((f=cc(ic()).find(v=>v.path===Jd))==null?void 0:f.content)??ap}),[W,fe]=j.useState([]),[Re,_e]=j.useState(!1),[T,G]=j.useState(""),[le,ae]=j.useState(""),[ce,me]=j.useState(null),[Te,We]=j.useState(!1),[ze,he]=j.useState(null),[je,at]=j.useState(!1),[V,J]=j.useState({}),[ie,Ce]=j.useState(!1),[Pe,Ve]=j.useState(0),[Me,De]=j.useState(()=>{var f,v;return((f=Vl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:f.board)??((v=Vl[0])==null?void 0:v.board)??""}),[wt,on]=j.useState(()=>{var f,v;return((f=Vl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:f.version)??((v=Vl[0])==null?void 0:v.version)??""}),[Pn,ht]=j.useState(null),[_r,sl]=j.useState({top:0,left:0}),[fn,mn]=j.useState(!1),[hn,jn]=j.useState(!1),[di,sr]=j.useState(!1),[Fn,it]=j.useState(!0),[vt,Qe]=j.useState(""),[vr,ba]=j.useState([]),[Nn,pn]=j.useState(null),[br,Rn]=j.useState(!1),[Jt,Ft]=j.useState({}),[en,tn]=j.useState({}),[Ze,ee]=j.useState(null),[be,Je]=j.useState(null),[cn,gn]=j.useState(""),[Gt,Gn]=j.useState(()=>Mm().clearTerminalOnRun),[nn,yr]=j.useState(()=>Mm().simplifiedErrors),[ol,wr]=j.useState(()=>typeof navigator<"u"?bh(navigator):!1),kt=j.useRef(null),xt=j.useRef(null),ft=j.useRef(null),ya=j.useRef(null),xr=j.useRef(null),fi=j.useRef(null),wa=j.useRef(null),kr=j.useRef(null),cl=j.useRef(null),An=j.useRef(null),or=j.useRef(null),rn=j.useRef(!1),_n=j.useRef(!1),bt=j.useRef(!1),$n=j.useRef(""),Dr=j.useRef(null),Cn=j.useRef(null),vn=j.useRef(null),mi=j.useRef(null),cr=j.useRef(null),ul=j.useRef(null),Or=j.useRef(0),ur=j.useRef(null),dr=j.useRef(null),Yn=j.useRef(null),Ht=j.useRef(null),$l=j.useRef([]),xa=j.useRef([]),Sr=j.useRef(null),Lr=_v(),Se=o==="control"&&!!s&&d(),hi=Se?(s==null?void 0:s.deviceID)??"ble":null,bn=Math.max(1,Z.split(`
`).length),pi=new Blob([Z]).size,Bs=xe==="pico"?"Picoen":"browseren",gi=j.useMemo(()=>[...new Set(Vl.map(f=>f.board))],[]),Xn=j.useMemo(()=>Vl.filter(f=>f.board===Me),[Me]),Br=Vl.find(f=>f.board===Me&&f.version===wt)??Xn[0]??Vl[0],ka=P||!!te||fn||hn,$t=xe==="pico",_i=$t?fn:hn,yn=$t&&fn&&x&&!Se||!$t&&hn&&!!vn.current&&di,zs=br||_i&&!yn,vi=yn?"stdin":">>>",Us=yn?$t?"Input til kørende Pico-kode":"Input til kørende Browser-MicroPython":$t?"Pico MicroPython":"Browser-MicroPython",bi=j.useMemo(()=>{const f=new vv({onData:v=>{_n.current||!rn.current||($n.current=($n.current+v).slice(-240),/(^|\r?\n)>>> ?$/.test($n.current)&&zr())},onLine:v=>{if(_n.current)return;const w=v.trimEnd();if(bt.current&&w.trim()){$("info",w);return}if(rn.current&&yi(w)){zr();return}rn.current&&w.trim()&&!wi(w)&&!w.includes("raw REPL")&&$("info",w)},onLog:$,onDisconnect:()=>{E(!1),mn(!1),Rn(!1),rn.current=!1,bt.current=!1,Kn(),$n.current="",qr(),$("warning","USB-forbindelse lukket.")}});return kt.current=f,f},[]);function $(f,v){H(w=>[...w.slice(-140),{level:f,text:v}])}function fr(f){H(v=>[...v.slice(-140),{level:"info",text:f,variant:"input"}])}function yi(f){return f.trim()===">>>"}function wi(f){return f.trimStart().startsWith(">>> import builtins as _pkp_builtins; exec(")}function Kn(){Dr.current!==null&&(window.clearTimeout(Dr.current),Dr.current=null)}function zr(){!rn.current||Dr.current!==null||(Dr.current=window.setTimeout(()=>{Dr.current=null,rn.current&&(mn(!1),rn.current=!1,$n.current="",$("success","Pico-koden er færdig."),xi())},0))}function xi(){const f=ft.current;f&&Ti(f,!1)}function dl(f,v=Z,w="error"){const N=Cv(f,v);H(D=>[...D.slice(-140),{level:w,text:N.simple,technical:N.technical}])}function St(f,v,w=xe){Ie(f),$e(w),R(v),tn(N=>({...N,[Zt(w,f)]:v})),wn()}function fl(f,v="pico"){Ie(f),$e(v),R(""),ee(null),sl({top:0,left:0}),wn()}function wn(){$l.current=[],xa.current=[],Sr.current=null}function Ur(){const f=xr.current;return{content:Z,selectionStart:(f==null?void 0:f.selectionStart)??Z.length,selectionEnd:(f==null?void 0:f.selectionEnd)??(f==null?void 0:f.selectionStart)??Z.length}}function Yl(f){const v=$l.current,w=v.at(-1);(w==null?void 0:w.content)===f.content&&w.selectionStart===f.selectionStart&&w.selectionEnd===f.selectionEnd||(v.push(f),v.length>Vv&&v.shift(),xa.current=[])}function Er(f,v){let w=0;const N=Math.min(f.length,v.length);for(;w<N&&f[w]===v[w];)w+=1;let D=f.length,X=v.length;for(;D>w&&X>w&&f[D-1]===v[X-1];)D-=1,X-=1;const de=f.slice(w,D),et=v.slice(w,X),Ae=et&&!de?"insert":de&&!et?"delete":"replace",tt=et.at(-1)??"";return{kind:Ae,boundaryAfter:Ae==="insert"&&/[\s.,:;()[\]{}'"`+\-*/%=<>!?]/.test(tt)}}function ki(f,v){if(v!=="typing")return Sr.current=null,!0;const w=Date.now(),N=Er(Z,f),D=Sr.current,X=D!==null&&D.path===ne&&D.source===xe&&D.kind===N.kind&&D.kind!=="replace"&&!D.boundaryAfter&&w-D.at<=Iv;return Sr.current={path:ne,source:xe,kind:N.kind,at:w,boundaryAfter:N.boundaryAfter},!X}function Xl(f){R(f.content),tn(v=>({...v,[Zt(xe,ne)]:f.content})),gn(""),ee(null),window.requestAnimationFrame(()=>{const v=xr.current;v&&(v.focus(),v.selectionStart=Math.min(f.selectionStart,f.content.length),v.selectionEnd=Math.min(f.selectionEnd,f.content.length))})}function qs(){const f=$l.current.pop();return f?(Sr.current=null,xa.current.push(Ur()),Xl(f),!0):!1}function Kl(){const f=xa.current.pop();return f?(Sr.current=null,$l.current.push(Ur()),Xl(f),!0):!1}function Dn(f,v=(X=>(X=xr.current)==null?void 0:X.selectionStart)()??f.length,w=Ur(),N=v,D="programmatic"){w&&f!==Z&&ki(f,D)&&Yl(w),R(f),tn(de=>({...de,[Zt(xe,ne)]:f})),gn(""),Ra(f,v),window.requestAnimationFrame(()=>{const de=xr.current;de&&(de.selectionStart=Math.min(v,f.length),de.selectionEnd=Math.min(N,f.length))})}function ml(f,v=xe){tn(w=>{const N=Zt(v,f);if(!(N in w))return w;const D={...w};return delete D[N],D})}function ln(){return Jt[ne]===Z}function Et(f,v){Ft(w=>({...w,[f]:v}))}function Ql(f,v){Et(f,v),tn(w=>({...w,[Zt("pico",f)]:v})),xe==="pico"&&ne===f&&R(v)}function qr(){ge([]),fe([]),Ft({}),tn({}),ee(null),Ie(f=>{const v=cc(ic());if(v.find(D=>D.path===f))return f;const N=v[0];return $e("local"),R(N.content),wn(),N.path})}function Vt(f){Hr(),he({value:100,label:f}),Ht.current=window.setTimeout(()=>{Ht.current=null,he(null)},900)}function Hr(){Ht.current!==null&&(window.clearTimeout(Ht.current),Ht.current=null)}function Si(){return ze?u.jsxs("div",{className:"ide-task-progress",role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":Math.round(ze.value),children:[u.jsxs("div",{children:[u.jsx("span",{children:ze.label}),u.jsxs("strong",{children:[Math.round(ze.value),"%"]}),ze.cancellable&&u.jsx("button",{className:"ide-task-cancel",type:"button",onClick:Wl,"aria-label":"Stop handling",title:"Stop",children:u.jsx(Pt,{name:"delete",size:18})})]}),u.jsx("b",{"aria-hidden":"true",children:u.jsx("i",{style:{width:`${Math.max(2,Math.min(100,ze.value))}%`}})})]}):null}function Wl(){cr.current&&Tr("Stopper læsning...",!0,!0)}function Tr(f="Stopper læsning...",v=!1,w=!1){var N;Hr(),dr.current=null,Or.current+=1,(N=cr.current)==null||N.abort(),cr.current=null,ur.current=null,pe(null),B(!1),he(v?{value:(ze==null?void 0:ze.value)??0,label:f,cancellable:!1}:null),w&&$("warning","Stopper BLE-læsning efter den aktuelle datapakke.")}function Hs(f){var v;if(!(ur.current===f||dr.current===f)){if(dr.current=f,ul.current){Or.current+=1,(v=cr.current)==null||v.abort(),cr.current=null,ur.current=null,fl(f),pe(f),B(!0),Hr(),he({value:2,label:`Skifter til ${Le(f)}...`,cancellable:!0});return}Vs()}}function Vs(){if(ul.current)return;const f=dr.current;if(!f)return;dr.current=null;const v=Or.current+1;Or.current=v;const w=new AbortController;cr.current=w,ur.current=f,fl(f),pe(f),B(!0),Hr(),he({value:12,label:`Indlæser ${Le(f)}...`,cancellable:!0});const N=(async()=>{try{const D=await g(f,(X,de)=>{Or.current===v&&he({value:X,label:de,cancellable:!0})},w.signal);if(w.signal.aborted||Or.current!==v)return;St(f,D,"pico"),Et(f,D),Vt("Fil indlæst")}catch(D){if(Or.current!==v)return;Xv(D)||w.signal.aborted?$("info",`Stoppede læsning af ${Le(f)}.`):(he(null),$("error",D instanceof Error?D.message:"BLE læsning fejlede."))}})();ul.current=N,N.finally(()=>{if(ul.current!==N)return;ul.current=null,cr.current===w&&(cr.current=null),ur.current===f&&(ur.current=null),!!dr.current||(pe(null),B(!1),w.signal.aborted&&he(null)),Vs()})}async function Sa(f){const v=_n.current;_n.current=!0;try{return await f()}finally{_n.current=v}}j.useEffect(()=>{if(!Fn)return;const f=cl.current;f&&(f.scrollTop=f.scrollHeight)},[F,Fn]),j.useEffect(()=>{Q2({clearTerminalOnRun:Gt,simplifiedErrors:nn})},[Gt,nn]),j.useEffect(()=>{var f;Xn.some(v=>v.version===wt)||on(((f=Xn[0])==null?void 0:f.version)??"")},[Xn,wt]),j.useEffect(()=>{wr(bh(navigator))},[]),j.useEffect(()=>{const f=()=>{const v=kt.current;xt.current=null,ft.current=null,kt.current=null,v==null||v.disconnect().catch(()=>{})};return window.addEventListener("pagehide",f),()=>{var v,w;Hr(),(v=Cn.current)==null||v.dispose(),Cn.current=null,(w=vn.current)==null||w.dispose(),vn.current=null,window.removeEventListener("pagehide",f),f()}},[]),j.useEffect(()=>{const f=v=>{!(v.ctrlKey||v.metaKey)||v.key.toLowerCase()!=="s"||(v.preventDefault(),!P&&ne.trim()&&!ol&&!Te&&!ce&&!Re&&Mi())};return window.addEventListener("keydown",f),()=>window.removeEventListener("keydown",f)},[xe,Se,P,x,Z,ne,ol,Te,ce,Re]);function Ea(f,v,w){Be(N=>{const D=Fd(N,f,v,w);return bs(D),D})}function Ta(f,v){Be(w=>{const N=w.find(Ae=>Ae.path===f),X=en[Zt("local",f)]??(N==null?void 0:N.content),de=X!==void 0&&Il(X)!==Il(v)?Fd(w,sb(f,hc(w)),X,!1):w,et=Fd(de,f,v,!1);return bs(et),et}),tn(w=>({...w,[Zt("local",f)]:v})),xe==="local"&&ne===f&&(R(v),gn(""),ee(null),wn())}const Ei=ub(oe,ve,en,x||Se);j.useEffect(()=>{if(!Se)return;const f={cancelled:!1};return(async()=>{for(let v=0;v<6&&!f.cancelled;v+=1)try{const w=await h();if(f.cancelled)return;ge(w),$("success",`Indlæste ${w.length} filer fra Pico via Bluetooth.`);return}catch(w){if(f.cancelled)return;v===5?$("error",w instanceof Error?w.message:"BLE filhandling fejlede."):await mh(1500)}})(),()=>{f.cancelled=!0}},[s,Se]),j.useEffect(()=>{const f=Yn.current;f&&f!==hi&&qr(),Yn.current=hi},[hi]);async function Ec(){if(Lr.supported){O(!0);try{await bi.requestAndConnect();const f=new Y_(bi);xt.current=f,ft.current=new J_(f),E(!0),Ve(0),await f.interrupt(),await Tc(f),$("success","Sendte stop-signal til Pico-terminalen."),await Ti(ft.current),await Ps(ft.current)}catch(f){$("error",f instanceof Error?f.message:"USB-forbindelse mislykkedes.");try{await bi.disconnect()}catch(v){$("error",v instanceof Error?`USB-porten kunne ikke lukkes: ${v.message}`:"USB-porten kunne ikke lukkes.");return}Ve(v=>{const w=v+1;return w>=3&&($("info","USB-forbindelsen er mislykkedes flere gange. Hvis Picoen er i BOOTSEL eller mangler MicroPython, kan du bruge MicroPython-download."),Ce(!0)),w}),E(!1)}finally{O(!1)}}}async function Tc(f){const v=await f.exec(`import sys
print(sys.implementation.name)
`,4e3);if(v.error||!v.output.toLowerCase().includes("micropython"))throw new Error("MicroPython blev ikke fundet på Picoen.")}async function Mc(){var f;try{await((f=kt.current)==null?void 0:f.disconnect()),xt.current=null,ft.current=null,E(!1),qr()}catch(v){$("error",v instanceof Error?`USB-porten kunne ikke lukkes: ${v.message}`:"USB-porten kunne ikke lukkes.")}}async function Qn(f){const v=ft.current;if(v){B(!0),_n.current=!0;try{await f(v)}catch(w){he(null),$("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{_n.current=!1,B(!1)}}}async function Tt(f=!0){if(Se){B(!0);try{const v=await h();ge(v),f&&$("success",`Indlæste ${v.length} filer fra Pico via Bluetooth.`)}catch(v){$("error",v instanceof Error?v.message:"BLE filhandling fejlede.")}finally{B(!1)}return}await Ti(ft.current,f)}async function Ti(f,v=!0){if(f){B(!0);try{const w=await Sa(()=>f.list("/"));ge(w),v&&$("success",`Indlæste ${w.length} filer fra Pico.`)}catch(w){$("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{B(!1)}}}async function Zl(){if(Se){B(!0),he({value:4,label:"Tjekker biblioteker på Pico via Bluetooth..."});try{const f=await Is((v,w)=>he({value:v,label:w}));fe(f),Vt("Fil-tjek færdigt")}catch(f){he(null),$("error",f instanceof Error?f.message:"BLE runtime check fejlede.")}finally{B(!1)}return}await Ps(ft.current)}async function Is(f){const v=[],w=await ph(()=>h()).catch(()=>null),N=li.filter(X=>X.kind==="library"&&!Pl(X));let D=0;for(const X of li){if(X.kind==="program"){v.push({...X,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}if(Pl(X)){v.push({...X,status:"unknown",detail:"Opdateres via USB"});continue}try{const de=D/Math.max(1,N.length)*100,et=100/Math.max(1,N.length);$("info",`Tjekker ${X.label} på Pico via Bluetooth...`),f==null||f(Math.min(95,de),`Tjekker ${X.label} på Pico...`);const Ae=await g(X.path,(Mt,Yt)=>{f==null||f(Math.min(95,de+Mt/100*et),`${X.label}: ${Yt}`)}),tt=Il(Ae)===Il(X.content);v.push({...X,status:tt?"ok":"outdated",detail:tt?"Matcher appens version":"Kan installeres via Bluetooth"})}catch(de){v.push(gh(X,de,w))}finally{D+=1}}return f==null||f(100,"Fil-tjek færdigt"),v}async function Ps(f){if(f){B(!0);try{const v=await Sa(()=>Ma(f)),w=v;fe(w)}catch(v){$("error",v instanceof Error?v.message:"Runtime check fejlede.")}finally{B(!1)}}}async function Ma(f){if(!f)return[];const v=[],w=await ph(()=>f.list("/")).catch(()=>null);for(const N of li){if(N.kind==="program"){v.push({...N,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}try{const D=await f.readText(N.path),X=Il(D)===Il(N.content);v.push({...N,status:X?"ok":"outdated",detail:X?"Matcher appens version":"Matcher ikke appens version"})}catch(D){v.push(gh(N,D,w))}}return v}async function jc(f=ne){if(Se){Hs(f);return}pe(f),await Qn(async v=>{he({value:12,label:`Indlæser ${Le(f)}...`});const w=await Nc(v,f);St(f,w,"pico"),Et(f,w),Vt("Fil indlæst")}),pe(null)}async function Nc(f,v){var w;try{return await f.readText(v)}catch(N){await((w=xt.current)==null?void 0:w.stop().catch(()=>{})),await mh(120);try{return await f.readText(v)}catch{throw N}}}function Rc(){We(!0)}async function Mi(){if(xe==="pico"){if(!x&&!Se){$("error","Ingen Pico-forbindelse. Brug Gem for at vælge en anden placering.");return}await ji();return}Fs()}function Fs(){if(Fl(ne)){$("error",Ss);return}Ea(ne,Z,!1),$e("local"),tn(f=>({...f,[Zt("local",ne)]:Z})),We(!1),$("success",`Gemte ${Le(ne)} lokalt.`)}async function ji(){if(We(!1),Fl(ne))return he(null),$("error",Ss),!1;if(he({value:0,label:"Starter gemning..."}),Se){B(!0);try{return await m(ne,Z,(v,w)=>he({value:v,label:w})),Et(ne,Z),$e("pico"),tn(v=>({...v,[Zt("pico",ne)]:Z})),Vt("Gemt på Pico via Bluetooth"),$("success",`Gemte ${Le(ne)} på Pico via Bluetooth.`),oc(ne)&&(ht("saved"),$("warning","main.py er gemt. Genstart Picoen for at køre den nye version.")),await Tt(!1),!0}catch(v){return he(null),$("error",v instanceof Error?v.message:"BLE gem fejlede."),!1}finally{B(!1)}}if(!ft.current)return he(null),!1;let f=!1;return await Qn(async v=>{pl(ne,"pico")?await v.replaceTextSafely(ne,Z,(w,N)=>he({value:w,label:N})):await v.writeText(ne,Z,(w,N)=>he({value:w,label:N})),Et(ne,Z),$e("pico"),tn(w=>({...w,[Zt("pico",ne)]:Z})),Vt("Gemt på Pico via USB"),$("success",`Gemte ${ne}.`),await Tt(),await Zl(),f=!0}),f}function Ac(){Gs(Le(ne),Z),We(!1),$("success",`Downloadede ${Le(ne)}.`)}function Gs(f,v){const w=new Blob([v],{type:"text/plain;charset=utf-8"}),N=URL.createObjectURL(w),D=document.createElement("a");D.href=N,D.download=f,D.click(),URL.revokeObjectURL(N)}async function $s(f){B(!0),f==="ide"&&q(!0),ht(null),he({value:10,label:"Genstarter Pico..."});try{await b(f)?(Vt("Pico genforbundet"),$("success",f==="control"?"Pico genforbundet. Åbner kontrolpanelet.":"Pico genforbundet til Kodeværkstedet.")):(he(null),$("warning","Automatisk genforbindelse lykkedes ikke. Vælg Picoen fra dashboardet."))}catch(v){he(null),$("error",v instanceof Error?v.message:"Genstart/genforbindelse mislykkedes.")}finally{B(!1),q(!1)}}function Ys(f){var X,de;const v=f??{path:ne,source:xe},w=v.source==="pico"?"Pico":"browser",N=(f==null?void 0:f.versions.length)??(v.source==="pico"?((X=ai(oe).get(v.path))==null?void 0:X.length)??0:((de=ai(hc(ve)).get(v.path))==null?void 0:de.length)??0),D=N>0?` Det sletter også filens versionshistorik (${N} gemte versioner).`:"";me(null),l({title:"Slet fil",message:`Vil du slette ${Le(v.path)} fra ${w}?${D}`,confirmLabel:"Slet",onConfirm:()=>{ea(v)}})}function Cc(){l({title:"Nulstil enhed",message:"Vil du nulstille Picoens enhedsindstillinger? Det sletter DeviceSettings.txt, så Picoen kan oprettes som en ny enhed igen. Kodefiler og startprogram bliver ikke slettet.",confirmLabel:"Nulstil",onConfirm:()=>{Dc()}})}async function Dc(){if(!ft.current){$("error","Forbind Picoen med USB først.");return}await Qn(async f=>{await f.delete("/DeviceSettings.txt").catch(v=>{const w=v instanceof Error?v.message:"";if(!/ENOENT|No such file|not found/i.test(w))throw v}),Ft(v=>{const w={...v};return delete w["/DeviceSettings.txt"],w}),ml("/DeviceSettings.txt","pico"),$("success","DeviceSettings.txt er nulstillet. Afbryd og forbind Picoen igen, hvis kontrolpanelet allerede var åbent."),await Tt()})}function Xs(f,v,w){const N=Ei.filter(de=>de.kind==="file"&&de.type==="file"),D=N.findIndex(de=>de.path===f&&de.source===v);if(D===-1)return null;const X=de=>!!de&&!(de.path===f&&de.source===v)&&!(de.source===v&&w.has(de.path))&&!(Se&&Pl(de));for(const de of[!0,!1])for(let et=1;et<N.length;et+=1){const Ae=N[D+et];if(X(Ae)&&(!de||Ae.source===v))return Ae;const tt=N[D-et];if(X(tt)&&(!de||tt.source===v))return tt}return null}function Jl(f){if(f){Ni(f);return}const v=cc(ic())[0];St(v.path,en[Zt("local",v.path)]??v.content,"local")}async function ea(f){const v=f.path,w=f.source,N=v===ne&&w===xe;if(w==="local"){const Ae=ai(hc(ve)).get(v)??[],tt=new Set([v,...Ae.map(pt=>pt.path)]),Mt=N?Xs(v,w,tt):null,Yt=ve.filter(pt=>!tt.has(pt.path));Be(Yt),bs(Yt);for(const pt of tt)ml(pt,"local");N&&Jl(Mt);const qe=Ae.length>0?` og ${Ae.length} gemte versioner`:"";$("warning",`Slettede ${Le(v)}${qe} fra browseren.`);return}const D=ai(oe).get(v)??[],X=[v,...D.map(Ae=>Ae.path)],de=N?Xs(v,w,new Set(X)):null;if(Se){B(!0);try{for(const tt of X)await _(tt);Ft(tt=>{const Mt={...tt};for(const Yt of X)delete Mt[Yt];return Mt});for(const tt of X)ml(tt,"pico");const Ae=D.length>0?` og ${D.length} gemte versioner`:"";$("warning",`Slettede ${Le(v)}${Ae} på Pico via Bluetooth.`),await Tt(),N&&Jl(de)}catch(Ae){$("error",Ae instanceof Error?Ae.message:"BLE sletning fejlede.")}finally{B(!1)}return}if(!ft.current){$("error","Ingen Pico-forbindelse. Kan ikke slette Pico-filen.");return}let et=!1;await Qn(async Ae=>{for(const Mt of X)await Ae.delete(Mt);Ft(Mt=>{const Yt={...Mt};for(const qe of X)delete Yt[qe];return Yt});const tt=D.length>0?` og ${D.length} gemte versioner`:"";$("warning",`Slettede ${v}${tt}.`);for(const Mt of X)ml(Mt,"pico");await Tt(),await Zl(),et=!0}),et&&N&&Jl(de)}async function Oc(f){if(!f)return;const v=Fv(f.name);if(!v){$("error","Kun .py, .txt, .json og .csv kan importeres.");return}if(Fl(v)){$("error",Ss);return}if(f.size>128*1024){$("error","Filen er for stor til Pico-værkstedet.");return}const w=await f.text();if(xe==="local"){Ea(v,w,!0),St(v,w,"local"),$("success",`Importerede ${Le(v)} i browseren.`);return}if(!x&&!Se){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(Se&&Pl({path:v})){$("error","PicoBluetooth.py kan ikke importeres over Bluetooth, mens den holder forbindelsen i gang. Brug USB i stedet.");return}if(he({value:0,label:"Uploader fil til Pico..."}),Se){B(!0);try{await m(v,w,(D,X)=>he({value:D,label:X})),Et(v,w),St(v,w,"pico"),Vt("Fil uploadet til Pico"),$("success",`Importerede ${Le(v)} på Pico via Bluetooth.`),await Tt()}catch(D){he(null),$("error",D instanceof Error?D.message:"Kunne ikke importere filen til Pico.")}finally{B(!1)}return}if(!ft.current){he(null),$("error","Ingen Pico-forbindelse. Kan ikke importere filen til Pico.");return}await Qn(async D=>{pl(v,"pico")?await D.replaceTextSafely(v,w,(X,de)=>he({value:X,label:de})):await D.writeText(v,w,(X,de)=>he({value:X,label:de})),Et(v,w),St(v,w,"pico"),Vt("Fil uploadet til Pico"),$("success",`Importerede ${Le(v)} på Pico.`),await Tt(),await Zl()})}async function Ks(){G(""),_e(!0)}function Qs(){const f=hh(T);if(!f)return;if(Fl(f)){$("error",Ss);return}const v=xe;if(pl(f,v)){$("error",`Der findes allerede en fil med navnet ${Le(f)} i ${v==="pico"?"Pico":"browseren"}.`);return}if(v==="local"){Ea(f,"",!1),St(f,"","local"),_e(!1),$("success",`Oprettede ${Le(f)} i browseren.`);return}Ws(f)}async function Ws(f){if(!x&&!Se){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(_e(!1),he({value:0,label:"Opretter fil på Pico..."}),Se){B(!0);try{await m(f,"",(v,w)=>he({value:v,label:w})),Et(f,""),St(f,"","pico"),Vt("Fil oprettet på Pico"),$("success",`Oprettede ${Le(f)} på Pico via Bluetooth.`),await Tt()}catch(v){he(null),$("error",v instanceof Error?v.message:"Kunne ikke oprette fil på Pico.")}finally{B(!1)}return}if(!ft.current){he(null),$("error","Ingen Pico-forbindelse. Kan ikke oprette Pico-filen.");return}await Qn(async v=>{await v.writeText(f,"",(w,N)=>he({value:w,label:N})),Et(f,""),St(f,"","pico"),Vt("Fil oprettet på Pico"),$("success",`Oprettede ${Le(f)} på Pico.`),await Tt()})}function Zs(f){f.type==="file"&&(me(f),ae(Gv(f.path)))}async function Js(f){if(!ce)return;const v=ce.path;if(me(null),ce.source==="local"){const w=ve.find(N=>N.path===f.path);if(!w){$("error","Kunne ikke finde versionen i browseren.");return}Ta(v,w.content),St(v,w.content,"local"),$("success",`Gendannede ${Le(f.path)} i browseren.`);return}if(he({value:0,label:"Gendanner version..."}),Se){B(!0);try{const w=await g(f.path);await m(v,w,(N,D)=>he({value:N,label:D})),Et(v,w),St(v,w,"pico"),Vt("Version gendannet"),await Tt(!1)}catch(w){he(null),$("error",w instanceof Error?w.message:"Kunne ikke gendanne versionen.")}finally{B(!1)}return}ft.current&&await Qn(async w=>{await w.replaceTextSafely(v,await w.readText(f.path),(D,X)=>he({value:D,label:X}));const N=await w.readText(v);Et(v,N),St(v,N,"pico"),Vt("Version gendannet"),await Tt()})}function hl(f){const v=(ce==null?void 0:ce.source)==="local"?"browseren":"Pico";l({title:"Slet version",message:`Vil du slette ${Le(f.path)} fra ${v}?`,confirmLabel:"Slet",onConfirm:()=>{Lc(f)}})}async function Lc(f){if((ce==null?void 0:ce.source)==="local"){const v=ve.filter(w=>w.path!==f.path);Be(v),bs(v),ml(f.path,"local"),me(w=>w&&{...w,versions:w.versions.filter(N=>N.path!==f.path)}),$("warning",`Slettede ${Le(f.path)} fra browserens versionshistorik.`);return}if(Se){B(!0);try{await _(f.path),await Tt(!1),me(v=>v&&{...v,versions:v.versions.filter(w=>w.path!==f.path)})}catch(v){$("error",v instanceof Error?v.message:"Kunne ikke slette versionen.")}finally{B(!1)}return}ft.current&&await Qn(async v=>{await v.delete(f.path),await Tt(!1),me(w=>w&&{...w,versions:w.versions.filter(N=>N.path!==f.path)})})}async function Bc(){var w;if(!ce)return;const f=ce,v=ob(f.path,N=>pl(N,f.source));if(!v){$("error",`Kunne ikke finde et ledigt filnavn til en kopi af ${Le(f.path)}.`);return}if(f.source==="local"){const N=en[Zt("local",f.path)]??((w=ve.find(D=>D.path===f.path))==null?void 0:w.content)??"";Ea(v,N,!1),St(v,N,"local"),me(null),$("success",`Duplikerede ${Le(f.path)} til ${Le(v)} i browseren.`);return}if(me(null),he({value:0,label:"Duplikerer fil..."}),Se){B(!0);try{const N=Jt[f.path]??await g(f.path);await m(v,N,(D,X)=>he({value:D,label:X})),Et(v,N),St(v,N,"pico"),Vt("Fil duplikeret"),await Tt(!1),$("success",`Duplikerede ${Le(f.path)} til ${Le(v)} på Pico via Bluetooth.`)}catch(N){he(null),$("error",N instanceof Error?N.message:"Kunne ikke duplikere filen.")}finally{B(!1)}return}if(!ft.current){he(null),$("error","Ingen Pico-forbindelse. Kan ikke duplikere Pico-filen.");return}await Qn(async N=>{const D=await N.readText(f.path);await N.writeText(v,D,(X,de)=>he({value:X,label:de})),Et(v,D),St(v,D,"pico"),Vt("Fil duplikeret"),await Tt(!1),$("success",`Duplikerede ${Le(f.path)} til ${Le(v)} på Pico.`)})}async function zc(){if(!ce)return;const f=ce,v=Pd(le,Es(f.path));if(!v||v===f.path)return;if(Fl(v)){$("error",Ss);return}if(pl(v,f.source)){$("error",`Der findes allerede en fil med navnet ${Le(v)}.`);return}const w=f.source==="local",N=f.source==="pico";if(Se&&N&&(oc(f.path)||oc(v))){$("error","main.py kan redigeres over Bluetooth, men ikke omdøbes. Gem den som main.py.");return}B(!0);try{if(N)if(Se){const D=Jt[f.path]??await g(f.path);await m(v,D,(X,de)=>he({value:X,label:de})),await _(f.path),Ft(X=>({...Eh(X,f.path,v),[v]:D}))}else ft.current&&(await Sa(()=>ft.current.rename(f.path,v)),Ft(D=>Eh(D,f.path,v)));w&&Be(D=>{const X=D.map(de=>de.path===f.path?{...de,path:v,updatedAt:Date.now()}:de);return bs(X),X}),ne===f.path&&xe===f.source&&Ie(v),tn(D=>mb(D,f.source,f.path,v)),me(null),ae(""),$("success",`Omdøbte ${Le(f.path)} til ${Le(v)}.`),N&&await Tt()}catch(D){$("error",D instanceof Error?D.message:"Kunne ikke omdøbe filen.")}finally{he(null),B(!1)}}function pl(f,v){return v==="pico"?oe.some(w=>w.path===f):ve.some(w=>w.path===f)}function Ni(f){if(f.type!=="file"){Se&&Tr(void 0,!1),Ie(f.path),$e(f.source);return}if(Se&&Pl(f)){$("warning","PicoBluetooth.py holder Bluetooth-forbindelsen i gang og kan ikke åbnes her.");return}if(f.source==="local"){Se&&Tr(void 0,!1);const w=ve.find(N=>N.path===f.path);St(f.path,en[Zt("local",f.path)]??(w==null?void 0:w.content)??"","local");return}const v=Zt("pico",f.path);if(Object.prototype.hasOwnProperty.call(en,v)){Se&&Tr(void 0,!1),St(f.path,en[v],"pico");return}if(Object.prototype.hasOwnProperty.call(Jt,f.path)){Se&&Tr(void 0,!1),St(f.path,Jt[f.path],"pico");return}jc(f.path)}async function gl(){if(!x&&!Se){const f=_h();fe(f),J(vh(f)),at(!0),he(null);return}B(!0),he({value:4,label:Se?"Tjekker biblioteker på Pico via Bluetooth...":"Tjekker biblioteker på Pico..."}),$("info",Se?"Tjekker om Picoens biblioteker er opdaterede via Bluetooth før installation...":"Tjekker om Picoens biblioteker er opdaterede før installation...");try{const f=W.length>0?W:Se?await Is((v,w)=>he({value:v,label:w})):await Sa(()=>Ma(ft.current));fe(f),J(vh(f)),at(!0),he(null)}catch(f){he(null),$("error",f instanceof Error?f.message:"Fil-tjek før installation fejlede.")}finally{B(!1)}}async function ta(){if(at(!1),Se){B(!0);try{const v=(W.length>0?W:li.map(N=>({...N,status:"unknown",detail:"Ikke tjekket"}))).filter(N=>V[N.id]&&!Pl(N));if(v.length===0){$("info","Ingen filer valgt til installation.");return}let w=null;he({value:0,label:"Starter installation..."});for(const[N,D]of v.entries()){$("info",`Installerer ${D.label} via Bluetooth...`);const X=N/v.length*100,de=100/v.length;await m(D.path,D.content,(et,Ae)=>{he({value:Math.min(99,X+et/100*de),label:`${D.label}: ${Ae}`})}),Ql(D.path,D.content),$("success",`Installerede ${D.label}.`),D.kind==="library"&&(w=D),oc(D.path)&&ht("saved")}Vt("Installation færdig"),await Tt(!1),await Zl(),w&&Ri(w)}catch(f){he(null),$("error",f instanceof Error?f.message:"BLE installation fejlede.")}finally{B(!1)}return}await Qn(async f=>{const w=(W.length>0?W:li.map(D=>({...D,status:"unknown",detail:"Ikke tjekket"}))).filter(D=>V[D.id]);if(w.length===0){$("info","Ingen filer valgt til installation.");return}let N=null;he({value:0,label:"Starter installation..."});for(const[D,X]of w.entries()){$("info",`Installerer ${X.label}...`);const de=D/w.length*100,et=100/w.length,Ae=await f.readText(X.path).catch(()=>null);Ae!==null&&Il(Ae)===Il(X.content)?(he({value:Math.min(99,de+et),label:`${X.label}: Allerede nyeste version`}),$("info",`${X.label} findes allerede i samme version.`)):(await f.replaceTextSafely(X.path,X.content,(tt,Mt)=>{he({value:Math.min(99,de+tt/100*et),label:`${X.label}: ${Mt}`})},{createBackup:!0}),$("success",`Installerede ${X.label}.`)),Ql(X.path,X.content),X.kind==="library"&&(N=X)}Vt("Installation færdig"),await Tt(!1),await Zl(),N&&Ri(N)})}function eo(){return(W.length>0?W:_h()).filter(v=>V[v.id])}function ja(){const f=eo();if(f.length===0){$("info","Ingen filer valgt.");return}for(const v of f)Ta(v.path,v.content);at(!1),$("success",`Gemte ${f.length} filer i browseren.`)}function to(){const f=eo();if(f.length===0){$("info","Ingen filer valgt.");return}f.forEach((v,w)=>{window.setTimeout(()=>{Gs(Le(v.path),v.content)},w*120)}),at(!1),$("success",`Starter download af ${f.length} filer.`)}function Ri(f){St(f.path,f.content,"pico"),Et(f.path,f.content),$("info",`Åbnede ${f.label} i editoren.`)}function Ai(f,v){J(w=>{if(f.kind!=="program")return{...w,[f.id]:v};const N={...w};for(const D of W)D.kind==="program"&&(N[D.id]=!1);return N[f.id]=v,N})}async function Ci(){if(na(),Se&&xe==="pico"){$("warning","Bluetooth holder forbindelsen åben, så koden kan ikke køres direkte her. Gem filen, og genstart Picoen for at køre den.");return}if(xe==="local"){await no();return}const f=xt.current;if(!f){$("error",`${Le(ne)} er gemt på Picoen, men der er ingen USB-forbindelse til Pico-terminalen.`);return}if(ne.endsWith(".py")){if(!ln()&&($("info",`${Le(ne)} har ikke gemte ændringer. Gemmer på Picoen før kørsel...`),!await ji())){$("error","Pico-forbindelsen blev afbrudt under gemning.");return}if(P)return;Kn(),$n.current="",it(!0);try{await f.runFile(ne,()=>{Kn(),$n.current="",bt.current=!1,mn(!0),rn.current=!0}),$("success",`Kører ${Le(ne)}. Brug Stop for at afbryde.`)}catch(v){mn(!1),rn.current=!1,Kn(),$n.current="",$("error",v instanceof Error?v.message:"Kunne ikke starte koden.")}return}B(!0);try{const v=await f.exec(Z,2e4);v.output.trim()&&$("info",v.output),v.error.trim()&&dl(v.error,Z),!v.output.trim()&&!v.error.trim()&&$("success","Koden kørte uden output.")}catch(v){$("error",v instanceof Error?v.message:"Kunne ikke køre koden.")}finally{B(!1)}}async function no(){const f=Wd(Z,{allowInput:!0});if(f.some(N=>N.level==="error")){for(const N of f){const D=N.line?`Linje ${N.line}: `:"";$(N.level==="error"?"error":"warning",`${D}${N.text}`)}return}/\binput\s*\(/.test(Z)&&!rp()&&$("warning","input() i browseren kræver at siden genindlæses. Opdater siden (F5) og prøv igen.");const v=new AbortController;mi.current=v;const w=new Ev;vn.current=w,B(!0),jn(!0),sr(!1),it(!0),$("info",x?"Starter Browser-MicroPython for browser-filen.":"Starter Browser-MicroPython. Forbind Pico med USB for at køre på selve Picoen.");try{const N=[],D=await w.run(Z,{timeoutMs:null,signal:v.signal,onOutput:Ae=>{N.push(Ae),$("info",Ae)},onWaitingForInput:sr});for(const Ae of D.issues){const tt=Ae.line?`Linje ${Ae.line}: `:"";$(Ae.level==="error"?"error":"warning",`${tt}${Ae.text}`)}const X=[...N,D.output].filter(Boolean).join(`
`).trim(),de=D.output.trim();!D.error.trim()&&Kv(X)?dl(X,Z):(de&&$("info",de),D.error.trim()&&dl(D.error,Z,D.unavailable?"warning":"error")),D.ok&&!X&&!D.error.trim()&&$("success","Browser-MicroPython kørte uden output.")}finally{mi.current=null,vn.current=null,w.dispose(),jn(!1),sr(!1),B(!1)}}async function ro(){var v,w,N;if(hn){(v=mi.current)==null||v.abort(),(w=vn.current)==null||w.stop(),$("warning","Stoppede Browser-MicroPython."),it(!0);return}if(!$t&&br){(N=Cn.current)==null||N.reset(),Rn(!1),$("warning","Stoppede Browser-MicroPython-terminalen. Variablerne i browser-terminalen blev nulstillet."),it(!0);return}const f=xt.current;if(f)try{await f.stop(),$("warning","Stoppede koden på Pico.")}catch(D){$("error",D instanceof Error?D.message:"Kunne ikke stoppe koden.")}finally{mn(!1),rn.current=!1,Kn(),$n.current="",it(!0),xi()}}function lo(){const f=cl.current;if(!f)return;const v=f.scrollHeight-f.scrollTop-f.clientHeight<12;it(v)}function Uc(){H([]),it(!0)}function qc(){window.requestAnimationFrame(()=>{const f=cl.current;f&&(f.scrollTop=f.scrollHeight)})}async function Di(){const f=yn?vt:vt.trimEnd();if(yn){if(!$t){const N=vn.current;if(!N){$("warning","Browser-MicroPython kører ikke lige nu."),Wn();return}Qe(""),it(!0),fr(f),N.sendInput(f),Wn();return}const w=xt.current;if(!w){$("warning","Pico-terminalen er ikke forbundet."),Wn();return}Qe(""),it(!0);try{await w.sendProgramInput(f)}catch(N){$("error",N instanceof Error?N.message:"Kunne ikke sende input til Pico-koden.")}finally{Wn()}return}if(!f.trim())return;if(ba(w=>(w.at(-1)===f?w:[...w,f]).slice(-80)),pn(null),Je(null),_i){$("warning",$t?"Tryk Stop, før du skriver i Pico-terminalen.":"Stop offline MicroPython, før du skriver i browser-terminalen."),Wn();return}if(!$t){const w=Wd(f);if(w.some(D=>D.level==="error")){for(const D of w){const X=D.line?"Linje "+D.line+": ":"";$(D.level==="error"?"error":"warning",X+D.text)}Wn();return}const N=Cn.current??new Sv;Cn.current=N,Qe(""),Rn(!0),it(!0),$("info",">>> "+f);try{let D=!1;const X=await N.send(f,{timeoutMs:15e3,onOutput:et=>{D=!0,$("info",et)}}),de=X.output.trim();de&&!D&&$("info",de),X.error.trim()&&dl(X.error,f,X.unavailable?"warning":"error")}catch(D){$("error",D instanceof Error?D.message:"Browser-MicroPython-terminalen fejlede.")}finally{Rn(!1),Wn()}return}if(Se){$("warning","Terminalen bruger USB Serial. Bluetooth-forbindelsen kan vise filer, men kan ikke modtage frie terminalkommandoer."),Wn();return}const v=xt.current;if(!x||!v){$("warning","Forbind en microcontroller med USB for at skrive i MicroPython-terminalen."),Wn();return}Qe(""),Rn(!0),it(!0),bt.current=!0,$("info",">>> "+f);try{await v.sendFriendlyLine(f)}catch(w){bt.current=!1,$("error",w instanceof Error?w.message:"Kunne ikke sende kommando til MicroPython REPL.")}finally{Rn(!1),Wn()}}function Wn(){window.requestAnimationFrame(()=>{const f=An.current;if(!f||f.disabled)return;f.focus();const v=f.value.length;f.selectionStart=v,f.selectionEnd=v})}function ao(f,v,w){if(w.length===0)return null;const N=x||Se;return u.jsxs("div",{className:"ide-install-group",children:[u.jsxs("div",{className:"ide-install-group-head",children:[u.jsx("h3",{children:f}),u.jsx("p",{children:v})]}),u.jsx("div",{className:"ide-install-scroll",children:w.map(D=>{const X=Se&&Pl(D);return u.jsxs("label",{className:`ide-install-row ${X?"disabled":""}`,children:[u.jsx("input",{type:"checkbox",checked:!!V[D.id],disabled:X,onChange:de=>Ai(D,de.target.checked)}),u.jsxs("span",{children:[u.jsxs("strong",{children:[un(D),N&&D.kind==="library"&&u.jsx("em",{className:`ide-install-status status-${D.status}`,children:X?"USB":cb(D.status)})]}),u.jsx("small",{children:D.description})]})]},D.id)})})]})}function un(f){return f.kind==="program"?f.label.replace(/\s*\(main\.py\)$/i,""):f.label}function na(){Gt&&H([]),it(!0)}function Na(f,v){const w=f.indexOf(`
`,v);return w===-1?f.length:w}function Ra(f,v){if(wh(f,v)){ee(null);return}const w=tf(f,v);if(!w||w.query.length<1){ee(null);return}const N=yh(f,v,!0).slice(0,8),D=xh(xr.current,w.start,N.length);N.length>0&&D?(ee({items:N,selected:0,start:w.start,end:v,position:D}),Mr(kr.current,0)):ee(null)}function Oi(f,v){if(wh(f,v)){Je(null);return}const w=tf(f,v);if(!w||w.query.length<1){Je(null);return}const N=yh(f,v,!1).slice(0,8),D=xh(An.current,w.start,N.length);N.length>0&&D?(Je({items:N,selected:0,start:w.start,end:v,position:D}),Mr(or.current,0)):Je(null)}function Li(f){const v=f.value.slice(f.selectionStart,f.selectionEnd);gn(nb(v)?v:"")}function Mr(f,v){window.requestAnimationFrame(()=>{const w=f==null?void 0:f.querySelector(`[data-autocomplete-index="${v}"]`);w==null||w.scrollIntoView({block:"nearest"})})}function Bi(f=Ze==null?void 0:Ze.items[Ze.selected]){if(!f||!Ze)return;const v=Ur(),w=Z.slice(0,Ze.start)+f.insert+Z.slice(Ze.end),N=Ze.start+f.insert.length-(f.insert.endsWith("()")?1:0);ee(null),Dn(w,N,v),window.requestAnimationFrame(()=>{const D=xr.current;D&&D.focus()})}function Vr(f=be==null?void 0:be.items[be.selected]){if(!f||!be)return;const v=vt.slice(0,be.start)+f.insert+vt.slice(be.end),w=be.start+f.insert.length-(f.insert.endsWith("()")?1:0);Qe(v),Je(null),window.requestAnimationFrame(()=>{const N=An.current;N&&(N.focus(),N.selectionStart=w,N.selectionEnd=w)})}function zi(f){const v=xr.current;if(!v)return!1;const w=v.selectionStart,N=v.selectionEnd,D={content:Z,selectionStart:w,selectionEnd:N},X=Z.lastIndexOf(`
`,w-1)+1,de=N>w&&Z[N-1]===`
`?N-1:N,et=Na(Z,de),Ae=et<Z.length?et+1:et,tt=Z.slice(X,Ae);if(f<0){if(X===0)return!1;const Rt=Z.lastIndexOf(`
`,X-2)+1,xn=Z.slice(Rt,X),zt=Z.slice(0,Rt)+tt+xn+Z.slice(Ae),On=-xn.length;return Dn(zt,w+On,D,N+On),!0}if(Ae>=Z.length)return!1;const Mt=Na(Z,Ae),Yt=Mt<Z.length?Mt+1:Mt,qe=Z.slice(Ae,Yt),pt=Z.slice(0,X)+qe+tt+Z.slice(Yt),mr=qe.length;return Dn(pt,w+mr,D,N+mr),!0}function ra(f){var Yt;if(ka){(f.key==="Enter"||f.key==="Tab"||(f.ctrlKey||f.metaKey)&&["z","y","s"].includes(f.key.toLowerCase()))&&f.preventDefault();return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="z"){f.preventDefault(),(f.shiftKey?Kl():qs())&&ee(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="y"){f.preventDefault(),Kl()&&ee(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="s"){f.preventDefault(),!P&&ne.trim()&&Mi();return}if(f.altKey&&!f.ctrlKey&&!f.metaKey&&(f.key==="ArrowUp"||f.key==="ArrowDown")){f.preventDefault(),zi(f.key==="ArrowUp"?-1:1)&&ee(null);return}if(Ze){if(f.key==="ArrowDown"){f.preventDefault(),ee(qe=>{if(!qe)return qe;const pt=(qe.selected+1)%qe.items.length;return Mr(kr.current,pt),{...qe,selected:pt}});return}if(f.key==="ArrowUp"){f.preventDefault(),ee(qe=>{if(!qe)return qe;const pt=(qe.selected-1+qe.items.length)%qe.items.length;return Mr(kr.current,pt),{...qe,selected:pt}});return}if(f.key==="Tab"){f.preventDefault(),Bi();return}if(f.key==="Enter"){if(!(Ze.items[Ze.selected]&&op(Ze.items[Ze.selected],Z.slice(Ze.start,Ze.end)))){f.preventDefault(),Bi();return}ee(null)}if(f.key==="Escape"){f.preventDefault(),ee(null);return}}if(f.key==="Enter"){f.preventDefault();const qe=f.currentTarget,pt=qe.selectionStart,mr=qe.selectionEnd,Rt={content:Z,selectionStart:pt,selectionEnd:mr},xn=Z.lastIndexOf(`
`,pt-1)+1,zt=Z.slice(xn,pt),On=((Yt=zt.match(/^[ \t]*/))==null?void 0:Yt[0])??"",Aa=zt.trimEnd().endsWith(":")?"    ":"",Ir=`
${On}${Aa}`,_l=Z.slice(0,pt)+Ir+Z.slice(mr),Pr=pt+Ir.length;Dn(_l,Pr,Rt),window.requestAnimationFrame(()=>{qe.selectionStart=Pr,qe.selectionEnd=Pr});return}if(f.key!=="Tab")return;f.preventDefault();const v=f.currentTarget,w=v.selectionStart,N=v.selectionEnd,D={content:Z,selectionStart:w,selectionEnd:N},X="    ";if(f.shiftKey){const qe=Z.lastIndexOf(`
`,w-1)+1,pt=w===N?Na(Z,w):N,mr=Z.slice(qe,pt);let Rt=0,xn=0;const zt=mr.replace(/(^|\n)( {1,4}|\t)/g,(Aa,Ir,_l,Pr)=>{const jr=_l.length;return qe+Pr<w&&(Rt+=jr),xn+=jr,Ir});if(xn===0)return;const On=Z.slice(0,qe)+zt+Z.slice(pt);Dn(On,Math.max(qe,w-Rt),D,w===N?Math.max(qe,w-Rt):Math.max(qe,N-xn)),window.requestAnimationFrame(()=>{v.selectionStart=Math.max(qe,w-Rt),v.selectionEnd=w===N?v.selectionStart:Math.max(v.selectionStart,N-xn)});return}if(w===N){const qe=Z.slice(0,w)+X+Z.slice(N);Dn(qe,w+X.length,D),window.requestAnimationFrame(()=>{v.selectionStart=w+X.length,v.selectionEnd=w+X.length});return}const de=Z.lastIndexOf(`
`,w-1)+1,Ae=Z.slice(de,N).replace(/^/gm,X),tt=Ae.split(`
`).length,Mt=Z.slice(0,de)+Ae+Z.slice(N);Dn(Mt,w+X.length,D,N+tt*X.length),window.requestAnimationFrame(()=>{v.selectionStart=w+X.length,v.selectionEnd=N+tt*X.length})}function Ui(f){if(yn){f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),Di());return}if(be){if(f.key==="ArrowDown"){f.preventDefault(),Je(v=>{if(!v)return v;const w=(v.selected+1)%v.items.length;return Mr(or.current,w),{...v,selected:w}});return}if(f.key==="ArrowUp"){f.preventDefault(),Je(v=>{if(!v)return v;const w=(v.selected-1+v.items.length)%v.items.length;return Mr(or.current,w),{...v,selected:w}});return}if(f.key==="Enter"||f.key==="Tab"){f.preventDefault(),Vr();return}if(f.key==="Escape"){f.preventDefault(),Je(null);return}}if(f.key==="Tab"){f.preventDefault();const v=f.currentTarget,w=v.selectionStart,N=v.selectionEnd,D="    ",X=vt.slice(0,w)+D+vt.slice(N),de=w+D.length;Qe(X),pn(null),Je(null),window.requestAnimationFrame(()=>{v.selectionStart=de,v.selectionEnd=de});return}if(f.key==="ArrowUp"||f.key==="ArrowDown"){if(!(f.key==="ArrowUp"?f.currentTarget.selectionStart===0&&f.currentTarget.selectionEnd===0:f.currentTarget.selectionStart===vt.length&&f.currentTarget.selectionEnd===vt.length)||vr.length===0)return;f.preventDefault();const w=f.key==="ArrowUp"?Nn===null?vr.length-1:Math.max(0,Nn-1):Nn===null||Nn+1>=vr.length?null:Nn+1;pn(w);const N=w===null?"":vr[w]??"";Qe(N),Je(null),it(!0),window.requestAnimationFrame(()=>{const D=An.current;D&&(D.selectionStart=N.length,D.selectionEnd=N.length,qc())});return}f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),Di())}return u.jsxs("div",{className:"screen ide-screen",children:[u.jsx(df,{title:"Pico Kodeværksted",onMenu:()=>a()}),ol?u.jsx("div",{className:"ide-size-gate",role:"dialog","aria-modal":"true","aria-labelledby":"ide-size-title",children:u.jsxs("div",{className:"ide-size-gate-panel",children:[u.jsx("h2",{id:"ide-size-title",children:"Brug en bærbar for at bruge Kodeværkstedet"}),u.jsx("p",{children:"Denne skærm er for lille, så du skal åbne Kodeværkstedet på en bærbar eller en større skærm."})]})}):u.jsxs("div",{className:"ide-layout",children:[u.jsxs("section",{className:"ide-panel ide-files-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Filer"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:Ks,"aria-label":"Ny fil",title:"Ny fil",children:u.jsx(Pt,{name:"plus",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>{var f;return(f=ya.current)==null?void 0:f.click()},"aria-label":"Importer fil",title:"Importer fil",children:u.jsx(Pt,{name:"upload",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>Tt(),disabled:!x&&!Se||P,"aria-label":"Opdater filer",title:"Opdater filer",children:u.jsx(Pt,{name:"refresh",size:20})})]})]}),u.jsx("div",{className:"ide-file-list",children:Ei.length===0?u.jsx("button",{type:"button",disabled:!0,children:"Ingen filer læst"}):Ei.map(f=>{if(f.kind==="separator"){const D=f.id==="pico-files"&&!x&&!Se;return u.jsxs(j.Fragment,{children:[u.jsx("div",{className:`ide-file-separator ${f.id==="browser-files"?"browser-section":""}`,children:u.jsx("span",{children:f.label})}),D&&u.jsx("div",{className:"ide-file-disconnected",role:"status",children:"Ikke forbundet"})]},f.id)}const v=Se&&Pl(f),w=en[Zt(f.source,f.path)],N=w!==void 0&&w!==ib(f,ve,Jt);return u.jsxs("div",{className:`ide-file-row ${ne===f.path&&xe===f.source?"active":""} ${v?"protected":""}`,children:[u.jsxs("button",{type:"button",onClick:()=>Ni(f),disabled:v,title:v?"Holder Bluetooth-forbindelsen i gang og kan ikke åbnes her":void 0,children:[u.jsx("span",{children:f.name}),u.jsxs("small",{title:N?"Ikke gemte ændringer":"Ingen ikke gemte ændringer",children:[f.versions.length>0&&u.jsx("em",{className:"ide-file-version-count",title:`${f.versions.length} gemte versioner i historikken`,children:f.versions.length}),u.jsx("i",{className:`ide-file-dirty-dot ${N?"dirty":"clean"}`,"aria-hidden":"true"})]})]}),u.jsx("button",{className:"ide-file-actions",type:"button",onClick:()=>Zs(f),disabled:f.type!=="file"||P||v,"aria-label":`Filvalg for ${f.name}`,title:v?"Holder Bluetooth-forbindelsen i gang og kan ikke ændres her":"Filvalg",children:u.jsx(Pt,{name:"settings",size:16})})]},`${f.source}:${f.path}`)})})]}),u.jsxs("section",{className:"ide-panel ide-status-panel",children:[u.jsxs("div",{children:[u.jsxs("div",{className:"ide-status-head",children:[u.jsx("h2",{children:Se?"Forbundet Pico":"USB udvikling"}),!Se&&u.jsx("span",{className:`ide-usb-status ${Lr.supported?"available":"unavailable"}`,title:Lr.message,"data-tooltip":Lr.message,role:"img","aria-label":Lr.message,tabIndex:0,children:"!"})]}),Se&&u.jsxs("p",{children:[(s==null?void 0:s.deviceName)??"Pico"," er forbundet via Bluetooth."]})]}),!Se&&u.jsxs("div",{className:"ide-actions",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:x?Mc:Ec,disabled:!Lr.supported||C,children:C?"Forbinder...":x?"Afbryd USB":"Forbind USB"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:gl,disabled:Se||P,children:"Download"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:Cc,disabled:!x||P,children:"Nulstil enhed"})]}),Se&&u.jsxs("div",{className:"ide-actions",children:[u.jsxs("button",{className:"btn btn-primary ide-connection-state",type:"button",disabled:!0,children:[u.jsx(Pt,{name:"power",size:22}),"Bluetooth forbundet"]}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:gl,disabled:P,children:"Startprogrammer og biblioteker"})]}),!Se&&u.jsx("div",{className:"ide-runtime",children:u.jsx("div",{className:"ide-mini-actions single",children:u.jsx("button",{className:"btn btn-outline ide-disconnect-btn",type:"button",onClick:()=>Ce(!0),children:"MicroPython"})})})]}),u.jsxs("section",{className:"ide-panel ide-editor-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("div",{className:"ide-editor-title",children:u.jsxs("h2",{children:[Le(ne),u.jsxs("small",{children:[pi," bytes"]})]})}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Ci,disabled:P,children:"Kør"}),Se&&xe==="pico"?u.jsx("button",{className:"btn btn-outline",type:"button",onClick:()=>ht("manual"),disabled:P,children:"Genstart"}):u.jsx("button",{className:"btn btn-outline",type:"button",onClick:ro,disabled:!hn&&!(!$t&&br)&&(!x||!fn),children:"Stop"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:Rc,disabled:P||!ne.trim(),children:"Gem"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Ys(),disabled:P||!ne.trim(),children:"Slet"})]})]}),Si(),u.jsxs("div",{className:"ide-editor-wrap",children:[u.jsx("div",{ref:wa,className:"ide-line-numbers","aria-hidden":"true",style:{transform:`translateY(${-_r.top}px)`},children:Array.from({length:bn},(f,v)=>u.jsx("span",{children:v+1},v))}),u.jsx("pre",{ref:fi,className:"ide-highlight","aria-hidden":"true",style:{transform:`translate(${-_r.left}px, ${-_r.top}px)`},children:ab(Z,cn)}),u.jsx("textarea",{ref:xr,className:"ide-editor",value:Z,onChange:f=>Dn(f.target.value,f.target.selectionStart,Ur(),f.target.selectionEnd,"typing"),onKeyDown:ra,onKeyUp:f=>{["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(f.key)||Ra(f.currentTarget.value,f.currentTarget.selectionStart)},onClick:f=>{ee(null),Li(f.currentTarget)},onSelect:f=>Li(f.currentTarget),onScroll:f=>{const{scrollTop:v,scrollLeft:w}=f.currentTarget;wa.current&&(wa.current.style.transform=`translateY(${-v}px)`),fi.current&&(fi.current.style.transform=`translate(${-w}px, ${-v}px)`),sl({top:v,left:w}),Ze&&Ra(f.currentTarget.value,f.currentTarget.selectionStart)},readOnly:ka,"aria-busy":ka,spellCheck:!1}),Ze&&u.jsx("div",{ref:kr,className:`ide-autocomplete placement-${Ze.position.placement}`,role:"listbox","aria-label":"Kodeforslag",style:{left:Ze.position.left,top:Ze.position.top,maxHeight:Ze.position.maxHeight},children:(Ze.position.placement==="above"?Ze.items.map((f,v)=>({item:f,index:v})).reverse():Ze.items.map((f,v)=>({item:f,index:v}))).map(({item:f,index:v})=>u.jsx("button",{className:v===Ze.selected?"active":"",type:"button","data-autocomplete-index":v,onMouseDown:w=>{w.preventDefault(),Bi(f)},role:"option","aria-selected":v===Ze.selected,children:f.label},f.label))}),te&&u.jsxs("div",{className:"ide-editor-loading",role:"status","aria-live":"polite",children:[u.jsx("span",{className:"spinner","aria-hidden":"true"}),u.jsxs("strong",{children:["Indlæser ",Le(te),"..."]})]})]})]}),u.jsxs("section",{className:"ide-panel ide-terminal-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Terminal"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${nn?"":"active"}`,type:"button",onClick:()=>yr(f=>!f),"aria-label":nn?"Tekniske fejl er slået fra":"Tekniske fejl er slået til","aria-pressed":!nn,title:nn?"Vis originale tekniske fejl":"Viser originale tekniske fejl",children:"Teknisk"}),u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${Gt?"active":""}`,type:"button",onClick:()=>Gn(f=>!f),"aria-pressed":Gt,title:Gt?"Terminalen ryddes, hver gang du trykker Kør":"Terminalen beholder tekst, når du trykker Kør",children:"Ryd ved Kør"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Uc,disabled:F.length===0,children:"Ryd"})]})]}),u.jsxs("div",{className:"ide-terminal","aria-live":"polite",ref:cl,onScroll:lo,onClick:()=>{var f;return(f=An.current)==null?void 0:f.focus()},children:[F.length===0?u.jsx("div",{className:"term-line",children:"Ingen terminaldata endnu."}):F.map((f,v)=>u.jsx("div",{className:`term-line ${f.variant==="input"?"term-input-echo":`term-${f.level}`}`,children:f.technical&&!nn?f.technical:f.text},`${v}-${f.text}`)),u.jsxs("form",{className:`ide-terminal-command ${_i&&!yn?"locked":""} ${yn?"stdin":""}`,onSubmit:f=>{f.preventDefault(),Di()},children:[u.jsx("span",{"aria-hidden":"true",children:vi}),u.jsx("textarea",{ref:An,value:vt,onChange:f=>{Qe(f.target.value),pn(null),yn?Je(null):Oi(f.target.value,f.target.selectionStart)},onKeyDown:Ui,onKeyUp:f=>{yn||["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(f.key)||Oi(f.currentTarget.value,f.currentTarget.selectionStart)},onClick:()=>Je(null),disabled:zs,placeholder:Us,"aria-label":yn?"Input til kørende Pico-kode":"MicroPython-terminalkommando",title:Us,rows:Math.max(1,vt.split(`
`).length)})]}),be&&u.jsx("div",{ref:or,className:`ide-autocomplete ide-repl-autocomplete placement-${be.position.placement}`,role:"listbox","aria-label":"Terminalforslag",style:{left:be.position.left,top:be.position.top,maxHeight:be.position.maxHeight},children:(be.position.placement==="above"?be.items.map((f,v)=>({item:f,index:v})).reverse():be.items.map((f,v)=>({item:f,index:v}))).map(({item:f,index:v})=>u.jsx("button",{className:v===be.selected?"active":"",type:"button","data-autocomplete-index":v,onMouseDown:w=>{w.preventDefault(),Vr(f)},role:"option","aria-selected":v===be.selected,children:f.label},f.label))})]})]})]}),re&&u.jsx("div",{className:"ide-restart-overlay",role:"alert","aria-live":"assertive",children:u.jsxs("div",{className:"ide-restart-overlay-panel",children:[u.jsx("div",{className:"spinner"}),u.jsx("p",{children:k.label||"Genstarter Pico..."})]})}),u.jsx("input",{ref:ya,type:"file",accept:".py,.txt,.json,.csv",className:"sr-only",onChange:f=>{var v;Oc((v=f.target.files)==null?void 0:v[0]),f.currentTarget.value=""}}),Te&&u.jsx(qt,{title:"Gem fil",onClose:()=>We(!1),children:u.jsxs("div",{className:"ide-save-options",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:()=>void ji(),disabled:!x&&!Se||P,children:"Gem filen på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Ac,children:"Download filen til computer"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Fs,children:"Gem filen i browseren"})]})}),je&&u.jsx(qt,{title:"Startprogrammer og biblioteker",onClose:()=>at(!1),children:u.jsxs("div",{className:"ide-install-list",children:[u.jsx("p",{className:"ide-install-note",children:x||Se?"Vælg et startprogram og de biblioteker dit projekt bruger. Installer lægger filerne på Picoen.":"Du er ikke forbundet til en Pico. Du kan gemme filerne i browseren eller downloade dem til computeren, men de virker først på Picoen, når de er installeret der."}),u.jsxs("div",{className:"ide-install-grid",children:[ao("Startprogrammer (main.py)","Starter automatisk på Picoen.",W.filter(f=>f.kind==="program")),ao("Biblioteker","Ekstra Python-filer som dine programmer kan importere.",W.filter(f=>f.kind==="library"))]}),u.jsxs("div",{className:"ide-install-actions",children:[(x||Se)&&u.jsx("button",{className:"btn btn-primary",type:"button",onClick:ta,disabled:P,children:"Installer på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:to,disabled:P,children:"Download til computer"}),u.jsx("button",{className:x||Se?"btn btn-outline":"btn btn-primary",type:"button",onClick:ja,disabled:P,children:"Gem i browseren"})]})]})}),Pn&&u.jsx(qt,{title:Pn==="saved"?"main.py er gemt":"Genstart Pico",onClose:()=>ht(null),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:Pn==="saved"?"Picoen kører stadig den gamle kode. Genstart Picoen for at anvende den nye main.py. Appen forsøger automatisk at genforbinde bagefter.":"Picoen genstarter og kører main.py forfra. Appen forsøger automatisk at genforbinde bagefter."}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>void $s("control"),disabled:P,children:"Genstart og åbn kontrolpanel"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void $s("ide"),disabled:P,children:"Genstart og bliv i Kodeværksted"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>ht(null),disabled:P,children:"Senere"})]})}),ie&&u.jsx(qt,{title:"Installer MicroPython",onClose:()=>Ce(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:"Hvis Picoen er helt frisk, skal MicroPython først lægges på den."}),u.jsxs("ol",{className:"micropython-steps",children:[u.jsx("li",{children:"Hold BOOTSEL-knappen nede."}),u.jsx("li",{children:"Sæt Picoen i USB, og slip derefter BOOTSEL."}),u.jsx("li",{children:"Vælg Pico-model og MicroPython-version herunder, og download UF2-filen."}),u.jsxs("li",{children:["Kopier UF2-filen til drevet ",u.jsx("strong",{children:"RPI-RP2"})]})]}),u.jsxs("div",{className:"micropython-selects",children:[u.jsx("label",{htmlFor:"micropython-board",children:"Pico-model"}),u.jsx("select",{id:"micropython-board",value:Me,onChange:f=>De(f.target.value),children:gi.map(f=>u.jsx("option",{value:f,children:f},f))}),u.jsx("label",{htmlFor:"micropython-version",children:"MicroPython-version"}),u.jsx("select",{id:"micropython-version",value:(Br==null?void 0:Br.version)??wt,onChange:f=>on(f.target.value),children:Xn.map(f=>u.jsxs("option",{value:f.version,children:[f.version," (",f.date,")"]},`${f.board}:${f.version}:${f.date}`))})]}),Br&&u.jsx("a",{className:"btn btn-primary btn-block",href:Br.url,download:Br.fileName,children:"Download UF2"}),u.jsx("a",{className:"btn btn-outline btn-block",href:"https://www.raspberrypi.com/documentation/microcontrollers/micropython.html",target:"_blank",rel:"noreferrer",children:"Se vejledning"})]})}),Re&&u.jsx(qt,{title:"Ny Python-fil",onClose:()=>_e(!1),children:u.jsxs("form",{className:"ide-new-file-form",onSubmit:f=>{f.preventDefault(),Qs()},children:[u.jsx("label",{htmlFor:"new-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"new-pico-file",value:T,onChange:f=>G(f.target.value),autoFocus:!0,placeholder:"test"}),u.jsx("span",{children:".py"})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen tilføjer .py automatisk og opretter filen i ",Bs,"."]}),u.jsx("button",{className:"btn btn-primary",type:"submit",disabled:!hh(T),children:"Opret"})]})}),ce&&u.jsx(qt,{title:Le(ce.path),onClose:()=>me(null),children:u.jsxs("div",{className:"ide-file-action-modal",children:[u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:"Placering"}),u.jsx("strong",{children:ce.source==="pico"?"Pico":"Browser"})]}),u.jsxs("form",{className:"ide-file-rename-form",onSubmit:f=>{f.preventDefault(),zc()},children:[u.jsx("label",{htmlFor:"rename-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"rename-pico-file",value:le,onChange:f=>ae(f.target.value),placeholder:"min_kode"}),u.jsxs("span",{children:[".",Es(ce.path)]})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen beholder filendelsen .",Es(ce.path)," automatisk."]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"submit",disabled:!Pd(le,Es(ce.path))||Pd(le,Es(ce.path))===ce.path||P,children:"Gem navn"})]}),u.jsxs("div",{className:"ide-file-action-buttons",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void Bc(),disabled:P,children:"Dupliker"}),u.jsx("button",{className:"btn btn-outline btn-danger btn-block",type:"button",onClick:()=>Ys(ce),disabled:P,children:"Slet"})]}),u.jsxs("section",{className:"ide-version-history",children:[u.jsx("h4",{children:"Versionshistorik"}),ce.versions.length===0?u.jsx("p",{children:"Versionshistorik: 0 gemte versioner."}):u.jsx("div",{className:"ide-version-list",children:ce.versions.map(f=>u.jsxs("div",{className:"ide-version-row",children:[u.jsx("span",{children:Le(f.path)}),u.jsx("small",{children:f.size!==void 0?`${f.size} bytes`:"Gemt på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:()=>void Js(f),disabled:P,children:"Gendan"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>hl(f),disabled:P,children:"Slet"})]},f.path))})]})]})})]})}function hh(a){var o;const l=(o=a.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:o.replace(/\.py$/i,"").replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"");return l?`/${l}.py`:""}function Fv(a){const l=a.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop(),o=l==null?void 0:l.match(/^(.+)\.(py|txt|json|csv)$/i);if(!o)return"";const s=ip(o[1]);return s?`/${s}.${o[2].toLowerCase()}`:""}function Pd(a,l="py"){const o=a.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop();if(!o)return"";const s=o.match(/^(.+?)(?:\.(py|txt|json|csv))?$/i);if(!s)return"";const d=ip(s[1]),h=l.replace(/^\./,"").toLowerCase(),g=(s[2]??(h||"py")).toLowerCase();return d?`/${d}.${g}`:""}function Gv(a){return Le(a).replace(/\.(py|txt|json|csv)$/i,"")}function ip(a){return a.replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"")}function Es(a){var s;const l=Le(a).match(/\.([a-z0-9]+)$/i),o=(s=l==null?void 0:l[1])==null?void 0:s.toLowerCase();return o&&["py","txt","json","csv"].includes(o)?o:"py"}function Il(a){return a.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trimEnd()}function sp(a){return`/${a.replace(/\\/g,"/").replace(/^\/+/,"")}`.toLowerCase()}async function ph(a){const l=await a();return new Set(l.map(o=>sp(o.path)))}function $v(a){return a instanceof Error?a.message:String(a??"")}function Yv(a){return/ENOENT|No such file|not found/i.test($v(a))}function gh(a,l,o){const s=(o==null?void 0:o.has(sp(a.path)))??!1;return!s&&Yv(l)?{...a,status:"missing",detail:"Mangler på Pico"}:{...a,status:"unknown",detail:s?"Filen findes, men kunne ikke læses. Stop koden eller genstart Picoen og tjek igen.":"Kunne ikke tjekkes. Stop koden eller genstart Picoen og tjek igen."}}function _h(){return li.map(a=>({...a,status:"unknown",detail:"Kan gemmes uden Pico. Forbind en Pico for at installere."}))}function vh(a){const l={};return a.forEach(o=>{l[o.id]=!1}),l}function Le(a){return a.split("/").filter(Boolean).pop()??a}function oc(a){return a.replace(/\\/g,"/").toLowerCase()==="/main.py"}function bh(a){const l=a.userAgent||"",o=a.platform||"",s=a.maxTouchPoints||0,d=/Android.*Mobile|iPhone|iPod|Windows Phone|Mobile Safari/i.test(l),h=/Macintosh/i.test(o)&&s>1;return d&&!h}function Xv(a){return a instanceof DOMException&&a.name==="AbortError"}function Kv(a){return/Traceback \(most recent call last\):/.test(a)||/\b(?:SyntaxError|NameError|TypeError|ValueError|IndentationError|ImportError|ModuleNotFoundError|ZeroDivisionError|IndexError|KeyError|AttributeError):/.test(a)}function Pl(a){return Qv(a)}function Qv(a){return a.path.replace(/\\/g,"/").toLowerCase()==="/picobluetooth.py"}const ef=[...["False","None","True","and","as","assert","async","await","break","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","nonlocal","not","or","pass","raise","return","try","while","with","yield"].map(a=>({label:a,insert:`${a}${["for","if","while","def","class","elif","else","try","except","finally","with"].includes(a)?" ":""}`})),...["abs","all","any","bin","bool","bytearray","bytes","callable","chr","dict","dir","divmod","enumerate","eval","exec","filter","float","getattr","hasattr","hash","hex","id","input","int","isinstance","issubclass","iter","len","list","map","max","min","next","object","oct","open","ord","pow","print","range","repr","reversed","round","set","setattr","slice","sorted","str","sum","super","tuple","type","zip"].map(a=>({label:`${a}()`,insert:`${a}()`})),{label:"for i in range():",insert:"for i in range():"},{label:"while True:",insert:"while True:"},{label:"if True:",insert:"if True:"},{label:"time",insert:"time"},{label:"time.",insert:"time."},{label:"time.sleep",insert:"time.sleep"},{label:"time.sleep()",insert:"time.sleep()"},{label:"time.sleep_ms()",insert:"time.sleep_ms()"},{label:"time.ticks_ms()",insert:"time.ticks_ms()"},{label:"time.ticks_diff()",insert:"time.ticks_diff()"},{label:"time.sleep_us()",insert:"time.sleep_us()"},{label:"time.ticks_us()",insert:"time.ticks_us()"},{label:"machine",insert:"machine"},{label:"machine.",insert:"machine."},{label:"machine.Pin",insert:"machine.Pin"},{label:"machine.PWM",insert:"machine.PWM"},{label:"machine.ADC",insert:"machine.ADC"},{label:"machine.I2C",insert:"machine.I2C"},{label:"machine.SPI",insert:"machine.SPI"},{label:"machine.Timer",insert:"machine.Timer"},{label:"machine.UART",insert:"machine.UART"},{label:"machine.reset()",insert:"machine.reset()"},{label:"machine.freq()",insert:"machine.freq()"},{label:"Pin()",insert:"Pin()"},{label:"PWM()",insert:"PWM()"},{label:"ADC()",insert:"ADC()"},{label:"I2C()",insert:"I2C()"},{label:"SPI()",insert:"SPI()"},{label:"Timer()",insert:"Timer()"},{label:"UART()",insert:"UART()"},{label:"Pin.OUT",insert:"Pin.OUT"},{label:"Pin.IN",insert:"Pin.IN"},{label:"Pin.PULL_UP",insert:"Pin.PULL_UP"},{label:"Pin.PULL_DOWN",insert:"Pin.PULL_DOWN"},{label:"Pin.IRQ_FALLING",insert:"Pin.IRQ_FALLING"},{label:"Pin.IRQ_RISING",insert:"Pin.IRQ_RISING"},{label:"import time",insert:"import time"},{label:"import utime as time",insert:"import utime as time"},{label:"import machine",insert:"import machine"},{label:"import random",insert:"import random"},{label:"import os",insert:"import os"},{label:"import sys",insert:"import sys"},{label:"from machine import Pin",insert:"from machine import Pin"},{label:"from machine import Pin, PWM",insert:"from machine import Pin, PWM"},{label:"from machine import Pin, PWM, ADC",insert:"from machine import Pin, PWM, ADC"},{label:"PicoBluetooth",insert:"PicoBluetooth"},{label:"PicoRobotics",insert:"PicoRobotics"},{label:"NeoPixel",insert:"NeoPixel"},{label:"HCSR04",insert:"HCSR04"},{label:"ble.send_toggle_state()",insert:"ble.send_toggle_state()"},{label:"ble.send_slider_state()",insert:"ble.send_slider_state()"},{label:"ble.send_radar()",insert:"ble.send_radar()"},{label:"ble.send_text()",insert:"ble.send_text()"},{label:"ble.send_plot()",insert:"ble.send_plot()"},{label:"on_button(name, is_down):",insert:"on_button(name, is_down):"},{label:"on_slider(name, value):",insert:"on_slider(name, value):"},{label:"on_toggle(name, value):",insert:"on_toggle(name, value):"},{label:"on_connect():",insert:"on_connect():"},{label:"on_disconnect():",insert:"on_disconnect():"},{label:"ValueError",insert:"ValueError"},{label:"TypeError",insert:"TypeError"},{label:"OSError",insert:"OSError"},{label:"Exception",insert:"Exception"}];function yh(a,l,o){const s=tf(a,l);if(!s)return[];const d=Wv(a,s.start,l),h=s.query.toLowerCase(),g=d.beforeToken.toLowerCase(),m=d.linePrefix.toLowerCase(),_=o?[...ef,...Jv(a)]:ef;return eb(_).filter(k=>{const x=k.label.toLowerCase(),E=k.insert.toLowerCase();return E===h||x===h||op(k,s.query)?!1:d.importLine?Zv(k,d)?x.startsWith(m)||E.startsWith(m)||x.startsWith(h)||E.startsWith(h):!1:g.endsWith(".")&&!E.includes(".")?!1:!!(E.startsWith(h)||x.startsWith(h))})}function Wv(a,l,o){const s=a.lastIndexOf(`
`,l-1)+1,d=a.slice(s,o),h=a.slice(s,l),g=/^\s*(?:import|from)\s+[\w.,\s]*$/i.test(d),m=/^\s*from\s+\w+(?:\.\w+)*\s+import\s+/i.test(d);return{linePrefix:d,beforeToken:h,importLine:g,fromImportLine:m}}function Zv(a,l){return l.fromImportLine?!a.insert.includes("(")&&!a.insert.startsWith("import "):a.insert.startsWith("import ")||a.insert.startsWith("from ")?!0:/^[A-Za-z_][A-Za-z0-9_]*$/.test(a.insert)}function Jv(a){const l=new Set,o=[/\bdef\s+([A-Za-z_][A-Za-z0-9_]*)\s*\(/g,/\bclass\s+([A-Za-z_][A-Za-z0-9_]*)\b/g,/(?:^|[^\w.])([A-Za-z_][A-Za-z0-9_]*)\s*=/g,/\bfor\s+([A-Za-z_][A-Za-z0-9_]*)\s+in\b/g,/\b([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z_][A-Za-z0-9_]*)\s*\(/g];for(const s of o)for(const d of a.matchAll(s))d[1]&&l.add(d[1]),d[2]&&l.add(d[2]);return[...l].filter(s=>s.length>1&&!tb.has(s)).sort((s,d)=>s.localeCompare(d,"da")).map(s=>({label:s,insert:s}))}function eb(a){const l=new Set,o=[];for(const s of a){const d=s.insert.toLowerCase();l.has(d)||(l.add(d),o.push(s))}return o}const tb=new Set(ef.map(a=>a.insert.replace(/[().: ]+$/g,"")));function tf(a,l){const s=a.slice(0,l).match(/[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_.]*$/);return!s||s.index===void 0?null:{query:s[0],start:s.index}}function wh(a,l){const o=a.lastIndexOf(`
...
`,g),k=b===-1?a.length:b;if(l<=k&&g>=o)return!0;g=k;continue}if(_==='"""'||_==="'''"){d=m,g+=2;continue}(m==='"'||m==="'")&&(s=m)}return s!==null||d!==null}function op(a,l){const o=a.insert.trim();return!/[().]/.test(o)&&o.toLowerCase()===l.toLowerCase()}function nb(a){return/^[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_]*$/.test(a)}function xh(a,l,o){if(!a)return null;const s=a.closest(".ide-terminal")??a.parentElement;if(!s)return null;const d=window.getComputedStyle(a),h=document.createElement("div"),g=document.createElement("span"),m=s.getBoundingClientRect(),_=a.getBoundingClientRect();h.style.position="absolute",h.style.visibility="hidden",h.style.pointerEvents="none",h.style.whiteSpace="pre-wrap",h.style.overflowWrap="break-word",h.style.wordBreak=d.wordBreak,h.style.boxSizing=d.boxSizing,h.style.width=`${a.getBoundingClientRect().width}px`,h.style.padding=d.padding,h.style.border=d.border,h.style.font=d.font,h.style.lineHeight=d.lineHeight,h.style.letterSpacing=d.letterSpacing,h.style.tabSize=d.tabSize,h.style.fontVariantLigatures=d.fontVariantLigatures,h.style.scrollbarGutter=d.scrollbarGutter,h.style.left=`${_.left-m.left-a.scrollLeft}px`,h.style.top=`${_.top-m.top-a.scrollTop}px`,h.textContent=a.value.slice(0,l),g.textContent=a.value.slice(l,l+1)||" ",h.appendChild(g),s.appendChild(h);const b=g.getBoundingClientRect();h.remove();const k=34,x=14,E=Math.min(210,Math.max(k+x,o*k+x)),C=rb(b.left-m.left,8,Math.max(8,s.clientWidth-296)),O=b.top-m.top+s.scrollTop,F=b.bottom-m.top+s.scrollTop+10,H=s.scrollTop+s.clientHeight-F-8,P=O-s.scrollTop-8,B=s.scrollTop+s.clientHeight,re=H>=Math.min(E,k*2)||H>=P?"below":"above",q=Math.max(k+x,Math.min(E,re==="below"?H:P)),oe=re==="below"?Math.min(F,B-q-8):Math.max(s.scrollTop+8,O-q-8);return{left:C,top:oe,maxHeight:q,placement:re}}function rb(a,l,o){return Math.max(l,Math.min(o,a))}function lb(a){const l=[];let o=null,s=null,d=!1,h=0,g=0;const m=(_,b)=>{_>h&&l.push({text:a.slice(h,_),isTriple:b}),h=_};for(;g<a.length;){const _=a[g],b=a.slice(g,g+3);if(s){if(b===s.repeat(3)){g+=3,s=null,m(g,!0);continue}g+=1;continue}if(o){d?d=!1:_==="\\"?d=!0:(_===o||_===`
`)&&(o=null),g+=1;continue}if(_==="#"){const k=a.indexOf(`
`,g);g=k===-1?a.length:k;continue}if(b==='"""'||b==="'''"){m(g,!1),s=_,g+=3;continue}(_==='"'||_==="'")&&(o=_),g+=1}return m(a.length,s!==null),l}function ab(a,l=""){const o=/\b(False|None|True|and|as|assert|async|await|break|class|continue|def|del|elif|else|except|finally|for|from|global|if|import|in|is|lambda|nonlocal|not|or|pass|raise|return|try|while|with|yield)\b/g,s=/(#.*$|"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|\b\d+(?:\.\d+)?\b|\b(?:print|range|len|str|int|float|bool|list|dict|set|tuple|sum|min|max|abs|round)\b)/gm,d=[];let h=0;function g(m,_){m.split(/(\r?\n)/).forEach(b=>{if(b===`
`||b===`\r
`){d.push(u.jsx("br",{},`br-${h++}`));return}b!==""&&_(b,`part-${h++}`)})}return lb(a).forEach(m=>{if(m.isTriple){g(m.text,(_,b)=>{d.push(...Ns(_,l,b,"tok-string"))});return}g(m.text,(_,b)=>{let k=0;[..._.matchAll(s)].forEach((E,C)=>{const O=E.index??0;O>k&&d.push(...kh(_.slice(k,O),o,`${b}-${C}-plain`,l));const F=E[0],H=F.startsWith("#")?"tok-comment":F.startsWith('"')||F.startsWith("'")?"tok-string":/^\d/.test(F)?"tok-number":"tok-builtin";d.push(...Ns(F,l,`${b}-${C}-token`,H)),k=O+F.length}),k<_.length&&d.push(...kh(_.slice(k),o,`${b}-tail`,l))})}),d.length?d:" "}function kh(a,l,o,s=""){const d=[];let h=0;const g=new RegExp(l.source,"g");return[...a.matchAll(g)].forEach((m,_)=>{const b=m.index??0;b>h&&d.push(...Ns(a.slice(h,b),s,`${o}-${_}-plain`)),d.push(...Ns(m[0],s,`${o}-${_}-keyword`,"tok-keyword")),h=b+m[0].length}),h<a.length&&d.push(...Ns(a.slice(h),s,`${o}-plain-end`)),d}function Ns(a,l,o,s=""){if(!l)return[u.jsx("span",{className:s||void 0,children:a},o)];const d=[],h=l.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),g=new RegExp(`(?<![A-Za-zÆØÅæøå0-9_])(${h})(?![A-Za-zÆØÅæøå0-9_])`,"g");let m=0;return[...a.matchAll(g)].forEach((_,b)=>{const k=_.index??0;k>m&&d.push(u.jsx("span",{className:s||void 0,children:a.slice(m,k)},`${o}-${b}-before`)),d.push(u.jsx("span",{className:`${s} tok-match`.trim(),children:_[0]},`${o}-${b}-match`)),m=k+_[0].length}),m<a.length&&d.push(u.jsx("span",{className:s||void 0,children:a.slice(m)},`${o}-after`)),d.length?d:[u.jsx("span",{className:s||void 0,children:a},o)]}function cc(a){return a.length>0?a:[{path:Jd,content:ap,uploaded:!1,updatedAt:Date.now()}]}function Fd(a,l,o,s){const d=a.filter(h=>h.path!==l);return[{path:l,content:o,uploaded:s,updatedAt:Date.now()},...d].sort((h,g)=>g.updatedAt-h.updatedAt)}function hc(a){return a.map(l=>({name:Le(l.path),path:l.path,type:"file",size:new Blob([l.content]).size}))}function ib(a,l,o){var s;return a.source==="pico"?o[a.path]:(s=l.find(d=>d.path===a.path))==null?void 0:s.content}function pc(a){const l=a.replace(/\\/g,"/"),o=l.lastIndexOf("/"),s=o>=0?l.slice(0,o+1):"",h=(o>=0?l.slice(o+1):l).match(/^(.+)_backup(\d+)(\.[^.]+)$/i);return h?{originalPath:`${s}${h[1]}${h[3]}`,index:parseInt(h[2],10)}:null}function Fl(a){return pc(a)!==null}function ai(a){const l=new Map;for(const o of a){const s=pc(o.path);if(!s)continue;const d=l.get(s.originalPath)??[];d.push(o),l.set(s.originalPath,d)}for(const o of l.values())o.sort((s,d)=>{var h,g;return(((h=pc(d.path))==null?void 0:h.index)??0)-(((g=pc(s.path))==null?void 0:g.index)??0)});return l}function sb(a,l){const o=a.replace(/\\/g,"/"),s=o.lastIndexOf("/"),d=s>=0?o.slice(0,s+1):"/",h=s>=0?o.slice(s+1):o.replace(/^\/+/,""),g=h.lastIndexOf("."),m=g>0?h.slice(0,g):h,_=g>0?h.slice(g):"",b=new Set(l.map(k=>k.path.toLowerCase()));for(let k=1;k<1e3;k+=1){const x=`${d}${m}_backup${k}${_}`;if(!b.has(x.toLowerCase()))return x}return`${d}${m}_backup${Date.now()}${_}`}function ob(a,l){const o=a.replace(/\\/g,"/"),s=o.lastIndexOf("/"),d=s>=0?o.slice(0,s+1):"/",h=s>=0?o.slice(s+1):o.replace(/^\/+/,""),g=h.lastIndexOf("."),m=g>0?h.slice(0,g):h,_=g>0?h.slice(g):"";for(let b=1;b<1e3;b+=1){const k=b===1?"_kopi":`_kopi${b}`,x=`${d}${m}${k}${_}`;if(!l(x)&&!Fl(x))return x}return`${d}${m}_kopi${Date.now()}${_}`}function cb(a){return a==="ok"?"Nyeste":a==="outdated"?"Opdater":a==="missing"?"Mangler":"Ikke tjekket"}function ub(a,l,o,s){const d=new Map,h=ai(a),g=ai(hc(l));for(const x of a)Fl(x.path)||d.set(Zt("pico",x.path),{kind:"file",name:x.name,path:x.path,type:x.type,size:x.size,source:"pico",uploaded:!0,versions:h.get(x.path)??[]});for(const x of l)Fl(x.path)||d.set(Zt("local",x.path),{kind:"file",name:Le(x.path),path:x.path,type:"file",source:"local",uploaded:!1,versions:g.get(x.path)??[]});for(const x of Object.keys(o)){const[E,...C]=x.split(":"),O=C.join(":");if(E!=="local"&&E!=="pico"||!O)continue;const F=d.get(x);if(F){d.set(x,F);continue}d.set(x,{kind:"file",name:Le(O),path:O,type:"file",source:E,uploaded:!1,versions:E==="pico"?h.get(O)??[]:g.get(O)??[]})}const m=[...d.values()].sort(fb),_=m.filter(x=>x.source==="pico"),b=m.filter(x=>x.source==="local"),k=[];return _.length>0||s?k.push({kind:"separator",id:"pico-files",label:s?"Pico":"Microcontroller"},..._):k.push({kind:"separator",id:"pico-files",label:"Microcontroller"}),b.length>0&&k.push({kind:"separator",id:"browser-files",label:"Browser"},...b),k}const db=new Map([["main.py",0],["devicesettings.txt",1],["layout.txt",2],["picobluetooth.py",3],["picofly.py",4],["picorobotics.py",5],["neopixel.py",6],["hcsr04.py",7]]);function fb(a,l){const o=Sh(a.path),s=Sh(l.path);return o===null&&s===null?a.name.localeCompare(l.name,"da"):o===null?-1:s===null?1:o-s}function Sh(a){var o;const l=(o=a.replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:o.toLowerCase();return l?db.get(l)??null:null}function Eh(a,l,o){if(!(l in a))return a;const s={...a,[o]:a[l]};return delete s[l],s}function mb(a,l,o,s){const d=`${l}:${o}`;if(!(d in a))return a;const h={...a,[`${l}:${s}`]:a[d]};return delete h[d],h}function hb({open:a}){const l=se(B=>B.screen),o=se(B=>B.active),s=se(B=>B.toggleSideMenu),d=se(B=>B.toggleDebugger),h=se(B=>B.setEditMode),g=se(B=>B.openMenuPage),m=se(B=>B.disconnect),_=se(B=>B.openPicoIde),b=se(B=>B.closePicoIde),k=se(B=>B.picoIdeOrigin),x=l==="dashboard",E=l==="control",C=l==="ide",O=E&&!!(o!=null&&o.canEdit),F=!E||!!(o!=null&&o.isOwnedByMe)||!!(o!=null&&o.canEditCode),H=k==="control",P=k==="control"?"Pico Kontrol Panel":"Hovedmenu";return u.jsxs(u.Fragment,{children:[u.jsx("div",{className:`scrim ${a?"open":"closing"}`,onClick:()=>s(!1)}),u.jsxs("nav",{className:`sidemenu sidemenu-${l} ${a?"open":"closing"}`,"aria-label":"Sidemenu",children:[x&&u.jsxs(u.Fragment,{children:[u.jsx(Vn,{label:"Bruger",icon:"user",onClick:()=>g("user-settings")}),u.jsx(Vn,{label:"Indstillinger",icon:"settings",onClick:()=>g("application-settings")}),u.jsx(Vn,{label:"Kodeværksted",icon:"picoIde",onClick:_,disabled:!F}),u.jsx(Gd,{}),u.jsx(Vn,{label:"Om appen",icon:"info",onClick:()=>g("application-about")}),u.jsx(Vn,{label:"Hjælp",icon:"help",onClick:()=>g("application-help")}),u.jsx(Vn,{label:"Fejlfinding",icon:"debugger",onClick:()=>d(!0)})]}),E&&u.jsxs(u.Fragment,{children:[u.jsx(Vn,{label:"Indstillinger",icon:"settings",onClick:()=>g("device-settings")}),u.jsx(Vn,{label:"Rediger",icon:"edit",onClick:()=>h(!0),disabled:!O}),u.jsx(Vn,{label:"Kodeværksted",icon:"picoIde",onClick:_,disabled:!F}),u.jsx(Gd,{}),u.jsx(Vn,{label:"Hjælp",icon:"help",onClick:()=>g("device-help")}),u.jsx(Vn,{label:"Fejlfinding",icon:"debugger",onClick:()=>d(!0)})]}),C&&u.jsxs(u.Fragment,{children:[u.jsx(Vn,{label:P,icon:"back",onClick:b}),u.jsx(Gd,{})]}),u.jsx("div",{className:"spacer"}),(E||C&&H)&&u.jsx(Vn,{label:"Forlad",icon:"exit",onClick:()=>m()})]})]})}function Vn({label:a,icon:l,disabled:o,onClick:s}){return u.jsxs("button",{className:"iconbtn",type:"button",onClick:s,disabled:o,"aria-label":a,children:[u.jsx(Pt,{name:l}),u.jsx("span",{children:a})]})}function Gd(){return u.jsxs("a",{className:"iconbtn sidemenu-link",href:"https://www.teknologiskolen.dk/",target:"_blank",rel:"noreferrer","aria-label":"Teknologiskolen",children:[u.jsx("img",{src:Eg,alt:""}),u.jsx("span",{children:"Teknologiskolen"})]})}const pb={error:"term-error",success:"term-success",warning:"term-warning",info:""},Th={error:"[FEJL] ",success:"[SUCCES] ",warning:"[ADVARSEL] ",info:""};function gb(){const a=new Date,l=o=>String(o).padStart(2,"0");return`${l(a.getDate())}-${l(a.getMonth()+1)}-${a.getFullYear()}-${l(a.getHours())}-${l(a.getMinutes())}`}function _b(){const a=se(d=>d.logs),l=se(d=>d.clearLogs),o=se(d=>d.toggleDebugger);function s(){const d=[...a].reverse().map(_=>`${_.time} ${Th[_.level]}${_.message}`).join(`
`),h=new Blob([d],{type:"text/plain"}),g=URL.createObjectURL(h),m=document.createElement("a");m.href=g,m.download=`${gb()}.txt`,m.click(),URL.revokeObjectURL(g)}return u.jsxs(qt,{title:"Fejlfinding",onClose:()=>o(!1),closeVariant:"circle",children:[u.jsx("div",{className:"terminal",children:a.length===0?u.jsx("div",{className:"term-line",children:"Ingen log endnu."}):a.map((d,h)=>u.jsxs("div",{className:`term-line ${pb[d.level]}`,children:[d.time," ",Th[d.level],d.message]},`${d.time}-${h}`))}),u.jsxs("div",{className:"row",style:{marginTop:14},children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:l,children:"Ryd"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:s,children:"Gem logfil"})]})]})}const cp=4,ir=cp*4+17,Mh=80,vb=20,bb=30660;function yb(a){const l=new TextEncoder().encode(a);if(l.length>76)throw new Error("QR-koden er for lang.");const o=jh(!1),s=jh(!1);wb(o,s);const d=kb(l),h=Tb(d,vb);return Sb(o,s,[...d,...h]),Eb(o,s),o}function jh(a){return Array.from({length:ir},()=>Array.from({length:ir},()=>a))}function ar(a,l,o,s,d,h=!0){a[s][o]=d,h&&(l[s][o]=!0)}function wb(a,l){$d(a,l,0,0),$d(a,l,ir-7,0),$d(a,l,0,ir-7);for(let o=0;o<ir;o+=1)l[6][o]||ar(a,l,o,6,o%2===0),l[o][6]||ar(a,l,6,o,o%2===0);xb(a,l,26,26),ar(a,l,8,cp*4+9,!0)}function $d(a,l,o,s){for(let d=-1;d<=7;d+=1)for(let h=-1;h<=7;h+=1){const g=o+h,m=s+d;if(g<0||m<0||g>=ir||m>=ir)continue;const _=h>=0&&h<=6&&d>=0&&d<=6&&(h===0||h===6||d===0||d===6||h>=2&&h<=4&&d>=2&&d<=4);ar(a,l,g,m,_)}}function xb(a,l,o,s){for(let d=-2;d<=2;d+=1)for(let h=-2;h<=2;h+=1)l[s+d][o+h]||ar(a,l,o+h,s+d,Math.max(Math.abs(h),Math.abs(d))!==1)}function kb(a){const l=[];uc(l,4,4),uc(l,a.length,8);for(const s of a)uc(l,s,8);for(uc(l,0,Math.min(4,Mh*8-l.length));l.length%8!==0;)l.push(0);const o=[];for(let s=0;s<l.length;s+=8)o.push(l.slice(s,s+8).reduce((d,h)=>d<<1|h,0));for(let s=236;o.length<Mh;s=s===236?17:236)o.push(s);return o}function uc(a,l,o){for(let s=o-1;s>=0;s-=1)a.push(l>>>s&1)}function Sb(a,l,o){const s=o.flatMap(g=>Array.from({length:8},(m,_)=>g>>>7-_&1));let d=0,h=!0;for(let g=ir-1;g>=1;g-=2){g===6&&(g-=1);for(let m=0;m<ir;m+=1){const _=h?ir-1-m:m;for(let b=0;b<2;b+=1){const k=g-b;if(l[_][k])continue;const x=d<s.length?s[d]===1:!1;a[_][k]=x!==((k+_)%2===0),d+=1}}h=!h}}function Eb(a,l){const o=s=>(bb>>>s&1)!==0;for(let s=0;s<=5;s+=1)ar(a,l,8,s,o(s));ar(a,l,8,7,o(6)),ar(a,l,8,8,o(7)),ar(a,l,7,8,o(8));for(let s=9;s<15;s+=1)ar(a,l,14-s,8,o(s));for(let s=0;s<8;s+=1)ar(a,l,ir-1-s,8,o(s));for(let s=8;s<15;s+=1)ar(a,l,8,ir-15+s,o(s))}const Rs=new Array(512),nf=new Array(256);let Nh=!1;function up(){if(Nh)return;let a=1;for(let l=0;l<255;l+=1)Rs[l]=a,nf[a]=l,a<<=1,a&256&&(a^=285);for(let l=255;l<512;l+=1)Rs[l]=Rs[l-255];Nh=!0}function dp(a,l){return a===0||l===0?0:Rs[nf[a]+nf[l]]}function Tb(a,l){up();const o=Mb(l),s=Array.from({length:l},()=>0);for(const d of a){const h=d^s.shift();s.push(0);for(let g=0;g<l;g+=1)s[g]^=dp(o[g],h)}return s}function Mb(a){up();let l=[1];for(let o=0;o<a;o+=1){const s=Array.from({length:l.length+1},()=>0);for(let d=0;d<l.length;d+=1)s[d]^=dp(l[d],Rs[o]),s[d+1]^=l[d];l=s}return l.slice(1)}function jb(){const a=se(je=>je.menuPage),l=se(je=>je.closeMenuPage),o=se(je=>je.user),s=se(je=>je.active),d=se(je=>je.layout),h=se(je=>je.savedDevices),g=se(je=>je.updateUsername),m=se(je=>je.createOwnerPairingCode),_=se(je=>je.applyOwnerPairingCode),b=se(je=>je.clearSavedDevices),k=se(je=>je.resetApplicationData),x=se(je=>je.saveDeviceSettings),E=se(je=>je.setEditMode),C=se(je=>je.askConfirm),[O,F]=j.useState((o==null?void 0:o.username)??""),[H,P]=j.useState(!1),[B,re]=j.useState(""),[q,oe]=j.useState(""),[ge,te]=j.useState(!1),[pe,ve]=j.useState(""),Be=j.useRef(null),[ne,Ie]=j.useState((s==null?void 0:s.icon)??Gl),[xe,$e]=j.useState(!1),[Z,R]=j.useState((s==null?void 0:s.canOthersConnect)??!1),[W,fe]=j.useState((s==null?void 0:s.canOthersEdit)??!1),[Re,_e]=j.useState((s==null?void 0:s.canOthersEditCode)??!1),[T,G]=j.useState((s==null?void 0:s.gridCols)??11),[le,ae]=j.useState((s==null?void 0:s.gridRows)??31),[ce,me]=j.useState(!1);j.useEffect(()=>{a==="user-settings"&&(F((o==null?void 0:o.username)??""),oe(""),ve(""),te(!1))},[a,o==null?void 0:o.username]),j.useEffect(()=>{a==="device-settings"&&s&&(Ie(s.icon),R(s.canOthersConnect),fe(s.canOthersEdit),_e(s.canOthersEditCode),G(s.gridCols),ae(s.gridRows))},[s,a]),j.useEffect(()=>{if(!ge)return;let je=!1,at=null,V=0;async function J(){var Ce;const ie=window.BarcodeDetector;if(!ie||!((Ce=navigator.mediaDevices)!=null&&Ce.getUserMedia)){ve("Denne browser kan ikke scanne QR-koder. Skriv ejerkoden i stedet."),te(!1);return}try{at=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const Pe=Be.current;if(!Pe)return;Pe.srcObject=at,await Pe.play();const Ve=new ie({formats:["qr_code"]}),Me=async()=>{var De;if(!je){try{const on=(De=(await Ve.detect(Pe)).find(Pn=>Pn.rawValue))==null?void 0:De.rawValue;if(on){oe(on),_(on)&&P(!1),te(!1);return}}catch{}V=window.requestAnimationFrame(Me)}};V=window.requestAnimationFrame(Me)}catch{ve("Kameraet kunne ikke åbnes. Skriv ejerkoden i stedet."),te(!1)}}return J(),()=>{je=!0,V&&window.cancelAnimationFrame(V),at==null||at.getTracks().forEach(ie=>ie.stop())}},[_,ge]);const Te=(je,at)=>Number.isFinite(je)?Math.max(si,Math.min(oi,Math.round(je))):at,We=(o==null?void 0:o.username)??"",ze=O.trim(),he=ze.length>0&&ze!==We;if(!a)return null;if(a==="user-settings"){let je=function(){const J=m();J&&(re(J),oe(""),P(!0))},at=function(){_(q)&&(oe(""),P(!1))};async function V(){var J;try{await((J=navigator.clipboard)==null?void 0:J.writeText(B))}catch{}}return u.jsxs(u.Fragment,{children:[u.jsx(qt,{title:"Brugerindstillinger",onClose:l,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(gr,{label:"GUID",value:(o==null?void 0:o.userID)??"Ukendt"}),u.jsxs("div",{className:`field ${O.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-username",value:O,onChange:J=>F(J.target.value),maxLength:24,autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-username",children:"Brugernavn"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>g(O),disabled:!he,children:"Gem nyt brugernavn"}),u.jsx("div",{className:"notice",children:"Ejerkode bruges, hvis den samme person skal forbinde fra flere browsere eller telefoner."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:je,children:"Ejerkode"}),u.jsx("button",{className:"btn btn-outline btn-block btn-danger",type:"button",onClick:()=>C({title:"Start forfra",message:"Vil du slette brugeroplysninger og gemte enheder fra denne browser? Siden genindlæses bagefter.",confirmLabel:"Slet alt",onConfirm:()=>{k()}}),children:"Slet brugerdata"})]})}),H&&u.jsx(qt,{title:"Del ejerkode",onClose:()=>P(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Rb,{code:B}),u.jsx("code",{className:"owner-code-text",children:B}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void V(),children:"Kopiér ejerkode"}),u.jsxs("div",{className:`field ${q.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-owner-code",value:q,onChange:J=>oe(J.target.value),autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-owner-code",children:"Skriv ejerkode"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:at,disabled:!q.trim(),children:"Brug ejerkode i denne browser"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>te(J=>!J),children:ge?"Stop scanning":"Scan QR-kode"}),pe&&u.jsx("div",{className:"notice",children:pe}),ge&&u.jsx("video",{className:"owner-code-video",ref:Be,muted:!0,playsInline:!0})]})})]})}if(a==="application-settings")return u.jsx(qt,{title:"Applikationsindstillinger",onClose:l,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(gr,{label:"Version",value:As}),u.jsx(gr,{label:"Bluetooth",value:kc()?"Tilgængelig":"Ikke tilgængelig"}),u.jsx(gr,{label:"Gemte enheder",value:String(h.length)}),u.jsx("div",{className:"notice",children:"Bluetooth-tilladelser styres af browseren. Hvis du vil glemme en parret Pico helt, skal du fjerne tilladelsen i browserens site- eller Bluetooth-indstillinger."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>C({title:"Ryd gemte enheder",message:"Vil du fjerne alle gemte enheder fra denne browser?",confirmLabel:"Ryd",onConfirm:b}),disabled:h.length===0,children:"Ryd gemte enheder"})]})});if(a==="application-about")return u.jsx(qt,{title:"Om appen",onClose:l,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Pico Kontrol Panel er lavet til at bygge og fjernstyre sjove eller seje Raspberry Pi Pico W-projekter."}),u.jsx(gr,{label:"Udvikler",value:"Christian Bröchner Rasmussen"}),u.jsx(gr,{label:"Version",value:As})]})});if(a==="application-help")return u.jsx(qt,{title:"Hjælp til applikationen",onClose:l,children:u.jsxs("div",{className:"settings-stack prose help-lesson",children:[u.jsxs("div",{className:"help-lesson-card",children:[u.jsx("strong",{children:"Komplet undervisningsforløb"}),u.jsx("p",{children:"Linket åbner Teknologiskolens guide til Pico Kontrol Panel. Her kan du lære hele arbejdsgangen: browseropsætning, Kodeværkstedet, MicroPython, USB-installation, Bluetooth-forbindelse, kontrolpaneler og trådløs kodeudvikling."})]}),u.jsxs("div",{className:"help-lesson-list","aria-label":"Undervisningsforløbet indeholder",children:[u.jsx("span",{children:"Trin-for-trin opsætning"}),u.jsx("span",{children:"Øvelser til kode og kontrolpanel"}),u.jsx("span",{children:"Projektforslag med Pico W"})]}),u.jsx("p",{className:"help-lesson-destination",children:"Du sendes til materialer.teknologiskolen.dk i en ny fane."}),u.jsx("a",{className:"btn btn-primary btn-block",href:"https://materialer.teknologiskolen.dk/lessons/fjernstyring-af-raspberry-pi-pico-w",target:"_blank",rel:"noreferrer",children:"Åbn komplet undervisningsforløb"})]})});if(a==="device-settings"){const je=!!(s!=null&&s.isOwnedByMe);async function at(V=!1){if(!s||!je)return;const J=Te(T,s.gridCols),ie=Te(le,s.gridRows),Ce=Nb(d,J,ie);if(Ce&&!V){C({title:"Gitter kan påvirke layout",message:`Det nuværende layout bruger op til ${Ce.requiredCols} kolonner og ${Ce.requiredRows} rækker. Det nye gitter er ${J} × ${ie}, så nogle kontroller kan ende udenfor eller skulle flyttes i redigering.`,confirmLabel:"Gem alligevel",onConfirm:()=>{at(!0)}});return}me(!0),await x(ne,Z,Z&&W,Z&&Re,J,ie),G(J),ae(ie),me(!1),l()}return u.jsxs(qt,{title:"Enhedsindstillinger",onClose:l,children:[u.jsxs("div",{className:"device-settings-modal",children:[u.jsx("div",{className:"device-settings-scroll",children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(gr,{label:"Navn",value:(s==null?void 0:s.deviceName)??"Ukendt"}),u.jsx(gr,{label:"Ejer",value:Ab(s)}),je?u.jsxs(u.Fragment,{children:[u.jsxs("button",{className:"device-icon-pick settings-icon-pick",type:"button",onClick:()=>$e(!0),"aria-label":"Vælg ikon",children:[u.jsx(Ls,{slug:ne}),u.jsx("span",{className:"badge",children:u.jsx(Pt,{name:"plus",size:22})})]}),u.jsx("p",{className:"prompt",children:"Må andre forbinde til- og bruge denne enhed?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:Z?"":"active",onClick:()=>R(!1),children:"Privat"}),u.jsx("button",{type:"button",className:Z?"active":"",onClick:()=>R(!0),children:"Offentlig"})]}),Z&&u.jsxs(u.Fragment,{children:[u.jsx("p",{className:"prompt",children:"Må andre redigere layoutet?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:W?"":"active",onClick:()=>fe(!1),children:"Nej"}),u.jsx("button",{type:"button",className:W?"active":"",onClick:()=>fe(!0),children:"Ja"})]}),u.jsx("p",{className:"prompt",children:"Må andre redigere koden?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:Re?"":"active",onClick:()=>_e(!1),children:"Nej"}),u.jsx("button",{type:"button",className:Re?"active":"",onClick:()=>_e(!0),children:"Ja"})]})]}),u.jsx("p",{className:"prompt",children:"Kontrolpanelets gitter"}),u.jsxs("div",{className:"row",children:[u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-cols",children:"Kolonner"}),u.jsx("input",{id:"device-cols",type:"number",min:si,max:oi,value:Number.isNaN(T)?"":T,onChange:V=>G(parseInt(V.target.value,10)),onBlur:()=>G(Te(T,(s==null?void 0:s.gridCols)??11))})]}),u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-rows",children:"Rækker"}),u.jsx("input",{id:"device-rows",type:"number",min:si,max:oi,value:Number.isNaN(le)?"":le,onChange:V=>ae(parseInt(V.target.value,10)),onBlur:()=>ae(Te(le,(s==null?void 0:s.gridRows)??31))})]})]})]}):u.jsxs(u.Fragment,{children:[u.jsx(gr,{label:"Ikon",value:(s==null?void 0:s.icon)??Gl}),u.jsx(gr,{label:"Redigering",value:s!=null&&s.canEdit?"Tilladt":"Ikke tilladt"}),u.jsx(gr,{label:"Gitter",value:`${(s==null?void 0:s.gridCols)??0} × ${(s==null?void 0:s.gridRows)??0}`})]})]})}),je&&u.jsx("div",{className:"device-settings-foot",children:u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>at(),disabled:ce,children:ce?"Gemmer...":"Gem enhedsindstillinger"})})]}),xe&&u.jsx(Fh,{selected:ne,onSelect:Ie,onClose:()=>$e(!1)})]})}return u.jsx(qt,{title:"Hjælp til enheden",onClose:l,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Knapper sender en kommando med deres navn, når de trykkes."}),u.jsx("p",{children:"Slidere sender værdien fra den firmware-definerede skala. Appen ændrer kun placering og størrelse."}),u.jsx("p",{children:"Hvis redigering er tilladt, kan du åbne redigering fra menuen og gemme layoutet tilbage på Picoen."}),(s==null?void 0:s.canEdit)&&u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>E(!0),children:"Rediger layout"})]})})}function Nb(a,l,o){let s=0,d=0;for(const h of a)Os(h)&&(s=Math.max(s,Math.ceil((h.centerX2+h.spanX)/2)+1),d=Math.max(d,Math.ceil((h.centerY2+h.spanY)/2)+1));return l<s||o<d?{requiredCols:s,requiredRows:d}:null}function Rb({code:a}){const l=j.useMemo(()=>yb(a),[a]),o=l.length;return u.jsxs("svg",{className:"owner-code-qr",viewBox:`0 0 ${o+8} ${o+8}`,role:"img","aria-label":"QR-kode til ejerkode",children:[u.jsx("rect",{width:o+8,height:o+8,fill:"white"}),l.map((s,d)=>s.map((h,g)=>h?u.jsx("rect",{x:g+4,y:d+4,width:"1",height:"1",fill:"currentColor"},`${g}-${d}`):null))]})}function Ab(a){var l;return a?a.isOwnedByMe?"Dig":((l=a.ownerName)==null?void 0:l.trim())||"Anden bruger":"Ukendt"}function gr({label:a,value:l}){return u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:a}),u.jsx("strong",{children:l})]})}function Cb(){const a=se(s=>s.confirmDialog),l=se(s=>s.closeConfirm);if(!a)return null;function o(){a==null||a.onConfirm(),l()}return u.jsx(qt,{title:a.title,onClose:l,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:a.message}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:l,children:a.cancelLabel??"Annuller"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:o,children:a.confirmLabel??"Fortsæt"})]})]})})}function Db(){const a=se(s=>s.connectionLost),l=se(s=>s.reconnectLostDevice),o=se(s=>s.dismissConnectionLost);return a?u.jsx(qt,{title:"Forbindelse afbrudt",onClose:o,children:u.jsxs("div",{className:"settings-stack",children:[u.jsxs("p",{className:"confirm-message",children:["Forbindelsen til ",a.deviceName," blev afbrudt. Tjek at Picoen har strøm og er tæt nok på."]}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:o,children:"Luk"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>l(),children:"Genforbind"})]})]})}):null}function Ob(){const a=se(o=>o.toast),l=se(o=>o.dismissToast);return a?u.jsx("div",{className:"toast",role:"alert",onClick:l,children:a.message},a.id):null}function Lb(){const a=se(m=>m.screen),l=se(m=>m.splashTarget),o=se(m=>m.init),s=se(m=>m.sideMenuOpen),d=se(m=>m.debuggerOpen),[h,g]=j.useState(!1);return j.useEffect(()=>{o()},[o]),j.useEffect(()=>{if(s){g(!0);return}const m=setTimeout(()=>g(!1),140);return()=>clearTimeout(m)},[s]),u.jsxs("div",{className:"app",children:[a==="splash"&&l==="intro"&&u.jsx(zm,{}),a==="splash"&&l==="dashboard"&&u.jsx(Hm,{}),a==="splash"&&u.jsx(Dg,{}),a==="intro"&&u.jsx(zm,{}),a==="dashboard"&&u.jsx(Hm,{}),a==="connection"&&u.jsx(Gg,{}),a==="create"&&u.jsx(Xg,{}),a==="control"&&u.jsx(G_,{}),a==="ide"&&u.jsx(Pv,{}),h&&u.jsx(hb,{open:s}),u.jsx(jb,{}),u.jsx(Db,{}),u.jsx(Cb,{}),d&&u.jsx(_b,{}),u.jsx(Ob,{})]})}function Bb(){if(!("serviceWorker"in navigator))return;window.addEventListener("load",()=>{const l=new URL("sw.js",window.location.href);navigator.serviceWorker.register(l,{scope:"./"}).catch(o=>{console.warn("Service worker registration failed:",o)})});let a=!1;navigator.serviceWorker.addEventListener("controllerchange",()=>{a||window.crossOriginIsolated||(a=!0,window.location.reload())})}Bb();H2.createRoot(document.getElementById("root")).render(u.jsx(Ts.StrictMode,{children:u.jsx(Lb,{})}));
