 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gm;function T2(){return gm||(gm=1,(function(i){function l(D,te){var me=D.length;D.push(te);e:for(;0<me;){var fe=me-1>>>1,we=D[fe];if(0<d(we,te))D[fe]=te,D[me]=we,me=fe;else break e}}function o(D){return D.length===0?null:D[0]}function s(D){if(D.length===0)return null;var te=D[0],me=D.pop();if(me!==te){D[0]=me;e:for(var fe=0,we=D.length,E=we>>>1;fe<E;){var U=2*(fe+1)-1,ne=D[U],le=U+1,he=D[le];if(0>d(ne,me))le<we&&0>d(he,ne)?(D[fe]=he,D[le]=me,fe=le):(D[fe]=ne,D[U]=me,fe=U);else if(le<we&&0>d(he,me))D[fe]=he,D[le]=me,fe=le;else break e}}return te}function d(D,te){var me=D.sortIndex-te.sortIndex;return me!==0?me:D.id-te.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;i.unstable_now=function(){return p.now()}}else{var _=Date,m=_.now();i.unstable_now=function(){return _.now()-m}}var g=[],b=[],w=1,k=null,T=3,N=!1,L=!1,G=!1,P=!1,V=typeof setTimeout=="function"?setTimeout:null,K=typeof clearTimeout=="function"?clearTimeout:null,F=typeof setImmediate<"u"?setImmediate:null;function re(D){for(var te=o(b);te!==null;){if(te.callback===null)s(b);else if(te.startTime<=D)s(b),te.sortIndex=te.expirationTime,l(g,te);else break;te=o(b)}}function be(D){if(G=!1,re(D),!L)if(o(g)!==null)L=!0,ue||(ue=!0,J());else{var te=o(b);te!==null&&de(be,te.startTime-D)}}var ue=!1,W=-1,Z=5,Se=-1;function Ee(){return P?!0:!(i.unstable_now()-Se<Z)}function qe(){if(P=!1,ue){var D=i.unstable_now();Se=D;var te=!0;try{e:{L=!1,G&&(G=!1,K(W),W=-1),N=!0;var me=T;try{t:{for(re(D),k=o(g);k!==null&&!(k.expirationTime>D&&Ee());){var fe=k.callback;if(typeof fe=="function"){k.callback=null,T=k.priorityLevel;var we=fe(k.expirationTime<=D);if(D=i.unstable_now(),typeof we=="function"){k.callback=we,re(D),te=!0;break t}k===o(g)&&s(g),re(D)}else s(g);k=o(g)}if(k!==null)te=!0;else{var E=o(b);E!==null&&de(be,E.startTime-D),te=!1}}break e}finally{k=null,T=me,N=!1}te=void 0}}finally{te?J():ue=!1}}}var J;if(typeof F=="function")J=function(){F(qe)};else if(typeof MessageChannel<"u"){var We=new MessageChannel,Re=We.port2;We.port1.onmessage=qe,J=function(){Re.postMessage(null)}}else J=function(){V(qe,0)};function de(D,te){W=V(function(){D(i.unstable_now())},te)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(D){D.callback=null},i.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<D?Math.floor(1e3/D):5},i.unstable_getCurrentPriorityLevel=function(){return T},i.unstable_next=function(D){switch(T){case 1:case 2:case 3:var te=3;break;default:te=T}var me=T;T=te;try{return D()}finally{T=me}},i.unstable_requestPaint=function(){P=!0},i.unstable_runWithPriority=function(D,te){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var me=T;T=D;try{return te()}finally{T=me}},i.unstable_scheduleCallback=function(D,te,me){var fe=i.unstable_now();switch(typeof me=="object"&&me!==null?(me=me.delay,me=typeof me=="number"&&0<me?fe+me:fe):me=fe,D){case 1:var we=-1;break;case 2:we=250;break;case 5:we=1073741823;break;case 4:we=1e4;break;default:we=5e3}return we=me+we,D={id:w++,callback:te,priorityLevel:D,startTime:me,expirationTime:we,sortIndex:-1},me>fe?(D.sortIndex=me,l(b,D),o(g)===null&&D===o(b)&&(G?(K(W),W=-1):G=!0,de(be,me-fe))):(D.sortIndex=we,l(g,D),L||N||(L=!0,ue||(ue=!0,J()))),D},i.unstable_shouldYield=Ee,i.unstable_wrapCallback=function(D){var te=T;return function(){var me=T;T=te;try{return D.apply(this,arguments)}finally{T=me}}}})(Nd)),Nd}var _m;function M2(){return _m||(_m=1,Md.exports=T2()),Md.exports}var jd={exports:{}},rn={};/**
 * @license React
...
`,_),w=b===-1?i.length:b;if(l<=w&&_>=o)return!0;_=w;continue}if(g==='"""'||g==="'''"){d=m,_+=2;continue}(m==='"'||m==="'")&&(s=m)}return s!==null||d!==null}function ep(i,l){const o=i.insert.trim();return!/[().]/.test(o)&&o.toLowerCase()===l.toLowerCase()}function Hv(i){return/^[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_]*$/.test(i)}function _h(i,l,o){if(!i)return null;const s=i.closest(".ide-terminal")??i.parentElement;if(!s)return null;const d=window.getComputedStyle(i),p=document.createElement("div"),_=document.createElement("span"),m=s.getBoundingClientRect(),g=i.getBoundingClientRect();p.style.position="absolute",p.style.visibility="hidden",p.style.pointerEvents="none",p.style.whiteSpace="pre-wrap",p.style.overflowWrap="break-word",p.style.wordBreak=d.wordBreak,p.style.boxSizing=d.boxSizing,p.style.width=`${i.getBoundingClientRect().width}px`,p.style.padding=d.padding,p.style.border=d.border,p.style.font=d.font,p.style.lineHeight=d.lineHeight,p.style.letterSpacing=d.letterSpacing,p.style.tabSize=d.tabSize,p.style.fontVariantLigatures=d.fontVariantLigatures,p.style.scrollbarGutter=d.scrollbarGutter,p.style.left=`${g.left-m.left-i.scrollLeft}px`,p.style.top=`${g.top-m.top-i.scrollTop}px`,p.textContent=i.value.slice(0,l),_.textContent=i.value.slice(l,l+1)||" ",p.appendChild(_),s.appendChild(p);const b=_.getBoundingClientRect();p.remove();const w=34,k=14,T=Math.min(210,Math.max(w+k,o*w+k)),N=Vv(b.left-m.left,8,Math.max(8,s.clientWidth-296)),L=b.top-m.top+s.scrollTop,G=b.bottom-m.top+s.scrollTop+10,P=s.scrollTop+s.clientHeight-G-8,V=L-s.scrollTop-8,K=s.scrollTop+s.clientHeight,F=P>=Math.min(T,w*2)||P>=V?"below":"above",re=Math.max(w+k,Math.min(T,F==="below"?P:V)),be=F==="below"?Math.min(G,K-re-8):Math.max(s.scrollTop+8,L-re-8);return{left:N,top:be,maxHeight:re,placement:F}}function Vv(i,l,o){return Math.max(l,Math.min(o,i))}function Pv(i){const l=[];let o=null,s=null,d=!1,p=0,_=0;const m=(g,b)=>{g>p&&l.push({text:i.slice(p,g),isTriple:b}),p=g};for(;_<i.length;){const g=i[_],b=i.slice(_,_+3);if(s){if(b===s.repeat(3)){_+=3,s=null,m(_,!0);continue}_+=1;continue}if(o){d?d=!1:g==="\\"?d=!0:(g===o||g===`
