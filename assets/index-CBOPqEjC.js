 ...
 */var Dh;function _g(){if(Dh)return zi;Dh=1;var o=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function u(s,c,h){var _=null;if(h!==void 0&&(_=""+h),c.key!==void 0&&(_=""+c.key),"key"in c){h={};for(var b in c)b!=="key"&&(h[b]=c[b])}else h=c;return c=h.ref,{$$typeof:o,type:s,key:_,ref:c!==void 0?c:null,props:h}}return zi.Fragment=i,zi.jsx=u,zi.jsxs=u,zi}var jh;function gg(){return jh||(jh=1,zu.exports=_g()),zu.exports}var f=gg(),Bu={exports:{}},ye={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Oh;function bg(){if(Oh)return ye;Oh=1;var o=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),u=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),_=Symbol.for("react.context"),b=Symbol.for("react.forward_ref"),v=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),k=Symbol.for("react.activity"),j=Symbol.iterator;function F(w){return w===null||typeof w!="object"?null:(w=j&&w[j]||w["@@iterator"],typeof w=="function"?w:null)}var Q={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},le=Object.assign,U={};function H(w,z,P){this.props=w,this.context=z,this.refs=U,this.updater=P||Q}H.prototype.isReactComponent={},H.prototype.setState=function(w,z){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,z,"setState")},H.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function pe(){}pe.prototype=H.prototype;function oe(w,z,P){this.props=w,this.context=z,this.refs=U,this.updater=P||Q}var xe=oe.prototype=new pe;xe.constructor=oe,le(xe,H.prototype),xe.isPureReactComponent=!0;var fe=Array.isArray;function Ne(){}var ee={H:null,A:null,T:null,S:null},W=Object.prototype.hasOwnProperty;function be(w,z,P){var D=P.ref;return{$$typeof:o,type:w,key:z,ref:D!==void 0?D:null,props:P}}function _e(w,z){return be(w.type,z,w.props)}function ve(w){return typeof w=="object"&&w!==null&&w.$$typeof===o}function ae(w){var z={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(P){return z[P]})}var Ve=/\/+/g;function De(w,z){return typeof w=="object"&&w!==null&&w.key!=null?ae(""+w.key):z.toString(36)}function Ze(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(Ne,Ne):(w.status="pending",w.then(function(z){w.status==="pending"&&(w.status="fulfilled",w.value=z)},function(z){w.status==="pending"&&(w.status="rejected",w.reason=z)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function O(w,z,P,D,I){var Z=typeof w;(Z==="undefined"||Z==="boolean")&&(w=null);var K=!1;if(w===null)K=!0;else switch(Z){case"bigint":case"string":case"number":K=!0;break;case"object":switch(w.$$typeof){case o:case i:K=!0;break;case E:return K=w._init,O(K(w._payload),z,P,D,I)}}if(K)return I=I(w),K=D===""?"."+De(w,0):D,fe(I)?(P="",K!=null&&(P=K.replace(Ve,"$&/")+"/"),O(I,z,P,"",function(Et){return Et})):I!=null&&(ve(I)&&(I=_e(I,P+(I.key==null||w&&w.key===I.key?"":(""+I.key).replace(Ve,"$&/")+"/")+K)),z.push(I)),1;K=0;var Ie=D===""?".":D+":";if(fe(w))for(var Le=0;Le<w.length;Le++)D=w[Le],Z=Ie+De(D,Le),K+=O(D,z,P,Z,I);else if(Le=F(w),typeof Le=="function")for(w=Le.call(w),Le=0;!(D=w.next()).done;)D=D.value,Z=Ie+De(D,Le++),K+=O(D,z,P,Z,I);else if(Z==="object"){if(typeof w.then=="function")return O(Ze(w),z,P,D,I);throw z=String(w),Error("Objects are not valid as a React child (found: "+(z==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":z)+"). If you meant to render a collection of children, use an array instead.")}return K}function Y(w,z,P){if(w==null)return w;var D=[],I=0;return O(w,D,"","",function(Z){return z.call(P,Z,I++)}),D}function ie(w){if(w._status===-1){var z=w._result;z=z(),z.then(function(P){(w._status===0||w._status===-1)&&(w._status=1,w._result=P)},function(P){(w._status===0||w._status===-1)&&(w._status=2,w._result=P)}),w._status===-1&&(w._status=0,w._result=z)}if(w._status===1)return w._result.default;throw w._result}var Ee=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)},de={map:Y,forEach:function(w,z,P){Y(w,function(){z.apply(this,arguments)},P)},count:function(w){var z=0;return Y(w,function(){z++}),z},toArray:function(w){return Y(w,function(z){return z})||[]},only:function(w){if(!ve(w))throw Error("React.Children.only expected to receive a single React element child.");return w}};return ye.Activity=k,ye.Children=de,ye.Component=H,ye.Fragment=u,ye.Profiler=c,ye.PureComponent=oe,ye.StrictMode=s,ye.Suspense=v,ye.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ee,ye.__COMPILER_RUNTIME={__proto__:null,c:function(w){return ee.H.useMemoCache(w)}},ye.cache=function(w){return function(){return w.apply(null,arguments)}},ye.cacheSignal=function(){return null},ye.cloneElement=function(w,z,P){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var D=le({},w.props),I=w.key;if(z!=null)for(Z in z.key!==void 0&&(I=""+z.key),z)!W.call(z,Z)||Z==="key"||Z==="__self"||Z==="__source"||Z==="ref"&&z.ref===void 0||(D[Z]=z[Z]);var Z=arguments.length-2;if(Z===1)D.children=P;else if(1<Z){for(var K=Array(Z),Ie=0;Ie<Z;Ie++)K[Ie]=arguments[Ie+2];D.children=K}return be(w.type,I,D)},ye.createContext=function(w){return w={$$typeof:_,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:h,_context:w},w},ye.createElement=function(w,z,P){var D,I={},Z=null;if(z!=null)for(D in z.key!==void 0&&(Z=""+z.key),z)W.call(z,D)&&D!=="key"&&D!=="__self"&&D!=="__source"&&(I[D]=z[D]);var K=arguments.length-2;if(K===1)I.children=P;else if(1<K){for(var Ie=Array(K),Le=0;Le<K;Le++)Ie[Le]=arguments[Le+2];I.children=Ie}if(w&&w.defaultProps)for(D in K=w.defaultProps,K)I[D]===void 0&&(I[D]=K[D]);return be(w,Z,I)},ye.createRef=function(){return{current:null}},ye.forwardRef=function(w){return{$$typeof:b,render:w}},ye.isValidElement=ve,ye.lazy=function(w){return{$$typeof:E,_payload:{_status:-1,_result:w},_init:ie}},ye.memo=function(w,z){return{$$typeof:y,type:w,compare:z===void 0?null:z}},ye.startTransition=function(w){var z=ee.T,P={};ee.T=P;try{var D=w(),I=ee.S;I!==null&&I(P,D),typeof D=="object"&&D!==null&&typeof D.then=="function"&&D.then(Ne,Ee)}catch(Z){Ee(Z)}finally{z!==null&&P.types!==null&&(z.types=P.types),ee.T=z}},ye.unstable_useCacheRefresh=function(){return ee.H.useCacheRefresh()},ye.use=function(w){return ee.H.use(w)},ye.useActionState=function(w,z,P){return ee.H.useActionState(w,z,P)},ye.useCallback=function(w,z){return ee.H.useCallback(w,z)},ye.useContext=function(w){return ee.H.useContext(w)},ye.useDebugValue=function(){},ye.useDeferredValue=function(w,z){return ee.H.useDeferredValue(w,z)},ye.useEffect=function(w,z){return ee.H.useEffect(w,z)},ye.useEffectEvent=function(w){return ee.H.useEffectEvent(w)},ye.useId=function(){return ee.H.useId()},ye.useImperativeHandle=function(w,z,P){return ee.H.useImperativeHandle(w,z,P)},ye.useInsertionEffect=function(w,z){return ee.H.useInsertionEffect(w,z)},ye.useLayoutEffect=function(w,z){return ee.H.useLayoutEffect(w,z)},ye.useMemo=function(w,z){return ee.H.useMemo(w,z)},ye.useOptimistic=function(w,z){return ee.H.useOptimistic(w,z)},ye.useReducer=function(w,z,P){return ee.H.useReducer(w,z,P)},ye.useRef=function(w){return ee.H.useRef(w)},ye.useState=function(w){return ee.H.useState(w)},ye.useSyncExternalStore=function(w,z,P){return ee.H.useSyncExternalStore(w,z,P)},ye.useTransition=function(){return ee.H.useTransition()},ye.version="19.2.7",ye}var Ch;function af(){return Ch||(Ch=1,Bu.exports=bg()),Bu.exports}var V=af();const Yi=Tp(V);var Lu={exports:{}},Bi={},Uu={exports:{}},Hu={};/**
 * @license React
...
`),b=this.buffer.slice(0,_).replace(/\r$/,"");this.buffer=this.buffer.slice(_+1),(h=(c=this.events).onLine)==null||h.call(c,b)}}}function f0(o){const i=o.usbVendorId!==void 0?`VID ${o.usbVendorId.toString(16).padStart(4,"0")}`:"ukendt VID",u=o.usbProductId!==void 0?`PID ${o.usbProductId.toString(16).padStart(4,"0")}`:"ukendt PID";return`${i}, ${u}`}const Up=15e3,pp=64*1024,_p=1e5,Hp=new URL("/micropython/micropython.mjs",window.location.origin).toString(),d0=new Set(["bluetooth","machine","network","PicoRobotics","rp2","ubluetooth"]);let m0=0;class h0{constructor(){ue(this,"worker",null);ue(this,"pending",null);ue(this,"nextId",0)}send(i,u={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython-terminalen er optaget. Stop den, eller vent på at kommandoen bliver færdig.",timedOut:!1,unavailable:!1});const s=++this.nextId,c=u.timeoutMs??Up,h=this.ensureWorker();return new Promise(_=>{const b=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython-terminalen stoppede, fordi kommandoen tog for lang tid. Tjek for uendelige løkker.",timedOut:!0,unavailable:!1}),this.restartWorker()},c);this.pending={id:s,timer:b,onOutput:u.onOutput,resolve:_},h.postMessage({type:"run",id:s,code:_0(i),runtimeUrl:Hp})})}reset(){this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),this.restartWorker()}dispose(){var i;this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),(i=this.worker)==null||i.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const i=new Worker(new URL(""+new URL("offlineMicroPython.worker-CDShyJ6y.js",import.meta.url).href,import.meta.url));return i.onmessage=u=>this.handleMessage(u.data),i.onerror=u=>{this.finish({ok:!1,output:"",error:u.message||"Browser-MicroPython-terminalen fejlede i browser-worker.",timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=i,i}handleMessage(i){var s;const u=this.pending;if(!(!u||i.id!==u.id||i.type==="ready")){if(i.type==="stdout"){(s=u.onOutput)==null||s.call(u,i.text);return}if(i.type==="unavailable"){this.finish({ok:!1,output:"",error:i.error,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:i.ok,output:i.output,error:i.error,timedOut:!1,unavailable:!1})}}finish(i){const u=this.pending;u&&(window.clearTimeout(u.timer),this.pending=null,u.resolve(i))}restartWorker(){var i;(i=this.worker)==null||i.terminate(),this.worker=null}}async function p0(o,i={}){const u=typeof i=="number"?i:i.timeoutMs??Up,s=typeof i=="number"?void 0:i.onOutput,c=typeof i=="number"?void 0:i.signal,h=ef(o);if(h.some(v=>v.level==="error"))return{ok:!1,output:"",error:"",issues:h,timedOut:!1,unavailable:!1};const _=++m0,b=new Worker(new URL(""+new URL("offlineMicroPython.worker-CDShyJ6y.js",import.meta.url).href,import.meta.url));return new Promise(v=>{let y=!1;const E=()=>{k({ok:!1,output:"",error:"",issues:h,timedOut:!1,unavailable:!1})},k=F=>{y||(y=!0,window.clearTimeout(j),c==null||c.removeEventListener("abort",E),b.terminate(),v(F))};if(c!=null&&c.aborted){E();return}c==null||c.addEventListener("abort",E,{once:!0});const j=window.setTimeout(()=>{k({ok:!1,output:"",error:"Offline MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:h,timedOut:!0,unavailable:!1})},u);b.onmessage=F=>{const Q=F.data;if(!(Q.id!==_||Q.type==="ready")){if(Q.type==="stdout"){s==null||s(Q.text);return}if(Q.type==="unavailable"){k({ok:!1,output:"",error:Q.error,issues:h,timedOut:!1,unavailable:!0});return}k({ok:Q.ok,output:Q.output,error:Q.error,issues:h,timedOut:!1,unavailable:!1})}},b.onerror=F=>{k({ok:!1,output:"",error:F.message||"Offline MicroPython fejlede i browser-worker.",issues:h,timedOut:!1,unavailable:!1})},b.postMessage({type:"run",id:_,code:o,runtimeUrl:Hp})})}function _0(o){const i=JSON.stringify(o);return["try:",`    __pico_repl_value = eval(${i})`,"    if __pico_repl_value is not None:","        print(repr(__pico_repl_value))","except SyntaxError:",`    exec(${i})`,"finally:","    try:","        del __pico_repl_value","    except Exception:","        pass"].join(`
`)}function ef(o){const i=[],u=new Blob([o]).size;u>pp&&i.push({level:"error",text:`Koden er ${u} bytes. Offline MicroPython kører kun små programmer op til ${pp} bytes.`});const s=o.split(/\r?\n/);for(let c=0;c<s.length;c+=1){const h=c+1,_=nf(s[c]).trim();if(!_)continue;const b=g0(_);b&&d0.has(b)&&i.push({level:"error",line:h,text:`${b} virker kun på Picoen. Forbind en Pico for at køre denne kode.`});const v=_.match(/\brange\(\s*(-?\d+)\s*(?:,\s*(-?\d+)\s*)?(?:,\s*(-?\d+)\s*)?\)/);v&&b0(v)>_p&&i.push({level:"error",line:h,text:`range(...) er for stor til offline kørsel. Brug højst ${_p} gentagelser.`})}for(const c of y0(s))i.push({level:"warning",text:`Funktionen ${c} ser rekursiv ud. Hvis den ikke stopper, afbryder offline MicroPython efter få sekunder.`});return i}function nf(o){let i=null;for(let u=0;u<o.length;u+=1){const s=o[u];if((s==='"'||s==="'")&&o[u-1]!=="\\"&&(i=i===s?null:i??s),s==="#"&&!i)return o.slice(0,u)}return o}function g0(o){const i=o.match(/^import\s+([A-Za-z_]\w*)/);if(i)return i[1];const u=o.match(/^from\s+([A-Za-z_]\w*)\s+import\b/);return(u==null?void 0:u[1])??null}function gp(o){const i=o.match(/^\s*/);return(i==null?void 0:i[0].replace(/\t/g,"    ").length)??0}function b0(o){const i=Number(o[1]),u=o[2]===void 0?void 0:Number(o[2]),s=o[3]===void 0?1:Number(o[3]);if(s===0)return Number.POSITIVE_INFINITY;const _=(u===void 0?i:u)-(u===void 0?0:i);return _>0&&s<0||_<0&&s>0?0:Math.ceil(Math.abs(_/s))}function y0(o){const i=new Set;for(let u=0;u<o.length;u+=1){const s=nf(o[u]).trim().match(/^def\s+([A-Za-z_]\w*)\s*\(/);if(!s)continue;const c=s[1],h=gp(o[u]);for(let _=u+1;_<o.length;_+=1){if(!o[_].trim())continue;if(gp(o[_])<=h)break;if(new RegExp(`\\b${c}\\s*\\(`).test(nf(o[_]))){i.add(c);break}}}return[...i]}const v0=/^(for|if|while|def|class|elif|else|try|except|finally|with)\b/;function x0(o,i){var E;const u=o.trim(),s=i.split(/\r?\n/),c=S0(u),h=c?s[c-1]??"":"",_=E0(s,c),b=u.split(/\r?\n/).filter(Boolean).at(-1)??"";if(/KeyboardInterrupt/.test(b))return{simple:"Programmet blev stoppet.",technical:u,line:c};if(/MemoryError/.test(b))return{simple:`Picoen eller browserens MicroPython løb tør for hukommelse${c?` omkring linje ${c}`:""}.`,technical:u,line:c};if(/RecursionError/.test(b))return{simple:`En funktion kalder sig selv for mange gange${c?` omkring linje ${c}`:""}.`,technical:u,line:c};const v=b.match(/UnboundLocalError:\s+local variable ['"](.+?)['"]/);if(v)return{simple:`Variablen ${v[1]} bruges inde i en funktion, før den har fået en værdi${c?` på linje ${c}`:""}.`,technical:u,line:c};const y=b.match(/NameError:\s+name ['"](.+?)['"] (?:isn't|is not) defined/);if(y)return{simple:T0(h,y[1])?`Teksten ${y[1]} mangler måske citationstegn${c?` på linje ${c}`:""}.`:`Python kender ikke navnet ${y[1]}${c?` på linje ${c}`:""}.`,technical:u,line:c};if(/ZeroDivisionError/.test(b))return{simple:`Kan ikke dividere med 0${c?` på linje ${c}`:""}.`,technical:u,line:c};if(/IndentationError:\s+unexpected indent/.test(b))return{simple:`Der er for meget indrykning${c?` på linje ${c}`:""}.`,technical:u,line:c};if(/IndentationError/.test(b))return{simple:`Mangler indrykning${c?` på linje ${c}`:""}.`,technical:u,line:c};if(/ImportError|ModuleNotFoundError/.test(b)){const k=(E=b.match(/['"](.+?)['"]/))==null?void 0:E[1];return{simple:`Python kan ikke finde modulet${k?` ${k}`:""}.`,technical:u,line:c}}if(/OSError/.test(b))return/ENOENT|No such file|Errno\s+2/.test(b)?{simple:`Python kan ikke finde filen${c?` på linje ${c}`:""}.`,technical:u,line:c}:/EACCES|permission|denied/i.test(b)?{simple:`Python har ikke adgang til filen eller enheden${c?` på linje ${c}`:""}.`,technical:u,line:c}:{simple:`Der opstod en fejl med en fil eller en enhed${c?` omkring linje ${c}`:""}.`,technical:u,line:c};if(/SyntaxError/.test(b)){if(/invalid syntax/.test(b)&&_.text.trim().endsWith(","))return{simple:`Linje ${_.line??c} slutter med komma. Tjek om der mangler noget efter kommaet.`,technical:u,line:_.line??c};const k=tf(h,c)??tf(_.text,_.line)??w0(s,c);return k?{simple:`Mangler måske : efter linje ${k.line}.`,technical:u,line:k.line}:c&&_.text.trim().endsWith(":")&&h.trim()&&!/^\s+/.test(h)?{simple:`Mangler måske indrykning på linje ${c}.`,technical:u,line:c}:k0(h)?{simple:`Tekst mangler måske citationstegn${c?` på linje ${c}`:""}.`,technical:u,line:c}:N0(h)?{simple:`Tekst mangler måske et afsluttende citationstegn${c?` på linje ${c}`:""}.`,technical:u,line:c}:R0(h)?{simple:`Mangler måske en afsluttende parentes${c?` på linje ${c}`:""}.`,technical:u,line:c}:M0(h)?{simple:`Der er måske en parentes for meget${c?` på linje ${c}`:""}.`,technical:u,line:c}:{simple:`Python fandt en syntaksfejl${c?` omkring linje ${c}`:""}.`,technical:u,line:c}}return/TypeError/.test(b)?/takes .* positional arguments? but .* given/.test(b)||/function takes/.test(b)?{simple:`En funktion får for mange eller for få værdier${c?` på linje ${c}`:""}.`,technical:u,line:c}:/unsupported operand type/.test(b)?{simple:`To værdier kan ikke bruges sammen på den måde${c?` på linje ${c}`:""}.`,technical:u,line:c}:/not callable/.test(b)?{simple:`Der bliver brugt parenteser efter noget, som ikke er en funktion${c?` på linje ${c}`:""}.`,technical:u,line:c}:{simple:`En værdi har den forkerte type${c?` på linje ${c}`:""}.`,technical:u,line:c}:/IndexError/.test(b)?{simple:`Listen har ikke et element på den plads${c?` på linje ${c}`:""}.`,technical:u,line:c}:/KeyError/.test(b)?{simple:`Ordbogen mangler den nøgle${c?` på linje ${c}`:""}.`,technical:u,line:c}:/AttributeError/.test(b)?{simple:`Den ting har ikke den kommando${c?` på linje ${c}`:""}.`,technical:u,line:c}:/ValueError/.test(b)?/invalid literal for int/.test(b)?{simple:`Teksten kan ikke laves om til et heltal${c?` på linje ${c}`:""}.`,technical:u,line:c}:{simple:`Værdien passer ikke her${c?` på linje ${c}`:""}.`,technical:u,line:c}:{simple:`Python fandt en fejl${c?` omkring linje ${c}`:""}.`,technical:u,line:c}}function S0(o){var c;const u=(c=[...o.matchAll(/line\s+(\d+)/g)].at(-1))==null?void 0:c[1];if(!u)return;const s=parseInt(u,10);return Number.isFinite(s)&&s>0?s:void 0}function E0(o,i){if(!i)return{text:""};for(let u=i-2;u>=0;u-=1){const s=o[u]??"";if(s.trim())return{line:u+1,text:s}}return{text:""}}function tf(o,i){if(!i)return null;const u=o.trim();return!v0.test(u)||u.endsWith(":")?null:{line:i}}function w0(o,i){const u=i?Math.min(o.length,i):o.length,s=Math.max(0,u-4);for(let c=u-1;c>=s;c-=1){const h=tf(o[c]??"",c+1);if(h)return h}return null}function N0(o){const i=(o.match(/'/g)??[]).length,u=(o.match(/"/g)??[]).length;return i%2===1||u%2===1}function k0(o){var s,c;const u=(c=(s=o.trim().match(/^print\((.+)\)$/))==null?void 0:s[1])==null?void 0:c.trim();return!u||/['"]/.test(u)?!1:/\s/.test(u)&&/[a-zA-ZæøåÆØÅ]/.test(u)}function T0(o,i){const u=o.trim();return!!i&&/[A-Za-zæøåÆØÅ]/.test(i)&&(u.startsWith("print(")||u.includes(`= ${i}`))}function R0(o){return Gp(o)>0}function M0(o){return Gp(o)<0}function Gp(o){let i=0,u=null;for(let s=0;s<o.length;s+=1){const c=o[s];if((c==='"'||c==="'")&&o[s-1]!=="\\"){u=u===c?null:u??c;continue}u||((c==="("||c==="["||c==="{")&&(i+=1),(c===")"||c==="]"||c==="}")&&(i-=1))}return i}const lf="/min_kode.py",Vp=`print('Hej fra Pico Kontrol Panel')
`,bp=0,Gi="Backup-filnavne er reserveret til versionshistorik. Vælg et andet navn.";function rt(o,i){return`${o}:${i}`}function A0(){const o=J(m=>m.toggleSideMenu),i=J(m=>m.askConfirm),u=J(m=>m.picoIdeOrigin),s=J(m=>m.active),c=J(m=>m.isBleConnected),h=J(m=>m.bleListFiles),_=J(m=>m.bleReadText),b=J(m=>m.bleWriteText),v=J(m=>m.bleDeleteFile),y=J(m=>m.bleRestartAndReconnect),[E,k]=V.useState(!1),[j,F]=V.useState(!1),[Q,le]=V.useState([]),[U,H]=V.useState(!1),[pe,oe]=V.useState([]),[xe,fe]=V.useState(null),[Ne,ee]=V.useState(()=>Zu(Vu())),[W,be]=V.useState(lf),[_e,ve]=V.useState("local"),[ae,Ve]=V.useState(()=>{var m;return((m=Zu(Vu()).find(g=>g.path===lf))==null?void 0:m.content)??Vp}),[De,Ze]=V.useState([]),[O,Y]=V.useState(!1),[ie,Ee]=V.useState(""),[de,w]=V.useState(""),[z,P]=V.useState(null),[D,I]=V.useState(!1),[Z,K]=V.useState(null),[Ie,Le]=V.useState(!1),[Et,Zl]=V.useState({}),[La,Or]=V.useState(!1),[ml,Cr]=V.useState(0),[hl,No]=V.useState(()=>{var m,g;return((m=Ql.find(x=>x.board==="Raspberry Pi Pico W"))==null?void 0:m.board)??((g=Ql[0])==null?void 0:g.board)??""}),[Pl,zr]=V.useState(()=>{var m,g;return((m=Ql.find(x=>x.board==="Raspberry Pi Pico W"))==null?void 0:m.version)??((g=Ql[0])==null?void 0:g.version)??""}),[Ua,Ht]=V.useState(!1),[Ha,Ki]=V.useState({top:0,left:0}),[Tn,Br]=V.useState(!1),[Lr,Ga]=V.useState(!1),[Wl,it]=V.useState(!0),[st,pl]=V.useState(""),[Ur,Jl]=V.useState([]),[pn,$n]=V.useState(null),[vn,_l]=V.useState(!1),[gl,bl]=V.useState({}),[At,Dn]=V.useState({}),[$e,xn]=V.useState(null),[on,jn]=V.useState(null),[ko,Va]=V.useState(""),[Dt,er]=V.useState(()=>Xh().clearTerminalOnRun),[Gt,Ii]=V.useState(()=>Xh().simplifiedErrors),[Hr,Fi]=V.useState(()=>typeof window<"u"&&window.innerWidth<bp),yl=V.useRef(null),jt=V.useRef(null),cn=V.useRef(null),Ya=V.useRef(null),Kn=V.useRef(null),ln=V.useRef(null),un=V.useRef(null),ot=V.useRef(!1),Ot=V.useRef(!1),Gr=V.useRef(!1),nr=V.useRef(null),Vr=V.useRef(null),Bn=V.useRef(null),Vt=V.useRef(null),Ln=V.useRef(0),In=V.useRef(null),ct=V.useRef(null),Yt=V.useRef(null),Pe=V.useRef(null),qt=c0(),he=u==="control"&&!!s&&c(),wt=he?(s==null?void 0:s.deviceID)??"ble":null,vl=Math.max(1,ae.split(`
`).length),To=new Blob([ae]).size,Qi=_e==="pico"?"Picoen":"browseren",Zi=V.useMemo(()=>[...new Set(Ql.map(m=>m.board))],[]),tr=V.useMemo(()=>Ql.filter(m=>m.board===hl),[hl]),Nt=Ql.find(m=>m.board===hl&&m.version===Pl)??tr[0]??Ql[0],kt=_e==="pico",Fn=kt?Tn:Lr,Un=vn||Fn,qa=kt?"Pico MicroPython":"Browser-MicroPython",Xa=V.useMemo(()=>{const m=new u0({onLine:g=>{if(Ot.current)return;const x=g.trimEnd();if(Gr.current&&x.trim()){$("info",x);return}ot.current&&x.trim()&&!x.includes(">>>")&&!x.includes("raw REPL")&&$("info",x)},onLog:$,onDisconnect:()=>{k(!1),Br(!1),_l(!1),ot.current=!1,Gr.current=!1,Yr(),$("warning","USB-forbindelse lukket.")}});return yl.current=m,m},[]);function $(m,g){le(x=>[...x.slice(-140),{level:m,text:g}])}function lr(m,g=ae,x="error"){const L=x0(m,g);le(B=>[...B.slice(-140),{level:x,text:L.simple,technical:L.technical}])}function Je(m,g,x=_e){be(m),ve(x),Ve(g),Dn(L=>({...L,[rt(x,m)]:g}))}function Pi(m,g="pico"){be(m),ve(g),Ve(""),xn(null),Ki({top:0,left:0})}function gn(m,g=(x=>(x=Kn.current)==null?void 0:x.selectionStart)()??m.length){Ve(m),Dn(L=>({...L,[rt(_e,W)]:m})),Va(""),fr(m,g)}function rr(m,g=_e){Dn(x=>{const L=rt(g,m);if(!(L in x))return x;const B={...x};return delete B[L],B})}function Wi(){return gl[W]===ae}function Rn(m,g){bl(x=>({...x,[m]:g}))}function Xt(m,g){Rn(m,g),Dn(x=>({...x,[rt("pico",m)]:g})),_e==="pico"&&W===m&&Ve(g)}function Yr(){oe([]),Ze([]),bl({}),Dn({}),xn(null),be(m=>{const g=Zu(Vu());if(g.find(B=>B.path===m))return m;const L=g[0];return ve("local"),Ve(L.content),L.path})}function Sn(m){ut(),K({value:100,label:m}),Pe.current=window.setTimeout(()=>{Pe.current=null,K(null)},900)}function ut(){Pe.current!==null&&(window.clearTimeout(Pe.current),Pe.current=null)}function Ro(){return Z?f.jsxs("div",{className:"ide-task-progress",role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":Math.round(Z.value),children:[f.jsxs("div",{children:[f.jsx("span",{children:Z.label}),f.jsxs("strong",{children:[Math.round(Z.value),"%"]}),Z.cancellable&&f.jsx("button",{className:"ide-task-cancel",type:"button",onClick:Ji,"aria-label":"Stop handling",title:"Stop",children:f.jsx(zn,{name:"delete",size:18})})]}),f.jsx("i",{style:{width:`${Math.max(2,Math.min(100,Z.value))}%`}})]}):null}function Ji(){Bn.current&&xl("Stopper læsning...",!0,!0)}function xl(m="Stopper læsning...",g=!1,x=!1){var L;ut(),ct.current=null,Ln.current+=1,(L=Bn.current)==null||L.abort(),Bn.current=null,In.current=null,fe(null),H(!1),K(g?{value:(Z==null?void 0:Z.value)??0,label:m,cancellable:!1}:null),x&&$("warning","Stopper BLE-læsning efter den aktuelle datapakke.")}function $a(m){var g;if(!(In.current===m||ct.current===m)){if(ct.current=m,Vt.current){Ln.current+=1,(g=Bn.current)==null||g.abort(),Bn.current=null,In.current=null,Pi(m),fe(m),H(!0),ut(),K({value:2,label:`Skifter til ${je(m)}...`,cancellable:!0});return}es()}}function es(){if(Vt.current)return;const m=ct.current;if(!m)return;ct.current=null;const g=Ln.current+1;Ln.current=g;const x=new AbortController;Bn.current=x,In.current=m,Pi(m),fe(m),H(!0),ut(),K({value:12,label:`Indlæser ${je(m)}...`,cancellable:!0});const L=(async()=>{try{const B=await _(m,(te,ge)=>{Ln.current===g&&K({value:te,label:ge,cancellable:!0})},x.signal);if(x.signal.aborted||Ln.current!==g)return;Je(m,B,"pico"),Rn(m,B),Sn("Fil indlæst")}catch(B){if(Ln.current!==g)return;O0(B)||x.signal.aborted?$("info",`Stoppede læsning af ${je(m)}.`):(K(null),$("error",B instanceof Error?B.message:"BLE læsning fejlede."))}})();Vt.current=L,L.finally(()=>{if(Vt.current!==L)return;Vt.current=null,Bn.current===x&&(Bn.current=null),In.current===m&&(In.current=null),!!ct.current||(fe(null),H(!1),x.signal.aborted&&K(null)),es()})}async function qr(m){const g=Ot.current;Ot.current=!0;try{return await m()}finally{Ot.current=g}}V.useEffect(()=>{if(!Wl)return;const m=ln.current;m&&(m.scrollTop=m.scrollHeight)},[Q,Wl]),V.useEffect(()=>{zg({clearTerminalOnRun:Dt,simplifiedErrors:Gt})},[Dt,Gt]),V.useEffect(()=>{var m;tr.some(g=>g.version===Pl)||zr(((m=tr[0])==null?void 0:m.version)??"")},[tr,Pl]),V.useEffect(()=>{const m=()=>Fi(window.innerWidth<bp);return m(),window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[]),V.useEffect(()=>{const m=()=>{const g=yl.current;jt.current=null,cn.current=null,yl.current=null,g==null||g.disconnect().catch(()=>{})};return window.addEventListener("pagehide",m),()=>{var g;ut(),(g=nr.current)==null||g.dispose(),nr.current=null,window.removeEventListener("pagehide",m),m()}},[]),V.useEffect(()=>{const m=g=>{!(g.ctrlKey||g.metaKey)||g.key.toLowerCase()!=="s"||(g.preventDefault(),!U&&W.trim()&&!Hr&&!D&&!z&&!O&&Kr())};return window.addEventListener("keydown",m),()=>window.removeEventListener("keydown",m)},[_e,he,U,E,ae,W,Hr,D,z,O]);function Sl(m,g,x){ee(L=>{const B=H0(L,m,g,x);return Yu(B),B})}const ft=q0(pe,Ne,At,E||he);V.useEffect(()=>{he&&rn()},[he]),V.useEffect(()=>{const m=Yt.current;m&&m!==wt&&Yr(),Yt.current=wt},[wt]);async function Ka(){if(qt.supported){F(!0);try{await Xa.requestAndConnect();const m=new qb(Xa);jt.current=m,cn.current=new Qb(m),k(!0),Cr(0),await m.interrupt(),await Ia(m),$("success","Sendte stop-signal til Pico-terminalen."),await Xr(cn.current),await dt(cn.current)}catch(m){$("error",m instanceof Error?m.message:"USB-forbindelse mislykkedes.");try{await Xa.disconnect()}catch(g){$("error",g instanceof Error?`USB-porten kunne ikke lukkes: ${g.message}`:"USB-porten kunne ikke lukkes.");return}Cr(g=>{const x=g+1;return x>=3&&($("info","USB-forbindelsen er mislykkedes flere gange. Hvis Picoen er i BOOTSEL eller mangler MicroPython, kan du bruge MicroPython-download."),Or(!0)),x}),k(!1)}finally{F(!1)}}}async function Ia(m){const g=await m.exec(`import sys
print(sys.implementation.name)
`,4e3);if(g.error||!g.output.toLowerCase().includes("micropython"))throw new Error("MicroPython blev ikke fundet på Picoen.")}async function El(){var m;try{await((m=yl.current)==null?void 0:m.disconnect()),jt.current=null,cn.current=null,k(!1),Yr()}catch(g){$("error",g instanceof Error?`USB-porten kunne ikke lukkes: ${g.message}`:"USB-porten kunne ikke lukkes.")}}async function On(m){const g=cn.current;if(g){H(!0),Ot.current=!0;try{await m(g)}catch(x){K(null),$("error",x instanceof Error?x.message:"USB filhandling fejlede.")}finally{Ot.current=!1,H(!1)}}}async function rn(m=!0){if(he){H(!0);try{const g=await h();oe(g),m&&$("success",`Indlæste ${g.length} filer fra Pico via Bluetooth.`)}catch(g){$("error",g instanceof Error?g.message:"BLE filhandling fejlede.")}finally{H(!1)}return}await Xr(cn.current,m)}async function Xr(m,g=!0){if(m){H(!0);try{const x=await qr(()=>m.list("/"));oe(x),g&&$("success",`Indlæste ${x.length} filer fra Pico.`)}catch(x){$("error",x instanceof Error?x.message:"USB filhandling fejlede.")}finally{H(!1)}}}async function $t(){if(he){H(!0),K({value:4,label:"Tjekker biblioteker på Pico via Bluetooth..."});try{const m=await wl((g,x)=>K({value:g,label:x}));Ze(m),Sn("Fil-tjek færdigt")}catch(m){K(null),$("error",m instanceof Error?m.message:"BLE runtime check fejlede.")}finally{H(!1)}return}await dt(cn.current)}async function wl(m){const g=[],x=Hi.filter(B=>B.kind==="library"&&!Ar(B));let L=0;for(const B of Hi){if(B.kind==="program"){g.push({...B,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}if(Ar(B)){g.push({...B,status:"unknown",detail:"Opdateres via USB"});continue}try{const te=L/Math.max(1,x.length)*100,ge=100/Math.max(1,x.length);$("info",`Tjekker ${B.label} på Pico via Bluetooth...`),m==null||m(Math.min(95,te),`Tjekker ${B.label} på Pico...`);const ze=await _(B.path,(Qn,It)=>{m==null||m(Math.min(95,te+Qn/100*ge),`${B.label}: ${It}`)}),en=fo(ze)===fo(B.content);g.push({...B,status:en?"ok":"outdated",detail:en?"Matcher appens version":"Kan installeres via Bluetooth"})}catch{g.push({...B,status:"missing",detail:"Mangler på Pico"})}finally{L+=1}}return m==null||m(100,"Fil-tjek færdigt"),g}async function dt(m){if(m){H(!0);try{const g=await qr(()=>$r(m)),x=g;Ze(x)}catch(g){$("error",g instanceof Error?g.message:"Runtime check fejlede.")}finally{H(!1)}}}async function $r(m){if(!m)return[];const g=[];for(const x of Hi){if(x.kind==="program"){g.push({...x,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}try{const L=await m.readText(x.path),B=fo(L)===fo(x.content);g.push({...x,status:B?"ok":"outdated",detail:B?"Matcher appens version":"Matcher ikke appens version"})}catch{g.push({...x,status:"missing",detail:"Mangler på Pico"})}}return g}async function ar(m=W){if(he){$a(m);return}fe(m),await On(async g=>{K({value:12,label:`Indlæser ${je(m)}...`});const x=await g.readText(m);Je(m,x,"pico"),Rn(m,x),Sn("Fil indlæst")}),fe(null)}function Ct(){I(!0)}async function Kr(){if(_e==="pico"){if(!E&&!he){$("error","Ingen Pico-forbindelse. Brug Gem for at vælge en anden placering.");return}await Ir();return}ir()}function ir(){if(Aa(W)){$("error",Gi);return}Sl(W,ae,!1),ve("local"),Dn(m=>({...m,[rt("local",W)]:ae})),I(!1),$("success",`Gemte ${je(W)} lokalt.`)}async function Ir(){if(I(!1),Aa(W))return K(null),$("error",Gi),!1;if(K({value:0,label:"Starter gemning..."}),he){H(!0);try{return await b(W,ae,(g,x)=>K({value:g,label:x})),Rn(W,ae),ve("pico"),Dn(g=>({...g,[rt("pico",W)]:ae})),Sn("Gemt på Pico via Bluetooth"),$("success",`Gemte ${je(W)} på Pico via Bluetooth.`),mo(W)&&(Ht(!0),$("warning","main.py er gemt. Genstart Picoen for at køre den nye version.")),await rn(!1),!0}catch(g){return K(null),$("error",g instanceof Error?g.message:"BLE gem fejlede."),!1}finally{H(!1)}}if(!cn.current)return K(null),!1;let m=!1;return await On(async g=>{ur(W,"pico")?await g.replaceTextSafely(W,ae,(x,L)=>K({value:x,label:L})):await g.writeText(W,ae,(x,L)=>K({value:x,label:L})),Rn(W,ae),ve("pico"),Dn(x=>({...x,[rt("pico",W)]:ae})),Sn("Gemt på Pico via USB"),$("success",`Gemte ${W}.`),await rn(),await $t(),m=!0}),m}function Fr(){const m=new Blob([ae],{type:"text/plain;charset=utf-8"}),g=URL.createObjectURL(m),x=document.createElement("a");x.href=g,x.download=je(W),x.click(),URL.revokeObjectURL(g),I(!1),$("success",`Downloadede ${je(W)}.`)}async function sr(m){H(!0),Ht(!1),K({value:10,label:"Genstarter Pico..."});try{await y(m)?(Sn("Pico genforbundet"),$("success",m==="control"?"Pico genforbundet. Åbner kontrolpanelet.":"Pico genforbundet til Kodeværkstedet."),m==="ide"&&await rn()):(K(null),$("warning","Automatisk genforbindelse lykkedes ikke. Vælg Picoen fra dashboardet."))}catch(g){K(null),$("error",g instanceof Error?g.message:"Genstart/genforbindelse mislykkedes.")}finally{H(!1)}}function Fa(m){var te;const g=m??{path:W,source:_e},x=g.source==="pico"?"Pico":"browser",L=g.source==="pico"?(m==null?void 0:m.versions.length)??((te=rf(pe).get(g.path))==null?void 0:te.length)??0:0,B=L>0?` Det sletter også filens versionshistorik (${L} gemte versioner).`:"";P(null),i({title:"Slet fil",message:`Vil du slette ${je(g.path)} fra ${x}?${B}`,confirmLabel:"Slet",onConfirm:()=>{Mn(g)}})}async function Mn(m){const g=m.path,x=m.source,L=g===W&&x===_e;if(x==="local"){const ge=Ne.filter(ze=>ze.path!==g);ee(ge),Yu(ge),L&&Je(g,"","local"),rr(g,"local"),$("warning",`Slettede ${je(g)} fra browseren.`);return}const B=rf(pe).get(g)??[],te=[g,...B.map(ge=>ge.path)];if(he){H(!0);try{for(const ze of te)await v(ze);bl(ze=>{const en={...ze};for(const Qn of te)delete en[Qn];return en}),L&&Je(g,"","pico");for(const ze of te)rr(ze,"pico");const ge=B.length>0?` og ${B.length} gemte versioner`:"";$("warning",`Slettede ${je(g)}${ge} på Pico via Bluetooth.`),await rn()}catch(ge){$("error",ge instanceof Error?ge.message:"BLE sletning fejlede.")}finally{H(!1)}return}if(!cn.current){$("error","Ingen Pico-forbindelse. Kan ikke slette Pico-filen.");return}await On(async ge=>{for(const en of te)await ge.delete(en);bl(en=>{const Qn={...en};for(const It of te)delete Qn[It];return Qn});const ze=B.length>0?` og ${B.length} gemte versioner`:"";$("warning",`Slettede ${g}${ze}.`),L&&Je(g,"","pico");for(const en of te)rr(en,"pico");await rn(),await $t()})}async function Kt(m){if(!m)return;const g=D0(m.name);if(!g){$("error","Kun .py, .txt, .json og .csv kan importeres.");return}if(Aa(g)){$("error",Gi);return}if(m.size>128*1024){$("error","Filen er for stor til Pico-værkstedet.");return}const x=await m.text();if(_e==="local"){Sl(g,x,!0),Je(g,x,"local"),$("success",`Importerede ${je(g)} i browseren.`);return}if(!E&&!he){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(he&&Ar({path:g})){$("error","BLEPeripheral.py kan ikke importeres over Bluetooth, mens den holder forbindelsen i gang. Brug USB i stedet.");return}if(K({value:0,label:"Uploader fil til Pico..."}),he){H(!0);try{await b(g,x,(B,te)=>K({value:B,label:te})),Rn(g,x),Je(g,x,"pico"),Sn("Fil uploadet til Pico"),$("success",`Importerede ${je(g)} på Pico via Bluetooth.`),await rn()}catch(B){K(null),$("error",B instanceof Error?B.message:"Kunne ikke importere filen til Pico.")}finally{H(!1)}return}if(!cn.current){K(null),$("error","Ingen Pico-forbindelse. Kan ikke importere filen til Pico.");return}await On(async B=>{ur(g,"pico")?await B.replaceTextSafely(g,x,(te,ge)=>K({value:te,label:ge})):await B.writeText(g,x,(te,ge)=>K({value:te,label:ge})),Rn(g,x),Je(g,x,"pico"),Sn("Fil uploadet til Pico"),$("success",`Importerede ${je(g)} på Pico.`),await rn(),await $t()})}async function Qr(){Ee(""),Y(!0)}function or(){const m=yp(ie);if(!m)return;if(Aa(m)){$("error",Gi);return}const g=_e;if(ur(m,g)){$("error",`Der findes allerede en fil med navnet ${je(m)} i ${g==="pico"?"Pico":"browseren"}.`);return}if(g==="local"){Sl(m,"",!1),Je(m,"","local"),Y(!1),$("success",`Oprettede ${je(m)} i browseren.`);return}Mo(m)}async function Mo(m){if(!E&&!he){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(Y(!1),K({value:0,label:"Opretter fil på Pico..."}),he){H(!0);try{await b(m,"",(g,x)=>K({value:g,label:x})),Rn(m,""),Je(m,"","pico"),Sn("Fil oprettet på Pico"),$("success",`Oprettede ${je(m)} på Pico via Bluetooth.`),await rn()}catch(g){K(null),$("error",g instanceof Error?g.message:"Kunne ikke oprette fil på Pico.")}finally{H(!1)}return}if(!cn.current){K(null),$("error","Ingen Pico-forbindelse. Kan ikke oprette Pico-filen.");return}await On(async g=>{await g.writeText(m,"",(x,L)=>K({value:x,label:L})),Rn(m,""),Je(m,"","pico"),Sn("Fil oprettet på Pico"),$("success",`Oprettede ${je(m)} på Pico.`),await rn()})}function Qa(m){m.type==="file"&&(P(m),w(j0(m.path)))}async function Za(m){if(!z||z.source!=="pico")return;const g=z.path;if(P(null),K({value:0,label:"Gendanner version..."}),he){H(!0);try{const x=await _(m.path);await b(g,x,(L,B)=>K({value:L,label:B})),Rn(g,x),Je(g,x,"pico"),Sn("Version gendannet"),await rn(!1)}catch(x){K(null),$("error",x instanceof Error?x.message:"Kunne ikke gendanne versionen.")}finally{H(!1)}return}cn.current&&await On(async x=>{await x.replaceTextSafely(g,await x.readText(m.path),(B,te)=>K({value:B,label:te}));const L=await x.readText(g);Rn(g,L),Je(g,L,"pico"),Sn("Version gendannet"),await rn()})}function cr(m){i({title:"Slet version",message:`Vil du slette ${je(m.path)} fra Pico?`,confirmLabel:"Slet",onConfirm:()=>{Zr(m)}})}async function Zr(m){if(he){H(!0);try{await v(m.path),await rn(!1),P(g=>g&&{...g,versions:g.versions.filter(x=>x.path!==m.path)})}catch(g){$("error",g instanceof Error?g.message:"Kunne ikke slette versionen.")}finally{H(!1)}return}cn.current&&await On(async g=>{await g.delete(m.path),await rn(!1),P(x=>x&&{...x,versions:x.versions.filter(L=>L.path!==m.path)})})}async function ns(){if(!z)return;const m=z,g=Fu(de,Vi(m.path));if(!g||g===m.path)return;if(Aa(g)){$("error",Gi);return}if(ur(g,m.source)){$("error",`Der findes allerede en fil med navnet ${je(g)}.`);return}const x=m.source==="local",L=m.source==="pico";if(he&&L&&(mo(m.path)||mo(g))){$("error","main.py kan redigeres over Bluetooth, men ikke omdøbes. Gem den som main.py.");return}H(!0);try{if(L)if(he){const B=gl[m.path]??await _(m.path);await b(g,B,(te,ge)=>K({value:te,label:ge})),await v(m.path),bl(te=>({...Np(te,m.path,g),[g]:B}))}else cn.current&&(await qr(()=>cn.current.rename(m.path,g)),bl(B=>Np(B,m.path,g)));x&&ee(B=>{const te=B.map(ge=>ge.path===m.path?{...ge,path:g,updatedAt:Date.now()}:ge);return Yu(te),te}),W===m.path&&_e===m.source&&be(g),Dn(B=>K0(B,m.source,m.path,g)),P(null),w(""),$("success",`Omdøbte ${je(m.path)} til ${je(g)}.`),L&&await rn()}catch(B){$("error",B instanceof Error?B.message:"Kunne ikke omdøbe filen.")}finally{K(null),H(!1)}}function ur(m,g){return g==="pico"?pe.some(x=>x.path===m):Ne.some(x=>x.path===m)}async function Ao(m){if(!ur(m,"pico"))return;const g=V0(m,pe),x=gl[m]??await _(m);await b(g,x)}function Do(m){if(m.type!=="file"){he&&xl(void 0,!1),be(m.path),ve(m.source);return}if(he&&Ar(m)){$("warning","BLEPeripheral.py holder Bluetooth-forbindelsen i gang og kan ikke åbnes her.");return}if(m.source==="local"){he&&xl(void 0,!1);const x=Ne.find(L=>L.path===m.path);Je(m.path,At[rt("local",m.path)]??(x==null?void 0:x.content)??"","local");return}const g=rt("pico",m.path);if(Object.prototype.hasOwnProperty.call(At,g)){he&&xl(void 0,!1),Je(m.path,At[g],"pico");return}if(Object.prototype.hasOwnProperty.call(gl,m.path)){he&&xl(void 0,!1),Je(m.path,gl[m.path],"pico");return}ar(m.path)}async function Pr(){if(!(!E&&!he)){H(!0),K({value:4,label:he?"Tjekker biblioteker på Pico via Bluetooth...":"Tjekker biblioteker på Pico..."}),$("info",he?"Tjekker om Picoens biblioteker er opdaterede via Bluetooth før installation...":"Tjekker om Picoens biblioteker er opdaterede før installation...");try{const m=De.length>0?De:he?await wl((x,L)=>K({value:x,label:L})):await qr(()=>$r(cn.current));Ze(m);const g={};m.forEach(x=>{g[x.id]=!1}),Zl(g),Le(!0),K(null)}catch(m){K(null),$("error",m instanceof Error?m.message:"Fil-tjek før installation fejlede.")}finally{H(!1)}}}async function jo(){if(Le(!1),he){H(!0);try{const g=(De.length>0?De:Hi.map(L=>({...L,status:"unknown",detail:"Ikke tjekket"}))).filter(L=>Et[L.id]&&!Ar(L));if(g.length===0){$("info","Ingen filer valgt til installation.");return}let x=null;K({value:0,label:"Starter installation..."});for(const[L,B]of g.entries()){$("info",`Installerer ${B.label} via Bluetooth...`);const te=L/g.length*100,ge=100/g.length;await Ao(B.path),await b(B.path,B.content,(ze,en)=>{K({value:Math.min(99,te+ze/100*ge),label:`${B.label}: ${en}`})}),Xt(B.path,B.content),$("success",`Installerede ${B.label}.`),B.kind==="library"&&(x=B),mo(B.path)&&Ht(!0)}Sn("Installation færdig"),await rn(!1),await $t(),x&&ts(x)}catch(m){K(null),$("error",m instanceof Error?m.message:"BLE installation fejlede.")}finally{H(!1)}return}await On(async m=>{const x=(De.length>0?De:Hi.map(B=>({...B,status:"unknown",detail:"Ikke tjekket"}))).filter(B=>Et[B.id]);if(x.length===0){$("info","Ingen filer valgt til installation.");return}let L=null;K({value:0,label:"Starter installation..."});for(const[B,te]of x.entries()){$("info",`Installerer ${te.label}...`);const ge=B/x.length*100,ze=100/x.length;await m.replaceTextSafely(te.path,te.content,(en,Qn)=>{K({value:Math.min(99,ge+en/100*ze),label:`${te.label}: ${Qn}`})},{createBackup:!0}),Xt(te.path,te.content),$("success",`Installerede ${te.label}.`),te.kind==="library"&&(L=te)}Sn("Installation færdig"),await rn(!1),await $t(),L&&ts(L)})}function ts(m){Je(m.path,m.content,"pico"),Rn(m.path,m.content),$("info",`Åbnede ${m.label} i editoren.`)}function Oo(m,g){Zl(x=>{if(m.kind!=="program")return{...x,[m.id]:g};const L={...x};for(const B of De)B.kind==="program"&&(L[B.id]=!1);return L[m.id]=g,L})}async function Co(){if(Uo(),he&&_e==="pico"){$("warning","Bluetooth holder forbindelsen åben, så koden kan ikke køres direkte her. Gem filen, og genstart Picoen for at køre den.");return}if(_e==="local"){await zo();return}const m=jt.current;if(!m){$("error",`${je(W)} er gemt på Picoen, men der er ingen USB-forbindelse til Pico-terminalen.`);return}if(W.endsWith(".py")){if(!Wi()&&($("info",`${je(W)} har ikke gemte ændringer. Gemmer på Picoen før kørsel...`),!await Ir())){$("error","Pico-forbindelsen blev afbrudt under gemning.");return}if(U)return;Br(!0),ot.current=!0,it(!0);try{await m.runFile(W),$("success",`Kører ${je(W)}. Brug Stop for at afbryde.`)}catch(g){Br(!1),ot.current=!1,$("error",g instanceof Error?g.message:"Kunne ikke starte koden.")}return}H(!0);try{const g=await m.exec(ae,2e4);g.output.trim()&&$("info",g.output),g.error.trim()&&lr(g.error,ae),!g.output.trim()&&!g.error.trim()&&$("success","Koden kørte uden output.")}catch(g){$("error",g instanceof Error?g.message:"Kunne ikke køre koden.")}finally{H(!1)}}async function zo(){const m=ef(ae);if(m.some(x=>x.level==="error")){for(const x of m){const L=x.line?`Linje ${x.line}: `:"";$(x.level==="error"?"error":"warning",`${L}${x.text}`)}return}const g=new AbortController;Vr.current=g,H(!0),Ga(!0),it(!0),$("info",E?"Starter offline MicroPython for browser-filen.":"Starter offline MicroPython. Forbind Pico med USB for at køre på selve Picoen.");try{const x=[],L=await p0(ae,{signal:g.signal,onOutput:ze=>{x.push(ze),$("info",ze)}});for(const ze of L.issues){const en=ze.line?`Linje ${ze.line}: `:"";$(ze.level==="error"?"error":"warning",`${en}${ze.text}`)}const B=[...x,L.output].filter(Boolean).join(`
`).trim(),te=L.output.trim();!L.error.trim()&&C0(B)?lr(B,ae):(te&&$("info",te),L.error.trim()&&lr(L.error,ae,L.unavailable?"warning":"error")),L.ok&&!B&&!L.error.trim()&&$("success","Offline MicroPython kørte uden output.")}finally{Vr.current=null,Ga(!1),H(!1)}}async function ls(){var g,x;if(Lr){(g=Vr.current)==null||g.abort(),$("warning","Stoppede offline MicroPython."),it(!0);return}if(!kt&&vn){(x=nr.current)==null||x.reset(),_l(!1),$("warning","Stoppede Browser-MicroPython-terminalen. Variablerne i browser-terminalen blev nulstillet."),it(!0);return}const m=jt.current;if(m)try{await m.stop(),$("warning","Stoppede koden på Pico.")}catch(L){$("error",L instanceof Error?L.message:"Kunne ikke stoppe koden.")}finally{Br(!1),ot.current=!1,it(!0)}}function Bo(){const m=ln.current;if(!m)return;const g=m.scrollHeight-m.scrollTop-m.clientHeight<12;it(g)}function Lo(){le([]),it(!0)}async function rs(){const m=st.trimEnd();if(!m.trim())return;if(Jl(x=>(x.at(-1)===m?x:[...x,m]).slice(-80)),$n(null),jn(null),Fn){$("warning",kt?"Tryk Stop, før du skriver i Pico-terminalen.":"Stop offline MicroPython, før du skriver i browser-terminalen.");return}if(!kt){const x=ef(m);if(x.some(B=>B.level==="error")){for(const B of x){const te=B.line?"Linje "+B.line+": ":"";$(B.level==="error"?"error":"warning",te+B.text)}return}const L=nr.current??new h0;nr.current=L,pl(""),_l(!0),it(!0),$("info",">>> "+m);try{let B=!1;const te=await L.send(m,{timeoutMs:15e3,onOutput:ze=>{B=!0,$("info",ze)}}),ge=te.output.trim();ge&&!B&&$("info",ge),te.error.trim()&&lr(te.error,m,te.unavailable?"warning":"error")}catch(B){$("error",B instanceof Error?B.message:"Browser-MicroPython-terminalen fejlede.")}finally{_l(!1)}return}if(he){$("warning","Terminalen bruger USB Serial. Bluetooth-forbindelsen kan vise filer, men kan ikke modtage frie terminalkommandoer.");return}const g=jt.current;if(!E||!g){$("warning","Forbind en microcontroller med USB for at skrive i MicroPython-terminalen.");return}pl(""),_l(!0),it(!0),Gr.current=!0,$("info",">>> "+m);try{await g.sendFriendlyLine(m)}catch(x){Gr.current=!1,$("error",x instanceof Error?x.message:"Kunne ikke sende kommando til MicroPython REPL.")}finally{_l(!1)}}function as(m,g,x){return x.length===0?null:f.jsxs("div",{className:"ide-install-group",children:[f.jsxs("div",{className:"ide-install-group-head",children:[f.jsx("h3",{children:m}),f.jsx("p",{children:g})]}),x.map(L=>{const B=he&&Ar(L);return f.jsxs("label",{className:`ide-install-row ${B?"disabled":""}`,children:[f.jsx("input",{type:"checkbox",checked:!!Et[L.id],disabled:B,onChange:te=>Oo(L,te.target.checked)}),f.jsxs("span",{children:[f.jsxs("strong",{children:[Pa(L),L.kind==="library"&&f.jsx("em",{className:`ide-install-status status-${L.status}`,children:B?"USB":Y0(L.status)})]}),f.jsx("small",{children:L.description})]})]},L.id)})]})}function Pa(m){return m.kind==="program"?m.label.replace(/\s*\(main\.py\)$/i,""):m.label}function Uo(){Dt&&le([]),it(!0)}function Ho(m,g){const x=m.indexOf(`
`,g);return x===-1?m.length:x}function fr(m,g){const x=xp(m,g);if(!x||x.query.length<1){xn(null);return}const L=x.query.toLowerCase(),B=vp.filter(ge=>ge.label.toLowerCase().startsWith(L)&&!Qu(ge,x.query)).slice(0,8),te=Sp(Kn.current,x.start);xn(B.length>0&&te?{items:B,selected:0,start:x.start,end:g,position:te}:null)}function dr(m,g){const x=xp(m,g);if(!x||x.query.length<1){jn(null);return}const L=x.query.toLowerCase(),B=vp.filter(ge=>ge.label.toLowerCase().startsWith(L)&&!Qu(ge,x.query)).slice(0,8),te=Sp(un.current,x.start);jn(B.length>0&&te?{items:B,selected:0,start:x.start,end:g,position:te}:null)}function is(m){const g=m.value.slice(m.selectionStart,m.selectionEnd);Va(B0(g)?g:"")}function Wa(m=$e==null?void 0:$e.items[$e.selected]){if(!m||!$e)return;const g=ae.slice(0,$e.start)+m.insert+ae.slice($e.end),x=$e.start+m.insert.length-(m.insert.endsWith("()")?1:0);Ve(g),Dn(L=>({...L,[rt(_e,W)]:g})),xn(null),window.requestAnimationFrame(()=>{const L=Kn.current;L&&(L.focus(),L.selectionStart=x,L.selectionEnd=x,fr(g,x))})}function ss(m=on==null?void 0:on.items[on.selected]){if(!m||!on)return;const g=st.slice(0,on.start)+m.insert+st.slice(on.end),x=on.start+m.insert.length-(m.insert.endsWith("()")?1:0);pl(g),jn(null),window.requestAnimationFrame(()=>{const L=un.current;L&&(L.focus(),L.selectionStart=x,L.selectionEnd=x,dr(g,x))})}function Go(m){var It;if((m.ctrlKey||m.metaKey)&&m.key.toLowerCase()==="s"){m.preventDefault(),!U&&W.trim()&&Kr();return}if($e){if(m.key==="ArrowDown"){m.preventDefault(),xn(Ue=>Ue&&{...Ue,selected:(Ue.selected+1)%Ue.items.length});return}if(m.key==="ArrowUp"){m.preventDefault(),xn(Ue=>Ue&&{...Ue,selected:(Ue.selected-1+Ue.items.length)%Ue.items.length});return}if(m.key==="Tab"){m.preventDefault(),Wa();return}if(m.key==="Enter"){if(!($e.items[$e.selected]&&Qu($e.items[$e.selected],ae.slice($e.start,$e.end)))){m.preventDefault(),Wa();return}xn(null)}if(m.key==="Escape"){m.preventDefault(),xn(null);return}}if(m.key==="Enter"){m.preventDefault();const Ue=m.currentTarget,Hn=Ue.selectionStart,Ja=Ue.selectionEnd,mr=ae.lastIndexOf(`
`,Hn-1)+1,Nl=ae.slice(mr,Hn),Wr=((It=Nl.match(/^[ \t]*/))==null?void 0:It[0])??"",Jr=Nl.trimEnd().endsWith(":")?"    ":"",Ft=`
${Wr}${Jr}`,Qt=ae.slice(0,Hn)+Ft+ae.slice(Ja),hr=Hn+Ft.length;gn(Qt,hr),window.requestAnimationFrame(()=>{Ue.selectionStart=hr,Ue.selectionEnd=hr});return}if(m.key!=="Tab")return;m.preventDefault();const g=m.currentTarget,x=g.selectionStart,L=g.selectionEnd,B="    ";if(m.shiftKey){const Ue=ae.lastIndexOf(`
`,x-1)+1,Hn=x===L?Ho(ae,x):L,Ja=ae.slice(Ue,Hn);let mr=0,Nl=0;const Wr=Ja.replace(/(^|\n)( {1,4}|\t)/g,(Ft,Qt,hr,ea)=>{const ei=hr.length;return Ue+ea<x&&(mr+=ei),Nl+=ei,Qt});if(Nl===0)return;const Jr=ae.slice(0,Ue)+Wr+ae.slice(Hn);gn(Jr,Math.max(Ue,x-mr)),window.requestAnimationFrame(()=>{g.selectionStart=Math.max(Ue,x-mr),g.selectionEnd=x===L?g.selectionStart:Math.max(g.selectionStart,L-Nl)});return}if(x===L){const Ue=ae.slice(0,x)+B+ae.slice(L);gn(Ue,x+B.length),window.requestAnimationFrame(()=>{g.selectionStart=x+B.length,g.selectionEnd=x+B.length});return}const te=ae.lastIndexOf(`
`,x-1)+1,ze=ae.slice(te,L).replace(/^/gm,B),en=ze.split(`
`).length,Qn=ae.slice(0,te)+ze+ae.slice(L);gn(Qn,x+B.length),window.requestAnimationFrame(()=>{g.selectionStart=x+B.length,g.selectionEnd=L+en*B.length})}function Vo(m){if(on){if(m.key==="ArrowDown"){m.preventDefault(),jn(g=>g&&{...g,selected:(g.selected+1)%g.items.length});return}if(m.key==="ArrowUp"){m.preventDefault(),jn(g=>g&&{...g,selected:(g.selected-1+g.items.length)%g.items.length});return}if(m.key==="Enter"||m.key==="Tab"){m.preventDefault(),ss();return}if(m.key==="Escape"){m.preventDefault(),jn(null);return}}if(m.key==="Tab"){m.preventDefault();const g=m.currentTarget,x=g.selectionStart,L=g.selectionEnd,B="    ",te=st.slice(0,x)+B+st.slice(L),ge=x+B.length;pl(te),$n(null),jn(null),window.requestAnimationFrame(()=>{g.selectionStart=ge,g.selectionEnd=ge});return}if(m.key==="ArrowUp"||m.key==="ArrowDown"){if(!(m.key==="ArrowUp"?m.currentTarget.selectionStart===0&&m.currentTarget.selectionEnd===0:m.currentTarget.selectionStart===st.length&&m.currentTarget.selectionEnd===st.length)||Ur.length===0)return;m.preventDefault();const x=m.key==="ArrowUp"?pn===null?Ur.length-1:Math.max(0,pn-1):pn===null||pn+1>=Ur.length?null:pn+1;$n(x);const L=x===null?"":Ur[x]??"";pl(L),jn(null),window.requestAnimationFrame(()=>{const B=un.current;B&&(B.selectionStart=L.length,B.selectionEnd=L.length)});return}m.key==="Enter"&&!m.shiftKey&&(m.preventDefault(),rs())}return f.jsxs("div",{className:"screen ide-screen",children:[f.jsx(df,{title:"Pico Kodeværksted",onMenu:()=>o()}),Hr?f.jsx("div",{className:"ide-size-gate",role:"dialog","aria-modal":"true","aria-labelledby":"ide-size-title",children:f.jsxs("div",{className:"ide-size-gate-panel",children:[f.jsx("h2",{id:"ide-size-title",children:"Brug en bærbar for at bruge Kodeværkstedet"}),f.jsx("p",{children:"Denne skærm er for lille, så du skal åbne Kodeværkstedet på en bærbar eller en større skærm."})]})}):f.jsxs("div",{className:"ide-layout",children:[f.jsxs("section",{className:"ide-panel ide-files-panel",children:[f.jsxs("div",{className:"ide-panel-head",children:[f.jsx("h2",{children:"Filer"}),f.jsxs("div",{className:"ide-mini-actions",children:[f.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:Qr,"aria-label":"Ny fil",title:"Ny fil",children:f.jsx(zn,{name:"plus",size:20})}),f.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>{var m;return(m=Ya.current)==null?void 0:m.click()},"aria-label":"Importer fil",title:"Importer fil",children:f.jsx(zn,{name:"upload",size:20})}),f.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>rn(),disabled:!E&&!he||U,"aria-label":"Opdater filer",title:"Opdater filer",children:f.jsx(zn,{name:"refresh",size:20})})]})]}),f.jsx("div",{className:"ide-file-list",children:ft.length===0?f.jsx("button",{type:"button",disabled:!0,children:"Ingen filer læst"}):ft.map(m=>{if(m.kind==="separator"){const B=m.id==="pico-files"&&!E&&!he;return f.jsxs(V.Fragment,{children:[f.jsx("div",{className:"ide-file-separator",children:f.jsx("span",{children:m.label})}),B&&f.jsx("div",{className:"ide-file-disconnected",role:"status",children:"Ikke forbundet"})]},m.id)}const g=he&&Ar(m),x=At[rt(m.source,m.path)],L=x!==void 0&&x!==G0(m,Ne,gl);return f.jsxs("div",{className:`ide-file-row ${W===m.path&&_e===m.source?"active":""} ${g?"protected":""}`,children:[f.jsxs("button",{type:"button",onClick:()=>Do(m),disabled:g,title:g?"Holder Bluetooth-forbindelsen i gang og kan ikke åbnes her":void 0,children:[f.jsx("span",{children:m.name}),f.jsx("small",{title:L?"Ikke gemte ændringer":"Ingen ikke gemte ændringer",children:f.jsx("i",{className:`ide-file-dirty-dot ${L?"dirty":"clean"}`,"aria-hidden":"true"})})]}),f.jsx("button",{className:"ide-file-actions",type:"button",onClick:()=>Qa(m),disabled:m.type!=="file"||U||g,"aria-label":`Filvalg for ${m.name}`,title:g?"Holder Bluetooth-forbindelsen i gang og kan ikke ændres her":"Filvalg",children:f.jsx(zn,{name:"settings",size:16})})]},`${m.source}:${m.path}`)})})]}),f.jsxs("section",{className:"ide-panel ide-status-panel",children:[f.jsxs("div",{children:[f.jsxs("div",{className:"ide-status-head",children:[f.jsx("h2",{children:he?"Forbundet Pico":"USB udvikling"}),!he&&f.jsx("span",{className:`ide-usb-status ${qt.supported?"available":"unavailable"}`,title:qt.message,"data-tooltip":qt.message,role:"img","aria-label":qt.message,tabIndex:0,children:"!"})]}),he&&f.jsxs("p",{children:[(s==null?void 0:s.deviceName)??"Pico"," er forbundet via Bluetooth."]})]}),!he&&f.jsxs("div",{className:"ide-actions",children:[f.jsx("button",{className:"btn btn-primary",type:"button",onClick:E?El:Ka,disabled:!qt.supported||j,children:j?"Forbinder...":E?"Afbryd USB":"Forbind USB"}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:Pr,disabled:!E||he||U,children:"Installer"})]}),he&&f.jsxs("div",{className:"ide-actions",children:[f.jsxs("button",{className:"btn btn-primary ide-connection-state",type:"button",disabled:!0,children:[f.jsx(zn,{name:"power",size:22}),"Bluetooth forbundet"]}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:Pr,disabled:U,children:"Installer"})]}),f.jsx("div",{className:"ide-runtime",children:f.jsxs("div",{className:`ide-mini-actions ${he?"single":""}`,children:[f.jsx("button",{className:"btn btn-outline",type:"button",onClick:$t,disabled:!E&&!he||U,children:"Tjek filer"}),!he&&f.jsx("button",{className:"btn btn-outline ide-disconnect-btn",type:"button",onClick:()=>Or(!0),children:"MicroPython"})]})})]}),f.jsxs("section",{className:"ide-panel ide-editor-panel",children:[f.jsxs("div",{className:"ide-panel-head",children:[f.jsx("div",{className:"ide-editor-title",children:f.jsxs("h2",{children:[je(W),f.jsxs("small",{children:[To," bytes"]})]})}),f.jsxs("div",{className:"ide-mini-actions",children:[f.jsx("button",{className:"btn btn-outline",type:"button",onClick:Co,disabled:U,children:"Kør"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:ls,disabled:!Lr&&!(!kt&&vn)&&(!E||!Tn),children:"Stop"}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:Ct,disabled:U||!W.trim(),children:"Gem"}),f.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Fa(),disabled:U||!W.trim(),children:"Slet"})]})]}),Ro(),f.jsxs("div",{className:"ide-editor-wrap",children:[f.jsx("div",{className:"ide-line-numbers","aria-hidden":"true",style:{transform:`translateY(${-Ha.top}px)`},children:Array.from({length:vl},(m,g)=>f.jsx("span",{children:g+1},g))}),f.jsx("pre",{className:"ide-highlight","aria-hidden":"true",style:{transform:`translate(${-Ha.left}px, ${-Ha.top}px)`},children:U0(ae,ko)}),f.jsx("textarea",{ref:Kn,className:"ide-editor",value:ae,onChange:m=>gn(m.target.value,m.target.selectionStart),onKeyDown:Go,onKeyUp:m=>{["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(m.key)||fr(m.currentTarget.value,m.currentTarget.selectionStart)},onClick:m=>{fr(m.currentTarget.value,m.currentTarget.selectionStart),is(m.currentTarget)},onSelect:m=>is(m.currentTarget),onScroll:m=>{Ki({top:m.currentTarget.scrollTop,left:m.currentTarget.scrollLeft}),$e&&fr(m.currentTarget.value,m.currentTarget.selectionStart)},readOnly:U||!!xe,"aria-busy":U||!!xe,spellCheck:!1}),$e&&f.jsx("div",{className:"ide-autocomplete",role:"listbox","aria-label":"Kodeforslag",style:{left:$e.position.left,top:$e.position.top},children:$e.items.map((m,g)=>f.jsx("button",{className:g===$e.selected?"active":"",type:"button",onMouseDown:x=>{x.preventDefault(),Wa(m)},role:"option","aria-selected":g===$e.selected,children:m.label},m.label))}),xe&&f.jsxs("div",{className:"ide-editor-loading",role:"status","aria-live":"polite",children:[f.jsx("span",{className:"spinner","aria-hidden":"true"}),f.jsxs("strong",{children:["Indlæser ",je(xe),"..."]})]})]})]}),f.jsxs("section",{className:"ide-panel ide-terminal-panel",children:[f.jsxs("div",{className:"ide-panel-head",children:[f.jsx("h2",{children:"Terminal"}),f.jsxs("div",{className:"ide-mini-actions",children:[f.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${Gt?"":"active"}`,type:"button",onClick:()=>Ii(m=>!m),"aria-label":Gt?"Tekniske fejl er slået fra":"Tekniske fejl er slået til","aria-pressed":!Gt,title:Gt?"Vis originale tekniske fejl":"Viser originale tekniske fejl",children:"Teknisk"}),f.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${Dt?"active":""}`,type:"button",onClick:()=>er(m=>!m),"aria-pressed":Dt,title:Dt?"Terminalen ryddes, hver gang du trykker Kør":"Terminalen beholder tekst, når du trykker Kør",children:"Ryd ved Kør"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:Lo,disabled:Q.length===0,children:"Ryd"})]})]}),f.jsxs("div",{className:"ide-terminal","aria-live":"polite",ref:ln,onScroll:Bo,onClick:()=>{var m;return(m=un.current)==null?void 0:m.focus()},children:[Q.length===0?f.jsx("div",{className:"term-line",children:"Ingen terminaldata endnu."}):Q.map((m,g)=>f.jsx("div",{className:`term-line term-${m.level}`,children:m.technical&&!Gt?m.technical:m.text},`${g}-${m.text}`)),f.jsxs("form",{className:`ide-terminal-command ${Fn?"locked":""}`,onSubmit:m=>{m.preventDefault(),rs()},children:[f.jsx("span",{"aria-hidden":"true",children:">>>"}),f.jsx("textarea",{ref:un,value:st,onChange:m=>{pl(m.target.value),$n(null),dr(m.target.value,m.target.selectionStart)},onKeyDown:Vo,onKeyUp:m=>{["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(m.key)||dr(m.currentTarget.value,m.currentTarget.selectionStart)},onClick:m=>dr(m.currentTarget.value,m.currentTarget.selectionStart),disabled:Un,placeholder:qa,"aria-label":"MicroPython-terminalkommando",title:qa,rows:Math.max(1,st.split(`
`).length)})]}),on&&f.jsx("div",{className:"ide-autocomplete ide-repl-autocomplete",role:"listbox","aria-label":"Terminalforslag",style:{left:on.position.left,top:on.position.top},children:on.items.map((m,g)=>f.jsx("button",{className:g===on.selected?"active":"",type:"button",onMouseDown:x=>{x.preventDefault(),ss(m)},role:"option","aria-selected":g===on.selected,children:m.label},m.label))})]})]})]}),f.jsx("input",{ref:Ya,type:"file",accept:".py,.txt,.json,.csv",className:"sr-only",onChange:m=>{var g;Kt((g=m.target.files)==null?void 0:g[0]),m.currentTarget.value=""}}),D&&f.jsx(yn,{title:"Gem fil",onClose:()=>I(!1),children:f.jsxs("div",{className:"ide-save-options",children:[f.jsx("button",{className:"btn btn-primary",type:"button",onClick:ir,children:"Gem i browser"}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:()=>void Ir(),disabled:!E&&!he||U,children:"Gem på Pico"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:Fr,children:"Download til computer"})]})}),Ie&&f.jsx(yn,{title:"Installer filer",onClose:()=>Le(!1),children:f.jsxs("div",{className:"ide-install-list",children:[f.jsx("p",{className:"ide-install-note",children:"Vælg et startprogram og de biblioteker dit projekt bruger. Ingen filer er valgt på forhånd."}),f.jsxs("div",{className:"ide-install-grid",children:[as("Startprogrammer (main.py)","Starter automatisk på Picoen.",De.filter(m=>m.kind==="program")),as("Biblioteker","Ekstra Python-filer som dine programmer kan importere.",De.filter(m=>m.kind==="library"))]}),f.jsx("button",{className:"btn btn-primary",type:"button",onClick:jo,disabled:U,children:"Installer valgte"})]})}),Ua&&f.jsx(yn,{title:"main.py er gemt",onClose:()=>Ht(!1),children:f.jsxs("div",{className:"settings-stack",children:[f.jsx("p",{className:"confirm-message",children:"Picoen kører stadig den gamle kode. Genstart Picoen for at anvende den nye main.py. Appen forsøger automatisk at genforbinde bagefter."}),f.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>void sr("control"),disabled:U,children:"Genstart og åbn kontrolpanel"}),f.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void sr("ide"),disabled:U,children:"Genstart og bliv i Kodeværksted"}),f.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>Ht(!1),disabled:U,children:"Senere"})]})}),La&&f.jsx(yn,{title:"Installer MicroPython",onClose:()=>Or(!1),children:f.jsxs("div",{className:"settings-stack",children:[f.jsx("p",{className:"confirm-message",children:"Hvis Picoen er helt frisk, skal MicroPython først lægges på den."}),f.jsxs("ol",{className:"micropython-steps",children:[f.jsx("li",{children:"Hold BOOTSEL-knappen nede."}),f.jsx("li",{children:"Sæt Picoen i USB, og slip derefter BOOTSEL."}),f.jsx("li",{children:"Vælg Pico-model og MicroPython-version herunder, og download UF2-filen."}),f.jsxs("li",{children:["Kopier UF2-filen til drevet ",f.jsx("strong",{children:"RPI-RP2"})]})]}),f.jsxs("div",{className:"micropython-selects",children:[f.jsx("label",{htmlFor:"micropython-board",children:"Pico-model"}),f.jsx("select",{id:"micropython-board",value:hl,onChange:m=>No(m.target.value),children:Zi.map(m=>f.jsx("option",{value:m,children:m},m))}),f.jsx("label",{htmlFor:"micropython-version",children:"MicroPython-version"}),f.jsx("select",{id:"micropython-version",value:(Nt==null?void 0:Nt.version)??Pl,onChange:m=>zr(m.target.value),children:tr.map(m=>f.jsxs("option",{value:m.version,children:[m.version," (",m.date,")"]},`${m.board}:${m.version}:${m.date}`))})]}),Nt&&f.jsx("a",{className:"btn btn-primary btn-block",href:Nt.url,download:Nt.fileName,children:"Download UF2"}),f.jsx("a",{className:"btn btn-outline btn-block",href:"https://www.raspberrypi.com/documentation/microcontrollers/micropython.html",target:"_blank",rel:"noreferrer",children:"Se vejledning"})]})}),O&&f.jsx(yn,{title:"Ny Python-fil",onClose:()=>Y(!1),children:f.jsxs("form",{className:"ide-new-file-form",onSubmit:m=>{m.preventDefault(),or()},children:[f.jsx("label",{htmlFor:"new-pico-file",children:"Filnavn"}),f.jsxs("div",{className:"ide-new-file-row",children:[f.jsx("input",{id:"new-pico-file",value:ie,onChange:m=>Ee(m.target.value),autoFocus:!0,placeholder:"test"}),f.jsx("span",{children:".py"})]}),f.jsxs("p",{children:["Skriv kun navnet. Appen tilføjer .py automatisk og opretter filen i ",Qi,"."]}),f.jsx("button",{className:"btn btn-primary",type:"submit",disabled:!yp(ie),children:"Opret"})]})}),z&&f.jsx(yn,{title:je(z.path),onClose:()=>P(null),children:f.jsxs("div",{className:"ide-file-action-modal",children:[f.jsxs("form",{className:"ide-file-rename-form",onSubmit:m=>{m.preventDefault(),ns()},children:[f.jsx("label",{htmlFor:"rename-pico-file",children:"Filnavn"}),f.jsxs("div",{className:"ide-new-file-row",children:[f.jsx("input",{id:"rename-pico-file",value:de,onChange:m=>w(m.target.value),placeholder:"min_kode"}),f.jsxs("span",{children:[".",Vi(z.path)]})]}),f.jsxs("p",{children:["Skriv kun navnet. Appen beholder filendelsen .",Vi(z.path)," automatisk."]}),f.jsx("button",{className:"btn btn-primary btn-block",type:"submit",disabled:!Fu(de,Vi(z.path))||Fu(de,Vi(z.path))===z.path||U,children:"Gem navn"})]}),f.jsx("div",{className:"ide-file-action-buttons",children:f.jsx("button",{className:"btn btn-outline btn-danger btn-block",type:"button",onClick:()=>Fa(z),disabled:U,children:"Slet"})}),f.jsxs("section",{className:"ide-version-history",children:[f.jsx("h4",{children:"Versionshistorik"}),z.source!=="pico"?f.jsx("p",{children:"Versioner gemmes kun for filer på Picoen."}):z.versions.length===0?f.jsx("p",{children:"Versionshistorik: 0 gemte versioner."}):f.jsx("div",{className:"ide-version-list",children:z.versions.map(m=>f.jsxs("div",{className:"ide-version-row",children:[f.jsx("span",{children:je(m.path)}),f.jsx("small",{children:m.size!==void 0?`${m.size} bytes`:"Gemt på Pico"}),f.jsx("button",{className:"btn btn-outline",type:"button",onClick:()=>void Za(m),disabled:U,children:"Gendan"}),f.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>cr(m),disabled:U,children:"Slet"})]},m.path))})]})]})})]})}function yp(o){var u;const i=(u=o.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:u.replace(/\.py$/i,"").replace(/[^a-zA-Z0-9_-]/g,"_").replace(/^_+|_+$/g,"");return i?`/${i}.py`:""}function D0(o){const i=o.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop(),u=i==null?void 0:i.match(/^(.+)\.(py|txt|json|csv)$/i);if(!u)return"";const s=u[1].replace(/[^a-zA-Z0-9_-]/g,"_").replace(/^_+|_+$/g,"");return s?`/${s}.${u[2].toLowerCase()}`:""}function Fu(o,i="py"){const u=o.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop();if(!u)return"";const s=u.match(/^(.+?)(?:\.(py|txt|json|csv))?$/i);if(!s)return"";const c=s[1].replace(/[^a-zA-Z0-9_-]/g,"_").replace(/^_+|_+$/g,""),h=i.replace(/^\./,"").toLowerCase(),_=(s[2]??(h||"py")).toLowerCase();return c?`/${c}.${_}`:""}function j0(o){return je(o).replace(/\.(py|txt|json|csv)$/i,"")}function Vi(o){var s;const i=je(o).match(/\.([a-z0-9]+)$/i),u=(s=i==null?void 0:i[1])==null?void 0:s.toLowerCase();return u&&["py","txt","json","csv"].includes(u)?u:"py"}function fo(o){return o.replace(/\r\n/g,`
`).replace(/\r/g,`
