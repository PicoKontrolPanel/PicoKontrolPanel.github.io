 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vm;function N2(){return vm||(vm=1,(function(a){function l(q,ee){var he=q.length;q.push(ee);e:for(;0<he;){var Ae=he-1>>>1,ge=q[Ae];if(0<d(ge,ee))q[Ae]=ee,q[he]=ge,he=Ae;else break e}}function o(q){return q.length===0?null:q[0]}function s(q){if(q.length===0)return null;var ee=q[0],he=q.pop();if(he!==ee){q[0]=he;e:for(var Ae=0,ge=q.length,E=ge>>>1;Ae<E;){var O=2*(Ae+1)-1,J=q[O],ie=O+1,ve=q[ie];if(0>d(J,he))ie<ge&&0>d(ve,J)?(q[Ae]=ve,q[ie]=he,Ae=ie):(q[Ae]=J,q[O]=he,Ae=O);else if(ie<ge&&0>d(ve,he))q[Ae]=ve,q[ie]=he,Ae=ie;else break e}}return ee}function d(q,ee){var he=q.sortIndex-ee.sortIndex;return he!==0?he:q.id-ee.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;a.unstable_now=function(){return p.now()}}else{var _=Date,m=_.now();a.unstable_now=function(){return _.now()-m}}var g=[],b=[],x=1,k=null,M=3,C=!1,R=!1,F=!1,P=!1,I=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,re=typeof setImmediate<"u"?setImmediate:null;function H(q){for(var ee=o(b);ee!==null;){if(ee.callback===null)s(b);else if(ee.startTime<=q)s(b),ee.sortIndex=ee.expirationTime,l(g,ee);else break;ee=o(b)}}function ue(q){if(F=!1,H(q),!R)if(o(g)!==null)R=!0,fe||(fe=!0,Q());else{var ee=o(b);ee!==null&&pe(ue,ee.startTime-q)}}var fe=!1,ae=-1,Z=5,we=-1;function de(){return P?!0:!(a.unstable_now()-we<Z)}function Re(){if(P=!1,fe){var q=a.unstable_now();we=q;var ee=!0;try{e:{R=!1,F&&(F=!1,Y(ae),ae=-1),C=!0;var he=M;try{t:{for(H(q),k=o(g);k!==null&&!(k.expirationTime>q&&de());){var Ae=k.callback;if(typeof Ae=="function"){k.callback=null,M=k.priorityLevel;var ge=Ae(k.expirationTime<=q);if(q=a.unstable_now(),typeof ge=="function"){k.callback=ge,H(q),ee=!0;break t}k===o(g)&&s(g),H(q)}else s(g);k=o(g)}if(k!==null)ee=!0;else{var E=o(b);E!==null&&pe(ue,E.startTime-q),ee=!1}}break e}finally{k=null,M=he,C=!1}ee=void 0}}finally{ee?Q():fe=!1}}}var Q;if(typeof re=="function")Q=function(){re(Re)};else if(typeof MessageChannel<"u"){var qe=new MessageChannel,Be=qe.port2;qe.port1.onmessage=Re,Q=function(){Be.postMessage(null)}}else Q=function(){I(Re,0)};function pe(q,ee){ae=I(function(){q(a.unstable_now())},ee)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(q){q.callback=null},a.unstable_forceFrameRate=function(q){0>q||125<q?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<q?Math.floor(1e3/q):5},a.unstable_getCurrentPriorityLevel=function(){return M},a.unstable_next=function(q){switch(M){case 1:case 2:case 3:var ee=3;break;default:ee=M}var he=M;M=ee;try{return q()}finally{M=he}},a.unstable_requestPaint=function(){P=!0},a.unstable_runWithPriority=function(q,ee){switch(q){case 1:case 2:case 3:case 4:case 5:break;default:q=3}var he=M;M=q;try{return ee()}finally{M=he}},a.unstable_scheduleCallback=function(q,ee,he){var Ae=a.unstable_now();switch(typeof he=="object"&&he!==null?(he=he.delay,he=typeof he=="number"&&0<he?Ae+he:Ae):he=Ae,q){case 1:var ge=-1;break;case 2:ge=250;break;case 5:ge=1073741823;break;case 4:ge=1e4;break;default:ge=5e3}return ge=he+ge,q={id:x++,callback:ee,priorityLevel:q,startTime:he,expirationTime:ge,sortIndex:-1},he>Ae?(q.sortIndex=he,l(b,q),o(g)===null&&q===o(b)&&(F?(Y(ae),ae=-1):F=!0,pe(ue,he-Ae))):(q.sortIndex=ge,l(g,q),R||C||(R=!0,fe||(fe=!0,Q()))),q},a.unstable_shouldYield=de,a.unstable_wrapCallback=function(q){var ee=M;return function(){var he=M;M=ee;try{return q.apply(this,arguments)}finally{M=he}}}})(jd)),jd}var bm;function R2(){return bm||(bm=1,Md.exports=N2()),Md.exports}var Nd={exports:{}},rn={};/**
 * @license React
...
`);let _=Atomics.load(o,0);for(const m of p)s[ch+_%d]=m,_+=1;Atomics.store(o,0,_),Atomics.notify(o,0)}const gv=new Set(["bluetooth","machine","network","PicoRobotics","rp2","ubluetooth"]);class _v{constructor(){ye(this,"worker",null);ye(this,"pending",null);ye(this,"nextId",0)}send(l,o={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython-terminalen er optaget. Stop den, eller vent på at kommandoen bliver færdig.",timedOut:!1,unavailable:!1});const s=++this.nextId,d=o.timeoutMs??Wh,p=this.ensureWorker();return new Promise(_=>{const m=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython-terminalen stoppede, fordi kommandoen tog for lang tid. Tjek for uendelige løkker.",timedOut:!0,unavailable:!1}),this.restartWorker()},d);this.pending={id:s,timer:m,onOutput:o.onOutput,resolve:_},p.postMessage({type:"run",id:s,code:bv(l),runtimeUrl:Zh})})}reset(){this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),this.restartWorker()}dispose(){var l;this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),(l=this.worker)==null||l.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const l=new Worker(new URL(""+new URL("offlineMicroPython.worker-B_-Tbi7X.js",import.meta.url).href,import.meta.url),{type:"module"});return l.onmessage=o=>this.handleMessage(o.data),l.onerror=o=>{this.finish({ok:!1,output:"",error:o.message||"Browser-MicroPython-terminalen fejlede i browser-worker.",timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=l,l}handleMessage(l){var s;const o=this.pending;if(!(!o||l.id!==o.id||l.type==="ready")){if(l.type==="stdout"){(s=o.onOutput)==null||s.call(o,l.text);return}if(l.type!=="stdin-wait"){if(l.type==="unavailable"){this.finish({ok:!1,output:"",error:l.error,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:l.ok,output:l.output,error:l.error,timedOut:!1,unavailable:!1})}}}finish(l){const o=this.pending;o&&(window.clearTimeout(o.timer),this.pending=null,o.resolve(l))}restartWorker(){var l;(l=this.worker)==null||l.terminate(),this.worker=null}}class vv{constructor(){ye(this,"worker",null);ye(this,"pending",null);ye(this,"nextId",0);ye(this,"stdinSab",null)}run(l,o={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython kører allerede kode. Stop den først.",issues:[],timedOut:!1,unavailable:!1});const s=typeof o=="number"?o:o.timeoutMs===null?null:o.timeoutMs??Wh,d=typeof o=="number"?void 0:o.onOutput,p=typeof o=="number"?void 0:o.onWaitingForInput,_=typeof o=="number"?void 0:o.signal,m=Qd(l,{allowInput:!0});if(m.some(k=>k.level==="error"))return Promise.resolve({ok:!1,output:"",error:"",issues:m,timedOut:!1,unavailable:!1});const g=++this.nextId,b=this.ensureWorker(),x=hv();return this.stdinSab=x,new Promise(k=>{const M=P=>this.finish(P),C=()=>{this.restartWorker(),M({ok:!1,output:"",error:"",issues:m,timedOut:!1,unavailable:!1})},R=s===null?null:window.setTimeout(()=>{M({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:m,timedOut:!0,unavailable:!1}),this.restartWorker()},s);if(this.pending={id:g,timer:R,timeoutMs:s,issues:m,onOutput:d,onWaitingForInput:p,signal:_,abort:C,resolve:k},_!=null&&_.aborted){C();return}_==null||_.addEventListener("abort",C,{once:!0});const F={type:"run",id:g,code:l,runtimeUrl:Zh,interactive:!0,sab:x??void 0};b.postMessage(F)})}sendInput(l){const o=this.pending;!o||!this.stdinSab||(this.refreshTimeout(o),pv(this.stdinSab,l))}stop(){const l=this.pending;l&&(this.restartWorker(),this.finish({ok:!1,output:"",error:"Browser-MicroPython blev stoppet.",issues:l.issues,timedOut:!1,unavailable:!1}))}dispose(){var l;this.finish({ok:!1,output:"",error:"",issues:[],timedOut:!1,unavailable:!1}),(l=this.worker)==null||l.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const l=new Worker(new URL(""+new URL("offlineMicroPython.worker-B_-Tbi7X.js",import.meta.url).href,import.meta.url),{type:"module"});return l.onmessage=o=>this.handleMessage(o.data),l.onerror=o=>{const s=this.pending;this.finish({ok:!1,output:"",error:o.message||"Offline MicroPython fejlede i browser-worker.",issues:(s==null?void 0:s.issues)??[],timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=l,l}handleMessage(l){var s,d;const o=this.pending;if(!(!o||l.id!==o.id||l.type==="ready")){if(l.type==="stdout"){this.refreshTimeout(o),(s=o.onOutput)==null||s.call(o,l.text);return}if(l.type==="stdin-wait"){l.waiting&&this.refreshTimeout(o),(d=o.onWaitingForInput)==null||d.call(o,l.waiting);return}if(l.type==="unavailable"){this.finish({ok:!1,output:"",error:l.error,issues:o.issues,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:l.ok,output:l.output,error:l.error,issues:o.issues,timedOut:!1,unavailable:!1}),this.restartWorker()}}finish(l){var s,d;const o=this.pending;o&&(o.timer!==null&&window.clearTimeout(o.timer),(s=o.signal)==null||s.removeEventListener("abort",o.abort),this.pending=null,(d=o.onWaitingForInput)==null||d.call(o,!1),o.resolve(l))}refreshTimeout(l){l.timeoutMs!==null&&(l.timer!==null&&window.clearTimeout(l.timer),l.timer=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:l.issues,timedOut:!0,unavailable:!1}),this.restartWorker()},l.timeoutMs))}restartWorker(){var l;(l=this.worker)==null||l.terminate(),this.worker=null,this.stdinSab=null}}function bv(a){const l=JSON.stringify(a);return["try:",`    __pico_repl_value = eval(${l})`,"    if __pico_repl_value is not None:","        print(repr(__pico_repl_value))","except SyntaxError:",`    exec(${l})`,"finally:","    try:","        del __pico_repl_value","    except Exception:","        pass"].join(`
`)}function Qd(a,l={}){const o=[],s=new Blob([a]).size;s>sh&&o.push({level:"error",text:`Koden er ${s} bytes. Offline MicroPython kører kun små programmer op til ${sh} bytes.`});const d=a.split(/\r?\n/);for(let p=0;p<d.length;p+=1){const _=p+1,m=_c(d[p]).trim();if(!m)continue;const g=wv(m);g&&gv.has(g)&&o.push({level:"error",line:_,text:`${g} virker kun på Picoen. Forbind en Pico for at køre denne kode.`}),!l.allowInput&&yv(d[p])&&o.push({level:"error",line:_,text:"input() virker i hele programmer. Skriv programmet i editoren og tryk Kør, eller kør filen på Pico via USB."});const b=m.match(/\brange\(\s*(-?\d+)\s*(?:,\s*(-?\d+)\s*)?(?:,\s*(-?\d+)\s*)?\)/);b&&xv(b)>oh&&o.push({level:"error",line:_,text:`range(...) er for stor til offline kørsel. Brug højst ${oh} gentagelser.`})}for(const p of kv(d))o.push({level:"warning",text:`Funktionen ${p} ser rekursiv ud. Hvis den ikke stopper, afbryder offline MicroPython efter få sekunder.`});return o}function _c(a){let l=null;for(let o=0;o<a.length;o+=1){const s=a[o];if((s==='"'||s==="'")&&a[o-1]!=="\\"&&(l=l===s?null:l??s),s==="#"&&!l)return a.slice(0,o)}return a}function yv(a){const l=_c(a);let o=null;for(let s=0;s<l.length;s+=1){const d=l[s];if((d==='"'||d==="'")&&l[s-1]!=="\\"){o=o===d?null:o??d;continue}if(!o&&!(!uh(l[s-1])||l.slice(s,s+5)!=="input")&&uh(l[s+5])&&l.slice(s+5).trimStart().startsWith("("))return!0}return!1}function uh(a){return!a||!/[A-Za-z0-9_]/.test(a)}function wv(a){const l=a.match(/^import\s+([A-Za-z_]\w*)/);if(l)return l[1];const o=a.match(/^from\s+([A-Za-z_]\w*)\s+import\b/);return(o==null?void 0:o[1])??null}function dh(a){const l=a.match(/^\s*/);return(l==null?void 0:l[0].replace(/\t/g,"    ").length)??0}function xv(a){const l=Number(a[1]),o=a[2]===void 0?void 0:Number(a[2]),s=a[3]===void 0?1:Number(a[3]);if(s===0)return Number.POSITIVE_INFINITY;const _=(o===void 0?l:o)-(o===void 0?0:l);return _>0&&s<0||_<0&&s>0?0:Math.ceil(Math.abs(_/s))}function kv(a){const l=new Set;for(let o=0;o<a.length;o+=1){const s=_c(a[o]).trim().match(/^def\s+([A-Za-z_]\w*)\s*\(/);if(!s)continue;const d=s[1],p=dh(a[o]);for(let _=o+1;_<a.length;_+=1){if(!a[_].trim())continue;if(dh(a[_])<=p)break;if(new RegExp(`\\b${d}\\s*\\(`).test(_c(a[_]))){l.add(d);break}}}return[...l]}const Sv=/^(for|if|while|def|class|elif|else|try|except|finally|with)\b/;function Ev(a,l){var x;const o=a.trim(),s=l.split(/\r?\n/),d=Tv(o),p=d?s[d-1]??"":"",_=Mv(s,d),m=o.split(/\r?\n/).filter(Boolean).at(-1)??"";if(/KeyboardInterrupt/.test(m))return{simple:"Programmet blev stoppet.",technical:o,line:d};if(/MemoryError/.test(m))return{simple:`Picoen eller browserens MicroPython løb tør for hukommelse${d?` omkring linje ${d}`:""}.`,technical:o,line:d};if(/RecursionError/.test(m))return{simple:`En funktion kalder sig selv for mange gange${d?` omkring linje ${d}`:""}.`,technical:o,line:d};const g=m.match(/UnboundLocalError:\s+local variable ['"](.+?)['"]/);if(g)return{simple:`Variablen ${g[1]} bruges inde i en funktion, før den har fået en værdi${d?` på linje ${d}`:""}.`,technical:o,line:d};const b=m.match(/NameError:\s+name ['"](.+?)['"] (?:isn't|is not) defined/);if(b)return{simple:Av(p,b[1])?`Teksten ${b[1]} mangler måske citationstegn${d?` på linje ${d}`:""}.`:`Python kender ikke navnet ${b[1]}${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/ZeroDivisionError/.test(m))return{simple:`Kan ikke dividere med 0${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/IndentationError:\s+unexpected indent/.test(m))return{simple:`Der er for meget indrykning${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/IndentationError/.test(m))return{simple:`Mangler indrykning${d?` på linje ${d}`:""}.`,technical:o,line:d};if(/ImportError|ModuleNotFoundError/.test(m)){const k=(x=m.match(/['"](.+?)['"]/))==null?void 0:x[1];return{simple:`Python kan ikke finde modulet${k?` ${k}`:""}.`,technical:o,line:d}}if(/OSError/.test(m))return/ENOENT|No such file|Errno\s+2/.test(m)?{simple:`Python kan ikke finde filen${d?` på linje ${d}`:""}.`,technical:o,line:d}:/EACCES|permission|denied/i.test(m)?{simple:`Python har ikke adgang til filen eller enheden${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Der opstod en fejl med en fil eller en enhed${d?` omkring linje ${d}`:""}.`,technical:o,line:d};if(/SyntaxError/.test(m)){if(/invalid syntax/.test(m)&&_.text.trim().endsWith(","))return{simple:`Linje ${_.line??d} slutter med komma. Tjek om der mangler noget efter kommaet.`,technical:o,line:_.line??d};const k=Wd(p,d)??Wd(_.text,_.line)??jv(s,d);return k?{simple:`Mangler måske : efter linje ${k.line}.`,technical:o,line:k.line}:d&&_.text.trim().endsWith(":")&&p.trim()&&!/^\s+/.test(p)?{simple:`Mangler måske indrykning på linje ${d}.`,technical:o,line:d}:Rv(p)?{simple:`Tekst mangler måske citationstegn${d?` på linje ${d}`:""}.`,technical:o,line:d}:Nv(p)?{simple:`Tekst mangler måske et afsluttende citationstegn${d?` på linje ${d}`:""}.`,technical:o,line:d}:Cv(p)?{simple:`Mangler måske en afsluttende parentes${d?` på linje ${d}`:""}.`,technical:o,line:d}:Dv(p)?{simple:`Der er måske en parentes for meget${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Python fandt en syntaksfejl${d?` omkring linje ${d}`:""}.`,technical:o,line:d}}return/TypeError/.test(m)?/takes .* positional arguments? but .* given/.test(m)||/function takes/.test(m)?{simple:`En funktion får for mange eller for få værdier${d?` på linje ${d}`:""}.`,technical:o,line:d}:/unsupported operand type/.test(m)?{simple:`To værdier kan ikke bruges sammen på den måde${d?` på linje ${d}`:""}.`,technical:o,line:d}:/not callable/.test(m)?{simple:`Der bliver brugt parenteser efter noget, som ikke er en funktion${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`En værdi har den forkerte type${d?` på linje ${d}`:""}.`,technical:o,line:d}:/IndexError/.test(m)?{simple:`Listen har ikke et element på den plads${d?` på linje ${d}`:""}.`,technical:o,line:d}:/KeyError/.test(m)?{simple:`Ordbogen mangler den nøgle${d?` på linje ${d}`:""}.`,technical:o,line:d}:/AttributeError/.test(m)?{simple:`Den ting har ikke den kommando${d?` på linje ${d}`:""}.`,technical:o,line:d}:/ValueError/.test(m)?/invalid literal for int/.test(m)?{simple:`Teksten kan ikke laves om til et heltal${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Værdien passer ikke her${d?` på linje ${d}`:""}.`,technical:o,line:d}:{simple:`Python fandt en fejl${d?` omkring linje ${d}`:""}.`,technical:o,line:d}}function Tv(a){var d;const o=(d=[...a.matchAll(/line\s+(\d+)/g)].at(-1))==null?void 0:d[1];if(!o)return;const s=parseInt(o,10);return Number.isFinite(s)&&s>0?s:void 0}function Mv(a,l){if(!l)return{text:""};for(let o=l-2;o>=0;o-=1){const s=a[o]??"";if(s.trim())return{line:o+1,text:s}}return{text:""}}function Wd(a,l){if(!l)return null;const o=a.trim();return!Sv.test(o)||o.endsWith(":")?null:{line:l}}function jv(a,l){const o=l?Math.min(a.length,l):a.length,s=Math.max(0,o-4);for(let d=o-1;d>=s;d-=1){const p=Wd(a[d]??"",d+1);if(p)return p}return null}function Nv(a){const l=(a.match(/'/g)??[]).length,o=(a.match(/"/g)??[]).length;return l%2===1||o%2===1}function Rv(a){var s,d;const o=(d=(s=a.trim().match(/^print\((.+)\)$/))==null?void 0:s[1])==null?void 0:d.trim();return!o||/['"]/.test(o)?!1:/\s/.test(o)&&/[a-zA-ZæøåÆØÅ]/.test(o)}function Av(a,l){const o=a.trim();return!!l&&/[A-Za-zæøåÆØÅ]/.test(l)&&(o.startsWith("print(")||o.includes(`= ${l}`))}function Cv(a){return ep(a)>0}function Dv(a){return ep(a)<0}function ep(a){let l=0,o=null;for(let s=0;s<a.length;s+=1){const d=a[s];if((d==='"'||d==="'")&&a[s-1]!=="\\"){o=o===d?null:o??d;continue}o||((d==="("||d==="["||d==="{")&&(l+=1),(d===")"||d==="]"||d==="}")&&(l-=1))}return l}const Zd="/min_kode.py",tp=`print('Hej fra Pico Kontrol Panel')
`,Ov=500,Lv=1200,_s="Backup-filnavne er reserveret til versionshistorik. Vælg et andet navn.";function Wt(a,l){return`${a}:${l}`}function Bv(a){return new Promise(l=>window.setTimeout(l,a))}function zv(){const a=oe(f=>f.toggleSideMenu),l=oe(f=>f.askConfirm),o=oe(f=>f.picoIdeOrigin),s=oe(f=>f.active),d=oe(f=>f.isBleConnected),p=oe(f=>f.bleListFiles),_=oe(f=>f.bleReadText),m=oe(f=>f.bleWriteText),g=oe(f=>f.bleDeleteFile),b=oe(f=>f.bleRestartAndReconnect),[x,k]=j.useState(!1),[M,C]=j.useState(!1),[R,F]=j.useState([]),[P,I]=j.useState(!1),[Y,re]=j.useState([]),[H,ue]=j.useState(null),[fe,ae]=j.useState(()=>ic(rc())),[Z,we]=j.useState(Zd),[de,Re]=j.useState("local"),[Q,qe]=j.useState(()=>{var f;return((f=ic(rc()).find(v=>v.path===Zd))==null?void 0:f.content)??tp}),[Be,pe]=j.useState([]),[q,ee]=j.useState(!1),[he,Ae]=j.useState(""),[ge,E]=j.useState(""),[O,J]=j.useState(null),[ie,ve]=j.useState(!1),[ke,ne]=j.useState(null),[st,Ue]=j.useState(!1),[Ft,L]=j.useState({}),[se,le]=j.useState(!1),[Se,Ee]=j.useState(0),[Je,xt]=j.useState(()=>{var f,v;return((f=Cl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:f.board)??((v=Cl[0])==null?void 0:v.board)??""}),[Ve,Kn]=j.useState(()=>{var f,v;return((f=Cl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:f.version)??((v=Cl[0])==null?void 0:v.version)??""}),[lr,xn]=j.useState(!1),[ar,Qn]=j.useState({top:0,left:0}),[Mt,wr]=j.useState(!1),[un,zl]=j.useState(!1),[Dn,xr]=j.useState(!1),[Ul,jt]=j.useState(!0),[bt,qt]=j.useState(""),[kt,Zt]=j.useState([]),[pt,el]=j.useState(null),[ql,ir]=j.useState(!1),[Jt,dn]=j.useState({}),[en,te]=j.useState({}),[_e,He]=j.useState(null),[Ye,St]=j.useState(null),[sr,fn]=j.useState(""),[Wn,Hl]=j.useState(()=>Tm().clearTerminalOnRun),[or,Ns]=j.useState(()=>Tm().simplifiedErrors),[Vl,di]=j.useState(()=>typeof navigator<"u"?ph(navigator):!1),Pl=j.useRef(null),Zn=j.useRef(null),et=j.useRef(null),Nt=j.useRef(null),gt=j.useRef(null),cr=j.useRef(null),Il=j.useRef(null),va=j.useRef(null),ba=j.useRef(null),kr=j.useRef(null),ur=j.useRef(null),mn=j.useRef(!1),hn=j.useRef(!1),On=j.useRef(!1),an=j.useRef(""),kn=j.useRef(null),dt=j.useRef(null),dr=j.useRef(null),ya=j.useRef(null),tn=j.useRef(null),Ln=j.useRef(null),Sr=j.useRef(0),Er=j.useRef(null),Tr=j.useRef(null),Rs=j.useRef(null),fr=j.useRef(null),Mr=j.useRef([]),pn=j.useRef([]),Lt=j.useRef(null),jr=uv(),je=o==="control"&&!!s&&d(),Fl=je?(s==null?void 0:s.deviceID)??"ble":null,As=Math.max(1,Q.split(`
`).length),wa=new Blob([Q]).size,xc=de==="pico"?"Picoen":"browseren",gn=j.useMemo(()=>[...new Set(Cl.map(f=>f.board))],[]),Nr=j.useMemo(()=>Cl.filter(f=>f.board===Je),[Je]),Rr=Cl.find(f=>f.board===Je&&f.version===Ve)??Nr[0]??Cl[0],Gl=P||!!H||Mt||un,Gt=de==="pico",xa=Gt?Mt:un,sn=Gt&&Mt&&x&&!je||!Gt&&un&&!!dr.current&&Dn,tl=ql||xa&&!sn,kc=sn?"stdin":">>>",fi=sn?Gt?"Input til kørende Pico-kode":"Input til kørende Browser-MicroPython":Gt?"Pico MicroPython":"Browser-MicroPython",ka=j.useMemo(()=>{const f=new dv({onData:v=>{hn.current||!mn.current||(an.current=(an.current+v).slice(-240),/(^|\r?\n)>>> ?$/.test(an.current)&&Ea())},onLine:v=>{if(hn.current)return;const w=v.trimEnd();if(On.current&&w.trim()){G("info",w);return}if(mn.current&&Ec(w)){Ea();return}mn.current&&w.trim()&&!Sa(w)&&!w.includes("raw REPL")&&G("info",w)},onLog:G,onDisconnect:()=>{k(!1),wr(!1),ir(!1),mn.current=!1,On.current=!1,on(),an.current="",Ht(),G("warning","USB-forbindelse lukket.")}});return Pl.current=f,f},[]);function G(f,v){F(w=>[...w.slice(-140),{level:f,text:v}])}function Sc(f){F(v=>[...v.slice(-140),{level:"info",text:f,variant:"input"}])}function Ec(f){return f.trim()===">>>"}function Sa(f){return f.trimStart().startsWith(">>> import builtins as _pkp_builtins; exec(")}function on(){kn.current!==null&&(window.clearTimeout(kn.current),kn.current=null)}function Ea(){!mn.current||kn.current!==null||(kn.current=window.setTimeout(()=>{kn.current=null,mn.current&&(wr(!1),mn.current=!1,an.current="",G("success","Pico-koden er færdig."),Ta())},0))}function Ta(){const f=et.current;f&&bi(f,!1)}function Jn(f,v=Q,w="error"){const A=Ev(f,v);F(N=>[...N.slice(-140),{level:w,text:A.simple,technical:A.technical}])}function ot(f,v,w=de){we(f),Re(w),qe(v),te(A=>({...A,[Wt(w,f)]:v})),nl()}function mi(f,v="pico"){we(f),Re(v),qe(""),He(null),Qn({top:0,left:0}),nl()}function nl(){Mr.current=[],pn.current=[],Lt.current=null}function rl(){const f=gt.current;return{content:Q,selectionStart:(f==null?void 0:f.selectionStart)??Q.length,selectionEnd:(f==null?void 0:f.selectionEnd)??(f==null?void 0:f.selectionStart)??Q.length}}function $l(f){const v=Mr.current,w=v.at(-1);(w==null?void 0:w.content)===f.content&&w.selectionStart===f.selectionStart&&w.selectionEnd===f.selectionEnd||(v.push(f),v.length>Ov&&v.shift(),pn.current=[])}function er(f,v){let w=0;const A=Math.min(f.length,v.length);for(;w<A&&f[w]===v[w];)w+=1;let N=f.length,W=v.length;for(;N>w&&W>w&&f[N-1]===v[W-1];)N-=1,W-=1;const me=f.slice(w,N),Xe=v.slice(w,W),Me=Xe&&!me?"insert":me&&!Xe?"delete":"replace",Ke=Xe.at(-1)??"";return{kind:Me,boundaryAfter:Me==="insert"&&/[\s.,:;()[\]{}'"`+\-*/%=<>!?]/.test(Ke)}}function hi(f,v){if(v!=="typing")return Lt.current=null,!0;const w=Date.now(),A=er(Q,f),N=Lt.current,W=N!==null&&N.path===Z&&N.source===de&&N.kind===A.kind&&N.kind!=="replace"&&!N.boundaryAfter&&w-N.at<=Lv;return Lt.current={path:Z,source:de,kind:A.kind,at:w,boundaryAfter:A.boundaryAfter},!W}function ll(f){qe(f.content),te(v=>({...v,[Wt(de,Z)]:f.content})),fn(""),He(null),window.requestAnimationFrame(()=>{const v=gt.current;v&&(v.focus(),v.selectionStart=Math.min(f.selectionStart,f.content.length),v.selectionEnd=Math.min(f.selectionEnd,f.content.length))})}function mr(){const f=Mr.current.pop();return f?(Lt.current=null,pn.current.push(rl()),ll(f),!0):!1}function Ma(){const f=pn.current.pop();return f?(Lt.current=null,Mr.current.push(rl()),ll(f),!0):!1}function Sn(f,v=(W=>(W=gt.current)==null?void 0:W.selectionStart)()??f.length,w=rl(),A=v,N="programmatic"){w&&f!==Q&&hi(f,N)&&$l(w),qe(f),te(me=>({...me,[Wt(de,Z)]:f})),fn(""),Vt(f,v),window.requestAnimationFrame(()=>{const me=gt.current;me&&(me.selectionStart=Math.min(v,f.length),me.selectionEnd=Math.min(A,f.length))})}function al(f,v=de){te(w=>{const A=Wt(v,f);if(!(A in w))return w;const N={...w};return delete N[A],N})}function ja(){return Jt[Z]===Q}function Bt(f,v){dn(w=>({...w,[f]:v}))}function pi(f,v){Bt(f,v),te(w=>({...w,[Wt("pico",f)]:v})),de==="pico"&&Z===f&&qe(v)}function Ht(){re([]),pe([]),dn({}),te({}),He(null),we(f=>{const v=ic(rc());if(v.find(N=>N.path===f))return f;const A=v[0];return Re("local"),qe(A.content),nl(),A.path})}function ft(f){hr(),ne({value:100,label:f}),fr.current=window.setTimeout(()=>{fr.current=null,ne(null)},900)}function hr(){fr.current!==null&&(window.clearTimeout(fr.current),fr.current=null)}function Yl(){return ke?u.jsxs("div",{className:"ide-task-progress",role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":Math.round(ke.value),children:[u.jsxs("div",{children:[u.jsx("span",{children:ke.label}),u.jsxs("strong",{children:[Math.round(ke.value),"%"]}),ke.cancellable&&u.jsx("button",{className:"ide-task-cancel",type:"button",onClick:Tc,"aria-label":"Stop handling",title:"Stop",children:u.jsx(Ot,{name:"delete",size:18})})]}),u.jsx("b",{"aria-hidden":"true",children:u.jsx("i",{style:{width:`${Math.max(2,Math.min(100,ke.value))}%`}})})]}):null}function Tc(){tn.current&&Ar("Stopper læsning...",!0,!0)}function Ar(f="Stopper læsning...",v=!1,w=!1){var A;hr(),Tr.current=null,Sr.current+=1,(A=tn.current)==null||A.abort(),tn.current=null,Er.current=null,ue(null),I(!1),ne(v?{value:(ke==null?void 0:ke.value)??0,label:f,cancellable:!1}:null),w&&G("warning","Stopper BLE-læsning efter den aktuelle datapakke.")}function gi(f){var v;if(!(Er.current===f||Tr.current===f)){if(Tr.current=f,Ln.current){Sr.current+=1,(v=tn.current)==null||v.abort(),tn.current=null,Er.current=null,mi(f),ue(f),I(!0),hr(),ne({value:2,label:`Skifter til ${De(f)}...`,cancellable:!0});return}il()}}function il(){if(Ln.current)return;const f=Tr.current;if(!f)return;Tr.current=null;const v=Sr.current+1;Sr.current=v;const w=new AbortController;tn.current=w,Er.current=f,mi(f),ue(f),I(!0),hr(),ne({value:12,label:`Indlæser ${De(f)}...`,cancellable:!0});const A=(async()=>{try{const N=await _(f,(W,me)=>{Sr.current===v&&ne({value:W,label:me,cancellable:!0})},w.signal);if(w.signal.aborted||Sr.current!==v)return;ot(f,N,"pico"),Bt(f,N),ft("Fil indlæst")}catch(N){if(Sr.current!==v)return;Hv(N)||w.signal.aborted?G("info",`Stoppede læsning af ${De(f)}.`):(ne(null),G("error",N instanceof Error?N.message:"BLE læsning fejlede."))}})();Ln.current=A,A.finally(()=>{if(Ln.current!==A)return;Ln.current=null,tn.current===w&&(tn.current=null),Er.current===f&&(Er.current=null),!!Tr.current||(ue(null),I(!1),w.signal.aborted&&ne(null)),il()})}async function Cr(f){const v=hn.current;hn.current=!0;try{return await f()}finally{hn.current=v}}j.useEffect(()=>{if(!Ul)return;const f=ba.current;f&&(f.scrollTop=f.scrollHeight)},[R,Ul]),j.useEffect(()=>{G2({clearTerminalOnRun:Wn,simplifiedErrors:or})},[Wn,or]),j.useEffect(()=>{var f;Nr.some(v=>v.version===Ve)||Kn(((f=Nr[0])==null?void 0:f.version)??"")},[Nr,Ve]),j.useEffect(()=>{di(ph(navigator))},[]),j.useEffect(()=>{const f=()=>{const v=Pl.current;Zn.current=null,et.current=null,Pl.current=null,v==null||v.disconnect().catch(()=>{})};return window.addEventListener("pagehide",f),()=>{var v,w;hr(),(v=dt.current)==null||v.dispose(),dt.current=null,(w=dr.current)==null||w.dispose(),dr.current=null,window.removeEventListener("pagehide",f),f()}},[]),j.useEffect(()=>{const f=v=>{!(v.ctrlKey||v.metaKey)||v.key.toLowerCase()!=="s"||(v.preventDefault(),!P&&Z.trim()&&!Vl&&!ie&&!O&&!q&&Ls())};return window.addEventListener("keydown",f),()=>window.removeEventListener("keydown",f)},[de,je,P,x,Q,Z,Vl,ie,O,q]);function Xl(f,v,w){ae(A=>{const N=Id(A,f,v,w);return fs(N),N})}function Cs(f,v){ae(w=>{const A=w.find(Me=>Me.path===f),W=en[Wt("local",f)]??(A==null?void 0:A.content),me=W!==void 0&&Dl(W)!==Dl(v)?Id(w,Jv(f,dc(w)),W,!1):w,Xe=Id(me,f,v,!1);return fs(Xe),Xe}),te(w=>({...w,[Wt("local",f)]:v})),de==="local"&&Z===f&&(qe(v),fn(""),He(null),nl())}const _i=nb(Y,fe,en,x||je);j.useEffect(()=>{je&&_t()},[je]),j.useEffect(()=>{const f=Rs.current;f&&f!==Fl&&Ht(),Rs.current=Fl},[Fl]);async function Mc(){if(jr.supported){C(!0);try{await ka.requestAndConnect();const f=new H_(ka);Zn.current=f,et.current=new $_(f),k(!0),Ee(0),await f.interrupt(),await vi(f),G("success","Sendte stop-signal til Pico-terminalen."),await bi(et.current),await Ds(et.current)}catch(f){G("error",f instanceof Error?f.message:"USB-forbindelse mislykkedes.");try{await ka.disconnect()}catch(v){G("error",v instanceof Error?`USB-porten kunne ikke lukkes: ${v.message}`:"USB-porten kunne ikke lukkes.");return}Ee(v=>{const w=v+1;return w>=3&&(G("info","USB-forbindelsen er mislykkedes flere gange. Hvis Picoen er i BOOTSEL eller mangler MicroPython, kan du bruge MicroPython-download."),le(!0)),w}),k(!1)}finally{C(!1)}}}async function vi(f){const v=await f.exec(`import sys
print(sys.implementation.name)
`,4e3);if(v.error||!v.output.toLowerCase().includes("micropython"))throw new Error("MicroPython blev ikke fundet på Picoen.")}async function jc(){var f;try{await((f=Pl.current)==null?void 0:f.disconnect()),Zn.current=null,et.current=null,k(!1),Ht()}catch(v){G("error",v instanceof Error?`USB-porten kunne ikke lukkes: ${v.message}`:"USB-porten kunne ikke lukkes.")}}async function Bn(f){const v=et.current;if(v){I(!0),hn.current=!0;try{await f(v)}catch(w){ne(null),G("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{hn.current=!1,I(!1)}}}async function _t(f=!0){if(je){I(!0);try{const v=await p();re(v),f&&G("success",`Indlæste ${v.length} filer fra Pico via Bluetooth.`)}catch(v){G("error",v instanceof Error?v.message:"BLE filhandling fejlede.")}finally{I(!1)}return}await bi(et.current,f)}async function bi(f,v=!0){if(f){I(!0);try{const w=await Cr(()=>f.list("/"));re(w),v&&G("success",`Indlæste ${w.length} filer fra Pico.`)}catch(w){G("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{I(!1)}}}async function Kl(){if(je){I(!0),ne({value:4,label:"Tjekker biblioteker på Pico via Bluetooth..."});try{const f=await yi((v,w)=>ne({value:v,label:w}));pe(f),ft("Fil-tjek færdigt")}catch(f){ne(null),G("error",f instanceof Error?f.message:"BLE runtime check fejlede.")}finally{I(!1)}return}await Ds(et.current)}async function yi(f){const v=[],w=li.filter(N=>N.kind==="library"&&!Ol(N));let A=0;for(const N of li){if(N.kind==="program"){v.push({...N,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}if(Ol(N)){v.push({...N,status:"unknown",detail:"Opdateres via USB"});continue}try{const W=A/Math.max(1,w.length)*100,me=100/Math.max(1,w.length);G("info",`Tjekker ${N.label} på Pico via Bluetooth...`),f==null||f(Math.min(95,W),`Tjekker ${N.label} på Pico...`);const Xe=await _(N.path,(Ke,vt)=>{f==null||f(Math.min(95,W+Ke/100*me),`${N.label}: ${vt}`)}),Me=Dl(Xe)===Dl(N.content);v.push({...N,status:Me?"ok":"outdated",detail:Me?"Matcher appens version":"Kan installeres via Bluetooth"})}catch{v.push({...N,status:"missing",detail:"Mangler på Pico"})}finally{A+=1}}return f==null||f(100,"Fil-tjek færdigt"),v}async function Ds(f){if(f){I(!0);try{const v=await Cr(()=>Os(f)),w=v;pe(w)}catch(v){G("error",v instanceof Error?v.message:"Runtime check fejlede.")}finally{I(!1)}}}async function Os(f){if(!f)return[];const v=[];for(const w of li){if(w.kind==="program"){v.push({...w,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}try{const A=await f.readText(w.path),N=Dl(A)===Dl(w.content);v.push({...w,status:N?"ok":"outdated",detail:N?"Matcher appens version":"Matcher ikke appens version"})}catch{v.push({...w,status:"missing",detail:"Mangler på Pico"})}}return v}async function Nc(f=Z){if(je){gi(f);return}ue(f),await Bn(async v=>{ne({value:12,label:`Indlæser ${De(f)}...`});const w=await Rc(v,f);ot(f,w,"pico"),Bt(f,w),ft("Fil indlæst")}),ue(null)}async function Rc(f,v){var w;try{return await f.readText(v)}catch(A){await((w=Zn.current)==null?void 0:w.stop().catch(()=>{})),await Bv(120);try{return await f.readText(v)}catch{throw A}}}function wi(){ve(!0)}async function Ls(){if(de==="pico"){if(!x&&!je){G("error","Ingen Pico-forbindelse. Brug Gem for at vælge en anden placering.");return}await xi();return}Bs()}function Bs(){if(Ll(Z)){G("error",_s);return}Xl(Z,Q,!1),Re("local"),te(f=>({...f,[Wt("local",Z)]:Q})),ve(!1),G("success",`Gemte ${De(Z)} lokalt.`)}async function xi(){if(ve(!1),Ll(Z))return ne(null),G("error",_s),!1;if(ne({value:0,label:"Starter gemning..."}),je){I(!0);try{return await m(Z,Q,(v,w)=>ne({value:v,label:w})),Bt(Z,Q),Re("pico"),te(v=>({...v,[Wt("pico",Z)]:Q})),ft("Gemt på Pico via Bluetooth"),G("success",`Gemte ${De(Z)} på Pico via Bluetooth.`),ac(Z)&&(xn(!0),G("warning","main.py er gemt. Genstart Picoen for at køre den nye version.")),await _t(!1),!0}catch(v){return ne(null),G("error",v instanceof Error?v.message:"BLE gem fejlede."),!1}finally{I(!1)}}if(!et.current)return ne(null),!1;let f=!1;return await Bn(async v=>{Wl(Z,"pico")?await v.replaceTextSafely(Z,Q,(w,A)=>ne({value:w,label:A})):await v.writeText(Z,Q,(w,A)=>ne({value:w,label:A})),Bt(Z,Q),Re("pico"),te(w=>({...w,[Wt("pico",Z)]:Q})),ft("Gemt på Pico via USB"),G("success",`Gemte ${Z}.`),await _t(),await Kl(),f=!0}),f}function zs(){Us(De(Z),Q),ve(!1),G("success",`Downloadede ${De(Z)}.`)}function Us(f,v){const w=new Blob([v],{type:"text/plain;charset=utf-8"}),A=URL.createObjectURL(w),N=document.createElement("a");N.href=A,N.download=f,N.click(),URL.revokeObjectURL(A)}async function qs(f){I(!0),xn(!1),ne({value:10,label:"Genstarter Pico..."});try{await b(f)?(ft("Pico genforbundet"),G("success",f==="control"?"Pico genforbundet. Åbner kontrolpanelet.":"Pico genforbundet til Kodeværkstedet."),f==="ide"&&await _t()):(ne(null),G("warning","Automatisk genforbindelse lykkedes ikke. Vælg Picoen fra dashboardet."))}catch(v){ne(null),G("error",v instanceof Error?v.message:"Genstart/genforbindelse mislykkedes.")}finally{I(!1)}}function Hs(f){var W,me;const v=f??{path:Z,source:de},w=v.source==="pico"?"Pico":"browser",A=(f==null?void 0:f.versions.length)??(v.source==="pico"?((W=ai(Y).get(v.path))==null?void 0:W.length)??0:((me=ai(dc(fe)).get(v.path))==null?void 0:me.length)??0),N=A>0?` Det sletter også filens versionshistorik (${A} gemte versioner).`:"";J(null),l({title:"Slet fil",message:`Vil du slette ${De(v.path)} fra ${w}?${N}`,confirmLabel:"Slet",onConfirm:()=>{Dc(v)}})}function Ac(){l({title:"Nulstil enhed",message:"Vil du nulstille Picoens enhedsindstillinger? Det sletter DeviceSettings.txt, så Picoen kan oprettes som en ny enhed igen. Kodefiler og startprogram bliver ikke slettet.",confirmLabel:"Nulstil",onConfirm:()=>{Cc()}})}async function Cc(){if(!et.current){G("error","Forbind Picoen med USB først.");return}await Bn(async f=>{await f.delete("/DeviceSettings.txt").catch(v=>{const w=v instanceof Error?v.message:"";if(!/ENOENT|No such file|not found/i.test(w))throw v}),dn(v=>{const w={...v};return delete w["/DeviceSettings.txt"],w}),al("/DeviceSettings.txt","pico"),G("success","DeviceSettings.txt er nulstillet. Afbryd og forbind Picoen igen, hvis kontrolpanelet allerede var åbent."),await _t()})}function Vs(f,v,w){const A=_i.filter(me=>me.kind==="file"&&me.type==="file"),N=A.findIndex(me=>me.path===f&&me.source===v);if(N===-1)return null;const W=me=>!!me&&!(me.path===f&&me.source===v)&&!(me.source===v&&w.has(me.path))&&!(je&&Ol(me));for(const me of[!0,!1])for(let Xe=1;Xe<A.length;Xe+=1){const Me=A[N+Xe];if(W(Me)&&(!me||Me.source===v))return Me;const Ke=A[N-Xe];if(W(Ke)&&(!me||Ke.source===v))return Ke}return null}function ki(f){if(f){Ys(f);return}const v=ic(rc())[0];ot(v.path,en[Wt("local",v.path)]??v.content,"local")}async function Dc(f){const v=f.path,w=f.source,A=v===Z&&w===de;if(w==="local"){const Me=ai(dc(fe)).get(v)??[],Ke=new Set([v,...Me.map(mt=>mt.path)]),vt=A?Vs(v,w,Ke):null,nn=fe.filter(mt=>!Ke.has(mt.path));ae(nn),fs(nn);for(const mt of Ke)al(mt,"local");A&&ki(vt);const ze=Me.length>0?` og ${Me.length} gemte versioner`:"";G("warning",`Slettede ${De(v)}${ze} fra browseren.`);return}const N=ai(Y).get(v)??[],W=[v,...N.map(Me=>Me.path)],me=A?Vs(v,w,new Set(W)):null;if(je){I(!0);try{for(const Ke of W)await g(Ke);dn(Ke=>{const vt={...Ke};for(const nn of W)delete vt[nn];return vt});for(const Ke of W)al(Ke,"pico");const Me=N.length>0?` og ${N.length} gemte versioner`:"";G("warning",`Slettede ${De(v)}${Me} på Pico via Bluetooth.`),await _t(),A&&ki(me)}catch(Me){G("error",Me instanceof Error?Me.message:"BLE sletning fejlede.")}finally{I(!1)}return}if(!et.current){G("error","Ingen Pico-forbindelse. Kan ikke slette Pico-filen.");return}let Xe=!1;await Bn(async Me=>{for(const vt of W)await Me.delete(vt);dn(vt=>{const nn={...vt};for(const ze of W)delete nn[ze];return nn});const Ke=N.length>0?` og ${N.length} gemte versioner`:"";G("warning",`Slettede ${v}${Ke}.`);for(const vt of W)al(vt,"pico");await _t(),await Kl(),Xe=!0}),Xe&&A&&ki(me)}async function Oc(f){if(!f)return;const v=Uv(f.name);if(!v){G("error","Kun .py, .txt, .json og .csv kan importeres.");return}if(Ll(v)){G("error",_s);return}if(f.size>128*1024){G("error","Filen er for stor til Pico-værkstedet.");return}const w=await f.text();if(de==="local"){Xl(v,w,!0),ot(v,w,"local"),G("success",`Importerede ${De(v)} i browseren.`);return}if(!x&&!je){G("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(je&&Ol({path:v})){G("error","PicoBluetooth.py kan ikke importeres over Bluetooth, mens den holder forbindelsen i gang. Brug USB i stedet.");return}if(ne({value:0,label:"Uploader fil til Pico..."}),je){I(!0);try{await m(v,w,(N,W)=>ne({value:N,label:W})),Bt(v,w),ot(v,w,"pico"),ft("Fil uploadet til Pico"),G("success",`Importerede ${De(v)} på Pico via Bluetooth.`),await _t()}catch(N){ne(null),G("error",N instanceof Error?N.message:"Kunne ikke importere filen til Pico.")}finally{I(!1)}return}if(!et.current){ne(null),G("error","Ingen Pico-forbindelse. Kan ikke importere filen til Pico.");return}await Bn(async N=>{Wl(v,"pico")?await N.replaceTextSafely(v,w,(W,me)=>ne({value:W,label:me})):await N.writeText(v,w,(W,me)=>ne({value:W,label:me})),Bt(v,w),ot(v,w,"pico"),ft("Fil uploadet til Pico"),G("success",`Importerede ${De(v)} på Pico.`),await _t(),await Kl()})}async function Si(){Ae(""),ee(!0)}function Ql(){const f=fh(he);if(!f)return;if(Ll(f)){G("error",_s);return}const v=de;if(Wl(f,v)){G("error",`Der findes allerede en fil med navnet ${De(f)} i ${v==="pico"?"Pico":"browseren"}.`);return}if(v==="local"){Xl(f,"",!1),ot(f,"","local"),ee(!1),G("success",`Oprettede ${De(f)} i browseren.`);return}Lc(f)}async function Lc(f){if(!x&&!je){G("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(ee(!1),ne({value:0,label:"Opretter fil på Pico..."}),je){I(!0);try{await m(f,"",(v,w)=>ne({value:v,label:w})),Bt(f,""),ot(f,"","pico"),ft("Fil oprettet på Pico"),G("success",`Oprettede ${De(f)} på Pico via Bluetooth.`),await _t()}catch(v){ne(null),G("error",v instanceof Error?v.message:"Kunne ikke oprette fil på Pico.")}finally{I(!1)}return}if(!et.current){ne(null),G("error","Ingen Pico-forbindelse. Kan ikke oprette Pico-filen.");return}await Bn(async v=>{await v.writeText(f,"",(w,A)=>ne({value:w,label:A})),Bt(f,""),ot(f,"","pico"),ft("Fil oprettet på Pico"),G("success",`Oprettede ${De(f)} på Pico.`),await _t()})}function Ps(f){f.type==="file"&&(J(f),E(qv(f.path)))}async function Is(f){if(!O)return;const v=O.path;if(J(null),O.source==="local"){const w=fe.find(A=>A.path===f.path);if(!w){G("error","Kunne ikke finde versionen i browseren.");return}Cs(v,w.content),ot(v,w.content,"local"),G("success",`Gendannede ${De(f.path)} i browseren.`);return}if(ne({value:0,label:"Gendanner version..."}),je){I(!0);try{const w=await _(f.path);await m(v,w,(A,N)=>ne({value:A,label:N})),Bt(v,w),ot(v,w,"pico"),ft("Version gendannet"),await _t(!1)}catch(w){ne(null),G("error",w instanceof Error?w.message:"Kunne ikke gendanne versionen.")}finally{I(!1)}return}et.current&&await Bn(async w=>{await w.replaceTextSafely(v,await w.readText(f.path),(N,W)=>ne({value:N,label:W}));const A=await w.readText(v);Bt(v,A),ot(v,A,"pico"),ft("Version gendannet"),await _t()})}function Fs(f){const v=(O==null?void 0:O.source)==="local"?"browseren":"Pico";l({title:"Slet version",message:`Vil du slette ${De(f.path)} fra ${v}?`,confirmLabel:"Slet",onConfirm:()=>{Gs(f)}})}async function Gs(f){if((O==null?void 0:O.source)==="local"){const v=fe.filter(w=>w.path!==f.path);ae(v),fs(v),al(f.path,"local"),J(w=>w&&{...w,versions:w.versions.filter(A=>A.path!==f.path)}),G("warning",`Slettede ${De(f.path)} fra browserens versionshistorik.`);return}if(je){I(!0);try{await g(f.path),await _t(!1),J(v=>v&&{...v,versions:v.versions.filter(w=>w.path!==f.path)})}catch(v){G("error",v instanceof Error?v.message:"Kunne ikke slette versionen.")}finally{I(!1)}return}et.current&&await Bn(async v=>{await v.delete(f.path),await _t(!1),J(w=>w&&{...w,versions:w.versions.filter(A=>A.path!==f.path)})})}async function $s(){var w;if(!O)return;const f=O,v=eb(f.path,A=>Wl(A,f.source));if(!v){G("error",`Kunne ikke finde et ledigt filnavn til en kopi af ${De(f.path)}.`);return}if(f.source==="local"){const A=en[Wt("local",f.path)]??((w=fe.find(N=>N.path===f.path))==null?void 0:w.content)??"";Xl(v,A,!1),ot(v,A,"local"),J(null),G("success",`Duplikerede ${De(f.path)} til ${De(v)} i browseren.`);return}if(J(null),ne({value:0,label:"Duplikerer fil..."}),je){I(!0);try{const A=Jt[f.path]??await _(f.path);await m(v,A,(N,W)=>ne({value:N,label:W})),Bt(v,A),ot(v,A,"pico"),ft("Fil duplikeret"),await _t(!1),G("success",`Duplikerede ${De(f.path)} til ${De(v)} på Pico via Bluetooth.`)}catch(A){ne(null),G("error",A instanceof Error?A.message:"Kunne ikke duplikere filen.")}finally{I(!1)}return}if(!et.current){ne(null),G("error","Ingen Pico-forbindelse. Kan ikke duplikere Pico-filen.");return}await Bn(async A=>{const N=await A.readText(f.path);await A.writeText(v,N,(W,me)=>ne({value:W,label:me})),Bt(v,N),ot(v,N,"pico"),ft("Fil duplikeret"),await _t(!1),G("success",`Duplikerede ${De(f.path)} til ${De(v)} på Pico.`)})}async function sl(){if(!O)return;const f=O,v=Pd(ge,vs(f.path));if(!v||v===f.path)return;if(Ll(v)){G("error",_s);return}if(Wl(v,f.source)){G("error",`Der findes allerede en fil med navnet ${De(v)}.`);return}const w=f.source==="local",A=f.source==="pico";if(je&&A&&(ac(f.path)||ac(v))){G("error","main.py kan redigeres over Bluetooth, men ikke omdøbes. Gem den som main.py.");return}I(!0);try{if(A)if(je){const N=Jt[f.path]??await _(f.path);await m(v,N,(W,me)=>ne({value:W,label:me})),await g(f.path),dn(W=>({...wh(W,f.path,v),[v]:N}))}else et.current&&(await Cr(()=>et.current.rename(f.path,v)),dn(N=>wh(N,f.path,v)));w&&ae(N=>{const W=N.map(me=>me.path===f.path?{...me,path:v,updatedAt:Date.now()}:me);return fs(W),W}),Z===f.path&&de===f.source&&we(v),te(N=>ab(N,f.source,f.path,v)),J(null),E(""),G("success",`Omdøbte ${De(f.path)} til ${De(v)}.`),A&&await _t()}catch(N){G("error",N instanceof Error?N.message:"Kunne ikke omdøbe filen.")}finally{ne(null),I(!1)}}function Wl(f,v){return v==="pico"?Y.some(w=>w.path===f):fe.some(w=>w.path===f)}function Ys(f){if(f.type!=="file"){je&&Ar(void 0,!1),we(f.path),Re(f.source);return}if(je&&Ol(f)){G("warning","PicoBluetooth.py holder Bluetooth-forbindelsen i gang og kan ikke åbnes her.");return}if(f.source==="local"){je&&Ar(void 0,!1);const w=fe.find(A=>A.path===f.path);ot(f.path,en[Wt("local",f.path)]??(w==null?void 0:w.content)??"","local");return}const v=Wt("pico",f.path);if(Object.prototype.hasOwnProperty.call(en,v)){je&&Ar(void 0,!1),ot(f.path,en[v],"pico");return}if(Object.prototype.hasOwnProperty.call(Jt,f.path)){je&&Ar(void 0,!1),ot(f.path,Jt[f.path],"pico");return}Nc(f.path)}async function Xs(){if(!x&&!je){const f=mh();pe(f),L(hh(f)),Ue(!0),ne(null);return}I(!0),ne({value:4,label:je?"Tjekker biblioteker på Pico via Bluetooth...":"Tjekker biblioteker på Pico..."}),G("info",je?"Tjekker om Picoens biblioteker er opdaterede via Bluetooth før installation...":"Tjekker om Picoens biblioteker er opdaterede før installation...");try{const f=Be.length>0?Be:je?await yi((v,w)=>ne({value:v,label:w})):await Cr(()=>Os(et.current));pe(f),L(hh(f)),Ue(!0),ne(null)}catch(f){ne(null),G("error",f instanceof Error?f.message:"Fil-tjek før installation fejlede.")}finally{I(!1)}}async function Ks(){if(Ue(!1),je){I(!0);try{const v=(Be.length>0?Be:li.map(A=>({...A,status:"unknown",detail:"Ikke tjekket"}))).filter(A=>Ft[A.id]&&!Ol(A));if(v.length===0){G("info","Ingen filer valgt til installation.");return}let w=null;ne({value:0,label:"Starter installation..."});for(const[A,N]of v.entries()){G("info",`Installerer ${N.label} via Bluetooth...`);const W=A/v.length*100,me=100/v.length;await m(N.path,N.content,(Xe,Me)=>{ne({value:Math.min(99,W+Xe/100*me),label:`${N.label}: ${Me}`})}),pi(N.path,N.content),G("success",`Installerede ${N.label}.`),N.kind==="library"&&(w=N),ac(N.path)&&xn(!0)}ft("Installation færdig"),await _t(!1),await Kl(),w&&Qs(w)}catch(f){ne(null),G("error",f instanceof Error?f.message:"BLE installation fejlede.")}finally{I(!1)}return}await Bn(async f=>{const w=(Be.length>0?Be:li.map(N=>({...N,status:"unknown",detail:"Ikke tjekket"}))).filter(N=>Ft[N.id]);if(w.length===0){G("info","Ingen filer valgt til installation.");return}let A=null;ne({value:0,label:"Starter installation..."});for(const[N,W]of w.entries()){G("info",`Installerer ${W.label}...`);const me=N/w.length*100,Xe=100/w.length,Me=await f.readText(W.path).catch(()=>null);Me!==null&&Dl(Me)===Dl(W.content)?(ne({value:Math.min(99,me+Xe),label:`${W.label}: Allerede nyeste version`}),G("info",`${W.label} findes allerede i samme version.`)):(await f.replaceTextSafely(W.path,W.content,(Ke,vt)=>{ne({value:Math.min(99,me+Ke/100*Xe),label:`${W.label}: ${vt}`})},{createBackup:!0}),G("success",`Installerede ${W.label}.`)),pi(W.path,W.content),W.kind==="library"&&(A=W)}ft("Installation færdig"),await _t(!1),await Kl(),A&&Qs(A)})}function Ei(){return(Be.length>0?Be:mh()).filter(v=>Ft[v.id])}function Zl(){const f=Ei();if(f.length===0){G("info","Ingen filer valgt.");return}for(const v of f)Cs(v.path,v.content);Ue(!1),G("success",`Gemte ${f.length} filer i browseren.`)}function Jl(){const f=Ei();if(f.length===0){G("info","Ingen filer valgt.");return}f.forEach((v,w)=>{window.setTimeout(()=>{Us(De(v.path),v.content)},w*120)}),Ue(!1),G("success",`Starter download af ${f.length} filer.`)}function Qs(f){ot(f.path,f.content,"pico"),Bt(f.path,f.content),G("info",`Åbnede ${f.label} i editoren.`)}function Na(f,v){L(w=>{if(f.kind!=="program")return{...w,[f.id]:v};const A={...w};for(const N of Be)N.kind==="program"&&(A[N.id]=!1);return A[f.id]=v,A})}async function Ws(){if(zc(),je&&de==="pico"){G("warning","Bluetooth holder forbindelsen åben, så koden kan ikke køres direkte her. Gem filen, og genstart Picoen for at køre den.");return}if(de==="local"){await Zs();return}const f=Zn.current;if(!f){G("error",`${De(Z)} er gemt på Picoen, men der er ingen USB-forbindelse til Pico-terminalen.`);return}if(Z.endsWith(".py")){if(!ja()&&(G("info",`${De(Z)} har ikke gemte ændringer. Gemmer på Picoen før kørsel...`),!await xi())){G("error","Pico-forbindelsen blev afbrudt under gemning.");return}if(P)return;on(),an.current="",jt(!0);try{await f.runFile(Z,()=>{on(),an.current="",On.current=!1,wr(!0),mn.current=!0}),G("success",`Kører ${De(Z)}. Brug Stop for at afbryde.`)}catch(v){wr(!1),mn.current=!1,on(),an.current="",G("error",v instanceof Error?v.message:"Kunne ikke starte koden.")}return}I(!0);try{const v=await f.exec(Q,2e4);v.output.trim()&&G("info",v.output),v.error.trim()&&Jn(v.error,Q),!v.output.trim()&&!v.error.trim()&&G("success","Koden kørte uden output.")}catch(v){G("error",v instanceof Error?v.message:"Kunne ikke køre koden.")}finally{I(!1)}}async function Zs(){const f=Qd(Q,{allowInput:!0});if(f.some(A=>A.level==="error")){for(const A of f){const N=A.line?`Linje ${A.line}: `:"";G(A.level==="error"?"error":"warning",`${N}${A.text}`)}return}/\binput\s*\(/.test(Q)&&!Jh()&&G("warning","input() i browseren kræver at siden genindlæses. Opdater siden (F5) og prøv igen.");const v=new AbortController;ya.current=v;const w=new vv;dr.current=w,I(!0),zl(!0),xr(!1),jt(!0),G("info",x?"Starter Browser-MicroPython for browser-filen.":"Starter Browser-MicroPython. Forbind Pico med USB for at køre på selve Picoen.");try{const A=[],N=await w.run(Q,{timeoutMs:null,signal:v.signal,onOutput:Me=>{A.push(Me),G("info",Me)},onWaitingForInput:xr});for(const Me of N.issues){const Ke=Me.line?`Linje ${Me.line}: `:"";G(Me.level==="error"?"error":"warning",`${Ke}${Me.text}`)}const W=[...A,N.output].filter(Boolean).join(`
`).trim(),me=N.output.trim();!N.error.trim()&&Vv(W)?Jn(W,Q):(me&&G("info",me),N.error.trim()&&Jn(N.error,Q,N.unavailable?"warning":"error")),N.ok&&!W&&!N.error.trim()&&G("success","Browser-MicroPython kørte uden output.")}finally{ya.current=null,dr.current=null,w.dispose(),zl(!1),xr(!1),I(!1)}}async function Ti(){var v,w,A;if(un){(v=ya.current)==null||v.abort(),(w=dr.current)==null||w.stop(),G("warning","Stoppede Browser-MicroPython."),jt(!0);return}if(!Gt&&ql){(A=dt.current)==null||A.reset(),ir(!1),G("warning","Stoppede Browser-MicroPython-terminalen. Variablerne i browser-terminalen blev nulstillet."),jt(!0);return}const f=Zn.current;if(f)try{await f.stop(),G("warning","Stoppede koden på Pico.")}catch(N){G("error",N instanceof Error?N.message:"Kunne ikke stoppe koden.")}finally{wr(!1),mn.current=!1,on(),an.current="",jt(!0),Ta()}}function Mi(){const f=ba.current;if(!f)return;const v=f.scrollHeight-f.scrollTop-f.clientHeight<12;jt(v)}function Js(){F([]),jt(!0)}function eo(){window.requestAnimationFrame(()=>{const f=ba.current;f&&(f.scrollTop=f.scrollHeight)})}async function Ra(){const f=sn?bt:bt.trimEnd();if(sn){if(!Gt){const A=dr.current;if(!A){G("warning","Browser-MicroPython kører ikke lige nu."),zn();return}qt(""),jt(!0),Sc(f),A.sendInput(f),zn();return}const w=Zn.current;if(!w){G("warning","Pico-terminalen er ikke forbundet."),zn();return}qt(""),jt(!0);try{await w.sendProgramInput(f)}catch(A){G("error",A instanceof Error?A.message:"Kunne ikke sende input til Pico-koden.")}finally{zn()}return}if(!f.trim())return;if(Zt(w=>(w.at(-1)===f?w:[...w,f]).slice(-80)),el(null),St(null),xa){G("warning",Gt?"Tryk Stop, før du skriver i Pico-terminalen.":"Stop offline MicroPython, før du skriver i browser-terminalen."),zn();return}if(!Gt){const w=Qd(f);if(w.some(N=>N.level==="error")){for(const N of w){const W=N.line?"Linje "+N.line+": ":"";G(N.level==="error"?"error":"warning",W+N.text)}zn();return}const A=dt.current??new _v;dt.current=A,qt(""),ir(!0),jt(!0),G("info",">>> "+f);try{let N=!1;const W=await A.send(f,{timeoutMs:15e3,onOutput:Xe=>{N=!0,G("info",Xe)}}),me=W.output.trim();me&&!N&&G("info",me),W.error.trim()&&Jn(W.error,f,W.unavailable?"warning":"error")}catch(N){G("error",N instanceof Error?N.message:"Browser-MicroPython-terminalen fejlede.")}finally{ir(!1),zn()}return}if(je){G("warning","Terminalen bruger USB Serial. Bluetooth-forbindelsen kan vise filer, men kan ikke modtage frie terminalkommandoer."),zn();return}const v=Zn.current;if(!x||!v){G("warning","Forbind en microcontroller med USB for at skrive i MicroPython-terminalen."),zn();return}qt(""),ir(!0),jt(!0),On.current=!0,G("info",">>> "+f);try{await v.sendFriendlyLine(f)}catch(w){On.current=!1,G("error",w instanceof Error?w.message:"Kunne ikke sende kommando til MicroPython REPL.")}finally{ir(!1),zn()}}function zn(){window.requestAnimationFrame(()=>{const f=kr.current;if(!f||f.disabled)return;f.focus();const v=f.value.length;f.selectionStart=v,f.selectionEnd=v})}function to(f,v,w){if(w.length===0)return null;const A=x||je;return u.jsxs("div",{className:"ide-install-group",children:[u.jsxs("div",{className:"ide-install-group-head",children:[u.jsx("h3",{children:f}),u.jsx("p",{children:v})]}),u.jsx("div",{className:"ide-install-scroll",children:w.map(N=>{const W=je&&Ol(N);return u.jsxs("label",{className:`ide-install-row ${W?"disabled":""}`,children:[u.jsx("input",{type:"checkbox",checked:!!Ft[N.id],disabled:W,onChange:me=>Na(N,me.target.checked)}),u.jsxs("span",{children:[u.jsxs("strong",{children:[Bc(N),A&&N.kind==="library"&&u.jsx("em",{className:`ide-install-status status-${N.status}`,children:W?"USB":tb(N.status)})]}),u.jsx("small",{children:N.description})]})]},N.id)})})]})}function Bc(f){return f.kind==="program"?f.label.replace(/\s*\(main\.py\)$/i,""):f.label}function zc(){Wn&&F([]),jt(!0)}function ji(f,v){const w=f.indexOf(`
`,v);return w===-1?f.length:w}function Vt(f,v){if(_h(f,v)){He(null);return}const w=ef(f,v);if(!w||w.query.length<1){He(null);return}const A=gh(f,v,!0).slice(0,8),N=vh(gt.current,w.start,A.length);A.length>0&&N?(He({items:A,selected:0,start:w.start,end:v,position:N}),Or(va.current,0)):He(null)}function Dr(f,v){if(_h(f,v)){St(null);return}const w=ef(f,v);if(!w||w.query.length<1){St(null);return}const A=gh(f,v,!1).slice(0,8),N=vh(kr.current,w.start,A.length);A.length>0&&N?(St({items:A,selected:0,start:w.start,end:v,position:N}),Or(ur.current,0)):St(null)}function Ni(f){const v=f.value.slice(f.selectionStart,f.selectionEnd);fn(Xv(v)?v:"")}function Or(f,v){window.requestAnimationFrame(()=>{const w=f==null?void 0:f.querySelector(`[data-autocomplete-index="${v}"]`);w==null||w.scrollIntoView({block:"nearest"})})}function Aa(f=_e==null?void 0:_e.items[_e.selected]){if(!f||!_e)return;const v=rl(),w=Q.slice(0,_e.start)+f.insert+Q.slice(_e.end),A=_e.start+f.insert.length-(f.insert.endsWith("()")?1:0);He(null),Sn(w,A,v),window.requestAnimationFrame(()=>{const N=gt.current;N&&N.focus()})}function Ri(f=Ye==null?void 0:Ye.items[Ye.selected]){if(!f||!Ye)return;const v=bt.slice(0,Ye.start)+f.insert+bt.slice(Ye.end),w=Ye.start+f.insert.length-(f.insert.endsWith("()")?1:0);qt(v),St(null),window.requestAnimationFrame(()=>{const A=kr.current;A&&(A.focus(),A.selectionStart=w,A.selectionEnd=w)})}function Ai(f){const v=gt.current;if(!v)return!1;const w=v.selectionStart,A=v.selectionEnd,N={content:Q,selectionStart:w,selectionEnd:A},W=Q.lastIndexOf(`
`,w-1)+1,me=A>w&&Q[A-1]===`
`?A-1:A,Xe=ji(Q,me),Me=Xe<Q.length?Xe+1:Xe,Ke=Q.slice(W,Me);if(f<0){if(W===0)return!1;const Un=Q.lastIndexOf(`
`,W-2)+1,qn=Q.slice(Un,W),pr=Q.slice(0,Un)+Ke+qn+Q.slice(Me),Pt=-qn.length;return Sn(pr,w+Pt,N,A+Pt),!0}if(Me>=Q.length)return!1;const vt=ji(Q,Me),nn=vt<Q.length?vt+1:vt,ze=Q.slice(Me,nn),mt=Q.slice(0,W)+ze+Ke+Q.slice(nn),Lr=ze.length;return Sn(mt,w+Lr,N,A+Lr),!0}function Uc(f){var nn;if(Gl){(f.key==="Enter"||f.key==="Tab"||(f.ctrlKey||f.metaKey)&&["z","y","s"].includes(f.key.toLowerCase()))&&f.preventDefault();return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="z"){f.preventDefault(),(f.shiftKey?Ma():mr())&&He(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="y"){f.preventDefault(),Ma()&&He(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="s"){f.preventDefault(),!P&&Z.trim()&&Ls();return}if(f.altKey&&!f.ctrlKey&&!f.metaKey&&(f.key==="ArrowUp"||f.key==="ArrowDown")){f.preventDefault(),Ai(f.key==="ArrowUp"?-1:1)&&He(null);return}if(_e){if(f.key==="ArrowDown"){f.preventDefault(),He(ze=>{if(!ze)return ze;const mt=(ze.selected+1)%ze.items.length;return Or(va.current,mt),{...ze,selected:mt}});return}if(f.key==="ArrowUp"){f.preventDefault(),He(ze=>{if(!ze)return ze;const mt=(ze.selected-1+ze.items.length)%ze.items.length;return Or(va.current,mt),{...ze,selected:mt}});return}if(f.key==="Tab"){f.preventDefault(),Aa();return}if(f.key==="Enter"){if(!(_e.items[_e.selected]&&rp(_e.items[_e.selected],Q.slice(_e.start,_e.end)))){f.preventDefault(),Aa();return}He(null)}if(f.key==="Escape"){f.preventDefault(),He(null);return}}if(f.key==="Enter"){f.preventDefault();const ze=f.currentTarget,mt=ze.selectionStart,Lr=ze.selectionEnd,Un={content:Q,selectionStart:mt,selectionEnd:Lr},qn=Q.lastIndexOf(`
`,mt-1)+1,pr=Q.slice(qn,mt),Pt=((nn=pr.match(/^[ \t]*/))==null?void 0:nn[0])??"",ea=pr.trimEnd().endsWith(":")?"    ":"",$t=`
${Pt}${ea}`,gr=Q.slice(0,mt)+$t+Q.slice(Lr),Br=mt+$t.length;Sn(gr,Br,Un),window.requestAnimationFrame(()=>{ze.selectionStart=Br,ze.selectionEnd=Br});return}if(f.key!=="Tab")return;f.preventDefault();const v=f.currentTarget,w=v.selectionStart,A=v.selectionEnd,N={content:Q,selectionStart:w,selectionEnd:A},W="    ";if(f.shiftKey){const ze=Q.lastIndexOf(`
`,w-1)+1,mt=w===A?ji(Q,w):A,Lr=Q.slice(ze,mt);let Un=0,qn=0;const pr=Lr.replace(/(^|\n)( {1,4}|\t)/g,(ea,$t,gr,Br)=>{const ta=gr.length;return ze+Br<w&&(Un+=ta),qn+=ta,$t});if(qn===0)return;const Pt=Q.slice(0,ze)+pr+Q.slice(mt);Sn(Pt,Math.max(ze,w-Un),N,w===A?Math.max(ze,w-Un):Math.max(ze,A-qn)),window.requestAnimationFrame(()=>{v.selectionStart=Math.max(ze,w-Un),v.selectionEnd=w===A?v.selectionStart:Math.max(v.selectionStart,A-qn)});return}if(w===A){const ze=Q.slice(0,w)+W+Q.slice(A);Sn(ze,w+W.length,N),window.requestAnimationFrame(()=>{v.selectionStart=w+W.length,v.selectionEnd=w+W.length});return}const me=Q.lastIndexOf(`
`,w-1)+1,Me=Q.slice(me,A).replace(/^/gm,W),Ke=Me.split(`
`).length,vt=Q.slice(0,me)+Me+Q.slice(A);Sn(vt,w+W.length,N,A+Ke*W.length),window.requestAnimationFrame(()=>{v.selectionStart=w+W.length,v.selectionEnd=A+Ke*W.length})}function ol(f){if(sn){f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),Ra());return}if(Ye){if(f.key==="ArrowDown"){f.preventDefault(),St(v=>{if(!v)return v;const w=(v.selected+1)%v.items.length;return Or(ur.current,w),{...v,selected:w}});return}if(f.key==="ArrowUp"){f.preventDefault(),St(v=>{if(!v)return v;const w=(v.selected-1+v.items.length)%v.items.length;return Or(ur.current,w),{...v,selected:w}});return}if(f.key==="Enter"||f.key==="Tab"){f.preventDefault(),Ri();return}if(f.key==="Escape"){f.preventDefault(),St(null);return}}if(f.key==="Tab"){f.preventDefault();const v=f.currentTarget,w=v.selectionStart,A=v.selectionEnd,N="    ",W=bt.slice(0,w)+N+bt.slice(A),me=w+N.length;qt(W),el(null),St(null),window.requestAnimationFrame(()=>{v.selectionStart=me,v.selectionEnd=me});return}if(f.key==="ArrowUp"||f.key==="ArrowDown"){if(!(f.key==="ArrowUp"?f.currentTarget.selectionStart===0&&f.currentTarget.selectionEnd===0:f.currentTarget.selectionStart===bt.length&&f.currentTarget.selectionEnd===bt.length)||kt.length===0)return;f.preventDefault();const w=f.key==="ArrowUp"?pt===null?kt.length-1:Math.max(0,pt-1):pt===null||pt+1>=kt.length?null:pt+1;el(w);const A=w===null?"":kt[w]??"";qt(A),St(null),jt(!0),window.requestAnimationFrame(()=>{const N=kr.current;N&&(N.selectionStart=A.length,N.selectionEnd=A.length,eo())});return}f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),Ra())}return u.jsxs("div",{className:"screen ide-screen",children:[u.jsx(uf,{title:"Pico Kodeværksted",onMenu:()=>a()}),Vl?u.jsx("div",{className:"ide-size-gate",role:"dialog","aria-modal":"true","aria-labelledby":"ide-size-title",children:u.jsxs("div",{className:"ide-size-gate-panel",children:[u.jsx("h2",{id:"ide-size-title",children:"Brug en bærbar for at bruge Kodeværkstedet"}),u.jsx("p",{children:"Denne skærm er for lille, så du skal åbne Kodeværkstedet på en bærbar eller en større skærm."})]})}):u.jsxs("div",{className:"ide-layout",children:[u.jsxs("section",{className:"ide-panel ide-files-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Filer"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:Si,"aria-label":"Ny fil",title:"Ny fil",children:u.jsx(Ot,{name:"plus",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>{var f;return(f=Nt.current)==null?void 0:f.click()},"aria-label":"Importer fil",title:"Importer fil",children:u.jsx(Ot,{name:"upload",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>_t(),disabled:!x&&!je||P,"aria-label":"Opdater filer",title:"Opdater filer",children:u.jsx(Ot,{name:"refresh",size:20})})]})]}),u.jsx("div",{className:"ide-file-list",children:_i.length===0?u.jsx("button",{type:"button",disabled:!0,children:"Ingen filer læst"}):_i.map(f=>{if(f.kind==="separator"){const N=f.id==="pico-files"&&!x&&!je;return u.jsxs(j.Fragment,{children:[u.jsx("div",{className:`ide-file-separator ${f.id==="browser-files"?"browser-section":""}`,children:u.jsx("span",{children:f.label})}),N&&u.jsx("div",{className:"ide-file-disconnected",role:"status",children:"Ikke forbundet"})]},f.id)}const v=je&&Ol(f),w=en[Wt(f.source,f.path)],A=w!==void 0&&w!==Zv(f,fe,Jt);return u.jsxs("div",{className:`ide-file-row ${Z===f.path&&de===f.source?"active":""} ${v?"protected":""}`,children:[u.jsxs("button",{type:"button",onClick:()=>Ys(f),disabled:v,title:v?"Holder Bluetooth-forbindelsen i gang og kan ikke åbnes her":void 0,children:[u.jsx("span",{children:f.name}),u.jsxs("small",{title:A?"Ikke gemte ændringer":"Ingen ikke gemte ændringer",children:[f.versions.length>0&&u.jsx("em",{className:"ide-file-version-count",title:`${f.versions.length} gemte versioner i historikken`,children:f.versions.length}),u.jsx("i",{className:`ide-file-dirty-dot ${A?"dirty":"clean"}`,"aria-hidden":"true"})]})]}),u.jsx("button",{className:"ide-file-actions",type:"button",onClick:()=>Ps(f),disabled:f.type!=="file"||P||v,"aria-label":`Filvalg for ${f.name}`,title:v?"Holder Bluetooth-forbindelsen i gang og kan ikke ændres her":"Filvalg",children:u.jsx(Ot,{name:"settings",size:16})})]},`${f.source}:${f.path}`)})})]}),u.jsxs("section",{className:"ide-panel ide-status-panel",children:[u.jsxs("div",{children:[u.jsxs("div",{className:"ide-status-head",children:[u.jsx("h2",{children:je?"Forbundet Pico":"USB udvikling"}),!je&&u.jsx("span",{className:`ide-usb-status ${jr.supported?"available":"unavailable"}`,title:jr.message,"data-tooltip":jr.message,role:"img","aria-label":jr.message,tabIndex:0,children:"!"})]}),je&&u.jsxs("p",{children:[(s==null?void 0:s.deviceName)??"Pico"," er forbundet via Bluetooth."]})]}),!je&&u.jsxs("div",{className:"ide-actions",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:x?jc:Mc,disabled:!jr.supported||M,children:M?"Forbinder...":x?"Afbryd USB":"Forbind USB"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:Xs,disabled:je||P,children:"Download"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:Ac,disabled:!x||P,children:"Nulstil enhed"})]}),je&&u.jsxs("div",{className:"ide-actions",children:[u.jsxs("button",{className:"btn btn-primary ide-connection-state",type:"button",disabled:!0,children:[u.jsx(Ot,{name:"power",size:22}),"Bluetooth forbundet"]}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:Xs,disabled:P,children:"Startprogrammer og biblioteker"})]}),!je&&u.jsx("div",{className:"ide-runtime",children:u.jsx("div",{className:"ide-mini-actions single",children:u.jsx("button",{className:"btn btn-outline ide-disconnect-btn",type:"button",onClick:()=>le(!0),children:"MicroPython"})})})]}),u.jsxs("section",{className:"ide-panel ide-editor-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("div",{className:"ide-editor-title",children:u.jsxs("h2",{children:[De(Z),u.jsxs("small",{children:[wa," bytes"]})]})}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Ws,disabled:P,children:"Kør"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Ti,disabled:!un&&!(!Gt&&ql)&&(!x||!Mt),children:"Stop"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:wi,disabled:P||!Z.trim(),children:"Gem"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Hs(),disabled:P||!Z.trim(),children:"Slet"})]})]}),Yl(),u.jsxs("div",{className:"ide-editor-wrap",children:[u.jsx("div",{ref:Il,className:"ide-line-numbers","aria-hidden":"true",style:{transform:`translateY(${-ar.top}px)`},children:Array.from({length:As},(f,v)=>u.jsx("span",{children:v+1},v))}),u.jsx("pre",{ref:cr,className:"ide-highlight","aria-hidden":"true",style:{transform:`translate(${-ar.left}px, ${-ar.top}px)`},children:Wv(Q,sr)}),u.jsx("textarea",{ref:gt,className:"ide-editor",value:Q,onChange:f=>Sn(f.target.value,f.target.selectionStart,rl(),f.target.selectionEnd,"typing"),onKeyDown:Uc,onKeyUp:f=>{["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(f.key)||Vt(f.currentTarget.value,f.currentTarget.selectionStart)},onClick:f=>{Vt(f.currentTarget.value,f.currentTarget.selectionStart),Ni(f.currentTarget)},onSelect:f=>Ni(f.currentTarget),onScroll:f=>{const{scrollTop:v,scrollLeft:w}=f.currentTarget;Il.current&&(Il.current.style.transform=`translateY(${-v}px)`),cr.current&&(cr.current.style.transform=`translate(${-w}px, ${-v}px)`),Qn({top:v,left:w}),_e&&Vt(f.currentTarget.value,f.currentTarget.selectionStart)},readOnly:Gl,"aria-busy":Gl,spellCheck:!1}),_e&&u.jsx("div",{ref:va,className:`ide-autocomplete placement-${_e.position.placement}`,role:"listbox","aria-label":"Kodeforslag",style:{left:_e.position.left,top:_e.position.top,maxHeight:_e.position.maxHeight},children:(_e.position.placement==="above"?_e.items.map((f,v)=>({item:f,index:v})).reverse():_e.items.map((f,v)=>({item:f,index:v}))).map(({item:f,index:v})=>u.jsx("button",{className:v===_e.selected?"active":"",type:"button","data-autocomplete-index":v,onMouseDown:w=>{w.preventDefault(),Aa(f)},role:"option","aria-selected":v===_e.selected,children:f.label},f.label))}),H&&u.jsxs("div",{className:"ide-editor-loading",role:"status","aria-live":"polite",children:[u.jsx("span",{className:"spinner","aria-hidden":"true"}),u.jsxs("strong",{children:["Indlæser ",De(H),"..."]})]})]})]}),u.jsxs("section",{className:"ide-panel ide-terminal-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Terminal"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${or?"":"active"}`,type:"button",onClick:()=>Ns(f=>!f),"aria-label":or?"Tekniske fejl er slået fra":"Tekniske fejl er slået til","aria-pressed":!or,title:or?"Vis originale tekniske fejl":"Viser originale tekniske fejl",children:"Teknisk"}),u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${Wn?"active":""}`,type:"button",onClick:()=>Hl(f=>!f),"aria-pressed":Wn,title:Wn?"Terminalen ryddes, hver gang du trykker Kør":"Terminalen beholder tekst, når du trykker Kør",children:"Ryd ved Kør"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Js,disabled:R.length===0,children:"Ryd"})]})]}),u.jsxs("div",{className:"ide-terminal","aria-live":"polite",ref:ba,onScroll:Mi,onClick:()=>{var f;return(f=kr.current)==null?void 0:f.focus()},children:[R.length===0?u.jsx("div",{className:"term-line",children:"Ingen terminaldata endnu."}):R.map((f,v)=>u.jsx("div",{className:`term-line ${f.variant==="input"?"term-input-echo":`term-${f.level}`}`,children:f.technical&&!or?f.technical:f.text},`${v}-${f.text}`)),u.jsxs("form",{className:`ide-terminal-command ${xa&&!sn?"locked":""} ${sn?"stdin":""}`,onSubmit:f=>{f.preventDefault(),Ra()},children:[u.jsx("span",{"aria-hidden":"true",children:kc}),u.jsx("textarea",{ref:kr,value:bt,onChange:f=>{qt(f.target.value),el(null),sn?St(null):Dr(f.target.value,f.target.selectionStart)},onKeyDown:ol,onKeyUp:f=>{sn||["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(f.key)||Dr(f.currentTarget.value,f.currentTarget.selectionStart)},onClick:f=>{sn||Dr(f.currentTarget.value,f.currentTarget.selectionStart)},disabled:tl,placeholder:fi,"aria-label":sn?"Input til kørende Pico-kode":"MicroPython-terminalkommando",title:fi,rows:Math.max(1,bt.split(`
`).length)})]}),Ye&&u.jsx("div",{ref:ur,className:`ide-autocomplete ide-repl-autocomplete placement-${Ye.position.placement}`,role:"listbox","aria-label":"Terminalforslag",style:{left:Ye.position.left,top:Ye.position.top,maxHeight:Ye.position.maxHeight},children:(Ye.position.placement==="above"?Ye.items.map((f,v)=>({item:f,index:v})).reverse():Ye.items.map((f,v)=>({item:f,index:v}))).map(({item:f,index:v})=>u.jsx("button",{className:v===Ye.selected?"active":"",type:"button","data-autocomplete-index":v,onMouseDown:w=>{w.preventDefault(),Ri(f)},role:"option","aria-selected":v===Ye.selected,children:f.label},f.label))})]})]})]}),u.jsx("input",{ref:Nt,type:"file",accept:".py,.txt,.json,.csv",className:"sr-only",onChange:f=>{var v;Oc((v=f.target.files)==null?void 0:v[0]),f.currentTarget.value=""}}),ie&&u.jsx(Ut,{title:"Gem fil",onClose:()=>ve(!1),children:u.jsxs("div",{className:"ide-save-options",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:()=>void xi(),disabled:!x&&!je||P,children:"Gem filen på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:zs,children:"Download filen til computer"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Bs,children:"Gem filen i browseren"})]})}),st&&u.jsx(Ut,{title:"Startprogrammer og biblioteker",onClose:()=>Ue(!1),children:u.jsxs("div",{className:"ide-install-list",children:[u.jsx("p",{className:"ide-install-note",children:x||je?"Vælg et startprogram og de biblioteker dit projekt bruger. Installer lægger filerne på Picoen.":"Du er ikke forbundet til en Pico. Du kan gemme filerne i browseren eller downloade dem til computeren, men de virker først på Picoen, når de er installeret der."}),u.jsxs("div",{className:"ide-install-grid",children:[to("Startprogrammer (main.py)","Starter automatisk på Picoen.",Be.filter(f=>f.kind==="program")),to("Biblioteker","Ekstra Python-filer som dine programmer kan importere.",Be.filter(f=>f.kind==="library"))]}),u.jsxs("div",{className:"ide-install-actions",children:[(x||je)&&u.jsx("button",{className:"btn btn-primary",type:"button",onClick:Ks,disabled:P,children:"Installer på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Jl,disabled:P,children:"Download til computer"}),u.jsx("button",{className:x||je?"btn btn-outline":"btn btn-primary",type:"button",onClick:Zl,disabled:P,children:"Gem i browseren"})]})]})}),lr&&u.jsx(Ut,{title:"main.py er gemt",onClose:()=>xn(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:"Picoen kører stadig den gamle kode. Genstart Picoen for at anvende den nye main.py. Appen forsøger automatisk at genforbinde bagefter."}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>void qs("control"),disabled:P,children:"Genstart og åbn kontrolpanel"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void qs("ide"),disabled:P,children:"Genstart og bliv i Kodeværksted"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>xn(!1),disabled:P,children:"Senere"})]})}),se&&u.jsx(Ut,{title:"Installer MicroPython",onClose:()=>le(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:"Hvis Picoen er helt frisk, skal MicroPython først lægges på den."}),u.jsxs("ol",{className:"micropython-steps",children:[u.jsx("li",{children:"Hold BOOTSEL-knappen nede."}),u.jsx("li",{children:"Sæt Picoen i USB, og slip derefter BOOTSEL."}),u.jsx("li",{children:"Vælg Pico-model og MicroPython-version herunder, og download UF2-filen."}),u.jsxs("li",{children:["Kopier UF2-filen til drevet ",u.jsx("strong",{children:"RPI-RP2"})]})]}),u.jsxs("div",{className:"micropython-selects",children:[u.jsx("label",{htmlFor:"micropython-board",children:"Pico-model"}),u.jsx("select",{id:"micropython-board",value:Je,onChange:f=>xt(f.target.value),children:gn.map(f=>u.jsx("option",{value:f,children:f},f))}),u.jsx("label",{htmlFor:"micropython-version",children:"MicroPython-version"}),u.jsx("select",{id:"micropython-version",value:(Rr==null?void 0:Rr.version)??Ve,onChange:f=>Kn(f.target.value),children:Nr.map(f=>u.jsxs("option",{value:f.version,children:[f.version," (",f.date,")"]},`${f.board}:${f.version}:${f.date}`))})]}),Rr&&u.jsx("a",{className:"btn btn-primary btn-block",href:Rr.url,download:Rr.fileName,children:"Download UF2"}),u.jsx("a",{className:"btn btn-outline btn-block",href:"https://www.raspberrypi.com/documentation/microcontrollers/micropython.html",target:"_blank",rel:"noreferrer",children:"Se vejledning"})]})}),q&&u.jsx(Ut,{title:"Ny Python-fil",onClose:()=>ee(!1),children:u.jsxs("form",{className:"ide-new-file-form",onSubmit:f=>{f.preventDefault(),Ql()},children:[u.jsx("label",{htmlFor:"new-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"new-pico-file",value:he,onChange:f=>Ae(f.target.value),autoFocus:!0,placeholder:"test"}),u.jsx("span",{children:".py"})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen tilføjer .py automatisk og opretter filen i ",xc,"."]}),u.jsx("button",{className:"btn btn-primary",type:"submit",disabled:!fh(he),children:"Opret"})]})}),O&&u.jsx(Ut,{title:De(O.path),onClose:()=>J(null),children:u.jsxs("div",{className:"ide-file-action-modal",children:[u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:"Placering"}),u.jsx("strong",{children:O.source==="pico"?"Pico":"Browser"})]}),u.jsxs("form",{className:"ide-file-rename-form",onSubmit:f=>{f.preventDefault(),sl()},children:[u.jsx("label",{htmlFor:"rename-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"rename-pico-file",value:ge,onChange:f=>E(f.target.value),placeholder:"min_kode"}),u.jsxs("span",{children:[".",vs(O.path)]})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen beholder filendelsen .",vs(O.path)," automatisk."]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"submit",disabled:!Pd(ge,vs(O.path))||Pd(ge,vs(O.path))===O.path||P,children:"Gem navn"})]}),u.jsxs("div",{className:"ide-file-action-buttons",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void $s(),disabled:P,children:"Dupliker"}),u.jsx("button",{className:"btn btn-outline btn-danger btn-block",type:"button",onClick:()=>Hs(O),disabled:P,children:"Slet"})]}),u.jsxs("section",{className:"ide-version-history",children:[u.jsx("h4",{children:"Versionshistorik"}),O.versions.length===0?u.jsx("p",{children:"Versionshistorik: 0 gemte versioner."}):u.jsx("div",{className:"ide-version-list",children:O.versions.map(f=>u.jsxs("div",{className:"ide-version-row",children:[u.jsx("span",{children:De(f.path)}),u.jsx("small",{children:f.size!==void 0?`${f.size} bytes`:"Gemt på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:()=>void Is(f),disabled:P,children:"Gendan"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Fs(f),disabled:P,children:"Slet"})]},f.path))})]})]})})]})}function fh(a){var o;const l=(o=a.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:o.replace(/\.py$/i,"").replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"");return l?`/${l}.py`:""}function Uv(a){const l=a.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop(),o=l==null?void 0:l.match(/^(.+)\.(py|txt|json|csv)$/i);if(!o)return"";const s=np(o[1]);return s?`/${s}.${o[2].toLowerCase()}`:""}function Pd(a,l="py"){const o=a.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop();if(!o)return"";const s=o.match(/^(.+?)(?:\.(py|txt|json|csv))?$/i);if(!s)return"";const d=np(s[1]),p=l.replace(/^\./,"").toLowerCase(),_=(s[2]??(p||"py")).toLowerCase();return d?`/${d}.${_}`:""}function qv(a){return De(a).replace(/\.(py|txt|json|csv)$/i,"")}function np(a){return a.replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"")}function vs(a){var s;const l=De(a).match(/\.([a-z0-9]+)$/i),o=(s=l==null?void 0:l[1])==null?void 0:s.toLowerCase();return o&&["py","txt","json","csv"].includes(o)?o:"py"}function Dl(a){return a.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trimEnd()}function mh(){return li.map(a=>({...a,status:"unknown",detail:"Kan gemmes uden Pico. Forbind en Pico for at installere."}))}function hh(a){const l={};return a.forEach(o=>{l[o.id]=!1}),l}function De(a){return a.split("/").filter(Boolean).pop()??a}function ac(a){return a.replace(/\\/g,"/").toLowerCase()==="/main.py"}function ph(a){const l=a.userAgent||"",o=a.platform||"",s=a.maxTouchPoints||0,d=/Android.*Mobile|iPhone|iPod|Windows Phone|Mobile Safari/i.test(l),p=/Macintosh/i.test(o)&&s>1;return d&&!p}function Hv(a){return a instanceof DOMException&&a.name==="AbortError"}function Vv(a){return/Traceback \(most recent call last\):/.test(a)||/\b(?:SyntaxError|NameError|TypeError|ValueError|IndentationError|ImportError|ModuleNotFoundError|ZeroDivisionError|IndexError|KeyError|AttributeError):/.test(a)}function Ol(a){return Pv(a)}function Pv(a){return a.path.replace(/\\/g,"/").toLowerCase()==="/picobluetooth.py"}const Jd=[...["False","None","True","and","as","assert","async","await","break","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","nonlocal","not","or","pass","raise","return","try","while","with","yield"].map(a=>({label:a,insert:`${a}${["for","if","while","def","class","elif","else","try","except","finally","with"].includes(a)?" ":""}`})),...["abs","all","any","bin","bool","bytearray","bytes","callable","chr","dict","dir","divmod","enumerate","eval","exec","filter","float","getattr","hasattr","hash","hex","id","input","int","isinstance","issubclass","iter","len","list","map","max","min","next","object","oct","open","ord","pow","print","range","repr","reversed","round","set","setattr","slice","sorted","str","sum","super","tuple","type","zip"].map(a=>({label:`${a}()`,insert:`${a}()`})),{label:"for i in range():",insert:"for i in range():"},{label:"while True:",insert:"while True:"},{label:"if True:",insert:"if True:"},{label:"time",insert:"time"},{label:"time.",insert:"time."},{label:"time.sleep",insert:"time.sleep"},{label:"time.sleep()",insert:"time.sleep()"},{label:"time.sleep_ms()",insert:"time.sleep_ms()"},{label:"time.ticks_ms()",insert:"time.ticks_ms()"},{label:"time.ticks_diff()",insert:"time.ticks_diff()"},{label:"time.sleep_us()",insert:"time.sleep_us()"},{label:"time.ticks_us()",insert:"time.ticks_us()"},{label:"machine",insert:"machine"},{label:"machine.",insert:"machine."},{label:"machine.Pin",insert:"machine.Pin"},{label:"machine.PWM",insert:"machine.PWM"},{label:"machine.ADC",insert:"machine.ADC"},{label:"machine.I2C",insert:"machine.I2C"},{label:"machine.SPI",insert:"machine.SPI"},{label:"machine.Timer",insert:"machine.Timer"},{label:"machine.UART",insert:"machine.UART"},{label:"machine.reset()",insert:"machine.reset()"},{label:"machine.freq()",insert:"machine.freq()"},{label:"Pin()",insert:"Pin()"},{label:"PWM()",insert:"PWM()"},{label:"ADC()",insert:"ADC()"},{label:"I2C()",insert:"I2C()"},{label:"SPI()",insert:"SPI()"},{label:"Timer()",insert:"Timer()"},{label:"UART()",insert:"UART()"},{label:"Pin.OUT",insert:"Pin.OUT"},{label:"Pin.IN",insert:"Pin.IN"},{label:"Pin.PULL_UP",insert:"Pin.PULL_UP"},{label:"Pin.PULL_DOWN",insert:"Pin.PULL_DOWN"},{label:"Pin.IRQ_FALLING",insert:"Pin.IRQ_FALLING"},{label:"Pin.IRQ_RISING",insert:"Pin.IRQ_RISING"},{label:"import time",insert:"import time"},{label:"import utime as time",insert:"import utime as time"},{label:"import machine",insert:"import machine"},{label:"import random",insert:"import random"},{label:"import os",insert:"import os"},{label:"import sys",insert:"import sys"},{label:"from machine import Pin",insert:"from machine import Pin"},{label:"from machine import Pin, PWM",insert:"from machine import Pin, PWM"},{label:"from machine import Pin, PWM, ADC",insert:"from machine import Pin, PWM, ADC"},{label:"PicoBluetooth",insert:"PicoBluetooth"},{label:"PicoRobotics",insert:"PicoRobotics"},{label:"NeoPixel",insert:"NeoPixel"},{label:"HCSR04",insert:"HCSR04"},{label:"ble.send_toggle_state()",insert:"ble.send_toggle_state()"},{label:"ble.send_slider_state()",insert:"ble.send_slider_state()"},{label:"ble.send_radar()",insert:"ble.send_radar()"},{label:"ble.send_text()",insert:"ble.send_text()"},{label:"ble.send_plot()",insert:"ble.send_plot()"},{label:"on_button(name, is_down):",insert:"on_button(name, is_down):"},{label:"on_slider(name, value):",insert:"on_slider(name, value):"},{label:"on_toggle(name, value):",insert:"on_toggle(name, value):"},{label:"on_connect():",insert:"on_connect():"},{label:"on_disconnect():",insert:"on_disconnect():"},{label:"ValueError",insert:"ValueError"},{label:"TypeError",insert:"TypeError"},{label:"OSError",insert:"OSError"},{label:"Exception",insert:"Exception"}];function gh(a,l,o){const s=ef(a,l);if(!s)return[];const d=Iv(a,s.start,l),p=s.query.toLowerCase(),_=d.beforeToken.toLowerCase(),m=d.linePrefix.toLowerCase(),g=o?[...Jd,...Gv(a)]:Jd;return $v(g).filter(x=>{const k=x.label.toLowerCase(),M=x.insert.toLowerCase();return M===p||k===p||rp(x,s.query)?!1:d.importLine?Fv(x,d)?k.startsWith(m)||M.startsWith(m)||k.startsWith(p)||M.startsWith(p):!1:_.endsWith(".")&&!M.includes(".")?!1:!!(M.startsWith(p)||k.startsWith(p))})}function Iv(a,l,o){const s=a.lastIndexOf(`
