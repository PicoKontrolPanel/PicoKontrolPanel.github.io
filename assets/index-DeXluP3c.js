 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var oh;function ib(){if(oh)return ke;oh=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),p=Symbol.for("react.consumer"),_=Symbol.for("react.context"),y=Symbol.for("react.forward_ref"),E=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),b=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),S=Symbol.iterator;function I(N){return N===null||typeof N!="object"?null:(N=S&&N[S]||N["@@iterator"],typeof N=="function"?N:null)}var V={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},q=Object.assign,j={};function L(N,U,te){this.props=N,this.context=U,this.refs=j,this.updater=te||V}L.prototype.isReactComponent={},L.prototype.setState=function(N,U){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,U,"setState")},L.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function H(){}H.prototype=L.prototype;function ie(N,U,te){this.props=N,this.context=U,this.refs=j,this.updater=te||V}var se=ie.prototype=new H;se.constructor=ie,q(se,L.prototype),se.isPureReactComponent=!0;var oe=Array.isArray;function pe(){}var J={H:null,A:null,T:null,S:null},ee=Object.prototype.hasOwnProperty;function Re(N,U,te){var O=te.ref;return{$$typeof:s,type:N,key:U,ref:O!==void 0?O:null,props:te}}function ve(N,U){return Re(N.type,U,N.props)}function we(N){return typeof N=="object"&&N!==null&&N.$$typeof===s}function W(N){var U={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(te){return U[te]})}var Pe=/\/+/g;function Ae(N,U){return typeof N=="object"&&N!==null&&N.key!=null?W(""+N.key):U.toString(36)}function qe(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(pe,pe):(N.status="pending",N.then(function(U){N.status==="pending"&&(N.status="fulfilled",N.value=U)},function(U){N.status==="pending"&&(N.status="rejected",N.reason=U)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function G(N,U,te,O,Z){var ne=typeof N;(ne==="undefined"||ne==="boolean")&&(N=null);var X=!1;if(N===null)X=!0;else switch(ne){case"bigint":case"string":case"number":X=!0;break;case"object":switch(N.$$typeof){case s:case i:X=!0;break;case b:return X=N._init,G(X(N._payload),U,te,O,Z)}}if(X)return Z=Z(N),X=O===""?"."+Ae(N,0):O,oe(Z)?(te="",X!=null&&(te=X.replace(Pe,"$&/")+"/"),G(Z,U,te,"",function(Qn){return Qn})):Z!=null&&(we(Z)&&(Z=ve(Z,te+(Z.key==null||N&&N.key===Z.key?"":(""+Z.key).replace(Pe,"$&/")+"/")+X)),U.push(Z)),1;X=0;var He=O===""?".":O+":";if(oe(N))for(var Oe=0;Oe<N.length;Oe++)O=N[Oe],ne=He+Ae(O,Oe),X+=G(O,U,te,ne,Z);else if(Oe=I(N),typeof Oe=="function")for(N=Oe.call(N),Oe=0;!(O=N.next()).done;)O=O.value,ne=He+Ae(O,Oe++),X+=G(O,U,te,ne,Z);else if(ne==="object"){if(typeof N.then=="function")return G(qe(N),U,te,O,Z);throw U=String(N),Error("Objects are not valid as a React child (found: "+(U==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":U)+"). If you meant to render a collection of children, use an array instead.")}return X}function re(N,U,te){if(N==null)return N;var O=[],Z=0;return G(N,O,"","",function(ne){return U.call(te,ne,Z++)}),O}function ue(N){if(N._status===-1){var U=N._result;U=U(),U.then(function(te){(N._status===0||N._status===-1)&&(N._status=1,N._result=te)},function(te){(N._status===0||N._status===-1)&&(N._status=2,N._result=te)}),N._status===-1&&(N._status=0,N._result=U)}if(N._status===1)return N._result.default;throw N._result}var fe=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var U=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(U))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)},Ee={map:re,forEach:function(N,U,te){re(N,function(){U.apply(this,arguments)},te)},count:function(N){var U=0;return re(N,function(){U++}),U},toArray:function(N){return re(N,function(U){return U})||[]},only:function(N){if(!we(N))throw Error("React.Children.only expected to receive a single React element child.");return N}};return ke.Activity=v,ke.Children=Ee,ke.Component=L,ke.Fragment=c,ke.Profiler=f,ke.PureComponent=ie,ke.StrictMode=a,ke.Suspense=E,ke.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=J,ke.__COMPILER_RUNTIME={__proto__:null,c:function(N){return J.H.useMemoCache(N)}},ke.cache=function(N){return function(){return N.apply(null,arguments)}},ke.cacheSignal=function(){return null},ke.cloneElement=function(N,U,te){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var O=q({},N.props),Z=N.key;if(U!=null)for(ne in U.key!==void 0&&(Z=""+U.key),U)!ee.call(U,ne)||ne==="key"||ne==="__self"||ne==="__source"||ne==="ref"&&U.ref===void 0||(O[ne]=U[ne]);var ne=arguments.length-2;if(ne===1)O.children=te;else if(1<ne){for(var X=Array(ne),He=0;He<ne;He++)X[He]=arguments[He+2];O.children=X}return Re(N.type,Z,O)},ke.createContext=function(N){return N={$$typeof:_,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:p,_context:N},N},ke.createElement=function(N,U,te){var O,Z={},ne=null;if(U!=null)for(O in U.key!==void 0&&(ne=""+U.key),U)ee.call(U,O)&&O!=="key"&&O!=="__self"&&O!=="__source"&&(Z[O]=U[O]);var X=arguments.length-2;if(X===1)Z.children=te;else if(1<X){for(var He=Array(X),Oe=0;Oe<X;Oe++)He[Oe]=arguments[Oe+2];Z.children=He}if(N&&N.defaultProps)for(O in X=N.defaultProps,X)Z[O]===void 0&&(Z[O]=X[O]);return Re(N,ne,Z)},ke.createRef=function(){return{current:null}},ke.forwardRef=function(N){return{$$typeof:y,render:N}},ke.isValidElement=we,ke.lazy=function(N){return{$$typeof:b,_payload:{_status:-1,_result:N},_init:ue}},ke.memo=function(N,U){return{$$typeof:x,type:N,compare:U===void 0?null:U}},ke.startTransition=function(N){var U=J.T,te={};J.T=te;try{var O=N(),Z=J.S;Z!==null&&Z(te,O),typeof O=="object"&&O!==null&&typeof O.then=="function"&&O.then(pe,fe)}catch(ne){fe(ne)}finally{U!==null&&te.types!==null&&(U.types=te.types),J.T=U}},ke.unstable_useCacheRefresh=function(){return J.H.useCacheRefresh()},ke.use=function(N){return J.H.use(N)},ke.useActionState=function(N,U,te){return J.H.useActionState(N,U,te)},ke.useCallback=function(N,U){return J.H.useCallback(N,U)},ke.useContext=function(N){return J.H.useContext(N)},ke.useDebugValue=function(){},ke.useDeferredValue=function(N,U){return J.H.useDeferredValue(N,U)},ke.useEffect=function(N,U){return J.H.useEffect(N,U)},ke.useEffectEvent=function(N){return J.H.useEffectEvent(N)},ke.useId=function(){return J.H.useId()},ke.useImperativeHandle=function(N,U,te){return J.H.useImperativeHandle(N,U,te)},ke.useInsertionEffect=function(N,U){return J.H.useInsertionEffect(N,U)},ke.useLayoutEffect=function(N,U){return J.H.useLayoutEffect(N,U)},ke.useMemo=function(N,U){return J.H.useMemo(N,U)},ke.useOptimistic=function(N,U){return J.H.useOptimistic(N,U)},ke.useReducer=function(N,U,te){return J.H.useReducer(N,U,te)},ke.useRef=function(N){return J.H.useRef(N)},ke.useState=function(N){return J.H.useState(N)},ke.useSyncExternalStore=function(N,U,te){return J.H.useSyncExternalStore(N,U,te)},ke.useTransition=function(){return J.H.useTransition()},ke.version="19.2.7",ke}var ch;function Wf(){return ch||(ch=1,kf.exports=ib()),kf.exports}var z=Wf();const ms=f_(z);var Nf={exports:{}},ls={},Rf={exports:{}},Tf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var uh;function ab(){return uh||(uh=1,(function(s){function i(G,re){var ue=G.length;G.push(re);e:for(;0<ue;){var fe=ue-1>>>1,Ee=G[fe];if(0<f(Ee,re))G[fe]=re,G[ue]=Ee,ue=fe;else break e}}function c(G){return G.length===0?null:G[0]}function a(G){if(G.length===0)return null;var re=G[0],ue=G.pop();if(ue!==re){G[0]=ue;e:for(var fe=0,Ee=G.length,N=Ee>>>1;fe<N;){var U=2*(fe+1)-1,te=G[U],O=U+1,Z=G[O];if(0>f(te,ue))O<Ee&&0>f(Z,te)?(G[fe]=Z,G[O]=ue,fe=O):(G[fe]=te,G[U]=ue,fe=U);else if(O<Ee&&0>f(Z,ue))G[fe]=Z,G[O]=ue,fe=O;else break e}}return re}function f(G,re){var ue=G.sortIndex-re.sortIndex;return ue!==0?ue:G.id-re.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;s.unstable_now=function(){return p.now()}}else{var _=Date,y=_.now();s.unstable_now=function(){return _.now()-y}}var E=[],x=[],b=1,v=null,S=3,I=!1,V=!1,q=!1,j=!1,L=typeof setTimeout=="function"?setTimeout:null,H=typeof clearTimeout=="function"?clearTimeout:null,ie=typeof setImmediate<"u"?setImmediate:null;function se(G){for(var re=c(x);re!==null;){if(re.callback===null)a(x);else if(re.startTime<=G)a(x),re.sortIndex=re.expirationTime,i(E,re);else break;re=c(x)}}function oe(G){if(q=!1,se(G),!V)if(c(E)!==null)V=!0,pe||(pe=!0,W());else{var re=c(x);re!==null&&qe(oe,re.startTime-G)}}var pe=!1,J=-1,ee=5,Re=-1;function ve(){return j?!0:!(s.unstable_now()-Re<ee)}function we(){if(j=!1,pe){var G=s.unstable_now();Re=G;var re=!0;try{e:{V=!1,q&&(q=!1,H(J),J=-1),I=!0;var ue=S;try{n:{for(se(G),v=c(E);v!==null&&!(v.expirationTime>G&&ve());){var fe=v.callback;if(typeof fe=="function"){v.callback=null,S=v.priorityLevel;var Ee=fe(v.expirationTime<=G);if(G=s.unstable_now(),typeof Ee=="function"){v.callback=Ee,se(G),re=!0;break n}v===c(E)&&a(E),se(G)}else a(E);v=c(E)}if(v!==null)re=!0;else{var N=c(x);N!==null&&qe(oe,N.startTime-G),re=!1}}break e}finally{v=null,S=ue,I=!1}re=void 0}}finally{re?W():pe=!1}}}var W;if(typeof ie=="function")W=function(){ie(we)};else if(typeof MessageChannel<"u"){var Pe=new MessageChannel,Ae=Pe.port2;Pe.port1.onmessage=we,W=function(){Ae.postMessage(null)}}else W=function(){L(we,0)};function qe(G,re){J=L(function(){G(s.unstable_now())},re)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(G){G.callback=null},s.unstable_forceFrameRate=function(G){0>G||125<G?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ee=0<G?Math.floor(1e3/G):5},s.unstable_getCurrentPriorityLevel=function(){return S},s.unstable_next=function(G){switch(S){case 1:case 2:case 3:var re=3;break;default:re=S}var ue=S;S=re;try{return G()}finally{S=ue}},s.unstable_requestPaint=function(){j=!0},s.unstable_runWithPriority=function(G,re){switch(G){case 1:case 2:case 3:case 4:case 5:break;default:G=3}var ue=S;S=G;try{return re()}finally{S=ue}},s.unstable_scheduleCallback=function(G,re,ue){var fe=s.unstable_now();switch(typeof ue=="object"&&ue!==null?(ue=ue.delay,ue=typeof ue=="number"&&0<ue?fe+ue:fe):ue=fe,G){case 1:var Ee=-1;break;case 2:Ee=250;break;case 5:Ee=1073741823;break;case 4:Ee=1e4;break;default:Ee=5e3}return Ee=ue+Ee,G={id:b++,callback:re,priorityLevel:G,startTime:ue,expirationTime:Ee,sortIndex:-1},ue>fe?(G.sortIndex=ue,i(x,G),c(E)===null&&G===c(x)&&(q?(H(J),J=-1):q=!0,qe(oe,ue-fe))):(G.sortIndex=Ee,i(E,G),V||I||(V=!0,pe||(pe=!0,W()))),G},s.unstable_shouldYield=ve,s.unstable_wrapCallback=function(G){var re=S;return function(){var ue=S;S=re;try{return G.apply(this,arguments)}finally{S=ue}}}})(Tf)),Tf}var fh;function sb(){return fh||(fh=1,Rf.exports=ab()),Rf.exports}var Mf={exports:{}},Xn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var dh;function ob(){if(dh)return Xn;dh=1;var s=Wf();function i(E){var x="https://react.dev/errors/"+E;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var b=2;b<arguments.length;b++)x+="&args[]="+encodeURIComponent(arguments[b])}return"Minified React error #"+E+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function c(){}var a={d:{f:c,r:function(){throw Error(i(522))},D:c,C:c,L:c,m:c,X:c,S:c,M:c},p:0,findDOMNode:null},f=Symbol.for("react.portal");function p(E,x,b){var v=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:f,key:v==null?null:""+v,children:E,containerInfo:x,implementation:b}}var _=s.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function y(E,x){if(E==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return Xn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=a,Xn.createPortal=function(E,x){var b=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(i(299));return p(E,x,null,b)},Xn.flushSync=function(E){var x=_.T,b=a.p;try{if(_.T=null,a.p=2,E)return E()}finally{_.T=x,a.p=b,a.d.f()}},Xn.preconnect=function(E,x){typeof E=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,a.d.C(E,x))},Xn.prefetchDNS=function(E){typeof E=="string"&&a.d.D(E)},Xn.preinit=function(E,x){if(typeof E=="string"&&x&&typeof x.as=="string"){var b=x.as,v=y(b,x.crossOrigin),S=typeof x.integrity=="string"?x.integrity:void 0,I=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;b==="style"?a.d.S(E,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:v,integrity:S,fetchPriority:I}):b==="script"&&a.d.X(E,{crossOrigin:v,integrity:S,fetchPriority:I,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},Xn.preinitModule=function(E,x){if(typeof E=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var b=y(x.as,x.crossOrigin);a.d.M(E,{crossOrigin:b,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&a.d.M(E)},Xn.preload=function(E,x){if(typeof E=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var b=x.as,v=y(b,x.crossOrigin);a.d.L(E,b,{crossOrigin:v,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},Xn.preloadModule=function(E,x){if(typeof E=="string")if(x){var b=y(x.as,x.crossOrigin);a.d.m(E,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:b,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else a.d.m(E)},Xn.requestFormReset=function(E){a.d.r(E)},Xn.unstable_batchedUpdates=function(E,x){return E(x)},Xn.useFormState=function(E,x,b){return _.H.useFormState(E,x,b)},Xn.useFormStatus=function(){return _.H.useHostTransitionStatus()},Xn.version="19.2.7",Xn}var mh;function cb(){if(mh)return Mf.exports;mh=1;function s(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(s)}catch(i){console.error(i)}}return s(),Mf.exports=ob(),Mf.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ph;function ub(){if(ph)return ls;ph=1;var s=sb(),i=Wf(),c=cb();function a(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var t=2;t<arguments.length;t++)n+="&args[]="+encodeURIComponent(arguments[t])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function p(e){var n=e,t=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(t=n.return),e=n.return;while(e)}return n.tag===3?t:null}function _(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function y(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function E(e){if(p(e)!==e)throw Error(a(188))}function x(e){var n=e.alternate;if(!n){if(n=p(e),n===null)throw Error(a(188));return n!==e?null:e}for(var t=e,r=n;;){var l=t.return;if(l===null)break;var o=l.alternate;if(o===null){if(r=l.return,r!==null){t=r;continue}break}if(l.child===o.child){for(o=l.child;o;){if(o===t)return E(l),e;if(o===r)return E(l),n;o=o.sibling}throw Error(a(188))}if(t.return!==r.return)t=l,r=o;else{for(var m=!1,g=l.child;g;){if(g===t){m=!0,t=l,r=o;break}if(g===r){m=!0,r=l,t=o;break}g=g.sibling}if(!m){for(g=o.child;g;){if(g===t){m=!0,t=o,r=l;break}if(g===r){m=!0,r=o,t=l;break}g=g.sibling}if(!m)throw Error(a(189))}}if(t.alternate!==r)throw Error(a(190))}if(t.tag!==3)throw Error(a(188));return t.stateNode.current===t?e:n}function b(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=b(e),n!==null)return n;e=e.sibling}return null}var v=Object.assign,S=Symbol.for("react.element"),I=Symbol.for("react.transitional.element"),V=Symbol.for("react.portal"),q=Symbol.for("react.fragment"),j=Symbol.for("react.strict_mode"),L=Symbol.for("react.profiler"),H=Symbol.for("react.consumer"),ie=Symbol.for("react.context"),se=Symbol.for("react.forward_ref"),oe=Symbol.for("react.suspense"),pe=Symbol.for("react.suspense_list"),J=Symbol.for("react.memo"),ee=Symbol.for("react.lazy"),Re=Symbol.for("react.activity"),ve=Symbol.for("react.memo_cache_sentinel"),we=Symbol.iterator;function W(e){return e===null||typeof e!="object"?null:(e=we&&e[we]||e["@@iterator"],typeof e=="function"?e:null)}var Pe=Symbol.for("react.client.reference");function Ae(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Pe?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case q:return"Fragment";case L:return"Profiler";case j:return"StrictMode";case oe:return"Suspense";case pe:return"SuspenseList";case Re:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case V:return"Portal";case ie:return e.displayName||"Context";case H:return(e._context.displayName||"Context")+".Consumer";case se:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case J:return n=e.displayName||null,n!==null?n:Ae(e.type)||"Memo";case ee:n=e._payload,e=e._init;try{return Ae(e(n))}catch{}}return null}var qe=Array.isArray,G=i.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,re=c.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,ue={pending:!1,data:null,method:null,action:null},fe=[],Ee=-1;function N(e){return{current:e}}function U(e){0>Ee||(e.current=fe[Ee],fe[Ee]=null,Ee--)}function te(e,n){Ee++,fe[Ee]=e.current,e.current=n}var O=N(null),Z=N(null),ne=N(null),X=N(null);function He(e,n){switch(te(ne,n),te(Z,e),te(O,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?Mp(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=Mp(n),e=Dp(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}U(O),te(O,e)}function Oe(){U(O),U(Z),U(ne)}function Qn(e){e.memoizedState!==null&&te(X,e);var n=O.current,t=Dp(n,e.type);n!==t&&(te(Z,e),te(O,t))}function Kt(e){Z.current===e&&(U(O),U(Z)),X.current===e&&(U(X),Ja._currentValue=ue)}var xe,wn;function Mn(e){if(xe===void 0)try{throw Error()}catch(t){var n=t.stack.trim().match(/\n( *(at )?)/);xe=n&&n[1]||"",wn=-1<t.stack.indexOf(`
    at`)?" (<anonymous>)":-1<t.stack.indexOf("@")?"@unknown:0:0":""}return`
`+xe+e+wn}var ze=!1;function Dn(e,n){if(!e||ze)return"";ze=!0;var t=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var r={DetermineComponentFrameRoot:function(){try{if(n){var K=function(){throw Error()};if(Object.defineProperty(K.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(K,[])}catch(Y){var B=Y}Reflect.construct(e,[],K)}else{try{K.call()}catch(Y){B=Y}e.call(K.prototype)}}else{try{throw Error()}catch(Y){B=Y}(K=e())&&typeof K.catch=="function"&&K.catch(function(){})}}catch(Y){if(Y&&B&&typeof Y.stack=="string")return[Y.stack,B.stack]}return[null,null]}};r.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var l=Object.getOwnPropertyDescriptor(r.DetermineComponentFrameRoot,"name");l&&l.configurable&&Object.defineProperty(r.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var o=r.DetermineComponentFrameRoot(),m=o[0],g=o[1];if(m&&g){var k=m.split(`
`),C=g.split(`
...
`),f=this.writeChar.properties.writeWithoutResponse&&typeof this.writeChar.writeValueWithoutResponse=="function"?this.writeChar.writeValueWithoutResponse.bind(this.writeChar):this.writeChar.writeValue.bind(this.writeChar);for(let p=0;p<c.length;p+=Af){const _=c.slice(p,p+Af);await f(_),p+Af<c.length&&await Mb(Nb)}}disconnect(){var c;const i=this.device;(c=i==null?void 0:i.gatt)!=null&&c.connected?i.gatt.disconnect():this.handleDisconnected()}}class Ab{constructor(i,c){me(this,"send");me(this,"onMessage");me(this,"inActive",!1);me(this,"inExpectedTotal",0);me(this,"inStreamId",0);me(this,"inParts",new Map);me(this,"inProgress",null);me(this,"outPendingLines",null);me(this,"outWaitingAck",!1);me(this,"outStreamId",0);me(this,"outNextStreamId",1);me(this,"outCache",new Map);me(this,"outProgress",null);me(this,"outResolve",null);me(this,"outReject",null);this.send=i,this.onMessage=c}reset(){this.inActive=!1,this.inExpectedTotal=0,this.inStreamId=0,this.inParts.clear(),this.inProgress=null,this.outPendingLines=null,this.outWaitingAck=!1,this.outStreamId=0,this.outCache.clear(),this.outProgress=null,this.outResolve=null,this.outReject=null}handleLine(i){var a;if(i.startsWith("prep,")){const f=i.split(","),p=f.length>=2&&/^\d+$/.test(f[1])?parseInt(f[1],10):null,_=f.length>=3&&/^\d+$/.test(f[2])?parseInt(f[2],10):0;p!==null&&p>0&&(this.inActive=!0,this.inExpectedTotal=p,this.inStreamId=_,this.inParts.clear(),this.send(_>0?`ack:prep,${_}`:"ack:prep"));return}if(i==="ack:prep"||i===`ack:prep,${this.outStreamId}`){this.flushOutbound();return}if(i.startsWith("miss,")){const f=i.split(",");if(f.length>=3&&/^\d+$/.test(f[1])&&/^\d+$/.test(f[2])){const p=parseInt(f[1],10),_=parseInt(f[2],10),y=this.outCache.get(_);p===this.outStreamId&&y&&this.send(y)}return}const c=this.parseNumbered(i);if(c){const{idx:f,payload:p}=c;if(!this.inActive){this.onMessage(p);return}this.inParts.has(f)||(this.inParts.set(f,p),(a=this.inProgress)==null||a.call(this,this.inParts.size,this.inExpectedTotal));let _=0;for(let y=1;y<=this.inExpectedTotal;y+=1)if(!this.inParts.has(y)){_=y;break}if(_>0&&this.inStreamId>0&&f>_&&this.send(`miss,${this.inStreamId},${_}`),this.inParts.size>=this.inExpectedTotal){for(let y=1;y<=this.inExpectedTotal;y+=1){const E=this.inParts.get(y);E!==void 0&&this.onMessage(E)}this.inActive=!1,this.inExpectedTotal=0,this.inStreamId=0,this.inParts.clear()}return}this.onMessage(i)}setInboundProgress(i){this.inProgress=i}async sendReliable(i,c){if(this.outPendingLines!==null||this.outWaitingAck)throw new Error("Reliable stream is already sending.");const a=i.length===0?[""]:i;this.outPendingLines=[...a],this.outWaitingAck=!0,this.outProgress=c??null,this.outStreamId=this.outNextStreamId,this.outNextStreamId+=1,this.outCache.clear();const f=new Promise((p,_)=>{this.outResolve=p,this.outReject=_});try{await this.send(`prep,${a.length},${this.outStreamId}`)}catch(p){throw this.outResolve=null,this.outReject=null,this.outPendingLines=null,this.outWaitingAck=!1,this.outProgress=null,p}await f}async flushOutbound(){var i,c,a,f;if(!this.outWaitingAck||this.outPendingLines===null){this.outWaitingAck=!1,this.outProgress=null,(i=this.outResolve)==null||i.call(this),this.outResolve=null,this.outReject=null;return}try{const p=this.outPendingLines.length;for(let _=0;_<p;_+=1){const y=this.outPendingLines[_],E=`${_+1}-${y}`;this.outCache.set(_+1,E),await this.send(E),(c=this.outProgress)==null||c.call(this,_+1,p,y)}(a=this.outResolve)==null||a.call(this)}catch(p){(f=this.outReject)==null||f.call(this,p)}finally{this.outResolve=null,this.outReject=null,this.outPendingLines=null,this.outWaitingAck=!1,this.outProgress=null}}parseNumbered(i){const c=i.indexOf("-");if(c<=0)return null;const a=i.slice(0,c);if(!/^\d+$/.test(a))return null;const f=parseInt(a,10);return f<1?null:{idx:f,payload:i.slice(c+1)}}}const sa=11,gs=31,Ob=2,Cb=60,la=4,ia=40;function Lb(s,i){return Math.max(14,Math.min(56,Math.min(s,i)*.05))}function p_(s,i,c=sa,a=gs){const f=Lb(s,i),p=Math.max(1,s-2*f),_=Math.max(1,i-2*f);return{areaW:s,areaH:i,cols:c,rows:a,margin:f,stepX:p/Math.max(1,c-1),stepY:_/Math.max(1,a-1)}}function h_(s,i){return i.margin+s/2*i.stepX}function __(s,i){const c=i.margin+s/2*i.stepY;return i.areaH-c}function ps(s,i){return s.centerX2===null||s.centerY2===null||s.spanX===null||s.spanY===null?null:{cx:h_(s.centerX2,i),cy:__(s.centerY2,i),width:s.spanX*i.stepX,height:s.spanY*i.stepY}}function Bb(s){const i=[];for(let c=0;c<s.cols;c+=1)for(let a=0;a<s.rows;a+=1)i.push({x:s.margin+c*s.stepX,y:s.areaH-(s.margin+a*s.stepY)});return i}function lc(s,i,c,a,f){const p=(E,x,b,v)=>{const S=x%2,I=v*2;let V=S,q=1/0;for(let j=S;j<=I;j+=2){const L=Math.abs(b(j)-E);L<q&&(q=L,V=j)}return Math.max(x,Math.min(I-x,V))},_=p(s,c,E=>h_(E,f),f.cols-1),y=p(i,a,E=>__(E,f),f.rows-1);return{centerX2:_,centerY2:y}}const ui=6e3,zb=15,Ub="",uc=[32,64,128,192],Hb=ui*10,Gb=3500,Ib=8e3,Vb=2,Yb=ui,$b=ui*8;function Of(s){return new Promise(i=>setTimeout(i,s))}function ea(s){if(s!=null&&s.aborted)throw new DOMException("BLE file read cancelled","AbortError")}function yh(s){return s instanceof DOMException&&s.name==="AbortError"}function kl(s){return s.replace(/[\r\n,]/g," ").trim()}class Pb{constructor(i={}){me(this,"transport",new jb);me(this,"stream");me(this,"events");me(this,"waiters",[]);me(this,"collectingLayout",!1);me(this,"layoutBuffer",[]);me(this,"layoutResolve",null);me(this,"collectingLines",!1);me(this,"lineBuffer",[]);me(this,"lineResolve",null);me(this,"lineReject",null);me(this,"lineCollectId",0);me(this,"controlPumpActive",!1);me(this,"pendingButtons",[]);me(this,"pendingSliders",new Map);me(this,"pendingToggles",new Map);me(this,"pendingJoysticks",new Map);me(this,"pendingDpads",[]);me(this,"expectingDisconnect",!1);me(this,"disconnectMessage",null);me(this,"busy",!1);me(this,"fsCapabilities",null);this.events=i,this.stream=new Ab(c=>this.transport.writeLine(c),c=>this.onDeviceMessage(c)),this.transport.onLine=c=>this.stream.handleLine(c),this.transport.onDisconnect=()=>this.handleDisconnect()}get device(){return this.transport.device}get deviceName(){var i;return d_((i=this.transport.device)==null?void 0:i.name)}get connected(){return this.transport.connected}setBusy(i){if(this.busy=i,i){this.pendingButtons=[],this.pendingSliders.clear(),this.pendingToggles.clear(),this.pendingJoysticks.clear(),this.pendingDpads=[];return}this.pumpControls()}log(i,c){var a,f;(f=(a=this.events).onLog)==null||f.call(a,i,c)}progress(i,c){var a,f;(f=(a=this.events).onProgress)==null||f.call(a,i,c)}onDeviceMessage(i){var a,f;if(i==="disconnect"||i==="disconnect_private"){const p=i==="disconnect_private"?"Du blev afbrudt, fordi enheden er privat, og andre brugere ikke må forbinde.":"Enheden afbrød forbindelsen.";this.disconnectMessage=p,this.log("warning",p),this.expectingDisconnect=!0,this.transport.disconnect();return}if(this.collectingLines){if(i==="__END__"){const p=this.lineBuffer;this.lineBuffer=[],this.collectingLines=!1,(a=this.lineResolve)==null||a.call(this,p),this.lineResolve=null;return}this.lineBuffer.push(i);return}if(this.collectingLayout){if(i==="__END__"){const p=this.layoutBuffer;this.layoutBuffer=[],this.collectingLayout=!1,(f=this.layoutResolve)==null||f.call(this,p),this.layoutResolve=null;return}!i.startsWith("ACK")&&!i.startsWith("ERR")&&!i.startsWith("#VERSION")?this.layoutBuffer.push(i):i.startsWith("#VERSION")&&this.layoutBuffer.push(i);return}i.startsWith("ERR")?this.log("error",i):i.startsWith("radar,")?this.handleRadarLine(i):i.startsWith("text,")?this.handleTextLine(i):i.startsWith("toggle_state,")?this.handleToggleStateLine(i):i.startsWith("ACK")||i==="LAYOUT_SAVED"||i.startsWith("READY")?this.log("success",i):this.log("info",`rx: ${i}`);const c=this.waiters.findIndex(p=>p.match(i));if(c>=0){const p=this.waiters[c];this.waiters.splice(c,1),clearTimeout(p.timer),p.resolve(i)}}waitFor(i,c,a){return new Promise((f,p)=>{const _=setTimeout(()=>{const y=this.waiters.findIndex(E=>E.timer===_);y>=0&&this.waiters.splice(y,1),p(new Error(`Timeout: ${a}`))},c);this.waiters.push({match:i,resolve:f,reject:p,timer:_})})}async collectLines(i,c,a,f,p){ea(f);const _=this.lineCollectId+1;this.lineCollectId=_,this.collectingLines=!0,this.lineBuffer=[],this.stream.setInboundProgress(p??null);const y=new Promise((E,x)=>{let b=!1;const v=()=>this.lineCollectId===_,S=()=>{b=!0,v()&&(this.lineReject=null,this.stream.setInboundProgress(null)),f==null||f.removeEventListener("abort",V)},I=L=>{b||(clearTimeout(q),v()&&(this.collectingLines=!1,this.lineBuffer=[],this.lineResolve=null),S(),x(L))},V=()=>{I(new DOMException("BLE file read cancelled","AbortError"))},q=setTimeout(()=>{v()&&I(new Error(`Timeout: ${a}`))},c);this.lineResolve=E,this.lineReject=I;const j=this.lineResolve;this.lineResolve=L=>{v()&&(clearTimeout(q),S(),j==null||j(L))},f==null||f.addEventListener("abort",V,{once:!0})});return await this.transport.writeLine(i),y}async exchange(i,c,a,f=3){let p;for(let _=1;_<=f;_+=1)try{return await this.transport.writeLine(i),await this.waitFor(c,ui,a)}catch(y){p=y,this.log("warning",`${a}: forsøg ${_}/${f} mislykkedes`)}throw p instanceof Error?p:new Error(`Failed: ${a}`)}async connect(i){this.expectingDisconnect=!1,this.stream.reset(),this.progress(5,"Forbinder til Bluetooth..."),await this.transport.connect(i)}async runHandshake(i){var se,oe,pe;await Of(350),this.progress(18,"Klargør forbindelse..."),this.progress(26,"Sender HELLO..."),await this.exchange("HELLO",J=>J==="ACK:HELLO","HELLO"),this.progress(34,"Forbindelse bekræftet"),this.progress(44,"Spørger om ejerskab...");const c=await this.exchange("who_are_you",J=>J==="unowned"||J.startsWith("unowned,")||J.startsWith("owned,"),"who_are_you");if(this.progress(56,"Ejerskab modtaget"),c==="unowned"||c.startsWith("unowned,"))return{kind:"unowned",deviceName:((se=c.split(",")[1])==null?void 0:se.trim())||void 0};const a=c.split(","),f=a[1]??"",p=a[2]!==void 0&&parseInt(a[2],10)||0,_=a[3]!==void 0?parseInt(a[3],10)===1:!0,y=a[4]!==void 0?parseInt(a[4],10)===1:!1,E=a.length>=7,x=E?parseInt(a[5]??"0",10)===1:y,b=((oe=a[E?6:5])==null?void 0:oe.trim())||void 0,v=((pe=a[E?7:6])==null?void 0:pe.trim())||void 0;await this.exchange("ACK:ownership",J=>J==="READY:permission","ACK:ownership",1),this.progress(66,"Anmoder om adgang...");const S=await this.exchange(`request_permission,${i.userID},${kl(i.username)}`,J=>J.startsWith("perm,"),"request_permission");this.progress(76,"Adgang vurderet");const I=S.split(",").filter(J=>/^\d+$/.test(J)),V=I.length>=1?parseInt(I[0]??"0",10):0,q=I.length>=2?parseInt(I[1]??"0",10):0,j=I.length>=3?parseInt(I[2]??"0",10):q;if(V===0)return this.expectingDisconnect=!0,this.disconnectMessage="Du kan ikke forbinde, fordi enheden er privat, og andre brugere ikke må forbinde.",{kind:"denied",ownerName:b,canOthersConnect:_};const L=i.userID===f,H=q===1||L,ie=j===1||L;return await this.transport.writeLine("ACK:permission"),{kind:"owned",ownerID:f,ownerName:b,deviceName:v,iconID:p,canEdit:H,canEditCode:ie,isOwnedByMe:L,canOthersConnect:_,canOthersEdit:y,canOthersEditCode:x}}async create(i,c,a,f,p,_,y){const E=a?1:0,x=a&&f?1:0,b=a&&p?1:0;await this.exchange(`create,${i.userID},${kl(i.username)},${c},${E},${x},${b},${_},${y}`,v=>v==="ACK:create","create")}async updateDeviceSettings(i,c,a,f,p,_,y){const E=c?1:0,x=c&&a?1:0,b=c&&f?1:0;await this.exchange(`settings_update,${i},${E},${x},${b},${p},${_},${kl(y??"")}`,v=>v==="ACK:settings_update","settings_update",3)}async requestLayout(){this.progress(84,"Henter kontrolpanel..."),this.collectingLayout=!0,this.layoutBuffer=[];const i=new Promise((a,f)=>{this.layoutResolve=a;const p=setTimeout(()=>{this.collectingLayout&&(this.collectingLayout=!1,this.layoutResolve=null,f(new Error("Timeout: layout")))},ui*2),_=this.layoutResolve;this.layoutResolve=y=>{clearTimeout(p),_==null||_(y)}});await this.transport.writeLine("request"),this.progress(92,"Modtager kontrolpanel...");const c=await i;return this.progress(100,"Klar"),c}async saveLayout(i){await this.exchange("update",f=>f==="ACK:update","update",3).catch(()=>{this.log("warning","ACK:update udeblev (fortsætter).")});const c=i.map(f=>{const p=y=>y===null?"n":String(y),_=`update,${f.type},${f.name},${p(f.centerX2)},${p(f.centerY2)},${p(f.spanX)},${p(f.spanY)},${f.rotation}`;return f.type==="slider"?`${_},${f.sliderMin??0},${f.sliderMax??100},${f.sliderRecenter??"none"}`:f.type==="toggle"?`${_},${f.toggleInitial?1:0}`:f.type==="radar"?[_,f.radarMinAngle??0,f.radarMaxAngle??180,f.radarMaxDistance??200,f.radarFadeMs??1200].join(","):f.type==="joystick"?[_,f.joystickXMin??-100,f.joystickXMax??100,f.joystickYMin??-100,f.joystickYMax??100,f.joystickXRecenter??"middle",f.joystickYRecenter??"middle"].join(","):_});c.push("__END__");const a=this.waitFor(f=>f==="LAYOUT_SAVED",ui*2,"LAYOUT_SAVED");await this.stream.sendReliable(c),await a}async listFiles(i="/"){return(await this.collectLines(`fs_list,${kl(i)}`,ui*3,"fs_list")).filter(a=>a.startsWith("fs_entry,")).map(a=>{const[,f,p,_]=a.split(","),y=f==="file"||f==="dir"?f:"unknown",E=parseInt(_??"",10),x=p||"/";return{name:x.split("/").filter(Boolean).pop()??x,path:x,type:y,...Number.isFinite(E)&&E>=0?{size:E}:{}}})}handleRadarLine(i){var _,y,E;const c=i.split(",");if(c.length<4)return;const a=(_=c[1])==null?void 0:_.trim(),f=parseFloat(c[2]??""),p=parseFloat(c[3]??"");!a||!Number.isFinite(f)||!Number.isFinite(p)||((E=(y=this.events).onRadar)==null||E.call(y,a,f,p),this.log("info",`rx: ${i}`))}handleTextLine(i){var E,x;const c=i.indexOf(","),a=c>=0?i.indexOf(",",c+1):-1;if(c<0||a<0)return;const f=i.slice(c+1,a),p=i.slice(a+1),_=f==null?void 0:f.trim();if(!_)return;const y=p.split(Ub).join(`
`);(x=(E=this.events).onText)==null||x.call(E,_,y),this.log("info",`rx: ${i}`)}handleToggleStateLine(i){var p,_,y;const c=i.split(",");if(c.length<3)return;const a=(p=c[1])==null?void 0:p.trim(),f=parseInt(c[2]??"",10);!a||!Number.isFinite(f)||((y=(_=this.events).onToggleState)==null||y.call(_,a,f===1),this.log("info",`rx: ${i}`))}async readText(i,c,a){c==null||c(4,"Validerer Picoens Bluetooth-filsystem...");const f=await this.getFilesystemCapabilities(a);if(f.streamRead)try{return await this.readTextStream(i,f,c,a)}catch(p){if(a!=null&&a.aborted||yh(p)||!f.pageRead)throw p;this.log("warning",p instanceof Error?`fs_read_stream fejlede; bruger paged read: ${p.message}`:"fs_read_stream fejlede; bruger paged read")}return this.readTextPaged(i,c,a)}async getFilesystemCapabilities(i){if(this.fsCapabilities)return this.fsCapabilities;const c=await this.collectLines("fs_capabilities",Yb,"fs_capabilities",i),a=c.find(b=>b.startsWith("ERR"));if(a)throw new Error(a);const f=c.find(b=>b.startsWith("fs_capabilities,"));if(!f)throw new Error("Kunne ikke validere Picoens Bluetooth-filsystem. Runtime sendte ikke fs_capabilities.");const p=f.split(","),_=new Map;for(let b=1;b<p.length-1;b+=2)_.set(p[b],p[b+1]);const y=parseInt(_.get("max_page")??"",10),E=parseInt(_.get("stream_chunk")??"",10),x={version:_.get("version")||void 0,pageRead:_.get("page_read")==="1",maxPageSize:Number.isFinite(y)&&y>0?y:32,streamRead:_.get("stream_read")==="1",streamChunkSize:Number.isFinite(E)&&E>0?E:128};if(!x.pageRead&&!x.streamRead)throw new Error("Picoens Bluetooth-runtime meldte, at file-read ikke er understøttet.");return this.fsCapabilities=x,x}async readTextPaged(i,c,a){const f=await this.getFilesystemCapabilities(a);let p=0,_=qb(f.maxPageSize),y=0,E=null,x="";const b=`Indlæser ${Cf(i)}...`;ea(a),c==null||c(5,b);for(let v=0;v<512;v+=1){ea(a),y===0&&(c==null||c(7,b));const I=await this.readPageWithRetry(i,y,p,_,a),V=I.lines;p=I.nextPageSizeIndex,_=I.maxPageSizeIndex,ea(a);const q=V.find(ee=>ee.startsWith("ERR"));if(q)throw new Error(q);const j=V.find(ee=>ee.startsWith("fs_page,"));if(!j)throw new Error("ERR: fs_read_page missing data");const[,L,H,ie,se=""]=j.split(",",5);if(L!==i)throw new Error("ERR: fs_read_page stale data");const oe=parseInt(H??"",10),pe=parseInt(ie??"",10);if(!Number.isFinite(oe)||oe!==y||!Number.isFinite(pe))throw new Error("ERR: fs_read_page invalid data");E=pe,x+=se,y+=Math.floor(se.length/2);const J=E>0?8+Math.min(87,Math.round(y/E*87)):95;if(c==null||c(J,b),y>=E||se.length===0)return c==null||c(100,"Fil indlæst fra Pico"),new TextDecoder().decode(xh(x))}throw new Error("ERR: fs_read_page too many pages")}async readPageWithRetry(i,c,a,f,p){let _,y=Math.min(a,f);for(;y>=0;){const E=uc[y],x=y===0?Vb:1,b=y===0?Ib:Gb;for(let v=1;v<=x;v+=1){ea(p);try{return{lines:await this.collectLines(`fs_read_page,${kl(i)},${c},${E}`,b,`fs_read_page ${c}`,p),nextPageSizeIndex:Math.min(y+1,f),maxPageSizeIndex:f}}catch(S){if(p!=null&&p.aborted||yh(S))throw S;if(_=S,v<x||y>0){const V=y>0&&v>=x?uc[y-1]:E;this.log("warning",`fs_read_page ${c} (${E} bytes) fejlede; prøver ${V} bytes`),await Of(80+v*80)}}}if(y===0)break;f=Math.max(0,y-1),y=f}throw _ instanceof Error?_:new Error(`Timeout: fs_read_page ${c}`)}async readTextStream(i,c,a,f){const p=`Indlæser ${Cf(i)}...`,_=Math.max(16,Math.min(192,c.streamChunkSize||128));a==null||a(5,p);const y=await this.collectLines(`fs_read_stream,${kl(i)},${_}`,$b,`fs_read_stream ${i}`,f,(J,ee)=>{const Re=8+Math.round(Math.min(J,ee)/Math.max(1,ee)*87);a==null||a(Math.min(95,Re),p)});ea(f);const E=y.find(J=>J.startsWith("ERR"));if(E)throw new Error(E);const x=y.find(J=>J.startsWith("fs_stream_begin,")),b=y.find(J=>J.startsWith("fs_stream_end,"));if(!x||!b)throw new Error("ERR: fs_read_stream missing metadata");const[,v,S]=x.split(",",4),[,I,V,q]=b.split(",",4),j=parseInt(S??"",10),L=parseInt(V??"",10),H=parseInt(q??"",10);if(v!==i||I!==i||!Number.isFinite(j)||j!==L||!Number.isFinite(H))throw new Error("ERR: fs_read_stream invalid metadata");let ie=0,se="";for(const J of y){if(!J.startsWith("fs_stream_chunk,"))continue;const[,ee,Re=""]=J.split(",",3),ve=parseInt(ee??"",10);if(!Number.isFinite(ve)||ve!==ie||Re.length%2!==0)throw new Error("ERR: fs_read_stream invalid chunk");se+=Re,ie+=Math.floor(Re.length/2)}if(ie!==j)throw new Error("ERR: fs_read_stream size mismatch");const oe=xh(se);if(vh(oe)!==H)throw new Error("ERR: fs_read_stream checksum mismatch");return a==null||a(100,"Fil indlæst fra Pico"),new TextDecoder().decode(oe)}async writeText(i,c,a){a==null||a(5,"Klargør BLE-overførsel..."),await this.exchange(`fs_write_begin,${kl(i)}`,b=>b==="ACK:fs_write_begin","fs_write_begin",2),a==null||a(18,"Pico er klar til filen...");const f=new TextEncoder().encode(c),p=[...f].map(b=>b.toString(16).padStart(2,"0")).join(""),_=[];for(let b=0;b<p.length;b+=160)_.push(`fs_write_chunk,${p.slice(b,b+160)}`);_.push("fs_write_end");const y=vh(f),E=this.waitFor(b=>b==="ACK:fs_write_done"||b.startsWith("ACK:fs_write_done,")||b.startsWith("ERR"),Hb,"fs_write_done");a==null||a(f.length===0?85:18,f.length===0?"Sender tom fil via Bluetooth...":`Sender 0/${f.length} bytes via Bluetooth...`),await this.stream.sendReliable(_,(b,v,S)=>{if(!S.startsWith("fs_write_chunk,"))return;const I=Math.min(f.length,b*80),V=18+Math.round(b/Math.max(1,v-1)*67);a==null||a(Math.min(85,V),`Sender ${I}/${f.length} bytes via Bluetooth...`)}),a==null||a(90,"Verificerer BLE-fil...");const x=await E;if(x.startsWith("ERR"))throw new Error(x);if(x.startsWith("ACK:fs_write_done,")){const[,b,v]=x.split(",",3),S=parseInt(b??"",10),I=parseInt(v??"",10);if(S!==f.length||I!==y)throw new Error(`ERR: BLE-verificering fejlede for ${Cf(i)}.`)}a==null||a(100,"Gemt på Pico")}async deleteFile(i){const c=await this.exchange(`fs_delete,${kl(i)}`,a=>a==="ACK:fs_delete"||a.startsWith("ERR"),"fs_delete",2);if(c.startsWith("ERR"))throw new Error(c)}async restart(){await this.exchange("restart",i=>i==="ACK:restart"||i.startsWith("ERR"),"restart",1).catch(()=>{}),this.expectingDisconnect=!0}async ping(){await this.exchange("HELLO",i=>i==="ACK:HELLO","heartbeat",1)}enqueueButton(i,c){this.busy||(this.pendingButtons.push(`button,${i}:${c?"down":"up"}`),this.pumpControls())}enqueueSlider(i,c){this.busy||(this.pendingSliders.set(i,`slider,${i}:${c}`),this.pumpControls())}enqueueToggle(i,c){this.busy||(this.pendingToggles.set(i,`toggle,${i}:${c?1:0}`),this.pumpControls())}enqueueJoystick(i,c,a){this.busy||(this.pendingJoysticks.set(i,`joystick,${i}:${Math.round(c)},${Math.round(a)}`),this.pumpControls())}enqueueDpad(i,c,a){this.busy||(this.pendingDpads.push(`dpad,${i}:${c},${a?"down":"up"}`),this.pumpControls())}pumpControls(){this.controlPumpActive||this.busy||!this.transport.connected||(this.controlPumpActive=!0,this.drainControls())}async drainControls(){try{for(;!this.busy&&this.transport.connected;){const i=this.nextControlLine();if(!i)break;await this.transport.writeLine(i),this.log("info",`tx: ${i}`),await Of(zb)}}catch(i){this.log("error",i instanceof Error?i.message:"Kunne ikke sende kommando."),this.handleDisconnect()}finally{this.controlPumpActive=!1,!this.busy&&this.transport.connected&&this.hasPendingControls()&&this.pumpControls()}}nextControlLine(){const i=this.pendingButtons.shift();if(i)return i;const c=this.pendingDpads.shift();if(c)return c;const a=this.pendingSliders.entries().next();if(!a.done){const[_,y]=a.value;return this.pendingSliders.delete(_),y}const f=this.pendingToggles.entries().next();if(!f.done){const[_,y]=f.value;return this.pendingToggles.delete(_),y}const p=this.pendingJoysticks.entries().next();if(!p.done){const[_,y]=p.value;return this.pendingJoysticks.delete(_),y}return null}hasPendingControls(){return this.pendingButtons.length>0||this.pendingDpads.length>0||this.pendingSliders.size>0||this.pendingToggles.size>0||this.pendingJoysticks.size>0}async disconnect(){if(!this.transport.connected){this.handleDisconnect();return}this.expectingDisconnect=!0;try{await this.exchange("disconnect",i=>i==="ACK:disconnect","disconnect",1)}catch{}this.transport.disconnect()}handleDisconnect(){var c,a,f;for(const p of this.waiters)clearTimeout(p.timer),p.reject(new Error("Forbindelsen blev afbrudt."));this.waiters=[],this.collectingLayout=!1,this.layoutResolve=null,(c=this.lineReject)==null||c.call(this,new Error("Forbindelsen blev afbrudt.")),this.collectingLines=!1,this.lineResolve=null,this.lineReject=null,this.fsCapabilities=null,this.stream.reset();const i=this.disconnectMessage??void 0;this.disconnectMessage=null,(f=(a=this.events).onDisconnect)==null||f.call(a,i)}}function qb(s){let i=0;for(let c=0;c<uc.length;c+=1)uc[c]<=s&&(i=c);return i}function Cf(s){return s.replace(/\\/g,"/").replace(/^\/+/,"")||s}function vh(s){let i=0;for(const c of s)i=i+c>>>0;return i}function xh(s){const i=new Uint8Array(Math.floor(s.length/2));for(let c=0;c<i.length;c+=1)i[c]=parseInt(s.slice(c*2,c*2+2),16);return i}function wh(s){const i=(c,a)=>Number.isFinite(c)?Math.max(Ob,Math.min(Cb,c)):a;for(const c of s){const a=c.trim();if(a.startsWith("#GRID,")){const f=a.split(","),p=i(parseInt(f[1],10),sa),_=i(parseInt(f[2],10),gs);return{cols:p,rows:_}}}return{cols:sa,rows:gs}}function Eh(s){const i=new Map;for(const c of s){const a=c.trim();if(!a||a.startsWith("#VERSION")||a==="__END__")continue;const f=a.split(",");if(f.length<7)continue;const[p,_,y,E,x,b,v,S,I,V,q,j,L]=f;if(p!=="button"&&p!=="slider"&&p!=="toggle"&&p!=="radar"&&p!=="text"&&p!=="joystick"&&p!=="dpad"||i.has(_))continue;const H=re=>{if(re==="n")return null;const ue=parseInt(re,10);return Number.isNaN(ue)?null:ue},ie=parseInt(v,10)||0,se=S!==void 0?parseInt(S,10):0,oe=I!==void 0?parseInt(I,10):100,pe=["none","bottom","middle","top"].includes(V??"")?V:"none",J=S!==void 0?parseInt(S,10)===1:!1,ee=S!==void 0?parseFloat(S):0,Re=I!==void 0?parseFloat(I):180,ve=V!==void 0?parseFloat(V):200,we=q!==void 0?parseInt(q,10):1200,W=(re,ue)=>["none","bottom","middle","top"].includes(re??"")?re:ue,Pe=S!==void 0?parseInt(S,10):-100,Ae=I!==void 0?parseInt(I,10):100,qe=V!==void 0?parseInt(V,10):-100,G=q!==void 0?parseInt(q,10):100;i.set(_,{type:p,name:_,centerX2:H(y),centerY2:H(E),spanX:H(x),spanY:H(b),rotation:[0,90,180,270].includes(ie)?ie:0,...p==="slider"?{sliderMin:Number.isFinite(se)?se:0,sliderMax:Number.isFinite(oe)?oe:100,sliderRecenter:pe}:{},...p==="toggle"?{toggleInitial:J}:{},...p==="radar"?{radarMinAngle:Number.isFinite(ee)?ee:0,radarMaxAngle:Number.isFinite(Re)?Re:180,radarMaxDistance:Number.isFinite(ve)&&ve>0?ve:200,radarFadeMs:Number.isFinite(we)&&we>0?we:1200}:{},...p==="joystick"?{joystickXMin:Number.isFinite(Pe)?Pe:-100,joystickXMax:Number.isFinite(Ae)&&Ae!==Pe?Ae:100,joystickYMin:Number.isFinite(qe)?qe:-100,joystickYMax:Number.isFinite(G)&&G!==qe?G:100,joystickXRecenter:W(j,"middle"),joystickYRecenter:W(L,"middle")}:{}})}return[...i.values()]}let le=null,as=null,ss=null,Jo=!1,Sh=0,Br=!1;function Fb(){return new Date().toLocaleTimeString("da-DK",{hour12:!1})}function kh(s){return new Promise(i=>setTimeout(i,s))}function Lf(s,i){const c=i.userID.toLowerCase();return s.map(a=>{if(!a.ownerID)return a;const f=a.ownerID.toLowerCase()===c;return{...a,isOwnedByMe:f,ownerName:f?i.username:a.ownerName}})}function Bf(s,i){return(s.name?d_(s.name):"")||(i==null?void 0:i.deviceName)||"Pico"}function Xb(s){return Object.fromEntries(s.filter(i=>i.type==="toggle").map(i=>[i.name,!!i.toggleInitial]))}function Nh(s,i){const c=Xb(s);for(const a of s)a.type==="toggle"&&i[a.name]!==void 0&&(c[a.name]=i[a.name]);return c}const ae=gb((s,i)=>{function c(b,v){s(S=>({logs:[{level:b,message:v,time:Fb()},...S.logs].slice(0,200)}))}function a(b){as&&clearTimeout(as),Sh+=1,s({toast:{message:b,id:Sh}}),as=setTimeout(()=>s({toast:null}),4500)}function f(b=null){E(),s({screen:"dashboard",active:null,layout:[],sliderValues:{},toggleValues:{},radarPings:{},textValues:{},editMode:!1,sideMenuOpen:!1,menuPage:null,connecting:null,connectionLost:b})}function p(b){return{deviceID:b.deviceID,deviceName:b.deviceName,ownerID:b.ownerID,deviceIconID:b.iconID,canOthersConnect:b.canOthersConnect,canOthersEdit:b.canOthersEdit,canOthersEditCode:b.canOthersEditCode,isOwnedByMe:b.isOwnedByMe,ownerName:b.ownerName}}function _(b){const{screen:v,active:S,picoIdeOrigin:I}=i();if(E(),Br){Br=!1;return}b&&(c("warning",b),a(b)),(v==="control"||v==="connection"||v==="create"||v==="ide"&&I==="control")&&f(S?p(S):null)}function y(){ss||(ss=setInterval(()=>{x()},3e3))}function E(){ss&&(clearInterval(ss),ss=null,Jo=!1)}async function x(){if(Jo)return;const{screen:b,active:v}=i();if(!(!!(le!=null&&le.connected)&&!!v&&b==="control")){E();return}Jo=!0;try{await(le==null?void 0:le.ping())}catch{c("warning","Bluetooth-forbindelsen svarer ikke længere."),await(le==null?void 0:le.disconnect().catch(()=>{})),_("Bluetooth-forbindelsen svarede ikke og blev afbrudt.")}finally{Jo=!1}}return le=new Pb({onProgress:(b,v)=>s({progress:{value:b,label:v}}),onLog:(b,v)=>c(b,v),onRadar:(b,v,S)=>{const I=Date.now(),V={id:`${I}-${Math.random().toString(36).slice(2)}`,angle:v,distance:S,createdAt:I};s(q=>{const j=q.layout.find(ie=>ie.type==="radar"&&ie.name===b),L=(j==null?void 0:j.radarFadeMs)??1200,H=q.radarPings[b]??[];return{radarPings:{...q.radarPings,[b]:[...H.filter(ie=>I-ie.createdAt<=L),V].slice(-80)}}})},onText:(b,v)=>{s(S=>({textValues:{...S.textValues,[b]:v}}))},onToggleState:(b,v)=>{s(S=>({toggleValues:{...S.toggleValues,[b]:v}}))},onDisconnect:b=>_(b)}),{screen:"splash",splashTarget:null,user:null,savedDevices:[],connecting:null,progress:{value:0,label:""},toast:null,confirmDialog:null,connectionLost:null,active:null,layout:[],sliderValues:{},toggleValues:{},radarPings:{},textValues:{},logs:[],sideMenuOpen:!1,debuggerOpen:!1,menuPage:null,editMode:!1,dashboardPage:"mine",picoIdeOrigin:"dashboard",init:()=>{const b=yb(),v=b?Lf(cc(),b):cc();b&&ra(v),s({user:b,savedDevices:v,splashTarget:b?"dashboard":"intro"})},finishSplash:()=>{const b=i().splashTarget;s({screen:b??"intro"})},createUser:b=>{const v=b.trim();if(!v)return;const S={username:v,userID:bb()};Df(S),s({user:S,screen:"dashboard"})},findDevice:async()=>{try{const b=await Db();await i().connectToDevice(b)}catch(b){b instanceof Error&&b.name!=="NotFoundError"&&c("error",b.message)}},connectToDevice:async(b,v)=>{var I,V,q;const S=i().user;if(!(!S||!le)){Br=!1,s({screen:"connection",connecting:{name:Bf(b,v),iconID:(v==null?void 0:v.deviceIconID)??0},progress:{value:0,label:"Forbinder..."}});try{await le.connect(b);const j=await le.runHandshake(S),L=b.id,H=(j.kind==="owned"||j.kind==="unowned")&&((I=j.deviceName)==null?void 0:I.trim())||Bf(b,v);if(s(J=>J.connecting?{connecting:{...J.connecting,name:H}}:{}),j.kind==="denied"){const ee=`Du kan ikke forbinde, fordi ${((V=j.ownerName)==null?void 0:V.trim())||((q=v==null?void 0:v.ownerName)==null?void 0:q.trim())||"ejeren"} ejer enheden og ikke tillader besøgende at forbinde.`;c("warning",ee),a(ee),s({screen:"dashboard",connecting:null}),await le.disconnect();return}if(j.kind==="unowned"){s({active:{deviceID:L,deviceName:H,ownerID:S.userID,iconID:0,canEdit:!0,canEditCode:!0,canOthersConnect:!1,canOthersEdit:!1,canOthersEditCode:!1,isOwnedByMe:!0,ownerName:S.username,gridCols:sa,gridRows:gs},screen:"create"});return}const ie={deviceID:L,deviceName:H,ownerID:j.ownerID,deviceIconID:j.iconID,canOthersConnect:j.canOthersConnect,canOthersEdit:j.canOthersEdit,canOthersEditCode:j.canOthersEditCode,isOwnedByMe:j.isOwnedByMe,ownerName:j.isOwnedByMe?S.username:j.ownerName??(v==null?void 0:v.ownerName)};s({savedDevices:jf(ie)});const se=await le.requestLayout(),oe=wh(se),pe=Eh(se);s({layout:pe,sliderValues:{},toggleValues:Nh(pe,i().toggleValues),radarPings:{},textValues:{},active:{deviceID:L,deviceName:H,ownerID:j.ownerID,iconID:j.iconID,canEdit:j.canEdit,canEditCode:j.canEditCode,canOthersConnect:j.canOthersConnect,canOthersEdit:j.canOthersEdit,canOthersEditCode:j.canOthersEditCode,isOwnedByMe:j.isOwnedByMe,ownerName:j.isOwnedByMe?S.username:j.ownerName??(v==null?void 0:v.ownerName),gridCols:oe.cols,gridRows:oe.rows},screen:"control",connecting:null,connectionLost:null}),y()}catch(j){const L=j instanceof Error?j.message:"Forbindelsen mislykkedes.";c("error",L),a("Forbindelsen mislykkedes."),s({screen:"dashboard",connecting:null}),await le.disconnect().catch(()=>{})}}},finishCreate:async(b,v,S,I,V,q)=>{const{user:j,active:L}=i();if(!(!j||!L||!le))try{le.setBusy(!0),await le.create(j,b,v,S,I,V,q),le.setBusy(!1);const H={deviceID:L.deviceID,deviceName:L.deviceName,ownerID:j.userID,deviceIconID:b,canOthersConnect:v,canOthersEdit:v&&S,canOthersEditCode:v&&I,isOwnedByMe:!0,ownerName:j.username};s({savedDevices:jf(H)});const ie=await le.requestLayout(),se=wh(ie),oe=Eh(ie);s({layout:oe,sliderValues:{},toggleValues:Nh(oe,i().toggleValues),radarPings:{},textValues:{},active:{...L,ownerID:j.userID,iconID:b,canEdit:!0,canEditCode:!0,canOthersConnect:v,canOthersEdit:v&&S,canOthersEditCode:v&&I,ownerName:j.username,gridCols:se.cols,gridRows:se.rows},screen:"control"}),y()}catch(H){le.setBusy(!1);const ie=H instanceof Error?H.message:"Oprettelse mislykkedes.";c("error",ie),a("Oprettelse mislykkedes."),s({screen:"dashboard"}),await le.disconnect().catch(()=>{})}},saveDeviceSettings:async(b,v,S,I,V,q)=>{const{active:j,user:L}=i();if(!(!j||!le||!j.isOwnedByMe))try{le.setBusy(!0),await le.updateDeviceSettings(b,v,S,I,V,q,L==null?void 0:L.username);const H={...j,iconID:b,canEdit:!0,canEditCode:!0,canOthersConnect:v,canOthersEdit:v&&S,canOthersEditCode:v&&I,ownerName:(L==null?void 0:L.username)??j.ownerName,gridCols:V,gridRows:q},ie={deviceID:j.deviceID,deviceName:j.deviceName,ownerID:j.ownerID??(L==null?void 0:L.userID),deviceIconID:b,canOthersConnect:v,canOthersEdit:v&&S,canOthersEditCode:v&&I,isOwnedByMe:!0,ownerName:(L==null?void 0:L.username)??j.ownerName};s({active:H,savedDevices:jf(ie)}),a("Enhedsindstillinger gemt.")}catch(H){c("error",H instanceof Error?H.message:"Kunne ikke gemme enhedsindstillinger."),a("Kunne ikke gemme enhedsindstillinger.")}finally{le.setBusy(!1)}},cancelCreate:async()=>{le&&await le.disconnect().catch(()=>{}),s({screen:"dashboard",active:null,connecting:null})},disconnect:async()=>{Br=!0,f(null),le&&await le.disconnect().catch(()=>{}),Br=!1},removeSavedDevice:b=>{s({savedDevices:Eb(b)})},clearSavedDevices:()=>{vb(),s({savedDevices:[]}),a("Gemte enheder ryddet.")},resetApplicationData:async()=>{Br=!0,le!=null&&le.connected&&await le.disconnect().catch(()=>{}),xb(),window.location.reload()},updateUsername:b=>{const v=i().user,S=b.trim();if(!v||!S)return;const I={...v,username:S};Df(I),s(V=>{var j;const q=Lf(V.savedDevices,I);return ra(q),{user:I,active:(j=V.active)!=null&&j.isOwnedByMe?{...V.active,ownerName:S}:V.active,savedDevices:q}}),a("Brugernavn gemt.")},createOwnerPairingCode:()=>{const b=i().user;return b?Kb(b):null},applyOwnerPairingCode:b=>{var S;const v=Qb(b,(S=i().user)==null?void 0:S.username);return v?(Df(v),s(I=>{var q,j,L;const V=Lf(I.savedDevices,v);return ra(V),{user:v,active:((j=(q=I.active)==null?void 0:q.ownerID)==null?void 0:j.toLowerCase())===v.userID.toLowerCase()||(L=I.active)!=null&&L.isOwnedByMe?{...I.active,isOwnedByMe:!0,ownerID:v.userID,ownerName:v.username}:I.active,savedDevices:V}}),a("Ejerkoden er gemt. Denne browser bruger nu samme ejer-GUID."),!0):(a("Ejerkoden kunne ikke læses."),!1)},openPicoIde:()=>{const b=i().screen==="control"&&!!(le!=null&&le.connected),v=i().active;if(b&&v&&!v.isOwnedByMe&&!v.canEditCode){a("Ejeren tillader ikke, at gæster åbner Kodeværkstedet på denne enhed."),c("warning","Kodeværkstedet er blokeret, fordi ejeren ikke tillader gæster at redigere kode."),s({sideMenuOpen:!1});return}s(S=>({screen:"ide",picoIdeOrigin:b?"control":"dashboard",active:b?S.active:null,layout:b?S.layout:[],sliderValues:b?S.sliderValues:{},toggleValues:b?S.toggleValues:{},radarPings:b?S.radarPings:{},textValues:b?S.textValues:{},editMode:!1,sideMenuOpen:!1,menuPage:null}))},closePicoIde:()=>{const{picoIdeOrigin:b,active:v}=i();s({screen:b==="control"&&v&&(le!=null&&le.connected)?"control":"dashboard",sideMenuOpen:!1,menuPage:null,picoIdeOrigin:"dashboard"})},isBleConnected:()=>!!(le!=null&&le.connected),bleListFiles:async()=>le!=null&&le.connected?le.listFiles("/"):[],bleReadText:async(b,v,S)=>{if(!(le!=null&&le.connected))throw new Error("Ingen BLE-forbindelse.");return le.readText(b,v,S)},bleWriteText:async(b,v,S)=>{if(!(le!=null&&le.connected))throw new Error("Ingen BLE-forbindelse.");await le.writeText(b,v,S)},bleDeleteFile:async b=>{if(!(le!=null&&le.connected))throw new Error("Ingen BLE-forbindelse.");await le.deleteFile(b)},bleRestart:async()=>{le!=null&&le.connected&&await le.restart()},bleRestartAndReconnect:async(b="control")=>{const{active:v}=i();if(!(le!=null&&le.connected)||!v)return!1;const S={deviceID:v.deviceID,deviceName:v.deviceName,ownerID:v.ownerID,deviceIconID:v.iconID,canOthersConnect:v.canOthersConnect,canOthersEdit:v.canOthersEdit,canOthersEditCode:v.canOthersEditCode,isOwnedByMe:v.isOwnedByMe,ownerName:v.ownerName};Br=!0,c("info","Genstarter Pico og forsøger automatisk genforbindelse...");try{await le.restart()}catch{}s({progress:{value:15,label:"Venter på Pico genstart..."},connecting:{name:S.deviceName,iconID:S.deviceIconID}});for(let I=0;I<12&&(le!=null&&le.connected);I+=1)await kh(250);le!=null&&le.connected||(Br=!1);for(let I=1;I<=8;I+=1){await kh(I===1?1200:850);try{const q=(await m_()).find(j=>j.id===S.deviceID);if(!q){s({progress:{value:Math.min(88,20+I*8),label:"Venter på browser-tilladelse..."}});continue}return s({progress:{value:Math.min(92,24+I*8),label:`Genforbinder (${I}/8)...`}}),await i().connectToDevice(q,S),b==="ide"&&s(j=>({screen:"ide",picoIdeOrigin:"control",active:j.active,layout:j.layout,sliderValues:j.sliderValues,toggleValues:j.toggleValues,radarPings:j.radarPings,textValues:j.textValues,editMode:!1,sideMenuOpen:!1,menuPage:null})),a("Pico genforbundet."),!0}catch(V){c("warning",V instanceof Error?V.message:"Genforbindelse mislykkedes.")}}return a("Kunne ikke genforbinde automatisk. Vælg Picoen igen."),Br=!1,s({screen:"dashboard",active:null,layout:[],sliderValues:{},toggleValues:{},radarPings:{},textValues:{},editMode:!1,sideMenuOpen:!1,menuPage:null,connecting:null,connectionLost:S}),!1},reconnectLostDevice:async()=>{var v;const b=i().connectionLost;if(b){s({connectionLost:null});try{if((v=navigator.bluetooth)!=null&&v.getDevices){const I=(await navigator.bluetooth.getDevices()).find(V=>V.id===b.deviceID);if(I){await i().connectToDevice(I,b);return}}}catch{}c("info","Genforbind: vælg enheden i browserens liste."),await i().findDevice()}},dismissConnectionLost:()=>s({connectionLost:null}),sendButton:(b,v)=>le==null?void 0:le.enqueueButton(b,v),sendSlider:(b,v)=>{s(S=>({sliderValues:{...S.sliderValues,[b]:v}})),le==null||le.enqueueSlider(b,v)},sendToggle:(b,v)=>{s(S=>({toggleValues:{...S.toggleValues,[b]:v}})),le==null||le.enqueueToggle(b,v)},sendJoystick:(b,v,S)=>le==null?void 0:le.enqueueJoystick(b,v,S),sendDpad:(b,v,S)=>le==null?void 0:le.enqueueDpad(b,v,S),saveLayout:async b=>{if(le)try{le.setBusy(!0),await le.saveLayout(b),s({layout:b,editMode:!1})}catch(v){c("error",v instanceof Error?v.message:"Kunne ikke gemme layout.")}finally{le.setBusy(!1)}},setEditMode:b=>s({editMode:b,sideMenuOpen:!1,menuPage:null}),setDashboardPage:b=>s({dashboardPage:b}),toggleSideMenu:b=>s(v=>({sideMenuOpen:b??!v.sideMenuOpen})),toggleDebugger:b=>s(v=>({debuggerOpen:b??!v.debuggerOpen,sideMenuOpen:!1,menuPage:null})),openMenuPage:b=>s({menuPage:b,sideMenuOpen:!1}),closeMenuPage:()=>s({menuPage:null}),clearLogs:()=>s({logs:[]}),log:(b,v)=>c(b,v),askConfirm:b=>s({confirmDialog:b}),closeConfirm:()=>s({confirmDialog:null}),showToast:b=>a(b),dismissToast:()=>{as&&clearTimeout(as),s({toast:null})}}}),$f="PKP-EJER";function Kb(s){var a;const i=s.userID.toLowerCase(),c=((a=i.match(/.{1,4}/g))==null?void 0:a.join("-"))??i;return`${$f}-${c}-${g_(i)}`}function Qb(s,i="Ejer"){const c=s.trim().toUpperCase().replace(/\s+/g,"-");if(!c.startsWith(`${$f}-`))return null;const a=c.slice($f.length+1).split("-").filter(Boolean),f=a.pop()??"",p=a.join("").toLowerCase();return!/^[a-f0-9]{32}$/.test(p)||f!==g_(p)?null:{userID:p,username:i.trim()||"Ejer"}}function g_(s){let i=2166136261;for(const c of s.toLowerCase())i^=c.charCodeAt(0),i=Math.imul(i,16777619)>>>0;return(i%65536).toString(16).toUpperCase().padStart(4,"0")}const gc="./",b_=[{id:0,label:"Raspberry Pi"},{id:1,label:"Sumo robot"},{id:2,label:"LED / lys"},{id:3,label:"Lineal + blyant"},{id:4,label:"Bil"},{id:5,label:"Tank"},{id:6,label:"Robotarm"},{id:7,label:"Bi"},{id:8,label:"Palet"},{id:9,label:"Afstandssensor"},{id:10,label:"Søg"},{id:11,label:"Alarm"}];function ca(s){const i=s>=0&&s<b_.length?s:0;return`${gc}device-icons/${i}.png`}const Zb=`${gc}art/logo.png`,Wb=`${gc}art/Teknologiskolen_logo.png`,Jb=`${gc}art/logo_teknologiskolen_white.png`,e0={menu:u.jsxs(u.Fragment,{children:[u.jsx("line",{x1:"3",y1:"6",x2:"21",y2:"6"}),u.jsx("line",{x1:"3",y1:"12",x2:"21",y2:"12"}),u.jsx("line",{x1:"3",y1:"18",x2:"21",y2:"18"})]}),close:u.jsxs(u.Fragment,{children:[u.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"}),u.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"})]}),user:u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),u.jsx("circle",{cx:"12",cy:"7",r:"4"})]}),settings:u.jsxs(u.Fragment,{children:[u.jsx("circle",{cx:"12",cy:"12",r:"3"}),u.jsx("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]}),info:u.jsxs(u.Fragment,{children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("line",{x1:"12",y1:"16",x2:"12",y2:"12"}),u.jsx("line",{x1:"12",y1:"8",x2:"12.01",y2:"8"})]}),help:u.jsxs(u.Fragment,{children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),u.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]}),debugger:u.jsx(u.Fragment,{children:u.jsx("path",{d:"M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"})}),edit:u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"}),u.jsx("path",{d:"M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4z"})]}),picoIde:u.jsxs(u.Fragment,{children:[u.jsx("rect",{x:"3",y:"4",width:"18",height:"16",rx:"2"}),u.jsx("path",{d:"M8 9l-3 3 3 3"}),u.jsx("path",{d:"M16 9l3 3-3 3"}),u.jsx("line",{x1:"13",y1:"8",x2:"11",y2:"16"})]}),exit:u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"}),u.jsx("polyline",{points:"16 17 21 12 16 7"}),u.jsx("line",{x1:"21",y1:"12",x2:"9",y2:"12"})]}),plus:u.jsxs(u.Fragment,{children:[u.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),u.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),delete:u.jsxs(u.Fragment,{children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"}),u.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"})]}),power:u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M18.36 6.64a9 9 0 1 1-12.73 0"}),u.jsx("line",{x1:"12",y1:"2",x2:"12",y2:"12"})]}),save:u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"}),u.jsx("polyline",{points:"17 21 17 13 7 13 7 21"}),u.jsx("polyline",{points:"7 3 7 8 15 8"})]}),upload:u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),u.jsx("polyline",{points:"17 8 12 3 7 8"}),u.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),refresh:u.jsxs(u.Fragment,{children:[u.jsx("polyline",{points:"23 4 23 10 17 10"}),u.jsx("polyline",{points:"1 20 1 14 7 14"}),u.jsx("path",{d:"M3.5 9a9 9 0 0 1 14.9-3.4L23 10"}),u.jsx("path",{d:"M20.5 15a9 9 0 0 1-14.9 3.4L1 14"})]}),package:u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),u.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),u.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]}),back:u.jsxs(u.Fragment,{children:[u.jsx("line",{x1:"19",y1:"12",x2:"5",y2:"12"}),u.jsx("polyline",{points:"12 19 5 12 12 5"})]})};function nt({name:s,size:i=24,className:c}){return u.jsx("svg",{width:i,height:i,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",className:c,"aria-hidden":"true",children:e0[s]})}const n0=1850,t0=450;function r0(){const s=ae(a=>a.splashTarget),i=ae(a=>a.finishSplash),c=s?"splash-screen-animation splash-ready":"splash-pending";return z.useEffect(()=>{if(!s)return;const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches?t0:n0,p=window.setTimeout(i,f);return()=>window.clearTimeout(p)},[i,s]),u.jsxs("div",{className:`screen splash-screen ${c}`,"aria-label":"Teknologiskolen starter",children:[u.jsx("div",{className:"splash-white-cover"}),u.jsx("div",{className:"splash-red-field"}),u.jsx("div",{className:"splash-brand","aria-hidden":"true",children:u.jsx("div",{className:"splash-mark splash-logo-shell",children:u.jsx("img",{className:"splash-logo",src:Zb,alt:""})})}),u.jsx("span",{className:"sr-only",children:"Teknologiskolen"})]})}function Rh(){const s=ae(f=>f.createUser),[i,c]=z.useState(""),a=i.length>0;return u.jsxs("div",{className:"screen intro",children:[u.jsxs("div",{className:"intro-header",children:[u.jsx("span",{className:"intro-header-fill","aria-hidden":"true"}),u.jsx("img",{className:"intro-header-image",src:Wb,alt:"Teknologiskolen"}),u.jsx("span",{className:"intro-header-fill","aria-hidden":"true"})]}),u.jsxs("div",{className:"intro-body",children:[u.jsx("p",{children:"Velkommen til Teknologiskolens Bluetooth-styringsapplikation til Raspberry Pi. Find selv på et navn, du vil vises som i appen. Det er ikke et login, og navnet gemmes kun i denne browser."}),u.jsxs("div",{className:`field ${a?"filled":""}`,children:[u.jsx("input",{id:"username",value:i,onChange:f=>c(f.target.value),maxLength:32,autoComplete:"off","aria-label":"Brugernavn"}),u.jsx("label",{htmlFor:"username",children:"Brugernavn"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",disabled:!a,onClick:()=>s(i),children:"Fortsæt"})]}),u.jsx("span",{className:"version",children:_s})]})}function rd({title:s,onMenu:i}){return u.jsx("header",{className:"topbar",children:u.jsxs("div",{className:"topbar-inner",children:[u.jsx("h1",{children:s}),u.jsx("button",{className:"iconbtn",type:"button",onClick:i,"aria-label":"Menu",children:u.jsx(nt,{name:"menu"})})]})})}function Tn({title:s,onClose:i,children:c,closeVariant:a="plain"}){const f=a==="circle",p=z.useRef(!1);return u.jsx("div",{className:"modal-root",onPointerDown:_=>{p.current=_.target===_.currentTarget},onClick:_=>{_.target===_.currentTarget&&p.current&&i(),p.current=!1},children:u.jsxs("div",{className:"modal",onClick:_=>_.stopPropagation(),children:[u.jsxs("div",{className:"modal-head",children:[u.jsx("h3",{children:s}),u.jsx("button",{className:`iconbtn ${f?"modal-close-circle":""}`,type:"button",onClick:i,"aria-label":"Luk",children:u.jsx(nt,{name:f?"delete":"close",size:f?30:24})})]}),u.jsx("div",{className:"modal-body",children:c})]})})}function Th(){const s=ae(S=>S.savedDevices),i=ae(S=>S.toggleSideMenu),c=ae(S=>S.findDevice),a=ae(S=>S.removeSavedDevice),f=ae(S=>S.askConfirm),p=ae(S=>S.dashboardPage),_=ae(S=>S.setDashboardPage),y=s0(),[E,x]=z.useState(null),b=_c(),v=s.filter(S=>p==="mine"?S.isOwnedByMe:!S.isOwnedByMe).sort(a0);return u.jsxs("div",{className:"screen dashboard-screen",children:[u.jsx(rd,{title:"Hovedmenu",onMenu:()=>i()}),u.jsxs("div",{className:"content dash-content",children:[!b&&u.jsx("div",{className:"notice",children:"Web Bluetooth er ikke tilgængelig her. På iPhone/iPad: åbn siden i Bluefy-browseren. På Android: brug Chrome."}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:p==="mine"?"active":"",onClick:()=>_("mine"),children:"Mine Enheder"}),u.jsx("button",{type:"button",className:p==="andre"?"active":"",onClick:()=>_("andre"),children:"Andre Enheder"})]}),u.jsx("div",{className:"panel panel-white device-list",children:v.length===0?u.jsx("div",{className:"device-list-empty",children:p==="mine"?"Ingen enheder endnu. Tryk på + for at finde en enhed.":"Ingen andre enheder gemt."}):v.map(S=>u.jsx(l0,{device:S,disabled:!b,onConnect:()=>y(S),onSettings:()=>x(S)},S.deviceID))})]}),u.jsx("button",{className:"fab",type:"button",onClick:()=>c(),disabled:!b,"aria-label":"Find enhed",children:u.jsx(nt,{name:"plus",size:30})}),u.jsx("span",{className:"version",children:_s}),E&&u.jsx(Tn,{title:"Enhedsindstillinger",onClose:()=>x(null),children:u.jsxs("div",{className:"settings-stack",children:[u.jsxs("div",{className:"saved-device-head",children:[u.jsx("img",{src:ca(E.deviceIconID),alt:""}),u.jsx("strong",{children:E.deviceName})]}),u.jsx(os,{label:"Gemte indstillinger",value:"Denne browser"}),u.jsx(os,{label:"Ejer",value:i0(E)}),u.jsx(os,{label:"Offentlig",value:E.canOthersConnect?"Ja":"Nej"}),u.jsx(os,{label:"Andre må redigere layout",value:E.canOthersEdit?"Ja":"Nej"}),u.jsx(os,{label:"Andre må redigere kode",value:E.canOthersEditCode?"Ja":"Nej"}),u.jsx("div",{className:"notice",children:"Forbind til enheden for at ændre de indstillinger, der er gemt på Picoen."}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",disabled:!b,onClick:()=>{const S=E;x(null),y(S)},children:"Forbind"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>f({title:"Glem enhed",message:`Vil du fjerne ${E.deviceName} fra gemte enheder?`,confirmLabel:"Glem",onConfirm:()=>{a(E.deviceID),x(null)}}),children:"Glem enhed"})]})})]})}function l0({device:s,disabled:i,onConnect:c,onSettings:a}){return u.jsxs("div",{className:"device-tile-wrap",children:[u.jsxs("button",{className:"device-tile",type:"button",onClick:c,disabled:i,children:[u.jsx("img",{className:"device-tile-icon",src:ca(s.deviceIconID),alt:""}),u.jsx("span",{className:"device-tile-name",children:s.deviceName})]}),u.jsx("button",{className:"device-tile-del",type:"button",onClick:a,"aria-label":"Enhedsindstillinger",children:u.jsx(nt,{name:"settings"})})]})}function os({label:s,value:i}){return u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:s}),u.jsx("strong",{children:i})]})}function i0(s){var i;return s.isOwnedByMe?"Dig":((i=s.ownerName)==null?void 0:i.trim())||"Anden bruger"}function a0(s,i){return s.deviceName.localeCompare(i.deviceName,"da",{sensitivity:"base"})}function s0(){const s=ae(a=>a.connectToDevice),i=ae(a=>a.findDevice),c=ae(a=>a.log);return async a=>{const p=(await m_()).find(_=>_.id===a.deviceID);p?await s(p,a):(c("info","Genforbind: vælg enheden i browserens liste."),await i())}}function o0(){const s=ae(c=>c.connecting),i=ae(c=>c.progress);return u.jsxs("div",{className:"screen connection",children:[u.jsx("div",{className:"device-icon-pick",children:u.jsx("img",{src:ca((s==null?void 0:s.iconID)??0),alt:""})}),u.jsxs("h2",{style:{margin:0,color:"var(--red)"},children:["Forbinder til ",(s==null?void 0:s.name)??"enhed"]}),u.jsx("div",{className:"spinner"}),u.jsxs("div",{style:{width:"100%"},children:[u.jsx("div",{className:"progress-track",children:u.jsx("div",{className:"progress-fill",style:{width:`${i.value}%`}})}),u.jsx("p",{style:{color:"var(--muted)",fontWeight:600,marginTop:12},children:i.label})]})]})}function y_({selected:s,onSelect:i,onClose:c}){return u.jsx(Tn,{title:"Vælg Enhedens Ikon",onClose:c,children:u.jsx("div",{className:"icon-grid",children:b_.map(a=>u.jsx("button",{type:"button",className:`icon-tile ${a.id===s?"selected":""}`,onClick:()=>{i(a.id),c()},"aria-label":a.label,children:u.jsx("img",{src:ca(a.id),alt:""})},a.id))})})}function c0(){const s=ae(se=>se.finishCreate),i=ae(se=>se.cancelCreate),[c,a]=z.useState(0),[f,p]=z.useState(!1),[_,y]=z.useState(!1),[E,x]=z.useState(!1),[b,v]=z.useState(!1),[S,I]=z.useState(sa),[V,q]=z.useState(gs),[j,L]=z.useState(!1),H=se=>Number.isFinite(se)?Math.max(la,Math.min(ia,Math.round(se))):sa;async function ie(){L(!0),await s(c,_,_&&E,_&&b,H(S),H(V))}return u.jsxs("div",{className:"screen",children:[u.jsx("header",{className:"topbar",children:u.jsx("h1",{children:"Opret Enhed"})}),u.jsxs("div",{className:"content create-body",children:[u.jsxs("button",{type:"button",className:"device-icon-pick",onClick:()=>p(!0),"aria-label":"Vælg ikon",children:[u.jsx("img",{src:ca(c),alt:""}),u.jsx("span",{className:"badge",children:u.jsx(nt,{name:"plus",size:22})})]}),u.jsx("p",{className:"prompt",children:"Må andre forbinde til- og bruge denne enhed?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:_?"":"active",onClick:()=>y(!1),children:"Privat"}),u.jsx("button",{type:"button",className:_?"active":"",onClick:()=>y(!0),children:"Offentlig"})]}),_&&u.jsxs(u.Fragment,{children:[u.jsx("p",{className:"prompt",children:"Må andre redigere layoutet?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:E?"":"active",onClick:()=>x(!1),children:"Nej"}),u.jsx("button",{type:"button",className:E?"active":"",onClick:()=>x(!0),children:"Ja"})]}),u.jsx("p",{className:"prompt",children:"Må andre redigere koden?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:b?"":"active",onClick:()=>v(!1),children:"Nej"}),u.jsx("button",{type:"button",className:b?"active":"",onClick:()=>v(!0),children:"Ja"})]})]}),u.jsx("p",{className:"prompt",children:"Kontrolpanelets gitter (kolonner × rækker)"}),u.jsxs("div",{className:"row",style:{width:"100%"},children:[u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"cols",children:"Kolonner"}),u.jsx("input",{id:"cols",type:"number",min:la,max:ia,value:Number.isNaN(S)?"":S,onChange:se=>I(parseInt(se.target.value,10)),onBlur:()=>I(H(S))})]}),u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"rows",children:"Rækker"}),u.jsx("input",{id:"rows",type:"number",min:la,max:ia,value:Number.isNaN(V)?"":V,onChange:se=>q(parseInt(se.target.value,10)),onBlur:()=>q(H(V))})]})]}),u.jsxs("div",{className:"row",style:{marginTop:"auto",width:"100%"},children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>i(),disabled:j,children:"Annuller"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:ie,disabled:j,children:j?"Opretter...":"Opret"})]})]}),f&&u.jsx(y_,{selected:c,onSelect:a,onClose:()=>p(!1)}),u.jsx("span",{className:"version",children:_s})]})}const oa=8;function ic(s){return Math.max(5,Math.min(22,s))}function u0(s,i,c){const a=Math.max(1,s.length),f=(i-oa*2)/(a*.58),p=(c-oa*2)*.48;return ic(Math.min(f,p))}function fi(s,i,c){switch(c){case 90:return{x:-i,y:s};case 180:return{x:-s,y:-i};case 270:return{x:i,y:-s};default:return{x:s,y:i}}}function fc(s){return(360-s)%360}function f0(s,i,c,a){const f=a===90||a===270;return u0(s,f?c:i,f?i:c)}function dc({name:s,width:i,height:c,rotation:a}){return u.jsx("span",{style:{display:"inline-block",fontWeight:800,fontSize:f0(s,i,c,a),transform:a?`rotate(${a}deg)`:void 0,whiteSpace:a===90||a===270?"nowrap":void 0},children:s})}function d0(s,i,c,a,f){const p=s.trim().split(/\s+/).filter(Boolean),_=Math.max(1,s.replace(/\s+/g,"").length+Math.max(0,p.length-1)*1.6),y=f?ic(Math.min(i/4.6,c/4.6,12)):0,E=f?y+oa:oa;if(a){const v=Math.max(1,c-E*2);return{fontSize:ic(Math.min(i*.48,v/(_*1.04))),endFontSize:y,centerInset:f?{top:E,bottom:E}:{}}}const x=Math.max(1,i-E*4.2);return{fontSize:ic(Math.min(c*.42,x/(_*.58))),endFontSize:y,centerInset:f?{left:E*2.1,right:E*2.1}:{}}}function m0({control:s,rect:i,disabled:c,latestValue:a,toggleValue:f,radarPings:p=[],textValue:_,onButton:y,onSlider:E,onToggle:x,onJoystick:b,onDpad:v}){const S=z.useRef(!1),I={left:i.cx,top:i.cy,width:i.width,height:i.height};if(s.type==="button"){const V=()=>{c||!S.current||(S.current=!1,y(s.name,!1))};return u.jsx("div",{className:"control",style:I,children:u.jsx("button",{className:"control-button",type:"button",disabled:c,style:{width:"100%",height:"100%",display:"grid",placeItems:"center"},onPointerDown:q=>{var j,L;c||(q.preventDefault(),(L=(j=q.currentTarget).setPointerCapture)==null||L.call(j,q.pointerId),S.current=!0,y(s.name,!0))},onPointerUp:q=>{var j,L;q.preventDefault(),(L=(j=q.currentTarget).releasePointerCapture)==null||L.call(j,q.pointerId),V()},onPointerCancel:V,onLostPointerCapture:V,children:u.jsx(dc,{name:s.name,width:i.width,height:i.height,rotation:s.rotation})})})}if(s.type==="toggle"){const V=!!f;return u.jsx("div",{className:"control",style:I,children:u.jsx("button",{className:`control-toggle ${V?"on":""}`,type:"button",disabled:c,"aria-pressed":V,style:{width:"100%",height:"100%"},onPointerDown:q=>{c||(q.preventDefault(),x(s.name,!V))},children:u.jsx(dc,{name:s.name,width:i.width,height:i.height,rotation:s.rotation})})})}return s.type==="radar"?u.jsx("div",{className:"control",style:I,children:u.jsx(x_,{control:s,pings:p,width:i.width,height:i.height})}):s.type==="text"?u.jsx("div",{className:"control",style:I,children:u.jsx(v_,{message:_??s.name,width:i.width,height:i.height,rotation:s.rotation})}):s.type==="joystick"?u.jsx("div",{className:"control",style:I,children:u.jsx(M0,{control:s,disabled:c,onJoystick:b,width:i.width,height:i.height})}):s.type==="dpad"?u.jsx("div",{className:"control",style:I,children:u.jsx(z0,{control:s,disabled:c,onDpad:v})}):u.jsx("div",{className:"control",style:I,children:u.jsx(T0,{control:s,disabled:c,latestValue:a,onSlider:E,width:i.width,height:i.height})})}function p0(s,i,c){const f=(s.trim()||" ").split(`
`),p=f.reduce((S,I)=>I.split(/\s+/).filter(Boolean).reduce((q,j)=>Math.max(q,j.length),S),1),_=Math.max(1,Math.floor(p*1.9)),y=Math.max(f.length,f.reduce((S,I)=>S+Math.max(1,Math.ceil(Math.max(1,I.trim().length)/_)),0)),E=Math.max(1,i-oa*3),x=Math.max(1,c-oa*3),b=E/(p*.58),v=x/(y*1.16);return Math.max(7,Math.min(24,b,v))}function v_({message:s,width:i,height:c,rotation:a=0}){const f=s.trim()||"...",p=a===90||a===270,_=p0(f,p?c:i,p?i:c);return u.jsx("div",{className:"control-text",style:{width:"100%",height:"100%",fontSize:_},children:u.jsx("span",{style:{transform:a?`rotate(${a}deg)`:void 0},children:f})})}function x_({control:s,pings:i,width:c,height:a,preview:f=!1}){const[,p]=z.useState(0),_=Math.max(120,s.radarFadeMs??1200),y=s.radarMinAngle??0,E=s.radarMaxAngle??180,x=Kn(y),b=Kn(E),v=Math.abs(E-y)>=360||x===b&&y!==E,S=Math.max(1,s.radarMaxDistance??200),I=Date.now(),V=i[i.length-1],q=s.rotation,j=Kn(x+q),L=Kn(b+q),H=S0(x,b),ie=((V==null?void 0:V.angle)??H)+q,se=f?[{id:"preview",angle:H,distance:S*.62,createdAt:I}]:i.filter(fe=>I-fe.createdAt<=_),oe=!v,pe=Math.max(8,Math.min(12,Math.min(c,a)*.16)),J=Math.max(7,pe*.85),ee=0,Re=0,ve=1,we=v0(v,j,L,q,S),W=v?{x:-1.12,y:-1.12,width:2.24,height:2.24}:x0(j,L,we.map(fe=>fe.point)),Pe=v?"":h0(ee,Re,ve,j,L),Ae=Ah(y),qe=Ah(E),G=oe?E0(j,L,W,c,a,Ae,qe,pe):null,re=we.map(fe=>{const Ee=w_(fe.point,W,c,a);return{key:fe.key,value:fe.value,x:Ee.x,y:Ee.y}});z.useEffect(()=>{if(f||i.length===0)return;const fe=window.setInterval(()=>p(Ee=>Ee+1),120);return()=>window.clearInterval(fe)},[_,i.length,f]);const ue=Et(ee,Re,ve,ie);return u.jsxs("div",{className:"control-radar",style:{width:"100%",height:"100%"},children:[u.jsxs("svg",{width:c,height:a,viewBox:`${W.x} ${W.y} ${W.width} ${W.height}`,preserveAspectRatio:"none","aria-hidden":"true",children:[v?u.jsx("circle",{className:"radar-sector-fill",cx:ee,cy:Re,r:ve}):u.jsx("path",{className:"radar-sector-fill",d:Pe}),[.25,.5,.75,1].map(fe=>v?u.jsx("circle",{className:"radar-ring",cx:ee,cy:Re,r:ve*fe},fe):u.jsx("path",{className:"radar-ring",d:_0(ee,Re,ve*fe,j,L)},fe)),!v&&u.jsx(Mh,{cx:ee,cy:Re,radius:ve,angle:j}),!v&&u.jsx(Mh,{cx:ee,cy:Re,radius:ve,angle:L}),u.jsx("line",{className:"radar-sweep",x1:ee,y1:Re,x2:ue.x,y2:ue.y}),se.map(fe=>{const Ee=f?0:I-fe.createdAt,N=Math.max(0,1-Ee/_),U=Math.max(0,Math.min(S,fe.distance)),te=Et(ee,Re,ve*(U/S),fe.angle+q);return u.jsx("circle",{className:"radar-ping",cx:te.x,cy:te.y,r:Math.max(.025,Math.min(W.width,W.height)*.025),opacity:N},fe.id)})]}),oe&&G&&u.jsxs(u.Fragment,{children:[u.jsx("span",{className:"radar-angle-label",style:{left:G.min.x,top:G.min.y,fontSize:pe},children:Ae}),u.jsx("span",{className:"radar-angle-label",style:{left:G.max.x,top:G.max.y,fontSize:pe},children:qe})]}),re.map(fe=>u.jsx("span",{className:"radar-range-label",style:{left:fe.x,top:fe.y,fontSize:J},children:fe.value},fe.key))]})}function Mh({cx:s,cy:i,radius:c,angle:a}){const f=Et(s,i,c,a);return u.jsx("line",{className:"radar-boundary",x1:s,y1:i,x2:f.x,y2:f.y})}function Et(s,i,c,a){const f=(Kn(a)-90)*Math.PI/180;return{x:s+Math.cos(f)*c,y:i+Math.sin(f)*c}}function h0(s,i,c,a,f){const p=Et(s,i,c,a),_=Et(s,i,c,f),y=bc(a,f)>180?1:0;return`M ${s} ${i} L ${p.x} ${p.y} A ${c} ${c} 0 ${y} 1 ${_.x} ${_.y} Z`}function _0(s,i,c,a,f){const p=Et(s,i,c,a),_=Et(s,i,c,f),y=bc(a,f)>180?1:0;return`M ${p.x} ${p.y} A ${c} ${c} 0 ${y} 1 ${_.x} ${_.y}`}function bc(s,i){const c=Kn(s),a=Kn(i),f=a>=c?a-c:360-c+a;return f===0?360:f}const ec=[.25,.5,.75,1],g0=.1,b0=.85,y0=55;function v0(s,i,c,a,f){const p=(E,x,b)=>({key:`${E}-${x}`,value:Math.round(f*x),point:Et(0,0,x,b)});if(s){const E=Kn(180+a);return ec.map(x=>p("full",x,E))}const _=360-bc(i,c);if(_<y0){const E=Kn(c+_/2);return ec.map(x=>p("mid",x,E))}const y=(E,x,b)=>{const v=Math.asin(Math.min(b0,g0/x))*180/Math.PI;return Kn(E+b*v)};return[...ec.map(E=>p("min",E,y(i,E,-1))),...ec.map(E=>p("max",E,y(c,E,1)))]}function x0(s,i,c=[]){const a=[{x:0,y:0},Et(0,0,1,s),Et(0,0,1,i),...c];for(const v of[0,90,180,270])w0(v,s,i)&&a.push(Et(0,0,1,v));const f=Math.min(...a.map(v=>v.x)),p=Math.max(...a.map(v=>v.x)),_=Math.min(...a.map(v=>v.y)),y=Math.max(...a.map(v=>v.y)),E=Math.max(.1,p-f),x=Math.max(.1,y-_),b=Math.max(E,x)*.24;return{x:f-b,y:_-b,width:E+b*2,height:x+b*2}}function w0(s,i,c){const a=Kn(i),f=Kn(s),p=bc(i,c),_=Kn(f-a);return _>=0&&_<=p}function E0(s,i,c,a,f,p,_,y){const x=Et(0,0,1.1,s),b=Et(0,0,1.1,i);return{min:Dh(x,c,a,f,p,y),max:Dh(b,c,a,f,_,y)}}function w_(s,i,c,a){return{x:(s.x-i.x)/i.width*c,y:(s.y-i.y)/i.height*a}}function Dh(s,i,c,a,f,p){const _=w_(s,i,c,a),y=Math.max(10,f.length*p*.62),E=p,x=7;return{x:jh(_.x,y/2+x,Math.max(y/2+x,c-y/2-x)),y:jh(_.y,E/2+x,Math.max(E/2+x,a-E/2-x))}}function jh(s,i,c){return Math.max(i,Math.min(c,s))}function Ah(s){return`${Math.round(s)}`}function Kn(s){return Number.isFinite(s)?(s%360+360)%360:0}function S0(s,i){const c=Kn(s),a=Kn(i),f=a>=c?a-c:360-c+a;return Kn(c+f/2)}function k0(s,i){if(!i)return s;const c=s.trim().split(/\s+/).filter(Boolean);return u.jsx("span",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",width:"100%",lineHeight:1.02,textAlign:"center",gap:"0.42em"},children:c.map((a,f)=>u.jsx("span",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[...a].map((p,_)=>u.jsx("span",{children:p},`${p}-${_}`))},`${a}-${f}`))})}function N0(s){const i={position:"absolute",display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"none"},c=4;return s===0?{low:{...i,left:c,top:0,bottom:0},high:{...i,right:c,top:0,bottom:0}}:s===180?{low:{...i,right:c,top:0,bottom:0},high:{...i,left:c,top:0,bottom:0}}:s===90?{low:{...i,bottom:c,left:0,right:0},high:{...i,top:c,left:0,right:0}}:{low:{...i,top:c,left:0,right:0},high:{...i,bottom:c,left:0,right:0}}}function R0({name:s,vertical:i,rotation:c,color:a,fontSize:f,endFontSize:p,centerInset:_,lowLabel:y,highLabel:E,showEnds:x}){const b=x?N0(c):null;return u.jsxs("div",{style:{position:"absolute",inset:0,color:a},children:[u.jsx("div",{style:{position:"absolute",inset:0,..._,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,fontSize:f,textAlign:"center",pointerEvents:"none"},children:k0(s,i)}),b&&u.jsxs(u.Fragment,{children:[u.jsx("div",{style:{...b.low,fontWeight:800,fontSize:p},children:y}),u.jsx("div",{style:{...b.high,fontWeight:800,fontSize:p},children:E})]})]})}function E_({name:s,rotation:i,width:c,height:a,value:f,showEnds:p=!1,fillColor:_="var(--red)",lowLabel:y="0",highLabel:E="100"}){const x=i===90||i===270,{fontSize:b,endFontSize:v,centerInset:S}=d0(s,c,a,x,p);let I,V;i===0?(I={left:0,top:0,bottom:0,width:`${f}%`},V={left:0,top:0}):i===180?(I={right:0,top:0,bottom:0,width:`${f}%`},V={right:0,top:0}):i===90?(I={left:0,right:0,bottom:0,height:`${f}%`},V={left:0,bottom:0}):(I={left:0,right:0,top:0,height:`${f}%`},V={left:0,top:0});const q=j=>u.jsx(R0,{name:s,vertical:x,rotation:i,color:j,fontSize:b,endFontSize:v,centerInset:S,lowLabel:y,highLabel:E,showEnds:p});return u.jsxs(u.Fragment,{children:[u.jsx("div",{style:{position:"absolute",left:0,top:0,width:`${c}px`,height:`${a}px`},children:q("var(--red)")}),u.jsx("div",{style:{position:"absolute",background:_,overflow:"hidden",...I},children:u.jsx("div",{style:{position:"absolute",width:`${c}px`,height:`${a}px`,...V},children:q("var(--white)")})})]})}function T0({control:s,disabled:i,latestValue:c,onSlider:a,width:f,height:p}){const _=z.useRef(null),y=s.sliderMin??0,E=s.sliderMax??100,[x,b]=z.useState(()=>c===void 0?Oh(s.sliderRecenter??"none"):Ch(c,y,E)),v=z.useRef(null),S=s.rotation;z.useEffect(()=>{c!==void 0&&(b(Ch(c,y,E)),v.current=c)},[c,y,E]);function I(L){const H=_.current;if(!H)return 0;const ie=H.getBoundingClientRect();let se;return S===0?se=(L.clientX-ie.left)/ie.width:S===180?se=1-(L.clientX-ie.left)/ie.width:S===90?se=1-(L.clientY-ie.top)/ie.height:se=(L.clientY-ie.top)/ie.height,Math.max(0,Math.min(1,se))}function V(L){i||q(I(L))}function q(L){const H=Math.round(L*100),ie=Math.round(y+(E-y)*L);b(H),ie!==v.current&&(v.current=ie,a(s.name,ie))}function j(){const L=s.sliderRecenter??"none";i||L==="none"||q(Oh(L)/100)}return u.jsx("div",{ref:_,className:"control-slider",style:{width:"100%",height:"100%",position:"relative",overflow:"hidden",touchAction:"none"},onPointerDown:L=>{i||(L.preventDefault(),L.currentTarget.setPointerCapture(L.pointerId),V(L))},onPointerMove:L=>{L.buttons!==0&&V(L)},onPointerUp:j,onPointerCancel:j,onLostPointerCapture:j,children:u.jsx(E_,{name:s.name,rotation:S,width:f,height:p,value:x,showEnds:!0,lowLabel:String(y),highLabel:String(E)})})}function Oh(s){return s==="bottom"?0:s==="top"?100:s==="middle"?50:0}function Ch(s,i,c){return c===i?0:Math.max(0,Math.min(100,Math.round((s-i)/(c-i)*100)))}function Lh(s,i,c){return Math.round(i+(c-i)*(s+1)/2)}function Bh(s,i){return s==="bottom"?i?1:-1:s==="top"?i?-1:1:0}function zh(s){return{nx:Bh(s.joystickXRecenter,!1),ny:Bh(s.joystickYRecenter,!0)}}function S_(s,i){const c=Math.min(s,i),a=Math.max(6,c*.16),f=Math.max(1,c/2-a-2);return{knobRadius:a,reach:f}}function k_({control:s,width:i,height:c,pos:a,dragging:f=!1}){const p=s.rotation,{knobRadius:_,reach:y}=S_(i,c),E=Math.max(7,Math.min(14,_*.62)),x=Math.max(7,Math.min(12,Math.min(i,c)*.1)),b=[{key:"xmax",value:s.joystickXMax??100,lx:1,ly:0},{key:"xmin",value:s.joystickXMin??-100,lx:-1,ly:0},{key:"ymax",value:s.joystickYMax??100,lx:0,ly:-1},{key:"ymin",value:s.joystickYMin??-100,lx:0,ly:1}];return u.jsxs("div",{className:"control-joystick",style:{width:"100%",height:"100%",position:"relative"},children:[u.jsx("div",{className:"joystick-oval",style:{position:"absolute",left:"50%",top:"50%",width:y*2,height:y*2,transform:"translate(-50%, -50%)"}}),b.map(v=>{const S=fi(v.lx,v.ly,p);return u.jsx("span",{className:"joystick-edge-label",style:{position:"absolute",left:"50%",top:"50%",fontSize:x,transform:`translate(-50%, -50%) translate(${S.x*y}px, ${S.y*y}px) rotate(${p}deg)`},children:v.value},v.key)}),u.jsx("div",{className:"joystick-knob",style:{position:"absolute",left:"50%",top:"50%",width:_*2,height:_*2,fontSize:E,transform:`translate(calc(-50% + ${a.nx*y}px), calc(-50% + ${a.ny*y}px))`,transition:f?"none":"transform 0.12s ease-out"},children:u.jsx("span",{style:{display:"inline-block",transform:s.rotation?`rotate(${s.rotation}deg)`:void 0,whiteSpace:s.rotation===90||s.rotation===270?"nowrap":void 0},children:s.name})})]})}function M0({control:s,disabled:i,onJoystick:c,width:a,height:f}){const p=s.rotation,_=z.useRef(null),[y,E]=z.useState(()=>{const H=zh(s),ie=fi(H.nx,H.ny,p);return{nx:ie.x,ny:ie.y}}),x=z.useRef(!1),b=z.useRef(null),v=s.joystickXMin??-100,S=s.joystickXMax??100,I=s.joystickYMin??-100,V=s.joystickYMax??100;function q(H,ie){const se=fi(H,ie,fc(p)),oe=Lh(se.x,v,S),pe=Lh(-se.y,I,V);(!b.current||b.current.x!==oe||b.current.y!==pe)&&(b.current={x:oe,y:pe},c(s.name,oe,pe))}function j(H){const ie=_.current;if(!ie)return;const se=ie.getBoundingClientRect(),{reach:oe}=S_(se.width,se.height);let pe=(H.clientX-(se.left+se.width/2))/oe,J=(H.clientY-(se.top+se.height/2))/oe;const ee=Math.hypot(pe,J);ee>1&&(pe/=ee,J/=ee),E({nx:pe,ny:J}),q(pe,J)}function L(){const H=s.joystickXRecenter??"middle",ie=s.joystickYRecenter??"middle";if(H==="none"&&ie==="none")return;const se=fi(y.nx,y.ny,fc(p)),oe=zh(s),pe={x:H==="none"?se.x:oe.nx,y:ie==="none"?se.y:oe.ny},J=fi(pe.x,pe.y,p),ee={nx:J.x,ny:J.y};x.current=!1,E(ee),q(ee.nx,ee.ny)}return u.jsx("div",{ref:_,style:{width:"100%",height:"100%",touchAction:"none"},onPointerDown:H=>{i||(H.preventDefault(),H.currentTarget.setPointerCapture(H.pointerId),x.current=!0,j(H))},onPointerMove:H=>{i||!x.current||H.buttons===0||j(H)},onPointerUp:L,onPointerCancel:L,onLostPointerCapture:L,children:u.jsx(k_,{control:s,width:a,height:f,pos:y,dragging:x.current})})}const D0=[{direction:"up",rotate:0},{direction:"right",rotate:90},{direction:"down",rotate:180},{direction:"left",rotate:270}],j0="M 34 30 L 34 15 Q 34 8 41 8 L 59 8 Q 66 8 66 15 L 66 30 L 50 46 L 34 30 Z",A0=.1,O0={up:"OP",down:"NED",left:"VENSTRE",right:"HØJRE"},C0={up:[0,-1],right:[1,0],down:[0,1],left:[-1,0]},L0=[{pos:"up",x:50,y:23},{pos:"right",x:78,y:50},{pos:"down",x:50,y:77},{pos:"left",x:22,y:50}];function Pf(s,i){return Math.hypot(s,i)<A0?null:Math.abs(s)>=Math.abs(i)?s>0?"right":"left":i>0?"down":"up"}function B0(s,i){const[c,a]=C0[s],f=fi(c,a,fc(i));return Pf(f.x,f.y)??s}function N_({control:s,active:i=null}){const c=s.rotation;return u.jsx("div",{className:"control-dpad",style:{width:"100%",height:"100%"},children:u.jsxs("svg",{viewBox:"0 0 100 100",preserveAspectRatio:"xMidYMid meet",children:[D0.map(a=>u.jsx("path",{className:`dpad-arm ${i===a.direction?"active":""}`,transform:`rotate(${a.rotate} 50 50)`,d:j0},a.direction)),L0.map(a=>u.jsx("text",{className:`dpad-label ${i===a.pos?"active":""}`,x:a.x,y:a.y,textAnchor:"middle",dominantBaseline:"central",transform:c?`rotate(${c} ${a.x} ${a.y})`:void 0,children:O0[B0(a.pos,c)]},a.pos))]})})}function z0({control:s,disabled:i,onDpad:c}){const a=z.useRef(null),f=z.useRef(null),p=z.useRef(!1),[_,y]=z.useState(null);function E(S){const I=a.current;if(!I)return{screen:null,logical:null};const V=I.getBoundingClientRect(),q=Math.min(V.width,V.height)/2,j=(S.clientX-(V.left+V.width/2))/q,L=(S.clientY-(V.top+V.height/2))/q,H=Pf(j,L),ie=fi(j,L,fc(s.rotation)),se=Pf(ie.x,ie.y);return{screen:H,logical:se}}function x(S){const I=a.current;if(!I)return!1;const V=I.getBoundingClientRect(),q=(S.clientX-V.left)/V.width,j=(S.clientY-V.top)/V.height;return q>=0&&q<=1&&j>=0&&j<=1}function b(S){S.logical!==f.current&&(f.current&&c(s.name,f.current,!1),f.current=S.logical,S.logical&&c(s.name,S.logical,!0)),y(S.screen)}function v(){p.current=!1,b({screen:null,logical:null})}return u.jsx("div",{ref:a,style:{width:"100%",height:"100%",touchAction:"none"},onPointerDown:S=>{i||!x(S)||(S.preventDefault(),S.currentTarget.setPointerCapture(S.pointerId),p.current=!0,b(E(S)))},onPointerMove:S=>{i||!p.current||S.buttons===0||b(E(S))},onPointerUp:v,onPointerCancel:v,onLostPointerCapture:v,children:u.jsx(N_,{control:s,active:_})})}const U0={button:"Knapper",slider:"Slidere",toggle:"Toggleknapper",radar:"Radar",text:"Tekstfelter",joystick:"Joysticks",dpad:"Dpads"},H0=["button","slider","toggle","radar","text","joystick","dpad"];function G0({unplaced:s,onAdd:i,onClose:c}){const a=z.useMemo(()=>H0.filter(y=>s.some(E=>E.type===y)),[s]),[f,p]=z.useState(a[0]??"button"),_=s.filter(y=>y.type===f);return z.useEffect(()=>{a.length>0&&!a.includes(f)&&p(a[0])},[a,f]),u.jsxs(Tn,{title:"Tilføj kontrol",onClose:c,children:[a.length>1&&u.jsx("div",{className:"segmented add-modal-tabs",children:a.map(y=>u.jsx("button",{type:"button",className:f===y?"active":"",onClick:()=>p(y),children:U0[y]},y))}),u.jsx("div",{className:"add-lists",children:a.length===0?u.jsx("div",{className:"device-list-empty",children:"Alle kontroller er allerede placeret."}):_.map(y=>u.jsxs("button",{type:"button",className:"add-entry",onClick:()=>i(y.name),children:[u.jsx("span",{children:y.name}),u.jsx("span",{className:"iconbtn",children:u.jsx(nt,{name:"plus",size:22})})]},y.name))})]})}function R_(s){const[i,c]=z.useState({w:0,h:0}),a=z.useRef(null),f=z.useRef(null);return z.useLayoutEffect(()=>{var E;const p=s.current;if(a.current===p)return;if((E=f.current)==null||E.disconnect(),f.current=null,a.current=p,!p){c(x=>x.w===0&&x.h===0?x:{w:0,h:0});return}const _=()=>{const x={w:p.clientWidth,h:p.clientHeight};c(b=>b.w===x.w&&b.h===x.h?b:x)};_();const y=new ResizeObserver(_);y.observe(p),f.current=y}),z.useEffect(()=>()=>{var p;(p=f.current)==null||p.disconnect(),f.current=null,a.current=null},[]),i}function aa(s){return s.centerX2!==null&&s.centerY2!==null&&s.spanX!==null&&s.spanY!==null}const I0=4,V0=5;function Y0(s){return s==="joystick"||s==="dpad"?{spanX:6,spanY:6}:{spanX:I0,spanY:V0}}function Uh(s){if(!aa(s))return null;const i=s.centerX2/2,c=s.centerY2/2;return{x0:i-s.spanX/2,x1:i+s.spanX/2,y0:c-s.spanY/2,y1:c+s.spanY/2}}function $0(s,i,c=.02){return s.x0<i.x1-c&&i.x0<s.x1-c&&s.y0<i.y1-c&&i.y0<s.y1-c}function Hh(s,i){const c=ps(s,i);if(!c||s.spanX===null||s.spanY===null)return s;const a=lc(c.cx,c.cy,s.spanX,s.spanY,i);return{...s,centerX2:a.centerX2,centerY2:a.centerY2}}function Gh(s,i){return Math.max(1,Math.min(i.cols-1,s))}function Ih(s,i){return Math.max(1,Math.min(i.rows-1,s))}function P0(){const s=ae(O=>O.layout),i=ae(O=>O.active),c=ae(O=>O.saveLayout),a=ae(O=>O.setEditMode),f=ae(O=>O.askConfirm),p=!!(i!=null&&i.canEdit),[_,y]=z.useState(()=>s.map(O=>({...O}))),[E,x]=z.useState(null),[b,v]=z.useState(!1),[S,I]=z.useState(null),[V,q]=z.useState(null),[j,L]=z.useState(!1),H=z.useRef(null),ie=R_(H),se=ie.w>0&&ie.h>0,oe=p_(ie.w,ie.h,i==null?void 0:i.gridCols,i==null?void 0:i.gridRows),pe=z.useMemo(()=>se?Bb(oe):[],[oe,se]),J=_.filter(aa),ee=_.filter(O=>!aa(O)),Re=z.useMemo(()=>{const O=new Set;for(let Z=0;Z<J.length;Z+=1)for(let ne=Z+1;ne<J.length;ne+=1){const X=Uh(J[Z]),He=Uh(J[ne]);X&&He&&$0(X,He)&&(O.add(J[Z].name),O.add(J[ne].name))}return O},[J]),ve=Re.size>0,we=_.find(O=>O.name===E)??null,W=z.useMemo(()=>Vh(_)!==Vh(s),[_,s]),Pe=z.useMemo(()=>{if(!S||!V)return null;const O=_.find(X=>X.name===S);if(!O||O.spanX===null||O.spanY===null)return null;const Z=lc(V.cx,V.cy,O.spanX,O.spanY,oe),ne=ps({...O,centerX2:Z.centerX2,centerY2:Z.centerY2},oe);return ne?{name:O.name,rect:ne}:null},[_,S,V,oe]);function Ae(O,Z){y(ne=>ne.map(X=>X.name===O?Z(X):X))}function qe(O,Z){O.stopPropagation(),x(Z.name);const ne=ps(Z,oe);ne&&(I(Z.name),q({cx:ne.cx,cy:ne.cy}),O.currentTarget.setPointerCapture(O.pointerId))}function G(O){if(!S)return;const Z=H.current;if(!Z)return;const ne=Z.getBoundingClientRect(),X=Z.clientWidth/ne.width,He=Z.clientHeight/ne.height;q({cx:Math.max(0,Math.min(Z.clientWidth,(O.clientX-ne.left)*X)),cy:Math.max(0,Math.min(Z.clientHeight,(O.clientY-ne.top)*He))})}function re(){if(S&&V){const O=_.find(Z=>Z.name===S);if(O&&O.spanX!==null&&O.spanY!==null){const Z=lc(V.cx,V.cy,O.spanX,O.spanY,oe);Ae(S,ne=>({...ne,centerX2:Z.centerX2,centerY2:Z.centerY2}))}}I(null),q(null)}function ue(O){Ae(O,Z=>Z.spanX===null||Z.spanY===null?{...Z,rotation:(Z.rotation+270)%360}:Hh({...Z,rotation:(Z.rotation+270)%360,spanX:Gh(Z.spanY,oe),spanY:Ih(Z.spanX,oe)},oe))}function fe(O,Z,ne){Ae(O,X=>{if(X.spanX===null||X.spanY===null)return X;const He=Z==="x"?Gh(X.spanX+ne,oe):X.spanX,Oe=Z==="y"?Ih(X.spanY+ne,oe):X.spanY;return Hh({...X,spanX:He,spanY:Oe},oe)})}function Ee(O){Ae(O,Z=>({...Z,centerX2:null,centerY2:null,spanX:null,spanY:null,rotation:0})),x(null)}function N(O){v(!1);const Z=_.find(Oe=>Oe.name===O);if(!Z)return;const{spanX:ne,spanY:X}=Y0(Z.type),He=lc(oe.areaW/2,oe.areaH/2,ne,X,oe);Ae(O,()=>({...Z,spanX:ne,spanY:X,rotation:0,centerX2:He.centerX2,centerY2:He.centerY2})),x(O)}async function U(){ve||(L(!0),await c(_),L(!1))}function te(){if(!W){a(!1);return}f({title:"Kassér ændringer",message:"Vil du forlade redigering og kassere dine layout-ændringer?",confirmLabel:"Kassér",onConfirm:()=>a(!1)})}return u.jsxs("div",{className:"edit-view",children:[u.jsx("div",{className:"edit-band edit-toolbar-band",children:we&&aa(we)?u.jsxs("div",{className:"edit-toolbar",onPointerDown:O=>O.stopPropagation(),children:[u.jsx(cs,{label:"⟲",title:"Roter",onClick:()=>ue(we.name)}),u.jsx(cs,{label:"W−",title:"Gør smallere",onClick:()=>fe(we.name,"x",-1),disabled:we.spanX===null||we.spanX<=1}),u.jsx(cs,{label:"W+",title:"Gør bredere",onClick:()=>fe(we.name,"x",1),disabled:we.spanX===null||we.spanX>=oe.cols-1}),u.jsx(cs,{label:"H−",title:"Gør lavere",onClick:()=>fe(we.name,"y",-1),disabled:we.spanY===null||we.spanY<=1}),u.jsx(cs,{label:"H+",title:"Gør højere",onClick:()=>fe(we.name,"y",1),disabled:we.spanY===null||we.spanY>=oe.rows-1}),u.jsx("button",{className:"iconbtn",style:{color:"var(--red)"},onClick:()=>Ee(we.name),"aria-label":"Slet",children:u.jsx(nt,{name:"delete",size:24})})]}):u.jsx("span",{className:"edit-hint",children:"Vælg en kontrol for at redigere"})}),u.jsx("div",{className:"controls-area-wrap",children:u.jsx("div",{className:"controls-area",ref:H,style:{touchAction:"none"},onPointerMove:G,onPointerUp:re,onPointerDown:()=>x(null),children:se&&u.jsxs(u.Fragment,{children:[u.jsx("svg",{width:oe.areaW,height:oe.areaH,style:{position:"absolute",inset:0,pointerEvents:"none"},children:pe.map((O,Z)=>u.jsx("circle",{cx:O.x,cy:O.y,r:2.5,fill:"rgba(198,80,78,0.45)"},Z))}),Pe&&u.jsx("div",{className:"snap-preview",style:{left:Pe.rect.cx,top:Pe.rect.cy,width:Pe.rect.width,height:Pe.rect.height}}),J.map(O=>{const Z=S===O.name&&V,ne=ps(O,oe);if(!ne)return null;const X=Z?V.cx:ne.cx,He=Z?V.cy:ne.cy,Oe={left:X,top:He,width:ne.width,height:ne.height,outline:E===O.name?"3px solid var(--text)":"none",outlineOffset:2};return u.jsx("div",{className:`control ${Re.has(O.name)?"colliding":""}`,style:Oe,onPointerDown:Qn=>qe(Qn,O),children:O.type==="button"?u.jsx("div",{className:"control-button",style:{width:"100%",height:"100%",display:"grid",placeItems:"center"},children:u.jsx(dc,{name:O.name,width:ne.width,height:ne.height,rotation:O.rotation})}):O.type==="toggle"?u.jsx("div",{className:"control-toggle on",style:{width:"100%",height:"100%"},children:u.jsx(dc,{name:O.name,width:ne.width,height:ne.height,rotation:O.rotation})}):O.type==="radar"?u.jsx(x_,{control:O,pings:[],width:ne.width,height:ne.height,preview:!0}):O.type==="text"?u.jsx(v_,{message:O.name,width:ne.width,height:ne.height,rotation:O.rotation}):O.type==="joystick"?u.jsx(k_,{control:O,width:ne.width,height:ne.height,pos:{nx:0,ny:0}}):O.type==="dpad"?u.jsx(N_,{control:O}):u.jsx("div",{className:"control-slider",style:{width:"100%",height:"100%",position:"relative",overflow:"hidden"},children:u.jsx(E_,{name:O.name,rotation:O.rotation,width:ne.width,height:ne.height,value:50,showEnds:!0,lowLabel:String(O.sliderMin??0),highLabel:String(O.sliderMax??100),fillColor:Re.has(O.name)?"var(--disabled)":"var(--red)"})})},O.name)}),p&&u.jsx("button",{type:"button",className:"fab",style:{width:52,height:52,right:12,bottom:12},onPointerDown:O=>O.stopPropagation(),onClick:()=>v(!0),"aria-label":"Tilføj kontrol",children:u.jsx(nt,{name:"plus",size:24})}),j&&u.jsx("div",{className:"overlay",children:u.jsx("div",{className:"spinner"})})]})})}),u.jsxs("div",{className:"edit-band edit-actions-band",children:[u.jsx("button",{className:"btn btn-outline",style:{flex:1},type:"button",onClick:te,disabled:j,children:"Annuller"}),u.jsx("button",{className:"btn btn-primary",style:{flex:1},type:"button",onClick:U,disabled:ve||j,children:j?"Gemmer...":"Gem"})]}),b&&u.jsx(G0,{unplaced:ee,onAdd:N,onClose:()=>v(!1)})]})}function Vh(s){return JSON.stringify(s.map(i=>({type:i.type,name:i.name,centerX2:i.centerX2,centerY2:i.centerY2,spanX:i.spanX,spanY:i.spanY,rotation:i.rotation})))}function cs({label:s,title:i,disabled:c,onClick:a}){return u.jsx("button",{type:"button","aria-label":i,title:i,disabled:c,onClick:a,style:{minWidth:38,height:38,borderRadius:12,background:c?"var(--grey)":"var(--red)",color:"var(--white)",fontWeight:800,fontSize:14,padding:"0 8px"},children:s})}function q0(){const s=ae(H=>H.layout),i=ae(H=>H.editMode),c=ae(H=>H.active),a=ae(H=>H.sliderValues),f=ae(H=>H.toggleValues),p=ae(H=>H.radarPings),_=ae(H=>H.textValues),y=ae(H=>H.toggleSideMenu),E=ae(H=>H.sendButton),x=ae(H=>H.sendSlider),b=ae(H=>H.sendToggle),v=ae(H=>H.sendJoystick),S=ae(H=>H.sendDpad),I=z.useRef(null),V=R_(I),q=p_(V.w,V.h,c==null?void 0:c.gridCols,c==null?void 0:c.gridRows),j=V.w>0&&V.h>0,L=s.filter(aa);return u.jsxs("div",{className:"screen control-screen",children:[u.jsx(rd,{title:"Kontrol Panel",onMenu:()=>y()}),i?u.jsx(P0,{}):u.jsx("div",{className:"controls-area-wrap",children:u.jsx("div",{className:"controls-area",ref:I,children:j?L.map(H=>{const ie=ps(H,q);return ie?u.jsx(m0,{control:H,rect:ie,disabled:!1,latestValue:H.type==="slider"?a[H.name]:void 0,toggleValue:H.type==="toggle"?f[H.name]:void 0,radarPings:H.type==="radar"?p[H.name]:void 0,textValue:H.type==="text"?_[H.name]:void 0,onButton:E,onSlider:x,onToggle:b,onJoystick:v,onDpad:S},H.name):null}):u.jsx("div",{className:"overlay",children:u.jsx("div",{className:"spinner"})})})})]})}const F0="",Yh="",$h="",ci="";function us(s){return new Promise(i=>setTimeout(i,s))}class X0{constructor(i){this.transport=i}async interrupt(){await this.transport.write($h),await us(80),await this.transport.write($h)}async friendlyRepl(){await this.transport.write(Yh)}async softReset(){await this.transport.write(ci)}async stop(){await this.interrupt(),await this.friendlyRepl().catch(()=>{}),await this.transport.writeLine(`try:
    ble.disconnect()
except Exception:
    pass
...
`,a=await this.repl.exec(c);if(a.error)throw new Error(a.error);return a.output.split(/\r?\n/).map(f=>f.trim()).filter(Boolean).map(f=>{const[p,_,y]=f.split("	"),E=_==="dir"||_==="file"?_:"unknown",x=parseInt(y??"",10);return{name:p,path:J0(i,p),type:E,...Number.isFinite(x)&&x>=0?{size:x}:{}}})}async readText(i){const c=`
import sys
...
\r
    ...
    def __init__(self, I2CAddress=108,sda=8,scl=9):\r
        ...
        self.initPCA()`,uy=`from machine import Pin\r
import utime as time\r
...
while True:
    ...
    if ble.connected:
        ...
        time.sleep_ms(100)
`,dy=`from machine import Pin, PWM, ADC\r
from BLEPeripheral import BLEPeripheral\r
...
while True:\r
    ...
    # til Bluetooth.\r
    time.sleep_ms(100)\r
`,na=[{id:"program:neopixel-led",path:"/main.py",label:"NeoPixel lys (main.py)",description:"Startprogram til NeoPixel med hold-knap og lysstyrke-slider.",kind:"program",content:sy},{id:"program:send-text",path:"/main.py",label:"Send tekst (main.py)",description:"Startprogram med kun et tekstfelt, hvor Picoen sender beskeder til kontrolpanelet.",kind:"program",content:fy},{id:"program:tank-control",path:"/main.py",label:"Robotbil med tankstyring (main.py)",description:"Startprogram til robotbil med to motor-slidere.",kind:"program",content:my},{id:"program:joystick-control",path:"/main.py",label:"Robotbil med joystick (main.py)",description:"Startprogram til robotbil styret med joystick og fart-slider.",kind:"program",content:ay},{id:"program:dpad-control",path:"/main.py",label:"Robotbil med D-pad (main.py)",description:"Startprogram til robotbil styret med fire retningsknapper og fart-slider.",kind:"program",content:iy},{id:"program:radar-control",path:"/main.py",label:"Radar med afstandssensor (main.py)",description:"Startprogram til radar med servo, afstandssensor og scan-toggle.",kind:"program",content:uy},{id:"program:smart-home",path:"/main.py",label:"SmartHome alarmstation (main.py)",description:"Startprogram til alarmstation med dør-servo, keypad, PIR, vandsensor, buzzer og NeoPixel.",kind:"program",content:dy},{id:"library:ble-peripheral",path:"/BLEPeripheral.py",label:"BLEPeripheral.py",description:"Bluetooth-biblioteket der får Picoen til at tale med appen.",kind:"library",content:ty},{id:"library:pico-robotics",path:"/PicoRobotics.py",label:"PicoRobotics.py",description:"Bibliotek til Kitronik Pico Robotics Board.",kind:"library",content:cy},{id:"library:pico-fly",path:"/PicoFly.py",label:"PicoFly.py",description:"Bibliotek til PicoFly-board med motorer og servoer.",kind:"library",content:oy},{id:"library:hcsr04",path:"/hcsr04.py",label:"hcsr04.py",description:"Bibliotek til HC-SR04 ultralyds-afstandssensor.",kind:"library",content:ry},{id:"library:neopixel",path:"/neopixel.py",label:"neopixel.py",description:"Bibliotek til NeoPixel LED-strips og LED-ringe.",kind:"library",content:ly}],py=11914;function hy(){return typeof navigator<"u"&&"serial"in navigator&&!!navigator.serial}function _y(){return hy()?{supported:!0,message:"USB-udvikling er tilgængelig i denne browser."}:{supported:!1,message:"USB-udvikling kræver en computer med Chrome, Edge eller Chromebook."}}class gy{constructor(i={}){me(this,"port",null);me(this,"reader",null);me(this,"writer",null);me(this,"readLoopDone",null);me(this,"readLoopActive",!1);me(this,"disconnecting",!1);me(this,"buffer","");me(this,"events");me(this,"dataListeners",new Set);this.events=i}get connected(){return!!this.port&&!!this.writer}get info(){var i;return((i=this.port)==null?void 0:i.getInfo())??null}async requestAndConnect(){if(!navigator.serial)throw new Error("Web Serial er ikke tilgængelig i denne browser.");const i=await navigator.serial.requestPort({filters:[{usbVendorId:py}]});await this.openPort(i)}async connectKnownPort(i){await this.openPort(i)}async disconnect(){var E,x;const i=this.connected||!!this.port||!!this.reader,c=this.port,a=this.reader,f=this.writer,p=this.readLoopDone,_=a==null?void 0:a.closed.catch(()=>{}),y=f==null?void 0:f.closed.catch(()=>{});this.disconnecting=!0,this.readLoopActive=!1;try{await(a==null?void 0:a.cancel())}catch{}p&&await p.catch(()=>{}),await _;try{a==null||a.releaseLock()}catch{}this.reader===a&&(this.reader=null);try{await(f==null?void 0:f.close()),await y}catch{try{await(f==null?void 0:f.abort("disconnect"))}catch{}}try{f==null||f.releaseLock()}catch{}this.writer===f&&(this.writer=null),c&&await c.close(),this.port===c&&(this.port=null),this.buffer="",this.readLoopDone===p&&(this.readLoopDone=null),this.disconnecting=!1,i&&((x=(E=this.events).onDisconnect)==null||x.call(E))}async write(i){if(!this.writer)throw new Error("Ingen USB-forbindelse.");await this.writer.write(new TextEncoder().encode(i))}async writeLine(i){await this.write(`${i}\r
`)}addDataListener(i){return this.dataListeners.add(i),()=>this.dataListeners.delete(i)}async openPort(i){var a,f,p;if(await this.disconnect().catch(()=>{}),await i.open({baudRate:115200,bufferSize:4096}),this.port=i,this.writer=((a=i.writable)==null?void 0:a.getWriter())??null,!this.writer||!i.readable)throw new Error("USB-porten kunne ikke åbnes til læsning og skrivning.");const c=i.getInfo();(p=(f=this.events).onLog)==null||p.call(f,"success",`USB-forbindelse oprettet (${by(c)}).`),this.readLoopDone=this.startReadLoop(i)}async startReadLoop(i){var f,p,_;this.readLoopActive=!0;const c=new TextDecoder;this.reader=((f=i.readable)==null?void 0:f.getReader())??null;const a=this.reader;if(a)try{for(;this.readLoopActive;){const{value:y,done:E}=await a.read();if(E)break;y&&this.consumeText(c.decode(y,{stream:!0}))}}catch(y){this.readLoopActive&&((_=(p=this.events).onLog)==null||_.call(p,"error",y instanceof Error?y.message:"USB-læsning stoppede."))}finally{try{a.releaseLock()}catch{}this.reader===a&&(this.reader=null),this.readLoopActive&&!this.disconnecting&&this.port===i&&this.closeAfterUnexpectedReadEnd(i)}}async closeAfterUnexpectedReadEnd(i){var p,_;const c=this.connected||this.port===i;this.disconnecting=!0,this.readLoopActive=!1;const a=this.writer,f=a==null?void 0:a.closed.catch(()=>{});try{await(a==null?void 0:a.close()),await f}catch{try{await(a==null?void 0:a.abort("disconnect"))}catch{}}try{a==null||a.releaseLock()}catch{}this.writer===a&&(this.writer=null);try{await i.close()}catch{}this.port===i&&(this.port=null),this.buffer="",this.readLoopDone=null,this.disconnecting=!1,c&&((_=(p=this.events).onDisconnect)==null||_.call(p))}consumeText(i){var c,a,f,p;(a=(c=this.events).onData)==null||a.call(c,i);for(const _ of this.dataListeners)_(i);for(this.buffer+=i;this.buffer.includes(`
`);){const _=this.buffer.indexOf(`
`),y=this.buffer.slice(0,_).replace(/\r$/,"");this.buffer=this.buffer.slice(_+1),(p=(f=this.events).onLine)==null||p.call(f,y)}}}function by(s){const i=s.usbVendorId!==void 0?`VID ${s.usbVendorId.toString(16).padStart(4,"0")}`:"ukendt VID",c=s.usbProductId!==void 0?`PID ${s.usbProductId.toString(16).padStart(4,"0")}`:"ukendt PID";return`${i}, ${c}`}const T_=15e3,Ph=64*1024,qh=1e5,M_=new URL("/micropython/micropython.mjs",window.location.origin).toString(),yy=64*1024,Fh=8;function D_(){return typeof SharedArrayBuffer<"u"&&globalThis.crossOriginIsolated===!0}function vy(){return D_()?new SharedArrayBuffer(yy):null}function xy(s,i){const c=new Int32Array(s,0,2),a=new Uint8Array(s),f=s.byteLength-Fh,p=new TextEncoder().encode(i+`
`);let _=Atomics.load(c,0);for(const y of p)a[Fh+_%f]=y,_+=1;Atomics.store(c,0,_),Atomics.notify(c,0)}const wy=new Set(["bluetooth","machine","network","PicoRobotics","rp2","ubluetooth"]);class Ey{constructor(){me(this,"worker",null);me(this,"pending",null);me(this,"nextId",0)}send(i,c={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython-terminalen er optaget. Stop den, eller vent på at kommandoen bliver færdig.",timedOut:!1,unavailable:!1});const a=++this.nextId,f=c.timeoutMs??T_,p=this.ensureWorker();return new Promise(_=>{const y=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython-terminalen stoppede, fordi kommandoen tog for lang tid. Tjek for uendelige løkker.",timedOut:!0,unavailable:!1}),this.restartWorker()},f);this.pending={id:a,timer:y,onOutput:c.onOutput,resolve:_},p.postMessage({type:"run",id:a,code:ky(i),runtimeUrl:M_})})}reset(){this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),this.restartWorker()}dispose(){var i;this.finish({ok:!1,output:"",error:"",timedOut:!1,unavailable:!1}),(i=this.worker)==null||i.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const i=new Worker(new URL(""+new URL("offlineMicroPython.worker-CyZOxxkY.js",import.meta.url).href,import.meta.url),{type:"module"});return i.onmessage=c=>this.handleMessage(c.data),i.onerror=c=>{this.finish({ok:!1,output:"",error:c.message||"Browser-MicroPython-terminalen fejlede i browser-worker.",timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=i,i}handleMessage(i){var a;const c=this.pending;if(!(!c||i.id!==c.id||i.type==="ready")){if(i.type==="stdout"){(a=c.onOutput)==null||a.call(c,i.text);return}if(i.type==="unavailable"){this.finish({ok:!1,output:"",error:i.error,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:i.ok,output:i.output,error:i.error,timedOut:!1,unavailable:!1})}}finish(i){const c=this.pending;c&&(window.clearTimeout(c.timer),this.pending=null,c.resolve(i))}restartWorker(){var i;(i=this.worker)==null||i.terminate(),this.worker=null}}class Sy{constructor(){me(this,"worker",null);me(this,"pending",null);me(this,"nextId",0);me(this,"stdinSab",null)}run(i,c={}){if(this.pending)return Promise.resolve({ok:!1,output:"",error:"Browser-MicroPython kører allerede kode. Stop den først.",issues:[],timedOut:!1,unavailable:!1});const a=typeof c=="number"?c:c.timeoutMs===null?null:c.timeoutMs??T_,f=typeof c=="number"?void 0:c.onOutput,p=typeof c=="number"?void 0:c.signal,_=qf(i,{allowInput:!0});if(_.some(b=>b.level==="error"))return Promise.resolve({ok:!1,output:"",error:"",issues:_,timedOut:!1,unavailable:!1});const y=++this.nextId,E=this.ensureWorker(),x=vy();return this.stdinSab=x,new Promise(b=>{const v=q=>this.finish(q),S=()=>{this.restartWorker(),v({ok:!1,output:"",error:"",issues:_,timedOut:!1,unavailable:!1})},I=a===null?null:window.setTimeout(()=>{v({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:_,timedOut:!0,unavailable:!1}),this.restartWorker()},a);if(this.pending={id:y,timer:I,timeoutMs:a,issues:_,onOutput:f,signal:p,abort:S,resolve:b},p!=null&&p.aborted){S();return}p==null||p.addEventListener("abort",S,{once:!0});const V={type:"run",id:y,code:i,runtimeUrl:M_,interactive:!0,sab:x??void 0};E.postMessage(V)})}sendInput(i){const c=this.pending;!c||!this.stdinSab||(this.refreshTimeout(c),xy(this.stdinSab,i))}stop(){const i=this.pending;i&&(this.restartWorker(),this.finish({ok:!1,output:"",error:"Browser-MicroPython blev stoppet.",issues:i.issues,timedOut:!1,unavailable:!1}))}dispose(){var i;this.finish({ok:!1,output:"",error:"",issues:[],timedOut:!1,unavailable:!1}),(i=this.worker)==null||i.terminate(),this.worker=null}ensureWorker(){if(this.worker)return this.worker;const i=new Worker(new URL(""+new URL("offlineMicroPython.worker-CyZOxxkY.js",import.meta.url).href,import.meta.url),{type:"module"});return i.onmessage=c=>this.handleMessage(c.data),i.onerror=c=>{const a=this.pending;this.finish({ok:!1,output:"",error:c.message||"Offline MicroPython fejlede i browser-worker.",issues:(a==null?void 0:a.issues)??[],timedOut:!1,unavailable:!1}),this.restartWorker()},this.worker=i,i}handleMessage(i){var a;const c=this.pending;if(!(!c||i.id!==c.id||i.type==="ready")){if(i.type==="stdout"){this.refreshTimeout(c),(a=c.onOutput)==null||a.call(c,i.text);return}if(i.type==="unavailable"){this.finish({ok:!1,output:"",error:i.error,issues:c.issues,timedOut:!1,unavailable:!0}),this.restartWorker();return}this.finish({ok:i.ok,output:i.output,error:i.error,issues:c.issues,timedOut:!1,unavailable:!1}),this.restartWorker()}}finish(i){var a;const c=this.pending;c&&(c.timer!==null&&window.clearTimeout(c.timer),(a=c.signal)==null||a.removeEventListener("abort",c.abort),this.pending=null,c.resolve(i))}refreshTimeout(i){i.timeoutMs!==null&&(i.timer!==null&&window.clearTimeout(i.timer),i.timer=window.setTimeout(()=>{this.finish({ok:!1,output:"",error:"Browser-MicroPython stoppede, fordi koden tog for lang tid. Tjek for uendelige løkker.",issues:i.issues,timedOut:!0,unavailable:!1}),this.restartWorker()},i.timeoutMs))}restartWorker(){var i;(i=this.worker)==null||i.terminate(),this.worker=null,this.stdinSab=null}}function ky(s){const i=JSON.stringify(s);return["try:",`    __pico_repl_value = eval(${i})`,"    if __pico_repl_value is not None:","        print(repr(__pico_repl_value))","except SyntaxError:",`    exec(${i})`,"finally:","    try:","        del __pico_repl_value","    except Exception:","        pass"].join(`
`)}function qf(s,i={}){const c=[],a=new Blob([s]).size;a>Ph&&c.push({level:"error",text:`Koden er ${a} bytes. Offline MicroPython kører kun små programmer op til ${Ph} bytes.`});const f=s.split(/\r?\n/);for(let p=0;p<f.length;p+=1){const _=p+1,y=mc(f[p]).trim();if(!y)continue;const E=Ry(y);E&&wy.has(E)&&c.push({level:"error",line:_,text:`${E} virker kun på Picoen. Forbind en Pico for at køre denne kode.`}),!i.allowInput&&Ny(f[p])&&c.push({level:"error",line:_,text:"input() virker i hele programmer. Skriv programmet i editoren og tryk Kør, eller kør filen på Pico via USB."});const x=y.match(/\brange\(\s*(-?\d+)\s*(?:,\s*(-?\d+)\s*)?(?:,\s*(-?\d+)\s*)?\)/);x&&Ty(x)>qh&&c.push({level:"error",line:_,text:`range(...) er for stor til offline kørsel. Brug højst ${qh} gentagelser.`})}for(const p of My(f))c.push({level:"warning",text:`Funktionen ${p} ser rekursiv ud. Hvis den ikke stopper, afbryder offline MicroPython efter få sekunder.`});return c}function mc(s){let i=null;for(let c=0;c<s.length;c+=1){const a=s[c];if((a==='"'||a==="'")&&s[c-1]!=="\\"&&(i=i===a?null:i??a),a==="#"&&!i)return s.slice(0,c)}return s}function Ny(s){const i=mc(s);let c=null;for(let a=0;a<i.length;a+=1){const f=i[a];if((f==='"'||f==="'")&&i[a-1]!=="\\"){c=c===f?null:c??f;continue}if(!c&&!(!Xh(i[a-1])||i.slice(a,a+5)!=="input")&&Xh(i[a+5])&&i.slice(a+5).trimStart().startsWith("("))return!0}return!1}function Xh(s){return!s||!/[A-Za-z0-9_]/.test(s)}function Ry(s){const i=s.match(/^import\s+([A-Za-z_]\w*)/);if(i)return i[1];const c=s.match(/^from\s+([A-Za-z_]\w*)\s+import\b/);return(c==null?void 0:c[1])??null}function Kh(s){const i=s.match(/^\s*/);return(i==null?void 0:i[0].replace(/\t/g,"    ").length)??0}function Ty(s){const i=Number(s[1]),c=s[2]===void 0?void 0:Number(s[2]),a=s[3]===void 0?1:Number(s[3]);if(a===0)return Number.POSITIVE_INFINITY;const _=(c===void 0?i:c)-(c===void 0?0:i);return _>0&&a<0||_<0&&a>0?0:Math.ceil(Math.abs(_/a))}function My(s){const i=new Set;for(let c=0;c<s.length;c+=1){const a=mc(s[c]).trim().match(/^def\s+([A-Za-z_]\w*)\s*\(/);if(!a)continue;const f=a[1],p=Kh(s[c]);for(let _=c+1;_<s.length;_+=1){if(!s[_].trim())continue;if(Kh(s[_])<=p)break;if(new RegExp(`\\b${f}\\s*\\(`).test(mc(s[_]))){i.add(f);break}}}return[...i]}const Dy=/^(for|if|while|def|class|elif|else|try|except|finally|with)\b/;function jy(s,i){var b;const c=s.trim(),a=i.split(/\r?\n/),f=Ay(c),p=f?a[f-1]??"":"",_=Oy(a,f),y=c.split(/\r?\n/).filter(Boolean).at(-1)??"";if(/KeyboardInterrupt/.test(y))return{simple:"Programmet blev stoppet.",technical:c,line:f};if(/MemoryError/.test(y))return{simple:`Picoen eller browserens MicroPython løb tør for hukommelse${f?` omkring linje ${f}`:""}.`,technical:c,line:f};if(/RecursionError/.test(y))return{simple:`En funktion kalder sig selv for mange gange${f?` omkring linje ${f}`:""}.`,technical:c,line:f};const E=y.match(/UnboundLocalError:\s+local variable ['"](.+?)['"]/);if(E)return{simple:`Variablen ${E[1]} bruges inde i en funktion, før den har fået en værdi${f?` på linje ${f}`:""}.`,technical:c,line:f};const x=y.match(/NameError:\s+name ['"](.+?)['"] (?:isn't|is not) defined/);if(x)return{simple:zy(p,x[1])?`Teksten ${x[1]} mangler måske citationstegn${f?` på linje ${f}`:""}.`:`Python kender ikke navnet ${x[1]}${f?` på linje ${f}`:""}.`,technical:c,line:f};if(/ZeroDivisionError/.test(y))return{simple:`Kan ikke dividere med 0${f?` på linje ${f}`:""}.`,technical:c,line:f};if(/IndentationError:\s+unexpected indent/.test(y))return{simple:`Der er for meget indrykning${f?` på linje ${f}`:""}.`,technical:c,line:f};if(/IndentationError/.test(y))return{simple:`Mangler indrykning${f?` på linje ${f}`:""}.`,technical:c,line:f};if(/ImportError|ModuleNotFoundError/.test(y)){const v=(b=y.match(/['"](.+?)['"]/))==null?void 0:b[1];return{simple:`Python kan ikke finde modulet${v?` ${v}`:""}.`,technical:c,line:f}}if(/OSError/.test(y))return/ENOENT|No such file|Errno\s+2/.test(y)?{simple:`Python kan ikke finde filen${f?` på linje ${f}`:""}.`,technical:c,line:f}:/EACCES|permission|denied/i.test(y)?{simple:`Python har ikke adgang til filen eller enheden${f?` på linje ${f}`:""}.`,technical:c,line:f}:{simple:`Der opstod en fejl med en fil eller en enhed${f?` omkring linje ${f}`:""}.`,technical:c,line:f};if(/SyntaxError/.test(y)){if(/invalid syntax/.test(y)&&_.text.trim().endsWith(","))return{simple:`Linje ${_.line??f} slutter med komma. Tjek om der mangler noget efter kommaet.`,technical:c,line:_.line??f};const v=Ff(p,f)??Ff(_.text,_.line)??Cy(a,f);return v?{simple:`Mangler måske : efter linje ${v.line}.`,technical:c,line:v.line}:f&&_.text.trim().endsWith(":")&&p.trim()&&!/^\s+/.test(p)?{simple:`Mangler måske indrykning på linje ${f}.`,technical:c,line:f}:By(p)?{simple:`Tekst mangler måske citationstegn${f?` på linje ${f}`:""}.`,technical:c,line:f}:Ly(p)?{simple:`Tekst mangler måske et afsluttende citationstegn${f?` på linje ${f}`:""}.`,technical:c,line:f}:Uy(p)?{simple:`Mangler måske en afsluttende parentes${f?` på linje ${f}`:""}.`,technical:c,line:f}:Hy(p)?{simple:`Der er måske en parentes for meget${f?` på linje ${f}`:""}.`,technical:c,line:f}:{simple:`Python fandt en syntaksfejl${f?` omkring linje ${f}`:""}.`,technical:c,line:f}}return/TypeError/.test(y)?/takes .* positional arguments? but .* given/.test(y)||/function takes/.test(y)?{simple:`En funktion får for mange eller for få værdier${f?` på linje ${f}`:""}.`,technical:c,line:f}:/unsupported operand type/.test(y)?{simple:`To værdier kan ikke bruges sammen på den måde${f?` på linje ${f}`:""}.`,technical:c,line:f}:/not callable/.test(y)?{simple:`Der bliver brugt parenteser efter noget, som ikke er en funktion${f?` på linje ${f}`:""}.`,technical:c,line:f}:{simple:`En værdi har den forkerte type${f?` på linje ${f}`:""}.`,technical:c,line:f}:/IndexError/.test(y)?{simple:`Listen har ikke et element på den plads${f?` på linje ${f}`:""}.`,technical:c,line:f}:/KeyError/.test(y)?{simple:`Ordbogen mangler den nøgle${f?` på linje ${f}`:""}.`,technical:c,line:f}:/AttributeError/.test(y)?{simple:`Den ting har ikke den kommando${f?` på linje ${f}`:""}.`,technical:c,line:f}:/ValueError/.test(y)?/invalid literal for int/.test(y)?{simple:`Teksten kan ikke laves om til et heltal${f?` på linje ${f}`:""}.`,technical:c,line:f}:{simple:`Værdien passer ikke her${f?` på linje ${f}`:""}.`,technical:c,line:f}:{simple:`Python fandt en fejl${f?` omkring linje ${f}`:""}.`,technical:c,line:f}}function Ay(s){var f;const c=(f=[...s.matchAll(/line\s+(\d+)/g)].at(-1))==null?void 0:f[1];if(!c)return;const a=parseInt(c,10);return Number.isFinite(a)&&a>0?a:void 0}function Oy(s,i){if(!i)return{text:""};for(let c=i-2;c>=0;c-=1){const a=s[c]??"";if(a.trim())return{line:c+1,text:a}}return{text:""}}function Ff(s,i){if(!i)return null;const c=s.trim();return!Dy.test(c)||c.endsWith(":")?null:{line:i}}function Cy(s,i){const c=i?Math.min(s.length,i):s.length,a=Math.max(0,c-4);for(let f=c-1;f>=a;f-=1){const p=Ff(s[f]??"",f+1);if(p)return p}return null}function Ly(s){const i=(s.match(/'/g)??[]).length,c=(s.match(/"/g)??[]).length;return i%2===1||c%2===1}function By(s){var a,f;const c=(f=(a=s.trim().match(/^print\((.+)\)$/))==null?void 0:a[1])==null?void 0:f.trim();return!c||/['"]/.test(c)?!1:/\s/.test(c)&&/[a-zA-ZæøåÆØÅ]/.test(c)}function zy(s,i){const c=s.trim();return!!i&&/[A-Za-zæøåÆØÅ]/.test(i)&&(c.startsWith("print(")||c.includes(`= ${i}`))}function Uy(s){return j_(s)>0}function Hy(s){return j_(s)<0}function j_(s){let i=0,c=null;for(let a=0;a<s.length;a+=1){const f=s[a];if((f==='"'||f==="'")&&s[a-1]!=="\\"){c=c===f?null:c??f;continue}c||((f==="("||f==="["||f==="{")&&(i+=1),(f===")"||f==="]"||f==="}")&&(i-=1))}return i}const Xf="/min_kode.py",A_=`print('Hej fra Pico Kontrol Panel')
`,Gy=500,Iy=1200,fs="Backup-filnavne er reserveret til versionshistorik. Vælg et andet navn.";function Vn(s,i){return`${s}:${i}`}function Vy(s){return new Promise(i=>window.setTimeout(i,s))}function Yy(){const s=ae(d=>d.toggleSideMenu),i=ae(d=>d.askConfirm),c=ae(d=>d.picoIdeOrigin),a=ae(d=>d.active),f=ae(d=>d.isBleConnected),p=ae(d=>d.bleListFiles),_=ae(d=>d.bleReadText),y=ae(d=>d.bleWriteText),E=ae(d=>d.bleDeleteFile),x=ae(d=>d.bleRestartAndReconnect),[b,v]=z.useState(!1),[S,I]=z.useState(!1),[V,q]=z.useState([]),[j,L]=z.useState(!1),[H,ie]=z.useState([]),[se,oe]=z.useState(null),[pe,J]=z.useState(()=>tc(Wo())),[ee,Re]=z.useState(Xf),[ve,we]=z.useState("local"),[W,Pe]=z.useState(()=>{var d;return((d=tc(Wo()).find(h=>h.path===Xf))==null?void 0:d.content)??A_}),[Ae,qe]=z.useState([]),[G,re]=z.useState(!1),[ue,fe]=z.useState(""),[Ee,N]=z.useState(""),[U,te]=z.useState(null),[O,Z]=z.useState(!1),[ne,X]=z.useState(null),[He,Oe]=z.useState(!1),[Qn,Kt]=z.useState({}),[xe,wn]=z.useState(!1),[Mn,ze]=z.useState(0),[Dn,Yt]=z.useState(()=>{var d,h;return((d=Nl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:d.board)??((h=Nl[0])==null?void 0:h.board)??""}),[Yn,Ur]=z.useState(()=>{var d,h;return((d=Nl.find(w=>w.board==="Raspberry Pi Pico W"))==null?void 0:d.version)??((h=Nl[0])==null?void 0:h.version)??""}),[Hr,St]=z.useState(!1),[di,Gr]=z.useState({top:0,left:0}),[En,Ml]=z.useState(!1),[Dl,ua]=z.useState(!1),[jl,Zn]=z.useState(!0),[ft,Qt]=z.useState(""),[mi,Al]=z.useState([]),[Sn,dt]=z.useState(null),[On,Ir]=z.useState(!1),[or,cr]=z.useState({}),[mt,$n]=z.useState({}),[Ye,on]=z.useState(null),[tn,Cn]=z.useState(null),[yc,Ol]=z.useState(""),[Zt,Cl]=z.useState(()=>bh().clearTerminalOnRun),[ur,bs]=z.useState(()=>bh().simplifiedErrors),[pi,ys]=z.useState(()=>typeof navigator<"u"?Jh(navigator):!1),Vr=z.useRef(null),kt=z.useRef(null),cn=z.useRef(null),fa=z.useRef(null),Ln=z.useRef(null),pn=z.useRef(null),kn=z.useRef(null),pt=z.useRef(null),Ll=z.useRef(null),Nt=z.useRef(!1),fr=z.useRef(!1),Yr=z.useRef(!1),Wn=z.useRef(""),Wt=z.useRef(null),Rt=z.useRef(null),tt=z.useRef(null),dr=z.useRef(null),Jn=z.useRef(null),rn=z.useRef(null),Jt=z.useRef(0),mr=z.useRef(null),rt=z.useRef(null),pr=z.useRef(null),Bl=z.useRef(null),zl=z.useRef([]),Ul=z.useRef([]),$r=z.useRef(null),$t=_y(),_e=c==="control"&&!!a&&f(),ht=_e?(a==null?void 0:a.deviceID)??"ble":null,lt=Math.max(1,W.split(`
`).length),vs=new Blob([W]).size,vc=ve==="pico"?"Picoen":"browseren",da=z.useMemo(()=>[...new Set(Nl.map(d=>d.board))],[]),Pr=z.useMemo(()=>Nl.filter(d=>d.board===Dn),[Dn]),Pt=Nl.find(d=>d.board===Dn&&d.version===Yn)??Pr[0]??Nl[0],Tt=ve==="pico",Pn=Tt?En:Dl,qn=Tt&&En&&b&&!_e||!Tt&&Dl&&!!tt.current,xs=On||Pn&&!qn,ma=qn?"stdin":">>>",hr=qn?Tt?"Input til kørende Pico-kode":"Input til kørende Browser-MicroPython":Tt?"Pico MicroPython":"Browser-MicroPython",hi=z.useMemo(()=>{const d=new gy({onData:h=>{fr.current||!Nt.current||(Wn.current=(Wn.current+h).slice(-240),/(^|\r?\n)>>> ?$/.test(Wn.current)&&_i())},onLine:h=>{if(fr.current)return;const w=h.trimEnd();if(Yr.current&&w.trim()){$("info",w);return}if(Nt.current&&xc(w)){_i();return}Nt.current&&w.trim()&&!ws(w)&&!w.includes("raw REPL")&&$("info",w)},onLog:$,onDisconnect:()=>{v(!1),Ml(!1),Ir(!1),Nt.current=!1,Yr.current=!1,Fr(),Wn.current="",Wr(),$("warning","USB-forbindelse lukket.")}});return Vr.current=d,d},[]);function $(d,h){q(w=>[...w.slice(-140),{level:d,text:h}])}function qr(d){q(h=>[...h.slice(-140),{level:"info",text:d,variant:"input"}])}function xc(d){return d.trim()===">>>"}function ws(d){return d.trimStart().startsWith(">>> import builtins as _pkp_builtins; exec(")}function Fr(){Wt.current!==null&&(window.clearTimeout(Wt.current),Wt.current=null)}function _i(){!Nt.current||Wt.current!==null||(Wt.current=window.setTimeout(()=>{Wt.current=null,Nt.current&&(Ml(!1),Nt.current=!1,Wn.current="",$("success","Pico-koden er færdig."),Es())},0))}function Es(){const d=cn.current;d&&pa(d,!1)}function gi(d,h=W,w="error"){const T=jy(d,h);q(M=>[...M.slice(-140),{level:w,text:T.simple,technical:T.technical}])}function ln(d,h,w=ve){Re(d),we(w),Pe(h),$n(T=>({...T,[Vn(w,d)]:h})),Xr()}function Mt(d,h="pico"){Re(d),we(h),Pe(""),on(null),Gr({top:0,left:0}),Xr()}function Xr(){zl.current=[],Ul.current=[],$r.current=null}function _r(){const d=Ln.current;return{content:W,selectionStart:(d==null?void 0:d.selectionStart)??W.length,selectionEnd:(d==null?void 0:d.selectionEnd)??(d==null?void 0:d.selectionStart)??W.length}}function Kr(d){const h=zl.current,w=h.at(-1);(w==null?void 0:w.content)===d.content&&w.selectionStart===d.selectionStart&&w.selectionEnd===d.selectionEnd||(h.push(d),h.length>Gy&&h.shift(),Ul.current=[])}function Qr(d,h){let w=0;const T=Math.min(d.length,h.length);for(;w<T&&d[w]===h[w];)w+=1;let M=d.length,Q=h.length;for(;M>w&&Q>w&&d[M-1]===h[Q-1];)M-=1,Q-=1;const ce=d.slice(w,M),Ge=h.slice(w,Q),be=Ge&&!ce?"insert":ce&&!Ge?"delete":"replace",Ce=Ge.at(-1)??"";return{kind:be,boundaryAfter:be==="insert"&&/[\s.,:;()[\]{}'"`+\-*/%=<>!?]/.test(Ce)}}function Ss(d,h){if(h!=="typing")return $r.current=null,!0;const w=Date.now(),T=Qr(W,d),M=$r.current,Q=M!==null&&M.path===ee&&M.source===ve&&M.kind===T.kind&&M.kind!=="replace"&&!M.boundaryAfter&&w-M.at<=Iy;return $r.current={path:ee,source:ve,kind:T.kind,at:w,boundaryAfter:T.boundaryAfter},!Q}function bi(d){Pe(d.content),$n(h=>({...h,[Vn(ve,ee)]:d.content})),Ol(""),on(null),window.requestAnimationFrame(()=>{const h=Ln.current;h&&(h.focus(),h.selectionStart=Math.min(d.selectionStart,d.content.length),h.selectionEnd=Math.min(d.selectionEnd,d.content.length))})}function ks(){const d=zl.current.pop();return d?($r.current=null,Ul.current.push(_r()),bi(d),!0):!1}function Zr(){const d=Ul.current.pop();return d?($r.current=null,zl.current.push(_r()),bi(d),!0):!1}function jn(d,h=(Q=>(Q=Ln.current)==null?void 0:Q.selectionStart)()??d.length,w=_r(),T=h,M="programmatic"){w&&d!==W&&Ss(d,M)&&Kr(w),Pe(d),$n(ce=>({...ce,[Vn(ve,ee)]:d})),Ol(""),Ni(d,h),window.requestAnimationFrame(()=>{const ce=Ln.current;ce&&(ce.selectionStart=Math.min(h,d.length),ce.selectionEnd=Math.min(T,d.length))})}function gr(d,h=ve){$n(w=>{const T=Vn(h,d);if(!(T in w))return w;const M={...w};return delete M[T],M})}function Hl(){return or[ee]===W}function un(d,h){cr(w=>({...w,[d]:h}))}function yi(d,h){un(d,h),$n(w=>({...w,[Vn("pico",d)]:h})),ve==="pico"&&ee===d&&Pe(h)}function Wr(){ie([]),qe([]),cr({}),$n({}),on(null),Re(d=>{const h=tc(Wo());if(h.find(M=>M.path===d))return d;const T=h[0];return we("local"),Pe(T.content),Xr(),T.path})}function Nn(d){er(),X({value:100,label:d}),Bl.current=window.setTimeout(()=>{Bl.current=null,X(null)},900)}function er(){Bl.current!==null&&(window.clearTimeout(Bl.current),Bl.current=null)}function vi(){return ne?u.jsxs("div",{className:"ide-task-progress",role:"progressbar","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":Math.round(ne.value),children:[u.jsxs("div",{children:[u.jsx("span",{children:ne.label}),u.jsxs("strong",{children:[Math.round(ne.value),"%"]}),ne.cancellable&&u.jsx("button",{className:"ide-task-cancel",type:"button",onClick:Ns,"aria-label":"Stop handling",title:"Stop",children:u.jsx(nt,{name:"delete",size:18})})]}),u.jsx("b",{"aria-hidden":"true",children:u.jsx("i",{style:{width:`${Math.max(2,Math.min(100,ne.value))}%`}})})]}):null}function Ns(){Jn.current&&gn("Stopper læsning...",!0,!0)}function gn(d="Stopper læsning...",h=!1,w=!1){var T;er(),rt.current=null,Jt.current+=1,(T=Jn.current)==null||T.abort(),Jn.current=null,mr.current=null,oe(null),L(!1),X(h?{value:(ne==null?void 0:ne.value)??0,label:d,cancellable:!1}:null),w&&$("warning","Stopper BLE-læsning efter den aktuelle datapakke.")}function br(d){var h;if(!(mr.current===d||rt.current===d)){if(rt.current=d,rn.current){Jt.current+=1,(h=Jn.current)==null||h.abort(),Jn.current=null,mr.current=null,Mt(d),oe(d),L(!0),er(),X({value:2,label:`Skifter til ${Ne(d)}...`,cancellable:!0});return}Gl()}}function Gl(){if(rn.current)return;const d=rt.current;if(!d)return;rt.current=null;const h=Jt.current+1;Jt.current=h;const w=new AbortController;Jn.current=w,mr.current=d,Mt(d),oe(d),L(!0),er(),X({value:12,label:`Indlæser ${Ne(d)}...`,cancellable:!0});const T=(async()=>{try{const M=await _(d,(Q,ce)=>{Jt.current===h&&X({value:Q,label:ce,cancellable:!0})},w.signal);if(w.signal.aborted||Jt.current!==h)return;ln(d,M,"pico"),un(d,M),Nn("Fil indlæst")}catch(M){if(Jt.current!==h)return;qy(M)||w.signal.aborted?$("info",`Stoppede læsning af ${Ne(d)}.`):(X(null),$("error",M instanceof Error?M.message:"BLE læsning fejlede."))}})();rn.current=T,T.finally(()=>{if(rn.current!==T)return;rn.current=null,Jn.current===w&&(Jn.current=null),mr.current===d&&(mr.current=null),!!rt.current||(oe(null),L(!1),w.signal.aborted&&X(null)),Gl()})}async function nr(d){const h=fr.current;fr.current=!0;try{return await d()}finally{fr.current=h}}z.useEffect(()=>{if(!jl)return;const d=kn.current;d&&(d.scrollTop=d.scrollHeight)},[V,jl]),z.useEffect(()=>{wb({clearTerminalOnRun:Zt,simplifiedErrors:ur})},[Zt,ur]),z.useEffect(()=>{var d;Pr.some(h=>h.version===Yn)||Ur(((d=Pr[0])==null?void 0:d.version)??"")},[Pr,Yn]),z.useEffect(()=>{ys(Jh(navigator))},[]),z.useEffect(()=>{const d=()=>{const h=Vr.current;kt.current=null,cn.current=null,Vr.current=null,h==null||h.disconnect().catch(()=>{})};return window.addEventListener("pagehide",d),()=>{var h,w;er(),(h=Rt.current)==null||h.dispose(),Rt.current=null,(w=tt.current)==null||w.dispose(),tt.current=null,window.removeEventListener("pagehide",d),d()}},[]),z.useEffect(()=>{const d=h=>{!(h.ctrlKey||h.metaKey)||h.key.toLowerCase()!=="s"||(h.preventDefault(),!j&&ee.trim()&&!pi&&!O&&!U&&!G&&As())};return window.addEventListener("keydown",d),()=>window.removeEventListener("keydown",d)},[ve,_e,j,b,W,ee,pi,O,U,G]);function xi(d,h,w){J(T=>{const M=Gf(T,d,h,w);return is(M),M})}function wi(d,h){J(w=>{const T=w.find(be=>be.path===d),Q=mt[Vn("local",d)]??(T==null?void 0:T.content),ce=Q!==void 0&&sr(Q)!==sr(h)?Gf(w,l_(d,sc(w)),Q,!1):w,Ge=Gf(ce,d,h,!1);return is(Ge),Ge}),$n(w=>({...w,[Vn("local",d)]:h})),ve==="local"&&ee===d&&(Pe(h),Ol(""),on(null),Xr())}const Il=av(H,pe,mt,b||_e);z.useEffect(()=>{_e&&fn()},[_e]),z.useEffect(()=>{const d=pr.current;d&&d!==ht&&Wr(),pr.current=ht},[ht]);async function Vl(){if($t.supported){I(!0);try{await hi.requestAndConnect();const d=new X0(hi);kt.current=d,cn.current=new ey(d),v(!0),ze(0),await d.interrupt(),await Ei(d),$("success","Sendte stop-signal til Pico-terminalen."),await pa(cn.current),await Ms(cn.current)}catch(d){$("error",d instanceof Error?d.message:"USB-forbindelse mislykkedes.");try{await hi.disconnect()}catch(h){$("error",h instanceof Error?`USB-porten kunne ikke lukkes: ${h.message}`:"USB-porten kunne ikke lukkes.");return}ze(h=>{const w=h+1;return w>=3&&($("info","USB-forbindelsen er mislykkedes flere gange. Hvis Picoen er i BOOTSEL eller mangler MicroPython, kan du bruge MicroPython-download."),wn(!0)),w}),v(!1)}finally{I(!1)}}}async function Ei(d){const h=await d.exec(`import sys
print(sys.implementation.name)
`,4e3);if(h.error||!h.output.toLowerCase().includes("micropython"))throw new Error("MicroPython blev ikke fundet på Picoen.")}async function Rs(){var d;try{await((d=Vr.current)==null?void 0:d.disconnect()),kt.current=null,cn.current=null,v(!1),Wr()}catch(h){$("error",h instanceof Error?`USB-porten kunne ikke lukkes: ${h.message}`:"USB-porten kunne ikke lukkes.")}}async function Dt(d){const h=cn.current;if(h){L(!0),fr.current=!0;try{await d(h)}catch(w){X(null),$("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{fr.current=!1,L(!1)}}}async function fn(d=!0){if(_e){L(!0);try{const h=await p();ie(h),d&&$("success",`Indlæste ${h.length} filer fra Pico via Bluetooth.`)}catch(h){$("error",h instanceof Error?h.message:"BLE filhandling fejlede.")}finally{L(!1)}return}await pa(cn.current,d)}async function pa(d,h=!0){if(d){L(!0);try{const w=await nr(()=>d.list("/"));ie(w),h&&$("success",`Indlæste ${w.length} filer fra Pico.`)}catch(w){$("error",w instanceof Error?w.message:"USB filhandling fejlede.")}finally{L(!1)}}}async function yr(){if(_e){L(!0),X({value:4,label:"Tjekker biblioteker på Pico via Bluetooth..."});try{const d=await Ts((h,w)=>X({value:h,label:w}));qe(d),Nn("Fil-tjek færdigt")}catch(d){X(null),$("error",d instanceof Error?d.message:"BLE runtime check fejlede.")}finally{L(!1)}return}await Ms(cn.current)}async function Ts(d){const h=[],w=na.filter(M=>M.kind==="library"&&!Rl(M));let T=0;for(const M of na){if(M.kind==="program"){h.push({...M,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}if(Rl(M)){h.push({...M,status:"unknown",detail:"Opdateres via USB"});continue}try{const Q=T/Math.max(1,w.length)*100,ce=100/Math.max(1,w.length);$("info",`Tjekker ${M.label} på Pico via Bluetooth...`),d==null||d(Math.min(95,Q),`Tjekker ${M.label} på Pico...`);const Ge=await _(M.path,(Ce,an)=>{d==null||d(Math.min(95,Q+Ce/100*ce),`${M.label}: ${an}`)}),be=sr(Ge)===sr(M.content);h.push({...M,status:be?"ok":"outdated",detail:be?"Matcher appens version":"Kan installeres via Bluetooth"})}catch{h.push({...M,status:"missing",detail:"Mangler på Pico"})}finally{T+=1}}return d==null||d(100,"Fil-tjek færdigt"),h}async function Ms(d){if(d){L(!0);try{const h=await nr(()=>Ds(d)),w=h;qe(w)}catch(h){$("error",h instanceof Error?h.message:"Runtime check fejlede.")}finally{L(!1)}}}async function Ds(d){if(!d)return[];const h=[];for(const w of na){if(w.kind==="program"){h.push({...w,status:"unknown",detail:"Startprogram kan vælges til installation"});continue}try{const T=await d.readText(w.path),M=sr(T)===sr(w.content);h.push({...w,status:M?"ok":"outdated",detail:M?"Matcher appens version":"Matcher ikke appens version"})}catch{h.push({...w,status:"missing",detail:"Mangler på Pico"})}}return h}async function wc(d=ee){if(_e){br(d);return}oe(d),await Dt(async h=>{X({value:12,label:`Indlæser ${Ne(d)}...`});const w=await Ec(h,d);ln(d,w,"pico"),un(d,w),Nn("Fil indlæst")}),oe(null)}async function Ec(d,h){var w;try{return await d.readText(h)}catch(T){await((w=kt.current)==null?void 0:w.stop().catch(()=>{})),await Vy(120);try{return await d.readText(h)}catch{throw T}}}function js(){Z(!0)}async function As(){if(ve==="pico"){if(!b&&!_e){$("error","Ingen Pico-forbindelse. Brug Gem for at vælge en anden placering.");return}await ha();return}Os()}function Os(){if(Tl(ee)){$("error",fs);return}xi(ee,W,!1),we("local"),$n(d=>({...d,[Vn("local",ee)]:W})),Z(!1),$("success",`Gemte ${Ne(ee)} lokalt.`)}async function ha(){if(Z(!1),Tl(ee))return X(null),$("error",fs),!1;if(X({value:0,label:"Starter gemning..."}),_e){L(!0);try{return await y(ee,W,(h,w)=>X({value:h,label:w})),un(ee,W),we("pico"),$n(h=>({...h,[Vn("pico",ee)]:W})),Nn("Gemt på Pico via Bluetooth"),$("success",`Gemte ${Ne(ee)} på Pico via Bluetooth.`),nc(ee)&&(St(!0),$("warning","main.py er gemt. Genstart Picoen for at køre den nye version.")),await fn(!1),!0}catch(h){return X(null),$("error",h instanceof Error?h.message:"BLE gem fejlede."),!1}finally{L(!1)}}if(!cn.current)return X(null),!1;let d=!1;return await Dt(async h=>{vr(ee,"pico")?await h.replaceTextSafely(ee,W,(w,T)=>X({value:w,label:T})):await h.writeText(ee,W,(w,T)=>X({value:w,label:T})),un(ee,W),we("pico"),$n(w=>({...w,[Vn("pico",ee)]:W})),Nn("Gemt på Pico via USB"),$("success",`Gemte ${ee}.`),await fn(),await yr(),d=!0}),d}function Sc(){Si(Ne(ee),W),Z(!1),$("success",`Downloadede ${Ne(ee)}.`)}function Si(d,h){const w=new Blob([h],{type:"text/plain;charset=utf-8"}),T=URL.createObjectURL(w),M=document.createElement("a");M.href=T,M.download=d,M.click(),URL.revokeObjectURL(T)}async function Cs(d){L(!0),St(!1),X({value:10,label:"Genstarter Pico..."});try{await x(d)?(Nn("Pico genforbundet"),$("success",d==="control"?"Pico genforbundet. Åbner kontrolpanelet.":"Pico genforbundet til Kodeværkstedet."),d==="ide"&&await fn()):(X(null),$("warning","Automatisk genforbindelse lykkedes ikke. Vælg Picoen fra dashboardet."))}catch(h){X(null),$("error",h instanceof Error?h.message:"Genstart/genforbindelse mislykkedes.")}finally{L(!1)}}function Ls(d){var Q,ce;const h=d??{path:ee,source:ve},w=h.source==="pico"?"Pico":"browser",T=(d==null?void 0:d.versions.length)??(h.source==="pico"?((Q=ta(H).get(h.path))==null?void 0:Q.length)??0:((ce=ta(sc(pe)).get(h.path))==null?void 0:ce.length)??0),M=T>0?` Det sletter også filens versionshistorik (${T} gemte versioner).`:"";te(null),i({title:"Slet fil",message:`Vil du slette ${Ne(h.path)} fra ${w}?${M}`,confirmLabel:"Slet",onConfirm:()=>{Nc(h)}})}function kc(){i({title:"Nulstil enhed",message:"Vil du nulstille Picoens enhedsindstillinger? Det sletter DeviceSettings.txt, så Picoen kan oprettes som en ny enhed igen. Kodefiler og startprogram bliver ikke slettet.",confirmLabel:"Nulstil",onConfirm:()=>{Bs()}})}async function Bs(){if(!cn.current){$("error","Forbind Picoen med USB først.");return}await Dt(async d=>{await d.delete("/DeviceSettings.txt").catch(h=>{const w=h instanceof Error?h.message:"";if(!/ENOENT|No such file|not found/i.test(w))throw h}),cr(h=>{const w={...h};return delete w["/DeviceSettings.txt"],w}),gr("/DeviceSettings.txt","pico"),$("success","DeviceSettings.txt er nulstillet. Afbryd og forbind Picoen igen, hvis kontrolpanelet allerede var åbent."),await fn()})}function zs(d,h,w){const T=Il.filter(ce=>ce.kind==="file"&&ce.type==="file"),M=T.findIndex(ce=>ce.path===d&&ce.source===h);if(M===-1)return null;const Q=ce=>!!ce&&!(ce.path===d&&ce.source===h)&&!(ce.source===h&&w.has(ce.path))&&!(_e&&Rl(ce));for(const ce of[!0,!1])for(let Ge=1;Ge<T.length;Ge+=1){const be=T[M+Ge];if(Q(be)&&(!ce||be.source===h))return be;const Ce=T[M-Ge];if(Q(Ce)&&(!ce||Ce.source===h))return Ce}return null}function _a(d){if(d){ba(d);return}const h=tc(Wo())[0];ln(h.path,mt[Vn("local",h.path)]??h.content,"local")}async function Nc(d){const h=d.path,w=d.source,T=h===ee&&w===ve;if(w==="local"){const be=ta(sc(pe)).get(h)??[],Ce=new Set([h,...be.map(Je=>Je.path)]),an=T?zs(h,w,Ce):null,Fn=pe.filter(Je=>!Ce.has(Je.path));J(Fn),is(Fn);for(const Je of Ce)gr(Je,"local");T&&_a(an);const Se=be.length>0?` og ${be.length} gemte versioner`:"";$("warning",`Slettede ${Ne(h)}${Se} fra browseren.`);return}const M=ta(H).get(h)??[],Q=[h,...M.map(be=>be.path)],ce=T?zs(h,w,new Set(Q)):null;if(_e){L(!0);try{for(const Ce of Q)await E(Ce);cr(Ce=>{const an={...Ce};for(const Fn of Q)delete an[Fn];return an});for(const Ce of Q)gr(Ce,"pico");const be=M.length>0?` og ${M.length} gemte versioner`:"";$("warning",`Slettede ${Ne(h)}${be} på Pico via Bluetooth.`),await fn(),T&&_a(ce)}catch(be){$("error",be instanceof Error?be.message:"BLE sletning fejlede.")}finally{L(!1)}return}if(!cn.current){$("error","Ingen Pico-forbindelse. Kan ikke slette Pico-filen.");return}let Ge=!1;await Dt(async be=>{for(const an of Q)await be.delete(an);cr(an=>{const Fn={...an};for(const Se of Q)delete Fn[Se];return Fn});const Ce=M.length>0?` og ${M.length} gemte versioner`:"";$("warning",`Slettede ${h}${Ce}.`);for(const an of Q)gr(an,"pico");await fn(),await yr(),Ge=!0}),Ge&&T&&_a(ce)}async function Rc(d){if(!d)return;const h=$y(d.name);if(!h){$("error","Kun .py, .txt, .json og .csv kan importeres.");return}if(Tl(h)){$("error",fs);return}if(d.size>128*1024){$("error","Filen er for stor til Pico-værkstedet.");return}const w=await d.text();if(ve==="local"){xi(h,w,!0),ln(h,w,"local"),$("success",`Importerede ${Ne(h)} i browseren.`);return}if(!b&&!_e){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(_e&&Rl({path:h})){$("error","BLEPeripheral.py kan ikke importeres over Bluetooth, mens den holder forbindelsen i gang. Brug USB i stedet.");return}if(X({value:0,label:"Uploader fil til Pico..."}),_e){L(!0);try{await y(h,w,(M,Q)=>X({value:M,label:Q})),un(h,w),ln(h,w,"pico"),Nn("Fil uploadet til Pico"),$("success",`Importerede ${Ne(h)} på Pico via Bluetooth.`),await fn()}catch(M){X(null),$("error",M instanceof Error?M.message:"Kunne ikke importere filen til Pico.")}finally{L(!1)}return}if(!cn.current){X(null),$("error","Ingen Pico-forbindelse. Kan ikke importere filen til Pico.");return}await Dt(async M=>{vr(h,"pico")?await M.replaceTextSafely(h,w,(Q,ce)=>X({value:Q,label:ce})):await M.writeText(h,w,(Q,ce)=>X({value:Q,label:ce})),un(h,w),ln(h,w,"pico"),Nn("Fil uploadet til Pico"),$("success",`Importerede ${Ne(h)} på Pico.`),await fn(),await yr()})}async function Tc(){fe(""),re(!0)}function Mc(){const d=Qh(ue);if(!d)return;if(Tl(d)){$("error",fs);return}const h=ve;if(vr(d,h)){$("error",`Der findes allerede en fil med navnet ${Ne(d)} i ${h==="pico"?"Pico":"browseren"}.`);return}if(h==="local"){xi(d,"",!1),ln(d,"","local"),re(!1),$("success",`Oprettede ${Ne(d)} i browseren.`);return}Dc(d)}async function Dc(d){if(!b&&!_e){$("error","Ingen Pico-forbindelse. Vælg en browser-fil først, eller forbind Picoen.");return}if(re(!1),X({value:0,label:"Opretter fil på Pico..."}),_e){L(!0);try{await y(d,"",(h,w)=>X({value:h,label:w})),un(d,""),ln(d,"","pico"),Nn("Fil oprettet på Pico"),$("success",`Oprettede ${Ne(d)} på Pico via Bluetooth.`),await fn()}catch(h){X(null),$("error",h instanceof Error?h.message:"Kunne ikke oprette fil på Pico.")}finally{L(!1)}return}if(!cn.current){X(null),$("error","Ingen Pico-forbindelse. Kan ikke oprette Pico-filen.");return}await Dt(async h=>{await h.writeText(d,"",(w,T)=>X({value:w,label:T})),un(d,""),ln(d,"","pico"),Nn("Fil oprettet på Pico"),$("success",`Oprettede ${Ne(d)} på Pico.`),await fn()})}function jc(d){d.type==="file"&&(te(d),N(Py(d.path)))}async function Ac(d){if(!U)return;const h=U.path;if(te(null),U.source==="local"){const w=pe.find(T=>T.path===d.path);if(!w){$("error","Kunne ikke finde versionen i browseren.");return}wi(h,w.content),ln(h,w.content,"local"),$("success",`Gendannede ${Ne(d.path)} i browseren.`);return}if(X({value:0,label:"Gendanner version..."}),_e){L(!0);try{const w=await _(d.path);await y(h,w,(T,M)=>X({value:T,label:M})),un(h,w),ln(h,w,"pico"),Nn("Version gendannet"),await fn(!1)}catch(w){X(null),$("error",w instanceof Error?w.message:"Kunne ikke gendanne versionen.")}finally{L(!1)}return}cn.current&&await Dt(async w=>{await w.replaceTextSafely(h,await w.readText(d.path),(M,Q)=>X({value:M,label:Q}));const T=await w.readText(h);un(h,T),ln(h,T,"pico"),Nn("Version gendannet"),await fn()})}function ga(d){const h=(U==null?void 0:U.source)==="local"?"browseren":"Pico";i({title:"Slet version",message:`Vil du slette ${Ne(d.path)} fra ${h}?`,confirmLabel:"Slet",onConfirm:()=>{Yl(d)}})}async function Yl(d){if((U==null?void 0:U.source)==="local"){const h=pe.filter(w=>w.path!==d.path);J(h),is(h),gr(d.path,"local"),te(w=>w&&{...w,versions:w.versions.filter(T=>T.path!==d.path)}),$("warning",`Slettede ${Ne(d.path)} fra browserens versionshistorik.`);return}if(_e){L(!0);try{await E(d.path),await fn(!1),te(h=>h&&{...h,versions:h.versions.filter(w=>w.path!==d.path)})}catch(h){$("error",h instanceof Error?h.message:"Kunne ikke slette versionen.")}finally{L(!1)}return}cn.current&&await Dt(async h=>{await h.delete(d.path),await fn(!1),te(w=>w&&{...w,versions:w.versions.filter(T=>T.path!==d.path)})})}async function Oc(){var w;if(!U)return;const d=U,h=lv(d.path,T=>vr(T,d.source));if(!h){$("error",`Kunne ikke finde et ledigt filnavn til en kopi af ${Ne(d.path)}.`);return}if(d.source==="local"){const T=mt[Vn("local",d.path)]??((w=pe.find(M=>M.path===d.path))==null?void 0:w.content)??"";xi(h,T,!1),ln(h,T,"local"),te(null),$("success",`Duplikerede ${Ne(d.path)} til ${Ne(h)} i browseren.`);return}if(te(null),X({value:0,label:"Duplikerer fil..."}),_e){L(!0);try{const T=or[d.path]??await _(d.path);await y(h,T,(M,Q)=>X({value:M,label:Q})),un(h,T),ln(h,T,"pico"),Nn("Fil duplikeret"),await fn(!1),$("success",`Duplikerede ${Ne(d.path)} til ${Ne(h)} på Pico via Bluetooth.`)}catch(T){X(null),$("error",T instanceof Error?T.message:"Kunne ikke duplikere filen.")}finally{L(!1)}return}if(!cn.current){X(null),$("error","Ingen Pico-forbindelse. Kan ikke duplikere Pico-filen.");return}await Dt(async T=>{const M=await T.readText(d.path);await T.writeText(h,M,(Q,ce)=>X({value:Q,label:ce})),un(h,M),ln(h,M,"pico"),Nn("Fil duplikeret"),await fn(!1),$("success",`Duplikerede ${Ne(d.path)} til ${Ne(h)} på Pico.`)})}async function Us(){if(!U)return;const d=U,h=Hf(Ee,ds(d.path));if(!h||h===d.path)return;if(Tl(h)){$("error",fs);return}if(vr(h,d.source)){$("error",`Der findes allerede en fil med navnet ${Ne(h)}.`);return}const w=d.source==="local",T=d.source==="pico";if(_e&&T&&(nc(d.path)||nc(h))){$("error","main.py kan redigeres over Bluetooth, men ikke omdøbes. Gem den som main.py.");return}L(!0);try{if(T)if(_e){const M=or[d.path]??await _(d.path);await y(h,M,(Q,ce)=>X({value:Q,label:ce})),await E(d.path),cr(Q=>({...a_(Q,d.path,h),[h]:M}))}else cn.current&&(await nr(()=>cn.current.rename(d.path,h)),cr(M=>a_(M,d.path,h)));w&&J(M=>{const Q=M.map(ce=>ce.path===d.path?{...ce,path:h,updatedAt:Date.now()}:ce);return is(Q),Q}),ee===d.path&&ve===d.source&&Re(h),$n(M=>cv(M,d.source,d.path,h)),te(null),N(""),$("success",`Omdøbte ${Ne(d.path)} til ${Ne(h)}.`),T&&await fn()}catch(M){$("error",M instanceof Error?M.message:"Kunne ikke omdøbe filen.")}finally{X(null),L(!1)}}function vr(d,h){return h==="pico"?H.some(w=>w.path===d):pe.some(w=>w.path===d)}async function Hs(d,h){if(!vr(d,"pico"))return;const w=l_(d,H),T=or[d]??await _(d);h!==void 0&&sr(T)===sr(h)||await y(w,T)}function ba(d){if(d.type!=="file"){_e&&gn(void 0,!1),Re(d.path),we(d.source);return}if(_e&&Rl(d)){$("warning","BLEPeripheral.py holder Bluetooth-forbindelsen i gang og kan ikke åbnes her.");return}if(d.source==="local"){_e&&gn(void 0,!1);const w=pe.find(T=>T.path===d.path);ln(d.path,mt[Vn("local",d.path)]??(w==null?void 0:w.content)??"","local");return}const h=Vn("pico",d.path);if(Object.prototype.hasOwnProperty.call(mt,h)){_e&&gn(void 0,!1),ln(d.path,mt[h],"pico");return}if(Object.prototype.hasOwnProperty.call(or,d.path)){_e&&gn(void 0,!1),ln(d.path,or[d.path],"pico");return}wc(d.path)}async function ya(){if(!b&&!_e){const d=Zh();qe(d),Kt(Wh(d)),Oe(!0),X(null);return}L(!0),X({value:4,label:_e?"Tjekker biblioteker på Pico via Bluetooth...":"Tjekker biblioteker på Pico..."}),$("info",_e?"Tjekker om Picoens biblioteker er opdaterede via Bluetooth før installation...":"Tjekker om Picoens biblioteker er opdaterede før installation...");try{const d=Ae.length>0?Ae:_e?await Ts((h,w)=>X({value:h,label:w})):await nr(()=>Ds(cn.current));qe(d),Kt(Wh(d)),Oe(!0),X(null)}catch(d){X(null),$("error",d instanceof Error?d.message:"Fil-tjek før installation fejlede.")}finally{L(!1)}}async function Jr(){if(Oe(!1),_e){L(!0);try{const h=(Ae.length>0?Ae:na.map(T=>({...T,status:"unknown",detail:"Ikke tjekket"}))).filter(T=>Qn[T.id]&&!Rl(T));if(h.length===0){$("info","Ingen filer valgt til installation.");return}let w=null;X({value:0,label:"Starter installation..."});for(const[T,M]of h.entries()){$("info",`Installerer ${M.label} via Bluetooth...`);const Q=T/h.length*100,ce=100/h.length;await Hs(M.path,M.content),await y(M.path,M.content,(Ge,be)=>{X({value:Math.min(99,Q+Ge/100*ce),label:`${M.label}: ${be}`})}),yi(M.path,M.content),$("success",`Installerede ${M.label}.`),M.kind==="library"&&(w=M),nc(M.path)&&St(!0)}Nn("Installation færdig"),await fn(!1),await yr(),w&&va(w)}catch(d){X(null),$("error",d instanceof Error?d.message:"BLE installation fejlede.")}finally{L(!1)}return}await Dt(async d=>{const w=(Ae.length>0?Ae:na.map(M=>({...M,status:"unknown",detail:"Ikke tjekket"}))).filter(M=>Qn[M.id]);if(w.length===0){$("info","Ingen filer valgt til installation.");return}let T=null;X({value:0,label:"Starter installation..."});for(const[M,Q]of w.entries()){$("info",`Installerer ${Q.label}...`);const ce=M/w.length*100,Ge=100/w.length,be=await d.readText(Q.path).catch(()=>null);be!==null&&sr(be)===sr(Q.content)?(X({value:Math.min(99,ce+Ge),label:`${Q.label}: Allerede nyeste version`}),$("info",`${Q.label} findes allerede i samme version.`)):(await d.replaceTextSafely(Q.path,Q.content,(Ce,an)=>{X({value:Math.min(99,ce+Ce/100*Ge),label:`${Q.label}: ${an}`})},{createBackup:!0}),$("success",`Installerede ${Q.label}.`)),yi(Q.path,Q.content),Q.kind==="library"&&(T=Q)}Nn("Installation færdig"),await fn(!1),await yr(),T&&va(T)})}function Gs(){return(Ae.length>0?Ae:Zh()).filter(h=>Qn[h.id])}function Cc(){const d=Gs();if(d.length===0){$("info","Ingen filer valgt.");return}for(const h of d)wi(h.path,h.content);Oe(!1),$("success",`Gemte ${d.length} filer i browseren.`)}function Lc(){const d=Gs();if(d.length===0){$("info","Ingen filer valgt.");return}d.forEach((h,w)=>{window.setTimeout(()=>{Si(Ne(h.path),h.content)},w*120)}),Oe(!1),$("success",`Starter download af ${d.length} filer.`)}function va(d){ln(d.path,d.content,"pico"),un(d.path,d.content),$("info",`Åbnede ${d.label} i editoren.`)}function Is(d,h){Kt(w=>{if(d.kind!=="program")return{...w,[d.id]:h};const T={...w};for(const M of Ae)M.kind==="program"&&(T[M.id]=!1);return T[d.id]=h,T})}async function $l(){if(Ps(),_e&&ve==="pico"){$("warning","Bluetooth holder forbindelsen åben, så koden kan ikke køres direkte her. Gem filen, og genstart Picoen for at køre den.");return}if(ve==="local"){await Pl();return}const d=kt.current;if(!d){$("error",`${Ne(ee)} er gemt på Picoen, men der er ingen USB-forbindelse til Pico-terminalen.`);return}if(ee.endsWith(".py")){if(!Hl()&&($("info",`${Ne(ee)} har ikke gemte ændringer. Gemmer på Picoen før kørsel...`),!await ha())){$("error","Pico-forbindelsen blev afbrudt under gemning.");return}if(j)return;Fr(),Wn.current="",Zn(!0);try{await d.runFile(ee,()=>{Fr(),Wn.current="",Yr.current=!1,Ml(!0),Nt.current=!0}),$("success",`Kører ${Ne(ee)}. Brug Stop for at afbryde.`)}catch(h){Ml(!1),Nt.current=!1,Fr(),Wn.current="",$("error",h instanceof Error?h.message:"Kunne ikke starte koden.")}return}L(!0);try{const h=await d.exec(W,2e4);h.output.trim()&&$("info",h.output),h.error.trim()&&gi(h.error,W),!h.output.trim()&&!h.error.trim()&&$("success","Koden kørte uden output.")}catch(h){$("error",h instanceof Error?h.message:"Kunne ikke køre koden.")}finally{L(!1)}}async function Pl(){const d=qf(W,{allowInput:!0});if(d.some(T=>T.level==="error")){for(const T of d){const M=T.line?`Linje ${T.line}: `:"";$(T.level==="error"?"error":"warning",`${M}${T.text}`)}return}/\binput\s*\(/.test(W)&&!D_()&&$("warning","input() i browseren kræver at siden genindlæses. Opdater siden (F5) og prøv igen.");const h=new AbortController;dr.current=h;const w=new Sy;tt.current=w,L(!0),ua(!0),Zn(!0),$("info",b?"Starter Browser-MicroPython for browser-filen.":"Starter Browser-MicroPython. Forbind Pico med USB for at køre på selve Picoen.");try{const T=[],M=await w.run(W,{timeoutMs:null,signal:h.signal,onOutput:be=>{T.push(be),$("info",be)}});for(const be of M.issues){const Ce=be.line?`Linje ${be.line}: `:"";$(be.level==="error"?"error":"warning",`${Ce}${be.text}`)}const Q=[...T,M.output].filter(Boolean).join(`
`).trim(),ce=M.output.trim();!M.error.trim()&&Fy(Q)?gi(Q,W):(ce&&$("info",ce),M.error.trim()&&gi(M.error,W,M.unavailable?"warning":"error")),M.ok&&!Q&&!M.error.trim()&&$("success","Browser-MicroPython kørte uden output.")}finally{dr.current=null,tt.current=null,w.dispose(),ua(!1),L(!1)}}async function Bc(){var h,w,T;if(Dl){(h=dr.current)==null||h.abort(),(w=tt.current)==null||w.stop(),$("warning","Stoppede Browser-MicroPython."),Zn(!0);return}if(!Tt&&On){(T=Rt.current)==null||T.reset(),Ir(!1),$("warning","Stoppede Browser-MicroPython-terminalen. Variablerne i browser-terminalen blev nulstillet."),Zn(!0);return}const d=kt.current;if(d)try{await d.stop(),$("warning","Stoppede koden på Pico.")}catch(M){$("error",M instanceof Error?M.message:"Kunne ikke stoppe koden.")}finally{Ml(!1),Nt.current=!1,Fr(),Wn.current="",Zn(!0),Es()}}function ki(){const d=kn.current;if(!d)return;const h=d.scrollHeight-d.scrollTop-d.clientHeight<12;Zn(h)}function Vs(){q([]),Zn(!0)}function Ys(){window.requestAnimationFrame(()=>{const d=kn.current;d&&(d.scrollTop=d.scrollHeight)})}async function ql(){const d=qn?ft:ft.trimEnd();if(qn){if(!Tt){const T=tt.current;if(!T){$("warning","Browser-MicroPython kører ikke lige nu."),it();return}Qt(""),Zn(!0),qr(d),T.sendInput(d),it();return}const w=kt.current;if(!w){$("warning","Pico-terminalen er ikke forbundet."),it();return}Qt(""),Zn(!0);try{await w.sendProgramInput(d)}catch(T){$("error",T instanceof Error?T.message:"Kunne ikke sende input til Pico-koden.")}finally{it()}return}if(!d.trim())return;if(Al(w=>(w.at(-1)===d?w:[...w,d]).slice(-80)),dt(null),Cn(null),Pn){$("warning",Tt?"Tryk Stop, før du skriver i Pico-terminalen.":"Stop offline MicroPython, før du skriver i browser-terminalen."),it();return}if(!Tt){const w=qf(d);if(w.some(M=>M.level==="error")){for(const M of w){const Q=M.line?"Linje "+M.line+": ":"";$(M.level==="error"?"error":"warning",Q+M.text)}it();return}const T=Rt.current??new Ey;Rt.current=T,Qt(""),Ir(!0),Zn(!0),$("info",">>> "+d);try{let M=!1;const Q=await T.send(d,{timeoutMs:15e3,onOutput:Ge=>{M=!0,$("info",Ge)}}),ce=Q.output.trim();ce&&!M&&$("info",ce),Q.error.trim()&&gi(Q.error,d,Q.unavailable?"warning":"error")}catch(M){$("error",M instanceof Error?M.message:"Browser-MicroPython-terminalen fejlede.")}finally{Ir(!1),it()}return}if(_e){$("warning","Terminalen bruger USB Serial. Bluetooth-forbindelsen kan vise filer, men kan ikke modtage frie terminalkommandoer."),it();return}const h=kt.current;if(!b||!h){$("warning","Forbind en microcontroller med USB for at skrive i MicroPython-terminalen."),it();return}Qt(""),Ir(!0),Zn(!0),Yr.current=!0,$("info",">>> "+d);try{await h.sendFriendlyLine(d)}catch(w){Yr.current=!1,$("error",w instanceof Error?w.message:"Kunne ikke sende kommando til MicroPython REPL.")}finally{Ir(!1),it()}}function it(){window.requestAnimationFrame(()=>{const d=pt.current;if(!d||d.disabled)return;d.focus();const h=d.value.length;d.selectionStart=h,d.selectionEnd=h})}function xa(d,h,w){if(w.length===0)return null;const T=b||_e;return u.jsxs("div",{className:"ide-install-group",children:[u.jsxs("div",{className:"ide-install-group-head",children:[u.jsx("h3",{children:d}),u.jsx("p",{children:h})]}),u.jsx("div",{className:"ide-install-scroll",children:w.map(M=>{const Q=_e&&Rl(M);return u.jsxs("label",{className:`ide-install-row ${Q?"disabled":""}`,children:[u.jsx("input",{type:"checkbox",checked:!!Qn[M.id],disabled:Q,onChange:ce=>Is(M,ce.target.checked)}),u.jsxs("span",{children:[u.jsxs("strong",{children:[$s(M),T&&M.kind==="library"&&u.jsx("em",{className:`ide-install-status status-${M.status}`,children:Q?"USB":iv(M.status)})]}),u.jsx("small",{children:M.description})]})]},M.id)})})]})}function $s(d){return d.kind==="program"?d.label.replace(/\s*\(main\.py\)$/i,""):d.label}function Ps(){Zt&&q([]),Zn(!0)}function wa(d,h){const w=d.indexOf(`
`,h);return w===-1?d.length:w}function Ni(d,h){if(n_(d,h)){on(null);return}const w=Qf(d,h);if(!w||w.query.length<1){on(null);return}const T=e_(d,h,!0).slice(0,8),M=t_(Ln.current,w.start,T.length);on(T.length>0&&M?{items:T,selected:0,start:w.start,end:h,position:M}:null)}function Ea(d,h){if(n_(d,h)){Cn(null);return}const w=Qf(d,h);if(!w||w.query.length<1){Cn(null);return}const T=e_(d,h,!1).slice(0,8),M=t_(pt.current,w.start,T.length);Cn(T.length>0&&M?{items:T,selected:0,start:w.start,end:h,position:M}:null)}function qs(d){const h=d.value.slice(d.selectionStart,d.selectionEnd);Ol(ev(h)?h:"")}function Ri(d,h){window.requestAnimationFrame(()=>{const w=d==null?void 0:d.querySelector(`[data-autocomplete-index="${h}"]`);w==null||w.scrollIntoView({block:"nearest"})})}function Bn(d=Ye==null?void 0:Ye.items[Ye.selected]){if(!d||!Ye)return;const h=_r(),w=W.slice(0,Ye.start)+d.insert+W.slice(Ye.end),T=Ye.start+d.insert.length-(d.insert.endsWith("()")?1:0);on(null),jn(w,T,h),window.requestAnimationFrame(()=>{const M=Ln.current;M&&M.focus()})}function el(d=tn==null?void 0:tn.items[tn.selected]){if(!d||!tn)return;const h=ft.slice(0,tn.start)+d.insert+ft.slice(tn.end),w=tn.start+d.insert.length-(d.insert.endsWith("()")?1:0);Qt(h),Cn(null),window.requestAnimationFrame(()=>{const T=pt.current;T&&(T.focus(),T.selectionStart=w,T.selectionEnd=w)})}function Fs(d){const h=Ln.current;if(!h)return!1;const w=h.selectionStart,T=h.selectionEnd,M={content:W,selectionStart:w,selectionEnd:T},Q=W.lastIndexOf(`
`,w-1)+1,ce=T>w&&W[T-1]===`
`?T-1:T,Ge=wa(W,ce),be=Ge<W.length?Ge+1:Ge,Ce=W.slice(Q,be);if(d<0){if(Q===0)return!1;const jt=W.lastIndexOf(`
`,Q-2)+1,qt=W.slice(jt,Q),nl=W.slice(0,jt)+Ce+qt+W.slice(be),tl=-qt.length;return jn(nl,w+tl,M,T+tl),!0}if(be>=W.length)return!1;const an=wa(W,be),Fn=an<W.length?an+1:an,Se=W.slice(be,Fn),Je=W.slice(0,Q)+Se+Ce+W.slice(Fn),tr=Se.length;return jn(Je,w+tr,M,T+tr),!0}function Xs(d){var Fn;if((d.ctrlKey||d.metaKey)&&d.key.toLowerCase()==="z"){d.preventDefault(),(d.shiftKey?Zr():ks())&&on(null);return}if((d.ctrlKey||d.metaKey)&&d.key.toLowerCase()==="y"){d.preventDefault(),Zr()&&on(null);return}if((d.ctrlKey||d.metaKey)&&d.key.toLowerCase()==="s"){d.preventDefault(),!j&&ee.trim()&&As();return}if(d.altKey&&!d.ctrlKey&&!d.metaKey&&(d.key==="ArrowUp"||d.key==="ArrowDown")){d.preventDefault(),Fs(d.key==="ArrowUp"?-1:1)&&on(null);return}if(Ye){if(d.key==="ArrowDown"){d.preventDefault(),on(Se=>{if(!Se)return Se;const Je=(Se.selected+1)%Se.items.length;return Ri(pn.current,Je),{...Se,selected:Je}});return}if(d.key==="ArrowUp"){d.preventDefault(),on(Se=>{if(!Se)return Se;const Je=(Se.selected-1+Se.items.length)%Se.items.length;return Ri(pn.current,Je),{...Se,selected:Je}});return}if(d.key==="Tab"){d.preventDefault(),Bn();return}if(d.key==="Enter"){if(!(Ye.items[Ye.selected]&&C_(Ye.items[Ye.selected],W.slice(Ye.start,Ye.end)))){d.preventDefault(),Bn();return}on(null)}if(d.key==="Escape"){d.preventDefault(),on(null);return}}if(d.key==="Enter"){d.preventDefault();const Se=d.currentTarget,Je=Se.selectionStart,tr=Se.selectionEnd,jt={content:W,selectionStart:Je,selectionEnd:tr},qt=W.lastIndexOf(`
`,Je-1)+1,nl=W.slice(qt,Je),tl=((Fn=nl.match(/^[ \t]*/))==null?void 0:Fn[0])??"",Sa=nl.trimEnd().endsWith(":")?"    ":"",Fl=`
${tl}${Sa}`,Xl=W.slice(0,Je)+Fl+W.slice(tr),zn=Je+Fl.length;jn(Xl,zn,jt),window.requestAnimationFrame(()=>{Se.selectionStart=zn,Se.selectionEnd=zn});return}if(d.key!=="Tab")return;d.preventDefault();const h=d.currentTarget,w=h.selectionStart,T=h.selectionEnd,M={content:W,selectionStart:w,selectionEnd:T},Q="    ";if(d.shiftKey){const Se=W.lastIndexOf(`
`,w-1)+1,Je=w===T?wa(W,w):T,tr=W.slice(Se,Je);let jt=0,qt=0;const nl=tr.replace(/(^|\n)( {1,4}|\t)/g,(Sa,Fl,Xl,zn)=>{const Kl=Xl.length;return Se+zn<w&&(jt+=Kl),qt+=Kl,Fl});if(qt===0)return;const tl=W.slice(0,Se)+nl+W.slice(Je);jn(tl,Math.max(Se,w-jt),M,w===T?Math.max(Se,w-jt):Math.max(Se,T-qt)),window.requestAnimationFrame(()=>{h.selectionStart=Math.max(Se,w-jt),h.selectionEnd=w===T?h.selectionStart:Math.max(h.selectionStart,T-qt)});return}if(w===T){const Se=W.slice(0,w)+Q+W.slice(T);jn(Se,w+Q.length,M),window.requestAnimationFrame(()=>{h.selectionStart=w+Q.length,h.selectionEnd=w+Q.length});return}const ce=W.lastIndexOf(`
`,w-1)+1,be=W.slice(ce,T).replace(/^/gm,Q),Ce=be.split(`
`).length,an=W.slice(0,ce)+be+W.slice(T);jn(an,w+Q.length,M,T+Ce*Q.length),window.requestAnimationFrame(()=>{h.selectionStart=w+Q.length,h.selectionEnd=T+Ce*Q.length})}function Ks(d){if(qn){d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),ql());return}if(tn){if(d.key==="ArrowDown"){d.preventDefault(),Cn(h=>{if(!h)return h;const w=(h.selected+1)%h.items.length;return Ri(Ll.current,w),{...h,selected:w}});return}if(d.key==="ArrowUp"){d.preventDefault(),Cn(h=>{if(!h)return h;const w=(h.selected-1+h.items.length)%h.items.length;return Ri(Ll.current,w),{...h,selected:w}});return}if(d.key==="Enter"||d.key==="Tab"){d.preventDefault(),el();return}if(d.key==="Escape"){d.preventDefault(),Cn(null);return}}if(d.key==="Tab"){d.preventDefault();const h=d.currentTarget,w=h.selectionStart,T=h.selectionEnd,M="    ",Q=ft.slice(0,w)+M+ft.slice(T),ce=w+M.length;Qt(Q),dt(null),Cn(null),window.requestAnimationFrame(()=>{h.selectionStart=ce,h.selectionEnd=ce});return}if(d.key==="ArrowUp"||d.key==="ArrowDown"){if(!(d.key==="ArrowUp"?d.currentTarget.selectionStart===0&&d.currentTarget.selectionEnd===0:d.currentTarget.selectionStart===ft.length&&d.currentTarget.selectionEnd===ft.length)||mi.length===0)return;d.preventDefault();const w=d.key==="ArrowUp"?Sn===null?mi.length-1:Math.max(0,Sn-1):Sn===null||Sn+1>=mi.length?null:Sn+1;dt(w);const T=w===null?"":mi[w]??"";Qt(T),Cn(null),Zn(!0),window.requestAnimationFrame(()=>{const M=pt.current;M&&(M.selectionStart=T.length,M.selectionEnd=T.length,Ys())});return}d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),ql())}return u.jsxs("div",{className:"screen ide-screen",children:[u.jsx(rd,{title:"Pico Kodeværksted",onMenu:()=>s()}),pi?u.jsx("div",{className:"ide-size-gate",role:"dialog","aria-modal":"true","aria-labelledby":"ide-size-title",children:u.jsxs("div",{className:"ide-size-gate-panel",children:[u.jsx("h2",{id:"ide-size-title",children:"Brug en bærbar for at bruge Kodeværkstedet"}),u.jsx("p",{children:"Denne skærm er for lille, så du skal åbne Kodeværkstedet på en bærbar eller en større skærm."})]})}):u.jsxs("div",{className:"ide-layout",children:[u.jsxs("section",{className:"ide-panel ide-files-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Filer"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:Tc,"aria-label":"Ny fil",title:"Ny fil",children:u.jsx(nt,{name:"plus",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>{var d;return(d=fa.current)==null?void 0:d.click()},"aria-label":"Importer fil",title:"Importer fil",children:u.jsx(nt,{name:"upload",size:20})}),u.jsx("button",{className:"btn btn-outline ide-tool-btn",type:"button",onClick:()=>fn(),disabled:!b&&!_e||j,"aria-label":"Opdater filer",title:"Opdater filer",children:u.jsx(nt,{name:"refresh",size:20})})]})]}),u.jsx("div",{className:"ide-file-list",children:Il.length===0?u.jsx("button",{type:"button",disabled:!0,children:"Ingen filer læst"}):Il.map(d=>{if(d.kind==="separator"){const M=d.id==="pico-files"&&!b&&!_e;return u.jsxs(z.Fragment,{children:[u.jsx("div",{className:"ide-file-separator",children:u.jsx("span",{children:d.label})}),M&&u.jsx("div",{className:"ide-file-disconnected",role:"status",children:"Ikke forbundet"})]},d.id)}const h=_e&&Rl(d),w=mt[Vn(d.source,d.path)],T=w!==void 0&&w!==rv(d,pe,or);return u.jsxs("div",{className:`ide-file-row ${ee===d.path&&ve===d.source?"active":""} ${h?"protected":""}`,children:[u.jsxs("button",{type:"button",onClick:()=>ba(d),disabled:h,title:h?"Holder Bluetooth-forbindelsen i gang og kan ikke åbnes her":void 0,children:[u.jsx("span",{children:d.name}),u.jsxs("small",{title:T?"Ikke gemte ændringer":"Ingen ikke gemte ændringer",children:[d.versions.length>0&&u.jsx("em",{className:"ide-file-version-count",title:`${d.versions.length} gemte versioner i historikken`,children:d.versions.length}),u.jsx("i",{className:`ide-file-dirty-dot ${T?"dirty":"clean"}`,"aria-hidden":"true"})]})]}),u.jsx("button",{className:"ide-file-actions",type:"button",onClick:()=>jc(d),disabled:d.type!=="file"||j||h,"aria-label":`Filvalg for ${d.name}`,title:h?"Holder Bluetooth-forbindelsen i gang og kan ikke ændres her":"Filvalg",children:u.jsx(nt,{name:"settings",size:16})})]},`${d.source}:${d.path}`)})})]}),u.jsxs("section",{className:"ide-panel ide-status-panel",children:[u.jsxs("div",{children:[u.jsxs("div",{className:"ide-status-head",children:[u.jsx("h2",{children:_e?"Forbundet Pico":"USB udvikling"}),!_e&&u.jsx("span",{className:`ide-usb-status ${$t.supported?"available":"unavailable"}`,title:$t.message,"data-tooltip":$t.message,role:"img","aria-label":$t.message,tabIndex:0,children:"!"})]}),_e&&u.jsxs("p",{children:[(a==null?void 0:a.deviceName)??"Pico"," er forbundet via Bluetooth."]})]}),!_e&&u.jsxs("div",{className:"ide-actions",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:b?Rs:Vl,disabled:!$t.supported||S,children:S?"Forbinder...":b?"Afbryd USB":"Forbind USB"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:ya,disabled:_e||j,children:"Download"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:kc,disabled:!b||j,children:"Nulstil enhed"})]}),_e&&u.jsxs("div",{className:"ide-actions",children:[u.jsxs("button",{className:"btn btn-primary ide-connection-state",type:"button",disabled:!0,children:[u.jsx(nt,{name:"power",size:22}),"Bluetooth forbundet"]}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:ya,disabled:j,children:"Startprogrammer og biblioteker"})]}),!_e&&u.jsx("div",{className:"ide-runtime",children:u.jsx("div",{className:"ide-mini-actions single",children:u.jsx("button",{className:"btn btn-outline ide-disconnect-btn",type:"button",onClick:()=>wn(!0),children:"MicroPython"})})})]}),u.jsxs("section",{className:"ide-panel ide-editor-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("div",{className:"ide-editor-title",children:u.jsxs("h2",{children:[Ne(ee),u.jsxs("small",{children:[vs," bytes"]})]})}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:"btn btn-outline",type:"button",onClick:$l,disabled:j,children:"Kør"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Bc,disabled:!Dl&&!(!Tt&&On)&&(!b||!En),children:"Stop"}),u.jsx("button",{className:"btn btn-primary",type:"button",onClick:js,disabled:j||!ee.trim(),children:"Gem"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>Ls(),disabled:j||!ee.trim(),children:"Slet"})]})]}),vi(),u.jsxs("div",{className:"ide-editor-wrap",children:[u.jsx("div",{className:"ide-line-numbers","aria-hidden":"true",style:{transform:`translateY(${-di.top}px)`},children:Array.from({length:lt},(d,h)=>u.jsx("span",{children:h+1},h))}),u.jsx("pre",{className:"ide-highlight","aria-hidden":"true",style:{transform:`translate(${-di.left}px, ${-di.top}px)`},children:tv(W,yc)}),u.jsx("textarea",{ref:Ln,className:"ide-editor",value:W,onChange:d=>jn(d.target.value,d.target.selectionStart,_r(),d.target.selectionEnd,"typing"),onKeyDown:Xs,onKeyUp:d=>{["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(d.key)||Ni(d.currentTarget.value,d.currentTarget.selectionStart)},onClick:d=>{Ni(d.currentTarget.value,d.currentTarget.selectionStart),qs(d.currentTarget)},onSelect:d=>qs(d.currentTarget),onScroll:d=>{Gr({top:d.currentTarget.scrollTop,left:d.currentTarget.scrollLeft}),Ye&&Ni(d.currentTarget.value,d.currentTarget.selectionStart)},readOnly:j||!!se,"aria-busy":j||!!se,spellCheck:!1}),Ye&&u.jsx("div",{ref:pn,className:`ide-autocomplete placement-${Ye.position.placement}`,role:"listbox","aria-label":"Kodeforslag",style:{left:Ye.position.left,top:Ye.position.top,maxHeight:Ye.position.maxHeight},children:(Ye.position.placement==="above"?Ye.items.map((d,h)=>({item:d,index:h})).reverse():Ye.items.map((d,h)=>({item:d,index:h}))).map(({item:d,index:h})=>u.jsx("button",{className:h===Ye.selected?"active":"",type:"button","data-autocomplete-index":h,onMouseDown:w=>{w.preventDefault(),Bn(d)},role:"option","aria-selected":h===Ye.selected,children:d.label},d.label))}),se&&u.jsxs("div",{className:"ide-editor-loading",role:"status","aria-live":"polite",children:[u.jsx("span",{className:"spinner","aria-hidden":"true"}),u.jsxs("strong",{children:["Indlæser ",Ne(se),"..."]})]})]})]}),u.jsxs("section",{className:"ide-panel ide-terminal-panel",children:[u.jsxs("div",{className:"ide-panel-head",children:[u.jsx("h2",{children:"Terminal"}),u.jsxs("div",{className:"ide-mini-actions",children:[u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${ur?"":"active"}`,type:"button",onClick:()=>bs(d=>!d),"aria-label":ur?"Tekniske fejl er slået fra":"Tekniske fejl er slået til","aria-pressed":!ur,title:ur?"Vis originale tekniske fejl":"Viser originale tekniske fejl",children:"Teknisk"}),u.jsx("button",{className:`btn btn-outline ide-terminal-toggle ${Zt?"active":""}`,type:"button",onClick:()=>Cl(d=>!d),"aria-pressed":Zt,title:Zt?"Terminalen ryddes, hver gang du trykker Kør":"Terminalen beholder tekst, når du trykker Kør",children:"Ryd ved Kør"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Vs,disabled:V.length===0,children:"Ryd"})]})]}),u.jsxs("div",{className:"ide-terminal","aria-live":"polite",ref:kn,onScroll:ki,onClick:()=>{var d;return(d=pt.current)==null?void 0:d.focus()},children:[V.length===0?u.jsx("div",{className:"term-line",children:"Ingen terminaldata endnu."}):V.map((d,h)=>u.jsx("div",{className:`term-line ${d.variant==="input"?"term-input-echo":`term-${d.level}`}`,children:d.technical&&!ur?d.technical:d.text},`${h}-${d.text}`)),u.jsxs("form",{className:`ide-terminal-command ${Pn&&!qn?"locked":""} ${qn?"stdin":""}`,onSubmit:d=>{d.preventDefault(),ql()},children:[u.jsx("span",{"aria-hidden":"true",children:ma}),u.jsx("textarea",{ref:pt,value:ft,onChange:d=>{Qt(d.target.value),dt(null),qn?Cn(null):Ea(d.target.value,d.target.selectionStart)},onKeyDown:Ks,onKeyUp:d=>{qn||["ArrowUp","ArrowDown","Enter","Tab","Escape"].includes(d.key)||Ea(d.currentTarget.value,d.currentTarget.selectionStart)},onClick:d=>{qn||Ea(d.currentTarget.value,d.currentTarget.selectionStart)},disabled:xs,placeholder:hr,"aria-label":qn?"Input til kørende Pico-kode":"MicroPython-terminalkommando",title:hr,rows:Math.max(1,ft.split(`
`).length)})]}),tn&&u.jsx("div",{ref:Ll,className:`ide-autocomplete ide-repl-autocomplete placement-${tn.position.placement}`,role:"listbox","aria-label":"Terminalforslag",style:{left:tn.position.left,top:tn.position.top,maxHeight:tn.position.maxHeight},children:(tn.position.placement==="above"?tn.items.map((d,h)=>({item:d,index:h})).reverse():tn.items.map((d,h)=>({item:d,index:h}))).map(({item:d,index:h})=>u.jsx("button",{className:h===tn.selected?"active":"",type:"button","data-autocomplete-index":h,onMouseDown:w=>{w.preventDefault(),el(d)},role:"option","aria-selected":h===tn.selected,children:d.label},d.label))})]})]})]}),u.jsx("input",{ref:fa,type:"file",accept:".py,.txt,.json,.csv",className:"sr-only",onChange:d=>{var h;Rc((h=d.target.files)==null?void 0:h[0]),d.currentTarget.value=""}}),O&&u.jsx(Tn,{title:"Gem fil",onClose:()=>Z(!1),children:u.jsxs("div",{className:"ide-save-options",children:[u.jsx("button",{className:"btn btn-primary",type:"button",onClick:()=>void ha(),disabled:!b&&!_e||j,children:"Gem filen på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Sc,children:"Download filen til computer"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Os,children:"Gem filen i browseren"})]})}),He&&u.jsx(Tn,{title:"Startprogrammer og biblioteker",onClose:()=>Oe(!1),children:u.jsxs("div",{className:"ide-install-list",children:[u.jsx("p",{className:"ide-install-note",children:b||_e?"Vælg et startprogram og de biblioteker dit projekt bruger. Installer lægger filerne på Picoen.":"Du er ikke forbundet til en Pico. Du kan gemme filerne i browseren eller downloade dem til computeren, men de virker først på Picoen, når de er installeret der."}),u.jsxs("div",{className:"ide-install-grid",children:[xa("Startprogrammer (main.py)","Starter automatisk på Picoen.",Ae.filter(d=>d.kind==="program")),xa("Biblioteker","Ekstra Python-filer som dine programmer kan importere.",Ae.filter(d=>d.kind==="library"))]}),u.jsxs("div",{className:"ide-install-actions",children:[(b||_e)&&u.jsx("button",{className:"btn btn-primary",type:"button",onClick:Jr,disabled:j,children:"Installer på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:Lc,disabled:j,children:"Download til computer"}),u.jsx("button",{className:b||_e?"btn btn-outline":"btn btn-primary",type:"button",onClick:Cc,disabled:j,children:"Gem i browseren"})]})]})}),Hr&&u.jsx(Tn,{title:"main.py er gemt",onClose:()=>St(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:"Picoen kører stadig den gamle kode. Genstart Picoen for at anvende den nye main.py. Appen forsøger automatisk at genforbinde bagefter."}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>void Cs("control"),disabled:j,children:"Genstart og åbn kontrolpanel"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void Cs("ide"),disabled:j,children:"Genstart og bliv i Kodeværksted"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>St(!1),disabled:j,children:"Senere"})]})}),xe&&u.jsx(Tn,{title:"Installer MicroPython",onClose:()=>wn(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:"Hvis Picoen er helt frisk, skal MicroPython først lægges på den."}),u.jsxs("ol",{className:"micropython-steps",children:[u.jsx("li",{children:"Hold BOOTSEL-knappen nede."}),u.jsx("li",{children:"Sæt Picoen i USB, og slip derefter BOOTSEL."}),u.jsx("li",{children:"Vælg Pico-model og MicroPython-version herunder, og download UF2-filen."}),u.jsxs("li",{children:["Kopier UF2-filen til drevet ",u.jsx("strong",{children:"RPI-RP2"})]})]}),u.jsxs("div",{className:"micropython-selects",children:[u.jsx("label",{htmlFor:"micropython-board",children:"Pico-model"}),u.jsx("select",{id:"micropython-board",value:Dn,onChange:d=>Yt(d.target.value),children:da.map(d=>u.jsx("option",{value:d,children:d},d))}),u.jsx("label",{htmlFor:"micropython-version",children:"MicroPython-version"}),u.jsx("select",{id:"micropython-version",value:(Pt==null?void 0:Pt.version)??Yn,onChange:d=>Ur(d.target.value),children:Pr.map(d=>u.jsxs("option",{value:d.version,children:[d.version," (",d.date,")"]},`${d.board}:${d.version}:${d.date}`))})]}),Pt&&u.jsx("a",{className:"btn btn-primary btn-block",href:Pt.url,download:Pt.fileName,children:"Download UF2"}),u.jsx("a",{className:"btn btn-outline btn-block",href:"https://www.raspberrypi.com/documentation/microcontrollers/micropython.html",target:"_blank",rel:"noreferrer",children:"Se vejledning"})]})}),G&&u.jsx(Tn,{title:"Ny Python-fil",onClose:()=>re(!1),children:u.jsxs("form",{className:"ide-new-file-form",onSubmit:d=>{d.preventDefault(),Mc()},children:[u.jsx("label",{htmlFor:"new-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"new-pico-file",value:ue,onChange:d=>fe(d.target.value),autoFocus:!0,placeholder:"test"}),u.jsx("span",{children:".py"})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen tilføjer .py automatisk og opretter filen i ",vc,"."]}),u.jsx("button",{className:"btn btn-primary",type:"submit",disabled:!Qh(ue),children:"Opret"})]})}),U&&u.jsx(Tn,{title:Ne(U.path),onClose:()=>te(null),children:u.jsxs("div",{className:"ide-file-action-modal",children:[u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:"Placering"}),u.jsx("strong",{children:U.source==="pico"?"Pico":"Browser"})]}),u.jsxs("form",{className:"ide-file-rename-form",onSubmit:d=>{d.preventDefault(),Us()},children:[u.jsx("label",{htmlFor:"rename-pico-file",children:"Filnavn"}),u.jsxs("div",{className:"ide-new-file-row",children:[u.jsx("input",{id:"rename-pico-file",value:Ee,onChange:d=>N(d.target.value),placeholder:"min_kode"}),u.jsxs("span",{children:[".",ds(U.path)]})]}),u.jsxs("p",{children:["Skriv kun navnet. Appen beholder filendelsen .",ds(U.path)," automatisk."]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"submit",disabled:!Hf(Ee,ds(U.path))||Hf(Ee,ds(U.path))===U.path||j,children:"Gem navn"})]}),u.jsxs("div",{className:"ide-file-action-buttons",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void Oc(),disabled:j,children:"Dupliker"}),u.jsx("button",{className:"btn btn-outline btn-danger btn-block",type:"button",onClick:()=>Ls(U),disabled:j,children:"Slet"})]}),u.jsxs("section",{className:"ide-version-history",children:[u.jsx("h4",{children:"Versionshistorik"}),U.versions.length===0?u.jsx("p",{children:"Versionshistorik: 0 gemte versioner."}):u.jsx("div",{className:"ide-version-list",children:U.versions.map(d=>u.jsxs("div",{className:"ide-version-row",children:[u.jsx("span",{children:Ne(d.path)}),u.jsx("small",{children:d.size!==void 0?`${d.size} bytes`:"Gemt på Pico"}),u.jsx("button",{className:"btn btn-outline",type:"button",onClick:()=>void Ac(d),disabled:j,children:"Gendan"}),u.jsx("button",{className:"btn btn-outline btn-danger",type:"button",onClick:()=>ga(d),disabled:j,children:"Slet"})]},d.path))})]})]})})]})}function Qh(s){var c;const i=(c=s.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:c.replace(/\.py$/i,"").replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"");return i?`/${i}.py`:""}function $y(s){const i=s.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop(),c=i==null?void 0:i.match(/^(.+)\.(py|txt|json|csv)$/i);if(!c)return"";const a=O_(c[1]);return a?`/${a}.${c[2].toLowerCase()}`:""}function Hf(s,i="py"){const c=s.trim().replace(/\\/g,"/").split("/").filter(Boolean).pop();if(!c)return"";const a=c.match(/^(.+?)(?:\.(py|txt|json|csv))?$/i);if(!a)return"";const f=O_(a[1]),p=i.replace(/^\./,"").toLowerCase(),_=(a[2]??(p||"py")).toLowerCase();return f?`/${f}.${_}`:""}function Py(s){return Ne(s).replace(/\.(py|txt|json|csv)$/i,"")}function O_(s){return s.replace(/[^\p{L}\p{N}_-]/gu,"_").replace(/^_+|_+$/g,"")}function ds(s){var a;const i=Ne(s).match(/\.([a-z0-9]+)$/i),c=(a=i==null?void 0:i[1])==null?void 0:a.toLowerCase();return c&&["py","txt","json","csv"].includes(c)?c:"py"}function sr(s){return s.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trimEnd()}function Zh(){return na.map(s=>({...s,status:"unknown",detail:"Kan gemmes uden Pico. Forbind en Pico for at installere."}))}function Wh(s){const i={};return s.forEach(c=>{i[c.id]=!1}),i}function Ne(s){return s.split("/").filter(Boolean).pop()??s}function nc(s){return s.replace(/\\/g,"/").toLowerCase()==="/main.py"}function Jh(s){const i=s.userAgent||"",c=s.platform||"",a=s.maxTouchPoints||0,f=/Android.*Mobile|iPhone|iPod|Windows Phone|Mobile Safari/i.test(i),p=/Macintosh/i.test(c)&&a>1;return f&&!p}function qy(s){return s instanceof DOMException&&s.name==="AbortError"}function Fy(s){return/Traceback \(most recent call last\):/.test(s)||/\b(?:SyntaxError|NameError|TypeError|ValueError|IndentationError|ImportError|ModuleNotFoundError|ZeroDivisionError|IndexError|KeyError|AttributeError):/.test(s)}function Rl(s){return Xy(s)}function Xy(s){return s.path.replace(/\\/g,"/").toLowerCase()==="/bleperipheral.py"}const Kf=[...["False","None","True","and","as","assert","async","await","break","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","nonlocal","not","or","pass","raise","return","try","while","with","yield"].map(s=>({label:s,insert:`${s}${["for","if","while","def","class","elif","else","try","except","finally","with"].includes(s)?" ":""}`})),...["abs","all","any","bin","bool","bytearray","bytes","callable","chr","dict","dir","divmod","enumerate","eval","exec","filter","float","getattr","hasattr","hash","hex","id","input","int","isinstance","issubclass","iter","len","list","map","max","min","next","object","oct","open","ord","pow","print","range","repr","reversed","round","set","setattr","slice","sorted","str","sum","super","tuple","type","zip"].map(s=>({label:`${s}()`,insert:`${s}()`})),{label:"for i in range():",insert:"for i in range():"},{label:"while True:",insert:"while True:"},{label:"if True:",insert:"if True:"},{label:"time",insert:"time"},{label:"time.",insert:"time."},{label:"time.sleep",insert:"time.sleep"},{label:"time.sleep()",insert:"time.sleep()"},{label:"time.sleep_ms()",insert:"time.sleep_ms()"},{label:"time.ticks_ms()",insert:"time.ticks_ms()"},{label:"time.ticks_diff()",insert:"time.ticks_diff()"},{label:"time.sleep_us()",insert:"time.sleep_us()"},{label:"time.ticks_us()",insert:"time.ticks_us()"},{label:"machine",insert:"machine"},{label:"machine.",insert:"machine."},{label:"machine.Pin",insert:"machine.Pin"},{label:"machine.PWM",insert:"machine.PWM"},{label:"machine.ADC",insert:"machine.ADC"},{label:"machine.I2C",insert:"machine.I2C"},{label:"machine.SPI",insert:"machine.SPI"},{label:"machine.Timer",insert:"machine.Timer"},{label:"machine.UART",insert:"machine.UART"},{label:"machine.reset()",insert:"machine.reset()"},{label:"machine.freq()",insert:"machine.freq()"},{label:"Pin()",insert:"Pin()"},{label:"PWM()",insert:"PWM()"},{label:"ADC()",insert:"ADC()"},{label:"I2C()",insert:"I2C()"},{label:"SPI()",insert:"SPI()"},{label:"Timer()",insert:"Timer()"},{label:"UART()",insert:"UART()"},{label:"Pin.OUT",insert:"Pin.OUT"},{label:"Pin.IN",insert:"Pin.IN"},{label:"Pin.PULL_UP",insert:"Pin.PULL_UP"},{label:"Pin.PULL_DOWN",insert:"Pin.PULL_DOWN"},{label:"Pin.IRQ_FALLING",insert:"Pin.IRQ_FALLING"},{label:"Pin.IRQ_RISING",insert:"Pin.IRQ_RISING"},{label:"import time",insert:"import time"},{label:"import utime as time",insert:"import utime as time"},{label:"import machine",insert:"import machine"},{label:"import random",insert:"import random"},{label:"import os",insert:"import os"},{label:"import sys",insert:"import sys"},{label:"from machine import Pin",insert:"from machine import Pin"},{label:"from machine import Pin, PWM",insert:"from machine import Pin, PWM"},{label:"from machine import Pin, PWM, ADC",insert:"from machine import Pin, PWM, ADC"},{label:"BLEPeripheral",insert:"BLEPeripheral"},{label:"PicoRobotics",insert:"PicoRobotics"},{label:"NeoPixel",insert:"NeoPixel"},{label:"HCSR04",insert:"HCSR04"},{label:"ble.send_toggle_state()",insert:"ble.send_toggle_state()"},{label:"ble.send_radar()",insert:"ble.send_radar()"},{label:"ble.send_text()",insert:"ble.send_text()"},{label:"on_button(name, is_down):",insert:"on_button(name, is_down):"},{label:"on_slider(name, value):",insert:"on_slider(name, value):"},{label:"on_toggle(name, value):",insert:"on_toggle(name, value):"},{label:"on_connect():",insert:"on_connect():"},{label:"on_disconnect():",insert:"on_disconnect():"},{label:"ValueError",insert:"ValueError"},{label:"TypeError",insert:"TypeError"},{label:"OSError",insert:"OSError"},{label:"Exception",insert:"Exception"}];function e_(s,i,c){const a=Qf(s,i);if(!a)return[];const f=Ky(s,a.start,i),p=a.query.toLowerCase(),_=f.beforeToken.toLowerCase(),y=f.linePrefix.toLowerCase(),E=c?[...Kf,...Zy(s)]:Kf;return Wy(E).filter(b=>{const v=b.label.toLowerCase(),S=b.insert.toLowerCase();return S===p||v===p||C_(b,a.query)?!1:f.importLine?Qy(b,f)?v.startsWith(y)||S.startsWith(y)||v.startsWith(p)||S.startsWith(p):!1:_.endsWith(".")&&!S.includes(".")?!1:!!(S.startsWith(p)||v.startsWith(p))})}function Ky(s,i,c){const a=s.lastIndexOf(`
`,i-1)+1,f=s.slice(a,c),p=s.slice(a,i),_=/^\s*(?:import|from)\s+[\w.,\s]*$/i.test(f),y=/^\s*from\s+\w+(?:\.\w+)*\s+import\s+/i.test(f);return{linePrefix:f,beforeToken:p,importLine:_,fromImportLine:y}}function Qy(s,i){return i.fromImportLine?!s.insert.includes("(")&&!s.insert.startsWith("import "):s.insert.startsWith("import ")||s.insert.startsWith("from ")?!0:/^[A-Za-z_][A-Za-z0-9_]*$/.test(s.insert)}function Zy(s){const i=new Set,c=[/\bdef\s+([A-Za-z_][A-Za-z0-9_]*)\s*\(/g,/\bclass\s+([A-Za-z_][A-Za-z0-9_]*)\b/g,/(?:^|[^\w.])([A-Za-z_][A-Za-z0-9_]*)\s*=/g,/\bfor\s+([A-Za-z_][A-Za-z0-9_]*)\s+in\b/g,/\b([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z_][A-Za-z0-9_]*)\s*\(/g];for(const a of c)for(const f of s.matchAll(a))f[1]&&i.add(f[1]),f[2]&&i.add(f[2]);return[...i].filter(a=>a.length>1&&!Jy.has(a)).sort((a,f)=>a.localeCompare(f,"da")).map(a=>({label:a,insert:a}))}function Wy(s){const i=new Set,c=[];for(const a of s){const f=a.insert.toLowerCase();i.has(f)||(i.add(f),c.push(a))}return c}const Jy=new Set(Kf.map(s=>s.insert.replace(/[().: ]+$/g,"")));function Qf(s,i){const a=s.slice(0,i).match(/[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_.]*$/);return!a||a.index===void 0?null:{query:a[0],start:a.index}}function n_(s,i){const c=s.lastIndexOf(`
`,Math.max(0,i-1))+1;let a=null,f=null,p=!1;for(let _=0;_<i;_+=1){const y=s[_],E=s.slice(_,_+3);if(f){E===f.repeat(3)&&(f=null,_+=2);continue}if(a){if(p){p=!1;continue}if(y==="\\"){p=!0;continue}y===a&&(a=null),y===`
`&&(a=null);continue}if(y==="#"){const x=s.indexOf(`
`,_),b=x===-1?s.length:x;if(i<=b&&_>=c)return!0;_=b;continue}if(E==='"""'||E==="'''"){f=y,_+=2;continue}(y==='"'||y==="'")&&(a=y)}return a!==null||f!==null}function C_(s,i){const c=s.insert.trim();return!/[().]/.test(c)&&c.toLowerCase()===i.toLowerCase()}function ev(s){return/^[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_]*$/.test(s)}function t_(s,i,c){if(!s)return null;const a=s.closest(".ide-terminal")??s.parentElement;if(!a)return null;const f=window.getComputedStyle(s),p=document.createElement("div"),_=document.createElement("span"),y=a.getBoundingClientRect(),E=s.getBoundingClientRect();p.style.position="absolute",p.style.visibility="hidden",p.style.pointerEvents="none",p.style.whiteSpace="pre-wrap",p.style.overflowWrap="break-word",p.style.wordBreak=f.wordBreak,p.style.boxSizing=f.boxSizing,p.style.width=`${s.getBoundingClientRect().width}px`,p.style.padding=f.padding,p.style.border=f.border,p.style.font=f.font,p.style.lineHeight=f.lineHeight,p.style.letterSpacing=f.letterSpacing,p.style.tabSize=f.tabSize,p.style.fontVariantLigatures=f.fontVariantLigatures,p.style.scrollbarGutter=f.scrollbarGutter,p.style.left=`${E.left-y.left-s.scrollLeft}px`,p.style.top=`${E.top-y.top-s.scrollTop}px`,p.textContent=s.value.slice(0,i),_.textContent=s.value.slice(i,i+1)||" ",p.appendChild(_),a.appendChild(p);const x=_.getBoundingClientRect();p.remove();const b=34,v=14,S=Math.min(210,Math.max(b+v,c*b+v)),I=nv(x.left-y.left,8,Math.max(8,a.clientWidth-296)),V=x.top-y.top+a.scrollTop,q=x.bottom-y.top+a.scrollTop+10,j=a.scrollTop+a.clientHeight-q-8,L=V-a.scrollTop-8,H=a.scrollTop+a.clientHeight,ie=j>=Math.min(S,b*2)||j>=L?"below":"above",se=Math.max(b+v,Math.min(S,ie==="below"?j:L)),oe=ie==="below"?Math.min(q,H-se-8):Math.max(a.scrollTop+8,V-se-8);return{left:I,top:oe,maxHeight:se,placement:ie}}function nv(s,i,c){return Math.max(i,Math.min(c,s))}function tv(s,i=""){const c=/\b(False|None|True|and|as|assert|async|await|break|class|continue|def|del|elif|else|except|finally|for|from|global|if|import|in|is|lambda|nonlocal|not|or|pass|raise|return|try|while|with|yield)\b/g,a=/(#.*$|"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|\b\d+(?:\.\d+)?\b|\b(?:print|range|len|str|int|float|bool|list|dict|set|tuple|sum|min|max|abs|round)\b)/gm,f=[];return s.split(/(\r?\n)/).forEach((p,_)=>{if(p===`
`||p===`\r
`){f.push(u.jsx("br",{},`br-${_}`));return}let y=0;[...p.matchAll(a)].forEach((x,b)=>{const v=x.index??0;v>y&&f.push(...r_(p.slice(y,v),c,`${_}-${b}-plain`,i));const S=x[0],I=S.startsWith("#")?"tok-comment":S.startsWith('"')||S.startsWith("'")?"tok-string":/^\d/.test(S)?"tok-number":"tok-builtin";f.push(...ac(S,i,`${_}-${b}-token`,I)),y=v+S.length}),y<p.length&&f.push(...r_(p.slice(y),c,`${_}-tail`,i))}),f.length?f:" "}function r_(s,i,c,a=""){const f=[];let p=0;const _=new RegExp(i.source,"g");return[...s.matchAll(_)].forEach((y,E)=>{const x=y.index??0;x>p&&f.push(...ac(s.slice(p,x),a,`${c}-${E}-plain`)),f.push(...ac(y[0],a,`${c}-${E}-keyword`,"tok-keyword")),p=x+y[0].length}),p<s.length&&f.push(...ac(s.slice(p),a,`${c}-plain-end`)),f}function ac(s,i,c,a=""){if(!i)return[u.jsx("span",{className:a||void 0,children:s},c)];const f=[],p=i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),_=new RegExp(`(?<![A-Za-zÆØÅæøå0-9_])(${p})(?![A-Za-zÆØÅæøå0-9_])`,"g");let y=0;return[...s.matchAll(_)].forEach((E,x)=>{const b=E.index??0;b>y&&f.push(u.jsx("span",{className:a||void 0,children:s.slice(y,b)},`${c}-${x}-before`)),f.push(u.jsx("span",{className:`${a} tok-match`.trim(),children:E[0]},`${c}-${x}-match`)),y=b+E[0].length}),y<s.length&&f.push(u.jsx("span",{className:a||void 0,children:s.slice(y)},`${c}-after`)),f.length?f:[u.jsx("span",{className:a||void 0,children:s},c)]}function tc(s){return s.length>0?s:[{path:Xf,content:A_,uploaded:!1,updatedAt:Date.now()}]}function Gf(s,i,c,a){const f=s.filter(p=>p.path!==i);return[{path:i,content:c,uploaded:a,updatedAt:Date.now()},...f].sort((p,_)=>_.updatedAt-p.updatedAt)}function sc(s){return s.map(i=>({name:Ne(i.path),path:i.path,type:"file",size:new Blob([i.content]).size}))}function rv(s,i,c){var a;return s.source==="pico"?c[s.path]:(a=i.find(f=>f.path===s.path))==null?void 0:a.content}function oc(s){const i=s.replace(/\\/g,"/"),c=i.lastIndexOf("/"),a=c>=0?i.slice(0,c+1):"",p=(c>=0?i.slice(c+1):i).match(/^(.+)_backup(\d+)(\.[^.]+)$/i);return p?{originalPath:`${a}${p[1]}${p[3]}`,index:parseInt(p[2],10)}:null}function Tl(s){return oc(s)!==null}function ta(s){const i=new Map;for(const c of s){const a=oc(c.path);if(!a)continue;const f=i.get(a.originalPath)??[];f.push(c),i.set(a.originalPath,f)}for(const c of i.values())c.sort((a,f)=>{var p,_;return(((p=oc(f.path))==null?void 0:p.index)??0)-(((_=oc(a.path))==null?void 0:_.index)??0)});return i}function l_(s,i){const c=s.replace(/\\/g,"/"),a=c.lastIndexOf("/"),f=a>=0?c.slice(0,a+1):"/",p=a>=0?c.slice(a+1):c.replace(/^\/+/,""),_=p.lastIndexOf("."),y=_>0?p.slice(0,_):p,E=_>0?p.slice(_):"",x=new Set(i.map(b=>b.path.toLowerCase()));for(let b=1;b<1e3;b+=1){const v=`${f}${y}_backup${b}${E}`;if(!x.has(v.toLowerCase()))return v}return`${f}${y}_backup${Date.now()}${E}`}function lv(s,i){const c=s.replace(/\\/g,"/"),a=c.lastIndexOf("/"),f=a>=0?c.slice(0,a+1):"/",p=a>=0?c.slice(a+1):c.replace(/^\/+/,""),_=p.lastIndexOf("."),y=_>0?p.slice(0,_):p,E=_>0?p.slice(_):"";for(let x=1;x<1e3;x+=1){const b=x===1?"_kopi":`_kopi${x}`,v=`${f}${y}${b}${E}`;if(!i(v)&&!Tl(v))return v}return`${f}${y}_kopi${Date.now()}${E}`}function iv(s){return s==="ok"?"Nyeste":s==="outdated"?"Opdater":s==="missing"?"Mangler":"Ikke tjekket"}function av(s,i,c,a){const f=new Map,p=ta(s),_=ta(sc(i));for(const v of s)Tl(v.path)||f.set(Vn("pico",v.path),{kind:"file",name:v.name,path:v.path,type:v.type,size:v.size,source:"pico",uploaded:!0,versions:p.get(v.path)??[]});for(const v of i)Tl(v.path)||f.set(Vn("local",v.path),{kind:"file",name:Ne(v.path),path:v.path,type:"file",source:"local",uploaded:!1,versions:_.get(v.path)??[]});for(const v of Object.keys(c)){const[S,...I]=v.split(":"),V=I.join(":");if(S!=="local"&&S!=="pico"||!V)continue;const q=f.get(v);if(q){f.set(v,q);continue}f.set(v,{kind:"file",name:Ne(V),path:V,type:"file",source:S,uploaded:!1,versions:S==="pico"?p.get(V)??[]:_.get(V)??[]})}const y=[...f.values()].sort(ov),E=y.filter(v=>v.source==="pico"),x=y.filter(v=>v.source==="local"),b=[];return E.length>0||a?b.push({kind:"separator",id:"pico-files",label:a?"Pico":"Microcontroller"},...E):b.push({kind:"separator",id:"pico-files",label:"Microcontroller"}),x.length>0&&b.push({kind:"separator",id:"browser-files",label:"Browser"},...x),b}const sv=new Map([["main.py",0],["devicesettings.txt",1],["layout.txt",2],["bleperipheral.py",3],["picofly.py",4],["picorobotics.py",5],["neopixel.py",6],["hcsr04.py",7]]);function ov(s,i){const c=i_(s.path),a=i_(i.path);return c===null&&a===null?s.name.localeCompare(i.name,"da"):c===null?-1:a===null?1:c-a}function i_(s){var c;const i=(c=s.replace(/\\/g,"/").split("/").filter(Boolean).pop())==null?void 0:c.toLowerCase();return i?sv.get(i)??null:null}function a_(s,i,c){if(!(i in s))return s;const a={...s,[c]:s[i]};return delete a[i],a}function cv(s,i,c,a){const f=`${i}:${c}`;if(!(f in s))return s;const p={...s,[`${i}:${a}`]:s[f]};return delete p[f],p}function uv({open:s}){const i=ae(H=>H.screen),c=ae(H=>H.active),a=ae(H=>H.toggleSideMenu),f=ae(H=>H.toggleDebugger),p=ae(H=>H.setEditMode),_=ae(H=>H.openMenuPage),y=ae(H=>H.disconnect),E=ae(H=>H.openPicoIde),x=ae(H=>H.closePicoIde),b=ae(H=>H.picoIdeOrigin),v=i==="dashboard",S=i==="control",I=i==="ide",V=S&&!!(c!=null&&c.canEdit),q=!S||!!(c!=null&&c.isOwnedByMe)||!!(c!=null&&c.canEditCode),j=b==="control",L=b==="control"?"Kontrol Panel":"Hovedmenu";return u.jsxs(u.Fragment,{children:[u.jsx("div",{className:`scrim ${s?"open":"closing"}`,onClick:()=>a(!1)}),u.jsxs("nav",{className:`sidemenu sidemenu-${i} ${s?"open":"closing"}`,"aria-label":"Sidemenu",children:[v&&u.jsxs(u.Fragment,{children:[u.jsx(wt,{label:"Bruger",icon:"user",onClick:()=>_("user-settings")}),u.jsx(wt,{label:"Indstillinger",icon:"settings",onClick:()=>_("application-settings")}),u.jsx(wt,{label:"Kodeværksted",icon:"picoIde",onClick:E,disabled:!q}),u.jsx(If,{}),u.jsx(wt,{label:"Om appen",icon:"info",onClick:()=>_("application-about")}),u.jsx(wt,{label:"Hjælp",icon:"help",onClick:()=>_("application-help")}),u.jsx(wt,{label:"Fejlfinding",icon:"debugger",onClick:()=>f(!0)})]}),S&&u.jsxs(u.Fragment,{children:[u.jsx(wt,{label:"Indstillinger",icon:"settings",onClick:()=>_("device-settings")}),u.jsx(wt,{label:"Rediger",icon:"edit",onClick:()=>p(!0),disabled:!V}),u.jsx(wt,{label:"Kodeværksted",icon:"picoIde",onClick:E,disabled:!q}),u.jsx(If,{}),u.jsx(wt,{label:"Hjælp",icon:"help",onClick:()=>_("device-help")}),u.jsx(wt,{label:"Fejlfinding",icon:"debugger",onClick:()=>f(!0)})]}),I&&u.jsxs(u.Fragment,{children:[u.jsx(wt,{label:L,icon:"back",onClick:x}),u.jsx(If,{})]}),u.jsx("div",{className:"spacer"}),(S||I&&j)&&u.jsx(wt,{label:"Forlad",icon:"exit",onClick:()=>y()})]})]})}function wt({label:s,icon:i,disabled:c,onClick:a}){return u.jsxs("button",{className:"iconbtn",type:"button",onClick:a,disabled:c,"aria-label":s,children:[u.jsx(nt,{name:i}),u.jsx("span",{children:s})]})}function If(){return u.jsxs("a",{className:"iconbtn sidemenu-link",href:"https://www.teknologiskolen.dk/",target:"_blank",rel:"noreferrer","aria-label":"Teknologiskolen",children:[u.jsx("img",{src:Jb,alt:""}),u.jsx("span",{children:"Teknologiskolen"})]})}const fv={error:"term-error",success:"term-success",warning:"term-warning",info:""},s_={error:"[FEJL] ",success:"[SUCCES] ",warning:"[ADVARSEL] ",info:""};function dv(){const s=new Date,i=c=>String(c).padStart(2,"0");return`${i(s.getDate())}-${i(s.getMonth()+1)}-${s.getFullYear()}-${i(s.getHours())}-${i(s.getMinutes())}`}function mv(){const s=ae(f=>f.logs),i=ae(f=>f.clearLogs),c=ae(f=>f.toggleDebugger);function a(){const f=[...s].reverse().map(E=>`${E.time} ${s_[E.level]}${E.message}`).join(`
`),p=new Blob([f],{type:"text/plain"}),_=URL.createObjectURL(p),y=document.createElement("a");y.href=_,y.download=`${dv()}.txt`,y.click(),URL.revokeObjectURL(_)}return u.jsxs(Tn,{title:"Fejlfinding",onClose:()=>c(!1),closeVariant:"circle",children:[u.jsx("div",{className:"terminal",children:s.length===0?u.jsx("div",{className:"term-line",children:"Ingen log endnu."}):s.map((f,p)=>u.jsxs("div",{className:`term-line ${fv[f.level]}`,children:[f.time," ",s_[f.level],f.message]},`${f.time}-${p}`))}),u.jsxs("div",{className:"row",style:{marginTop:14},children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:i,children:"Ryd"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:a,children:"Gem logfil"})]})]})}const L_=4,Vt=L_*4+17,o_=80,pv=20,hv=30660;function _v(s){const i=new TextEncoder().encode(s);if(i.length>76)throw new Error("QR-koden er for lang.");const c=c_(!1),a=c_(!1);gv(c,a);const f=yv(i),p=wv(f,pv);return vv(c,a,[...f,...p]),xv(c,a),c}function c_(s){return Array.from({length:Vt},()=>Array.from({length:Vt},()=>s))}function It(s,i,c,a,f,p=!0){s[a][c]=f,p&&(i[a][c]=!0)}function gv(s,i){Vf(s,i,0,0),Vf(s,i,Vt-7,0),Vf(s,i,0,Vt-7);for(let c=0;c<Vt;c+=1)i[6][c]||It(s,i,c,6,c%2===0),i[c][6]||It(s,i,6,c,c%2===0);bv(s,i,26,26),It(s,i,8,L_*4+9,!0)}function Vf(s,i,c,a){for(let f=-1;f<=7;f+=1)for(let p=-1;p<=7;p+=1){const _=c+p,y=a+f;if(_<0||y<0||_>=Vt||y>=Vt)continue;const E=p>=0&&p<=6&&f>=0&&f<=6&&(p===0||p===6||f===0||f===6||p>=2&&p<=4&&f>=2&&f<=4);It(s,i,_,y,E)}}function bv(s,i,c,a){for(let f=-2;f<=2;f+=1)for(let p=-2;p<=2;p+=1)i[a+f][c+p]||It(s,i,c+p,a+f,Math.max(Math.abs(p),Math.abs(f))!==1)}function yv(s){const i=[];rc(i,4,4),rc(i,s.length,8);for(const a of s)rc(i,a,8);for(rc(i,0,Math.min(4,o_*8-i.length));i.length%8!==0;)i.push(0);const c=[];for(let a=0;a<i.length;a+=8)c.push(i.slice(a,a+8).reduce((f,p)=>f<<1|p,0));for(let a=236;c.length<o_;a=a===236?17:236)c.push(a);return c}function rc(s,i,c){for(let a=c-1;a>=0;a-=1)s.push(i>>>a&1)}function vv(s,i,c){const a=c.flatMap(_=>Array.from({length:8},(y,E)=>_>>>7-E&1));let f=0,p=!0;for(let _=Vt-1;_>=1;_-=2){_===6&&(_-=1);for(let y=0;y<Vt;y+=1){const E=p?Vt-1-y:y;for(let x=0;x<2;x+=1){const b=_-x;if(i[E][b])continue;const v=f<a.length?a[f]===1:!1;s[E][b]=v!==((b+E)%2===0),f+=1}}p=!p}}function xv(s,i){const c=a=>(hv>>>a&1)!==0;for(let a=0;a<=5;a+=1)It(s,i,8,a,c(a));It(s,i,8,7,c(6)),It(s,i,8,8,c(7)),It(s,i,7,8,c(8));for(let a=9;a<15;a+=1)It(s,i,14-a,8,c(a));for(let a=0;a<8;a+=1)It(s,i,Vt-1-a,8,c(a));for(let a=8;a<15;a+=1)It(s,i,8,Vt-15+a,c(a))}const hs=new Array(512),Zf=new Array(256);let u_=!1;function B_(){if(u_)return;let s=1;for(let i=0;i<255;i+=1)hs[i]=s,Zf[s]=i,s<<=1,s&256&&(s^=285);for(let i=255;i<512;i+=1)hs[i]=hs[i-255];u_=!0}function z_(s,i){return s===0||i===0?0:hs[Zf[s]+Zf[i]]}function wv(s,i){B_();const c=Ev(i),a=Array.from({length:i},()=>0);for(const f of s){const p=f^a.shift();a.push(0);for(let _=0;_<i;_+=1)a[_]^=z_(c[_],p)}return a}function Ev(s){B_();let i=[1];for(let c=0;c<s;c+=1){const a=Array.from({length:i.length+1},()=>0);for(let f=0;f<i.length;f+=1)a[f]^=z_(i[f],hs[c]),a[f+1]^=i[f];i=a}return i.slice(1)}function Sv(){const s=ae(xe=>xe.menuPage),i=ae(xe=>xe.closeMenuPage),c=ae(xe=>xe.user),a=ae(xe=>xe.active),f=ae(xe=>xe.layout),p=ae(xe=>xe.sliderValues),_=ae(xe=>xe.savedDevices),y=ae(xe=>xe.updateUsername),E=ae(xe=>xe.createOwnerPairingCode),x=ae(xe=>xe.applyOwnerPairingCode),b=ae(xe=>xe.clearSavedDevices),v=ae(xe=>xe.resetApplicationData),S=ae(xe=>xe.saveDeviceSettings),I=ae(xe=>xe.setEditMode),V=ae(xe=>xe.askConfirm),[q,j]=z.useState((c==null?void 0:c.username)??""),[L,H]=z.useState(!1),[ie,se]=z.useState(""),[oe,pe]=z.useState(""),[J,ee]=z.useState(!1),[Re,ve]=z.useState(""),we=z.useRef(null),[W,Pe]=z.useState((a==null?void 0:a.iconID)??0),[Ae,qe]=z.useState(!1),[G,re]=z.useState((a==null?void 0:a.canOthersConnect)??!1),[ue,fe]=z.useState((a==null?void 0:a.canOthersEdit)??!1),[Ee,N]=z.useState((a==null?void 0:a.canOthersEditCode)??!1),[U,te]=z.useState((a==null?void 0:a.gridCols)??11),[O,Z]=z.useState((a==null?void 0:a.gridRows)??31),[ne,X]=z.useState(!1);z.useEffect(()=>{s==="user-settings"&&(j((c==null?void 0:c.username)??""),pe(""),ve(""),ee(!1))},[s,c==null?void 0:c.username]),z.useEffect(()=>{s==="device-settings"&&a&&(Pe(a.iconID),re(a.canOthersConnect),fe(a.canOthersEdit),N(a.canOthersEditCode),te(a.gridCols),Z(a.gridRows))},[a,s]),z.useEffect(()=>{if(!J)return;let xe=!1,wn=null,Mn=0;async function ze(){var Yt;const Dn=window.BarcodeDetector;if(!Dn||!((Yt=navigator.mediaDevices)!=null&&Yt.getUserMedia)){ve("Denne browser kan ikke scanne QR-koder. Skriv ejerkoden i stedet."),ee(!1);return}try{wn=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const Yn=we.current;if(!Yn)return;Yn.srcObject=wn,await Yn.play();const Ur=new Dn({formats:["qr_code"]}),Hr=async()=>{var St;if(!xe){try{const Gr=(St=(await Ur.detect(Yn)).find(En=>En.rawValue))==null?void 0:St.rawValue;if(Gr){pe(Gr),x(Gr)&&H(!1),ee(!1);return}}catch{}Mn=window.requestAnimationFrame(Hr)}};Mn=window.requestAnimationFrame(Hr)}catch{ve("Kameraet kunne ikke åbnes. Skriv ejerkoden i stedet."),ee(!1)}}return ze(),()=>{xe=!0,Mn&&window.cancelAnimationFrame(Mn),wn==null||wn.getTracks().forEach(Dn=>Dn.stop())}},[x,J]);const He=(xe,wn)=>Number.isFinite(xe)?Math.max(la,Math.min(ia,Math.round(xe))):wn,Oe=(c==null?void 0:c.username)??"",Qn=q.trim(),Kt=Qn.length>0&&Qn!==Oe;if(!s)return null;if(s==="user-settings"){let xe=function(){const ze=E();ze&&(se(ze),pe(""),H(!0))},wn=function(){x(oe)&&(pe(""),H(!1))};async function Mn(){var ze;try{await((ze=navigator.clipboard)==null?void 0:ze.writeText(ie))}catch{}}return u.jsxs(u.Fragment,{children:[u.jsx(Tn,{title:"Brugerindstillinger",onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Gt,{label:"GUID",value:(c==null?void 0:c.userID)??"Ukendt"}),u.jsxs("div",{className:`field ${q.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-username",value:q,onChange:ze=>j(ze.target.value),maxLength:24,autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-username",children:"Brugernavn"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>y(q),disabled:!Kt,children:"Gem nyt brugernavn"}),u.jsx("div",{className:"notice",children:"Ejerkode bruges, hvis den samme person skal forbinde fra flere browsere eller telefoner."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:xe,children:"Ejerkode"}),u.jsx("button",{className:"btn btn-outline btn-block btn-danger",type:"button",onClick:()=>V({title:"Start forfra",message:"Vil du slette brugeroplysninger og gemte enheder fra denne browser? Siden genindlæses bagefter.",confirmLabel:"Slet alt",onConfirm:()=>{v()}}),children:"Slet brugerdata"})]})}),L&&u.jsx(Tn,{title:"Del ejerkode",onClose:()=>H(!1),children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Rv,{code:ie}),u.jsx("code",{className:"owner-code-text",children:ie}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>void Mn(),children:"Kopiér ejerkode"}),u.jsxs("div",{className:`field ${oe.trim()?"filled":""}`,children:[u.jsx("input",{id:"settings-owner-code",value:oe,onChange:ze=>pe(ze.target.value),autoComplete:"off",placeholder:""}),u.jsx("label",{htmlFor:"settings-owner-code",children:"Skriv ejerkode"})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:wn,disabled:!oe.trim(),children:"Brug ejerkode i denne browser"}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>ee(ze=>!ze),children:J?"Stop scanning":"Scan QR-kode"}),Re&&u.jsx("div",{className:"notice",children:Re}),J&&u.jsx("video",{className:"owner-code-video",ref:we,muted:!0,playsInline:!0})]})})]})}if(s==="application-settings")return u.jsx(Tn,{title:"Applikationsindstillinger",onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Gt,{label:"Version",value:_s}),u.jsx(Gt,{label:"Bluetooth",value:_c()?"Tilgængelig":"Ikke tilgængelig"}),u.jsx(Gt,{label:"Gemte enheder",value:String(_.length)}),u.jsx("div",{className:"notice",children:"Bluetooth-tilladelser styres af browseren. Hvis du vil glemme en parret Pico helt, skal du fjerne tilladelsen i browserens site- eller Bluetooth-indstillinger."}),u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:()=>V({title:"Ryd gemte enheder",message:"Vil du fjerne alle gemte enheder fra denne browser?",confirmLabel:"Ryd",onConfirm:b}),disabled:_.length===0,children:"Ryd gemte enheder"})]})});if(s==="application-about")return u.jsx(Tn,{title:"Om appen",onClose:i,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Pico Kontrol Panel er lavet til at bygge og fjernstyre sjove eller seje Raspberry Pi Pico W-projekter."}),u.jsx(Gt,{label:"Udvikler",value:"Christian Bröchner Rasmussen"}),u.jsx(Gt,{label:"Version",value:_s})]})});if(s==="application-help")return u.jsx(Tn,{title:"Hjælp til applikationen",onClose:i,children:u.jsxs("div",{className:"settings-stack prose help-lesson",children:[u.jsxs("div",{className:"help-lesson-card",children:[u.jsx("strong",{children:"Komplet undervisningsforløb"}),u.jsx("p",{children:"Linket åbner Teknologiskolens guide til Pico Kontrol Panel. Her kan du lære hele arbejdsgangen: browseropsætning, Kodeværkstedet, MicroPython, USB-installation, Bluetooth-forbindelse, kontrolpaneler og trådløs kodeudvikling."})]}),u.jsxs("div",{className:"help-lesson-list","aria-label":"Undervisningsforløbet indeholder",children:[u.jsx("span",{children:"Trin-for-trin opsætning"}),u.jsx("span",{children:"Øvelser til kode og kontrolpanel"}),u.jsx("span",{children:"Projektforslag med Pico W"})]}),u.jsx("p",{className:"help-lesson-destination",children:"Du sendes til materialer.teknologiskolen.dk i en ny fane."}),u.jsx("a",{className:"btn btn-primary btn-block",href:"https://materialer.teknologiskolen.dk/lessons/fjernstyring-af-raspberry-pi-pico-w",target:"_blank",rel:"noreferrer",children:"Åbn komplet undervisningsforløb"})]})});if(s==="device-settings"){const xe=f.filter(ze=>ze.type==="slider"),wn=!!(a!=null&&a.isOwnedByMe);async function Mn(ze=!1){if(!a||!wn)return;const Dn=He(U,a.gridCols),Yt=He(O,a.gridRows),Yn=kv(f,Dn,Yt);if(Yn&&!ze){V({title:"Gitter kan påvirke layout",message:`Det nuværende layout bruger op til ${Yn.requiredCols} kolonner og ${Yn.requiredRows} rækker. Det nye gitter er ${Dn} × ${Yt}, så nogle kontroller kan ende udenfor eller skulle flyttes i redigering.`,confirmLabel:"Gem alligevel",onConfirm:()=>{Mn(!0)}});return}X(!0),await S(W,G,G&&ue,G&&Ee,Dn,Yt),te(Dn),Z(Yt),X(!1)}return u.jsx(Tn,{title:"Enhedsindstillinger",onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx(Gt,{label:"Navn",value:(a==null?void 0:a.deviceName)??"Ukendt"}),u.jsx(Gt,{label:"Ejer",value:Tv(a)}),wn?u.jsxs(u.Fragment,{children:[u.jsx("button",{className:"device-icon-pick settings-icon-pick",type:"button",onClick:()=>qe(!0),children:u.jsx("img",{src:ca(W),alt:""})}),u.jsx("p",{className:"prompt",children:"Må andre forbinde til- og bruge denne enhed?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:G?"":"active",onClick:()=>re(!1),children:"Privat"}),u.jsx("button",{type:"button",className:G?"active":"",onClick:()=>re(!0),children:"Offentlig"})]}),G&&u.jsxs(u.Fragment,{children:[u.jsx("p",{className:"prompt",children:"Må andre redigere layoutet?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:ue?"":"active",onClick:()=>fe(!1),children:"Nej"}),u.jsx("button",{type:"button",className:ue?"active":"",onClick:()=>fe(!0),children:"Ja"})]}),u.jsx("p",{className:"prompt",children:"Må andre redigere koden?"}),u.jsxs("div",{className:"segmented",children:[u.jsx("button",{type:"button",className:Ee?"":"active",onClick:()=>N(!1),children:"Nej"}),u.jsx("button",{type:"button",className:Ee?"active":"",onClick:()=>N(!0),children:"Ja"})]})]}),u.jsx("p",{className:"prompt",children:"Kontrolpanelets gitter"}),u.jsxs("div",{className:"row",children:[u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-cols",children:"Kolonner"}),u.jsx("input",{id:"device-cols",type:"number",min:la,max:ia,value:Number.isNaN(U)?"":U,onChange:ze=>te(parseInt(ze.target.value,10)),onBlur:()=>te(He(U,(a==null?void 0:a.gridCols)??11))})]}),u.jsxs("div",{className:"grid-field",children:[u.jsx("label",{htmlFor:"device-rows",children:"Rækker"}),u.jsx("input",{id:"device-rows",type:"number",min:la,max:ia,value:Number.isNaN(O)?"":O,onChange:ze=>Z(parseInt(ze.target.value,10)),onBlur:()=>Z(He(O,(a==null?void 0:a.gridRows)??31))})]})]}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>Mn(),disabled:ne,children:ne?"Gemmer...":"Gem enhedsindstillinger"})]}):u.jsxs(u.Fragment,{children:[u.jsx(Gt,{label:"Ikon ID",value:String((a==null?void 0:a.iconID)??0)}),u.jsx(Gt,{label:"Redigering",value:a!=null&&a.canEdit?"Tilladt":"Ikke tilladt"}),u.jsx(Gt,{label:"Gitter",value:`${(a==null?void 0:a.gridCols)??0} × ${(a==null?void 0:a.gridRows)??0}`})]}),u.jsx(Gt,{label:"Kontroller",value:String(f.length)}),xe.length>0&&u.jsxs("div",{className:"settings-section",children:[u.jsx("h4",{children:"Slidere"}),xe.map(ze=>u.jsxs("div",{className:"slider-meta",children:[u.jsx("strong",{children:ze.name}),u.jsxs("span",{children:[ze.sliderMin??0," til ",ze.sliderMax??100]}),u.jsxs("span",{children:["Retur: ",Nv(ze.sliderRecenter??"none")]}),u.jsxs("span",{children:["Seneste værdi: ",p[ze.name]??"Ikke brugt"]})]},ze.name))]}),Ae&&u.jsx(y_,{selected:W,onSelect:Pe,onClose:()=>qe(!1)})]})})}return u.jsx(Tn,{title:"Hjælp til enheden",onClose:i,children:u.jsxs("div",{className:"settings-stack prose",children:[u.jsx("p",{children:"Knapper sender en kommando med deres navn, når de trykkes."}),u.jsx("p",{children:"Slidere sender værdien fra den firmware-definerede skala. Appen ændrer kun placering og størrelse."}),u.jsx("p",{children:"Hvis redigering er tilladt, kan du åbne redigering fra menuen og gemme layoutet tilbage på Picoen."}),(a==null?void 0:a.canEdit)&&u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>I(!0),children:"Rediger layout"})]})})}function kv(s,i,c){let a=0,f=0;for(const p of s)aa(p)&&(a=Math.max(a,Math.ceil((p.centerX2+p.spanX)/2)+1),f=Math.max(f,Math.ceil((p.centerY2+p.spanY)/2)+1));return i<a||c<f?{requiredCols:a,requiredRows:f}:null}function Nv(s){return s==="bottom"?"bund":s==="middle"?"midte":s==="top"?"top":"ingen"}function Rv({code:s}){const i=z.useMemo(()=>_v(s),[s]),c=i.length;return u.jsxs("svg",{className:"owner-code-qr",viewBox:`0 0 ${c+8} ${c+8}`,role:"img","aria-label":"QR-kode til ejerkode",children:[u.jsx("rect",{width:c+8,height:c+8,fill:"white"}),i.map((a,f)=>a.map((p,_)=>p?u.jsx("rect",{x:_+4,y:f+4,width:"1",height:"1",fill:"currentColor"},`${_}-${f}`):null))]})}function Tv(s){var i;return s?s.isOwnedByMe?"Dig":((i=s.ownerName)==null?void 0:i.trim())||"Anden bruger":"Ukendt"}function Gt({label:s,value:i}){return u.jsxs("div",{className:"settings-row",children:[u.jsx("span",{children:s}),u.jsx("strong",{children:i})]})}function Mv(){const s=ae(a=>a.confirmDialog),i=ae(a=>a.closeConfirm);if(!s)return null;function c(){s==null||s.onConfirm(),i()}return u.jsx(Tn,{title:s.title,onClose:i,children:u.jsxs("div",{className:"settings-stack",children:[u.jsx("p",{className:"confirm-message",children:s.message}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:i,children:s.cancelLabel??"Annuller"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:c,children:s.confirmLabel??"Fortsæt"})]})]})})}function Dv(){const s=ae(a=>a.connectionLost),i=ae(a=>a.reconnectLostDevice),c=ae(a=>a.dismissConnectionLost);return s?u.jsx(Tn,{title:"Forbindelse afbrudt",onClose:c,children:u.jsxs("div",{className:"settings-stack",children:[u.jsxs("p",{className:"confirm-message",children:["Forbindelsen til ",s.deviceName," blev afbrudt. Tjek at Picoen har strøm og er tæt nok på."]}),u.jsxs("div",{className:"row",children:[u.jsx("button",{className:"btn btn-outline btn-block",type:"button",onClick:c,children:"Luk"}),u.jsx("button",{className:"btn btn-primary btn-block",type:"button",onClick:()=>i(),children:"Genforbind"})]})]})}):null}function jv(){const s=ae(c=>c.toast),i=ae(c=>c.dismissToast);return s?u.jsx("div",{className:"toast",role:"alert",onClick:i,children:s.message},s.id):null}function Av(){const s=ae(y=>y.screen),i=ae(y=>y.splashTarget),c=ae(y=>y.init),a=ae(y=>y.sideMenuOpen),f=ae(y=>y.debuggerOpen),[p,_]=z.useState(!1);return z.useEffect(()=>{c()},[c]),z.useEffect(()=>{if(a){_(!0);return}const y=setTimeout(()=>_(!1),140);return()=>clearTimeout(y)},[a]),u.jsxs("div",{className:"app",children:[s==="splash"&&i==="intro"&&u.jsx(Rh,{}),s==="splash"&&i==="dashboard"&&u.jsx(Th,{}),s==="splash"&&u.jsx(r0,{}),s==="intro"&&u.jsx(Rh,{}),s==="dashboard"&&u.jsx(Th,{}),s==="connection"&&u.jsx(o0,{}),s==="create"&&u.jsx(c0,{}),s==="control"&&u.jsx(q0,{}),s==="ide"&&u.jsx(Yy,{}),p&&u.jsx(uv,{open:a}),u.jsx(Sv,{}),u.jsx(Dv,{}),u.jsx(Mv,{}),f&&u.jsx(mv,{}),u.jsx(jv,{})]})}function Ov(){if(!("serviceWorker"in navigator))return;window.addEventListener("load",()=>{const i=new URL("sw.js",window.location.href);navigator.serviceWorker.register(i,{scope:"./"}).catch(c=>{console.warn("Service worker registration failed:",c)})});let s=!1;navigator.serviceWorker.addEventListener("controllerchange",()=>{s||window.crossOriginIsolated||(s=!0,window.location.reload())})}Ov();mb.createRoot(document.getElementById("root")).render(u.jsx(ms.StrictMode,{children:u.jsx(Av,{})}));
