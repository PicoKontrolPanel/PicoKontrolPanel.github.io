 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hm;function E2(){if(hm)return Re;hm=1;var i=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),p=Symbol.for("react.consumer"),_=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),k=Symbol.for("react.activity"),T=Symbol.iterator;function U(E){return E===null||typeof E!="object"?null:(E=T&&E[T]||E["@@iterator"],typeof E=="function"?E:null)}var R={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},G=Object.assign,P={};function V(E,z,ee){this.props=E,this.context=z,this.refs=P,this.updater=ee||R}V.prototype.isReactComponent={},V.prototype.setState=function(E,z){if(typeof E!="object"&&typeof E!="function"&&E!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,E,z,"setState")},V.prototype.forceUpdate=function(E){this.updater.enqueueForceUpdate(this,E,"forceUpdate")};function X(){}X.prototype=V.prototype;function I(E,z,ee){this.props=E,this.context=z,this.refs=P,this.updater=ee||R}var re=I.prototype=new X;re.constructor=I,G(re,V.prototype),re.isPureReactComponent=!0;var _e=Array.isArray;function ue(){}var W={H:null,A:null,T:null,S:null},Z=Object.prototype.hasOwnProperty;function ke(E,z,ee){var le=ee.ref;return{$$typeof:i,type:E,key:z,ref:le!==void 0?le:null,props:ee}}function Ee(E,z){return ke(E.type,z,E.props)}function ze(E){return typeof E=="object"&&E!==null&&E.$$typeof===i}function J(E){var z={"=":"=0",":":"=2"};return"$"+E.replace(/[=:]/g,function(ee){return z[ee]})}var Ne=/\/+/g;function je(E,z){return typeof E=="object"&&E!==null&&E.key!=null?J(""+E.key):z.toString(36)}function de(E){switch(E.status){case"fulfilled":return E.value;case"rejected":throw E.reason;default:switch(typeof E.status=="string"?E.then(ue,ue):(E.status="pending",E.then(function(z){E.status==="pending"&&(E.status="fulfilled",E.value=z)},function(z){E.status==="pending"&&(E.status="rejected",E.reason=z)})),E.status){case"fulfilled":return E.value;case"rejected":throw E.reason}}throw E}function B(E,z,ee,le,se){var H=typeof E;(H==="undefined"||H==="boolean")&&(E=null);var D=!1;if(E===null)D=!0;else switch(H){case"bigint":case"string":case"number":D=!0;break;case"object":switch(E.$$typeof){case i:case l:D=!0;break;case w:return D=E._init,B(D(E._payload),z,ee,le,se)}}if(D)return se=se(E),D=le===""?"."+je(E,0):le,_e(se)?(ee="",D!=null&&(ee=D.replace(Ne,"$&/")+"/"),B(se,z,ee,"",function(Ue){return Ue})):se!=null&&(ze(se)&&(se=Ee(se,ee+(se.key==null||E&&E.key===se.key?"":(""+se.key).replace(Ne,"$&/")+"/")+D)),z.push(se)),1;D=0;var oe=le===""?".":le+":";if(_e(E))for(var xe=0;xe<E.length;xe++)le=E[xe],H=oe+je(le,xe),D+=B(le,z,ee,H,se);else if(xe=U(E),typeof xe=="function")for(E=xe.call(E),xe=0;!(le=E.next()).done;)le=le.value,H=oe+je(le,xe++),D+=B(le,z,ee,H,se);else if(H==="object"){if(typeof E.then=="function")return B(de(E),z,ee,le,se);throw z=String(E),Error("Objects are not valid as a React child (found: "+(z==="[object Object]"?"object with keys {"+Object.keys(E).join(", ")+"}":z)+"). If you meant to render a collection of children, use an array instead.")}return D}function ne(E,z,ee){if(E==null)return E;var le=[],se=0;return B(E,le,"","",function(H){return z.call(ee,H,se++)}),le}function he(E){if(E._status===-1){var z=E._result;z=z(),z.then(function(ee){(E._status===0||E._status===-1)&&(E._status=1,E._result=ee)},function(ee){(E._status===0||E._status===-1)&&(E._status=2,E._result=ee)}),E._status===-1&&(E._status=0,E._result=z)}if(E._status===1)return E._result.default;throw E._result}var me=typeof reportError=="function"?reportError:function(E){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof E=="object"&&E!==null&&typeof E.message=="string"?String(E.message):String(E),error:E});if(!window.dispatchEvent(z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",E);return}console.error(E)},we={map:ne,forEach:function(E,z,ee){ne(E,function(){z.apply(this,arguments)},ee)},count:function(E){var z=0;return ne(E,function(){z++}),z},toArray:function(E){return ne(E,function(z){return z})||[]},only:function(E){if(!ze(E))throw Error("React.Children.only expected to receive a single React element child.");return E}};return Re.Activity=k,Re.Children=we,Re.Component=V,Re.Fragment=o,Re.Profiler=d,Re.PureComponent=I,Re.StrictMode=s,Re.Suspense=g,Re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=W,Re.__COMPILER_RUNTIME={__proto__:null,c:function(E){return W.H.useMemoCache(E)}},Re.cache=function(E){return function(){return E.apply(null,arguments)}},Re.cacheSignal=function(){return null},Re.cloneElement=function(E,z,ee){if(E==null)throw Error("The argument must be a React element, but you passed "+E+".");var le=G({},E.props),se=E.key;if(z!=null)for(H in z.key!==void 0&&(se=""+z.key),z)!Z.call(z,H)||H==="key"||H==="__self"||H==="__source"||H==="ref"&&z.ref===void 0||(le[H]=z[H]);var H=arguments.length-2;if(H===1)le.children=ee;else if(1<H){for(var D=Array(H),oe=0;oe<H;oe++)D[oe]=arguments[oe+2];le.children=D}return ke(E.type,se,le)},Re.createContext=function(E){return E={$$typeof:_,_currentValue:E,_currentValue2:E,_threadCount:0,Provider:null,Consumer:null},E.Provider=E,E.Consumer={$$typeof:p,_context:E},E},Re.createElement=function(E,z,ee){var le,se={},H=null;if(z!=null)for(le in z.key!==void 0&&(H=""+z.key),z)Z.call(z,le)&&le!=="key"&&le!=="__self"&&le!=="__source"&&(se[le]=z[le]);var D=arguments.length-2;if(D===1)se.children=ee;else if(1<D){for(var oe=Array(D),xe=0;xe<D;xe++)oe[xe]=arguments[xe+2];se.children=oe}if(E&&E.defaultProps)for(le in D=E.defaultProps,D)se[le]===void 0&&(se[le]=D[le]);return ke(E,H,se)},Re.createRef=function(){return{current:null}},Re.forwardRef=function(E){return{$$typeof:m,render:E}},Re.isValidElement=ze,Re.lazy=function(E){return{$$typeof:w,_payload:{_status:-1,_result:E},_init:he}},Re.memo=function(E,z){return{$$typeof:b,type:E,compare:z===void 0?null:z}},Re.startTransition=function(E){var z=W.T,ee={};W.T=ee;try{var le=E(),se=W.S;se!==null&&se(ee,le),typeof le=="object"&&le!==null&&typeof le.then=="function"&&le.then(ue,me)}catch(H){me(H)}finally{z!==null&&ee.types!==null&&(z.types=ee.types),W.T=z}},Re.unstable_useCacheRefresh=function(){return W.H.useCacheRefresh()},Re.use=function(E){return W.H.use(E)},Re.useActionState=function(E,z,ee){return W.H.useActionState(E,z,ee)},Re.useCallback=function(E,z){return W.H.useCallback(E,z)},Re.useContext=function(E){return W.H.useContext(E)},Re.useDebugValue=function(){},Re.useDeferredValue=function(E,z){return W.H.useDeferredValue(E,z)},Re.useEffect=function(E,z){return W.H.useEffect(E,z)},Re.useEffectEvent=function(E){return W.H.useEffectEvent(E)},Re.useId=function(){return W.H.useId()},Re.useImperativeHandle=function(E,z,ee){return W.H.useImperativeHandle(E,z,ee)},Re.useInsertionEffect=function(E,z){return W.H.useInsertionEffect(E,z)},Re.useLayoutEffect=function(E,z){return W.H.useLayoutEffect(E,z)},Re.useMemo=function(E,z){return W.H.useMemo(E,z)},Re.useOptimistic=function(E,z){return W.H.useOptimistic(E,z)},Re.useReducer=function(E,z,ee){return W.H.useReducer(E,z,ee)},Re.useRef=function(E){return W.H.useRef(E)},Re.useState=function(E){return W.H.useState(E)},Re.useSyncExternalStore=function(E,z,ee){return W.H.useSyncExternalStore(E,z,ee)},Re.useTransition=function(){return W.H.useTransition()},Re.version="19.2.7",Re}var pm;function ef(){return pm||(pm=1,Ed.exports=E2()),Ed.exports}var C=ef();const ms=Eh(C);var Td={exports:{}},is={},Md={exports:{}},jd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gm;function T2(){return gm||(gm=1,(function(i){function l(B,ne){var he=B.length;B.push(ne);e:for(;0<he;){var me=he-1>>>1,we=B[me];if(0<d(we,ne))B[me]=ne,B[he]=we,he=me;else break e}}function o(B){return B.length===0?null:B[0]}function s(B){if(B.length===0)return null;var ne=B[0],he=B.pop();if(he!==ne){B[0]=he;e:for(var me=0,we=B.length,E=we>>>1;me<E;){var z=2*(me+1)-1,ee=B[z],le=z+1,se=B[le];if(0>d(ee,he))le<we&&0>d(se,ee)?(B[me]=se,B[le]=he,me=le):(B[me]=ee,B[z]=he,me=z);else if(le<we&&0>d(se,he))B[me]=se,B[le]=he,me=le;else break e}}return ne}function d(B,ne){var he=B.sortIndex-ne.sortIndex;return he!==0?he:B.id-ne.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;i.unstable_now=function(){return p.now()}}else{var _=Date,m=_.now();i.unstable_now=function(){return _.now()-m}}var g=[],b=[],w=1,k=null,T=3,U=!1,R=!1,G=!1,P=!1,V=typeof setTimeout=="function"?setTimeout:null,X=typeof clearTimeout=="function"?clearTimeout:null,I=typeof setImmediate<"u"?setImmediate:null;function re(B){for(var ne=o(b);ne!==null;){if(ne.callback===null)s(b);else if(ne.startTime<=B)s(b),ne.sortIndex=ne.expirationTime,l(g,ne);else break;ne=o(b)}}function _e(B){if(G=!1,re(B),!R)if(o(g)!==null)R=!0,ue||(ue=!0,J());else{var ne=o(b);ne!==null&&de(_e,ne.startTime-B)}}var ue=!1,W=-1,Z=5,ke=-1;function Ee(){return P?!0:!(i.unstable_now()-ke<Z)}function ze(){if(P=!1,ue){var B=i.unstable_now();ke=B;var ne=!0;try{e:{R=!1,G&&(G=!1,X(W),W=-1),U=!0;var he=T;try{t:{for(re(B),k=o(g);k!==null&&!(k.expirationTime>B&&Ee());){var me=k.callback;if(typeof me=="function"){k.callback=null,T=k.priorityLevel;var we=me(k.expirationTime<=B);if(B=i.unstable_now(),typeof we=="function"){k.callback=we,re(B),ne=!0;break t}k===o(g)&&s(g),re(B)}else s(g);k=o(g)}if(k!==null)ne=!0;else{var E=o(b);E!==null&&de(_e,E.startTime-B),ne=!1}}break e}finally{k=null,T=he,U=!1}ne=void 0}}finally{ne?J():ue=!1}}}var J;if(typeof I=="function")J=function(){I(ze)};else if(typeof MessageChannel<"u"){var Ne=new MessageChannel,je=Ne.port2;Ne.port1.onmessage=ze,J=function(){je.postMessage(null)}}else J=function(){V(ze,0)};function de(B,ne){W=V(function(){B(i.unstable_now())},ne)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(B){B.callback=null},i.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<B?Math.floor(1e3/B):5},i.unstable_getCurrentPriorityLevel=function(){return T},i.unstable_next=function(B){switch(T){case 1:case 2:case 3:var ne=3;break;default:ne=T}var he=T;T=ne;try{return B()}finally{T=he}},i.unstable_requestPaint=function(){P=!0},i.unstable_runWithPriority=function(B,ne){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var he=T;T=B;try{return ne()}finally{T=he}},i.unstable_scheduleCallback=function(B,ne,he){var me=i.unstable_now();switch(typeof he=="object"&&he!==null?(he=he.delay,he=typeof he=="number"&&0<he?me+he:me):he=me,B){case 1:var we=-1;break;case 2:we=250;break;case 5:we=1073741823;break;case 4:we=1e4;break;default:we=5e3}return we=he+we,B={id:w++,callback:ne,priorityLevel:B,startTime:he,expirationTime:we,sortIndex:-1},he>me?(B.sortIndex=he,l(b,B),o(g)===null&&B===o(b)&&(G?(X(W),W=-1):G=!0,de(_e,he-me))):(B.sortIndex=we,l(g,B),R||U||(R=!0,ue||(ue=!0,J()))),B},i.unstable_shouldYield=Ee,i.unstable_wrapCallback=function(B){var ne=T;return function(){var he=T;T=ne;try{return B.apply(this,arguments)}finally{T=he}}}})(jd)),jd}var _m;function M2(){return _m||(_m=1,Md.exports=T2()),Md.exports}var Nd={exports:{}},on={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ym;function N2(){if(ym)return is;ym=1;var i=M2(),l=ef(),o=Th();function s(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function d(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function p(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function _(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function m(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function g(e){if(p(e)!==e)throw Error(s(188))}function b(e){var t=e.alternate;if(!t){if(t=p(e),t===null)throw Error(s(188));return t!==e?null:e}for(var n=e,r=t;;){var a=n.return;if(a===null)break;var c=a.alternate;if(c===null){if(r=a.return,r!==null){n=r;continue}break}if(a.child===c.child){for(c=a.child;c;){if(c===n)return g(a),e;if(c===r)return g(a),t;c=c.sibling}throw Error(s(188))}if(n.return!==r.return)n=a,r=c;else{for(var h=!1,y=a.child;y;){if(y===n){h=!0,n=a,r=c;break}if(y===r){h=!0,r=a,n=c;break}y=y.sibling}if(!h){for(y=c.child;y;){if(y===n){h=!0,n=c,r=a;break}if(y===r){h=!0,r=c,n=a;break}y=y.sibling}if(!h)throw Error(s(189))}}if(n.alternate!==r)throw Error(s(190))}if(n.tag!==3)throw Error(s(188));return n.stateNode.current===n?e:t}function w(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=w(e),t!==null)return t;e=e.sibling}return null}var k=Object.assign,T=Symbol.for("react.element"),U=Symbol.for("react.transitional.element"),R=Symbol.for("react.portal"),G=Symbol.for("react.fragment"),P=Symbol.for("react.strict_mode"),V=Symbol.for("react.profiler"),X=Symbol.for("react.consumer"),I=Symbol.for("react.context"),re=Symbol.for("react.forward_ref"),_e=Symbol.for("react.suspense"),ue=Symbol.for("react.suspense_list"),W=Symbol.for("react.memo"),Z=Symbol.for("react.lazy"),ke=Symbol.for("react.activity"),Ee=Symbol.for("react.memo_cache_sentinel"),ze=Symbol.iterator;function J(e){return e===null||typeof e!="object"?null:(e=ze&&e[ze]||e["@@iterator"],typeof e=="function"?e:null)}var Ne=Symbol.for("react.client.reference");function je(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Ne?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case G:return"Fragment";case V:return"Profiler";case P:return"StrictMode";case _e:return"Suspense";case ue:return"SuspenseList";case ke:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case R:return"Portal";case I:return e.displayName||"Context";case X:return(e._context.displayName||"Context")+".Consumer";case re:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case W:return t=e.displayName||null,t!==null?t:je(e.type)||"Memo";case Z:t=e._payload,e=e._init;try{return je(e(t))}catch{}}return null}var de=Array.isArray,B=l.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,ne=o.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,he={pending:!1,data:null,method:null,action:null},me=[],we=-1;function E(e){return{current:e}}function z(e){0>we||(e.current=me[we],me[we]=null,we--)}function ee(e,t){we++,me[we]=e.current,e.current=t}var le=E(null),se=E(null),H=E(null),D=E(null);function oe(e,t){switch(ee(H,t),ee(se,e),ee(le,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?L1(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=L1(t),e=B1(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}z(le),ee(le,e)}function xe(){z(le),z(se),z(H)}function Ue(e){e.memoizedState!==null&&ee(D,e);var t=le.current,n=B1(t,e.type);t!==n&&(ee(se,e),ee(le,n))}function fe(e){se.current===e&&(z(le),z(se)),D.current===e&&(z(D),ts._currentValue=he)}var Be,Ce;function Ke(e){if(Be===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);Be=t&&t[1]||"",Ce=-1<n.stack.indexOf(`
    at`)?" (<anonymous>)":-1<n.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Be+e+Ce}var it=!1;function wt(e,t){if(!e||it)return"";it=!0;var n=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var r={DetermineComponentFrameRoot:function(){try{if(t){var Q=function(){throw Error()};if(Object.defineProperty(Q.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(Q,[])}catch(F){var q=F}Reflect.construct(e,[],Q)}else{try{Q.call()}catch(F){q=F}e.call(Q.prototype)}}else{try{throw Error()}catch(F){q=F}(Q=e())&&typeof Q.catch=="function"&&Q.catch(function(){})}}catch(F){if(F&&q&&typeof F.stack=="string")return[F.stack,q.stack]}return[null,null]}};r.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var a=Object.getOwnPropertyDescriptor(r.DetermineComponentFrameRoot,"name");a&&a.configurable&&Object.defineProperty(r.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var c=r.DetermineComponentFrameRoot(),h=c[0],y=c[1];if(h&&y){var S=h.split(`
`),L=y.split(`
...
`,te-2)+1,sr=J.slice(ir,te),Nr=J.slice(0,ir)+$e+sr+J.slice(Me),Rr=-sr.length;return Gt(Nr,x+Rr,N,j+Rr),!0}if(Me>=J.length)return!1;const tt=ki(J,Me),an=tt<J.length?tt+1:tt,Oe=J.slice(Me,an),ot=J.slice(0,te)+Oe+$e+J.slice(an),jr=Oe.length;return Gt(ot,x+jr,N,j+jr),!0}function $s(f){var an;if(Vl){(f.key==="Enter"||f.key==="Tab"||(f.ctrlKey||f.metaKey)&&["z","y","s"].includes(f.key.toLowerCase()))&&f.preventDefault();return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="z"){f.preventDefault(),(f.shiftKey?rl():mi())&&ft(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="y"){f.preventDefault(),rl()&&ft(null);return}if((f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="s"){f.preventDefault(),!P&&Z.trim()&&As();return}if(f.altKey&&!f.ctrlKey&&!f.metaKey&&(f.key==="ArrowUp"||f.key==="ArrowDown")){f.preventDefault(),Gs(f.key==="ArrowUp"?-1:1)&&ft(null);return}if(We){if(f.key==="ArrowDown"){f.preventDefault(),ft(Oe=>{if(!Oe)return Oe;const ot=(Oe.selected+1)%Oe.items.length;return In(er.current,ot),{...Oe,selected:ot}});return}if(f.key==="ArrowUp"){f.preventDefault(),ft(Oe=>{if(!Oe)return Oe;const ot=(Oe.selected-1+Oe.items.length)%Oe.items.length;return In(er.current,ot),{...Oe,selected:ot}});return}if(f.key==="Tab"){f.preventDefault(),Ta();return}if(f.key==="Enter"){if(!(We.items[We.selected]&&ep(We.items[We.selected],J.slice(We.start,We.end)))){f.preventDefault(),Ta();return}ft(null)}if(f.key==="Escape"){f.preventDefault(),ft(null);return}}if(f.key==="Enter"){f.preventDefault();const Oe=f.currentTarget,ot=Oe.selectionStart,jr=Oe.selectionEnd,ir={content:J,selectionStart:ot,selectionEnd:jr},sr=J.lastIndexOf(`
...
`,_),w=b===-1?i.length:b;if(l<=w&&_>=o)return!0;_=w;continue}if(g==='"""'||g==="'''"){d=m,_+=2;continue}(m==='"'||m==="'")&&(s=m)}return s!==null||d!==null}function ep(i,l){const o=i.insert.trim();return!/[().]/.test(o)&&o.toLowerCase()===l.toLowerCase()}function qv(i){return/^[A-Za-zÆØÅæøå_][A-Za-zÆØÅæøå0-9_]*$/.test(i)}function _h(i,l,o){if(!i)return null;const s=i.closest(".ide-terminal")??i.parentElement;if(!s)return null;const d=window.getComputedStyle(i),p=document.createElement("div"),_=document.createElement("span"),m=s.getBoundingClientRect(),g=i.getBoundingClientRect();p.style.position="absolute",p.style.visibility="hidden",p.style.pointerEvents="none",p.style.whiteSpace="pre-wrap",p.style.overflowWrap="break-word",p.style.wordBreak=d.wordBreak,p.style.boxSizing=d.boxSizing,p.style.width=`${i.getBoundingClientRect().width}px`,p.style.padding=d.padding,p.style.border=d.border,p.style.font=d.font,p.style.lineHeight=d.lineHeight,p.style.letterSpacing=d.letterSpacing,p.style.tabSize=d.tabSize,p.style.fontVariantLigatures=d.fontVariantLigatures,p.style.scrollbarGutter=d.scrollbarGutter,p.style.left=`${g.left-m.left-i.scrollLeft}px`,p.style.top=`${g.top-m.top-i.scrollTop}px`,p.textContent=i.value.slice(0,l),_.textContent=i.value.slice(l,l+1)||" ",p.appendChild(_),s.appendChild(p);const b=_.getBoundingClientRect();p.remove();const w=34,k=14,T=Math.min(210,Math.max(w+k,o*w+k)),U=Hv(b.left-m.left,8,Math.max(8,s.clientWidth-296)),R=b.top-m.top+s.scrollTop,G=b.bottom-m.top+s.scrollTop+10,P=s.scrollTop+s.clientHeight-G-8,V=R-s.scrollTop-8,X=s.scrollTop+s.clientHeight,I=P>=Math.min(T,w*2)||P>=V?"below":"above",re=Math.max(w+k,Math.min(T,I==="below"?P:V)),_e=I==="below"?Math.min(G,X-re-8):Math.max(s.scrollTop+8,R-re-8);return{left:U,top:_e,maxHeight:re,placement:I}}function Hv(i,l,o){return Math.max(l,Math.min(o,i))}function Vv(i){const l=[];let o=null,s=null,d=!1,p=0,_=0;const m=(g,b)=>{g>p&&l.push({text:i.slice(p,g),isTriple:b}),p=g};for(;_<i.length;){const g=i[_],b=i.slice(_,_+3);if(s){if(b===s.repeat(3)){_+=3,s=null,m(_,!0);continue}_+=1;continue}if(o){d?d=!1:g==="\\"?d=!0:(g===o||g===`
